...
- **Name**: `rPackages.Certara_DarwinReporter`
- **Version**: `2.0.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/Certara.DarwinReporter/](https://cran.r-project.org/web/packages/Certara.DarwinReporter/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/dc0y3zwsqf4va5f7zsqnia54hlci37x0-r-Certara.DarwinReporter-2.0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/dc0y3zwsqf4va5f7zsqnia54hlci37x0-r-Certara.DarwinReporter-2.0.1`
...
- [[i6r21i6290zwg0yslyzb0fs47xsyrpdb-Certara.DarwinReporter_2.0.1.tar.gz]]
