...
Arrays of small integers, not necessarily chars

## 📋 Package Information

- **Name**: `akkuPackages.slib-byte`
- **Version**: `3.1.5`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/nd6xb20b04vwfqi8gbkgda85f4h0a32s-akku-slib-byte-3.1.5.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/tools/package-management/akku/default.nix:39`
- **Outputs**:
  - `out`:  `/nix/store/nd6xb20b04vwfqi8gbkgda85f4h0a32s-akku-slib-byte-3.1.5`
...
- [[l8jpq6dhwdsp2sbwj58i2r81dvdmmf3s-slib-byte-SLIB-3b5-r7rs.tgz]]
