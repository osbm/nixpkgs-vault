...
- **Name**: `linuxKernel.packages.linux_latest_libre.zfs_unstable`
...
- **Derivation Path**: `/nix/store/gpdwvr4p5dhz3nwafm3i423fcz1ya4lf-zfs-kernel-2.4.0-rc1-6.16.8.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/zfs/generic.nix:322`
- **Outputs**:
  - `out`:  `/nix/store/gpdwvr4p5dhz3nwafm3i423fcz1ya4lf-zfs-kernel-2.4.0-rc1-6.16.8`
