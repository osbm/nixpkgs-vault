...
- **Name**: `linuxKernel.packages.linux_6_1.virtualbox`
- **Version**: `7.2.0-6.1.153`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/fpww4n7vzx9659xcba5990bdr7dc989k-virtualbox-modules-7.2.0-6.1.153.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/virtualbox/default.nix:27`
- **Outputs**:
  - `out`:  `/nix/store/fpww4n7vzx9659xcba5990bdr7dc989k-virtualbox-modules-7.2.0-6.1.153`
