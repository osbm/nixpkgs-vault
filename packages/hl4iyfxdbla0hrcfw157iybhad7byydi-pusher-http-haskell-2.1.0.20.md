---
aliases:
  - haskellPackages.pusher-http-haskell
tags:
  - license/unknown
  - outputs/doc
  - outputs/out
...
- **Name**: `haskellPackages.pusher-http-haskell`
- **Version**: `2.1.0.20`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Haskell client library for the Pusher Channels HTTP API
- **Homepage**: [https://hackage.haskell.org/package/pusher-http-haskell](https://hackage.haskell.org/package/pusher-http-haskell)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/hl4iyfxdbla0hrcfw157iybhad7byydi-pusher-http-haskell-2.1.0.20.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:548464`
- **Outputs**:
  - `doc`:  `/nix/store/hl4iyfxdbla0hrcfw157iybhad7byydi-pusher-http-haskell-2.1.0.20`
  - `out`:  `/nix/store/hl4iyfxdbla0hrcfw157iybhad7byydi-pusher-http-haskell-2.1.0.20`

## 🔗 Dependencies

- [[2pr652igq6awvbbf5rfnb3kbrmg1cryf-http-types-0.12.4]]
- [[45wky4h8vdpjfgbfywky6wd460dcnk82-hspec-2.11.12]]
- [[4b4dbrhpzn3b72gwhg165wwpkg6y864h-pusher-http-haskell-2.1.0.20.tar.gz]]
