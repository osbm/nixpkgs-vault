...
- **Name**: `rPackages.fmerPack`
- **Version**: `0.0-1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/fmerPack/](https://cran.r-project.org/web/packages/fmerPack/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/9vli991q1x7p2aj1aci6p6hmpxr778y2-r-fmerPack-0.0-1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/9vli991q1x7p2aj1aci6p6hmpxr778y2-r-fmerPack-0.0-1`
...
- [[s0jgs8zxivqh7j22z35nb03sj5w82nj4-fmerPack_0.0-1.tar.gz]]
