---
aliases:
  - haskellPackages.yesod-content-pdf
tags:
  - broken
  - not-available
  - license/unknown
...
- **Name**: `haskellPackages.yesod-content-pdf`
- **Version**: `0.2.0.5`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: PDF Content Type for Yesod
- **Homepage**: [https://hackage.haskell.org/package/yesod-content-pdf](https://hackage.haskell.org/package/yesod-content-pdf)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/nbnj9j0rgxks0d7k4dnj24z1sb04hslj-yesod-content-pdf-0.2.0.5.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:739650`
- **Outputs**:
  - `doc`:  `/nix/store/nbnj9j0rgxks0d7k4dnj24z1sb04hslj-yesod-content-pdf-0.2.0.5`
  - `out`:  `/nix/store/nbnj9j0rgxks0d7k4dnj24z1sb04hslj-yesod-content-pdf-0.2.0.5`
...
- [[ldj3l4a0fv6y2kyiym86idhw8srgnx5n-yesod-content-pdf-0.2.0.5.tar.gz]]
