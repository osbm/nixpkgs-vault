...
- **Name**: `python313Packages.psycopg`
- **Version**: `3.2.9`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/pfhrbq9pgza67d8vmvya8n4mw44wla99-python3.13-psycopg-3.2.9.drv`
...
- **Outputs**:
  - `dist`:  `/nix/store/pfhrbq9pgza67d8vmvya8n4mw44wla99-python3.13-psycopg-3.2.9`
  - `doc`:  `/nix/store/pfhrbq9pgza67d8vmvya8n4mw44wla99-python3.13-psycopg-3.2.9`
  - `out`:  `/nix/store/pfhrbq9pgza67d8vmvya8n4mw44wla99-python3.13-psycopg-3.2.9`
...
- [[fji2azdjr8kbggyjjipm6bgjy6b0if50-python3.13-pproxy-2.7.9]]
