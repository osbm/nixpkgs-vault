...
- **Name**: `rPackages.iheatmapr`
- **Version**: `0.7.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/iheatmapr/](https://cran.r-project.org/web/packages/iheatmapr/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/idk8y8bcfcnkgsw7ld7iqv6zlmwi9a73-r-iheatmapr-0.7.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/idk8y8bcfcnkgsw7ld7iqv6zlmwi9a73-r-iheatmapr-0.7.1`
...
- [[43s9fwh993zn87a69744zq180v32zn57-iheatmapr_0.7.1.tar.gz]]
