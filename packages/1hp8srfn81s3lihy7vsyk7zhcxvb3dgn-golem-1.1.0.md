...
Open source durable computing platform that makes it easy to build and deploy highly reliable distributed systems
...
- **Homepage**: [https://www.golem.cloud/](https://www.golem.cloud/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/1hp8srfn81s3lihy7vsyk7zhcxvb3dgn-golem-1.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/go/golem/package.nix:71`
- **Outputs**:
  - `out`:  `/nix/store/1hp8srfn81s3lihy7vsyk7zhcxvb3dgn-golem-1.1.0`
...
- [[qfjjgz2d2jd313ciwfyjk57myapl4yw8-golem-1.1.0-vendor]]
- [[qi6337yh29r9ppqm262bf6vz0g13451b-cargo-build-hook.sh]]
- [[qyl8ilxawkbnkv3akxcffrkmc883dpnq-source]]
