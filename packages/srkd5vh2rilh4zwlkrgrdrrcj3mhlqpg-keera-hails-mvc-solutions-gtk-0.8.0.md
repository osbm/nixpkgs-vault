---
aliases:
  - haskellPackages.keera-hails-mvc-solutions-gtk
tags:
  - license/unknown
  - outputs/doc
  - outputs/out
...
- **Name**: `haskellPackages.keera-hails-mvc-solutions-gtk`
- **Version**: `0.8.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Haskell on Gtk rails - Solutions to recurrent problems in Gtk applications
- **Homepage**: [https://hackage.haskell.org/package/keera-hails-mvc-solutions-gtk](https://hackage.haskell.org/package/keera-hails-mvc-solutions-gtk)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/srkd5vh2rilh4zwlkrgrdrrcj3mhlqpg-keera-hails-mvc-solutions-gtk-0.8.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:398932`
- **Outputs**:
  - `doc`:  `/nix/store/srkd5vh2rilh4zwlkrgrdrrcj3mhlqpg-keera-hails-mvc-solutions-gtk-0.8.0`
  - `out`:  `/nix/store/srkd5vh2rilh4zwlkrgrdrrcj3mhlqpg-keera-hails-mvc-solutions-gtk-0.8.0`
...
- [[84q7iz6b3c7rf2snxrd4qig2i8002m1h-keera-hails-mvc-solutions-gtk-0.8.0.tar.gz]]
