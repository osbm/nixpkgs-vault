...
Application that helps to clean unwanted traces the user leaves on the system

## 📋 Package Information

- **Name**: `kdePackages.sweeper`
- **Version**: `25.08.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Application that helps to clean unwanted traces the user leaves on the system
- **Homepage**: [https://invent.kde.org/utilities/sweeper](https://invent.kde.org/utilities/sweeper)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/hxsm0zdqrrsgh10s7xi13lyyifsr2aac-sweeper-25.08.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/kde/gear/sweeper/default.nix:3`
- **Outputs**:
  - `debug`:  `/nix/store/hxsm0zdqrrsgh10s7xi13lyyifsr2aac-sweeper-25.08.1`
  - `dev`:  `/nix/store/hxsm0zdqrrsgh10s7xi13lyyifsr2aac-sweeper-25.08.1`
  - `devtools`:  `/nix/store/hxsm0zdqrrsgh10s7xi13lyyifsr2aac-sweeper-25.08.1`
  - `out`:  `/nix/store/hxsm0zdqrrsgh10s7xi13lyyifsr2aac-sweeper-25.08.1`
...
- [[v8zyg0n4z2c9fynv6jn3i3v3i4nl9x5n-sweeper-25.08.1.tar.xz]]
