...
- **Name**: `python312Packages.linearmodels`
- **Version**: `6.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Models for panel data, system regression, instrumental variables and asset pricing
- **Homepage**: [https://bashtage.github.io/linearmodels/](https://bashtage.github.io/linearmodels/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/f21y8pyyh9rspl06qj387gfskg9nnql3-python3.12-linearmodels-6.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/linearmodels/default.nix:53`
- **Outputs**:
  - `dist`:  `/nix/store/f21y8pyyh9rspl06qj387gfskg9nnql3-python3.12-linearmodels-6.1`
  - `out`:  `/nix/store/f21y8pyyh9rspl06qj387gfskg9nnql3-python3.12-linearmodels-6.1`

## 🔗 Dependencies

- [[1rhn4g4wvzzgm6r50ljh0zza89zirw79-source]]
...
- [[qz8y0g9a408kics7h5qy0hf3r8d0mcj7-python3.12-pyhdfe-0.2.0]]
