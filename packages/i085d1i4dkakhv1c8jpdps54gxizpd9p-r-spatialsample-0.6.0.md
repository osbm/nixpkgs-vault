...
- **Name**: `rPackages.spatialsample`
- **Version**: `0.6.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/spatialsample/](https://cran.r-project.org/web/packages/spatialsample/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/i085d1i4dkakhv1c8jpdps54gxizpd9p-r-spatialsample-0.6.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/i085d1i4dkakhv1c8jpdps54gxizpd9p-r-spatialsample-0.6.0`
...
- [[pcrqkialh3nbb4yfq7sywix4vh03ckh4-spatialsample_0.6.0.tar.gz]]
