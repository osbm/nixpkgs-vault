...
- **Name**: `rPackages.marketr`
- **Version**: `0.0.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/marketr/](https://cran.r-project.org/web/packages/marketr/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/hm8w7pl448kh5sdsgpdw80bqs3l83dnb-r-marketr-0.0.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/hm8w7pl448kh5sdsgpdw80bqs3l83dnb-r-marketr-0.0.2`

## 🔗 Dependencies

- [[20nv0z25glcb2mbsb18n103lvpcy7kgl-marketr_0.0.2.tar.gz]]
