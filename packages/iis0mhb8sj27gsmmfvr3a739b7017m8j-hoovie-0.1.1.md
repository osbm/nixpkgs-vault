...
- **Name**: `haskellPackages.hoovie`
- **Version**: `0.1.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Haskell Media Server
- **Homepage**: [https://hackage.haskell.org/package/hoovie](https://hackage.haskell.org/package/hoovie)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/iis0mhb8sj27gsmmfvr3a739b7017m8j-hoovie-0.1.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:340660`
- **Outputs**:
  - `doc`:  `/nix/store/iis0mhb8sj27gsmmfvr3a739b7017m8j-hoovie-0.1.1`
  - `out`:  `/nix/store/iis0mhb8sj27gsmmfvr3a739b7017m8j-hoovie-0.1.1`
...
- [[bzjpfj3hq8a9sbb7slpwd2h9wm2k315p-hoovie-0.1.1.tar.gz]]
