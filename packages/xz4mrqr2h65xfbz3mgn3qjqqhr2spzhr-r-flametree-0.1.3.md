...
- **Name**: `rPackages.flametree`
- **Version**: `0.1.3`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/flametree/](https://cran.r-project.org/web/packages/flametree/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/xz4mrqr2h65xfbz3mgn3qjqqhr2spzhr-r-flametree-0.1.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/xz4mrqr2h65xfbz3mgn3qjqqhr2spzhr-r-flametree-0.1.3`
...
- [[flpcqh6pfhky50r30gjnbx6x48p9ljrx-flametree_0.1.3.tar.gz]]
