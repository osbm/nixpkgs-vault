---
aliases:
  - home-assistant-component-tests.facebook
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.facebook`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/v5kfmjffik4bk3nf0dp2qqqn53j08n8z-homeassistant-test-facebook-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/v5kfmjffik4bk3nf0dp2qqqn53j08n8z-homeassistant-test-facebook-2025.9.4`
