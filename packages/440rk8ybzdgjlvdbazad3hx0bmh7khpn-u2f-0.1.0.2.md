...
- **Name**: `haskellPackages.u2f`
- **Version**: `0.1.0.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Haskell Universal Two Factor helper toolbox library thing
- **Homepage**: [https://hackage.haskell.org/package/u2f](https://hackage.haskell.org/package/u2f)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/440rk8ybzdgjlvdbazad3hx0bmh7khpn-u2f-0.1.0.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:692900`
- **Outputs**:
  - `doc`:  `/nix/store/440rk8ybzdgjlvdbazad3hx0bmh7khpn-u2f-0.1.0.2`
  - `out`:  `/nix/store/440rk8ybzdgjlvdbazad3hx0bmh7khpn-u2f-0.1.0.2`
...
- [[9276yv24i9qcpb5jiv8zbr5pmfkv19qk-u2f-0.1.0.2.tar.gz]]
