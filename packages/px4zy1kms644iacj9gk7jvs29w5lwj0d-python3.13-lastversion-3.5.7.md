...
- **Homepage**: [https://github.com/dvershinin/lastversion](https://github.com/dvershinin/lastversion)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/px4zy1kms644iacj9gk7jvs29w5lwj0d-python3.13-lastversion-3.5.7.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/lastversion/default.nix:82`
- **Outputs**:
  - `dist`:  `/nix/store/px4zy1kms644iacj9gk7jvs29w5lwj0d-python3.13-lastversion-3.5.7`
  - `out`:  `/nix/store/px4zy1kms644iacj9gk7jvs29w5lwj0d-python3.13-lastversion-3.5.7`
...
- [[7dwszmdsrmhqagd7l3fgbh949dfvr8a1-source]]
