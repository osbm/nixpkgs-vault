...
- **Derivation Path**: `/nix/store/049i488aima0y8gx0mpyhhsg7l9czcw6-php-session-8.4.12.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/top-level/php-packages.nix:206`
- **Outputs**:
  - `dev`:  `/nix/store/049i488aima0y8gx0mpyhhsg7l9czcw6-php-session-8.4.12`
  - `out`:  `/nix/store/049i488aima0y8gx0mpyhhsg7l9czcw6-php-session-8.4.12`
