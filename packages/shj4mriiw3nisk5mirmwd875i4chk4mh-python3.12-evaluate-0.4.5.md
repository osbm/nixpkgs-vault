...
- **Name**: `python312Packages.evaluate`
- **Version**: `0.4.5`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/shj4mriiw3nisk5mirmwd875i4chk4mh-python3.12-evaluate-0.4.5.drv`
...
- **Outputs**:
  - `dist`:  `/nix/store/shj4mriiw3nisk5mirmwd875i4chk4mh-python3.12-evaluate-0.4.5`
  - `out`:  `/nix/store/shj4mriiw3nisk5mirmwd875i4chk4mh-python3.12-evaluate-0.4.5`
