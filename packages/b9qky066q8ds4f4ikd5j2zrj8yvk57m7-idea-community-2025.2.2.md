...
tags:
  - license/unknown
  - maintainers/edwtjo
  - maintainers/gytis-ivaskevicius
...
IDE for Java SE, Groovy & Scala development Powerful environment for building Google Android apps Integration with JUnit, TestNG, popular SCMs, Ant & Maven. Also known as IntelliJ.

## 📋 Package Information

- **Name**: `jetbrains.idea-community-bin`
- **Version**: `2025.2.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Free Java, Kotlin, Groovy and Scala IDE from jetbrains (patched binaries from jetbrains)
...
- **Derivation Path**: `/nix/store/b9qky066q8ds4f4ikd5j2zrj8yvk57m7-idea-community-2025.2.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/applications/editors/jetbrains/default.nix:54`
- **Outputs**:
  - `out`:  `/nix/store/b9qky066q8ds4f4ikd5j2zrj8yvk57m7-idea-community-2025.2.2`
...
- [[pp1xq7056gkkxaybp0cdq3hqnrb7x3n7-ideaIC-2025.2.2.tar.gz]]
- [[xmkq4zrc5747vl4155kavbb0r1wp4nyp-idea-community.desktop]]
