...
- **Name**: `haskellPackages.gtk-sni-tray`
- **Version**: `0.1.8.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: A standalone StatusNotifierItem/AppIndicator tray
- **Homepage**: [https://hackage.haskell.org/package/gtk-sni-tray](https://hackage.haskell.org/package/gtk-sni-tray)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/mivkzxhq37jypwdfvbl3hv7653iy2np2-gtk-sni-tray-0.1.8.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:286255`
- **Outputs**:
  - `doc`:  `/nix/store/mivkzxhq37jypwdfvbl3hv7653iy2np2-gtk-sni-tray-0.1.8.1`
  - `out`:  `/nix/store/mivkzxhq37jypwdfvbl3hv7653iy2np2-gtk-sni-tray-0.1.8.1`
...
- [[lka7rb94b89qxj7fjsmvbhy34w14x3if-gtk-sni-tray-0.1.8.1.tar.gz]]
...
- [[ngwikr498xwcma5lscs2icc0dhqsrfam-gi-dbusmenugtk3-0.4.16]]
