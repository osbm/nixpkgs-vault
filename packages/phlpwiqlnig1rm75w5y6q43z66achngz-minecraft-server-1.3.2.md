...
- **Name**: `minecraftServers.vanilla-1-3`
- **Version**: `1.3.2`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/phlpwiqlnig1rm75w5y6q43z66achngz-minecraft-server-1.3.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/games/minecraft-servers/derivation.nix:43`
- **Outputs**:
  - `out`:  `/nix/store/phlpwiqlnig1rm75w5y6q43z66achngz-minecraft-server-1.3.2`
...
- [[cpbcvh6s1qvd5xfj8kjhap2k4gwb7pi6-server.jar]]
