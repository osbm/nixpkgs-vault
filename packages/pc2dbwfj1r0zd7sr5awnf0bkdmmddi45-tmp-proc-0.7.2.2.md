...
- **Name**: `haskellPackages.tmp-proc`
- **Version**: `0.7.2.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Run 'tmp' processes in integration tests
- **Homepage**: [https://hackage.haskell.org/package/tmp-proc](https://hackage.haskell.org/package/tmp-proc)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/pc2dbwfj1r0zd7sr5awnf0bkdmmddi45-tmp-proc-0.7.2.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:677918`
- **Outputs**:
  - `data`:  `/nix/store/pc2dbwfj1r0zd7sr5awnf0bkdmmddi45-tmp-proc-0.7.2.2`
  - `doc`:  `/nix/store/pc2dbwfj1r0zd7sr5awnf0bkdmmddi45-tmp-proc-0.7.2.2`
  - `out`:  `/nix/store/pc2dbwfj1r0zd7sr5awnf0bkdmmddi45-tmp-proc-0.7.2.2`
...
- [[7i7nbsx7aafsxcxvzr55mmm96fwsxhml-tmp-proc-0.7.2.2.tar.gz]]
