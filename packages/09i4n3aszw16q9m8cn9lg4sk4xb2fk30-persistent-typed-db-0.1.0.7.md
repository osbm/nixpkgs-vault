...
- **Name**: `haskellPackages.persistent-typed-db`
- **Version**: `0.1.0.7`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Type safe access to multiple database schemata
- **Homepage**: [https://hackage.haskell.org/package/persistent-typed-db](https://hackage.haskell.org/package/persistent-typed-db)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/09i4n3aszw16q9m8cn9lg4sk4xb2fk30-persistent-typed-db-0.1.0.7.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:514505`
- **Outputs**:
  - `doc`:  `/nix/store/09i4n3aszw16q9m8cn9lg4sk4xb2fk30-persistent-typed-db-0.1.0.7`
  - `out`:  `/nix/store/09i4n3aszw16q9m8cn9lg4sk4xb2fk30-persistent-typed-db-0.1.0.7`

## 🔗 Dependencies

- [[0yq8ck0l668g2v794kxpksh6j0baly1a-esqueleto-3.5.14.0]]
- [[0yrz11qijjkr0bd3s76dfbdvgn2inmlg-hspec-discover-2.11.12]]
- [[30j457vfk5wm1mk6fk9m79lpyxsrz5jd-persistent-typed-db-0.1.0.7.tar.gz]]
...
- [[qjc8k496rxfh99nl56i7lqk6p9kkb7p1-persistent-typed-db-0.1.0.7-r2.cabal]]
