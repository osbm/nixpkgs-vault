---
aliases:
  - python312Packages.torchWithoutRocm
tags:
  - license/unknown
...
- **Name**: `python312Packages.torchWithoutRocm`
- **Version**: `2.8.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/01snwzmzl4pm638jnggnzvcdd5m2yq2l-python3.12-torch-2.8.0.drv`
...
- **Outputs**:
  - `cxxdev`:  `/nix/store/01snwzmzl4pm638jnggnzvcdd5m2yq2l-python3.12-torch-2.8.0`
  - `dev`:  `/nix/store/01snwzmzl4pm638jnggnzvcdd5m2yq2l-python3.12-torch-2.8.0`
  - `dist`:  `/nix/store/01snwzmzl4pm638jnggnzvcdd5m2yq2l-python3.12-torch-2.8.0`
  - `lib`:  `/nix/store/01snwzmzl4pm638jnggnzvcdd5m2yq2l-python3.12-torch-2.8.0`
  - `out`:  `/nix/store/01snwzmzl4pm638jnggnzvcdd5m2yq2l-python3.12-torch-2.8.0`
