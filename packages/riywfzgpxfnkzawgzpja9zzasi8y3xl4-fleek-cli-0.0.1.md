...
- **Derivation Path**: `/nix/store/riywfzgpxfnkzawgzpja9zzasi8y3xl4-fleek-cli-0.0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/node-packages/node-packages.nix:52860`
- **Outputs**:
  - `out`:  `/nix/store/riywfzgpxfnkzawgzpja9zzasi8y3xl4-fleek-cli-0.0.1`
