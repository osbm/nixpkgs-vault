---
aliases:
  - androidenv.androidPkgs.all.system-images.v34x.google_apis_playstore.x86_64
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.system-images.v34x.google_apis_playstore.x86_64`
- **Version**: `34-ext10_r01.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/lxi567qp48sm3ax32jhqc35gkaw3j3gi-x86_64-34-ext10_r01.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/lxi567qp48sm3ax32jhqc35gkaw3j3gi-x86_64-34-ext10_r01.zip`
