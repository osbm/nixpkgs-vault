---
aliases:
  - haskellPackages.simple-conduit
tags:
  - broken
  - not-available
  - license/unknown
...
- **Name**: `haskellPackages.simple-conduit`
- **Version**: `0.6.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: A simple streaming I/O library based on monadic folds
- **Homepage**: [https://hackage.haskell.org/package/simple-conduit](https://hackage.haskell.org/package/simple-conduit)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/8hlvqgn6pln02b5wamqjq0609kw6b2dz-simple-conduit-0.6.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:611178`
- **Outputs**:
  - `doc`:  `/nix/store/8hlvqgn6pln02b5wamqjq0609kw6b2dz-simple-conduit-0.6.0`
  - `out`:  `/nix/store/8hlvqgn6pln02b5wamqjq0609kw6b2dz-simple-conduit-0.6.0`
...
- [[a85pcbppswx3pkzxplq1v4siqqvr471s-simple-conduit-0.6.0.tar.gz]]
