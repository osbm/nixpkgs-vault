...
- **Name**: `python312Packages.libpysal`
- **Version**: `4.13.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Library of spatial analysis functions
- **Homepage**: [https://pysal.org/libpysal/](https://pysal.org/libpysal/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/2zbifcwr3nay41qgvh75bdl3gyxq29ip-python3.12-libpysal-4.13.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/libpysal/default.nix:83`
- **Outputs**:
  - `dist`:  `/nix/store/2zbifcwr3nay41qgvh75bdl3gyxq29ip-python3.12-libpysal-4.13.0`
  - `out`:  `/nix/store/2zbifcwr3nay41qgvh75bdl3gyxq29ip-python3.12-libpysal-4.13.0`

## 🔗 Dependencies

- [[4kd1n81g9qg101dfcn5lkkycc431vgj5-python3.12-pandas-2.3.1]]
- [[5rx5iaja9jrxrq6pw0alg2lrn524siai-python3.12-fiona-1.10.1]]
- [[5vsffdi0kgla24ca4l9bv0fxzc7s2qyk-pypa-build-hook.sh]]
- [[6svb0kkd07wk7dl0myyrvkxmm97b2rd5-source]]
