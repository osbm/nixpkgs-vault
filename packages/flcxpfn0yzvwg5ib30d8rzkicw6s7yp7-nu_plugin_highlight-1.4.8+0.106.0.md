...
`nushell` plugin for syntax highlighting

## 📋 Package Information

- **Name**: `nushellPlugins.highlight`
- **Version**: `1.4.8+0.106.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: `nushell` plugin for syntax highlighting
- **Homepage**: [https://github.com/cptpiepmatz/nu-plugin-highlight](https://github.com/cptpiepmatz/nu-plugin-highlight)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/flcxpfn0yzvwg5ib30d8rzkicw6s7yp7-nu_plugin_highlight-1.4.8+0.106.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/shells/nushell/plugins/highlight.nix:32`
- **Outputs**:
  - `out`:  `/nix/store/flcxpfn0yzvwg5ib30d8rzkicw6s7yp7-nu_plugin_highlight-1.4.8+0.106.0`
...
- [[q2iz8cn4lcq0zrfmkfb2ij7lpqnf0siz-nu_plugin_highlight-1.4.8+0.106.0-vendor]]
- [[qi6337yh29r9ppqm262bf6vz0g13451b-cargo-build-hook.sh]]
- [[vrf3cjbzfwhmi96zrna4zhghbz3x665z-source]]
