...
- **Name**: `rPackages.randomUniformForest`
- **Version**: `1.1.6`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/randomUniformForest/](https://cran.r-project.org/web/packages/randomUniformForest/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/13ph0gc3jdm975qsljamz08d03f4m6x3-r-randomUniformForest-1.1.6.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/13ph0gc3jdm975qsljamz08d03f4m6x3-r-randomUniformForest-1.1.6`
...
- [[qc44j2mxr1xk0s7nhjs4b0n3wssq71n5-randomUniformForest_1.1.6.tar.gz]]
