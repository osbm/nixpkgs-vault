...
- **Name**: `haskellPackages.net-spider`
- **Version**: `0.4.3.7`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: A graph database middleware to maintain a time-varying graph
- **Homepage**: [https://hackage.haskell.org/package/net-spider](https://hackage.haskell.org/package/net-spider)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/5qayzcsiyy9j3z9lc3qis68yssa6rmjq-net-spider-0.4.3.7.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:473001`
- **Outputs**:
  - `doc`:  `/nix/store/5qayzcsiyy9j3z9lc3qis68yssa6rmjq-net-spider-0.4.3.7`
  - `out`:  `/nix/store/5qayzcsiyy9j3z9lc3qis68yssa6rmjq-net-spider-0.4.3.7`
...
- [[cxfysb0j3z09yd4wwk33a5xjd5zak6zi-net-spider-0.4.3.7.tar.gz]]
...
- [[y53728xhrgck87fwyyy6zlhrqx2pmrdq-greskell-websocket-1.0.0.4]]
