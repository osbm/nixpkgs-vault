---
aliases:
  - linuxKernel.packages.linux_6_6.apfs
tags:
  - license/unknown
  - maintainers/Luflosi
  - outputs/out
...
- **Name**: `linuxKernel.packages.linux_6_6.apfs`
- **Version**: `0.3.15-6.6.107`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/vfd0arqrd8x2zlg44nzvi7rfm5f5imbw-apfs-0.3.15-6.6.107.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/apfs/default.nix:41`
- **Outputs**:
  - `out`:  `/nix/store/vfd0arqrd8x2zlg44nzvi7rfm5f5imbw-apfs-0.3.15-6.6.107`
