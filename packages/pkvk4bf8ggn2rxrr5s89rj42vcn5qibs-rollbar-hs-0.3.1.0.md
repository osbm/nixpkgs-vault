...
- **Name**: `haskellPackages.rollbar-hs`
- **Version**: `0.3.1.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Core Rollbar data types and APIs
- **Homepage**: [https://hackage.haskell.org/package/rollbar-hs](https://hackage.haskell.org/package/rollbar-hs)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/pkvk4bf8ggn2rxrr5s89rj42vcn5qibs-rollbar-hs-0.3.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:578233`
- **Outputs**:
  - `doc`:  `/nix/store/pkvk4bf8ggn2rxrr5s89rj42vcn5qibs-rollbar-hs-0.3.1.0`
  - `out`:  `/nix/store/pkvk4bf8ggn2rxrr5s89rj42vcn5qibs-rollbar-hs-0.3.1.0`
...
- [[7kkfm4jvps91v9qh97p5yk7mxs136258-rollbar-hs-0.3.1.0.tar.gz]]
