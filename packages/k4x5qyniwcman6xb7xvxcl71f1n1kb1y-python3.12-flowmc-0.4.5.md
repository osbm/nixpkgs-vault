...
- **Name**: `python312Packages.flowmc`
- **Version**: `0.4.5`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Normalizing-flow enhanced sampling package for probabilistic inference in Jax
- **Homepage**: [https://github.com/kazewong/flowMC](https://github.com/kazewong/flowMC)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/k4x5qyniwcman6xb7xvxcl71f1n1kb1y-python3.12-flowmc-0.4.5.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/flowmc/default.nix:63`
- **Outputs**:
  - `dist`:  `/nix/store/k4x5qyniwcman6xb7xvxcl71f1n1kb1y-python3.12-flowmc-0.4.5`
  - `out`:  `/nix/store/k4x5qyniwcman6xb7xvxcl71f1n1kb1y-python3.12-flowmc-0.4.5`
...
- [[ibanz0w581ybbaql0s06zqb4ycnqc4ms-source]]
