...
- **Name**: `rPackages.FeatSeekR`
- **Version**: `1.8.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://bioconductor.org/packages/3.21/bioc/html/FeatSeekR.html](https://bioconductor.org/packages/3.21/bioc/html/FeatSeekR.html)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/h5i4gvl49s2m9m1clkcpmrn42560zirq-r-FeatSeekR-1.8.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/h5i4gvl49s2m9m1clkcpmrn42560zirq-r-FeatSeekR-1.8.0`

## 🔗 Dependencies

- [[6klqixh6v4i01h51099sg4wzkmz5db2w-FeatSeekR_1.8.0.tar.gz]]
