...
- **Name**: `haskellPackages.simple`
- **Version**: `2.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: A minimalist web framework for the WAI server interface
- **Homepage**: [https://hackage.haskell.org/package/simple](https://hackage.haskell.org/package/simple)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/ij67yv2k2agipd71smabqr66f225qbrk-simple-2.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:610703`
- **Outputs**:
  - `data`:  `/nix/store/ij67yv2k2agipd71smabqr66f225qbrk-simple-2.0.0`
  - `doc`:  `/nix/store/ij67yv2k2agipd71smabqr66f225qbrk-simple-2.0.0`
  - `out`:  `/nix/store/ij67yv2k2agipd71smabqr66f225qbrk-simple-2.0.0`
...
- [[l8p5c7jmfqz43rvzcsrsv1q02yj9qsx2-simple-2.0.0.tar.gz]]
