---
aliases:
  - androidenv.androidPkgs.all.addons.v10.google_apis
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.addons.v10.google_apis`
- **Version**: `10_r02.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/0lfyy0v13p7s11n891riqjnx9rdlvr05-google_apis-10_r02.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/0lfyy0v13p7s11n891riqjnx9rdlvr05-google_apis-10_r02.zip`
