...
- **Name**: `python313Packages.pyenphase`
- **Version**: `2.3.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Library to control enphase envoy
- **Homepage**: [https://github.com/pyenphase/pyenphase](https://github.com/pyenphase/pyenphase)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/bikj623cg391zg8a4rvw56nicn3c978k-python3.13-pyenphase-2.3.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/pyenphase/default.nix:69`
- **Outputs**:
  - `dist`:  `/nix/store/bikj623cg391zg8a4rvw56nicn3c978k-python3.13-pyenphase-2.3.1`
  - `out`:  `/nix/store/bikj623cg391zg8a4rvw56nicn3c978k-python3.13-pyenphase-2.3.1`
...
- [[g89qb0dzm0gv8j6j362qkgljj5g3abln-python3.13-envoy-utils-0.0.1]]
...
- [[y7gblvdib6cjjgc10b6rcs8ilppck1sf-source]]
