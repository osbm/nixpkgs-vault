...
- **Name**: `haskellPackages.arpack`
- **Version**: `0.1.0.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Solve large scale eigenvalue problems
- **Homepage**: [https://hackage.haskell.org/package/arpack](https://hackage.haskell.org/package/arpack)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/m3qmcsg2kbbysn60s7jipdawsj9pckaf-arpack-0.1.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:83338`
- **Outputs**:
  - `doc`:  `/nix/store/m3qmcsg2kbbysn60s7jipdawsj9pckaf-arpack-0.1.0.0`
  - `out`:  `/nix/store/m3qmcsg2kbbysn60s7jipdawsj9pckaf-arpack-0.1.0.0`
...
- [[ig8c3aziczxfyhrbfwma9930j19jmhwn-arpack-0.1.0.0.tar.gz]]
