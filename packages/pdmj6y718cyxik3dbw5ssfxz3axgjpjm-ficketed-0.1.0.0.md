...
- **Name**: `haskellPackages.ficketed`
- **Version**: `0.1.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: update statically hosted file in a push stule through socketed
- **Homepage**: [https://hackage.haskell.org/package/ficketed](https://hackage.haskell.org/package/ficketed)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/pdmj6y718cyxik3dbw5ssfxz3axgjpjm-ficketed-0.1.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:232421`
- **Outputs**:
  - `doc`:  `/nix/store/pdmj6y718cyxik3dbw5ssfxz3axgjpjm-ficketed-0.1.0.0`
  - `out`:  `/nix/store/pdmj6y718cyxik3dbw5ssfxz3axgjpjm-ficketed-0.1.0.0`
...
- [[rrxg0szdqw8pin0ss0ff07ly93q99c3s-ficketed-0.1.0.0.tar.gz]]
