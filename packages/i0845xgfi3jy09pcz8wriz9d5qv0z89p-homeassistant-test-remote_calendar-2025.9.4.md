---
aliases:
  - home-assistant-component-tests.remote_calendar
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.remote_calendar`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/i0845xgfi3jy09pcz8wriz9d5qv0z89p-homeassistant-test-remote_calendar-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/i0845xgfi3jy09pcz8wriz9d5qv0z89p-homeassistant-test-remote_calendar-2025.9.4`
