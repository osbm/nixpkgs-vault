---
aliases:
  - haskellPackages.kubernetes-api
tags:
  - license/unknown
  - outputs/doc
  - outputs/out
...
- **Name**: `haskellPackages.kubernetes-api`
- **Version**: `132.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Auto-generated kubernetes-api API Client
- **Homepage**: [https://hackage.haskell.org/package/kubernetes-api](https://hackage.haskell.org/package/kubernetes-api)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/20ddfdrhv0kw1d78rxmpwwigcf2pv69h-kubernetes-api-132.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:403131`
- **Outputs**:
  - `doc`:  `/nix/store/20ddfdrhv0kw1d78rxmpwwigcf2pv69h-kubernetes-api-132.0.0`
  - `out`:  `/nix/store/20ddfdrhv0kw1d78rxmpwwigcf2pv69h-kubernetes-api-132.0.0`
...
- [[5s0kfh334lzh44yjrlwjx6jsij7pdlm2-kubernetes-api-132.0.0.tar.gz]]
