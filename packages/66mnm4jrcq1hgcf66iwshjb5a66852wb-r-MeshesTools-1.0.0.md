...
- **Name**: `rPackages.MeshesTools`
- **Version**: `1.0.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://cran.r-project.org/web/packages/MeshesTools/](https://cran.r-project.org/web/packages/MeshesTools/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/66mnm4jrcq1hgcf66iwshjb5a66852wb-r-MeshesTools-1.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/66mnm4jrcq1hgcf66iwshjb5a66852wb-r-MeshesTools-1.0.0`
...
- [[n4pwcn7hras2z40vvjrzh980q8spxyvz-MeshesTools_1.0.0.tar.gz]]
