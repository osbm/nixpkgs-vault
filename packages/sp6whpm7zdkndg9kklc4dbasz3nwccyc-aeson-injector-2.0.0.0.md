---
aliases:
  - haskellPackages.aeson-injector
tags:
  - broken
  - not-available
  - license/unknown
...
- **Name**: `haskellPackages.aeson-injector`
- **Version**: `2.0.0.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Injecting fields into aeson values
- **Homepage**: [https://hackage.haskell.org/package/aeson-injector](https://hackage.haskell.org/package/aeson-injector)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/sp6whpm7zdkndg9kklc4dbasz3nwccyc-aeson-injector-2.0.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:54688`
- **Outputs**:
  - `doc`:  `/nix/store/sp6whpm7zdkndg9kklc4dbasz3nwccyc-aeson-injector-2.0.0.0`
  - `out`:  `/nix/store/sp6whpm7zdkndg9kklc4dbasz3nwccyc-aeson-injector-2.0.0.0`
...
- [[b5dvfs0n51dfzbzwdisb9dws59apqbj5-aeson-injector-2.0.0.0.tar.gz]]
