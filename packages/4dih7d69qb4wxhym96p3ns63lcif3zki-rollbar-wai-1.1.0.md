...
- **Name**: `haskellPackages.rollbar-wai`
- **Version**: `1.1.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Provides error reporting capabilities to WAI based applications through Rollbar API
- **Homepage**: [https://hackage.haskell.org/package/rollbar-wai](https://hackage.haskell.org/package/rollbar-wai)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/4dih7d69qb4wxhym96p3ns63lcif3zki-rollbar-wai-1.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:578290`
- **Outputs**:
  - `doc`:  `/nix/store/4dih7d69qb4wxhym96p3ns63lcif3zki-rollbar-wai-1.1.0`
  - `out`:  `/nix/store/4dih7d69qb4wxhym96p3ns63lcif3zki-rollbar-wai-1.1.0`
...
- [[gggh1mr5gl95vzr7bw204a31w5ahviri-rollbar-wai-1.1.0.tar.gz]]
