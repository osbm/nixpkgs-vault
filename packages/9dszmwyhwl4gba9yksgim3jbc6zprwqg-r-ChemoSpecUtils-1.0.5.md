...
- **Name**: `rPackages.ChemoSpecUtils`
- **Version**: `1.0.5`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/ChemoSpecUtils/](https://cran.r-project.org/web/packages/ChemoSpecUtils/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/9dszmwyhwl4gba9yksgim3jbc6zprwqg-r-ChemoSpecUtils-1.0.5.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/9dszmwyhwl4gba9yksgim3jbc6zprwqg-r-ChemoSpecUtils-1.0.5`
...
- [[m93k8nc5xzz2a6gl4yzmbc22ic2knc6q-ChemoSpecUtils_1.0.5.tar.gz]]
