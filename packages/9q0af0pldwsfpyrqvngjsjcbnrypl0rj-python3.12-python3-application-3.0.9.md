---
aliases:
  - python312Packages.python3-application
tags:
  - license/unknown
...
- **Name**: `python312Packages.python3-application`
- **Version**: `3.0.9`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Collection of modules that are useful when building python applications
- **Homepage**: [https://github.com/AGProjects/python3-application](https://github.com/AGProjects/python3-application)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/9q0af0pldwsfpyrqvngjsjcbnrypl0rj-python3.12-python3-application-3.0.9.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/python3-application/default.nix:37`
- **Outputs**:
  - `dist`:  `/nix/store/9q0af0pldwsfpyrqvngjsjcbnrypl0rj-python3.12-python3-application-3.0.9`
  - `out`:  `/nix/store/9q0af0pldwsfpyrqvngjsjcbnrypl0rj-python3.12-python3-application-3.0.9`
...
- [[by7khirbf48lzycfn6mddhnmdadxzq43-source]]
