...
- **Name**: `haskellPackages.yesod-routes-flow`
- **Version**: `3.0.0.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Generate Flow routes for Yesod
- **Homepage**: [https://hackage.haskell.org/package/yesod-routes-flow](https://hackage.haskell.org/package/yesod-routes-flow)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/9i555gjvrwj9q8hdp4m7fnxzkii5dfhi-yesod-routes-flow-3.0.0.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:742261`
- **Outputs**:
  - `doc`:  `/nix/store/9i555gjvrwj9q8hdp4m7fnxzkii5dfhi-yesod-routes-flow-3.0.0.2`
  - `out`:  `/nix/store/9i555gjvrwj9q8hdp4m7fnxzkii5dfhi-yesod-routes-flow-3.0.0.2`

## 🔗 Dependencies

- [[0sla2ha6kb6fwhizkbgwvl83hmxv31i7-shakespeare-2.1.4]]
- [[45wky4h8vdpjfgbfywky6wd460dcnk82-hspec-2.11.12]]
- [[4imdgj8r9ydvzp75rhwpxd8mvjk6lgkw-yesod-routes-flow-3.0.0.2.tar.gz]]
