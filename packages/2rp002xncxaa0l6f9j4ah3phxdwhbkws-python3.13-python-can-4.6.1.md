...
- **Name**: `python313Packages.python-can`
- **Version**: `4.6.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: CAN support for Python
- **Homepage**: [https://python-can.readthedocs.io](https://python-can.readthedocs.io)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/2rp002xncxaa0l6f9j4ah3phxdwhbkws-python3.13-python-can-4.6.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/python-can/default.nix:91`
- **Outputs**:
  - `dist`:  `/nix/store/2rp002xncxaa0l6f9j4ah3phxdwhbkws-python3.13-python-can-4.6.1`
  - `out`:  `/nix/store/2rp002xncxaa0l6f9j4ah3phxdwhbkws-python3.13-python-can-4.6.1`
...
- [[in1lb1q6116n8disi62cpwc2w68yaqfm-source]]
