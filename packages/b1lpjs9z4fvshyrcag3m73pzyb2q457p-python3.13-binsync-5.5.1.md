...
Reversing plugin for cross-decompiler collaboration, built on git

## 📋 Package Information

- **Name**: `python313Packages.binsync`
- **Version**: `5.5.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Reversing plugin for cross-decompiler collaboration, built on git
- **Homepage**: [https://github.com/binsync/binsync](https://github.com/binsync/binsync)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/b1lpjs9z4fvshyrcag3m73pzyb2q457p-python3.13-binsync-5.5.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/binsync/default.nix:62`
- **Outputs**:
  - `dist`:  `/nix/store/b1lpjs9z4fvshyrcag3m73pzyb2q457p-python3.13-binsync-5.5.1`
  - `out`:  `/nix/store/b1lpjs9z4fvshyrcag3m73pzyb2q457p-python3.13-binsync-5.5.1`

## 🔗 Dependencies

- [[06a2j9jv7f40ihnra63q0xx99ry62h35-python-imports-check-hook.sh]]
- [[257k0vnqp1xjgyrpc5as1r0nl7s4yv71-python3-3.13.7]]
- [[2974f20xw85bzmkahm1rb1rwg34j1pha-source]]
...
- [[qskpf6l5cqz91ld59rizydsd47zaxivb-python3.13-libbs-2.15.4]]
