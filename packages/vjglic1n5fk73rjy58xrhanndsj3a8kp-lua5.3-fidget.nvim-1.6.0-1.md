...
- **Name**: `lua53Packages.fidget-nvim`
- **Version**: `1.6.0-1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/vjglic1n5fk73rjy58xrhanndsj3a8kp-lua5.3-fidget.nvim-1.6.0-1.drv`
...
- **Outputs**:
  - `out`:  `/nix/store/vjglic1n5fk73rjy58xrhanndsj3a8kp-lua5.3-fidget.nvim-1.6.0-1`
...
- [[v9saydrxyb9gzg42p9gykp991idlgqi3-fidget.nvim-luarocks-config.lua]]
