...
- **Name**: `python312Packages.avwx-engine`
- **Version**: `1.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Aviation Weather parsing engine
- **Homepage**: [https://github.com/avwx-rest/avwx-engine](https://github.com/avwx-rest/avwx-engine)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/xkgvnf3sas0ffh92yqqfyxzgjisbdc6y-python3.12-avwx-engine-1.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/avwx-engine/default.nix:77`
- **Outputs**:
  - `dist`:  `/nix/store/xkgvnf3sas0ffh92yqqfyxzgjisbdc6y-python3.12-avwx-engine-1.9.4`
  - `out`:  `/nix/store/xkgvnf3sas0ffh92yqqfyxzgjisbdc6y-python3.12-avwx-engine-1.9.4`
...
- [[kyqd7dwv9xssp69nlbzdjhcqljsywafj-source]]
