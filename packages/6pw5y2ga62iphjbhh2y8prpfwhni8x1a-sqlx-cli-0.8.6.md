...
CLI for managing databases, migrations, and enabling offline mode with `sqlx::query!()` and friends
...
- **Homepage**: [https://github.com/launchbadge/sqlx](https://github.com/launchbadge/sqlx)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/6pw5y2ga62iphjbhh2y8prpfwhni8x1a-sqlx-cli-0.8.6.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/sq/sqlx-cli/package.nix:68`
- **Outputs**:
  - `out`:  `/nix/store/6pw5y2ga62iphjbhh2y8prpfwhni8x1a-sqlx-cli-0.8.6`
...
- [[ijkb60hjd7c9sdj3rgr0hnw8dsqyqcyn-source]]
- [[lvdvlk7cwad5mna0wfpz8jllb30jdj1n-pkg-config-wrapper-0.29.2]]
- [[nr5nfa70i1ybmkd4vrsp1404502k49j5-sqlx-cli-0.8.6-vendor]]
