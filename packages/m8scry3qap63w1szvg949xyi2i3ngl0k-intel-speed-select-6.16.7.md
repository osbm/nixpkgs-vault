...
- **Name**: `linuxKernel.packages.linux_lqx.intel-speed-select`
- **Version**: `6.16.7`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
...
- **Derivation Path**: `/nix/store/m8scry3qap63w1szvg949xyi2i3ngl0k-intel-speed-select-6.16.7.drv`
...
- **Outputs**:
  - `out`:  `/nix/store/m8scry3qap63w1szvg949xyi2i3ngl0k-intel-speed-select-6.16.7`
