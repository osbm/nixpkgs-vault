...
- **Name**: `python313Packages.dbt-postgres`
- **Version**: `1.9.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/dqxxl0k4whflbanq5j0c8myz6mmp1brn-python3.13-dbt-postgres-1.9.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/dbt-postgres/default.nix:46`
- **Outputs**:
  - `dist`:  `/nix/store/dqxxl0k4whflbanq5j0c8myz6mmp1brn-python3.13-dbt-postgres-1.9.0`
  - `out`:  `/nix/store/dqxxl0k4whflbanq5j0c8myz6mmp1brn-python3.13-dbt-postgres-1.9.0`
...
- [[bhaq168s00g7jdbyshnb4vvaww6akq05-source]]
