---
aliases:
  - androidenv.androidPkgs.all.packages.emulator.v32_1_15
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.packages.emulator.v32_1_15`
- **Version**: `10696886.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/gsijq1prxb6zbzlbgd5qnzyifcwzrzk6-emulator-linux_x64-10696886.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/gsijq1prxb6zbzlbgd5qnzyifcwzrzk6-emulator-linux_x64-10696886.zip`
