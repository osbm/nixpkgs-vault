---
aliases:
  - python313Packages.python-magnumclient
tags:
  - license/unknown
...
Client library for OpenStack Magnum API

## 📋 Package Information

- **Name**: `python313Packages.python-magnumclient`
- **Version**: `4.9.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Client library for OpenStack Magnum API
- **Homepage**: [https://github.com/openstack/python-magnumclient](https://github.com/openstack/python-magnumclient)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/04ysy4hxg0ixc54c49s8kigvysx5l6ij-python3.13-python-magnumclient-4.9.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/python-magnumclient/default.nix:91`
- **Outputs**:
  - `dist`:  `/nix/store/04ysy4hxg0ixc54c49s8kigvysx5l6ij-python3.13-python-magnumclient-4.9.0`
  - `out`:  `/nix/store/04ysy4hxg0ixc54c49s8kigvysx5l6ij-python3.13-python-magnumclient-4.9.0`
...
- [[lsdsrbnggmg2xlgxba7hap649dc0k77c-source]]
- [[p76r0cwlf6k97ibprrpfd8xw0r8wc3nx-stdenv-linux]]
- [[pdlfx4rmrl87vr9pprnzhwc04d2l7rzc-python3.13-osc-lib-4.2.0]]
- [[q31amkdlw945gfmqcci8n00brh5liiz2-pypa-install-hook]]
- [[rs3h8g5y8rznyb4k64hgvzvp3jgsr5b8-python3.13-requests-2.32.4]]
- [[s8gn25s2qjg9na0laswxwc07mxz1xhyh-python3.13-osprofiler-4.3.0]]
