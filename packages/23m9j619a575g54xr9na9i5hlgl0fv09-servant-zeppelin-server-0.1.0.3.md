---
aliases:
  - haskellPackages.servant-zeppelin-server
tags:
  - license/unknown
  - outputs/doc
  - outputs/out
...
- **Name**: `haskellPackages.servant-zeppelin-server`
- **Version**: `0.1.0.3`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Server library for servant-zeppelin combinators
- **Homepage**: [https://hackage.haskell.org/package/servant-zeppelin-server](https://hackage.haskell.org/package/servant-zeppelin-server)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/23m9j619a575g54xr9na9i5hlgl0fv09-servant-zeppelin-server-0.1.0.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:603419`
- **Outputs**:
  - `doc`:  `/nix/store/23m9j619a575g54xr9na9i5hlgl0fv09-servant-zeppelin-server-0.1.0.3`
  - `out`:  `/nix/store/23m9j619a575g54xr9na9i5hlgl0fv09-servant-zeppelin-server-0.1.0.3`
...
- [[88rxv9fjrr12cvssw9j1fiwbq5204dhp-servant-zeppelin-server-0.1.0.3.tar.gz]]
