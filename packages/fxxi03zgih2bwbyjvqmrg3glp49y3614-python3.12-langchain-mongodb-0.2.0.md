...
- **Name**: `python312Packages.langchain-mongodb`
- **Version**: `0.2.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Integration package connecting MongoDB and LangChain
- **Homepage**: [https://github.com/langchain-ai/langchain/tree/master/libs/partners/mongodb](https://github.com/langchain-ai/langchain/tree/master/libs/partners/mongodb)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/fxxi03zgih2bwbyjvqmrg3glp49y3614-python3.12-langchain-mongodb-0.2.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/langchain-mongodb/default.nix:79`
- **Outputs**:
  - `dist`:  `/nix/store/fxxi03zgih2bwbyjvqmrg3glp49y3614-python3.12-langchain-mongodb-0.2.0`
  - `out`:  `/nix/store/fxxi03zgih2bwbyjvqmrg3glp49y3614-python3.12-langchain-mongodb-0.2.0`
...
- [[lhhx240flcwy0g19828kgzlmn56f6p5m-source]]
- [[m1frhzhcibf9rsp57h5hzw46shk3xahs-python3.12-pytest-asyncio-1.1.0]]
- [[nc3x0d6g7slq1p1y3wlw1sdn13ds3bdb-python3.12-langchain-0.3.72]]
...
---
*Generated on 2025-09-27 12:39:30 UTC*
