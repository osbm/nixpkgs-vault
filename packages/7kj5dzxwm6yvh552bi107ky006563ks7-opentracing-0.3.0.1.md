...
- **Name**: `haskellPackages.opentracing`
- **Version**: `0.3.0.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: OpenTracing for Haskell
- **Homepage**: [https://hackage.haskell.org/package/opentracing](https://hackage.haskell.org/package/opentracing)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/7kj5dzxwm6yvh552bi107ky006563ks7-opentracing-0.3.0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:493118`
- **Outputs**:
  - `doc`:  `/nix/store/7kj5dzxwm6yvh552bi107ky006563ks7-opentracing-0.3.0.1`
  - `out`:  `/nix/store/7kj5dzxwm6yvh552bi107ky006563ks7-opentracing-0.3.0.1`
...
- [[c8d019i44fpc6l0n1qysrcrqhp0pqcs3-opentracing-0.3.0.1.tar.gz]]
