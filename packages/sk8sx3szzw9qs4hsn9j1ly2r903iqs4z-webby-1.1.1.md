...
- **Name**: `haskellPackages.webby`
- **Version**: `1.1.1`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: A super-simple web server framework
- **Homepage**: [https://hackage.haskell.org/package/webby](https://hackage.haskell.org/package/webby)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/sk8sx3szzw9qs4hsn9j1ly2r903iqs4z-webby-1.1.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:719129`
- **Outputs**:
  - `doc`:  `/nix/store/sk8sx3szzw9qs4hsn9j1ly2r903iqs4z-webby-1.1.1`
  - `out`:  `/nix/store/sk8sx3szzw9qs4hsn9j1ly2r903iqs4z-webby-1.1.1`

## 🔗 Dependencies

- [[1a106fmkf16kvjszrm70l29spcrya6y9-webby-1.1.1.tar.gz]]
