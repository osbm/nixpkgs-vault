---
aliases:
  - home-assistant-component-tests.lock
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.lock`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/5pcdxg85l2phkjh6kfl163jlkn3dq2v9-homeassistant-test-lock-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/5pcdxg85l2phkjh6kfl163jlkn3dq2v9-homeassistant-test-lock-2025.9.4`
