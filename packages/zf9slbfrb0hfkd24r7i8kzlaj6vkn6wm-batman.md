...
- **Name**: `bat-extras.batman`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Read system manual pages (man) using bat as the manual page formatter
...
- **Derivation Path**: `/nix/store/zf9slbfrb0hfkd24r7i8kzlaj6vkn6wm-batman.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/tools/misc/bat-extras/modules/batman.nix:10`
- **Outputs**:
  - `out`:  `/nix/store/zf9slbfrb0hfkd24r7i8kzlaj6vkn6wm-batman`
