...
- **Name**: `haskellPackages.gi-poppler`
- **Version**: `0.18.30`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Poppler bindings
- **Homepage**: [https://hackage.haskell.org/package/gi-poppler](https://hackage.haskell.org/package/gi-poppler)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/4ianm8mzmxb1z4djs36db8kj23vmrrjw-gi-poppler-0.18.30.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:266877`
- **Outputs**:
  - `doc`:  `/nix/store/4ianm8mzmxb1z4djs36db8kj23vmrrjw-gi-poppler-0.18.30`
  - `out`:  `/nix/store/4ianm8mzmxb1z4djs36db8kj23vmrrjw-gi-poppler-0.18.30`
...
- [[xcjk3bl4q13xbcsh048i84m1n3arpyap-gi-poppler-0.18.30.tar.gz]]
