...
- **Name**: `rPackages.GiniDistance`
- **Version**: `0.1.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/GiniDistance/](https://cran.r-project.org/web/packages/GiniDistance/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/29vilzpdaqf82shgcxv4jywzlckwq8pb-r-GiniDistance-0.1.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/29vilzpdaqf82shgcxv4jywzlckwq8pb-r-GiniDistance-0.1.1`
...
- [[c5r3a7l6s9msy1ffd5ij8qmhck6w46cl-GiniDistance_0.1.1.tar.gz]]
