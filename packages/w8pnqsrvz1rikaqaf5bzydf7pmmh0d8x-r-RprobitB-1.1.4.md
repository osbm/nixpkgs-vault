...
- **Name**: `rPackages.RprobitB`
- **Version**: `1.1.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/RprobitB/](https://cran.r-project.org/web/packages/RprobitB/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/w8pnqsrvz1rikaqaf5bzydf7pmmh0d8x-r-RprobitB-1.1.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/w8pnqsrvz1rikaqaf5bzydf7pmmh0d8x-r-RprobitB-1.1.4`
...
- [[k8j4nmd9ymsjiqhww6j9y18pfacq5jn0-RprobitB_1.1.4.tar.gz]]
