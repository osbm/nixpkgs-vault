...
- **Name**: `python313Packages.jenkinsapi`
- **Version**: `0.3.15`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/03a7kqfwja9m62g8gjm0p7zxz40hysx8-python3.13-jenkinsapi-0.3.15.drv`
...
- **Outputs**:
  - `dist`:  `/nix/store/03a7kqfwja9m62g8gjm0p7zxz40hysx8-python3.13-jenkinsapi-0.3.15`
  - `out`:  `/nix/store/03a7kqfwja9m62g8gjm0p7zxz40hysx8-python3.13-jenkinsapi-0.3.15`
