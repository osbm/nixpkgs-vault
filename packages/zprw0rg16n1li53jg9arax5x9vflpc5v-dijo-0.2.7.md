...
- **Homepage**: [https://github.com/oppiliappan/dijo](https://github.com/oppiliappan/dijo)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/zprw0rg16n1li53jg9arax5x9vflpc5v-dijo-0.2.7.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/di/dijo/package.nix:22`
- **Outputs**:
  - `out`:  `/nix/store/zprw0rg16n1li53jg9arax5x9vflpc5v-dijo-0.2.7`
...
- [[68dqf08ldb2grya229akdrj79s099k9x-dijo-0.2.7-vendor]]
- [[bjsb6wdjykafnkixq156qdvmxhsm2bai-bash-5.3p3]]
- [[izwvxslrpgji1s39dlcc38rhgf1zp4ka-source]]
