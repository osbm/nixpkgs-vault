...
- **Name**: `haskellPackages.subcategories`
- **Version**: `0.2.1.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Subcategories induced by class constraints
- **Homepage**: [https://hackage.haskell.org/package/subcategories](https://hackage.haskell.org/package/subcategories)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/wdzy6px5lf2737fb2zlis6xsr7214fxn-subcategories-0.2.1.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:644885`
- **Outputs**:
  - `doc`:  `/nix/store/wdzy6px5lf2737fb2zlis6xsr7214fxn-subcategories-0.2.1.1`
  - `out`:  `/nix/store/wdzy6px5lf2737fb2zlis6xsr7214fxn-subcategories-0.2.1.1`
...
- [[pdq16n55w3m80knqa7pslr5r6yi11s6v-subcategories-0.2.1.1.tar.gz]]
