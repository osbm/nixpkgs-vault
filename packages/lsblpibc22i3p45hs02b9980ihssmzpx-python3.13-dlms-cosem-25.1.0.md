...
- **Name**: `python313Packages.dlms-cosem`
- **Version**: `25.1.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/lsblpibc22i3p45hs02b9980ihssmzpx-python3.13-dlms-cosem-25.1.0.drv`
...
- **Outputs**:
  - `dist`:  `/nix/store/lsblpibc22i3p45hs02b9980ihssmzpx-python3.13-dlms-cosem-25.1.0`
  - `out`:  `/nix/store/lsblpibc22i3p45hs02b9980ihssmzpx-python3.13-dlms-cosem-25.1.0`
