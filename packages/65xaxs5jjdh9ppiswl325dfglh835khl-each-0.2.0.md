...
Command-line tool for processing CSV, JSON and other structured data
...
- **Homepage**: [https://github.com/arraypad/each](https://github.com/arraypad/each)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/65xaxs5jjdh9ppiswl325dfglh835khl-each-0.2.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/ea/each/package.nix:21`
- **Outputs**:
  - `out`:  `/nix/store/65xaxs5jjdh9ppiswl325dfglh835khl-each-0.2.0`
...
- [[a8km3di0yga10ya07r9zy5sa27g3gylp-each-0.2.0-vendor]]
- [[bjsb6wdjykafnkixq156qdvmxhsm2bai-bash-5.3p3]]
- [[i2gy62bxzxi01x2cpqq7abiffx7xkjg3-source]]
