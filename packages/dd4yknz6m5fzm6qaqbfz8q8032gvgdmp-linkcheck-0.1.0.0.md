...
- **Name**: `haskellPackages.linkcheck`
- **Version**: `0.1.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Check for broken links in CI
- **Homepage**: [https://hackage.haskell.org/package/linkcheck](https://hackage.haskell.org/package/linkcheck)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/dd4yknz6m5fzm6qaqbfz8q8032gvgdmp-linkcheck-0.1.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:421317`
- **Outputs**:
  - `doc`:  `/nix/store/dd4yknz6m5fzm6qaqbfz8q8032gvgdmp-linkcheck-0.1.0.0`
  - `out`:  `/nix/store/dd4yknz6m5fzm6qaqbfz8q8032gvgdmp-linkcheck-0.1.0.0`
...
- [[rw1i4x546bv58rnd70f0wdx9dxskvnyb-linkcheck-0.1.0.0.tar.gz]]
