...
- **Name**: `haskellPackages.HSmarty`
- **Version**: `0.4.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Small template engine
- **Homepage**: [https://hackage.haskell.org/package/HSmarty](https://hackage.haskell.org/package/HSmarty)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/9vabzv97cgkydipi8fswg1b4a8dbir4b-HSmarty-0.4.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:20264`
- **Outputs**:
  - `data`:  `/nix/store/9vabzv97cgkydipi8fswg1b4a8dbir4b-HSmarty-0.4.2`
  - `doc`:  `/nix/store/9vabzv97cgkydipi8fswg1b4a8dbir4b-HSmarty-0.4.2`
  - `out`:  `/nix/store/9vabzv97cgkydipi8fswg1b4a8dbir4b-HSmarty-0.4.2`

## 🔗 Dependencies

- [[2p5f4ivzq4f1n670xq7xw6vsm2v0pvig-Glob-0.10.2]]
- [[4a2xxy5l5j9jpdwigskmb64j05i58ahb-HSmarty-0.4.2.tar.gz]]
