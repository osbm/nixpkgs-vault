...
- **Name**: `rPackages.purrr`
- **Version**: `1.1.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/purrr/](https://cran.r-project.org/web/packages/purrr/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/6mvy7jqnrh3la9hbkpng9c2iz9rv7x6h-r-purrr-1.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/6mvy7jqnrh3la9hbkpng9c2iz9rv7x6h-r-purrr-1.1.0`

## 🔗 Dependencies

- [[0zmfx1hq9mzs5zw3d6s81rihvlk1278b-purrr_1.1.0.tar.gz]]
