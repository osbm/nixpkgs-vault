...
- **Name**: `haskellPackages.hspec-wai`
- **Version**: `0.11.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Experimental Hspec support for testing WAI applications
- **Homepage**: [https://hackage.haskell.org/package/hspec-wai](https://hackage.haskell.org/package/hspec-wai)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/fwaj0vhnhmacd8yrzycf1r1lva792555-hspec-wai-0.11.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:356447`
- **Outputs**:
  - `doc`:  `/nix/store/fwaj0vhnhmacd8yrzycf1r1lva792555-hspec-wai-0.11.1`
  - `out`:  `/nix/store/fwaj0vhnhmacd8yrzycf1r1lva792555-hspec-wai-0.11.1`
...
- [[q775l61di5vzhifnfhb3i214b2swg87z-hspec-wai-0.11.1.tar.gz]]
