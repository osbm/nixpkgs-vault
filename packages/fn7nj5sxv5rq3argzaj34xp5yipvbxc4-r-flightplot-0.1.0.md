...
- **Name**: `rPackages.flightplot`
- **Version**: `0.1.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/flightplot/](https://cran.r-project.org/web/packages/flightplot/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/fn7nj5sxv5rq3argzaj34xp5yipvbxc4-r-flightplot-0.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/fn7nj5sxv5rq3argzaj34xp5yipvbxc4-r-flightplot-0.1.0`

## 🔗 Dependencies

- [[0ad2p4c4crbxvfhb6gzi3hpgy0fskkbk-flightplot_0.1.0.tar.gz]]
