...
- **Name**: `rPackages.ggplot2`
- **Version**: `3.5.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/ggplot2/](https://cran.r-project.org/web/packages/ggplot2/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/9k9ja7yk27jmqdld2xrl97xipiv3a83p-r-ggplot2-3.5.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/9k9ja7yk27jmqdld2xrl97xipiv3a83p-r-ggplot2-3.5.2`
...
- [[salspjbsicnlvarx0flm2q034wfidq8s-ggplot2_3.5.2.tar.gz]]
