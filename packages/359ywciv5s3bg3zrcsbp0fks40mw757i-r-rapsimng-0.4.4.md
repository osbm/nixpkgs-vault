...
- **Name**: `rPackages.rapsimng`
- **Version**: `0.4.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/rapsimng/](https://cran.r-project.org/web/packages/rapsimng/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/359ywciv5s3bg3zrcsbp0fks40mw757i-r-rapsimng-0.4.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/359ywciv5s3bg3zrcsbp0fks40mw757i-r-rapsimng-0.4.4`
...
- [[gf32d9d6nza7hqfps15y3dr9w42mlrb4-rapsimng_0.4.4.tar.gz]]
