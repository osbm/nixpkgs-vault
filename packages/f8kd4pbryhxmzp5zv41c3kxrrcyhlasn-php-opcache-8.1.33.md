...
- **Name**: `php81Extensions.opcache`
- **Version**: `8.1.33`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: PHP upstream extension: opcache
...
- **Derivation Path**: `/nix/store/f8kd4pbryhxmzp5zv41c3kxrrcyhlasn-php-opcache-8.1.33.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/top-level/php-packages.nix:206`
- **Outputs**:
  - `dev`:  `/nix/store/f8kd4pbryhxmzp5zv41c3kxrrcyhlasn-php-opcache-8.1.33`
  - `out`:  `/nix/store/f8kd4pbryhxmzp5zv41c3kxrrcyhlasn-php-opcache-8.1.33`
