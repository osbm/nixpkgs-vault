---
aliases:
  - home-assistant-component-tests.person
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.person`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/ik17i84k4jgkvsx4zziccdlfqsdbjqwi-homeassistant-test-person-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/ik17i84k4jgkvsx4zziccdlfqsdbjqwi-homeassistant-test-person-2025.9.4`
