...
- **Name**: `haskellPackages.erebos`
- **Version**: `0.1.8.1`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Decentralized messaging and synchronization
- **Homepage**: [https://hackage.haskell.org/package/erebos](https://hackage.haskell.org/package/erebos)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/p4x0llgkdz8y27r1l4sq975i4pzzdvf7-erebos-0.1.8.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:217375`
- **Outputs**:
  - `doc`:  `/nix/store/p4x0llgkdz8y27r1l4sq975i4pzzdvf7-erebos-0.1.8.1`
  - `out`:  `/nix/store/p4x0llgkdz8y27r1l4sq975i4pzzdvf7-erebos-0.1.8.1`
...
- [[gdkimnvypxmnli7bi6ahqyiwywjndjl9-erebos-0.1.8.1.tar.gz]]
