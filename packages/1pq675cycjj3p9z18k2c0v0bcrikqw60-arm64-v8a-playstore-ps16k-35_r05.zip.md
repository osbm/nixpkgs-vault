---
aliases:
  - androidenv.androidPkgs.all.system-images.v35.page_size_16kb.arm64-v8a
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.system-images.v35.page_size_16kb.arm64-v8a`
- **Version**: `35_r05.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/1pq675cycjj3p9z18k2c0v0bcrikqw60-arm64-v8a-playstore-ps16k-35_r05.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/1pq675cycjj3p9z18k2c0v0bcrikqw60-arm64-v8a-playstore-ps16k-35_r05.zip`
