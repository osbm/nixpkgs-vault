...
- **Name**: `emacsPackages.lxc`
- **Version**: `20140410.2022`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://github.com/nicferrier/emacs-lxc](https://github.com/nicferrier/emacs-lxc)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/6a9bfil10l4m7pn5ccxwbhm76b2a2ixy-emacs-lxc-20140410.2022.drv`
...
- **Outputs**:
  - `out`:  `/nix/store/6a9bfil10l4m7pn5ccxwbhm76b2a2ixy-emacs-lxc-20140410.2022`

## 🔗 Dependencies

- [[06q4gl29qsbxvxl4z08l64z4548kx08j-source]]
- [[9p1vja8gcrm3qf5vhzmgqf1iq73xw8aj-lxc-recipe]]
