...
Rust API search engine which allows you to search functions by names and type signatures
...
- **Homepage**: [https://github.com/hkmatsumoto/roogle](https://github.com/hkmatsumoto/roogle)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/jpf9d9gm855axzdcjkd0sg6z22k3rcsk-roogle-1.0.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/ro/roogle/package.nix:21`
- **Outputs**:
  - `out`:  `/nix/store/jpf9d9gm855axzdcjkd0sg6z22k3rcsk-roogle-1.0.2`
...
- [[7pkckd7i84d3dwn1jnna4jxiczp0b9hf-roogle-1.0.2-vendor]]
- [[bjsb6wdjykafnkixq156qdvmxhsm2bai-bash-5.3p3]]
- [[fv29zcsg8sj9y4ynhhz990ig542pv87j-source]]
