...
Command line utility to render templates from json|toml|yaml and ENV, using the tera templating engine
...
- **Homepage**: [https://github.com/chevdor/tera-cli](https://github.com/chevdor/tera-cli)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/vipbi1z826gnjigg2qwzrkr1p7cx6fmr-tera-cli-0.5.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/te/tera-cli/package.nix:23`
- **Outputs**:
  - `out`:  `/nix/store/vipbi1z826gnjigg2qwzrkr1p7cx6fmr-tera-cli-0.5.0`
...
- [[8yixaynvjxaja5ipm03vaz90xyh1m8z6-source]]
- [[bjsb6wdjykafnkixq156qdvmxhsm2bai-bash-5.3p3]]
- [[i4yh1j1l0mf4yg3abv1iw1b5n43bx4pf-tera-cli-0.5.0-vendor]]
