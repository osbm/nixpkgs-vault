...
- **Name**: `python312Packages.lancedb`
- **Version**: `0.21.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Developer-friendly, serverless vector database for AI applications
- **Homepage**: [https://github.com/lancedb/lancedb](https://github.com/lancedb/lancedb)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/nyzk4wyxsp8phxd30njmfvds10sm2mpn-python3.12-lancedb-0.21.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/lancedb/default.nix:124`
- **Outputs**:
  - `dist`:  `/nix/store/nyzk4wyxsp8phxd30njmfvds10sm2mpn-python3.12-lancedb-0.21.2`
  - `out`:  `/nix/store/nyzk4wyxsp8phxd30njmfvds10sm2mpn-python3.12-lancedb-0.21.2`
...
- [[58svln9196yr1l2f1ckgscygfydmc2v9-lancedb-0.21.2-vendor]]
...
- [[f3vpfv4mc5vjwqchbla6ywijclz5b4ga-source]]
...
- [[wla379piq42sfxgr8rwdhj0gcwcbix7l-python3.12-pylance-0.37.0]]
