...
- **Name**: `python312Packages.omemo`
- **Version**: `2.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Open python implementation of the OMEMO Multi-End Message and Object Encryption protocol
- **Homepage**: [https://github.com/Syndace/python-omemo](https://github.com/Syndace/python-omemo)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/jjf11p0wiazm7ashb9lzanaqsa8phll9-python3.12-omemo-2.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/omemo/default.nix:63`
- **Outputs**:
  - `dist`:  `/nix/store/jjf11p0wiazm7ashb9lzanaqsa8phll9-python3.12-omemo-2.0.0`
  - `out`:  `/nix/store/jjf11p0wiazm7ashb9lzanaqsa8phll9-python3.12-omemo-2.0.0`

## 🔗 Dependencies

- [[40z77wd3bldsn4kdg9wink84nnipmm9g-source]]
