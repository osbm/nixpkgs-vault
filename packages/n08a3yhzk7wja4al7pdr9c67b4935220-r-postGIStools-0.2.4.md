...
- **Name**: `rPackages.postGIStools`
- **Version**: `0.2.4`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://cran.r-project.org/web/packages/postGIStools/](https://cran.r-project.org/web/packages/postGIStools/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/n08a3yhzk7wja4al7pdr9c67b4935220-r-postGIStools-0.2.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/n08a3yhzk7wja4al7pdr9c67b4935220-r-postGIStools-0.2.4`
...
- [[vl8mc9sgp8g1g2871jnqwxfikv90lmpk-postGIStools_0.2.4.tar.gz]]
