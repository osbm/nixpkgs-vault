...
- **Name**: `rPackages.diffuStats`
- **Version**: `1.28.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://bioconductor.org/packages/3.21/bioc/html/diffuStats.html](https://bioconductor.org/packages/3.21/bioc/html/diffuStats.html)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/m8iqzrv1b8svs9jvn5vjjzak08mcjm1q-r-diffuStats-1.28.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/m8iqzrv1b8svs9jvn5vjjzak08mcjm1q-r-diffuStats-1.28.0`
