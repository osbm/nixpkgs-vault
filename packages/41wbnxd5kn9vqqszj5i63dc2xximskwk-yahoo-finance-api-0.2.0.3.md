---
aliases:
  - haskellPackages.yahoo-finance-api
tags:
  - broken
  - not-available
  - license/unknown
...
- **Name**: `haskellPackages.yahoo-finance-api`
- **Version**: `0.2.0.3`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Read quotes from Yahoo Finance API
- **Homepage**: [https://hackage.haskell.org/package/yahoo-finance-api](https://hackage.haskell.org/package/yahoo-finance-api)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/41wbnxd5kn9vqqszj5i63dc2xximskwk-yahoo-finance-api-0.2.0.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:734746`
- **Outputs**:
  - `doc`:  `/nix/store/41wbnxd5kn9vqqszj5i63dc2xximskwk-yahoo-finance-api-0.2.0.3`
  - `out`:  `/nix/store/41wbnxd5kn9vqqszj5i63dc2xximskwk-yahoo-finance-api-0.2.0.3`
...
- [[jnhmwn3vbw4lwnz6wdxd37ly5nah1mga-yahoo-finance-api-0.2.0.3.tar.gz]]
