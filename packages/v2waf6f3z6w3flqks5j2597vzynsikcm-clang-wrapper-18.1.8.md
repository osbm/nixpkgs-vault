...
- **Name**: `llvmPackages_18.libcxxClang`
- **Version**: `18.1.8`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/v2waf6f3z6w3flqks5j2597vzynsikcm-clang-wrapper-18.1.8.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/build-support/cc-wrapper/default.nix:989`
- **Outputs**:
  - `out`:  `/nix/store/v2waf6f3z6w3flqks5j2597vzynsikcm-clang-wrapper-18.1.8`
