---
aliases:
  - androidenv.androidPkgs.all.addons.v19.google_apis
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.addons.v19.google_apis`
- **Version**: `19_r20.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/lhch0gxfg9s4pn6srhcia1qdhz77867g-google_apis-19_r20.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/lhch0gxfg9s4pn6srhcia1qdhz77867g-google_apis-19_r20.zip`
