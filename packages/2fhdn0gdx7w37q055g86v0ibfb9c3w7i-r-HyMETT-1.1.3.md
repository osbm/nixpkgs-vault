...
- **Name**: `rPackages.HyMETT`
- **Version**: `1.1.3`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/HyMETT/](https://cran.r-project.org/web/packages/HyMETT/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/2fhdn0gdx7w37q055g86v0ibfb9c3w7i-r-HyMETT-1.1.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/2fhdn0gdx7w37q055g86v0ibfb9c3w7i-r-HyMETT-1.1.3`

## 🔗 Dependencies

- [[3hxhp1gzfpvzf14bwwdg6hhxlrrgzdyk-r-checkmate-2.3.2]]
- [[9gav9w787ncmljdn6g0i0p65yrjcldmc-HyMETT_1.1.3.tar.gz]]
