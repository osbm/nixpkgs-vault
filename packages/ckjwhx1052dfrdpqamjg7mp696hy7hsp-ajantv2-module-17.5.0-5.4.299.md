---
aliases:
  - linuxKernel.packages.linux_5_4.ajantv2
tags:
  - license/unknown
  - maintainers/lukegb
  - outputs/out
...
- **Name**: `linuxKernel.packages.linux_5_4.ajantv2`
- **Version**: `17.5.0-5.4.299`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/ckjwhx1052dfrdpqamjg7mp696hy7hsp-ajantv2-module-17.5.0-5.4.299.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/ajantv2/default.nix:45`
- **Outputs**:
  - `out`:  `/nix/store/ckjwhx1052dfrdpqamjg7mp696hy7hsp-ajantv2-module-17.5.0-5.4.299`
