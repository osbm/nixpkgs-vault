...
- **Homepage**: [https://git.asonix.dog/asonix/pict-rs](https://git.asonix.dog/asonix/pict-rs)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/spq76yp5wwq9c01m0733nmavc6ymnp46-pict-rs-0.5.19.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/pi/pict-rs/package.nix:49`
- **Outputs**:
  - `out`:  `/nix/store/spq76yp5wwq9c01m0733nmavc6ymnp46-pict-rs-0.5.19`
...
- [[m4zzlgdazk3vfklyqwnasfp4hjlqgd39-pict-rs-0.5.19-vendor]]
- [[mnrj2sc47x22c3hzxiifjlyacdxl7kkf-source]]
