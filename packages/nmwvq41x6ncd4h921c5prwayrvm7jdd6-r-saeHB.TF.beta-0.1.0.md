...
- **Name**: `rPackages.saeHB_TF_beta`
- **Version**: `0.1.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/saeHB.TF.beta/](https://cran.r-project.org/web/packages/saeHB.TF.beta/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/nmwvq41x6ncd4h921c5prwayrvm7jdd6-r-saeHB.TF.beta-0.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/nmwvq41x6ncd4h921c5prwayrvm7jdd6-r-saeHB.TF.beta-0.1.0`

## 🔗 Dependencies

- [[0z557z2xnangv23dr4gdhs23h097ibg4-saeHB.TF.beta_0.1.0.tar.gz]]
