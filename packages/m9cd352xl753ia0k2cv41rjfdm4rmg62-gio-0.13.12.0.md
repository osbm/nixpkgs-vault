...
- **Name**: `haskellPackages.gio`
- **Version**: `0.13.12.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Binding to GIO
- **Homepage**: [https://hackage.haskell.org/package/gio](https://hackage.haskell.org/package/gio)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/m9cd352xl753ia0k2cv41rjfdm4rmg62-gio-0.13.12.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:268192`
- **Outputs**:
  - `data`:  `/nix/store/m9cd352xl753ia0k2cv41rjfdm4rmg62-gio-0.13.12.0`
  - `doc`:  `/nix/store/m9cd352xl753ia0k2cv41rjfdm4rmg62-gio-0.13.12.0`
  - `out`:  `/nix/store/m9cd352xl753ia0k2cv41rjfdm4rmg62-gio-0.13.12.0`
...
- [[fclab0r5z7fwzvqq4ljl9v3fhdafznh8-gio-0.13.12.0.tar.gz]]
