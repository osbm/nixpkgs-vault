---
aliases:
  - python312Packages.sphinx-autoapi
tags:
  - license/unknown
  - outputs/dist
  - outputs/out
...
- **Name**: `python312Packages.sphinx-autoapi`
- **Version**: `3.6.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/lgs73mxfvny98s60pxilhhzmcl6a374c-python3.12-sphinx-autoapi-3.6.0.drv`
...
- **Outputs**:
  - `dist`:  `/nix/store/lgs73mxfvny98s60pxilhhzmcl6a374c-python3.12-sphinx-autoapi-3.6.0`
  - `out`:  `/nix/store/lgs73mxfvny98s60pxilhhzmcl6a374c-python3.12-sphinx-autoapi-3.6.0`
