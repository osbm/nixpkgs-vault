...
- **Name**: `rPackages.benchmarkme`
- **Version**: `1.0.8`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/benchmarkme/](https://cran.r-project.org/web/packages/benchmarkme/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/srxhdvnibsvcxgpighzwrvyjgks5ldad-r-benchmarkme-1.0.8.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/srxhdvnibsvcxgpighzwrvyjgks5ldad-r-benchmarkme-1.0.8`

## 🔗 Dependencies

- [[3ilg3305g063yihcyk1j6xvy3q31336v-benchmarkme_1.0.8.tar.gz]]
...
- [[fpgcldz2c693w3mn3bg70yqc9wzldm57-r-benchmarkmeData-1.0.4]]
