---
aliases:
  - python313Packages.python-designateclient
tags:
  - license/unknown
...
Client library for OpenStack Designate API

## 📋 Package Information

- **Name**: `python313Packages.python-designateclient`
- **Version**: `6.3.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Client library for OpenStack Designate API
- **Homepage**: [https://opendev.org/openstack/python-designateclient](https://opendev.org/openstack/python-designateclient)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/jwvqzql3r6l83qqba19y5b3nfsx6i607-python3.13-python-designateclient-6.3.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/python-designateclient/default.nix:78`
- **Outputs**:
  - `dist`:  `/nix/store/jwvqzql3r6l83qqba19y5b3nfsx6i607-python3.13-python-designateclient-6.3.0`
  - `out`:  `/nix/store/jwvqzql3r6l83qqba19y5b3nfsx6i607-python3.13-python-designateclient-6.3.0`
...
- [[dq35jaqsvyn3wgj10c3kvg1nk8l7b2nq-source]]
