...
- **Name**: `rPackages.netboxr`
- **Version**: `1.9.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://bioconductor.org/packages/3.21/bioc/html/netboxr.html](https://bioconductor.org/packages/3.21/bioc/html/netboxr.html)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/5awhad9xhpx0padwisx820hlpybibzvs-r-netboxr-1.9.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/5awhad9xhpx0padwisx820hlpybibzvs-r-netboxr-1.9.0`

## 🔗 Dependencies

- [[3d1zg63m7x6a972rwcfljks0pr53vz0r-netboxr_1.9.0.tar.gz]]
