...
- **Name**: `python312Packages.noisereduce`
- **Version**: `3.0.3`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/pxcn3s62arp148jawy6ic1d0qh6fs2g5-python3.12-noisereduce-3.0.3.drv`
...
- **Outputs**:
  - `dist`:  `/nix/store/pxcn3s62arp148jawy6ic1d0qh6fs2g5-python3.12-noisereduce-3.0.3`
  - `out`:  `/nix/store/pxcn3s62arp148jawy6ic1d0qh6fs2g5-python3.12-noisereduce-3.0.3`
