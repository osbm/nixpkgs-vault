...
- **Homepage**: [https://github.com/franccesco/getaltname](https://github.com/franccesco/getaltname)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/60d6gbrk6kg0ahwhxap536m9qyab9yvy-gsan-5.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/gs/gsan/package.nix:35`
- **Outputs**:
  - `dist`:  `/nix/store/60d6gbrk6kg0ahwhxap536m9qyab9yvy-gsan-5.0.0`
  - `out`:  `/nix/store/60d6gbrk6kg0ahwhxap536m9qyab9yvy-gsan-5.0.0`
...
- [[lawkn01nwawh1kmimash820zsdrxxvk4-source]]
