...
Tools and language server for Postgres
...
- **Homepage**: [https://pgtools.dev](https://pgtools.dev)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/srlvcjxg7p7frdag5rfyag1b3zcjzfia-postgres-lsp-0.13.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/po/postgres-lsp/package.nix:47`
- **Outputs**:
  - `out`:  `/nix/store/srlvcjxg7p7frdag5rfyag1b3zcjzfia-postgres-lsp-0.13.0`
...
- [[n3d1cawml90a8d71b01ldk3fxg7sm6v0-postgres-lsp-0.13.0-vendor]]
- [[p76r0cwlf6k97ibprrpfd8xw0r8wc3nx-stdenv-linux]]
- [[plbiln66yirxjrc7i4p26xmfb4vzk8ja-source]]
