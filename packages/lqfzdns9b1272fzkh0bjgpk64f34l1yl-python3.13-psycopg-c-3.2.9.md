...
- **Name**: `python313Packages.psycopg-c`
- **Version**: `3.2.9`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/lqfzdns9b1272fzkh0bjgpk64f34l1yl-python3.13-psycopg-c-3.2.9.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/psycopg/default.nix:91`
- **Outputs**:
  - `dist`:  `/nix/store/lqfzdns9b1272fzkh0bjgpk64f34l1yl-python3.13-psycopg-c-3.2.9`
  - `out`:  `/nix/store/lqfzdns9b1272fzkh0bjgpk64f34l1yl-python3.13-psycopg-c-3.2.9`
