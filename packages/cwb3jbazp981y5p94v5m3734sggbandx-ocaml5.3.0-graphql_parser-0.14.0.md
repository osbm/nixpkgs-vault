...
- **Name**: `ocamlPackages.graphql_parser`
- **Version**: `0.14.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/cwb3jbazp981y5p94v5m3734sggbandx-ocaml5.3.0-graphql_parser-0.14.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/ocaml-modules/graphql/parser.nix:35`
- **Outputs**:
  - `out`:  `/nix/store/cwb3jbazp981y5p94v5m3734sggbandx-ocaml5.3.0-graphql_parser-0.14.0`
