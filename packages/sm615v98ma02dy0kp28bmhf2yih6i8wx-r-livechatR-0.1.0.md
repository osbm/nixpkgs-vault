...
- **Name**: `rPackages.livechatR`
- **Version**: `0.1.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://cran.r-project.org/web/packages/livechatR/](https://cran.r-project.org/web/packages/livechatR/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/sm615v98ma02dy0kp28bmhf2yih6i8wx-r-livechatR-0.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/sm615v98ma02dy0kp28bmhf2yih6i8wx-r-livechatR-0.1.0`
...
- [[nvnar1z8k4c3cdk35xllnyvkbw1vvalb-livechatR_0.1.0.tar.gz]]
