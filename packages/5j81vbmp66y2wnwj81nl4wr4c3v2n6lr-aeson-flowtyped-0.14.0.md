---
aliases:
  - haskellPackages.aeson-flowtyped
tags:
  - broken
  - not-available
  - license/unknown
...
- **Name**: `haskellPackages.aeson-flowtyped`
- **Version**: `0.14.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Create Flow or TypeScript type definitions from Haskell data types
- **Homepage**: [https://hackage.haskell.org/package/aeson-flowtyped](https://hackage.haskell.org/package/aeson-flowtyped)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/5j81vbmp66y2wnwj81nl4wr4c3v2n6lr-aeson-flowtyped-0.14.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:54438`
- **Outputs**:
  - `doc`:  `/nix/store/5j81vbmp66y2wnwj81nl4wr4c3v2n6lr-aeson-flowtyped-0.14.0`
  - `out`:  `/nix/store/5j81vbmp66y2wnwj81nl4wr4c3v2n6lr-aeson-flowtyped-0.14.0`
...
- [[c37k1scyqz2z4krdcmqxda2iyd9akqpg-aeson-flowtyped-0.14.0.tar.gz]]
