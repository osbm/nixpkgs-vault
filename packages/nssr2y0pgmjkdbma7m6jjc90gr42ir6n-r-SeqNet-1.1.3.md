...
- **Name**: `rPackages.SeqNet`
- **Version**: `1.1.3`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://cran.r-project.org/web/packages/SeqNet/](https://cran.r-project.org/web/packages/SeqNet/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/nssr2y0pgmjkdbma7m6jjc90gr42ir6n-r-SeqNet-1.1.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/nssr2y0pgmjkdbma7m6jjc90gr42ir6n-r-SeqNet-1.1.3`
...
- [[szhaz70bbw8745h8wvv8xfhvyf31brdb-SeqNet_1.1.3.tar.gz]]
