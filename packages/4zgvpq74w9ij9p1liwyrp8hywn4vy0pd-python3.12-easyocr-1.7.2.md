...
- **Name**: `python312Packages.easyocr`
- **Version**: `1.7.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/4zgvpq74w9ij9p1liwyrp8hywn4vy0pd-python3.12-easyocr-1.7.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/easyocr/default.nix:80`
- **Outputs**:
  - `dist`:  `/nix/store/4zgvpq74w9ij9p1liwyrp8hywn4vy0pd-python3.12-easyocr-1.7.2`
  - `out`:  `/nix/store/4zgvpq74w9ij9p1liwyrp8hywn4vy0pd-python3.12-easyocr-1.7.2`
...
- [[phs5pb8p0x67crnmf764gkzblsjx868h-python3.12-python-bidi-0.6.6]]
