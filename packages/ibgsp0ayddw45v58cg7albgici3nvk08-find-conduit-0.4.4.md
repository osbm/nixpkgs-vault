...
- **Name**: `haskellPackages.find-conduit`
- **Version**: `0.4.4`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: A file-finding conduit that allows user control over traversals
- **Homepage**: [https://hackage.haskell.org/package/find-conduit](https://hackage.haskell.org/package/find-conduit)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/ibgsp0ayddw45v58cg7albgici3nvk08-find-conduit-0.4.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:233957`
- **Outputs**:
  - `doc`:  `/nix/store/ibgsp0ayddw45v58cg7albgici3nvk08-find-conduit-0.4.4`
  - `out`:  `/nix/store/ibgsp0ayddw45v58cg7albgici3nvk08-find-conduit-0.4.4`
...
- [[rc6nwvdsvf4c1wv1j3x4nlgiymmiybr5-find-conduit-0.4.4.tar.gz]]
