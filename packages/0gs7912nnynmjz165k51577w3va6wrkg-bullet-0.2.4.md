...
- **Name**: `haskellPackages.bullet`
- **Version**: `0.2.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: A wrapper for the Bullet physics engine
- **Homepage**: [https://hackage.haskell.org/package/bullet](https://hackage.haskell.org/package/bullet)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/0gs7912nnynmjz165k51577w3va6wrkg-bullet-0.2.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:118953`
- **Outputs**:
  - `doc`:  `/nix/store/0gs7912nnynmjz165k51577w3va6wrkg-bullet-0.2.4`
  - `out`:  `/nix/store/0gs7912nnynmjz165k51577w3va6wrkg-bullet-0.2.4`
...
- [[k9hv3k2rh8d96d5ap50fh1pw5kccrw1b-bullet-0.2.4.tar.gz]]
