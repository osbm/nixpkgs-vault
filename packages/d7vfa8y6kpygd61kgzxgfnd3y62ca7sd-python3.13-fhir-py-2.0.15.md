...
- **Name**: `python313Packages.fhir-py`
- **Version**: `2.0.15`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/d7vfa8y6kpygd61kgzxgfnd3y62ca7sd-python3.13-fhir-py-2.0.15.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/fhir-py/default.nix:54`
- **Outputs**:
  - `dist`:  `/nix/store/d7vfa8y6kpygd61kgzxgfnd3y62ca7sd-python3.13-fhir-py-2.0.15`
  - `out`:  `/nix/store/d7vfa8y6kpygd61kgzxgfnd3y62ca7sd-python3.13-fhir-py-2.0.15`
