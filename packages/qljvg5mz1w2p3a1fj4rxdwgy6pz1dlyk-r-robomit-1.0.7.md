...
- **Name**: `rPackages.robomit`
- **Version**: `1.0.7`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/robomit/](https://cran.r-project.org/web/packages/robomit/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/qljvg5mz1w2p3a1fj4rxdwgy6pz1dlyk-r-robomit-1.0.7.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/qljvg5mz1w2p3a1fj4rxdwgy6pz1dlyk-r-robomit-1.0.7`

## 🔗 Dependencies

- [[2dbgwfqf87lg2dg70ndy25qnzymhz58s-robomit_1.0.7.tar.gz]]
