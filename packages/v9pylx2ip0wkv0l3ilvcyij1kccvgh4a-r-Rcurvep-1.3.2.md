...
- **Name**: `rPackages.Rcurvep`
- **Version**: `1.3.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/Rcurvep/](https://cran.r-project.org/web/packages/Rcurvep/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/v9pylx2ip0wkv0l3ilvcyij1kccvgh4a-r-Rcurvep-1.3.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/v9pylx2ip0wkv0l3ilvcyij1kccvgh4a-r-Rcurvep-1.3.2`
...
- [[qk1bbqax3kjrwkwmalvv01hwa99hq8qf-Rcurvep_1.3.2.tar.gz]]
