...
- **Homepage**: [https://hackage.haskell.org/package/nix-tree](https://hackage.haskell.org/package/nix-tree)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/h5bvan7sm7xnm8gkj712if3qvpfnhi2b-nix-tree-0.6.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:479470`
- **Outputs**:
  - `out`:  `/nix/store/h5bvan7sm7xnm8gkj712if3qvpfnhi2b-nix-tree-0.6.3`
...
- [[ns7rqd948vqh7g8dp56ykngh24k5kyp4-dot-0.3]]
...
- [[ra0c7fwg8304fbydkllkw1hvhbpjhclx-nix-tree-0.6.3.tar.gz]]
