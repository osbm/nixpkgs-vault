...
- **Name**: `haskellPackages.respond`
- **Version**: `1.1.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: process and route HTTP requests and generate responses on top of WAI
- **Homepage**: [https://hackage.haskell.org/package/respond](https://hackage.haskell.org/package/respond)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/kmqmih3ycpsfzr6zs18h09rrmjyixh1b-respond-1.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:572263`
- **Outputs**:
  - `doc`:  `/nix/store/kmqmih3ycpsfzr6zs18h09rrmjyixh1b-respond-1.1.0`
  - `out`:  `/nix/store/kmqmih3ycpsfzr6zs18h09rrmjyixh1b-respond-1.1.0`
...
- [[pvb079ccdmjrrfif23vv0c4f5q2jji5p-respond-1.1.0.tar.gz]]
