...
- **Name**: `python313Packages.pypubsub`
- **Version**: `4.0.3`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Python 3 publish-subcribe library
- **Homepage**: [https://github.com/schollii/pypubsub](https://github.com/schollii/pypubsub)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/c0xcdnpw1ywl70k5h5x64p96g207sxsk-python3.13-pypubsub-4.0.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/pypubsub/default.nix:31`
- **Outputs**:
  - `dist`:  `/nix/store/c0xcdnpw1ywl70k5h5x64p96g207sxsk-python3.13-pypubsub-4.0.3`
  - `out`:  `/nix/store/c0xcdnpw1ywl70k5h5x64p96g207sxsk-python3.13-pypubsub-4.0.3`
...
- [[j6xbr9c77zg4f7zsb09a7l1wb3q3qmxm-source]]
