...
Local network server with live reload feature for static pages
...
- **Homepage**: [https://github.com/lomirus/live-server](https://github.com/lomirus/live-server)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/izaiqr59ybp3qs8i12sc37w2w5cz3hwa-live-server-0.10.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/li/live-server/package.nix:30`
- **Outputs**:
  - `out`:  `/nix/store/izaiqr59ybp3qs8i12sc37w2w5cz3hwa-live-server-0.10.1`
...
- [[5lmwy064kzw8df03kx65l9nzaz614vqa-live-server-0.10.1-vendor]]
- [[7d5p0ip9nd3aj3r1a2pmhsxxizqqnis8-openssl-3.5.1]]
- [[bjsb6wdjykafnkixq156qdvmxhsm2bai-bash-5.3p3]]
- [[lvdvlk7cwad5mna0wfpz8jllb30jdj1n-pkg-config-wrapper-0.29.2]]
- [[mnqxl16fiycfzbgflx0zcc5dgq0k0ci0-source]]
