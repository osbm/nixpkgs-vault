...
- **Name**: `haskellPackages.zendesk-api`
- **Version**: `0.1.0.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Zendesk API for Haskell programming language
- **Homepage**: [https://hackage.haskell.org/package/zendesk-api](https://hackage.haskell.org/package/zendesk-api)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/bhz8s6bz13svi012s3mzbhn76bph168y-zendesk-api-0.1.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:746207`
- **Outputs**:
  - `doc`:  `/nix/store/bhz8s6bz13svi012s3mzbhn76bph168y-zendesk-api-0.1.0.0`
  - `out`:  `/nix/store/bhz8s6bz13svi012s3mzbhn76bph168y-zendesk-api-0.1.0.0`
...
- [[zn6867j68kgz5bbskxnkic86ljlslb1y-zendesk-api-0.1.0.0.tar.gz]]
