...
A streamly-based library providing performance-focused alternatives for functionality found in yesod-static

## 📋 Package Information

- **Name**: `haskellPackages.yesod-static-streamly`
- **Version**: `0.1.5.3`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: A streamly-based library providing performance-focused alternatives for functionality found in yesod-static
- **Homepage**: [https://hackage.haskell.org/package/yesod-static-streamly](https://hackage.haskell.org/package/yesod-static-streamly)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/jd3mbfvmgybzb5p41zpkvwij9v3drxmj-yesod-static-streamly-0.1.5.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:742826`
- **Outputs**:
  - `doc`:  `/nix/store/jd3mbfvmgybzb5p41zpkvwij9v3drxmj-yesod-static-streamly-0.1.5.3`
  - `out`:  `/nix/store/jd3mbfvmgybzb5p41zpkvwij9v3drxmj-yesod-static-streamly-0.1.5.3`
...
- [[6i35ddhvhn0gsrxcr2vb141m7jf18y2n-yesod-static-streamly-0.1.5.3.tar.gz]]
...
- [[y9fdmzjcavggxagwzq5qfyikll501w24-cryptonite-conduit-0.2.2]]
