---
aliases:
  - androidenv.androidPkgs.all.system-images.v34x.google_apis_playstore.arm64-v8a
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.system-images.v34x.google_apis_playstore.arm64-v8a`
- **Version**: `34-ext10_r01-linux.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/z0p24r12hwydz843sr3xcajjqn6khr64-arm64-v8a-34-ext10_r01-linux.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/z0p24r12hwydz843sr3xcajjqn6khr64-arm64-v8a-34-ext10_r01-linux.zip`
