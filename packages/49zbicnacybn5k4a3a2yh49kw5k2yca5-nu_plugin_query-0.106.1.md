...
- **Name**: `nushellPlugins.query`
- **Version**: `0.106.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Nushell plugin to query JSON, XML, and various web data
- **Homepage**: [https://github.com/nushell/nushell/tree/0.106.1/crates/nu_plugin_query](https://github.com/nushell/nushell/tree/0.106.1/crates/nu_plugin_query)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/49zbicnacybn5k4a3a2yh49kw5k2yca5-nu_plugin_query-0.106.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/shells/nushell/plugins/query.nix:30`
- **Outputs**:
  - `out`:  `/nix/store/49zbicnacybn5k4a3a2yh49kw5k2yca5-nu_plugin_query-0.106.1`
...
- [[6rdzjbp28z4h3v6q0yjr88hn17pfkrdv-nu_plugin_query-0.106.1-vendor]]
