---
aliases:
  - haskellPackages.yesod-auth-oidc
tags:
  - broken
  - not-available
  - license/unknown
...
- **Name**: `haskellPackages.yesod-auth-oidc`
- **Version**: `0.1.4`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: A yesod-auth plugin for multi-tenant SSO via OpenID Connect
- **Homepage**: [https://hackage.haskell.org/package/yesod-auth-oidc](https://hackage.haskell.org/package/yesod-auth-oidc)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/zyxicc37045m6y742yhny9z9bk9ysc37-yesod-auth-oidc-0.1.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:739116`
- **Outputs**:
  - `doc`:  `/nix/store/zyxicc37045m6y742yhny9z9bk9ysc37-yesod-auth-oidc-0.1.4`
  - `out`:  `/nix/store/zyxicc37045m6y742yhny9z9bk9ysc37-yesod-auth-oidc-0.1.4`
...
- [[35im32qp237hy687hb0igg2gwnv4iakr-yesod-auth-oidc-0.1.4.tar.gz]]
