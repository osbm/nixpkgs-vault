---
aliases:
  - python313Packages.mypy-boto3-sqs
tags:
  - license/unknown
  - maintainers/fabaff
...
- **Name**: `python313Packages.mypy-boto3-sqs`
- **Version**: `1.40.35`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/7b96vfvx3q05hld0kspqgrr0azimkqww-python3.13-mypy-boto3-sqs-1.40.35.drv`
...
- **Outputs**:
  - `dist`:  `/nix/store/7b96vfvx3q05hld0kspqgrr0azimkqww-python3.13-mypy-boto3-sqs-1.40.35`
  - `out`:  `/nix/store/7b96vfvx3q05hld0kspqgrr0azimkqww-python3.13-mypy-boto3-sqs-1.40.35`
...
- [[fx5fvny0mlw295v81nnkdml3m48i0hi9-mypy_boto3_sqs-1.40.35.tar.gz]]
