...
- **Name**: `rPackages.starry`
- **Version**: `0.1.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/starry/](https://cran.r-project.org/web/packages/starry/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/0b0md8bzjq1ayqjpd9dwisx8yyvqv0l8-r-starry-0.1.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/0b0md8bzjq1ayqjpd9dwisx8yyvqv0l8-r-starry-0.1.2`
...
- [[539s75z0n8k6sjvgx12xgx2s9kzmilg7-starry_0.1.2.tar.gz]]
