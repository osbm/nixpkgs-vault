...
- **Name**: `haskellPackages.attomail`
- **Version**: `0.1.0.2`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Minimal mail delivery agent (MDA) for local mail with maildir support
- **Homepage**: [https://hackage.haskell.org/package/attomail](https://hackage.haskell.org/package/attomail)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/f6ipc5n4nn614xvd25dwk2qcgp0lga1a-attomail-0.1.0.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:88173`
- **Outputs**:
  - `doc`:  `/nix/store/f6ipc5n4nn614xvd25dwk2qcgp0lga1a-attomail-0.1.0.2`
  - `out`:  `/nix/store/f6ipc5n4nn614xvd25dwk2qcgp0lga1a-attomail-0.1.0.2`

## 🔗 Dependencies

- [[166lz3zab9z7s1smab2f7zdwjvdgh76a-attomail-0.1.0.2.tar.gz]]
...
- [[ky1jybmbhfqhpxkv9688xjf7mbar01l7-hsemail-ns-1.7.7]]
