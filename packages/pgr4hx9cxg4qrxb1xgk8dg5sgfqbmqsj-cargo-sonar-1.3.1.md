...
Utility to produce some Sonar-compatible format from different Rust tools like cargo-clippy cargo-audit or cargo-outdated
...
- **Homepage**: [https://gitlab.com/woshilapin/cargo-sonar](https://gitlab.com/woshilapin/cargo-sonar)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/pgr4hx9cxg4qrxb1xgk8dg5sgfqbmqsj-cargo-sonar-1.3.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/ca/cargo-sonar/package.nix:27`
- **Outputs**:
  - `out`:  `/nix/store/pgr4hx9cxg4qrxb1xgk8dg5sgfqbmqsj-cargo-sonar-1.3.1`
...
- [[7x6n9lsk3w6jhx3fas86v8rn1jbkdq3n-cargo-sonar-1.3.1-vendor]]
- [[bjsb6wdjykafnkixq156qdvmxhsm2bai-bash-5.3p3]]
- [[fmklifdhhwdwq6szv938w29xmy1f218w-source]]
