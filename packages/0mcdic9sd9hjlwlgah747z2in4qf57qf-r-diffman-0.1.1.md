...
- **Name**: `rPackages.diffman`
- **Version**: `0.1.1`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://cran.r-project.org/web/packages/diffman/](https://cran.r-project.org/web/packages/diffman/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/0mcdic9sd9hjlwlgah747z2in4qf57qf-r-diffman-0.1.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/0mcdic9sd9hjlwlgah747z2in4qf57qf-r-diffman-0.1.1`

## 🔗 Dependencies

- [[2blanm2xsdn1xn2dp07x023523zxmy79-diffman_0.1.1.tar.gz]]
