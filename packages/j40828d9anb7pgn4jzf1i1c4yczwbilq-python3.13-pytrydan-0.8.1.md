...
- **Name**: `python313Packages.pytrydan`
- **Version**: `0.8.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/j40828d9anb7pgn4jzf1i1c4yczwbilq-python3.13-pytrydan-0.8.1.drv`
...
- **Outputs**:
  - `dist`:  `/nix/store/j40828d9anb7pgn4jzf1i1c4yczwbilq-python3.13-pytrydan-0.8.1`
  - `out`:  `/nix/store/j40828d9anb7pgn4jzf1i1c4yczwbilq-python3.13-pytrydan-0.8.1`
