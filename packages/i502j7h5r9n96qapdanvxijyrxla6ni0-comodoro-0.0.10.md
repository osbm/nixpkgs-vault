...
- **Homepage**: [https://github.com/pimalaya/comodoro](https://github.com/pimalaya/comodoro)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/i502j7h5r9n96qapdanvxijyrxla6ni0-comodoro-0.0.10.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/co/comodoro/package.nix:44`
- **Outputs**:
  - `out`:  `/nix/store/i502j7h5r9n96qapdanvxijyrxla6ni0-comodoro-0.0.10`
...
- [[dwxj11mgi04rx056rx81r3vcs5h3gdb3-comodoro-0.0.10-vendor]]
- [[hb7cf8r6xq8ja1icq8a4v8fbfndfwhq1-source]]
