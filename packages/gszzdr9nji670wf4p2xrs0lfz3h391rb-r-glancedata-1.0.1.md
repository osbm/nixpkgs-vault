...
- **Name**: `rPackages.glancedata`
- **Version**: `1.0.1`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://cran.r-project.org/web/packages/glancedata/](https://cran.r-project.org/web/packages/glancedata/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/gszzdr9nji670wf4p2xrs0lfz3h391rb-r-glancedata-1.0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/gszzdr9nji670wf4p2xrs0lfz3h391rb-r-glancedata-1.0.1`

## 🔗 Dependencies

- [[1r64mq06vg56gppasfwig1v7r7l94aiy-glancedata_1.0.1.tar.gz]]
