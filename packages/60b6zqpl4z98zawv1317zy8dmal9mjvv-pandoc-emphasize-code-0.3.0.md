...
- **Name**: `haskellPackages.pandoc-emphasize-code`
- **Version**: `0.3.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: A Pandoc filter for emphasizing code in fenced blocks
- **Homepage**: [https://hackage.haskell.org/package/pandoc-emphasize-code](https://hackage.haskell.org/package/pandoc-emphasize-code)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/60b6zqpl4z98zawv1317zy8dmal9mjvv-pandoc-emphasize-code-0.3.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:500731`
- **Outputs**:
  - `doc`:  `/nix/store/60b6zqpl4z98zawv1317zy8dmal9mjvv-pandoc-emphasize-code-0.3.0`
  - `out`:  `/nix/store/60b6zqpl4z98zawv1317zy8dmal9mjvv-pandoc-emphasize-code-0.3.0`

## 🔗 Dependencies

- [[4lykrm96bxajhbrv42nzm365n9yf9s1y-coreutils-9.7]]
- [[55skdvm9nvfv299nmajgpznd8x6mns9s-glibc-locales-2.40-66]]
- [[5k0lihsk8wn6s13gnhl0lrfb1zpr0gd7-pandoc-emphasize-code-0.3.0.tar.gz]]
