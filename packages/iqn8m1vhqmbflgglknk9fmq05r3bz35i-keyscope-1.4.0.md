...
Key and secret workflow (validation, invalidation, etc.) tool
...
- **Homepage**: [https://github.com/spectralops/keyscope](https://github.com/spectralops/keyscope)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/iqn8m1vhqmbflgglknk9fmq05r3bz35i-keyscope-1.4.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/ke/keyscope/package.nix:40`
- **Outputs**:
  - `out`:  `/nix/store/iqn8m1vhqmbflgglknk9fmq05r3bz35i-keyscope-1.4.0`

## 🔗 Dependencies

- [[0f5ann1sgwyp31vlfqqsnr95xzv3mzhf-cargo-1.89.0]]
- [[28xhsqqk6bc8j7nlk0fjld7vjnck62iq-keyscope-1.4.0-vendor]]
- [[2fq6liaj4p9i2ngva38s5ilrhskkdahc-source]]
