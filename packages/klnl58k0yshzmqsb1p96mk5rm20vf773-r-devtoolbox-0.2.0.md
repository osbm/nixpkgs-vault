...
- **Name**: `rPackages.devtoolbox`
- **Version**: `0.2.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://cran.r-project.org/web/packages/devtoolbox/](https://cran.r-project.org/web/packages/devtoolbox/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/klnl58k0yshzmqsb1p96mk5rm20vf773-r-devtoolbox-0.2.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/klnl58k0yshzmqsb1p96mk5rm20vf773-r-devtoolbox-0.2.0`

## 🔗 Dependencies

- [[0868dvcq1as5rv5w9sam8afn07jglcp0-r-ggiraph-0.8.13]]
...
- [[4jlmbasnxkys691vmmkvawv5mgwbappl-r-pkgnet-0.5.0]]
...
- [[cva6r1ypb9nm5wwpf9mqkgnqqqcni0jb-r-cranlogs-2.1.1]]
...
- [[md7b34nggls4acnrs5134n7dbmbzapkp-devtoolbox_0.2.0.tar.gz]]
