...
- **Name**: `python312Packages.mwdblib`
- **Version**: `4.5.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Python client library for the mwdb service
- **Homepage**: [https://github.com/CERT-Polska/mwdblib](https://github.com/CERT-Polska/mwdblib)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/wbdv993inymxr68fg2fzinbjwkwb9wi2-python3.12-mwdblib-4.5.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/mwdblib/default.nix:45`
- **Outputs**:
  - `dist`:  `/nix/store/wbdv993inymxr68fg2fzinbjwkwb9wi2-python3.12-mwdblib-4.5.0`
  - `out`:  `/nix/store/wbdv993inymxr68fg2fzinbjwkwb9wi2-python3.12-mwdblib-4.5.0`
...
- [[i03q3fqw7cqva9lkzpngm0395x4b3khx-python3.12-beautifultable-1.1.0]]
...
- [[ygrhn6qg22bs39x7cq7lfsg45i63nb6f-source]]
