...
- **Name**: `haskellPackages.DSA`
- **Version**: `1.0.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Implementation of DSA, based on the description of FIPS 186-4
- **Homepage**: [https://hackage.haskell.org/package/DSA](https://hackage.haskell.org/package/DSA)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/gglc9knksm9w283pa1w9ncaryzr18cxa-DSA-1.0.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:9258`
- **Outputs**:
  - `doc`:  `/nix/store/gglc9knksm9w283pa1w9ncaryzr18cxa-DSA-1.0.2`
  - `out`:  `/nix/store/gglc9knksm9w283pa1w9ncaryzr18cxa-DSA-1.0.2`
...
- [[k94p24j2yv95dn42lw7mzbp6wd6x5s6z-DSA-1.0.2.tar.gz]]
