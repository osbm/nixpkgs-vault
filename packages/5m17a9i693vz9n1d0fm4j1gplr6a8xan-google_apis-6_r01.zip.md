---
aliases:
  - androidenv.androidPkgs.all.addons.v6.google_apis
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.addons.v6.google_apis`
- **Version**: `6_r01.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/5m17a9i693vz9n1d0fm4j1gplr6a8xan-google_apis-6_r01.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/5m17a9i693vz9n1d0fm4j1gplr6a8xan-google_apis-6_r01.zip`
