...
Trim the excess padding found in Nintendo DS(i) ROMs
...
- **Homepage**: [https://github.com/Nemris/ndstrim](https://github.com/Nemris/ndstrim)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/hlkwinq6qi2b9abw8yyf82c1m0d178r0-ndstrim-0.2.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/nd/ndstrim/package.nix:21`
- **Outputs**:
  - `out`:  `/nix/store/hlkwinq6qi2b9abw8yyf82c1m0d178r0-ndstrim-0.2.1`
...
- [[dl8z80cc357dnl3clvvmhrdfivfp34bp-ndstrim-0.2.1-vendor]]
- [[ha1krgqm74yzlb8jmz0xb0f5hfakv1p2-source]]
