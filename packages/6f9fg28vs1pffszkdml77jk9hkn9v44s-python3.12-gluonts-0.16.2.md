...
- **Name**: `python312Packages.gluonts`
- **Version**: `0.16.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Probabilistic time series modeling in Python
- **Homepage**: [https://ts.gluon.ai](https://ts.gluon.ai)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/6f9fg28vs1pffszkdml77jk9hkn9v44s-python3.12-gluonts-0.16.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/gluonts/default.nix:107`
- **Outputs**:
  - `dist`:  `/nix/store/6f9fg28vs1pffszkdml77jk9hkn9v44s-python3.12-gluonts-0.16.2`
  - `out`:  `/nix/store/6f9fg28vs1pffszkdml77jk9hkn9v44s-python3.12-gluonts-0.16.2`
...
- [[irj2528slc79bk73z56ly2i99056dncm-source]]
- [[j14jid00l8a5ix8i1az44aafjbgn4dsc-python3.12-lightning-2.5.5]]
