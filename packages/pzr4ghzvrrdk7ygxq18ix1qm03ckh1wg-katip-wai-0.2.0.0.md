...
- **Name**: `haskellPackages.katip-wai`
- **Version**: `0.2.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: WAI middleware for logging request and response info through katip
- **Homepage**: [https://hackage.haskell.org/package/katip-wai](https://hackage.haskell.org/package/katip-wai)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/pzr4ghzvrrdk7ygxq18ix1qm03ckh1wg-katip-wai-0.2.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:397878`
- **Outputs**:
  - `doc`:  `/nix/store/pzr4ghzvrrdk7ygxq18ix1qm03ckh1wg-katip-wai-0.2.0.0`
  - `out`:  `/nix/store/pzr4ghzvrrdk7ygxq18ix1qm03ckh1wg-katip-wai-0.2.0.0`
...
- [[vj16pj68jbb4mrjc9nzmvpmc7268ac6f-katip-wai-0.2.0.0.tar.gz]]
