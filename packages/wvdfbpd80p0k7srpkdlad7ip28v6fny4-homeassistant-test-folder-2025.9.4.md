---
aliases:
  - home-assistant-component-tests.folder
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.folder`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/wvdfbpd80p0k7srpkdlad7ip28v6fny4-homeassistant-test-folder-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/wvdfbpd80p0k7srpkdlad7ip28v6fny4-homeassistant-test-folder-2025.9.4`
