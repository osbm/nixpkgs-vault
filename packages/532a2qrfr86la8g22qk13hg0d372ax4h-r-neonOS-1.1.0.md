...
- **Name**: `rPackages.neonOS`
- **Version**: `1.1.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/neonOS/](https://cran.r-project.org/web/packages/neonOS/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/532a2qrfr86la8g22qk13hg0d372ax4h-r-neonOS-1.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/532a2qrfr86la8g22qk13hg0d372ax4h-r-neonOS-1.1.0`

## 🔗 Dependencies

- [[5q7ql10bjf0issicjyvpphn2iv07shd3-neonOS_1.1.0.tar.gz]]
