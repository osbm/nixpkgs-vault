...
- **Name**: `python313Packages.tox`
- **Version**: `4.28.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Generic virtualenv management and test command line tool
- **Homepage**: [https://github.com/tox-dev/tox](https://github.com/tox-dev/tox)
- **License**: `unknown`
- **Platforms**: `aarch64-linux`, `armv5tel-linux`, `armv6l-linux`, `armv7a-linux`, `armv7l-linux`, `i686-linux`, `loongarch64-linux`, `m68k-linux`, `microblaze-linux`, `microblazeel-linux`, `mips-linux`, `mips64-linux`, `mips64el-linux`, `mipsel-linux`, `powerpc-linux`, `powerpc64-linux`, `powerpc64le-linux`, `riscv32-linux`, `riscv64-linux`, `s390-linux`, `s390x-linux`, `x86_64-linux`, `x86_64-darwin`, `aarch64-darwin`, `i686-cygwin`, `x86_64-cygwin`, `aarch64-windows`, `x86_64-windows`, `i686-windows`, `i686-freebsd`, `x86_64-freebsd`, `aarch64-freebsd`

## 🔧 Build Information

- **Derivation Path**: `/nix/store/alp9bcqzjsbj53wi1zpam3i2rwdnfxnz-python3.13-tox-4.28.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/tox/default.nix:71`
- **Outputs**:
  - `dist`:  `/nix/store/alp9bcqzjsbj53wi1zpam3i2rwdnfxnz-python3.13-tox-4.28.4`
  - `out`:  `/nix/store/alp9bcqzjsbj53wi1zpam3i2rwdnfxnz-python3.13-tox-4.28.4`

## 🔗 Dependencies

- [[06a2j9jv7f40ihnra63q0xx99ry62h35-python-imports-check-hook.sh]]
- [[1m5k6jw675cz1vkalh64ph2rp4x75mng-python3.13-platformdirs-4.3.8]]
- [[1qz57qdfligr3bsvggw4n4vp42vsxzpw-source]]
...
- [[z33ic13fx902kjp9yd0xif1wchxr2qaj-python3.13-pyproject-api-1.9.1]]
