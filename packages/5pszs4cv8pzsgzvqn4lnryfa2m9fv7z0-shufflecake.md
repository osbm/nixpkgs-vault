---
aliases:
  - linuxKernel.packages.linux_xanmod_stable.shufflecake
tags:
  - license/unknown
  - maintainers/oluceps
  - outputs/bin
...
- **Name**: `linuxKernel.packages.linux_xanmod_stable.shufflecake`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/5pszs4cv8pzsgzvqn4lnryfa2m9fv7z0-shufflecake.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/shufflecake/default.nix:44`
- **Outputs**:
  - `bin`:  `/nix/store/5pszs4cv8pzsgzvqn4lnryfa2m9fv7z0-shufflecake`
  - `out`:  `/nix/store/5pszs4cv8pzsgzvqn4lnryfa2m9fv7z0-shufflecake`
