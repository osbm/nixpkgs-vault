...
- **Name**: `python312Packages.tldextract`
- **Version**: `5.3.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Python module to accurately separate the TLD from the domain of an URL
- **Homepage**: [https://github.com/john-kurkowski/tldextract](https://github.com/john-kurkowski/tldextract)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/kgc5s9rf99j2js86k42yh0yd1lhkllca-python3.12-tldextract-5.3.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/tldextract/default.nix:54`
- **Outputs**:
  - `dist`:  `/nix/store/kgc5s9rf99j2js86k42yh0yd1lhkllca-python3.12-tldextract-5.3.0`
  - `out`:  `/nix/store/kgc5s9rf99j2js86k42yh0yd1lhkllca-python3.12-tldextract-5.3.0`

## 🔗 Dependencies

- [[4gxxh41zcgbj5m7xq3yyv8w40gmlkb3b-source]]
...
- [[vap7zimbssq11h2lcjday3i459yl76fn-python3.12-requests-file-2.1.0]]
