...
- **Homepage**: [https://github.com/adamsky/globe](https://github.com/adamsky/globe)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/6dfnvcypm026ylxwkvrkr5936cql8lap-globe-cli-0.2.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/gl/globe-cli/package.nix:19`
- **Outputs**:
  - `out`:  `/nix/store/6dfnvcypm026ylxwkvrkr5936cql8lap-globe-cli-0.2.0`
...
- [[m9dcm5qlg6awy3jg3yy0jnnw68ilvr2r-globe-cli-0.2.0.tar.gz]]
- [[p0mnv4dhf2v9631cniis649vdwybxrli-globe-cli-0.2.0-vendor]]
