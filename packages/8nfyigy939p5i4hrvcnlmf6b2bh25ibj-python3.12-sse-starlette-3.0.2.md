...
- **Name**: `python312Packages.sse-starlette`
- **Version**: `3.0.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/8nfyigy939p5i4hrvcnlmf6b2bh25ibj-python3.12-sse-starlette-3.0.2.drv`
...
- **Outputs**:
  - `dist`:  `/nix/store/8nfyigy939p5i4hrvcnlmf6b2bh25ibj-python3.12-sse-starlette-3.0.2`
  - `out`:  `/nix/store/8nfyigy939p5i4hrvcnlmf6b2bh25ibj-python3.12-sse-starlette-3.0.2`
