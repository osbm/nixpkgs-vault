---
aliases:
  - linuxKernel.packages.linux_hardened.usbip
tags:
  - license/unknown
  - outputs/out
---
...
- **Name**: `linuxKernel.packages.linux_hardened.usbip`
- **Version**: `6.12.43`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/1ypfrak1dl80mc6nxz6z26xpgghhsqxy-usbip-linux-hardened-6.12.43.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/usbip/default.nix:45`
- **Outputs**:
  - `out`:  `/nix/store/1ypfrak1dl80mc6nxz6z26xpgghhsqxy-usbip-linux-hardened-6.12.43`
