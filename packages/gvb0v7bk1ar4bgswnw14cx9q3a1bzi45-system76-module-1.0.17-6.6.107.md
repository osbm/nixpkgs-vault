---
aliases:
  - linuxKernel.packages.linux_6_6.system76
tags:
  - license/unknown
...
- **Name**: `linuxKernel.packages.linux_6_6.system76`
- **Version**: `1.0.17-6.6.107`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/gvb0v7bk1ar4bgswnw14cx9q3a1bzi45-system76-module-1.0.17-6.6.107.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/system76/default.nix:47`
- **Outputs**:
  - `out`:  `/nix/store/gvb0v7bk1ar4bgswnw14cx9q3a1bzi45-system76-module-1.0.17-6.6.107`
