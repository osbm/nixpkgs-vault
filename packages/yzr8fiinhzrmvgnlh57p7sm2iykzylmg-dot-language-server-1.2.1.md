...
- **Derivation Path**: `/nix/store/yzr8fiinhzrmvgnlh57p7sm2iykzylmg-dot-language-server-1.2.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/do/dot-language-server/package.nix:23`
- **Outputs**:
  - `out`:  `/nix/store/yzr8fiinhzrmvgnlh57p7sm2iykzylmg-dot-language-server-1.2.1`
...
- [[ic1vx6d9bpg7m03985f66qrgj0clqz7w-source]]
- [[ip1vk08d6b2ma1k4mirz5769ipfrswga-dot-language-server-1.2.1-npm-deps]]
