...
- **Name**: `haskellPackages.hats`
- **Version**: `0.1.0.1`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Haskell client for the NATS messaging system
- **Homepage**: [https://hackage.haskell.org/package/hats](https://hackage.haskell.org/package/hats)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/6kxqm0hylnd5mk12swpjxc4kkmqccy1i-hats-0.1.0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:314057`
- **Outputs**:
  - `doc`:  `/nix/store/6kxqm0hylnd5mk12swpjxc4kkmqccy1i-hats-0.1.0.1`
  - `out`:  `/nix/store/6kxqm0hylnd5mk12swpjxc4kkmqccy1i-hats-0.1.0.1`

## 🔗 Dependencies

- [[2x39qw4qvyf3nsm9zfgb9p2npjbxd0jf-hats-0.1.0.1.tar.gz]]
