...
- **Name**: `rPackages.stringr`
- **Version**: `1.5.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/stringr/](https://cran.r-project.org/web/packages/stringr/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/3sisfv8m6ziv41s3h6jnwq12ppp62xd4-r-stringr-1.5.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/3sisfv8m6ziv41s3h6jnwq12ppp62xd4-r-stringr-1.5.1`
...
- [[hqfy4ig6d7pkmxv9nkw4vr1a1lfiaih0-stringr_1.5.1.tar.gz]]
