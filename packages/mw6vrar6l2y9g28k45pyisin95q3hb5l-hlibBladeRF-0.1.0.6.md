...
Haskell binding to libBladeRF SDR library

## 📋 Package Information

- **Name**: `haskellPackages.hlibBladeRF`
- **Version**: `0.1.0.6`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Haskell binding to libBladeRF SDR library
- **Homepage**: [https://hackage.haskell.org/package/hlibBladeRF](https://hackage.haskell.org/package/hlibBladeRF)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/mw6vrar6l2y9g28k45pyisin95q3hb5l-hlibBladeRF-0.1.0.6.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:332921`
- **Outputs**:
  - `doc`:  `/nix/store/mw6vrar6l2y9g28k45pyisin95q3hb5l-hlibBladeRF-0.1.0.6`
  - `out`:  `/nix/store/mw6vrar6l2y9g28k45pyisin95q3hb5l-hlibBladeRF-0.1.0.6`
...
- [[h1nwliqwjdaw45lzzv5inhxa3fysdgbf-hlibBladeRF-0.1.0.6.tar.gz]]
