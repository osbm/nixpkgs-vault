...
- **Name**: `haskellPackages.hls-code-range-plugin`
- **Version**: `2.6.0.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: HLS Plugin to support smart selection range and Folding range
- **Homepage**: [https://hackage.haskell.org/package/hls-code-range-plugin](https://hackage.haskell.org/package/hls-code-range-plugin)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/dhhajkh05d51x871cj8glsjmvxns9x0q-hls-code-range-plugin-2.6.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:333895`
- **Outputs**:
  - `doc`:  `/nix/store/dhhajkh05d51x871cj8glsjmvxns9x0q-hls-code-range-plugin-2.6.0.0`
  - `out`:  `/nix/store/dhhajkh05d51x871cj8glsjmvxns9x0q-hls-code-range-plugin-2.6.0.0`
...
- [[rvsc0cpj3s0yjr8vgn6ffzyn3da9j3av-hls-code-range-plugin-2.6.0.0.tar.gz]]
