...
- **Name**: `kdePackages.drkonqi`
- **Version**: `6.4.5`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Crash handler for KDE software
- **Homepage**: [https://invent.kde.org/plasma/drkonqi](https://invent.kde.org/plasma/drkonqi)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/phhvcsgyz5lyj7vfr3si2gm141bbf83n-drkonqi-6.4.5.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/kde/plasma/drkonqi/default.nix:21`
- **Outputs**:
  - `debug`:  `/nix/store/phhvcsgyz5lyj7vfr3si2gm141bbf83n-drkonqi-6.4.5`
  - `dev`:  `/nix/store/phhvcsgyz5lyj7vfr3si2gm141bbf83n-drkonqi-6.4.5`
  - `devtools`:  `/nix/store/phhvcsgyz5lyj7vfr3si2gm141bbf83n-drkonqi-6.4.5`
  - `out`:  `/nix/store/phhvcsgyz5lyj7vfr3si2gm141bbf83n-drkonqi-6.4.5`
...
- [[l9anmq9n3064925ikag7ykz362qzz2aj-hardcode-paths.patch]]
...
- [[xcgxldk95dj33qadxmap9b2jb44w2zjv-drkonqi-6.4.5.tar.xz]]
- [[xjn2y7ziw8i5dj0ljjsp250rb8bxl9kf-kf6-move-outputs-hook]]
- [[ylai7krx9rb1vvy3xi7i9fypk8235v2c-gdb-host-cpu-only-16.3]]
