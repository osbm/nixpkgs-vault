...
- **Homepage**: [https://github.com/gilesknap/gphotos-sync](https://github.com/gilesknap/gphotos-sync)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/gs2vq8inc005mlk6iad685nacrwh7zrs-gphotos-sync-3.2.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/gp/gphotos-sync/package.nix:57`
- **Outputs**:
  - `dist`:  `/nix/store/gs2vq8inc005mlk6iad685nacrwh7zrs-gphotos-sync-3.2.1`
  - `out`:  `/nix/store/gs2vq8inc005mlk6iad685nacrwh7zrs-gphotos-sync-3.2.1`
...
- `/nix/store/j99af93cw0f00wih7ja8qz2dsbwk95fi-skip-network-tests.patch`
