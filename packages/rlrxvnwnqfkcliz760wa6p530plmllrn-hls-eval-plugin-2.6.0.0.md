...
- **Name**: `haskellPackages.hls-eval-plugin`
- **Version**: `2.6.0.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Eval plugin for Haskell Language Server
- **Homepage**: [https://hackage.haskell.org/package/hls-eval-plugin](https://hackage.haskell.org/package/hls-eval-plugin)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/rlrxvnwnqfkcliz760wa6p530plmllrn-hls-eval-plugin-2.6.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:333977`
- **Outputs**:
  - `doc`:  `/nix/store/rlrxvnwnqfkcliz760wa6p530plmllrn-hls-eval-plugin-2.6.0.0`
  - `out`:  `/nix/store/rlrxvnwnqfkcliz760wa6p530plmllrn-hls-eval-plugin-2.6.0.0`
...
- [[8h45ha8vw2g3rf8l7mv5ccs9biysm7p7-hls-eval-plugin-2.6.0.0.tar.gz]]
