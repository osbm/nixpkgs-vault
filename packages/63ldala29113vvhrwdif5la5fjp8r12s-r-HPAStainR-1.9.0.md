...
- **Name**: `rPackages.HPAStainR`
- **Version**: `1.9.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://bioconductor.org/packages/3.21/bioc/html/HPAStainR.html](https://bioconductor.org/packages/3.21/bioc/html/HPAStainR.html)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/63ldala29113vvhrwdif5la5fjp8r12s-r-HPAStainR-1.9.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/63ldala29113vvhrwdif5la5fjp8r12s-r-HPAStainR-1.9.0`
...
- [[fsk974h7k689c4qjbbjh7y33gcz6x4r1-HPAStainR_1.9.0.tar.gz]]
