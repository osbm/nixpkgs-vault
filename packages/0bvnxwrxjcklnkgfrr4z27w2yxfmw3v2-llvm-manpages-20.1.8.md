...
man pages for LLVM 20.1.8

## 📋 Package Information

- **Name**: `llvmPackages_20.llvm-manpages`
- **Version**: `20.1.8`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: man pages for LLVM 20.1.8
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/0bvnxwrxjcklnkgfrr4z27w2yxfmw3v2-llvm-manpages-20.1.8.drv`
...
- **Outputs**:
  - `out`:  `/nix/store/0bvnxwrxjcklnkgfrr4z27w2yxfmw3v2-llvm-manpages-20.1.8`

## 🔗 Dependencies

- [[257k0vnqp1xjgyrpc5as1r0nl7s4yv71-python3-3.13.7]]
- [[3h2pqwsp2izzlynp9gjar39hm70nnz89-libxml2-2.14.5]]
- [[613ys9h058kbbnlkrg144ik9ajisrqq7-llvm-src-20.1.8]]
