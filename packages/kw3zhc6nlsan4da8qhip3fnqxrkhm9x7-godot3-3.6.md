...
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Free and Open Source 2D and 3D game engine (X11 tools)
...
- **Derivation Path**: `/nix/store/kw3zhc6nlsan4da8qhip3fnqxrkhm9x7-godot3-3.6.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/tools/godot/3/default.nix:178`
- **Outputs**:
  - `dev`:  `/nix/store/kw3zhc6nlsan4da8qhip3fnqxrkhm9x7-godot3-3.6`
  - `man`:  `/nix/store/kw3zhc6nlsan4da8qhip3fnqxrkhm9x7-godot3-3.6`
  - `out`:  `/nix/store/kw3zhc6nlsan4da8qhip3fnqxrkhm9x7-godot3-3.6`
