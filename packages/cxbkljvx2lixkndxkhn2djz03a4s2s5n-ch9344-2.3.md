---
aliases:
  - linuxKernel.packages.linux_6_12.ch9344
tags:
  - license/unknown
...
- **Name**: `linuxKernel.packages.linux_6_12.ch9344`
- **Version**: `2.3`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/cxbkljvx2lixkndxkhn2djz03a4s2s5n-ch9344-2.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/ch9344/default.nix:46`
- **Outputs**:
  - `out`:  `/nix/store/cxbkljvx2lixkndxkhn2djz03a4s2s5n-ch9344-2.3`
