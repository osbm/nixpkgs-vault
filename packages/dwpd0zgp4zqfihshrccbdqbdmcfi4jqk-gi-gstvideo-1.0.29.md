...
- **Name**: `haskellPackages.gi-gstvideo`
- **Version**: `1.0.29`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: GStreamerVideo bindings
- **Homepage**: [https://hackage.haskell.org/package/gi-gstvideo](https://hackage.haskell.org/package/gi-gstvideo)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/dwpd0zgp4zqfihshrccbdqbdmcfi4jqk-gi-gstvideo-1.0.29.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:265430`
- **Outputs**:
  - `doc`:  `/nix/store/dwpd0zgp4zqfihshrccbdqbdmcfi4jqk-gi-gstvideo-1.0.29`
  - `out`:  `/nix/store/dwpd0zgp4zqfihshrccbdqbdmcfi4jqk-gi-gstvideo-1.0.29`
...
- [[f2lg99y2f1qcjfy87649q9j0pb0ycd12-gi-gstvideo-1.0.29.tar.gz]]
