...
- **Name**: `haskellPackages.pinecone`
- **Version**: `1.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Servant bindings to Pinecone
- **Homepage**: [https://hackage.haskell.org/package/pinecone](https://hackage.haskell.org/package/pinecone)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/n2fwy4bjd72r8nn4qi8akisc3z1qzq51-pinecone-1.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:518953`
- **Outputs**:
  - `doc`:  `/nix/store/n2fwy4bjd72r8nn4qi8akisc3z1qzq51-pinecone-1.0.0`
  - `out`:  `/nix/store/n2fwy4bjd72r8nn4qi8akisc3z1qzq51-pinecone-1.0.0`
...
- [[mm730svm4c6c6idlidfvfzrin998c9a4-pinecone-1.0.0.tar.gz]]
