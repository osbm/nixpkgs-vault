...
- **Name**: `haskellPackages.MIP`
- **Version**: `0.2.0.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Library for using Mixed Integer Programming (MIP)
- **Homepage**: [https://hackage.haskell.org/package/MIP](https://hackage.haskell.org/package/MIP)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/w8r9xamkr5483flcl0bx8ywprn1v6zy6-MIP-0.2.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:28843`
- **Outputs**:
  - `doc`:  `/nix/store/w8r9xamkr5483flcl0bx8ywprn1v6zy6-MIP-0.2.0.0`
  - `out`:  `/nix/store/w8r9xamkr5483flcl0bx8ywprn1v6zy6-MIP-0.2.0.0`

## 🔗 Dependencies

- [[1iphh970yvj60hi5x9xgf2d1lax9ms98-intern-0.9.6]]
- [[1iqli5637yhgp9jsc4bvcw2g26cgblw2-OptDir-0.1.0]]
...
- [[6n8ihlm323k72z9q9fs7fscs9qbc59mv-MIP-0.2.0.0.tar.gz]]
...
- [[khpwpnigss7di1ccii90pzl1ndi8p5z0-bytestring-encoding-0.1.2.0]]
