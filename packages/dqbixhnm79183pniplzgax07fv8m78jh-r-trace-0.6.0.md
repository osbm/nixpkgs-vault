...
- **Name**: `rPackages.trace`
- **Version**: `0.6.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/trace/](https://cran.r-project.org/web/packages/trace/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/dqbixhnm79183pniplzgax07fv8m78jh-r-trace-0.6.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/dqbixhnm79183pniplzgax07fv8m78jh-r-trace-0.6.0`
...
- [[kaafbnhdfvsyr80xw4cr0khsawzryhc0-trace_0.6.0.tar.gz]]
