...
- **Name**: `haskellPackages.yesod-csp`
- **Version**: `0.2.6.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Add CSP headers to Yesod apps
- **Homepage**: [https://hackage.haskell.org/package/yesod-csp](https://hackage.haskell.org/package/yesod-csp)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/39ljqyrxkgxwp1qf1y8lfq86kvgz7xig-yesod-csp-0.2.6.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:739964`
- **Outputs**:
  - `doc`:  `/nix/store/39ljqyrxkgxwp1qf1y8lfq86kvgz7xig-yesod-csp-0.2.6.0`
  - `out`:  `/nix/store/39ljqyrxkgxwp1qf1y8lfq86kvgz7xig-yesod-csp-0.2.6.0`
...
- [[hdzghs078l74vlr6ymmphn40zda0lcq9-yesod-csp-0.2.6.0.tar.gz]]
