---
aliases:
  - androidenv.androidPkgs.all.system-images.v21.google_apis.x86_64
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.system-images.v21.google_apis.x86_64`
- **Version**: `21_r32.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/j7hf9gyx8pxysddh22nx5kbaqn7206jh-x86_64-21_r32.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/j7hf9gyx8pxysddh22nx5kbaqn7206jh-x86_64-21_r32.zip`
