---
aliases:
  - androidenv.androidPkgs.all.addons.v15.google_apis
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.addons.v15.google_apis`
- **Version**: `15_r03.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/k0ch4ah2a9mi76p211mphjdpf54nagzd-google_apis-15_r03.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/k0ch4ah2a9mi76p211mphjdpf54nagzd-google_apis-15_r03.zip`
