---
aliases:
  - androidenv.androidPkgs.all.system-images.v16.default.mips
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.system-images.v16.default.mips`
- **Version**: `16_r04.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/kimr0k3vzs4aqxhzjcairqzfvfk4kpdr-sysimg_mips-16_r04.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/kimr0k3vzs4aqxhzjcairqzfvfk4kpdr-sysimg_mips-16_r04.zip`
