...
- **Name**: `python312Packages.starlette`
- **Version**: `0.47.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Little ASGI framework that shines
- **Homepage**: [https://www.starlette.io/](https://www.starlette.io/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/wpq070ckjj4x657f6l4svmavr70mwi99-python3.12-starlette-0.47.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/starlette/default.nix:78`
- **Outputs**:
  - `dist`:  `/nix/store/wpq070ckjj4x657f6l4svmavr70mwi99-python3.12-starlette-0.47.2`
  - `out`:  `/nix/store/wpq070ckjj4x657f6l4svmavr70mwi99-python3.12-starlette-0.47.2`
...
- [[l4snwbzwr23mmfd5sjdqpwnc34y6923d-source]]
