...
- **Name**: `python313Packages.argilla`
- **Version**: `2.8.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Open-source data curation platform for LLMs
- **Homepage**: [https://github.com/argilla-io/argilla](https://github.com/argilla-io/argilla)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/7cdjmsqpafgg9lz9ml94crlglp4zdgih-python3.13-argilla-2.8.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/argilla/default.nix:189`
- **Outputs**:
  - `dist`:  `/nix/store/7cdjmsqpafgg9lz9ml94crlglp4zdgih-python3.13-argilla-2.8.0`
  - `out`:  `/nix/store/7cdjmsqpafgg9lz9ml94crlglp4zdgih-python3.13-argilla-2.8.0`
...
- [[3xank55gh4yhclm7x6qmbgwbw3lscpmr-source]]
