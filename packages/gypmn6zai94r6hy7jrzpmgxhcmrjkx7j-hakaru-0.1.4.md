...
- **Name**: `haskellPackages.hakaru`
- **Version**: `0.1.4`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: A probabilistic programming embedded DSL
- **Homepage**: [https://hackage.haskell.org/package/hakaru](https://hackage.haskell.org/package/hakaru)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/gypmn6zai94r6hy7jrzpmgxhcmrjkx7j-hakaru-0.1.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:292793`
- **Outputs**:
  - `doc`:  `/nix/store/gypmn6zai94r6hy7jrzpmgxhcmrjkx7j-hakaru-0.1.4`
  - `out`:  `/nix/store/gypmn6zai94r6hy7jrzpmgxhcmrjkx7j-hakaru-0.1.4`
...
- [[wwm4xc4vq8fl1nx8avxrwnli2kk08c1d-hakaru-0.1.4.tar.gz]]
