...
- **Name**: `haskellPackages.hls-cabal-plugin`
- **Version**: `2.6.0.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Cabal integration plugin with Haskell Language Server
- **Homepage**: [https://hackage.haskell.org/package/hls-cabal-plugin](https://hackage.haskell.org/package/hls-cabal-plugin)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/g510a2n3x77lxckjdzv7jgmyzwh57ip4-hls-cabal-plugin-2.6.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:333700`
- **Outputs**:
  - `doc`:  `/nix/store/g510a2n3x77lxckjdzv7jgmyzwh57ip4-hls-cabal-plugin-2.6.0.0`
  - `out`:  `/nix/store/g510a2n3x77lxckjdzv7jgmyzwh57ip4-hls-cabal-plugin-2.6.0.0`
...
- [[3dr0lskisf6hfava592ad6xx4yivvn0n-hls-cabal-plugin-2.6.0.0.tar.gz]]
