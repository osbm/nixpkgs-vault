...
- **Name**: `haskellPackages.fortran-src`
- **Version**: `0.16.7`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Parsers and analyses for Fortran standards 66, 77, 90, 95 and 2003 (partial)
- **Homepage**: [https://hackage.haskell.org/package/fortran-src](https://hackage.haskell.org/package/fortran-src)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/2wdxkljbjvaq4zwzprci26k2jwh3z12m-fortran-src-0.16.7.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:241295`
- **Outputs**:
  - `doc`:  `/nix/store/2wdxkljbjvaq4zwzprci26k2jwh3z12m-fortran-src-0.16.7`
  - `out`:  `/nix/store/2wdxkljbjvaq4zwzprci26k2jwh3z12m-fortran-src-0.16.7`
...
- [[k558z5a8cgmngibjjqymgsg50dg4vzzq-fortran-src-0.16.7.tar.gz]]
