...
- **Name**: `haskellPackages.vte`
- **Version**: `0.13.1.1`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Binding to the VTE library
- **Homepage**: [https://hackage.haskell.org/package/vte](https://hackage.haskell.org/package/vte)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/jzwrbwcv6fwrvc1xnfczb43hg6pac4q9-vte-0.13.1.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:710202`
- **Outputs**:
  - `data`:  `/nix/store/jzwrbwcv6fwrvc1xnfczb43hg6pac4q9-vte-0.13.1.1`
  - `doc`:  `/nix/store/jzwrbwcv6fwrvc1xnfczb43hg6pac4q9-vte-0.13.1.1`
  - `out`:  `/nix/store/jzwrbwcv6fwrvc1xnfczb43hg6pac4q9-vte-0.13.1.1`
...
- [[cpi09k6iwmsy35x0gsndh8vpp16qcz1f-vte-0.13.1.1.tar.gz]]
