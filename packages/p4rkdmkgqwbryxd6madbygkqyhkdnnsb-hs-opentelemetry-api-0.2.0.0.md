---
aliases:
  - haskellPackages.hs-opentelemetry-api
tags:
  - license/unknown
  - outputs/doc
  - outputs/out
...
- **Name**: `haskellPackages.hs-opentelemetry-api`
- **Version**: `0.2.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: OpenTelemetry API for use by libraries for direct instrumentation or wrapper packages
- **Homepage**: [https://hackage.haskell.org/package/hs-opentelemetry-api](https://hackage.haskell.org/package/hs-opentelemetry-api)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/p4rkdmkgqwbryxd6madbygkqyhkdnnsb-hs-opentelemetry-api-0.2.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:346793`
- **Outputs**:
  - `doc`:  `/nix/store/p4rkdmkgqwbryxd6madbygkqyhkdnnsb-hs-opentelemetry-api-0.2.0.0`
  - `out`:  `/nix/store/p4rkdmkgqwbryxd6madbygkqyhkdnnsb-hs-opentelemetry-api-0.2.0.0`
...
- [[6xiw7hbfkvd7kvyfpg1n6007sbx0vrbk-hs-opentelemetry-api-0.2.0.0.tar.gz]]
...
- [[g9a78qs3yyxfmk1wjgq22zdf54i5ny38-thread-utils-context-0.3.0.4]]
