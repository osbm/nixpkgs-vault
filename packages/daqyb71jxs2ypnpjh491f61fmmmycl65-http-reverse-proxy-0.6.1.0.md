---
aliases:
  - haskellPackages.http-reverse-proxy
tags:
  - license/unknown
  - outputs/doc
  - outputs/out
...
- **Name**: `haskellPackages.http-reverse-proxy`
- **Version**: `0.6.1.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Reverse proxy HTTP requests, either over raw sockets or with WAI
- **Homepage**: [https://hackage.haskell.org/package/http-reverse-proxy](https://hackage.haskell.org/package/http-reverse-proxy)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/daqyb71jxs2ypnpjh491f61fmmmycl65-http-reverse-proxy-0.6.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:362545`
- **Outputs**:
  - `doc`:  `/nix/store/daqyb71jxs2ypnpjh491f61fmmmycl65-http-reverse-proxy-0.6.1.0`
  - `out`:  `/nix/store/daqyb71jxs2ypnpjh491f61fmmmycl65-http-reverse-proxy-0.6.1.0`
...
- [[pvjjmqvk6665fzsv47f5zrzjcid51bzq-http-reverse-proxy-0.6.1.0.tar.gz]]
