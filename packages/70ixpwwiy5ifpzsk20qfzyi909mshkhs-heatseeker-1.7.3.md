...
General-purpose fuzzy selector
...
- **Homepage**: [https://github.com/rschmitt/heatseeker](https://github.com/rschmitt/heatseeker)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/70ixpwwiy5ifpzsk20qfzyi909mshkhs-heatseeker-1.7.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/he/heatseeker/package.nix:33`
- **Outputs**:
  - `out`:  `/nix/store/70ixpwwiy5ifpzsk20qfzyi909mshkhs-heatseeker-1.7.3`
...
- [[hmfyh7xpl88ai0sqyxjisy2xvnxkjrhd-heatseeker-1.7.3-vendor]]
- [[j9v34mgafnigbscmgd3b9a9mh7zi8gr5-source]]
