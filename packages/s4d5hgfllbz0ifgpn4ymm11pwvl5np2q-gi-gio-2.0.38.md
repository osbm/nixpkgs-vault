...
- **Name**: `haskellPackages.gi-gio`
- **Version**: `2.0.38`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Gio bindings
- **Homepage**: [https://hackage.haskell.org/package/gi-gio](https://hackage.haskell.org/package/gi-gio)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/s4d5hgfllbz0ifgpn4ymm11pwvl5np2q-gi-gio-2.0.38.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:264775`
- **Outputs**:
  - `doc`:  `/nix/store/s4d5hgfllbz0ifgpn4ymm11pwvl5np2q-gi-gio-2.0.38`
  - `out`:  `/nix/store/s4d5hgfllbz0ifgpn4ymm11pwvl5np2q-gi-gio-2.0.38`
...
- [[cghsdax2dlr3y3l4a5fmcsadnm7zl9wc-gi-gio-2.0.38.tar.gz]]
