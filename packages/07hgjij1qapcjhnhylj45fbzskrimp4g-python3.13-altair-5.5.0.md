...
- **Name**: `python313Packages.altair`
- **Version**: `5.5.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Declarative statistical visualization library for Python
- **Homepage**: [https://altair-viz.github.io](https://altair-viz.github.io)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/07hgjij1qapcjhnhylj45fbzskrimp4g-python3.13-altair-5.5.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/altair/default.nix:83`
- **Outputs**:
  - `dist`:  `/nix/store/07hgjij1qapcjhnhylj45fbzskrimp4g-python3.13-altair-5.5.0`
  - `out`:  `/nix/store/07hgjij1qapcjhnhylj45fbzskrimp4g-python3.13-altair-5.5.0`

## 🔗 Dependencies

- [[06a2j9jv7f40ihnra63q0xx99ry62h35-python-imports-check-hook.sh]]
- [[257k0vnqp1xjgyrpc5as1r0nl7s4yv71-python3-3.13.7]]
- [[4ijia5a6w43vva4xxxraffsijwv8sg0q-source]]
...
- [[p2rhxbp5djl8615h8h88djp3m6p4b5c2-python3.13-vega-datasets-0.9.0]]
