...
- **Name**: `cudaPackages.cuda_documentation`
- **Version**: `12.8.90`
- **Available**: ❌ No
- **Broken**: ✅ No
- **Description**: CUDA Documentation. By downloading and using the packages you accept the terms and conditions of the CUDA EULA
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/agyfs3s5pbgb5fhmraanmwsywgxbqkw0-cuda_documentation-12.8.90.drv`
...
- **Outputs**:
  - `out`:  `/nix/store/agyfs3s5pbgb5fhmraanmwsywgxbqkw0-cuda_documentation-12.8.90`
...
- [[spgqrsrss3p1njhrwkcb0zkkkrfmb75w-cuda_documentation-linux-x86_64-12.8.90-archive.tar.xz]]
