...
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/ibb/](https://cran.r-project.org/web/packages/ibb/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/pywhbdm9ymrkb2pzfc5z45i20r4mm4nc-r-ibb-0.0.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/pywhbdm9ymrkb2pzfc5z45i20r4mm4nc-r-ibb-0.0.2`
...
- [[y9402jl062ix3sq1h2pr1b1fa62gh478-ibb_0.0.2.tar.gz]]
