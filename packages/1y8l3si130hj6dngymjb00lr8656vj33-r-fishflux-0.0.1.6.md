...
- **Name**: `rPackages.fishflux`
- **Version**: `0.0.1.6`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://cran.r-project.org/web/packages/fishflux/](https://cran.r-project.org/web/packages/fishflux/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/1y8l3si130hj6dngymjb00lr8656vj33-r-fishflux-0.0.1.6.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/1y8l3si130hj6dngymjb00lr8656vj33-r-fishflux-0.0.1.6`

## 🔗 Dependencies

- [[09pr1a3bj8bl2xd91n74lrhvxappycd9-r-fishualize-0.2.3]]
...
- [[hzzibsm3mj6zjrg3b7qkc5q2nmc56km7-fishflux_0.0.1.6.tar.gz]]
