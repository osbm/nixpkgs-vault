...
- **Name**: `nushellPlugins.gstat`
- **Version**: `0.106.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Git status plugin for Nushell
- **Homepage**: [https://github.com/nushell/nushell/tree/0.106.1/crates/nu_plugin_gstat](https://github.com/nushell/nushell/tree/0.106.1/crates/nu_plugin_gstat)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/zsbxxf0byywhn6r1g369p3b255pvq9dq-nu_plugin_gstat-0.106.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/shells/nushell/plugins/gstat.nix:26`
- **Outputs**:
  - `out`:  `/nix/store/zsbxxf0byywhn6r1g369p3b255pvq9dq-nu_plugin_gstat-0.106.1`
...
- [[j7cki7rrvwgr0lvymqhapyihcf2vxlis-nu_plugin_gstat-0.106.1-vendor]]
