...
- **Name**: `rPackages.clubpro`
- **Version**: `0.6.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/clubpro/](https://cran.r-project.org/web/packages/clubpro/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/balhild8gfwhmswm9h9wq92kslcri8lr-r-clubpro-0.6.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/balhild8gfwhmswm9h9wq92kslcri8lr-r-clubpro-0.6.2`
...
- [[glixxgnqkjqxh0hic1s40y1nk5diddhf-clubpro_0.6.2.tar.gz]]
