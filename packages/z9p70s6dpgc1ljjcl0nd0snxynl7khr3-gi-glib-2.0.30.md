...
- **Name**: `haskellPackages.gi-glib`
- **Version**: `2.0.30`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: GLib bindings
- **Homepage**: [https://hackage.haskell.org/package/gi-glib](https://hackage.haskell.org/package/gi-glib)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/z9p70s6dpgc1ljjcl0nd0snxynl7khr3-gi-glib-2.0.30.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:264890`
- **Outputs**:
  - `doc`:  `/nix/store/z9p70s6dpgc1ljjcl0nd0snxynl7khr3-gi-glib-2.0.30`
  - `out`:  `/nix/store/z9p70s6dpgc1ljjcl0nd0snxynl7khr3-gi-glib-2.0.30`
...
- [[8w8arf5d6ajmwpkfzi7311yyhawah2qy-gi-glib-2.0.30.tar.gz]]
