...
- **Name**: `haskellPackages.glue-common`
- **Version**: `0.6.3`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Make better services and clients
- **Homepage**: [https://hackage.haskell.org/package/glue-common](https://hackage.haskell.org/package/glue-common)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/6lq2c145ljrg0qz6h9d5s24qxgb5ryz1-glue-common-0.6.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:274103`
- **Outputs**:
  - `doc`:  `/nix/store/6lq2c145ljrg0qz6h9d5s24qxgb5ryz1-glue-common-0.6.3`
  - `out`:  `/nix/store/6lq2c145ljrg0qz6h9d5s24qxgb5ryz1-glue-common-0.6.3`
...
- [[ixlsy5klycgscyj044ckl0vw9x3fcncr-glue-common-0.6.3.tar.gz]]
