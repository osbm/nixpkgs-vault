...
- **Name**: `rPackages.bayesian`
- **Version**: `1.0.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/bayesian/](https://cran.r-project.org/web/packages/bayesian/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/y56w5sx6mxc5946l0i9q1brip9ngc9hq-r-bayesian-1.0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/y56w5sx6mxc5946l0i9q1brip9ngc9hq-r-bayesian-1.0.1`
...
- [[iyx8rk1lx36zvfpih27sfk8wrv87dr2d-bayesian_1.0.1.tar.gz]]
