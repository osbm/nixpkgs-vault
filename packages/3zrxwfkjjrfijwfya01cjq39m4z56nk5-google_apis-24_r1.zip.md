---
aliases:
  - androidenv.androidPkgs.all.addons.v24.google_apis
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.addons.v24.google_apis`
- **Version**: `24_r1.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/3zrxwfkjjrfijwfya01cjq39m4z56nk5-google_apis-24_r1.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/3zrxwfkjjrfijwfya01cjq39m4z56nk5-google_apis-24_r1.zip`
