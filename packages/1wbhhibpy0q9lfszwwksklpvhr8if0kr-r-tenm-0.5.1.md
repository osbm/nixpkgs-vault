...
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/tenm/](https://cran.r-project.org/web/packages/tenm/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/1wbhhibpy0q9lfszwwksklpvhr8if0kr-r-tenm-0.5.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/1wbhhibpy0q9lfszwwksklpvhr8if0kr-r-tenm-0.5.1`
...
- [[81xdgv4cf4fyqagq06d5im0dr7v3gcsr-tenm_0.5.1.tar.gz]]
