...
man pages for LLVM 21.1.1

## 📋 Package Information

- **Name**: `llvmPackages_21.llvm-manpages`
- **Version**: `21.1.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: man pages for LLVM 21.1.1
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/fxbsz8rs6i2lz1fdn5wqx8aah2icp4qy-llvm-manpages-21.1.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/compilers/llvm/common/llvm/default.nix:640`
- **Outputs**:
  - `out`:  `/nix/store/fxbsz8rs6i2lz1fdn5wqx8aah2icp4qy-llvm-manpages-21.1.1`
...
- [[cbgfkqm50wk2bhfqiwk1f3xkm8f0mw23-llvm-src-21.1.1]]
...
- `/nix/store/cvqzr3i3m5b3xgni0bv8iby7b6m5lm0n-gnu-install-dirs.patch`
...
- `/nix/store/n2iajpbj02yn11j24jhbyzrb045i0wba-gnu-install-dirs-polly.patch`
