---
aliases:
  - haskellPackages.gi-gtk4-layer-shell
tags:
  - broken
  - not-available
  - license/unknown
...
- **Name**: `haskellPackages.gi-gtk4-layer-shell`
- **Version**: `0.1.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: gtk4-layer-shell bindings
- **Homepage**: [https://hackage.haskell.org/package/gi-gtk4-layer-shell](https://hackage.haskell.org/package/gi-gtk4-layer-shell)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/zs42qbvc868n0a37pab2nxr7j4lsb0m6-gi-gtk4-layer-shell-0.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:265865`
- **Outputs**:
  - `doc`:  `/nix/store/zs42qbvc868n0a37pab2nxr7j4lsb0m6-gi-gtk4-layer-shell-0.1.0`
  - `out`:  `/nix/store/zs42qbvc868n0a37pab2nxr7j4lsb0m6-gi-gtk4-layer-shell-0.1.0`
...
- [[5y6c2n8y80ic0vi98w5v800ks56g8yfj-gi-gtk4-layer-shell-0.1.0.tar.gz]]
