...
- **Name**: `linuxKernel.packages.linux_6_1.zfs_unstable`
- **Version**: `2.4.0-rc1-6.1.153`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/k8fcih88f01gihjab0z9hbxbfxzhx5ls-zfs-kernel-2.4.0-rc1-6.1.153.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/zfs/generic.nix:322`
- **Outputs**:
  - `out`:  `/nix/store/k8fcih88f01gihjab0z9hbxbfxzhx5ls-zfs-kernel-2.4.0-rc1-6.1.153`
