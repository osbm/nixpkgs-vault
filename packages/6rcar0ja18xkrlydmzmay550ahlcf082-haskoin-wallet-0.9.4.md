---
aliases:
  - haskellPackages.haskoin-wallet
tags:
  - license/unknown
  - outputs/doc
  - outputs/out
...
- **Name**: `haskellPackages.haskoin-wallet`
- **Version**: `0.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Lightweight CLI wallet for Bitcoin and Bitcoin Cash
- **Homepage**: [https://hackage.haskell.org/package/haskoin-wallet](https://hackage.haskell.org/package/haskoin-wallet)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/6rcar0ja18xkrlydmzmay550ahlcf082-haskoin-wallet-0.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:309442`
- **Outputs**:
  - `doc`:  `/nix/store/6rcar0ja18xkrlydmzmay550ahlcf082-haskoin-wallet-0.9.4`
  - `out`:  `/nix/store/6rcar0ja18xkrlydmzmay550ahlcf082-haskoin-wallet-0.9.4`
...
- [[30q8m1rlxlwsjlrig2bixg6009a5xyi1-haskoin-store-data-1.4.0]]
...
- [[7n9lvkkl24lc8s5n8dmdfs2lz0sm8hf0-haskoin-wallet-0.9.4.tar.gz]]
