...
- **Name**: `python312Packages.aioesphomeapi`
- **Version**: `39.0.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Python Client for ESPHome native API
- **Homepage**: [https://github.com/esphome/aioesphomeapi](https://github.com/esphome/aioesphomeapi)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/jlwq81hk5pgz3bfpbq6is46wmc2dz9i3-python3.12-aioesphomeapi-39.0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/aioesphomeapi/default.nix:75`
- **Outputs**:
  - `dist`:  `/nix/store/jlwq81hk5pgz3bfpbq6is46wmc2dz9i3-python3.12-aioesphomeapi-39.0.1`
  - `out`:  `/nix/store/jlwq81hk5pgz3bfpbq6is46wmc2dz9i3-python3.12-aioesphomeapi-39.0.1`

## 🔗 Dependencies

- [[0r17q21xxn88s3rj9s4h4vvrjj9wmmk9-python3.12-chacha20poly1305-reuseable-0.13.2]]
- [[2ixcl8yjsp2l8r531vl5f2sk6jrzvsnd-source]]
