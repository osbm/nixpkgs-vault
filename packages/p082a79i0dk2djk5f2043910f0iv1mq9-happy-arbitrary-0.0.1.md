...
Token list generator for arbitrary Happy grammars

## 📋 Package Information

- **Name**: `haskellPackages.happy-arbitrary`
- **Version**: `0.0.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Token list generator for arbitrary Happy grammars
- **Homepage**: [https://hackage.haskell.org/package/happy-arbitrary](https://hackage.haskell.org/package/happy-arbitrary)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/p082a79i0dk2djk5f2043910f0iv1mq9-happy-arbitrary-0.0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:297681`
- **Outputs**:
  - `doc`:  `/nix/store/p082a79i0dk2djk5f2043910f0iv1mq9-happy-arbitrary-0.0.1`
  - `out`:  `/nix/store/p082a79i0dk2djk5f2043910f0iv1mq9-happy-arbitrary-0.0.1`
...
- [[b1p70nm79q8kbsz5z68z3myypk4vaqxq-happy-arbitrary-0.0.1.tar.gz]]
