...
- **Name**: `haskellPackages.csg`
- **Version**: `0.1.0.6`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Analytical CSG (Constructive Solid Geometry) library
- **Homepage**: [https://hackage.haskell.org/package/csg](https://hackage.haskell.org/package/csg)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/535hjz1msq2mj41lblg8zqydxxn5hp9w-csg-0.1.0.6.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:171069`
- **Outputs**:
  - `doc`:  `/nix/store/535hjz1msq2mj41lblg8zqydxxn5hp9w-csg-0.1.0.6`
  - `out`:  `/nix/store/535hjz1msq2mj41lblg8zqydxxn5hp9w-csg-0.1.0.6`

## 🔗 Dependencies

- [[2sh5fna8i9pira02jglbq7nin5mk8jhn-simple-vec3-0.6.0.1]]
...
- [[8aqvzq7qb7wayxyl0qf3apidd6vmszs6-csg-0.1.0.6.tar.gz]]
