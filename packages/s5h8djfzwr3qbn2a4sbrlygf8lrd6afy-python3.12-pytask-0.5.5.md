...
Workflow management system that facilitates reproducible data analyses

## 📋 Package Information

- **Name**: `python312Packages.pytask`
- **Version**: `0.5.5`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Workflow management system that facilitates reproducible data analyses
- **Homepage**: [https://github.com/pytask-dev/pytask](https://github.com/pytask-dev/pytask)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/s5h8djfzwr3qbn2a4sbrlygf8lrd6afy-python3.12-pytask-0.5.5.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/pytask/default.nix:80`
- **Outputs**:
  - `dist`:  `/nix/store/s5h8djfzwr3qbn2a4sbrlygf8lrd6afy-python3.12-pytask-0.5.5`
  - `out`:  `/nix/store/s5h8djfzwr3qbn2a4sbrlygf8lrd6afy-python3.12-pytask-0.5.5`

## 🔗 Dependencies

- [[292gvim613y8d7fajizbjwfrqn5fnbzj-python3.12-pytest-xdist-3.8.0]]
- [[42ghxi438avcfcqysq5av9ccbnlrn8yn-python3.12-optree-0.17.0]]
...
- [[ffzsvjwcf38pyqzw11ymiq8d413pwllj-source]]
...
- [[llhaa93fq2x6abd63b98v8rfmm007h5a-python3.12-nbmake-1.5.5]]
