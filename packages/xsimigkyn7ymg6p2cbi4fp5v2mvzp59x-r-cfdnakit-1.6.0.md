...
- **Name**: `rPackages.cfdnakit`
- **Version**: `1.6.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://bioconductor.org/packages/3.21/bioc/html/cfdnakit.html](https://bioconductor.org/packages/3.21/bioc/html/cfdnakit.html)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/xsimigkyn7ymg6p2cbi4fp5v2mvzp59x-r-cfdnakit-1.6.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/xsimigkyn7ymg6p2cbi4fp5v2mvzp59x-r-cfdnakit-1.6.0`
...
- [[9lyi45vxcc5b79sn4ni9glgx9y9cmck0-cfdnakit_1.6.0.tar.gz]]
