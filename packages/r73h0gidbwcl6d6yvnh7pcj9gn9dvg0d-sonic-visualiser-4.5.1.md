...
- **Homepage**: [https://www.sonicvisualiser.org/](https://www.sonicvisualiser.org/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/r73h0gidbwcl6d6yvnh7pcj9gn9dvg0d-sonic-visualiser-4.5.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/applications/audio/sonic-visualiser/default.nix:86`
- **Outputs**:
  - `out`:  `/nix/store/r73h0gidbwcl6d6yvnh7pcj9gn9dvg0d-sonic-visualiser-4.5.1`
...
- [[d8i8gcz8dn8w8yjrsi7pisqcr9dxz6r7-sonic-visualiser-4.5.1.tar.gz]]
