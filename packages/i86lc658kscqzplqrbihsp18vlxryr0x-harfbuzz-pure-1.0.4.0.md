...
- **Name**: `haskellPackages.harfbuzz-pure`
- **Version**: `1.0.4.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Pure-functional Harfbuzz language bindings
- **Homepage**: [https://hackage.haskell.org/package/harfbuzz-pure](https://hackage.haskell.org/package/harfbuzz-pure)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/i86lc658kscqzplqrbihsp18vlxryr0x-harfbuzz-pure-1.0.4.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:298222`
- **Outputs**:
  - `doc`:  `/nix/store/i86lc658kscqzplqrbihsp18vlxryr0x-harfbuzz-pure-1.0.4.0`
  - `out`:  `/nix/store/i86lc658kscqzplqrbihsp18vlxryr0x-harfbuzz-pure-1.0.4.0`
...
- [[q1cd44k72na3hrxzjij82160l482rs4l-harfbuzz-pure-1.0.4.0.tar.gz]]
