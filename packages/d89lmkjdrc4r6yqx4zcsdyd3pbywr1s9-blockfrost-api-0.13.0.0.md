...
- **Name**: `haskellPackages.blockfrost-api`
- **Version**: `0.13.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: API definitions for blockfrost.io
- **Homepage**: [https://hackage.haskell.org/package/blockfrost-api](https://hackage.haskell.org/package/blockfrost-api)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/d89lmkjdrc4r6yqx4zcsdyd3pbywr1s9-blockfrost-api-0.13.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:111025`
- **Outputs**:
  - `doc`:  `/nix/store/d89lmkjdrc4r6yqx4zcsdyd3pbywr1s9-blockfrost-api-0.13.0.0`
  - `out`:  `/nix/store/d89lmkjdrc4r6yqx4zcsdyd3pbywr1s9-blockfrost-api-0.13.0.0`
...
- [[58b289f4gsdrnvdyqspl52x1m81807j6-blockfrost-api-0.13.0.0.tar.gz]]
