---
aliases:
  - haskellPackages.backblaze-b2-hs
tags:
  - license/unknown
  - outputs/doc
  - outputs/out
...
- **Name**: `haskellPackages.backblaze-b2-hs`
- **Version**: `0.1.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: A client library to access Backblaze B2 cloud storage in Haskell
- **Homepage**: [https://hackage.haskell.org/package/backblaze-b2-hs](https://hackage.haskell.org/package/backblaze-b2-hs)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/hpwmkx1xjf9ax9y0lfwpcc8nfp7gi4i6-backblaze-b2-hs-0.1.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:95284`
- **Outputs**:
  - `doc`:  `/nix/store/hpwmkx1xjf9ax9y0lfwpcc8nfp7gi4i6-backblaze-b2-hs-0.1.0.0`
  - `out`:  `/nix/store/hpwmkx1xjf9ax9y0lfwpcc8nfp7gi4i6-backblaze-b2-hs-0.1.0.0`
...
- [[pf6my94w1ka1w5zmqm7v7gs9iwil9r8k-req-conduit-1.0.2]]
...
- [[zhigp4n1ldqly3lajphb90fgin411fin-backblaze-b2-hs-0.1.0.0.tar.gz]]
