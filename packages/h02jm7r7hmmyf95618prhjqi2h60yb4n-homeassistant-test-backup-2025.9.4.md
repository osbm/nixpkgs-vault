---
aliases:
  - home-assistant-component-tests.backup
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.backup`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/h02jm7r7hmmyf95618prhjqi2h60yb4n-homeassistant-test-backup-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/h02jm7r7hmmyf95618prhjqi2h60yb4n-homeassistant-test-backup-2025.9.4`
