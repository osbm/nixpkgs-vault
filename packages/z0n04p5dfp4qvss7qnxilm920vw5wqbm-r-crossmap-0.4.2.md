...
- **Name**: `rPackages.crossmap`
- **Version**: `0.4.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/crossmap/](https://cran.r-project.org/web/packages/crossmap/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/z0n04p5dfp4qvss7qnxilm920vw5wqbm-r-crossmap-0.4.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/z0n04p5dfp4qvss7qnxilm920vw5wqbm-r-crossmap-0.4.2`
...
- [[qqrh8jh3pz6xarzv13qp4y8l06xn3s7r-crossmap_0.4.2.tar.gz]]
