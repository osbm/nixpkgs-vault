...
The Linux kernel (with patches: bridge-stp-helper, request-key-helper, linux-hardened-v6.12.43-hardened1)

## 📋 Package Information

- **Name**: `linuxKernel.kernels.linux_hardened`
- **Version**: `6.12.43`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: The Linux kernel (with patches: bridge-stp-helper, request-key-helper, linux-hardened-v6.12.43-hardened1)
...
- **Derivation Path**: `/nix/store/kwgskdwfgqc49fvj0bwjmxnyssz82fj5-linux-hardened-6.12.43.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/top-level/linux-kernels.nix:60`
- **Outputs**:
  - `dev`:  `/nix/store/kwgskdwfgqc49fvj0bwjmxnyssz82fj5-linux-hardened-6.12.43`
  - `modules`:  `/nix/store/kwgskdwfgqc49fvj0bwjmxnyssz82fj5-linux-hardened-6.12.43`
  - `out`:  `/nix/store/kwgskdwfgqc49fvj0bwjmxnyssz82fj5-linux-hardened-6.12.43`
...
- [[k4c0zb3gydw2knmqxwnxvqsikb5dlb8f-linux-config-6.12.43]]
...
- [[nfryww6nqib8vslakgwf00g5bq3q0mfc-linux-hardened-v6.12.43-hardened1.patch]]
- [[p76r0cwlf6k97ibprrpfd8xw0r8wc3nx-stdenv-linux]]
- [[qmg0h7ddbh8r5iissdh538jgwx5xi189-kmod-31]]
- [[slcp4pdbh65jxz72z8vfrwwp4yki90ip-rsync-3.4.1]]
- [[wy61x67y125m36dp7l7xhzqbi30mxg1d-flex-2.6.4]]
- [[x1ijf3xrn8gfa18nn1dqqy4nchlip80n-linux-6.12.43.tar.xz]]
