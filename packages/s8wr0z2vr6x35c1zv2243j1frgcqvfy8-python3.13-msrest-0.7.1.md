...
- **Name**: `python313Packages.msrest`
- **Version**: `0.7.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Runtime library for AutoRest generated Python clients
- **Homepage**: [https://github.com/Azure/msrest-for-python](https://github.com/Azure/msrest-for-python)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/s8wr0z2vr6x35c1zv2243j1frgcqvfy8-python3.13-msrest-0.7.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/msrest/default.nix:76`
- **Outputs**:
  - `dist`:  `/nix/store/s8wr0z2vr6x35c1zv2243j1frgcqvfy8-python3.13-msrest-0.7.1`
  - `out`:  `/nix/store/s8wr0z2vr6x35c1zv2243j1frgcqvfy8-python3.13-msrest-0.7.1`
...
- [[f0l76q51vykhih2j42jxjsm3h83093sc-source]]
