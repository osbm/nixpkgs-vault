...
- **Name**: `rPackages.matrixset`
- **Version**: `0.4.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/matrixset/](https://cran.r-project.org/web/packages/matrixset/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/2ri2n9z9pyvvziss0g2q25pmscsdggzy-r-matrixset-0.4.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/2ri2n9z9pyvvziss0g2q25pmscsdggzy-r-matrixset-0.4.0`

## 🔗 Dependencies

- [[16mhnh40hxr6mdzc5n9zrrg1ca2qsx54-matrixset_0.4.0.tar.gz]]
