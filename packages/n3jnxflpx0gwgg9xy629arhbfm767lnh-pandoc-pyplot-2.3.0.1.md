...
- **Name**: `haskellPackages.pandoc-pyplot`
- **Version**: `2.3.0.1`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: A Pandoc filter to include figures generated from Python code blocks
- **Homepage**: [https://hackage.haskell.org/package/pandoc-pyplot](https://hackage.haskell.org/package/pandoc-pyplot)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/n3jnxflpx0gwgg9xy629arhbfm767lnh-pandoc-pyplot-2.3.0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:501720`
- **Outputs**:
  - `doc`:  `/nix/store/n3jnxflpx0gwgg9xy629arhbfm767lnh-pandoc-pyplot-2.3.0.1`
  - `out`:  `/nix/store/n3jnxflpx0gwgg9xy629arhbfm767lnh-pandoc-pyplot-2.3.0.1`
...
- [[kzxrhf6zzdy4r6z1vmhb2n47vgh2vi1i-pandoc-pyplot-2.3.0.1.tar.gz]]
