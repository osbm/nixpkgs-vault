---
aliases:
  - haskellPackages.utxorpc-client
tags:
  - license/unknown
  - outputs/doc
  - outputs/out
...
- **Name**: `haskellPackages.utxorpc-client`
- **Version**: `0.0.2.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: An SDK for clients of the UTxO RPC specification
- **Homepage**: [https://hackage.haskell.org/package/utxorpc-client](https://hackage.haskell.org/package/utxorpc-client)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/11b078bs5ffrg8yyaascc1bhs4jlf4rm-utxorpc-client-0.0.2.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:702167`
- **Outputs**:
  - `doc`:  `/nix/store/11b078bs5ffrg8yyaascc1bhs4jlf4rm-utxorpc-client-0.0.2.0`
  - `out`:  `/nix/store/11b078bs5ffrg8yyaascc1bhs4jlf4rm-utxorpc-client-0.0.2.0`
...
- [[zkmh633qd1y3q189q9ngal129ij2wimd-utxorpc-client-0.0.2.0.tar.gz]]
