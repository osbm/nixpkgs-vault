...
- **Name**: `haskellPackages.galois-fft`
- **Version**: `0.1.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: FFTs over finite fields
- **Homepage**: [https://hackage.haskell.org/package/galois-fft](https://hackage.haskell.org/package/galois-fft)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/rlhjw61a5imq6yybdnlmb31vnw664d7w-galois-fft-0.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:250111`
- **Outputs**:
  - `doc`:  `/nix/store/rlhjw61a5imq6yybdnlmb31vnw664d7w-galois-fft-0.1.0`
  - `out`:  `/nix/store/rlhjw61a5imq6yybdnlmb31vnw664d7w-galois-fft-0.1.0`
...
- [[znvy6ih5vd68alpkp0ks6ns3w5gfn9x6-galois-fft-0.1.0.tar.gz]]
