...
- **Name**: `rPackages.REDCapDM`
- **Version**: `0.9.9`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/REDCapDM/](https://cran.r-project.org/web/packages/REDCapDM/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/dmp4aklfrrplg0r53hg9hw21nqlczh71-r-REDCapDM-0.9.9.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/dmp4aklfrrplg0r53hg9hw21nqlczh71-r-REDCapDM-0.9.9`
...
- [[4m6p2dybf9jpvhada360385950l12x4p-REDCapDM_0.9.9.tar.gz]]
