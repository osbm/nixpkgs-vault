...
- **Name**: `postgresql16Packages.pgx_ulid`
- **Version**: `0.2.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/z2x9fma6610gnq5w5dbqz4ixj6pybc9x-pgx_ulid-0.2.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/sql/postgresql/ext/pgx_ulid.nix:52`
- **Outputs**:
  - `out`:  `/nix/store/z2x9fma6610gnq5w5dbqz4ixj6pybc9x-pgx_ulid-0.2.0`
