---
aliases:
  - androidenv.androidPkgs.all.packages.extras.v2_0
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.packages.extras.v2_0`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/4vni75zc48am90nagm9hmn0qihkkkvih-desktop-head-unit-linux-x64_r02.0.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/4vni75zc48am90nagm9hmn0qihkkkvih-desktop-head-unit-linux-x64_r02.0.zip`
