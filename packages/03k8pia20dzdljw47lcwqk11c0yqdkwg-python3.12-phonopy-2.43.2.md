...
- **Name**: `python312Packages.phonopy`
- **Version**: `2.43.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/03k8pia20dzdljw47lcwqk11c0yqdkwg-python3.12-phonopy-2.43.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/phonopy/default.nix:69`
- **Outputs**:
  - `dist`:  `/nix/store/03k8pia20dzdljw47lcwqk11c0yqdkwg-python3.12-phonopy-2.43.2`
  - `out`:  `/nix/store/03k8pia20dzdljw47lcwqk11c0yqdkwg-python3.12-phonopy-2.43.2`
...
- [[99y8rrx7j0x8a12w8qymvnh7q2xab6d5-python3.12-symfc-1.5.4]]
