...
- **Name**: `python312Packages.embedding-reader`
- **Version**: `1.8.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Efficiently read embedding in streaming from any filesystem
- **Homepage**: [https://github.com/rom1504/embedding-reader](https://github.com/rom1504/embedding-reader)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/r0f0pcw8zpk419gf3x4hjqg7wdq44j72-python3.12-embedding-reader-1.8.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/embedding-reader/default.nix:40`
- **Outputs**:
  - `dist`:  `/nix/store/r0f0pcw8zpk419gf3x4hjqg7wdq44j72-python3.12-embedding-reader-1.8.1`
  - `out`:  `/nix/store/r0f0pcw8zpk419gf3x4hjqg7wdq44j72-python3.12-embedding-reader-1.8.1`
...
- [[rx4cq6qv522m0frg1csiwjkml36cpc3n-source]]
