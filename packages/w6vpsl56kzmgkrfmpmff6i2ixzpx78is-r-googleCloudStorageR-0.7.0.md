...
- **Name**: `rPackages.googleCloudStorageR`
- **Version**: `0.7.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/googleCloudStorageR/](https://cran.r-project.org/web/packages/googleCloudStorageR/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/w6vpsl56kzmgkrfmpmff6i2ixzpx78is-r-googleCloudStorageR-0.7.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/w6vpsl56kzmgkrfmpmff6i2ixzpx78is-r-googleCloudStorageR-0.7.0`
...
- [[bxf0b81cm652fcfksbiq7h7csmb0xp82-googleCloudStorageR_0.7.0.tar.gz]]
