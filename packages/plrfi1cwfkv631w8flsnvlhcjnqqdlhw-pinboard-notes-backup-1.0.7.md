...
- **Name**: `haskellPackages.pinboard-notes-backup`
- **Version**: `1.0.7`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Back up the notes you've saved to Pinboard
- **Homepage**: [https://hackage.haskell.org/package/pinboard-notes-backup](https://hackage.haskell.org/package/pinboard-notes-backup)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/plrfi1cwfkv631w8flsnvlhcjnqqdlhw-pinboard-notes-backup-1.0.7.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:518706`
- **Outputs**:
  - `doc`:  `/nix/store/plrfi1cwfkv631w8flsnvlhcjnqqdlhw-pinboard-notes-backup-1.0.7`
  - `out`:  `/nix/store/plrfi1cwfkv631w8flsnvlhcjnqqdlhw-pinboard-notes-backup-1.0.7`
...
- [[n6yrxjiwsbrv772jmjxzfkybyd0yqn1q-pinboard-notes-backup-1.0.7.tar.gz]]
