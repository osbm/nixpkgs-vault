...
- **Name**: `rPackages.SqueakR`
- **Version**: `1.3.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/SqueakR/](https://cran.r-project.org/web/packages/SqueakR/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/6izdr9ahkw3mnckdbdmkfdzqdsw1lzm8-r-SqueakR-1.3.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/6izdr9ahkw3mnckdbdmkfdzqdsw1lzm8-r-SqueakR-1.3.0`

## 🔗 Dependencies

- [[1nva2ybkd1ax6s5xjza9f6fy8jlvabg4-r-plotly-4.11.0]]
- [[23cci3w7s9ir27g2mnh1s4hx6cp1a3zy-SqueakR_1.3.0.tar.gz]]
...
- [[rnj9fszy5vhk4qwa5qp5fkkd8xja3l7j-r-gghighlight-0.5.0]]
