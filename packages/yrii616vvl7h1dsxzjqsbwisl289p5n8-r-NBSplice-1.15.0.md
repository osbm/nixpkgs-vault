...
- **Name**: `rPackages.NBSplice`
- **Version**: `1.15.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://bioconductor.org/packages/3.21/bioc/html/NBSplice.html](https://bioconductor.org/packages/3.21/bioc/html/NBSplice.html)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/yrii616vvl7h1dsxzjqsbwisl289p5n8-r-NBSplice-1.15.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/yrii616vvl7h1dsxzjqsbwisl289p5n8-r-NBSplice-1.15.0`

## 🔗 Dependencies

- [[0vpikcy1a4q1rzjbj1hv8mha64rg5hzk-r-reshape2-1.4.4]]
- [[2136fn88izk36jra89as802lns0z587n-NBSplice_1.15.0.tar.gz]]
