...
- **Name**: `haskellPackages.hoodle-render`
- **Version**: `0.6`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Hoodle file renderer
- **Homepage**: [https://hackage.haskell.org/package/hoodle-render](https://hackage.haskell.org/package/hoodle-render)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/8d9mq5kfgm3slji8gg91lah0waw7n7jq-hoodle-render-0.6.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:340262`
- **Outputs**:
  - `doc`:  `/nix/store/8d9mq5kfgm3slji8gg91lah0waw7n7jq-hoodle-render-0.6`
  - `out`:  `/nix/store/8d9mq5kfgm3slji8gg91lah0waw7n7jq-hoodle-render-0.6`
...
- [[xnii8fbv724q8bayf7km3fdxm5nn5031-hoodle-render-0.6.tar.gz]]
