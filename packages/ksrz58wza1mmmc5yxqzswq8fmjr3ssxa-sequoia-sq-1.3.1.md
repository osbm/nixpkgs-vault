...
Command line application exposing a useful set of OpenPGP functionality for common tasks
...
- **Homepage**: [https://sequoia-pgp.org/](https://sequoia-pgp.org/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/ksrz58wza1mmmc5yxqzswq8fmjr3ssxa-sequoia-sq-1.3.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/se/sequoia-sq/package.nix:64`
- **Outputs**:
  - `out`:  `/nix/store/ksrz58wza1mmmc5yxqzswq8fmjr3ssxa-sequoia-sq-1.3.1`

## 🔗 Dependencies

- [[0f5ann1sgwyp31vlfqqsnr95xzv3mzhf-cargo-1.89.0]]
- [[18lzg5iplx3xnq7xwpllkmx6m9rc4jah-source]]
...
- [[z4g15qgdq2d44wss07wnk17vqrrpcwyp-sequoia-sq-1.3.1-vendor]]
