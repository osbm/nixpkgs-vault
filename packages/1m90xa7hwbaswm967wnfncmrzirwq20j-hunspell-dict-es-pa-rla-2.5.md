...
Hunspell dictionary for Spanish (Panama) from rla

## 📋 Package Information

- **Name**: `hunspellDicts.es_PA`
- **Version**: `2.5`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Hunspell dictionary for Spanish (Panama) from rla
...
- **Derivation Path**: `/nix/store/1m90xa7hwbaswm967wnfncmrzirwq20j-hunspell-dict-es-pa-rla-2.5.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/hu/hunspell/dictionaries.nix:68`
- **Outputs**:
  - `out`:  `/nix/store/1m90xa7hwbaswm967wnfncmrzirwq20j-hunspell-dict-es-pa-rla-2.5`
