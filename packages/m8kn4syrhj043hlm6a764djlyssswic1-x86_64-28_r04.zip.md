---
aliases:
  - androidenv.androidPkgs.all.system-images.v28.default.x86_64
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.system-images.v28.default.x86_64`
- **Version**: `28_r04.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/m8kn4syrhj043hlm6a764djlyssswic1-x86_64-28_r04.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/m8kn4syrhj043hlm6a764djlyssswic1-x86_64-28_r04.zip`
