...
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Implementation of the SSH protocol with GSSAPI support
...
- **Derivation Path**: `/nix/store/hwagk49rcfin822mla1ngh3y391cgnxf-openssh-with-gssapi-10.0p2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/tools/networking/openssh/common.nix:250`
- **Outputs**:
  - `out`:  `/nix/store/hwagk49rcfin822mla1ngh3y391cgnxf-openssh-with-gssapi-10.0p2`
...
- [[p32pjnhwaak1a7yimqvb992ils4rb0jx-openssh-gssapi.patch]]
