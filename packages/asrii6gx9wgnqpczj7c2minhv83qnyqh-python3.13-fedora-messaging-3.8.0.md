...
- **Name**: `python313Packages.fedora-messaging`
- **Version**: `3.8.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Library for sending AMQP messages with JSON schema in Fedora infrastructure
- **Homepage**: [https://github.com/fedora-infra/fedora-messaging](https://github.com/fedora-infra/fedora-messaging)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/asrii6gx9wgnqpczj7c2minhv83qnyqh-python3.13-fedora-messaging-3.8.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/fedora-messaging/default.nix:59`
- **Outputs**:
  - `dist`:  `/nix/store/asrii6gx9wgnqpczj7c2minhv83qnyqh-python3.13-fedora-messaging-3.8.0`
  - `out`:  `/nix/store/asrii6gx9wgnqpczj7c2minhv83qnyqh-python3.13-fedora-messaging-3.8.0`
...
- [[gsxq4gp14qnp6bq1rwzq8sls657vp029-python3.13-pika-1.3.2]]
- [[h1f0mlj4cqb9aarl70ap31l2n6ywxr5y-python3.13-blinker-1.9.0]]
- [[jmg2c7bm1cbc0akgbbpjmrbsn792vw86-pytest-check-hook]]
- [[lkdfb9w1jw8x5anmf2amfq5k1gmphyqi-source]]
...
- [[x9kmmyg8cav0rxm2w2iblysn9x0kzghy-python3.13-crochet-2.1.1]]
