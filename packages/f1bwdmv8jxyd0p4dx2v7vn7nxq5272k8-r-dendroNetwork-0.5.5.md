...
- **Name**: `rPackages.dendroNetwork`
- **Version**: `0.5.5`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/dendroNetwork/](https://cran.r-project.org/web/packages/dendroNetwork/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/f1bwdmv8jxyd0p4dx2v7vn7nxq5272k8-r-dendroNetwork-0.5.5.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/f1bwdmv8jxyd0p4dx2v7vn7nxq5272k8-r-dendroNetwork-0.5.5`
...
- [[v5hlmag5gc4nj9k2scgn2lw30zwf6bwp-dendroNetwork_0.5.5.tar.gz]]
