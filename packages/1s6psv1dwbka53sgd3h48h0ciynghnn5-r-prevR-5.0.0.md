...
- **Name**: `rPackages.prevR`
- **Version**: `5.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/prevR/](https://cran.r-project.org/web/packages/prevR/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/1s6psv1dwbka53sgd3h48h0ciynghnn5-r-prevR-5.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/1s6psv1dwbka53sgd3h48h0ciynghnn5-r-prevR-5.0.0`

## 🔗 Dependencies

- [[8l2dgiy0lna0ib6hag4arykyh3z0yjn8-prevR_5.0.0.tar.gz]]
