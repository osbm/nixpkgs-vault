...
- **Name**: `haskellPackages.tesla`
- **Version**: `0.7.5.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Tesla API client
- **Homepage**: [https://hackage.haskell.org/package/tesla](https://hackage.haskell.org/package/tesla)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/x9xm7ylyq7hjgpigmqgsa6ak1fbvifh8-tesla-0.7.5.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:664668`
- **Outputs**:
  - `doc`:  `/nix/store/x9xm7ylyq7hjgpigmqgsa6ak1fbvifh8-tesla-0.7.5.0`
  - `out`:  `/nix/store/x9xm7ylyq7hjgpigmqgsa6ak1fbvifh8-tesla-0.7.5.0`

## 🔗 Dependencies

- [[0q2kplqph4y18f7pc3f2h3266raqnra3-tesla-0.7.5.0.tar.gz]]
