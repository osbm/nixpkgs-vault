...
- **Name**: `linuxKernel.kernels.linux_6_1`
- **Version**: `6.1.153`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/kiwlzf58gnbl6519hdnck7bp8bx5zb18-linux-6.1.153.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/kernel/mainline.nix:34`
- **Outputs**:
  - `dev`:  `/nix/store/kiwlzf58gnbl6519hdnck7bp8bx5zb18-linux-6.1.153`
  - `modules`:  `/nix/store/kiwlzf58gnbl6519hdnck7bp8bx5zb18-linux-6.1.153`
  - `out`:  `/nix/store/kiwlzf58gnbl6519hdnck7bp8bx5zb18-linux-6.1.153`
...
- [[9m61bflskl40gnhifmkfzdmdrnfnyzaf-linux-config-6.1.153]]
