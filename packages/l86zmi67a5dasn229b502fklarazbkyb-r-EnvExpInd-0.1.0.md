...
- **Name**: `rPackages.EnvExpInd`
- **Version**: `0.1.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://cran.r-project.org/web/packages/EnvExpInd/](https://cran.r-project.org/web/packages/EnvExpInd/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/l86zmi67a5dasn229b502fklarazbkyb-r-EnvExpInd-0.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/l86zmi67a5dasn229b502fklarazbkyb-r-EnvExpInd-0.1.0`
...
- [[fv998zzdyfiiikng3dqz0akrn53j4v02-EnvExpInd_0.1.0.tar.gz]]
