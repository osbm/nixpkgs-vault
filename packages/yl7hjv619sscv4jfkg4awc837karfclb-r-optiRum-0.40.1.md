...
- **Name**: `rPackages.optiRum`
- **Version**: `0.40.1`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://cran.r-project.org/web/packages/optiRum/](https://cran.r-project.org/web/packages/optiRum/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/yl7hjv619sscv4jfkg4awc837karfclb-r-optiRum-0.40.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/yl7hjv619sscv4jfkg4awc837karfclb-r-optiRum-0.40.1`

## 🔗 Dependencies

- [[144s79h8fzn6k0dpfy02hnaj62l83l86-optiRum_0.40.1.tar.gz]]
