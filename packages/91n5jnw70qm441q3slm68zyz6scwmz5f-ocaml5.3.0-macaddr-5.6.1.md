...
Library for manipulation of MAC address representations

## 📋 Package Information

- **Name**: `ocamlPackages.macaddr`
- **Version**: `5.6.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/91n5jnw70qm441q3slm68zyz6scwmz5f-ocaml5.3.0-macaddr-5.6.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/ocaml-modules/macaddr/default.nix:29`
- **Outputs**:
  - `out`:  `/nix/store/91n5jnw70qm441q3slm68zyz6scwmz5f-ocaml5.3.0-macaddr-5.6.1`
