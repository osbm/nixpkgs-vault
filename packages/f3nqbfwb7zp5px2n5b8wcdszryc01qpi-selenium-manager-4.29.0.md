...
- **Homepage**: [https://github.com/SeleniumHQ/selenium](https://github.com/SeleniumHQ/selenium)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/f3nqbfwb7zp5px2n5b8wcdszryc01qpi-selenium-manager-4.29.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/se/selenium-manager/package.nix:32`
- **Outputs**:
  - `out`:  `/nix/store/f3nqbfwb7zp5px2n5b8wcdszryc01qpi-selenium-manager-4.29.0`
...
- [[3vmn5fjjx6rypvv6ksxsc55a0bjpjf5h-selenium-manager-4.29.0-vendor]]
...
- `/nix/store/1c9hlb8nm2qsj6bkisig215y2mcfv6i7-disable-telemetry.patch`
