...
- **Name**: `haskellPackages.synthesizer`
- **Version**: `0.2.0.1`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Audio signal processing coded in Haskell
- **Homepage**: [https://hackage.haskell.org/package/synthesizer](https://hackage.haskell.org/package/synthesizer)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/5ayyjad5sy6szkvf68df248ppawi2h0h-synthesizer-0.2.0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:652452`
- **Outputs**:
  - `doc`:  `/nix/store/5ayyjad5sy6szkvf68df248ppawi2h0h-synthesizer-0.2.0.1`
  - `out`:  `/nix/store/5ayyjad5sy6szkvf68df248ppawi2h0h-synthesizer-0.2.0.1`
...
- [[qh9yc5xpxvkv2hxmif3x09xw4jrmh3h6-synthesizer-0.2.0.1.tar.gz]]
