...
- **Name**: `python313Packages.http-sf`
- **Version**: `1.0.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/frslrcjjzlbg6flml4q1nmc5j10dy2b1-python3.13-http-sf-1.0.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/http-sf/default.nix:34`
- **Outputs**:
  - `dist`:  `/nix/store/frslrcjjzlbg6flml4q1nmc5j10dy2b1-python3.13-http-sf-1.0.4`
  - `out`:  `/nix/store/frslrcjjzlbg6flml4q1nmc5j10dy2b1-python3.13-http-sf-1.0.4`
