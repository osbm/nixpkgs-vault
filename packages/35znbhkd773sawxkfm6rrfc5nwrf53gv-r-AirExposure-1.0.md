...
- **Name**: `rPackages.AirExposure`
- **Version**: `1.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/AirExposure/](https://cran.r-project.org/web/packages/AirExposure/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/35znbhkd773sawxkfm6rrfc5nwrf53gv-r-AirExposure-1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/35znbhkd773sawxkfm6rrfc5nwrf53gv-r-AirExposure-1.0`

## 🔗 Dependencies

- [[1gjf3ssfjpwpp5h94a23n3kzicfypm16-r-htmlwidgets-1.6.4]]
- [[4z93mh5b29ill7rrmzzf3f4k0ncf9a20-AirExposure_1.0.tar.gz]]
