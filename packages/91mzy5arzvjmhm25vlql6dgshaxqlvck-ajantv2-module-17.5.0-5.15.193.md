---
aliases:
  - linuxKernel.packages.linux_5_15.ajantv2
tags:
  - license/unknown
  - maintainers/lukegb
  - outputs/out
...
- **Name**: `linuxKernel.packages.linux_5_15.ajantv2`
- **Version**: `17.5.0-5.15.193`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/91mzy5arzvjmhm25vlql6dgshaxqlvck-ajantv2-module-17.5.0-5.15.193.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/ajantv2/default.nix:45`
- **Outputs**:
  - `out`:  `/nix/store/91mzy5arzvjmhm25vlql6dgshaxqlvck-ajantv2-module-17.5.0-5.15.193`
