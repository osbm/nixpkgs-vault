...
- **Name**: `haskellPackages.hstzaar`
- **Version**: `0.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: A two player abstract strategy game
- **Homepage**: [https://hackage.haskell.org/package/hstzaar](https://hackage.haskell.org/package/hstzaar)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/55kk3zvalivalz4qcbmhllss0ady2ixb-hstzaar-0.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:358148`
- **Outputs**:
  - `data`:  `/nix/store/55kk3zvalivalz4qcbmhllss0ady2ixb-hstzaar-0.9.4`
  - `doc`:  `/nix/store/55kk3zvalivalz4qcbmhllss0ady2ixb-hstzaar-0.9.4`
  - `out`:  `/nix/store/55kk3zvalivalz4qcbmhllss0ady2ixb-hstzaar-0.9.4`

## 🔗 Dependencies

- [[2ajvn407r7w37qc7rzklb56ldjip3rfj-parallel-3.2.2.0]]
- [[36fq3wzqcmb9hrc7qq8zani0k5np2j43-hstzaar-0.9.4.tar.gz]]
