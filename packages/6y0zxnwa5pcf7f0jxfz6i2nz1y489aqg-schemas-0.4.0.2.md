...
- **Name**: `haskellPackages.schemas`
- **Version**: `0.4.0.2`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: schema guided serialization
- **Homepage**: [https://hackage.haskell.org/package/schemas](https://hackage.haskell.org/package/schemas)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/6y0zxnwa5pcf7f0jxfz6i2nz1y489aqg-schemas-0.4.0.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:587956`
- **Outputs**:
  - `doc`:  `/nix/store/6y0zxnwa5pcf7f0jxfz6i2nz1y489aqg-schemas-0.4.0.2`
  - `out`:  `/nix/store/6y0zxnwa5pcf7f0jxfz6i2nz1y489aqg-schemas-0.4.0.2`
...
- [[grgxngll4a4va109vijkx0c9m9rmhyqs-schemas-0.4.0.2.tar.gz]]
