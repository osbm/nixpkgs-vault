---
aliases:
  - androidenv.androidPkgs.all.addons.v22.google_apis
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.addons.v22.google_apis`
- **Version**: `22_r01.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/vp3s1wr3g20ymszkrb1klsrqijb968fk-google_apis-22_r01.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/vp3s1wr3g20ymszkrb1klsrqijb968fk-google_apis-22_r01.zip`
