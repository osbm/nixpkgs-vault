...
- **Name**: `php81Extensions.filter`
- **Version**: `8.1.33`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: PHP upstream extension: filter
...
- **Derivation Path**: `/nix/store/pm4cm4hnsc7m7d4lks228qk9qzf51v59-php-filter-8.1.33.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/top-level/php-packages.nix:206`
- **Outputs**:
  - `dev`:  `/nix/store/pm4cm4hnsc7m7d4lks228qk9qzf51v59-php-filter-8.1.33`
  - `out`:  `/nix/store/pm4cm4hnsc7m7d4lks228qk9qzf51v59-php-filter-8.1.33`
