...
- **Name**: `haskellPackages.fibon`
- **Version**: `0.2.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Tools for running and analyzing Haskell benchmarks
- **Homepage**: [https://hackage.haskell.org/package/fibon](https://hackage.haskell.org/package/fibon)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/g5k5dzxwjjszy4zbgffmmbnd4is37y49-fibon-0.2.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:232354`
- **Outputs**:
  - `doc`:  `/nix/store/g5k5dzxwjjszy4zbgffmmbnd4is37y49-fibon-0.2.0`
  - `out`:  `/nix/store/g5k5dzxwjjszy4zbgffmmbnd4is37y49-fibon-0.2.0`
...
- [[s6y32xqnbhzc7zvz41ic1rcc21j3ajzj-fibon-0.2.0.tar.gz]]
