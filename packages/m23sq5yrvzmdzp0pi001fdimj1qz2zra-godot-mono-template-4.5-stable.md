...
- **Name**: `godotPackages.export-template-mono`
- **Version**: `4.5-stable`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/m23sq5yrvzmdzp0pi001fdimj1qz2zra-godot-mono-template-4.5-stable.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/tools/godot/common.nix:564`
- **Outputs**:
  - `debug`:  `/nix/store/m23sq5yrvzmdzp0pi001fdimj1qz2zra-godot-mono-template-4.5-stable`
  - `out`:  `/nix/store/m23sq5yrvzmdzp0pi001fdimj1qz2zra-godot-mono-template-4.5-stable`
...
- [[i065mkbzb36j0r1kc31qvnxli34fbsr6-source]]
...
- `/nix/store/il8ir34nvlzv0x8z42jrwgb3ka0dsjvs-fix-freetype-link-error.patch`
