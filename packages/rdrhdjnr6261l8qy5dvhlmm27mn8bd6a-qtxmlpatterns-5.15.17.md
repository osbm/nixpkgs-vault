...
- **Name**: `libsForQt5.qt5.qtxmlpatterns`
- **Version**: `5.15.17`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/rdrhdjnr6261l8qy5dvhlmm27mn8bd6a-qtxmlpatterns-5.15.17.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/libraries/qt-5/qtModule.nix:113`
- **Outputs**:
  - `dev`:  `/nix/store/rdrhdjnr6261l8qy5dvhlmm27mn8bd6a-qtxmlpatterns-5.15.17`
  - `out`:  `/nix/store/rdrhdjnr6261l8qy5dvhlmm27mn8bd6a-qtxmlpatterns-5.15.17`
...
- [[pwxxbi2qkc5ngmi9swmsz4bv8d5y2nci-qtxmlpatterns-e645537]]
