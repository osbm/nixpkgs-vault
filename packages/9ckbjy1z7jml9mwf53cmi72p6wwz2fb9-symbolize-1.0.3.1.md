...
- **Name**: `haskellPackages.symbolize`
- **Version**: `1.0.3.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Efficient global Symbol table, with Garbage Collection
- **Homepage**: [https://hackage.haskell.org/package/symbolize](https://hackage.haskell.org/package/symbolize)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/9ckbjy1z7jml9mwf53cmi72p6wwz2fb9-symbolize-1.0.3.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:651404`
- **Outputs**:
  - `doc`:  `/nix/store/9ckbjy1z7jml9mwf53cmi72p6wwz2fb9-symbolize-1.0.3.1`
  - `out`:  `/nix/store/9ckbjy1z7jml9mwf53cmi72p6wwz2fb9-symbolize-1.0.3.1`
...
- [[lrwyz70506ivlx4hspka6kc7cjg1y0ar-symbolize-1.0.3.1.tar.gz]]
