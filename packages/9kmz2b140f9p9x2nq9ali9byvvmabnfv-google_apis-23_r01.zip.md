---
aliases:
  - androidenv.androidPkgs.all.addons.v23.google_apis
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.addons.v23.google_apis`
- **Version**: `23_r01.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/9kmz2b140f9p9x2nq9ali9byvvmabnfv-google_apis-23_r01.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/9kmz2b140f9p9x2nq9ali9byvvmabnfv-google_apis-23_r01.zip`
