...
- **Name**: `linuxKernel.packages.linux_lqx.ch9344`
- **Version**: `2.3`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/5a9rx5y728h3a52f0gsxp9kld8ik6nyy-ch9344-2.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/ch9344/default.nix:46`
- **Outputs**:
  - `out`:  `/nix/store/5a9rx5y728h3a52f0gsxp9kld8ik6nyy-ch9344-2.3`
