...
- **Name**: `haskellPackages.xml-to-json`
- **Version**: `2.0.1`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Library and command line tool for converting XML files to json
- **Homepage**: [https://hackage.haskell.org/package/xml-to-json](https://hackage.haskell.org/package/xml-to-json)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/15j4sg106k5skgsc3wql2mbcvp0mpqkc-xml-to-json-2.0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:732014`
- **Outputs**:
  - `doc`:  `/nix/store/15j4sg106k5skgsc3wql2mbcvp0mpqkc-xml-to-json-2.0.1`
  - `out`:  `/nix/store/15j4sg106k5skgsc3wql2mbcvp0mpqkc-xml-to-json-2.0.1`
...
- [[m7jshz23kc67xgbbgjywrpfrrc3im0wp-xml-to-json-2.0.1.tar.gz]]
- [[p76r0cwlf6k97ibprrpfd8xw0r8wc3nx-stdenv-linux]]
- [[qk5n706ywx55qjqbyydmig91p7pmavhh-hxt-expat-9.1.1]]
