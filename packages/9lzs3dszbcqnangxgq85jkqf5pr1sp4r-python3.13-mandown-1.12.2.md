...
- **Derivation Path**: `/nix/store/9lzs3dszbcqnangxgq85jkqf5pr1sp4r-python3.13-mandown-1.12.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/mandown/default.nix:66`
- **Outputs**:
  - `dist`:  `/nix/store/9lzs3dszbcqnangxgq85jkqf5pr1sp4r-python3.13-mandown-1.12.2`
  - `out`:  `/nix/store/9lzs3dszbcqnangxgq85jkqf5pr1sp4r-python3.13-mandown-1.12.2`
