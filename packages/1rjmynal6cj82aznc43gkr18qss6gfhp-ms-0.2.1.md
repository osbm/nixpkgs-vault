...
- **Name**: `haskellPackages.ms`
- **Version**: `0.2.1`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: metric spaces
- **Homepage**: [https://hackage.haskell.org/package/ms](https://hackage.haskell.org/package/ms)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/1rjmynal6cj82aznc43gkr18qss6gfhp-ms-0.2.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:462205`
- **Outputs**:
  - `doc`:  `/nix/store/1rjmynal6cj82aznc43gkr18qss6gfhp-ms-0.2.1`
  - `out`:  `/nix/store/1rjmynal6cj82aznc43gkr18qss6gfhp-ms-0.2.1`
...
- [[mlsf4psmh37mmw0yk7wm9c4zmill7dyx-ms-0.2.1.tar.gz]]
