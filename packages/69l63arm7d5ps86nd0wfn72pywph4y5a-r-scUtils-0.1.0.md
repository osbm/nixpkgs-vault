...
- **Name**: `rPackages.scUtils`
- **Version**: `0.1.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/scUtils/](https://cran.r-project.org/web/packages/scUtils/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/69l63arm7d5ps86nd0wfn72pywph4y5a-r-scUtils-0.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/69l63arm7d5ps86nd0wfn72pywph4y5a-r-scUtils-0.1.0`
...
- [[qnc1c1iskds855f3mycdnfc5ixbgpyr2-scUtils_0.1.0.tar.gz]]
