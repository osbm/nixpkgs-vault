...
- **Name**: `python312Packages.osc-placement`
- **Version**: `4.7.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/kc2iz6iwy0k1yvlp4wb2s0h8kms59cz0-python3.12-osc-placement-4.7.0.drv`
...
- **Outputs**:
  - `dist`:  `/nix/store/kc2iz6iwy0k1yvlp4wb2s0h8kms59cz0-python3.12-osc-placement-4.7.0`
  - `out`:  `/nix/store/kc2iz6iwy0k1yvlp4wb2s0h8kms59cz0-python3.12-osc-placement-4.7.0`
