...
- **Name**: `haskellPackages.nm`
- **Version**: `1.0.1`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Network Manager, binding to libnm-glib
- **Homepage**: [https://hackage.haskell.org/package/nm](https://hackage.haskell.org/package/nm)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/9c73kz8ndhn27vrin34z9km89i6kqixi-nm-1.0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:480073`
- **Outputs**:
  - `doc`:  `/nix/store/9c73kz8ndhn27vrin34z9km89i6kqixi-nm-1.0.1`
  - `out`:  `/nix/store/9c73kz8ndhn27vrin34z9km89i6kqixi-nm-1.0.1`
...
- [[sm8qyfs7f7ijw39k8wa98blc7clqrd7p-nm-1.0.1.tar.gz]]
