...
- **Name**: `haskellPackages.generic-persistence`
- **Version**: `0.7.0.1`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Database persistence using generics
- **Homepage**: [https://hackage.haskell.org/package/generic-persistence](https://hackage.haskell.org/package/generic-persistence)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/lgpm35fwj4xzraa1mwlp5wp4jl5nc8ql-generic-persistence-0.7.0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:253627`
- **Outputs**:
  - `doc`:  `/nix/store/lgpm35fwj4xzraa1mwlp5wp4jl5nc8ql-generic-persistence-0.7.0.1`
  - `out`:  `/nix/store/lgpm35fwj4xzraa1mwlp5wp4jl5nc8ql-generic-persistence-0.7.0.1`

## 🔗 Dependencies

- [[0yrz11qijjkr0bd3s76dfbdvgn2inmlg-hspec-discover-2.11.12]]
- [[1bhkbazzq78285zwqhxghc5h9q2izz58-generic-persistence-0.7.0.1.tar.gz]]
