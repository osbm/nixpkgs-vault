---
aliases:
  - python312Packages.pytest-regressions
tags:
  - license/unknown
  - outputs/dist
  - outputs/out
...
- **Name**: `python312Packages.pytest-regressions`
- **Version**: `2.8.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/nrs46zywpzaidnjssf9q6dklib2hjsy8-python3.12-pytest-regressions-2.8.1.drv`
...
- **Outputs**:
  - `dist`:  `/nix/store/nrs46zywpzaidnjssf9q6dklib2hjsy8-python3.12-pytest-regressions-2.8.1`
  - `out`:  `/nix/store/nrs46zywpzaidnjssf9q6dklib2hjsy8-python3.12-pytest-regressions-2.8.1`
