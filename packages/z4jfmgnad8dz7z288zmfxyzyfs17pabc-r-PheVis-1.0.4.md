...
- **Name**: `rPackages.PheVis`
- **Version**: `1.0.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/PheVis/](https://cran.r-project.org/web/packages/PheVis/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/z4jfmgnad8dz7z288zmfxyzyfs17pabc-r-PheVis-1.0.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/z4jfmgnad8dz7z288zmfxyzyfs17pabc-r-PheVis-1.0.4`
...
- [[m3dz7jcg2bwbh7wjqah8rx552lfazzvm-PheVis_1.0.4.tar.gz]]
