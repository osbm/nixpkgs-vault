...
- **Name**: `rPackages.cypress`
- **Version**: `1.4.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://bioconductor.org/packages/3.21/bioc/html/cypress.html](https://bioconductor.org/packages/3.21/bioc/html/cypress.html)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/k110ny12fw0zs6abknx017zaribiqlh6-r-cypress-1.4.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/k110ny12fw0zs6abknx017zaribiqlh6-r-cypress-1.4.0`
...
- [[xjlpv5nj4lbbiwcb411mh6r4a1hfgrf0-cypress_1.4.0.tar.gz]]
