...
- **Name**: `rPackages.fcScan`
- **Version**: `1.22.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://bioconductor.org/packages/3.21/bioc/html/fcScan.html](https://bioconductor.org/packages/3.21/bioc/html/fcScan.html)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/4vfqjzhv8qvwjwrnbzkabjg7qr0rklal-r-fcScan-1.22.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/4vfqjzhv8qvwjwrnbzkabjg7qr0rklal-r-fcScan-1.22.0`
...
- [[rzmrajfzfa5xwkcggsh9b5r7ylblf2qh-fcScan_1.22.0.tar.gz]]
