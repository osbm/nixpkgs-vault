...
- **Name**: `rPackages.bidux`
- **Version**: `0.1.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/bidux/](https://cran.r-project.org/web/packages/bidux/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/07q6z0krv5v4h87wvy3gpkpmx3gvs8in-r-bidux-0.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/07q6z0krv5v4h87wvy3gpkpmx3gvs8in-r-bidux-0.1.0`
...
- [[x3l3yh9rqxfnfmb8h06q2vmycrkrc4wh-bidux_0.1.0.tar.gz]]
