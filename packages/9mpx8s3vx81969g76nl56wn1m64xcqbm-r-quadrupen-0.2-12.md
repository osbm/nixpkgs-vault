...
- **Name**: `rPackages.quadrupen`
- **Version**: `0.2-12`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/quadrupen/](https://cran.r-project.org/web/packages/quadrupen/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/9mpx8s3vx81969g76nl56wn1m64xcqbm-r-quadrupen-0.2-12.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/9mpx8s3vx81969g76nl56wn1m64xcqbm-r-quadrupen-0.2-12`
...
- [[gr8z1avgpjx47lpfshinbgqi3dw6irc7-quadrupen_0.2-12.tar.gz]]
