...
- **Name**: `akkuPackages.chez-stats`
- **Version**: `0.1.6`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Read and write delimited text files, compute descriptive statistics, and generate random variates in Chez Scheme.
- **Homepage**: []()
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/5mk8fk91aad2h5x0dqxpdmbhck9r6qz1-akku-chez-stats-0.1.6.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/tools/package-management/akku/default.nix:39`
- **Outputs**:
  - `out`:  `/nix/store/5mk8fk91aad2h5x0dqxpdmbhck9r6qz1-akku-chez-stats-0.1.6`

## 🔗 Dependencies

- [[2jbjfm0s7c03a7mylffys7n228vs64rz-make-shell-wrapper-hook]]
- [[2pljaqx01wyaa2ania8gbjiawnpihvqg-chez-stats_0.1.6_repack.tar.xz]]
