...
- **Name**: `haskellPackages.hdf5`
- **Version**: `1.8.14`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Haskell interface to the HDF5 scientific data storage library
- **Homepage**: [https://hackage.haskell.org/package/hdf5](https://hackage.haskell.org/package/hdf5)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/kn90kd101li5m1103qzqhgsfrnn61sm1-hdf5-1.8.14.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:316856`
- **Outputs**:
  - `doc`:  `/nix/store/kn90kd101li5m1103qzqhgsfrnn61sm1-hdf5-1.8.14`
  - `out`:  `/nix/store/kn90kd101li5m1103qzqhgsfrnn61sm1-hdf5-1.8.14`
...
- [[5vvv7lfd58dd1in9zv34s96c7syrrm5i-hdf5-1.8.14.tar.gz]]
