...
- **Name**: `linuxKernel.packages.linux_5_10.v4l2loopback`
- **Version**: `0.15.1-5.10.244`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/f0pfl17b6zsb5mbamsnc8dhvjyk33w65-v4l2loopback-0.15.1-5.10.244.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/v4l2loopback/default.nix:58`
- **Outputs**:
  - `bin`:  `/nix/store/f0pfl17b6zsb5mbamsnc8dhvjyk33w65-v4l2loopback-0.15.1-5.10.244`
  - `out`:  `/nix/store/f0pfl17b6zsb5mbamsnc8dhvjyk33w65-v4l2loopback-0.15.1-5.10.244`
