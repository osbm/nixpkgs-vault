---
aliases:
  - haskellPackages.predicate-typed
tags:
  - broken
  - not-available
  - license/unknown
...
- **Name**: `haskellPackages.predicate-typed`
- **Version**: `0.7.4.5`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Predicates, Refinement types and Dsl
- **Homepage**: [https://hackage.haskell.org/package/predicate-typed](https://hackage.haskell.org/package/predicate-typed)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/9bhwa8xcm2y33k9ah7bizw51y8342yha-predicate-typed-0.7.4.5.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:535889`
- **Outputs**:
  - `doc`:  `/nix/store/9bhwa8xcm2y33k9ah7bizw51y8342yha-predicate-typed-0.7.4.5`
  - `out`:  `/nix/store/9bhwa8xcm2y33k9ah7bizw51y8342yha-predicate-typed-0.7.4.5`
...
- [[5w7m6mi800xpqjdkkl6i4d3qj3k2dhbi-predicate-typed-0.7.4.5.tar.gz]]
