...
- **Name**: `haskellPackages.hnetcdf`
- **Version**: `0.5.0.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Haskell NetCDF library
- **Homepage**: [https://hackage.haskell.org/package/hnetcdf](https://hackage.haskell.org/package/hnetcdf)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/9v3kx3y1mdmmq3d6c565i4dps6ia83zq-hnetcdf-0.5.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:336722`
- **Outputs**:
  - `data`:  `/nix/store/9v3kx3y1mdmmq3d6c565i4dps6ia83zq-hnetcdf-0.5.0.0`
  - `doc`:  `/nix/store/9v3kx3y1mdmmq3d6c565i4dps6ia83zq-hnetcdf-0.5.0.0`
  - `out`:  `/nix/store/9v3kx3y1mdmmq3d6c565i4dps6ia83zq-hnetcdf-0.5.0.0`

## 🔗 Dependencies

- [[0hprqkz0v90w2cvqz070136bqfvi947r-hnetcdf-0.5.0.0.tar.gz]]
