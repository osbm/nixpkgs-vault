...
- **Name**: `akkuPackages.ip-address`
- **Version**: `1.1.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: IP address parsing and formatting
- **Homepage**: []()
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/2p4r0670pk18nynwqiibbm32gjaibjfd-akku-ip-address-1.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/tools/package-management/akku/default.nix:39`
- **Outputs**:
  - `out`:  `/nix/store/2p4r0670pk18nynwqiibbm32gjaibjfd-akku-ip-address-1.1.0`
...
- [[h84slzh03y4b4lbr6c44p4j3ags1kr93-ip-address_1.1.0_repack.tar.xz]]
