...
- **Name**: `rPackages.NormalityAssessment`
- **Version**: `0.1.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/NormalityAssessment/](https://cran.r-project.org/web/packages/NormalityAssessment/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/gjryf9vgc82vxpv3ri52khlaw8kcx8kw-r-NormalityAssessment-0.1.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/gjryf9vgc82vxpv3ri52khlaw8kcx8kw-r-NormalityAssessment-0.1.1`
...
- [[hgx962q4gwd7w6l9mfp2f604kvf31ckr-NormalityAssessment_0.1.1.tar.gz]]
