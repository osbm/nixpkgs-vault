...
- **Name**: `haskellPackages.metar-http`
- **Version**: `0.0.3`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: HTTP for METAR
- **Homepage**: [https://hackage.haskell.org/package/metar-http](https://hackage.haskell.org/package/metar-http)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/b72jmkb3vc9ap66696llb6s915d385bz-metar-http-0.0.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:445397`
- **Outputs**:
  - `doc`:  `/nix/store/b72jmkb3vc9ap66696llb6s915d385bz-metar-http-0.0.3`
  - `out`:  `/nix/store/b72jmkb3vc9ap66696llb6s915d385bz-metar-http-0.0.3`
...
- [[7xfxac99f7rhdgxrlk06xr3r19xiv8wb-metar-0.0.3]]
...
- [[zli37f97kzz2pnag8zrln9614zkmzrqb-metar-http-0.0.3.tar.gz]]
