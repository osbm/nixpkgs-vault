...
- **Homepage**: [https://codemadness.org/sfeed-simple-feed-parser.html](https://codemadness.org/sfeed-simple-feed-parser.html)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/h3bsy8b9qvhdvxnwk8mqmkncfvd9i1n7-sfeed-2.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/sf/sfeed/package.nix:34`
- **Outputs**:
  - `out`:  `/nix/store/h3bsy8b9qvhdvxnwk8mqmkncfvd9i1n7-sfeed-2.2`

## 🔗 Dependencies

- [[3x9b536jpi37ckghfmn3wprwwzzcgvaw-ncurses-6.5]]
- [[bjsb6wdjykafnkixq156qdvmxhsm2bai-bash-5.3p3]]
- [[mb48wbqj4rvicjzdbbsjmxaq6rsmqc0b-sfeed]]
