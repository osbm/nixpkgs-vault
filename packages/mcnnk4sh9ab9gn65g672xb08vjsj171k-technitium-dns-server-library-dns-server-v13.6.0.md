...
- **Name**: `technitium-dns-server-library`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/mcnnk4sh9ab9gn65g672xb08vjsj171k-technitium-dns-server-library-dns-server-v13.6.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/te/technitium-dns-server-library/package.nix:33`
- **Outputs**:
  - `out`:  `/nix/store/mcnnk4sh9ab9gn65g672xb08vjsj171k-technitium-dns-server-library-dns-server-v13.6.0`
...
- [[0rplfyd1xhkf4nm7fwqawrnd0ngk9kna-technitium-dns-server-library-dns-server-v13.6.0]]
