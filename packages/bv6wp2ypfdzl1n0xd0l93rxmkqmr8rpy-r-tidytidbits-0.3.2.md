...
- **Name**: `rPackages.tidytidbits`
- **Version**: `0.3.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/tidytidbits/](https://cran.r-project.org/web/packages/tidytidbits/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/bv6wp2ypfdzl1n0xd0l93rxmkqmr8rpy-r-tidytidbits-0.3.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/bv6wp2ypfdzl1n0xd0l93rxmkqmr8rpy-r-tidytidbits-0.3.2`
...
- [[mrcnhp6mbpnibz8i7wsx4xr1h378ymna-tidytidbits_0.3.2.tar.gz]]
