...
- **Name**: `haskellPackages.greskell-websocket`
- **Version**: `1.0.0.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Haskell client for Gremlin Server using WebSocket serializer
- **Homepage**: [https://hackage.haskell.org/package/greskell-websocket](https://hackage.haskell.org/package/greskell-websocket)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/y53728xhrgck87fwyyy6zlhrqx2pmrdq-greskell-websocket-1.0.0.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:283532`
- **Outputs**:
  - `doc`:  `/nix/store/y53728xhrgck87fwyyy6zlhrqx2pmrdq-greskell-websocket-1.0.0.4`
  - `out`:  `/nix/store/y53728xhrgck87fwyyy6zlhrqx2pmrdq-greskell-websocket-1.0.0.4`
...
- [[qfx6zcgih22hcw9rr2566z9lm8ss6zir-greskell-websocket-1.0.0.4.tar.gz]]
