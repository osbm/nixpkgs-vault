...
- **Name**: `linuxKernel.packages.linux_libre.zfs_unstable`
...
- **Derivation Path**: `/nix/store/v7z6izn0m7pyn8lvq2cl3627qyrxf1mi-zfs-kernel-2.4.0-rc1-6.12.48.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/zfs/generic.nix:322`
- **Outputs**:
  - `out`:  `/nix/store/v7z6izn0m7pyn8lvq2cl3627qyrxf1mi-zfs-kernel-2.4.0-rc1-6.12.48`
