...
- **Name**: `rPackages.Andromeda`
- **Version**: `1.1.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/Andromeda/](https://cran.r-project.org/web/packages/Andromeda/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/04zsz1n708g30mf27pi2p01mqjvjphyq-r-Andromeda-1.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/04zsz1n708g30mf27pi2p01mqjvjphyq-r-Andromeda-1.1.0`

## 🔗 Dependencies

- [[b66hy4m7nmgkmr42vhw9gyyppaignq6q-Andromeda_1.1.0.tar.gz]]
