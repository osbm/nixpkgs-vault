...
- **Homepage**: [https://pythonqt.sourceforge.net/](https://pythonqt.sourceforge.net/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/x2275qplp3jrnmj6v6ib9l9nd8926id4-python-qt-3.6.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/libraries/python-qt/default.nix:60`
- **Outputs**:
  - `out`:  `/nix/store/x2275qplp3jrnmj6v6ib9l9nd8926id4-python-qt-3.6.1`
