...
- **Name**: `beamMinimal27Packages.elixir`
- **Version**: `1.18.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/k0m147xvm7ns4a4b2ifaq94nqwbz9cn8-elixir-1.18.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/interpreters/elixir/1.18.nix:4`
- **Outputs**:
  - `out`:  `/nix/store/k0m147xvm7ns4a4b2ifaq94nqwbz9cn8-elixir-1.18.4`
