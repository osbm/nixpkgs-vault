...
- **Name**: `haskellPackages.streaming-osm`
- **Version**: `1.0.2`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: A hand-written streaming byte parser for OpenStreetMap Protobuf data
- **Homepage**: [https://hackage.haskell.org/package/streaming-osm](https://hackage.haskell.org/package/streaming-osm)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/6qchsigw3avfijy4szj2wkifbrgww9lw-streaming-osm-1.0.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:639636`
- **Outputs**:
  - `doc`:  `/nix/store/6qchsigw3avfijy4szj2wkifbrgww9lw-streaming-osm-1.0.2`
  - `out`:  `/nix/store/6qchsigw3avfijy4szj2wkifbrgww9lw-streaming-osm-1.0.2`

## 🔗 Dependencies

- [[0fvxjl2098dvx1pm74n6zvhwwdqf8zwd-streaming-osm-1.0.2.tar.gz]]
