...
- **Name**: `haskellPackages.brok`
- **Version**: `1.1.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Finds broken links in text files
- **Homepage**: [https://hackage.haskell.org/package/brok](https://hackage.haskell.org/package/brok)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/ppr8rzqbrxm9szv8jgsyxzjaiq3ga8p0-brok-1.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:116773`
- **Outputs**:
  - `doc`:  `/nix/store/ppr8rzqbrxm9szv8jgsyxzjaiq3ga8p0-brok-1.1.0`
  - `out`:  `/nix/store/ppr8rzqbrxm9szv8jgsyxzjaiq3ga8p0-brok-1.1.0`
...
- [[n9jbnl04z8fspi9kcbsdpp1blbv84pza-brok-1.1.0.tar.gz]]
