...
- **Name**: `python312Packages.ariadne`
- **Version**: `0.26.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Python library for implementing GraphQL servers using schema-first approach
- **Homepage**: [https://ariadnegraphql.org](https://ariadnegraphql.org)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/0sv9ilqzk3xkgjb34m1idfir2dyp4wns-python3.12-ariadne-0.26.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/ariadne/default.nix:79`
- **Outputs**:
  - `dist`:  `/nix/store/0sv9ilqzk3xkgjb34m1idfir2dyp4wns-python3.12-ariadne-0.26.2`
  - `out`:  `/nix/store/0sv9ilqzk3xkgjb34m1idfir2dyp4wns-python3.12-ariadne-0.26.2`
...
- [[spr6qzcdwj9har0p2bclrwc704s6m0v7-source]]
...
- `/nix/store/df7b7frfl7jjbcas460k6fmrjckwli47-remove-opentracing.patch`
