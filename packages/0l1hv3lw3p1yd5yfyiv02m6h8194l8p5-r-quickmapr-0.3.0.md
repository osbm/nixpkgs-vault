...
- **Name**: `rPackages.quickmapr`
- **Version**: `0.3.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://cran.r-project.org/web/packages/quickmapr/](https://cran.r-project.org/web/packages/quickmapr/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/0l1hv3lw3p1yd5yfyiv02m6h8194l8p5-r-quickmapr-0.3.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/0l1hv3lw3p1yd5yfyiv02m6h8194l8p5-r-quickmapr-0.3.0`
...
- [[cwmds7f2rm5w4rwp1zwyjf3jy1y81k7l-quickmapr_0.3.0.tar.gz]]
