...
- **Name**: `llvmPackages_18.clangNoCompilerRtWithLibc`
- **Version**: `18.1.8`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/0hp34hh1svilik7i5cavaxvgmskynzzg-clang-wrapper-18.1.8.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/build-support/cc-wrapper/default.nix:989`
- **Outputs**:
  - `out`:  `/nix/store/0hp34hh1svilik7i5cavaxvgmskynzzg-clang-wrapper-18.1.8`
