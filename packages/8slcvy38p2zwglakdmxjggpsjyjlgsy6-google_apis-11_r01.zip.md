---
aliases:
  - androidenv.androidPkgs.all.addons.v11.google_apis
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.addons.v11.google_apis`
- **Version**: `11_r01.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/8slcvy38p2zwglakdmxjggpsjyjlgsy6-google_apis-11_r01.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/8slcvy38p2zwglakdmxjggpsjyjlgsy6-google_apis-11_r01.zip`
