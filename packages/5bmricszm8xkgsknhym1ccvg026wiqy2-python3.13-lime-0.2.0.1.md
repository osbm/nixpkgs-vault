...
- **Name**: `python313Packages.lime`
- **Version**: `0.2.0.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Local Interpretable Model-Agnostic Explanations for machine learning classifiers
- **Homepage**: [https://github.com/marcotcr/lime](https://github.com/marcotcr/lime)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/5bmricszm8xkgsknhym1ccvg026wiqy2-python3.13-lime-0.2.0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/lime/default.nix:59`
- **Outputs**:
  - `dist`:  `/nix/store/5bmricszm8xkgsknhym1ccvg026wiqy2-python3.13-lime-0.2.0.1`
  - `out`:  `/nix/store/5bmricszm8xkgsknhym1ccvg026wiqy2-python3.13-lime-0.2.0.1`
...
- [[p3a6yf6hvcalzb1w1q23dmmjnl2kqglr-lime-0.2.0.1.tar.gz]]
