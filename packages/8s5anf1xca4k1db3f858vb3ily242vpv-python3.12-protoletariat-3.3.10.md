---
aliases:
  - python312Packages.protoletariat
tags:
  - license/unknown
...
- **Name**: `python312Packages.protoletariat`
- **Version**: `3.3.10`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/8s5anf1xca4k1db3f858vb3ily242vpv-python3.12-protoletariat-3.3.10.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/protoletariat/default.nix:54`
- **Outputs**:
  - `dist`:  `/nix/store/8s5anf1xca4k1db3f858vb3ily242vpv-python3.12-protoletariat-3.3.10`
  - `out`:  `/nix/store/8s5anf1xca4k1db3f858vb3ily242vpv-python3.12-protoletariat-3.3.10`
...
- [[zz9f2qspv0x4ilm9xy0fr5i1rw1k9iwy-source]]
