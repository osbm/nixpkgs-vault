...
- **Name**: `rPackages.interfacer`
- **Version**: `0.3.3`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/interfacer/](https://cran.r-project.org/web/packages/interfacer/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/5ipvdf9vx6mnfvg6mvmi2rwp2wyksgiv-r-interfacer-0.3.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/5ipvdf9vx6mnfvg6mvmi2rwp2wyksgiv-r-interfacer-0.3.3`
...
- [[rpy5ap95zdnmjbd4kqff3496kgi40kaz-interfacer_0.3.3.tar.gz]]
