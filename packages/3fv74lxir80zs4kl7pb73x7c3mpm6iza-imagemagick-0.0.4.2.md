...
- **Name**: `haskellPackages.imagemagick`
- **Version**: `0.0.4.2`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: bindings to imagemagick library
- **Homepage**: [https://hackage.haskell.org/package/imagemagick](https://hackage.haskell.org/package/imagemagick)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/3fv74lxir80zs4kl7pb73x7c3mpm6iza-imagemagick-0.0.4.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:374924`
- **Outputs**:
  - `doc`:  `/nix/store/3fv74lxir80zs4kl7pb73x7c3mpm6iza-imagemagick-0.0.4.2`
  - `out`:  `/nix/store/3fv74lxir80zs4kl7pb73x7c3mpm6iza-imagemagick-0.0.4.2`
...
- [[mskfr5iggb2jr7jjvc0fa1y8qsmkqiyh-imagemagick-0.0.4.2.tar.gz]]
