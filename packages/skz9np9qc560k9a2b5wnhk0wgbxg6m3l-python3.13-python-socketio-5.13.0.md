...
- **Name**: `python313Packages.python-socketio`
- **Version**: `5.13.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/skz9np9qc560k9a2b5wnhk0wgbxg6m3l-python3.13-python-socketio-5.13.0.drv`
...
- **Outputs**:
  - `dist`:  `/nix/store/skz9np9qc560k9a2b5wnhk0wgbxg6m3l-python3.13-python-socketio-5.13.0`
  - `out`:  `/nix/store/skz9np9qc560k9a2b5wnhk0wgbxg6m3l-python3.13-python-socketio-5.13.0`
