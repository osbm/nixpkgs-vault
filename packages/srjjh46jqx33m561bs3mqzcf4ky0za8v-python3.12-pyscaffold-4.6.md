...
- **Name**: `python312Packages.pyscaffold`
- **Version**: `4.6`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Template tool for putting up the scaffold of a Python project
- **Homepage**: [https://pypi.org/project/PyScaffold/](https://pypi.org/project/PyScaffold/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/srjjh46jqx33m561bs3mqzcf4ky0za8v-python3.12-pyscaffold-4.6.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/pyscaffold/default.nix:99`
- **Outputs**:
  - `dist`:  `/nix/store/srjjh46jqx33m561bs3mqzcf4ky0za8v-python3.12-pyscaffold-4.6`
  - `out`:  `/nix/store/srjjh46jqx33m561bs3mqzcf4ky0za8v-python3.12-pyscaffold-4.6`
...
- [[lsc4wml3zbnxf3r77gidiyw4av1jqdnv-pyscaffold-4.6.tar.gz]]
