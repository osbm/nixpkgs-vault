...
- **Name**: `haskellPackages.raft`
- **Version**: `0.4.0.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Miscellaneous Haskell utilities for data structures and data manipulation
- **Homepage**: [https://hackage.haskell.org/package/raft](https://hackage.haskell.org/package/raft)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/3rq5519g86rah911cr6rj1zax9gha9j5-raft-0.4.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:554965`
- **Outputs**:
  - `doc`:  `/nix/store/3rq5519g86rah911cr6rj1zax9gha9j5-raft-0.4.0.0`
  - `out`:  `/nix/store/3rq5519g86rah911cr6rj1zax9gha9j5-raft-0.4.0.0`
...
- [[rjbrxkg01mav8pdzz4hdp8wq5ivazmjd-raft-0.4.0.0.tar.gz]]
