...
- **Name**: `llvmPackages.mlir`
- **Version**: `19.1.7`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Multi-Level IR Compiler Framework
- **Homepage**: [https://mlir.llvm.org/](https://mlir.llvm.org/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/gz45rcxz4axay9sgksfns5kryq7j13zk-mlir-19.1.7.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/compilers/llvm/common/mlir/default.nix:86`
- **Outputs**:
  - `dev`:  `/nix/store/gz45rcxz4axay9sgksfns5kryq7j13zk-mlir-19.1.7`
  - `out`:  `/nix/store/gz45rcxz4axay9sgksfns5kryq7j13zk-mlir-19.1.7`
...
- [[angsdnm92ndalb5c63f1ih7xippwbhz6-mlir-src-19.1.7]]
...
- `/nix/store/jfdbx262zliziiad6brgyavzn0vqigif-gnu-install-dirs.patch`
