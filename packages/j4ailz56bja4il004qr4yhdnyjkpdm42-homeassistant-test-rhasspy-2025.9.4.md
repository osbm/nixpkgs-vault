---
aliases:
  - home-assistant-component-tests.rhasspy
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.rhasspy`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/j4ailz56bja4il004qr4yhdnyjkpdm42-homeassistant-test-rhasspy-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/j4ailz56bja4il004qr4yhdnyjkpdm42-homeassistant-test-rhasspy-2025.9.4`
