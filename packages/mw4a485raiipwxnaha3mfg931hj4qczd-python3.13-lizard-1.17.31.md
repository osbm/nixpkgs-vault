...
- **Name**: `python313Packages.lizard`
- **Version**: `1.17.31`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Code analyzer without caring the C/C++ header files
- **Homepage**: [http://www.lizard.ws](http://www.lizard.ws)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/mw4a485raiipwxnaha3mfg931hj4qczd-python3.13-lizard-1.17.31.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/lizard/default.nix:46`
- **Outputs**:
  - `dist`:  `/nix/store/mw4a485raiipwxnaha3mfg931hj4qczd-python3.13-lizard-1.17.31`
  - `out`:  `/nix/store/mw4a485raiipwxnaha3mfg931hj4qczd-python3.13-lizard-1.17.31`
...
- [[mhiwvcv7cz69igkmqgi70bc1q1w7n6ca-source]]
