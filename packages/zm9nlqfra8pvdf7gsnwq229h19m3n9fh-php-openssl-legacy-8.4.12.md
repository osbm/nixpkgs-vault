...
- **Name**: `php84Extensions.openssl-legacy`
- **Version**: `8.4.12`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/zm9nlqfra8pvdf7gsnwq229h19m3n9fh-php-openssl-legacy-8.4.12.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/top-level/php-packages.nix:206`
- **Outputs**:
  - `dev`:  `/nix/store/zm9nlqfra8pvdf7gsnwq229h19m3n9fh-php-openssl-legacy-8.4.12`
  - `out`:  `/nix/store/zm9nlqfra8pvdf7gsnwq229h19m3n9fh-php-openssl-legacy-8.4.12`
