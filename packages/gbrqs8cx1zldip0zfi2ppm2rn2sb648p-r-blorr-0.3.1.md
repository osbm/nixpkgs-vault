...
- **Name**: `rPackages.blorr`
- **Version**: `0.3.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/blorr/](https://cran.r-project.org/web/packages/blorr/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/gbrqs8cx1zldip0zfi2ppm2rn2sb648p-r-blorr-0.3.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/gbrqs8cx1zldip0zfi2ppm2rn2sb648p-r-blorr-0.3.1`

## 🔗 Dependencies

- [[2mvcmadpg0xm7365sm4ssfs1p5gmx9ff-blorr_0.3.1.tar.gz]]
