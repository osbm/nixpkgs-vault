...
- **Name**: `rPackages.gesttools`
- **Version**: `1.3.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://cran.r-project.org/web/packages/gesttools/](https://cran.r-project.org/web/packages/gesttools/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/hsrllmpfkb021iscx1nvdkizsiymh6cq-r-gesttools-1.3.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/hsrllmpfkb021iscx1nvdkizsiymh6cq-r-gesttools-1.3.0`
...
- [[k9y0x2gfa9yvxxvyngvlsz1iph7g5bn8-gesttools_1.3.0.tar.gz]]
