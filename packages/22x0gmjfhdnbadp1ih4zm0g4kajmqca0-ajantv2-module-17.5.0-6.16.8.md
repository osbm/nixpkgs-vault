---
aliases:
  - linuxKernel.packages.linux_latest_libre.ajantv2
tags:
  - license/unknown
  - maintainers/lukegb
  - outputs/out
...
- **Name**: `linuxKernel.packages.linux_latest_libre.ajantv2`
- **Version**: `17.5.0-6.16.8`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/22x0gmjfhdnbadp1ih4zm0g4kajmqca0-ajantv2-module-17.5.0-6.16.8.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/ajantv2/default.nix:45`
- **Outputs**:
  - `out`:  `/nix/store/22x0gmjfhdnbadp1ih4zm0g4kajmqca0-ajantv2-module-17.5.0-6.16.8`
