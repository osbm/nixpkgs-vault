...
- **Name**: `rPackages.randomForestExplainer`
- **Version**: `0.10.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/randomForestExplainer/](https://cran.r-project.org/web/packages/randomForestExplainer/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/2zf30jpnahqygx9gcm5jx59kyyvhx6pr-r-randomForestExplainer-0.10.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/2zf30jpnahqygx9gcm5jx59kyyvhx6pr-r-randomForestExplainer-0.10.1`
...
- [[pxv3ng7n68xsxrn7lr9mbcqri0hzn71v-randomForestExplainer_0.10.1.tar.gz]]
