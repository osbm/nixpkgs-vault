...
- **Name**: `haskellPackages.vgrep`
- **Version**: `0.2.3.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: A pager for grep
- **Homepage**: [https://hackage.haskell.org/package/vgrep](https://hackage.haskell.org/package/vgrep)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/y3i6khc9y8s31r07bs33ycln71zzbcpa-vgrep-0.2.3.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:708116`
- **Outputs**:
  - `doc`:  `/nix/store/y3i6khc9y8s31r07bs33ycln71zzbcpa-vgrep-0.2.3.0`
  - `out`:  `/nix/store/y3i6khc9y8s31r07bs33ycln71zzbcpa-vgrep-0.2.3.0`
...
- [[p46dqk9zmawsjliaf16cx00n0grr7gy3-vgrep-0.2.3.0-r2.cabal]]
...
- [[wmfr641pw60jdmxwkvfq5km5v5cpb6hb-vgrep-0.2.3.0.tar.gz]]
