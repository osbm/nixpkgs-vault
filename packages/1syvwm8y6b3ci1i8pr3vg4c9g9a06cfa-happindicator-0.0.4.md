...
- **Name**: `haskellPackages.happindicator`
- **Version**: `0.0.4`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Binding to the appindicator library
- **Homepage**: [https://hackage.haskell.org/package/happindicator](https://hackage.haskell.org/package/happindicator)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/1syvwm8y6b3ci1i8pr3vg4c9g9a06cfa-happindicator-0.0.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:296020`
- **Outputs**:
  - `data`:  `/nix/store/1syvwm8y6b3ci1i8pr3vg4c9g9a06cfa-happindicator-0.0.4`
  - `doc`:  `/nix/store/1syvwm8y6b3ci1i8pr3vg4c9g9a06cfa-happindicator-0.0.4`
  - `out`:  `/nix/store/1syvwm8y6b3ci1i8pr3vg4c9g9a06cfa-happindicator-0.0.4`
...
- [[d9sg8kym9g738hjdcrg28m90d10agbk7-happindicator-0.0.4.tar.gz]]
