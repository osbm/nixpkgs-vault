...
- **Name**: `python313Packages.pvlib`
- **Version**: `0.13.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Simulate the performance of photovoltaic energy systems
- **Homepage**: [https://pvlib-python.readthedocs.io](https://pvlib-python.readthedocs.io)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/f1dg8bsms81gvk3hx222mvcbn7djkk54-python3.13-pvlib-0.13.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/pvlib/default.nix:60`
- **Outputs**:
  - `dist`:  `/nix/store/f1dg8bsms81gvk3hx222mvcbn7djkk54-python3.13-pvlib-0.13.0`
  - `out`:  `/nix/store/f1dg8bsms81gvk3hx222mvcbn7djkk54-python3.13-pvlib-0.13.0`
...
- [[cs36zrscbm5qsa1g5pia94zc1q7qa5pg-pvlib-0.13.0.tar.gz]]
...
- [[nl5lgyrfm5hb9dfjbn85vdn239jgx13q-python3.13-pytest-remotedata-0.4.1]]
