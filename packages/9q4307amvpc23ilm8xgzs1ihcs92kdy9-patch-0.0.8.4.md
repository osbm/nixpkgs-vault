...
- **Name**: `haskellPackages.patch`
- **Version**: `0.0.8.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Data structures for describing changes to other data structures
- **Homepage**: [https://hackage.haskell.org/package/patch](https://hackage.haskell.org/package/patch)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/9q4307amvpc23ilm8xgzs1ihcs92kdy9-patch-0.0.8.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:507140`
- **Outputs**:
  - `doc`:  `/nix/store/9q4307amvpc23ilm8xgzs1ihcs92kdy9-patch-0.0.8.4`
  - `out`:  `/nix/store/9q4307amvpc23ilm8xgzs1ihcs92kdy9-patch-0.0.8.4`
...
- [[b7dys6hyik8avp7jkzin2ivd1zwawig2-patch-0.0.8.4.tar.gz]]
