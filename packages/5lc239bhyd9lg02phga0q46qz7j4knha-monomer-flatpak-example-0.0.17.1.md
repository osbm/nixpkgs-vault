---
aliases:
  - haskellPackages.monomer-flatpak-example
tags:
  - license/unknown
  - outputs/data
  - outputs/doc
...
- **Name**: `haskellPackages.monomer-flatpak-example`
- **Version**: `0.0.17.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Monomer Flatpak Example Application
- **Homepage**: [https://hackage.haskell.org/package/monomer-flatpak-example](https://hackage.haskell.org/package/monomer-flatpak-example)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/5lc239bhyd9lg02phga0q46qz7j4knha-monomer-flatpak-example-0.0.17.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:458488`
- **Outputs**:
  - `data`:  `/nix/store/5lc239bhyd9lg02phga0q46qz7j4knha-monomer-flatpak-example-0.0.17.1`
  - `doc`:  `/nix/store/5lc239bhyd9lg02phga0q46qz7j4knha-monomer-flatpak-example-0.0.17.1`
  - `out`:  `/nix/store/5lc239bhyd9lg02phga0q46qz7j4knha-monomer-flatpak-example-0.0.17.1`
...
- [[dsicygw614cvpflfiqmlgvlbfag3d7ja-monomer-flatpak-example-0.0.17.1.tar.gz]]
...
- [[jr9wx0vl2nhbrj2ms1snj2j7qbcinq3p-monomer-hagrid-0.4.0.1]]
...
- [[v19x9r09g9q88lbsj80cmsyf9lj57407-desktop-portal-0.8.0.1]]
