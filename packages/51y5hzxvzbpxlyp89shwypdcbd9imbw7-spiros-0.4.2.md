...
- **Name**: `haskellPackages.spiros`
- **Version**: `0.4.2`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Spiros Boosalis's Custom Prelude
- **Homepage**: [https://hackage.haskell.org/package/spiros](https://hackage.haskell.org/package/spiros)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/51y5hzxvzbpxlyp89shwypdcbd9imbw7-spiros-0.4.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:627686`
- **Outputs**:
  - `doc`:  `/nix/store/51y5hzxvzbpxlyp89shwypdcbd9imbw7-spiros-0.4.2`
  - `out`:  `/nix/store/51y5hzxvzbpxlyp89shwypdcbd9imbw7-spiros-0.4.2`
...
- [[aik164i115mfpzmzscyysdd0invsy9qf-cpuinfo-0.1.0.3]]
...
- [[mmbwgl9k42pb5a066lsqszk080lmsa3h-spiros-0.4.2.tar.gz]]
