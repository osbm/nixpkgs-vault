...
Error formatter tool for Reason and OCaml. Takes raw error output from compiler and converts to pretty output

## 📋 Package Information

- **Name**: `ocamlPackages.reason-native.refmterr`
...
- **Homepage**: [https://reason-native.com/docs/refmterr/](https://reason-native.com/docs/refmterr/)
- **License**: `unknown`
- **Platforms**: `aarch64-linux`, `armv5tel-linux`, `armv6l-linux`, `armv7a-linux`, `armv7l-linux`, `i686-linux`, `loongarch64-linux`, `m68k-linux`, `microblaze-linux`, `microblazeel-linux`, `mips-linux`, `mips64-linux`, `mips64el-linux`, `mipsel-linux`, `powerpc-linux`, `powerpc64-linux`, `powerpc64le-linux`, `riscv32-linux`, `riscv64-linux`, `s390-linux`, `s390x-linux`, `x86_64-linux`, `x86_64-darwin`, `aarch64-darwin`

## 🔧 Build Information

- **Derivation Path**: `/nix/store/izqfjlcc9axi9h45hc26042zw5wl5n7l-ocaml5.3.0-refmterr-3.3.0-unstable-2024-05-07.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/ocaml-modules/reason-native/refmterr.nix:34`
- **Outputs**:
  - `out`:  `/nix/store/izqfjlcc9axi9h45hc26042zw5wl5n7l-ocaml5.3.0-refmterr-3.3.0-unstable-2024-05-07`
