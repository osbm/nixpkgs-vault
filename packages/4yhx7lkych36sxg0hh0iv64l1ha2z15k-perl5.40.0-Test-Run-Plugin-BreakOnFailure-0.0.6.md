---
aliases:
  - perl540Packages.TestRunPluginBreakOnFailure
tags:
  - license/unknown
  - outputs/devdoc
  - outputs/out
...
- **Name**: `perl540Packages.TestRunPluginBreakOnFailure`
- **Version**: `0.0.6`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/4yhx7lkych36sxg0hh0iv64l1ha2z15k-perl5.40.0-Test-Run-Plugin-BreakOnFailure-0.0.6.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/top-level/perl-packages.nix:35031`
- **Outputs**:
  - `devdoc`:  `/nix/store/4yhx7lkych36sxg0hh0iv64l1ha2z15k-perl5.40.0-Test-Run-Plugin-BreakOnFailure-0.0.6`
  - `out`:  `/nix/store/4yhx7lkych36sxg0hh0iv64l1ha2z15k-perl5.40.0-Test-Run-Plugin-BreakOnFailure-0.0.6`
