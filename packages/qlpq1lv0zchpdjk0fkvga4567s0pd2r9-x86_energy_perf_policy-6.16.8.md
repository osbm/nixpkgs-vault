---
aliases:
  - linuxKernel.packages.linux_latest_libre.x86_energy_perf_policy
tags:
  - license/unknown
  - outputs/out
---
...
- **Name**: `linuxKernel.packages.linux_latest_libre.x86_energy_perf_policy`
- **Version**: `6.16.8`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/qlpq1lv0zchpdjk0fkvga4567s0pd2r9-x86_energy_perf_policy-6.16.8.drv`
...
- **Outputs**:
  - `out`:  `/nix/store/qlpq1lv0zchpdjk0fkvga4567s0pd2r9-x86_energy_perf_policy-6.16.8`
