...
Python image library that sits on top of Pillow, Wand and OpenCV

## 📋 Package Information

- **Name**: `python312Packages.willow`
- **Version**: `1.11.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Python image library that sits on top of Pillow, Wand and OpenCV
- **Homepage**: [https://github.com/torchbox/Willow/](https://github.com/torchbox/Willow/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/2m21v3mlnj958i9pbj7w8vs70sxjr5az-python3.12-willow-1.11.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/willow/default.nix:52`
- **Outputs**:
  - `dist`:  `/nix/store/2m21v3mlnj958i9pbj7w8vs70sxjr5az-python3.12-willow-1.11.0`
  - `out`:  `/nix/store/2m21v3mlnj958i9pbj7w8vs70sxjr5az-python3.12-willow-1.11.0`
...
- [[jrg7zi46lrnvdqxzqh67ayh5vp7dhn4d-source]]
