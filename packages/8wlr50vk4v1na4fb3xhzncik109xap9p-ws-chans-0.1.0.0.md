...
- **Name**: `haskellPackages.ws-chans`
- **Version**: `0.1.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Unagi chan based websocket client
- **Homepage**: [https://hackage.haskell.org/package/ws-chans](https://hackage.haskell.org/package/ws-chans)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/8wlr50vk4v1na4fb3xhzncik109xap9p-ws-chans-0.1.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:727713`
- **Outputs**:
  - `doc`:  `/nix/store/8wlr50vk4v1na4fb3xhzncik109xap9p-ws-chans-0.1.0.0`
  - `out`:  `/nix/store/8wlr50vk4v1na4fb3xhzncik109xap9p-ws-chans-0.1.0.0`

## 🔗 Dependencies

- [[2pr652igq6awvbbf5rfnb3kbrmg1cryf-http-types-0.12.4]]
- [[3rlbg81rzcrypijlmw0idxw2ll5r9hi7-ws-chans-0.1.0.0.tar.gz]]
