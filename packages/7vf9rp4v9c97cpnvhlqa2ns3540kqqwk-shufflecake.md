...
- **Name**: `linuxKernel.packages.linux_6_12.shufflecake`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/7vf9rp4v9c97cpnvhlqa2ns3540kqqwk-shufflecake.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/shufflecake/default.nix:44`
- **Outputs**:
  - `bin`:  `/nix/store/7vf9rp4v9c97cpnvhlqa2ns3540kqqwk-shufflecake`
  - `out`:  `/nix/store/7vf9rp4v9c97cpnvhlqa2ns3540kqqwk-shufflecake`
