...
- **Name**: `python313Packages.graph-tool`
- **Version**: `2.98`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Python module for manipulation and statistical analysis of graphs
- **Homepage**: [https://graph-tool.skewed.de](https://graph-tool.skewed.de)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/1wxfq71jqxqq5cywzq7g712qilq31ih1-python3.13-graph-tool-2.98.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/graph-tool/default.nix:87`
- **Outputs**:
  - `out`:  `/nix/store/1wxfq71jqxqq5cywzq7g712qilq31ih1-python3.13-graph-tool-2.98`
...
- [[v7mmj1ixcyw212qjwfihggyl4i71fwfk-graph-tool-2.98.tar.bz2]]
