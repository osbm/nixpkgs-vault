...
- **Name**: `php81Extensions.readline`
- **Version**: `8.1.33`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: PHP upstream extension: readline
...
- **Derivation Path**: `/nix/store/wdq4dhzi49rr227k4dp8r7md3ikvlv13-php-readline-8.1.33.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/top-level/php-packages.nix:206`
- **Outputs**:
  - `dev`:  `/nix/store/wdq4dhzi49rr227k4dp8r7md3ikvlv13-php-readline-8.1.33`
  - `out`:  `/nix/store/wdq4dhzi49rr227k4dp8r7md3ikvlv13-php-readline-8.1.33`
