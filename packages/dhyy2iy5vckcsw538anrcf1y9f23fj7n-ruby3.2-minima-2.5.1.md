...
- **Derivation Path**: `/nix/store/dhyy2iy5vckcsw538anrcf1y9f23fj7n-ruby3.2-minima-2.5.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/top-level/ruby-packages.nix:2522`
- **Outputs**:
  - `out`:  `/nix/store/dhyy2iy5vckcsw538anrcf1y9f23fj7n-ruby3.2-minima-2.5.1`
