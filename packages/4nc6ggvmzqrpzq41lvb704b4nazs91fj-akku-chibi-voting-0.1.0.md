...
Preferential voting utilities to help come to reasonable decisions when there are more than 2 options

## 📋 Package Information

- **Name**: `akkuPackages.chibi-voting`
- **Version**: `0.1.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
...
- **Derivation Path**: `/nix/store/4nc6ggvmzqrpzq41lvb704b4nazs91fj-akku-chibi-voting-0.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/tools/package-management/akku/default.nix:39`
- **Outputs**:
  - `out`:  `/nix/store/4nc6ggvmzqrpzq41lvb704b4nazs91fj-akku-chibi-voting-0.1.0`
...
- [[lgdyg11514250h4frqmvrscc4fn70ajs-chibi-voting-0.1.tgz]]
