...
- **Name**: `haskellPackages.rustls`
- **Version**: `0.2.2.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: TLS bindings for Rustls
- **Homepage**: [https://hackage.haskell.org/package/rustls](https://hackage.haskell.org/package/rustls)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/ify9gfcblssvffm3li1cqz1spp1jmgw2-rustls-0.2.2.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:581743`
- **Outputs**:
  - `doc`:  `/nix/store/ify9gfcblssvffm3li1cqz1spp1jmgw2-rustls-0.2.2.0`
  - `out`:  `/nix/store/ify9gfcblssvffm3li1cqz1spp1jmgw2-rustls-0.2.2.0`
...
- [[cwldp627i9vph0zpbh8pp54pxhw8q6vp-rustls-0.2.2.0.tar.gz]]
