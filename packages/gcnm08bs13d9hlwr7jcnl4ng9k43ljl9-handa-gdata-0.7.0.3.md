...
- **Name**: `haskellPackages.handa-gdata`
- **Version**: `0.7.0.3`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Library and command-line utility for accessing Google services and APIs
- **Homepage**: [https://hackage.haskell.org/package/handa-gdata](https://hackage.haskell.org/package/handa-gdata)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/gcnm08bs13d9hlwr7jcnl4ng9k43ljl9-handa-gdata-0.7.0.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:295349`
- **Outputs**:
  - `doc`:  `/nix/store/gcnm08bs13d9hlwr7jcnl4ng9k43ljl9-handa-gdata-0.7.0.3`
  - `out`:  `/nix/store/gcnm08bs13d9hlwr7jcnl4ng9k43ljl9-handa-gdata-0.7.0.3`
...
- [[ykaaycr1l9rli3p760kd21yksmrhm1bs-handa-gdata-0.7.0.3.tar.gz]]
