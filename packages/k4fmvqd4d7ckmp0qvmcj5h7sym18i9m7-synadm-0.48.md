...
- **Homepage**: [https://synadm.readthedocs.io/](https://synadm.readthedocs.io/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/k4fmvqd4d7ckmp0qvmcj5h7sym18i9m7-synadm-0.48.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/sy/synadm/package.nix:42`
- **Outputs**:
  - `dist`:  `/nix/store/k4fmvqd4d7ckmp0qvmcj5h7sym18i9m7-synadm-0.48`
  - `out`:  `/nix/store/k4fmvqd4d7ckmp0qvmcj5h7sym18i9m7-synadm-0.48`
...
- [[8g0higvylh1na94ihkasfpz6kbjza3zz-source]]
