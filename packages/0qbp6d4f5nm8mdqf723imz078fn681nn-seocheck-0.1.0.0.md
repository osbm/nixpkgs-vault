...
- **Name**: `haskellPackages.seocheck`
- **Version**: `0.1.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Check for common SEO mistakes on CI
- **Homepage**: [https://hackage.haskell.org/package/seocheck](https://hackage.haskell.org/package/seocheck)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/0qbp6d4f5nm8mdqf723imz078fn681nn-seocheck-0.1.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:594212`
- **Outputs**:
  - `doc`:  `/nix/store/0qbp6d4f5nm8mdqf723imz078fn681nn-seocheck-0.1.0.0`
  - `out`:  `/nix/store/0qbp6d4f5nm8mdqf723imz078fn681nn-seocheck-0.1.0.0`
...
- [[kw9p6828csw7d5211kri34f1hpblkvgq-seocheck-0.1.0.0.tar.gz]]
