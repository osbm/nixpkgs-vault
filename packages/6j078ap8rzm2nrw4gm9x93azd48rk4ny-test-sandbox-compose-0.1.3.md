---
aliases:
  - haskellPackages.test-sandbox-compose
tags:
  - license/unknown
  - outputs/doc
  - outputs/out
...
- **Name**: `haskellPackages.test-sandbox-compose`
- **Version**: `0.1.3`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Lightweight development enviroments using test-sandbox
- **Homepage**: [https://hackage.haskell.org/package/test-sandbox-compose](https://hackage.haskell.org/package/test-sandbox-compose)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/6j078ap8rzm2nrw4gm9x93azd48rk4ny-test-sandbox-compose-0.1.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:665589`
- **Outputs**:
  - `doc`:  `/nix/store/6j078ap8rzm2nrw4gm9x93azd48rk4ny-test-sandbox-compose-0.1.3`
  - `out`:  `/nix/store/6j078ap8rzm2nrw4gm9x93azd48rk4ny-test-sandbox-compose-0.1.3`

## 🔗 Dependencies

- [[00d6js7d91zmrll15kzqpvmchwa5xh1g-lifted-base-0.2.3.12]]
- [[1n81j434ccg66y0sydbqakb6csklax3p-test-sandbox-compose-0.1.3.tar.gz]]
