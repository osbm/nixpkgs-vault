...
- **Name**: `rPackages.nbTransmission`
- **Version**: `1.2.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/nbTransmission/](https://cran.r-project.org/web/packages/nbTransmission/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/riml6wwwvswlkb1dzkfjb44bvarbml1h-r-nbTransmission-1.2.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/riml6wwwvswlkb1dzkfjb44bvarbml1h-r-nbTransmission-1.2.0`

## 🔗 Dependencies

- [[03660ms2a23f7471hzvy1hyg5b3jnqjs-nbTransmission_1.2.0.tar.gz]]
