...
- **Name**: `haskellPackages.http-proxy`
- **Version**: `0.1.2.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: A library for writing HTTP and HTTPS proxies
- **Homepage**: [https://hackage.haskell.org/package/http-proxy](https://hackage.haskell.org/package/http-proxy)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/lr9m6iq0gazp5s05ajs3q2ycrwx1p879-http-proxy-0.1.2.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:362349`
- **Outputs**:
  - `doc`:  `/nix/store/lr9m6iq0gazp5s05ajs3q2ycrwx1p879-http-proxy-0.1.2.0`
  - `out`:  `/nix/store/lr9m6iq0gazp5s05ajs3q2ycrwx1p879-http-proxy-0.1.2.0`
...
- [[swxm2drbw1bk2ycikd23v5cgqqz4g9gh-http-proxy-0.1.2.0.tar.gz]]
