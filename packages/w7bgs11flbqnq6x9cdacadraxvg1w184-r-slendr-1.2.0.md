...
- **Name**: `rPackages.slendr`
- **Version**: `1.2.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/slendr/](https://cran.r-project.org/web/packages/slendr/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/w7bgs11flbqnq6x9cdacadraxvg1w184-r-slendr-1.2.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/w7bgs11flbqnq6x9cdacadraxvg1w184-r-slendr-1.2.0`

## 🔗 Dependencies

- [[0y9rb5899bni1yjnhxpnrzz99crsq5z6-slendr_1.2.0.tar.gz]]
