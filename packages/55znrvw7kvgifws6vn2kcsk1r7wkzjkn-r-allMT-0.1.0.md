...
- **Name**: `rPackages.allMT`
- **Version**: `0.1.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/allMT/](https://cran.r-project.org/web/packages/allMT/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/55znrvw7kvgifws6vn2kcsk1r7wkzjkn-r-allMT-0.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/55znrvw7kvgifws6vn2kcsk1r7wkzjkn-r-allMT-0.1.0`
...
- [[dyki6s4zlrzjlh82v20rvrk677zmb5qz-allMT_0.1.0.tar.gz]]
