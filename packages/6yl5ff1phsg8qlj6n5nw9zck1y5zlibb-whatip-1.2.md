...
- **Homepage**: [https://gitlab.gnome.org/GabMus/whatip](https://gitlab.gnome.org/GabMus/whatip)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/6yl5ff1phsg8qlj6n5nw9zck1y5zlibb-whatip-1.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/wh/whatip/package.nix:58`
- **Outputs**:
  - `out`:  `/nix/store/6yl5ff1phsg8qlj6n5nw9zck1y5zlibb-whatip-1.2`

## 🔗 Dependencies

- [[06a2j9jv7f40ihnra63q0xx99ry62h35-python-imports-check-hook.sh]]
- [[257k0vnqp1xjgyrpc5as1r0nl7s4yv71-python3-3.13.7]]
- [[31xqglmgsm2i8diqwqslv8c58ya063s2-source]]
