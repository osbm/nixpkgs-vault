...
- **Name**: `haskellPackages.amazonka-mtl`
- **Version**: `2.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: MTL-style type-class and deriving-via newtypes for Amazonka
- **Homepage**: [https://hackage.haskell.org/package/amazonka-mtl](https://hackage.haskell.org/package/amazonka-mtl)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/2cnv3m8cygp6abwrgzpc237x9siv4j3m-amazonka-mtl-2.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:69692`
- **Outputs**:
  - `doc`:  `/nix/store/2cnv3m8cygp6abwrgzpc237x9siv4j3m-amazonka-mtl-2.0`
  - `out`:  `/nix/store/2cnv3m8cygp6abwrgzpc237x9siv4j3m-amazonka-mtl-2.0`
