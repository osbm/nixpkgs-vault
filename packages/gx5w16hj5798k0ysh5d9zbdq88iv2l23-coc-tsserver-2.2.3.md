...
- **Name**: `nodePackages.coc-tsserver`
- **Version**: `2.2.3`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/gx5w16hj5798k0ysh5d9zbdq88iv2l23-coc-tsserver-2.2.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/node-packages/node-packages.nix:49461`
- **Outputs**:
  - `out`:  `/nix/store/gx5w16hj5798k0ysh5d9zbdq88iv2l23-coc-tsserver-2.2.3`
