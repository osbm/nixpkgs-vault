...
- **Name**: `haskellPackages.glue`
- **Version**: `0.2.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Make better services
- **Homepage**: [https://hackage.haskell.org/package/glue](https://hackage.haskell.org/package/glue)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/v06z3n0xid7jgak1swfxgsj0lyqhkawv-glue-0.2.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:274028`
- **Outputs**:
  - `doc`:  `/nix/store/v06z3n0xid7jgak1swfxgsj0lyqhkawv-glue-0.2.0`
  - `out`:  `/nix/store/v06z3n0xid7jgak1swfxgsj0lyqhkawv-glue-0.2.0`
...
- [[as99sywghq3srw21biyk5la859d9knni-glue-0.2.0.tar.gz]]
