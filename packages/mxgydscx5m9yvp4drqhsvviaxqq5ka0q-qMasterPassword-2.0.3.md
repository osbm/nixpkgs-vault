...
- **Name**: `qMasterPassword-wayland`
- **Version**: `2.0.3`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Stateless Master Password Manager
- **Homepage**: [https://github.com/bkueng/qMasterPassword](https://github.com/bkueng/qMasterPassword)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/mxgydscx5m9yvp4drqhsvviaxqq5ka0q-qMasterPassword-2.0.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/applications/misc/qMasterPassword/default.nix:80`
- **Outputs**:
  - `out`:  `/nix/store/mxgydscx5m9yvp4drqhsvviaxqq5ka0q-qMasterPassword-2.0.3`
...
- [[jkkyqkm5a9b91zh3si11iisr2aak4znr-libscrypt-1.22]]
- [[jyazjyx5k23c91nyamdw996876v8q6c7-source]]
