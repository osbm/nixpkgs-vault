...
- **Name**: `rPackages.triplot`
- **Version**: `1.3.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/triplot/](https://cran.r-project.org/web/packages/triplot/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/d5ky3fakl6b26vrwavaplg4a0iwj0kzp-r-triplot-1.3.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/d5ky3fakl6b26vrwavaplg4a0iwj0kzp-r-triplot-1.3.0`

## 🔗 Dependencies

- [[3q2dmwa67rmji2ijq4x75id5j09wzlqa-triplot_1.3.0.tar.gz]]
