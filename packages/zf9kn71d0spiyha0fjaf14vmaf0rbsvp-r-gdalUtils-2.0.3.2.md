...
- **Name**: `rPackages.gdalUtils`
- **Version**: `2.0.3.2`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://cran.r-project.org/web/packages/gdalUtils/](https://cran.r-project.org/web/packages/gdalUtils/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/zf9kn71d0spiyha0fjaf14vmaf0rbsvp-r-gdalUtils-2.0.3.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/zf9kn71d0spiyha0fjaf14vmaf0rbsvp-r-gdalUtils-2.0.3.2`
...
- [[fljr20mv3z7a5wmgsvgwciw64cci4yvq-gdalUtils_2.0.3.2.tar.gz]]
