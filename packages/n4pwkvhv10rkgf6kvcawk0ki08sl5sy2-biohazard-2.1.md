...
bioinformatics support library

## 📋 Package Information

- **Name**: `haskellPackages.biohazard`
- **Version**: `2.1`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: bioinformatics support library
- **Homepage**: [https://hackage.haskell.org/package/biohazard](https://hackage.haskell.org/package/biohazard)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/n4pwkvhv10rkgf6kvcawk0ki08sl5sy2-biohazard-2.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:106373`
- **Outputs**:
  - `doc`:  `/nix/store/n4pwkvhv10rkgf6kvcawk0ki08sl5sy2-biohazard-2.1`
  - `out`:  `/nix/store/n4pwkvhv10rkgf6kvcawk0ki08sl5sy2-biohazard-2.1`
...
- [[wgd3c0z76m6gp4zj454c5184kr5sdpx1-biohazard-2.1.tar.gz]]
