...
- **Name**: `python313Packages.eyed3`
- **Version**: `0.9.8`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Python module and command line program for processing ID3 tags
- **Homepage**: [https://eyed3.nicfit.net/](https://eyed3.nicfit.net/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/m0l7gh2kvbb87103bv56jqf54pwrm8vb-python3.13-eyed3-0.9.8.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/eyed3/default.nix:37`
- **Outputs**:
  - `dist`:  `/nix/store/m0l7gh2kvbb87103bv56jqf54pwrm8vb-python3.13-eyed3-0.9.8`
  - `out`:  `/nix/store/m0l7gh2kvbb87103bv56jqf54pwrm8vb-python3.13-eyed3-0.9.8`
...
- [[awpkk99qd8l57i0fa9zf0wjlnkh6l3fz-source]]
