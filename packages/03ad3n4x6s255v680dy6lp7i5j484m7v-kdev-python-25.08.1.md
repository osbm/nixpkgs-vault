...
- **Name**: `kdePackages.kdev-python`
- **Version**: `25.08.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: KDevelop Python language support
- **Homepage**: [https://invent.kde.org/kdevelop/kdev-python](https://invent.kde.org/kdevelop/kdev-python)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/03ad3n4x6s255v680dy6lp7i5j484m7v-kdev-python-25.08.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/kde/gear/kdev-python/default.nix:3`
- **Outputs**:
  - `debug`:  `/nix/store/03ad3n4x6s255v680dy6lp7i5j484m7v-kdev-python-25.08.1`
  - `dev`:  `/nix/store/03ad3n4x6s255v680dy6lp7i5j484m7v-kdev-python-25.08.1`
  - `devtools`:  `/nix/store/03ad3n4x6s255v680dy6lp7i5j484m7v-kdev-python-25.08.1`
  - `out`:  `/nix/store/03ad3n4x6s255v680dy6lp7i5j484m7v-kdev-python-25.08.1`

## 🔗 Dependencies

- [[3mjvv5mmm3f06as8nhmwmqswr2dpbhmi-kdev-python-25.08.1.tar.xz]]
...
- [[wixcvma9aq3s5vqv5wk7k9lb5dfzbg8k-kdevelop-25.08.1]]
