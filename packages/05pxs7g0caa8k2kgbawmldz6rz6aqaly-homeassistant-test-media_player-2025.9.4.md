---
aliases:
  - home-assistant-component-tests.media_player
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.media_player`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/05pxs7g0caa8k2kgbawmldz6rz6aqaly-homeassistant-test-media_player-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/05pxs7g0caa8k2kgbawmldz6rz6aqaly-homeassistant-test-media_player-2025.9.4`
