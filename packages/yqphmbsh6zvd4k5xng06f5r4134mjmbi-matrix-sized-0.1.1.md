...
- **Name**: `haskellPackages.matrix-sized`
- **Version**: `0.1.1`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Haskell matrix library with interface to C++ linear algebra libraries
- **Homepage**: [https://hackage.haskell.org/package/matrix-sized](https://hackage.haskell.org/package/matrix-sized)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/yqphmbsh6zvd4k5xng06f5r4134mjmbi-matrix-sized-0.1.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:440114`
- **Outputs**:
  - `doc`:  `/nix/store/yqphmbsh6zvd4k5xng06f5r4134mjmbi-matrix-sized-0.1.1`
  - `out`:  `/nix/store/yqphmbsh6zvd4k5xng06f5r4134mjmbi-matrix-sized-0.1.1`
...
- [[a1vvzk7pqd3kckip9bkm3xzz3b6vccsp-matrix-sized-0.1.1.tar.gz]]
