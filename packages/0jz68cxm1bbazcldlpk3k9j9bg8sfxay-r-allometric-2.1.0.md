...
- **Name**: `rPackages.allometric`
- **Version**: `2.1.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://cran.r-project.org/web/packages/allometric/](https://cran.r-project.org/web/packages/allometric/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/0jz68cxm1bbazcldlpk3k9j9bg8sfxay-r-allometric-2.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/0jz68cxm1bbazcldlpk3k9j9bg8sfxay-r-allometric-2.1.0`
...
- [[vg8gi38idpr5h4h1linf7xynrwsfj8ph-allometric_2.1.0.tar.gz]]
