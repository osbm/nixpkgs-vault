...
- **Name**: `akkuPackages.json-tools`
- **Version**: `0.1.1-akku.15.7.23`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Collection of JSON utilities
- **Homepage**: []()
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/8f67zfl2vvg26ab8x9yxlagxqcwq28ns-akku-json-tools-0.1.1-akku.15.7.23.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/tools/package-management/akku/default.nix:39`
- **Outputs**:
  - `out`:  `/nix/store/8f67zfl2vvg26ab8x9yxlagxqcwq28ns-akku-json-tools-0.1.1-akku.15.7.23`
...
- [[v77znh63blnz05ispma87p5xwjncmli2-json-tools_0.1.1-akku.15.7.23_repack.tar.xz]]
