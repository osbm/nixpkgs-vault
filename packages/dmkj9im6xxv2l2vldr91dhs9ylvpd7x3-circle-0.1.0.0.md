...
- **Name**: `haskellPackages.circle`
- **Version**: `0.1.0.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Circle API client for Haskell
- **Homepage**: [https://hackage.haskell.org/package/circle](https://hackage.haskell.org/package/circle)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/dmkj9im6xxv2l2vldr91dhs9ylvpd7x3-circle-0.1.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:140046`
- **Outputs**:
  - `doc`:  `/nix/store/dmkj9im6xxv2l2vldr91dhs9ylvpd7x3-circle-0.1.0.0`
  - `out`:  `/nix/store/dmkj9im6xxv2l2vldr91dhs9ylvpd7x3-circle-0.1.0.0`

## 🔗 Dependencies

- [[180xmmd0zhpflp3p8f8cyq1vaxk28yj4-country-0.2.5.0]]
...
- [[alylf5kfl5hian0b6982zhav0ijgrjy4-circle-0.1.0.0.tar.gz]]
