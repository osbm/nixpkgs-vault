...
- **Name**: `rPackages.ggheatmap`
- **Version**: `2.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/ggheatmap/](https://cran.r-project.org/web/packages/ggheatmap/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/x60j6zdarwj6qx02vwpsmbga2p9izfd9-r-ggheatmap-2.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/x60j6zdarwj6qx02vwpsmbga2p9izfd9-r-ggheatmap-2.2`
...
- [[v8ag81i52qydncpfhsy49bxpn0hgixb0-ggheatmap_2.2.tar.gz]]
