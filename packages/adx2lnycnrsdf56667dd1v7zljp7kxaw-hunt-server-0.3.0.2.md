...
- **Name**: `haskellPackages.hunt-server`
- **Version**: `0.3.0.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: A search and indexing engine server
- **Homepage**: [https://hackage.haskell.org/package/hunt-server](https://hackage.haskell.org/package/hunt-server)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/adx2lnycnrsdf56667dd1v7zljp7kxaw-hunt-server-0.3.0.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:364789`
- **Outputs**:
  - `doc`:  `/nix/store/adx2lnycnrsdf56667dd1v7zljp7kxaw-hunt-server-0.3.0.2`
  - `out`:  `/nix/store/adx2lnycnrsdf56667dd1v7zljp7kxaw-hunt-server-0.3.0.2`
...
- [[34xxjdzrfb2mpi0vx54b3419fx0wpw4h-hunt-server-0.3.0.2.tar.gz]]
