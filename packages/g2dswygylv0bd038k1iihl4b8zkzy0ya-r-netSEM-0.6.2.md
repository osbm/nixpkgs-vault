...
- **Name**: `rPackages.netSEM`
- **Version**: `0.6.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/netSEM/](https://cran.r-project.org/web/packages/netSEM/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/g2dswygylv0bd038k1iihl4b8zkzy0ya-r-netSEM-0.6.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/g2dswygylv0bd038k1iihl4b8zkzy0ya-r-netSEM-0.6.2`
...
- [[fv3dl5a1a92r3iyph2chqpk3xxar9myw-netSEM_0.6.2.tar.gz]]
