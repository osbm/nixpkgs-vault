---
aliases:
  - haskellPackages.nicovideo-translator
tags:
  - broken
  - not-available
  - license/unknown
...
- **Name**: `haskellPackages.nicovideo-translator`
- **Version**: `0.3.0.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Nico Nico Douga (ニコニコ動画) Comment Translator
- **Homepage**: [https://hackage.haskell.org/package/nicovideo-translator](https://hackage.haskell.org/package/nicovideo-translator)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/nrvcidgwfjp6k12kvqjqlwakcahi44rn-nicovideo-translator-0.3.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:478373`
- **Outputs**:
  - `doc`:  `/nix/store/nrvcidgwfjp6k12kvqjqlwakcahi44rn-nicovideo-translator-0.3.0.0`
  - `out`:  `/nix/store/nrvcidgwfjp6k12kvqjqlwakcahi44rn-nicovideo-translator-0.3.0.0`

## 🔗 Dependencies

- [[14qcbzxqr6x725n7ylkxmxmcxmcrvi0n-iso639-0.1.0.3]]
...
- [[k5sqkfylzl3kbfk71xrvi7pd7zrq5bph-nicovideo-translator-0.3.0.0.tar.gz]]
