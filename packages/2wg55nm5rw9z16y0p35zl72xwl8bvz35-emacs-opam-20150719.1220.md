...
- **Name**: `emacsPackages.opam`
- **Version**: `20150719.1220`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://github.com/emacsorphanage/opam](https://github.com/emacsorphanage/opam)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/2wg55nm5rw9z16y0p35zl72xwl8bvz35-emacs-opam-20150719.1220.drv`
...
- **Outputs**:
  - `out`:  `/nix/store/2wg55nm5rw9z16y0p35zl72xwl8bvz35-emacs-opam-20150719.1220`

## 🔗 Dependencies

- [[01nyvn70a6x9wxnbdjw13xbrynm6vjls-source]]
- [[43fc86jivl9v10v3r3r4ycbrgx7fcqp6-opam-recipe]]
