...
- **Name**: `rPackages.customiser`
- **Version**: `0.1.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/customiser/](https://cran.r-project.org/web/packages/customiser/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/6zvi6j23bjrcm6f3xgaq73c8zyjjs89a-r-customiser-0.1.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/6zvi6j23bjrcm6f3xgaq73c8zyjjs89a-r-customiser-0.1.1`

## 🔗 Dependencies

- [[1inx2ja5190jjfm29md596i85pj7pn3a-customiser_0.1.1.tar.gz]]
