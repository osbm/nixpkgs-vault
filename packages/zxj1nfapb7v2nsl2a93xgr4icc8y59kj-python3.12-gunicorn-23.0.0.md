...
- **Name**: `python312Packages.gunicorn`
- **Version**: `23.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: WSGI HTTP Server for UNIX, fast clients and sleepy applications
- **Homepage**: [https://github.com/benoitc/gunicorn](https://github.com/benoitc/gunicorn)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/zxj1nfapb7v2nsl2a93xgr4icc8y59kj-python3.12-gunicorn-23.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/gunicorn/default.nix:58`
- **Outputs**:
  - `dist`:  `/nix/store/zxj1nfapb7v2nsl2a93xgr4icc8y59kj-python3.12-gunicorn-23.0.0`
  - `out`:  `/nix/store/zxj1nfapb7v2nsl2a93xgr4icc8y59kj-python3.12-gunicorn-23.0.0`
...
- [[kl2bansfm4nl0vyk9fhjvymb0w5ll0h8-source]]
