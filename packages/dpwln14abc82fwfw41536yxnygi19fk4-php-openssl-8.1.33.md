...
- **Name**: `php81Extensions.openssl`
- **Version**: `8.1.33`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: PHP upstream extension: openssl
...
- **Derivation Path**: `/nix/store/dpwln14abc82fwfw41536yxnygi19fk4-php-openssl-8.1.33.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/top-level/php-packages.nix:206`
- **Outputs**:
  - `dev`:  `/nix/store/dpwln14abc82fwfw41536yxnygi19fk4-php-openssl-8.1.33`
  - `out`:  `/nix/store/dpwln14abc82fwfw41536yxnygi19fk4-php-openssl-8.1.33`
