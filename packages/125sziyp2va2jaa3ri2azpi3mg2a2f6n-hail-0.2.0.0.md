...
- **Name**: `haskellPackages.hail`
- **Version**: `0.2.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: A service for pull-based continuous deployment based on hydra
- **Homepage**: [https://hackage.haskell.org/package/hail](https://hackage.haskell.org/package/hail)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/125sziyp2va2jaa3ri2azpi3mg2a2f6n-hail-0.2.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:292362`
- **Outputs**:
  - `data`:  `/nix/store/125sziyp2va2jaa3ri2azpi3mg2a2f6n-hail-0.2.0.0`
  - `doc`:  `/nix/store/125sziyp2va2jaa3ri2azpi3mg2a2f6n-hail-0.2.0.0`
  - `out`:  `/nix/store/125sziyp2va2jaa3ri2azpi3mg2a2f6n-hail-0.2.0.0`
...
- [[sjj0w1pj876f0r4y31d58085a8bdk7s5-hail-0.2.0.0.tar.gz]]
