...
- **Name**: `akkuPackages.rapid-and-let`
- **Version**: `0.1.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: And with local bindings compatible with SRFI 2
- **Homepage**: []()
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/04w79xl9sb8zr92bhf8cq555xdap1x8l-akku-rapid-and-let-0.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/tools/package-management/akku/default.nix:39`
- **Outputs**:
  - `out`:  `/nix/store/04w79xl9sb8zr92bhf8cq555xdap1x8l-akku-rapid-and-let-0.1.0`
...
- [[i7n2imnizy2khzwwrf02haj98kcqwiza-rapid-and-let-0.1.0.tgz]]
