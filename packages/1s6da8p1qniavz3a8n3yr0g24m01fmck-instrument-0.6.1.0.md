...
Easy stats/metrics instrumentation for Haskell programs

## 📋 Package Information

- **Name**: `haskellPackages.instrument`
- **Version**: `0.6.1.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Easy stats/metrics instrumentation for Haskell programs
- **Homepage**: [https://hackage.haskell.org/package/instrument](https://hackage.haskell.org/package/instrument)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/1s6da8p1qniavz3a8n3yr0g24m01fmck-instrument-0.6.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:380499`
- **Outputs**:
  - `doc`:  `/nix/store/1s6da8p1qniavz3a8n3yr0g24m01fmck-instrument-0.6.1.0`
  - `out`:  `/nix/store/1s6da8p1qniavz3a8n3yr0g24m01fmck-instrument-0.6.1.0`

## 🔗 Dependencies

- [[0dh6gwvd39nmlp7dz6fnqxv855b93rby-instrument-0.6.1.0.tar.gz]]
