...
- **Name**: `haskellPackages.mu-graphql`
- **Version**: `0.5.0.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: GraphQL support for Mu
- **Homepage**: [https://hackage.haskell.org/package/mu-graphql](https://hackage.haskell.org/package/mu-graphql)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/gxvijnwhlj45wphw7vqlql7gl6nxhll7-mu-graphql-0.5.0.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:463742`
- **Outputs**:
  - `data`:  `/nix/store/gxvijnwhlj45wphw7vqlql7gl6nxhll7-mu-graphql-0.5.0.4`
  - `doc`:  `/nix/store/gxvijnwhlj45wphw7vqlql7gl6nxhll7-mu-graphql-0.5.0.4`
  - `out`:  `/nix/store/gxvijnwhlj45wphw7vqlql7gl6nxhll7-mu-graphql-0.5.0.4`
...
- [[c8i9fssg06qj17f1rivr40f8jf6lrlha-mu-graphql-0.5.0.4.tar.gz]]
