...
- **Name**: `kdePackages.koko`
- **Version**: `25.08.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Image gallery application
- **Homepage**: [https://invent.kde.org/graphics/koko](https://invent.kde.org/graphics/koko)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/576xljmm3w2kvhxz7hv1ngv11b3j19qs-koko-25.08.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/kde/gear/koko/default.nix:28`
- **Outputs**:
  - `debug`:  `/nix/store/576xljmm3w2kvhxz7hv1ngv11b3j19qs-koko-25.08.1`
  - `dev`:  `/nix/store/576xljmm3w2kvhxz7hv1ngv11b3j19qs-koko-25.08.1`
  - `devtools`:  `/nix/store/576xljmm3w2kvhxz7hv1ngv11b3j19qs-koko-25.08.1`
  - `out`:  `/nix/store/576xljmm3w2kvhxz7hv1ngv11b3j19qs-koko-25.08.1`
...
- [[xx51l18hz7csn0b29xld7k7wwz3nrgp7-admin1CodesASCII.txt]]

## 📁 Input Sources

- `/nix/store/cshrp8x8j6p43r4sbjd29mb98869bzs6-optional-runtime-dependencies.patch`
