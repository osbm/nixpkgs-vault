---
aliases:
  - androidenv.androidPkgs.all.system-images.v15.default.armeabi-v7a
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.system-images.v15.default.armeabi-v7a`
- **Version**: `15_r05.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/agqkfjg95hwiamaag2xxm6rxa4wx06a1-armeabi-v7a-15_r05.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/agqkfjg95hwiamaag2xxm6rxa4wx06a1-armeabi-v7a-15_r05.zip`
