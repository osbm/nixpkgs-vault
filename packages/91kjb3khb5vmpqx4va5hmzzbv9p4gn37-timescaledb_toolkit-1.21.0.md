...
- **Name**: `postgresql16Packages.timescaledb_toolkit`
- **Version**: `1.21.0`
- **Available**: ❌ No
- **Broken**: ✅ No
- **Description**: Provide additional tools to ease all things analytic when using TimescaleDB
- **Homepage**: [https://github.com/timescale/timescaledb-toolkit](https://github.com/timescale/timescaledb-toolkit)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/91kjb3khb5vmpqx4va5hmzzbv9p4gn37-timescaledb_toolkit-1.21.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/sql/postgresql/ext/timescaledb_toolkit.nix:40`
- **Outputs**:
  - `out`:  `/nix/store/91kjb3khb5vmpqx4va5hmzzbv9p4gn37-timescaledb_toolkit-1.21.0`
...
- [[gbxnwjl7i2bkdrckayd5rwsrq205b46q-source]]
...
- [[sgdslp80rfi10cigvhdcf61sfqjn6qsc-timescaledb_toolkit-1.21.0-vendor]]
