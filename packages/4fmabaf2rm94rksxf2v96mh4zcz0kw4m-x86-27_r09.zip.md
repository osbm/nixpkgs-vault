---
aliases:
  - androidenv.androidPkgs.all.system-images.v27.android-tv.x86
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.system-images.v27.android-tv.x86`
- **Version**: `27_r09.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/4fmabaf2rm94rksxf2v96mh4zcz0kw4m-x86-27_r09.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/4fmabaf2rm94rksxf2v96mh4zcz0kw4m-x86-27_r09.zip`
