...
- **Name**: `python312Packages.foolscap`
- **Version**: `24.9.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: RPC protocol for Python that follows the distributed object-capability model
- **Homepage**: [https://github.com/warner/foolscap](https://github.com/warner/foolscap)
- **License**: `unknown`
- **Platforms**: `aarch64-linux`, `armv5tel-linux`, `armv6l-linux`, `armv7a-linux`, `armv7l-linux`, `i686-linux`, `loongarch64-linux`, `m68k-linux`, `microblaze-linux`, `microblazeel-linux`, `mips-linux`, `mips64-linux`, `mips64el-linux`, `mipsel-linux`, `powerpc-linux`, `powerpc64-linux`, `powerpc64le-linux`, `riscv32-linux`, `riscv64-linux`, `s390-linux`, `s390x-linux`, `x86_64-linux`, `x86_64-darwin`, `aarch64-darwin`, `i686-cygwin`, `x86_64-cygwin`, `aarch64-windows`, `x86_64-windows`, `i686-windows`, `i686-freebsd`, `x86_64-freebsd`, `aarch64-freebsd`

## 🔧 Build Information

- **Derivation Path**: `/nix/store/k7pwgnfdv7rg6f1jya1awxl22q998w0f-python3.12-foolscap-24.9.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/foolscap/default.nix:60`
- **Outputs**:
  - `dist`:  `/nix/store/k7pwgnfdv7rg6f1jya1awxl22q998w0f-python3.12-foolscap-24.9.0`
  - `out`:  `/nix/store/k7pwgnfdv7rg6f1jya1awxl22q998w0f-python3.12-foolscap-24.9.0`
...
- [[rmd036y6gsap4rhfpay2jmibmqg7d3yb-foolscap-24.9.0.tar.gz]]
- [[w15rcd7xqynnk2l879dh98mb7nlfgmr2-python3.12-txi2p-tahoe-0.3.7]]
