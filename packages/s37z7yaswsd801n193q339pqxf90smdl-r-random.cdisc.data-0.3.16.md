...
- **Name**: `rPackages.random_cdisc_data`
- **Version**: `0.3.16`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/random.cdisc.data/](https://cran.r-project.org/web/packages/random.cdisc.data/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/s37z7yaswsd801n193q339pqxf90smdl-r-random.cdisc.data-0.3.16.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/s37z7yaswsd801n193q339pqxf90smdl-r-random.cdisc.data-0.3.16`
...
- [[n3g8xw445plcqs4f4dxbhav29hlk3b52-random.cdisc.data_0.3.16.tar.gz]]
