---
aliases:
  - androidenv.androidPkgs.all.addons.v8.google_apis
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.addons.v8.google_apis`
- **Version**: `8_r02.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/b05fa8v1cn4fdh1yr9ri7j3nas2vhkm4-google_apis-8_r02.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/b05fa8v1cn4fdh1yr9ri7j3nas2vhkm4-google_apis-8_r02.zip`
