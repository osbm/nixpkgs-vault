...
- **Name**: `rPackages.mapbayr`
- **Version**: `0.10.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/mapbayr/](https://cran.r-project.org/web/packages/mapbayr/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/2jq6pxln6flq2856cl1m6cp2g1mskj4z-r-mapbayr-0.10.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/2jq6pxln6flq2856cl1m6cp2g1mskj4z-r-mapbayr-0.10.0`
...
- [[ar4a23hlx789cjdzi6z05xjylc4fs6s6-mapbayr_0.10.0.tar.gz]]
