...
- **Name**: `haskellPackages.gi-secret`
- **Version**: `0.0.20`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Libsecret bindings
- **Homepage**: [https://hackage.haskell.org/package/gi-secret](https://hackage.haskell.org/package/gi-secret)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/l4m99r57cqndlkk8mbk42lgmzwlwhszj-gi-secret-0.0.20.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:266981`
- **Outputs**:
  - `doc`:  `/nix/store/l4m99r57cqndlkk8mbk42lgmzwlwhszj-gi-secret-0.0.20`
  - `out`:  `/nix/store/l4m99r57cqndlkk8mbk42lgmzwlwhszj-gi-secret-0.0.20`
...
- [[shzymys7l2yqjpays7kmyp9ccbc2b35r-gi-secret-0.0.20.tar.gz]]
