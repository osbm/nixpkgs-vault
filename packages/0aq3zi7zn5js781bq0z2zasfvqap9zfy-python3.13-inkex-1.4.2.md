...
- **Derivation Path**: `/nix/store/0aq3zi7zn5js781bq0z2zasfvqap9zfy-python3.13-inkex-1.4.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/inkex/default.nix:85`
- **Outputs**:
  - `dist`:  `/nix/store/0aq3zi7zn5js781bq0z2zasfvqap9zfy-python3.13-inkex-1.4.2`
  - `out`:  `/nix/store/0aq3zi7zn5js781bq0z2zasfvqap9zfy-python3.13-inkex-1.4.2`
