...
- **Name**: `haskellPackages.bitcoin-hs`
- **Version**: `0.0.1`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Partial implementation of the Bitcoin protocol (as of 2013)
- **Homepage**: [https://hackage.haskell.org/package/bitcoin-hs](https://hackage.haskell.org/package/bitcoin-hs)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/24z3dgwzxfpnr5frdk39w4lk8nxv7w93-bitcoin-hs-0.0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:107712`
- **Outputs**:
  - `doc`:  `/nix/store/24z3dgwzxfpnr5frdk39w4lk8nxv7w93-bitcoin-hs-0.0.1`
  - `out`:  `/nix/store/24z3dgwzxfpnr5frdk39w4lk8nxv7w93-bitcoin-hs-0.0.1`
...
- [[z4hx4bhvrkhnncq6qqc92z0kd6vvad6q-bitcoin-hs-0.0.1.tar.gz]]
