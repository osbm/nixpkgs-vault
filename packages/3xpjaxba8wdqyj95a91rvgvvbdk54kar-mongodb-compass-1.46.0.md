...
- **Homepage**: [https://github.com/mongodb-js/compass](https://github.com/mongodb-js/compass)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/3xpjaxba8wdqyj95a91rvgvvbdk54kar-mongodb-compass-1.46.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/mo/mongodb-compass/package.nix:11`
- **Outputs**:
  - `out`:  `/nix/store/3xpjaxba8wdqyj95a91rvgvvbdk54kar-mongodb-compass-1.46.0`
...
- [[pbi648zms295jyv3y591rhkg1qqd4p9r-mongodb-compass_1.46.0_amd64.deb]]
