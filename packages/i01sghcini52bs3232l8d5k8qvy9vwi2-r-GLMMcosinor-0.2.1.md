...
- **Name**: `rPackages.GLMMcosinor`
- **Version**: `0.2.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/GLMMcosinor/](https://cran.r-project.org/web/packages/GLMMcosinor/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/i01sghcini52bs3232l8d5k8qvy9vwi2-r-GLMMcosinor-0.2.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/i01sghcini52bs3232l8d5k8qvy9vwi2-r-GLMMcosinor-0.2.1`
...
- [[wnjpsgkhwr4hz5a0v5ka86rqkckvszvv-GLMMcosinor_0.2.1.tar.gz]]
