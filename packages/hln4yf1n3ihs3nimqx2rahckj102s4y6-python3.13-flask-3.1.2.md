...
- **Derivation Path**: `/nix/store/hln4yf1n3ihs3nimqx2rahckj102s4y6-python3.13-flask-3.1.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/flask/default.nix:74`
- **Outputs**:
  - `dist`:  `/nix/store/hln4yf1n3ihs3nimqx2rahckj102s4y6-python3.13-flask-3.1.2`
  - `out`:  `/nix/store/hln4yf1n3ihs3nimqx2rahckj102s4y6-python3.13-flask-3.1.2`
...
- [[ckv41zlwybyabbwwh09riyvpn75rjncq-flask-3.1.2.tar.gz]]
