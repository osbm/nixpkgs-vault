...
- **Name**: `rPackages.artma`
- **Version**: `0.2.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/artma/](https://cran.r-project.org/web/packages/artma/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/kwqi91i7ahjvqskcdng0i0j7bpj9ifs7-r-artma-0.2.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/kwqi91i7ahjvqskcdng0i0j7bpj9ifs7-r-artma-0.2.1`
...
- [[llqxc3iz32c344nnxd0rg73w16hp64vk-artma_0.2.1.tar.gz]]
