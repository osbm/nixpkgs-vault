...
- **Name**: `python313Packages.recordlinkage`
- **Version**: `0.16`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/lnqdw6xp7ibngg9wqqkz994qpl2hmbsv-python3.13-recordlinkage-0.16.drv`
...
- **Outputs**:
  - `dist`:  `/nix/store/lnqdw6xp7ibngg9wqqkz994qpl2hmbsv-python3.13-recordlinkage-0.16`
  - `out`:  `/nix/store/lnqdw6xp7ibngg9wqqkz994qpl2hmbsv-python3.13-recordlinkage-0.16`
