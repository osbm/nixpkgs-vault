...
- **Name**: `rPackages.memoria`
- **Version**: `1.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/memoria/](https://cran.r-project.org/web/packages/memoria/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/0rnq6zs08n18qkjhlzbzh3bgahylzz7m-r-memoria-1.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/0rnq6zs08n18qkjhlzbzh3bgahylzz7m-r-memoria-1.0.0`
...
- [[wxjmsyg0mzlyv1rq52jgfxwnqj7dd9g3-memoria_1.0.0.tar.gz]]
