...
- **Name**: `python312Packages.pycognito`
- **Version**: `2024.5.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Python class to integrate Boto3's Cognito client so it is easy to login users. With SRP support
- **Homepage**: [https://github.com/pvizeli/pycognito](https://github.com/pvizeli/pycognito)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/vaq8dyxybklphzvyd3b5f28cc4mfj2xj-python3.12-pycognito-2024.5.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/pycognito/default.nix:61`
- **Outputs**:
  - `dist`:  `/nix/store/vaq8dyxybklphzvyd3b5f28cc4mfj2xj-python3.12-pycognito-2024.5.1`
  - `out`:  `/nix/store/vaq8dyxybklphzvyd3b5f28cc4mfj2xj-python3.12-pycognito-2024.5.1`

## 🔗 Dependencies

- [[2mq7wykj8l8b04xhakb5zh9avwps91z7-source]]
