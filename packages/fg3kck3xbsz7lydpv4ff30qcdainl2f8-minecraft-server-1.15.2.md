...
- **Name**: `minecraftServers.vanilla-1-15`
- **Version**: `1.15.2`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/fg3kck3xbsz7lydpv4ff30qcdainl2f8-minecraft-server-1.15.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/games/minecraft-servers/derivation.nix:43`
- **Outputs**:
  - `out`:  `/nix/store/fg3kck3xbsz7lydpv4ff30qcdainl2f8-minecraft-server-1.15.2`
...
- [[s3p36fb5sa9bm4ckribnvh9831d12xrr-server.jar]]
