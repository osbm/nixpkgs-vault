...
- **Name**: `rPackages.weathercan`
- **Version**: `0.6.2`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://cran.r-project.org/web/packages/weathercan/](https://cran.r-project.org/web/packages/weathercan/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/hgz9hmm90k35i7xwvrz614zzli7h98gp-r-weathercan-0.6.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/hgz9hmm90k35i7xwvrz614zzli7h98gp-r-weathercan-0.6.2`
...
- [[q11ixy0n7flim0fc5l2hzsxh3b7glnr1-weathercan_0.6.2.tar.gz]]
