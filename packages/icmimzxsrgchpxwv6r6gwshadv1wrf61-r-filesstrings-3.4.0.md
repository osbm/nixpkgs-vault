...
- **Name**: `rPackages.filesstrings`
- **Version**: `3.4.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/filesstrings/](https://cran.r-project.org/web/packages/filesstrings/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/icmimzxsrgchpxwv6r6gwshadv1wrf61-r-filesstrings-3.4.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/icmimzxsrgchpxwv6r6gwshadv1wrf61-r-filesstrings-3.4.0`
...
- [[8rp55s29h2lyfcpycykr1aj2b2xg7g6c-filesstrings_3.4.0.tar.gz]]
