---
aliases:
  - linuxKernel.packages.linux_6_6.x86_energy_perf_policy
tags:
  - license/unknown
  - outputs/out
---
...
- **Name**: `linuxKernel.packages.linux_6_6.x86_energy_perf_policy`
- **Version**: `6.6.107`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/cy1sj3ibjvyldqycy7f83xwivn3yr6s5-x86_energy_perf_policy-6.6.107.drv`
...
- **Outputs**:
  - `out`:  `/nix/store/cy1sj3ibjvyldqycy7f83xwivn3yr6s5-x86_energy_perf_policy-6.6.107`
