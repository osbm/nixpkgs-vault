...
- **Name**: `postgresql13Packages.pg_tle`
- **Version**: `1.5.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/1sp6w1ixlvdzxa0bgchwm8hmw7zh325c-pg_tle-1.5.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/sql/postgresql/ext/pg_tle.nix:27`
- **Outputs**:
  - `out`:  `/nix/store/1sp6w1ixlvdzxa0bgchwm8hmw7zh325c-pg_tle-1.5.1`
