...
- **Name**: `rPackages.vDiveR`
- **Version**: `2.0.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/vDiveR/](https://cran.r-project.org/web/packages/vDiveR/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/gb2qxc742nqijkhmi4vx0s0kajan34ax-r-vDiveR-2.0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/gb2qxc742nqijkhmi4vx0s0kajan34ax-r-vDiveR-2.0.1`
...
- [[s24rlpl02klhky9y6y7mlvrl7692qsr4-vDiveR_2.0.1.tar.gz]]
