...
- **Name**: `python313Packages.anndata`
- **Version**: `0.12.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Python package for handling annotated data matrices in memory and on disk
- **Homepage**: [https://anndata.readthedocs.io/](https://anndata.readthedocs.io/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/a410w1p10zk9ifgigvxw3b8kfv2mk7a5-python3.13-anndata-0.12.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/anndata/default.nix:139`
- **Outputs**:
  - `dist`:  `/nix/store/a410w1p10zk9ifgigvxw3b8kfv2mk7a5-python3.13-anndata-0.12.2`
  - `out`:  `/nix/store/a410w1p10zk9ifgigvxw3b8kfv2mk7a5-python3.13-anndata-0.12.2`
...
- [[98qy077djs5ksr7dq7mdkdxadk3j34kg-source]]
...
- [[h510svy7bfgyag9ir29nldpzpbkr3p9w-python3.13-array-api-compat-1.12]]
