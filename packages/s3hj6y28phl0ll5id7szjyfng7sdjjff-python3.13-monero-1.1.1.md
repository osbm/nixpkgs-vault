...
- **Name**: `python313Packages.monero`
- **Version**: `1.1.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Comprehensive Python module for handling Monero
- **Homepage**: [https://github.com/monero-ecosystem/monero-python](https://github.com/monero-ecosystem/monero-python)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/s3hj6y28phl0ll5id7szjyfng7sdjjff-python3.13-monero-1.1.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/monero/default.nix:49`
- **Outputs**:
  - `dist`:  `/nix/store/s3hj6y28phl0ll5id7szjyfng7sdjjff-python3.13-monero-1.1.1`
  - `out`:  `/nix/store/s3hj6y28phl0ll5id7szjyfng7sdjjff-python3.13-monero-1.1.1`

## 🔗 Dependencies

- [[06a2j9jv7f40ihnra63q0xx99ry62h35-python-imports-check-hook.sh]]
- [[10vyvpww925496jqxril8ykb450pbsq2-source]]
