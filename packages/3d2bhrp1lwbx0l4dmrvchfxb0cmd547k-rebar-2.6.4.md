...
- **Derivation Path**: `/nix/store/3d2bhrp1lwbx0l4dmrvchfxb0cmd547k-rebar-2.6.4.drv`
...
- **Outputs**:
  - `out`:  `/nix/store/3d2bhrp1lwbx0l4dmrvchfxb0cmd547k-rebar-2.6.4`
