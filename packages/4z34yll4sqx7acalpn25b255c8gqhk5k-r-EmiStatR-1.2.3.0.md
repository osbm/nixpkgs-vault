...
- **Name**: `rPackages.EmiStatR`
- **Version**: `1.2.3.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://cran.r-project.org/web/packages/EmiStatR/](https://cran.r-project.org/web/packages/EmiStatR/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/4z34yll4sqx7acalpn25b255c8gqhk5k-r-EmiStatR-1.2.3.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/4z34yll4sqx7acalpn25b255c8gqhk5k-r-EmiStatR-1.2.3.0`
...
- [[lm5hzi5wapp5z0mpaz705k0bgvgj02fn-EmiStatR_1.2.3.0.tar.gz]]
