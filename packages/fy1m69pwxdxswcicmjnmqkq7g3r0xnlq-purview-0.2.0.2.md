...
- **Name**: `haskellPackages.purview`
- **Version**: `0.2.0.2`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: A simple, fun way to build websites
- **Homepage**: [https://hackage.haskell.org/package/purview](https://hackage.haskell.org/package/purview)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/fy1m69pwxdxswcicmjnmqkq7g3r0xnlq-purview-0.2.0.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:547987`
- **Outputs**:
  - `doc`:  `/nix/store/fy1m69pwxdxswcicmjnmqkq7g3r0xnlq-purview-0.2.0.2`
  - `out`:  `/nix/store/fy1m69pwxdxswcicmjnmqkq7g3r0xnlq-purview-0.2.0.2`
...
- [[i1wbgn9h1jyvdqvkrxq0h84gg6ar0f59-purview-0.2.0.2.tar.gz]]
