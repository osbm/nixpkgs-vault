---
aliases:
  - androidenv.androidPkgs.all.system-images.v18.default.armeabi-v7a
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.system-images.v18.default.armeabi-v7a`
- **Version**: `18_r05.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/1qxm7lsy1scyznn0llzykab34cdwm9g5-armeabi-v7a-18_r05.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/1qxm7lsy1scyznn0llzykab34cdwm9g5-armeabi-v7a-18_r05.zip`
