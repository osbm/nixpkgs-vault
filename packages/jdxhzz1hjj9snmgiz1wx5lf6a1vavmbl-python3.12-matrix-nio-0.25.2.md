...
- **Name**: `python312Packages.matrix-nio`
- **Version**: `0.25.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Python Matrix client library, designed according to sans I/O principles
- **Homepage**: [https://github.com/poljar/matrix-nio](https://github.com/poljar/matrix-nio)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/jdxhzz1hjj9snmgiz1wx5lf6a1vavmbl-python3.12-matrix-nio-0.25.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/matrix-nio/default.nix:167`
- **Outputs**:
  - `dist`:  `/nix/store/jdxhzz1hjj9snmgiz1wx5lf6a1vavmbl-python3.12-matrix-nio-0.25.2`
  - `out`:  `/nix/store/jdxhzz1hjj9snmgiz1wx5lf6a1vavmbl-python3.12-matrix-nio-0.25.2`

## 🔗 Dependencies

- [[113b6hxwnpbyv852cf0zwd6a6z2w8m68-python3.12-aiohttp-3.12.15]]
- [[16aqspsn74dhk69k9fy2n361ik8y4bfc-python3.12-hpack-4.1.0]]
...
- [[818kjz3vzh335ylg65b8kzvy1d4yylq4-python3.12-hyperframe-6.1.0]]
- [[8bak1x4f2rb7c7wvawcsry464jgm317h-python3.12-aiohttp-socks-0.10.1]]
...
- [[w8jc659b60m2ily3va8s3ka1a35lfy3j-source]]
...
- `/nix/store/jgq0qij4gh71jn5naigb60ipbr6471ph-allow-tests-without-olm.patch`
