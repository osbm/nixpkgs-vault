...
- **Name**: `python312Packages.aiopvpc`
- **Version**: `4.3.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Python module to download Spanish electricity hourly prices (PVPC)
- **Homepage**: [https://github.com/azogue/aiopvpc](https://github.com/azogue/aiopvpc)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/bpvaw2c2h6gn14wfzmbi48a3gpxkrx7c-python3.12-aiopvpc-4.3.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/aiopvpc/default.nix:48`
- **Outputs**:
  - `dist`:  `/nix/store/bpvaw2c2h6gn14wfzmbi48a3gpxkrx7c-python3.12-aiopvpc-4.3.1`
  - `out`:  `/nix/store/bpvaw2c2h6gn14wfzmbi48a3gpxkrx7c-python3.12-aiopvpc-4.3.1`
...
- [[n5iai984anzn90b7fdy60kam5f5n69rz-source]]
