...
Modul to communicate with Tailwind garage door openers

## 📋 Package Information

- **Name**: `python312Packages.gotailwind`
- **Version**: `0.3.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Modul to communicate with Tailwind garage door openers
- **Homepage**: [https://github.com/frenck/python-gotailwind](https://github.com/frenck/python-gotailwind)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/1nz9c7vcxkilynbpjcaxp3ry4x2bm9dw-python3.12-gotailwind-0.3.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/gotailwind/default.nix:69`
- **Outputs**:
  - `dist`:  `/nix/store/1nz9c7vcxkilynbpjcaxp3ry4x2bm9dw-python3.12-gotailwind-0.3.0`
  - `out`:  `/nix/store/1nz9c7vcxkilynbpjcaxp3ry4x2bm9dw-python3.12-gotailwind-0.3.0`

## 🔗 Dependencies

- [[06cshvy0lwbaj0ad05190hsawrisamzq-source]]
