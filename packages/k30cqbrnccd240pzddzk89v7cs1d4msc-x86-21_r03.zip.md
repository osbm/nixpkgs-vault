---
aliases:
  - androidenv.androidPkgs.all.system-images.v21.android-tv.x86
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.system-images.v21.android-tv.x86`
- **Version**: `21_r03.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/k30cqbrnccd240pzddzk89v7cs1d4msc-x86-21_r03.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/k30cqbrnccd240pzddzk89v7cs1d4msc-x86-21_r03.zip`
