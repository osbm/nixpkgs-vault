...
- **Name**: `haskellPackages.hs-pattrans`
- **Version**: `0.1.0.2`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: DSL for musical patterns and transformation, based on contravariant functors
- **Homepage**: [https://hackage.haskell.org/package/hs-pattrans](https://hackage.haskell.org/package/hs-pattrans)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/3w5qr3xcagr4zymvh4xbfpr3cc7ax7cz-hs-pattrans-0.1.0.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:347593`
- **Outputs**:
  - `doc`:  `/nix/store/3w5qr3xcagr4zymvh4xbfpr3cc7ax7cz-hs-pattrans-0.1.0.2`
  - `out`:  `/nix/store/3w5qr3xcagr4zymvh4xbfpr3cc7ax7cz-hs-pattrans-0.1.0.2`
...
- [[kf9dmibwdcy6fg6dqqj8bs7ai7q3fl31-hs-pattrans-0.1.0.2.tar.gz]]
