...
- **Name**: `haskellPackages.pptable`
- **Version**: `0.3.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Pretty Print containers in a tabular format
- **Homepage**: [https://hackage.haskell.org/package/pptable](https://hackage.haskell.org/package/pptable)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/4m1m4lzrga06sc3p3pqjv3q22ww77f1z-pptable-0.3.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:535220`
- **Outputs**:
  - `doc`:  `/nix/store/4m1m4lzrga06sc3p3pqjv3q22ww77f1z-pptable-0.3.0.0`
  - `out`:  `/nix/store/4m1m4lzrga06sc3p3pqjv3q22ww77f1z-pptable-0.3.0.0`
...
- [[d5vngpbfa8ykpgp6lhf4w40ybv1vssdw-pptable-0.3.0.0.tar.gz]]
...
- [[rsjvdj272alpwwgdsfbiycg9c4n3gk7x-pptable-0.3.0.0-r1.cabal]]
