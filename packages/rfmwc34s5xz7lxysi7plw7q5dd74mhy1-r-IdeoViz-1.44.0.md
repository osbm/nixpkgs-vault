...
- **Name**: `rPackages.IdeoViz`
- **Version**: `1.44.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://bioconductor.org/packages/3.21/bioc/html/IdeoViz.html](https://bioconductor.org/packages/3.21/bioc/html/IdeoViz.html)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/rfmwc34s5xz7lxysi7plw7q5dd74mhy1-r-IdeoViz-1.44.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/rfmwc34s5xz7lxysi7plw7q5dd74mhy1-r-IdeoViz-1.44.0`
...
- [[xclgsxcrxnwx8fb6famv72cdyxjdfc8r-IdeoViz_1.44.0.tar.gz]]
