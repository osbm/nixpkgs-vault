...
- **Name**: `minecraftServers.vanilla-1-14`
- **Version**: `1.14.4`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/0fzlkwwvggi40wx4zqzlpbc75v4ir1rx-minecraft-server-1.14.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/games/minecraft-servers/derivation.nix:43`
- **Outputs**:
  - `out`:  `/nix/store/0fzlkwwvggi40wx4zqzlpbc75v4ir1rx-minecraft-server-1.14.4`
...
- [[k9hrlrja5mzk332qnm1a1x4a1ccsz493-server.jar]]
