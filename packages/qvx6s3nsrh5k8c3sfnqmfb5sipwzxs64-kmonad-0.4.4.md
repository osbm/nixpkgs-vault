...
- **Homepage**: [https://hackage.haskell.org/package/kmonad](https://hackage.haskell.org/package/kmonad)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/qvx6s3nsrh5k8c3sfnqmfb5sipwzxs64-kmonad-0.4.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:401781`
- **Outputs**:
  - `bin`:  `/nix/store/qvx6s3nsrh5k8c3sfnqmfb5sipwzxs64-kmonad-0.4.4`
  - `doc`:  `/nix/store/qvx6s3nsrh5k8c3sfnqmfb5sipwzxs64-kmonad-0.4.4`
  - `out`:  `/nix/store/qvx6s3nsrh5k8c3sfnqmfb5sipwzxs64-kmonad-0.4.4`
...
- [[rglqrdl3y3s70g14v5zfkxvq83yaixva-kmonad-0.4.4.tar.gz]]
