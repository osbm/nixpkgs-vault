...
- **Name**: `graalvmPackages.graalnodejs`
- **Version**: `24.2.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: High-Performance Polyglot VM (Product: graalnodejs)
...
- **Derivation Path**: `/nix/store/ji0i8r52s6nwy8d954ix1643hzaffis1-graalnodejs-24.2.2.drv`
...
- **Outputs**:
  - `out`:  `/nix/store/ji0i8r52s6nwy8d954ix1643hzaffis1-graalnodejs-24.2.2`
...
- [[vfryqc139p2lfa64p94jikhswxq1nf0m-graalnodejs-community-24.2.2-linux-amd64.tar.gz]]
