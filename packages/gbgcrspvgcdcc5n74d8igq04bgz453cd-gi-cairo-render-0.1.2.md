...
- **Name**: `haskellPackages.gi-cairo-render`
- **Version**: `0.1.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: GI friendly Binding to the Cairo library
- **Homepage**: [https://hackage.haskell.org/package/gi-cairo-render](https://hackage.haskell.org/package/gi-cairo-render)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/gbgcrspvgcdcc5n74d8igq04bgz453cd-gi-cairo-render-0.1.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:263856`
- **Outputs**:
  - `doc`:  `/nix/store/gbgcrspvgcdcc5n74d8igq04bgz453cd-gi-cairo-render-0.1.2`
  - `out`:  `/nix/store/gbgcrspvgcdcc5n74d8igq04bgz453cd-gi-cairo-render-0.1.2`
...
- [[8amx267nm3vr6hc16w8dd70lkg3x0fx7-gi-cairo-render-0.1.2.tar.gz]]
