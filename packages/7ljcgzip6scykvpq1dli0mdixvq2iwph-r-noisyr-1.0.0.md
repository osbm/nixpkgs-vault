...
- **Name**: `rPackages.noisyr`
- **Version**: `1.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/noisyr/](https://cran.r-project.org/web/packages/noisyr/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/7ljcgzip6scykvpq1dli0mdixvq2iwph-r-noisyr-1.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/7ljcgzip6scykvpq1dli0mdixvq2iwph-r-noisyr-1.0.0`
...
- [[a0h60vd03yzb13jywgi047jzs56hrl39-noisyr_1.0.0.tar.gz]]
