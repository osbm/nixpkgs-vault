...
- **Name**: `linuxKernel.packages.linux_xanmod.zfs_2_3`
...
- **Derivation Path**: `/nix/store/f69jrva0wrad5kjjkaljmi6mngh6zgby-zfs-kernel-2.3.4-6.12.48.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/zfs/generic.nix:322`
- **Outputs**:
  - `out`:  `/nix/store/f69jrva0wrad5kjjkaljmi6mngh6zgby-zfs-kernel-2.3.4-6.12.48`
