---
aliases:
  - linuxKernel.packages.linux_6_16.rr-zen_workaround
tags:
  - license/unknown
  - maintainers/vcunat
  - outputs/out
...
- **Name**: `linuxKernel.packages.linux_6_16.rr-zen_workaround`
- **Version**: `5.9.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/milv86k7829irqv0azfbqw1d2yvzzcva-rr-zen_workaround-5.9.0.drv`
...
- **Outputs**:
  - `out`:  `/nix/store/milv86k7829irqv0azfbqw1d2yvzzcva-rr-zen_workaround-5.9.0`
