...
- **Name**: `python313Packages.authlib`
- **Version**: `1.6.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/rzv5nysf1ws8zd8j10a6mdmg0ka50bqa-python3.13-authlib-1.6.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/authlib/default.nix:65`
- **Outputs**:
  - `dist`:  `/nix/store/rzv5nysf1ws8zd8j10a6mdmg0ka50bqa-python3.13-authlib-1.6.1`
  - `out`:  `/nix/store/rzv5nysf1ws8zd8j10a6mdmg0ka50bqa-python3.13-authlib-1.6.1`
