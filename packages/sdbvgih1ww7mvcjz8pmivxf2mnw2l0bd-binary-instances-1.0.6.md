---
aliases:
  - haskellPackages.binary-instances
tags:
  - license/unknown
  - outputs/doc
  - outputs/out
...
- **Name**: `haskellPackages.binary-instances`
- **Version**: `1.0.6`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Orphan instances for binary
- **Homepage**: [https://hackage.haskell.org/package/binary-instances](https://hackage.haskell.org/package/binary-instances)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/sdbvgih1ww7mvcjz8pmivxf2mnw2l0bd-binary-instances-1.0.6.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:103531`
- **Outputs**:
  - `doc`:  `/nix/store/sdbvgih1ww7mvcjz8pmivxf2mnw2l0bd-binary-instances-1.0.6`
  - `out`:  `/nix/store/sdbvgih1ww7mvcjz8pmivxf2mnw2l0bd-binary-instances-1.0.6`
...
- [[j2kmpqpshzd35nfh312y7wyrgf33kqa2-binary-instances-1.0.6.tar.gz]]
