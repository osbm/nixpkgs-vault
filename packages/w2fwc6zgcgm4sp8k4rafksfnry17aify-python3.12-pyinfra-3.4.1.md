...
- **Name**: `python312Packages.pyinfra`
- **Version**: `3.4.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/w2fwc6zgcgm4sp8k4rafksfnry17aify-python3.12-pyinfra-3.4.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/pyinfra/default.nix:62`
- **Outputs**:
  - `dist`:  `/nix/store/w2fwc6zgcgm4sp8k4rafksfnry17aify-python3.12-pyinfra-3.4.1`
  - `out`:  `/nix/store/w2fwc6zgcgm4sp8k4rafksfnry17aify-python3.12-pyinfra-3.4.1`
