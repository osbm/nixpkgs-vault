...
- **Homepage**: [https://angie.software/en/](https://angie.software/en/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/py8ppvrq6zcij8482r4dbwxhw9kjcp39-angie-1.10.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/http/angie/default.nix:46`
- **Outputs**:
  - `doc`:  `/nix/store/py8ppvrq6zcij8482r4dbwxhw9kjcp39-angie-1.10.2`
  - `out`:  `/nix/store/py8ppvrq6zcij8482r4dbwxhw9kjcp39-angie-1.10.2`
...
- [[wrxzhd1nhvvbbkqdlwlf85zxljd2g42z-angie-1.10.2.tar.gz]]
