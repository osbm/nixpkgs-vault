...
- **Name**: `rPackages.feedeR`
- **Version**: `0.0.10`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://cran.r-project.org/web/packages/feedeR/](https://cran.r-project.org/web/packages/feedeR/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/dmgpf7xm03axygvzmg49q40xyycpf6vf-r-feedeR-0.0.10.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/dmgpf7xm03axygvzmg49q40xyycpf6vf-r-feedeR-0.0.10`

## 🔗 Dependencies

- [[1h27yi3m0mr91rrvkqjz9ybdlxcmz2q7-feedeR_0.0.10.tar.gz]]
