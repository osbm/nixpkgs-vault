---
aliases:
  - androidenv.androidPkgs.all.system-images.v25.android-tv.x86
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.system-images.v25.android-tv.x86`
- **Version**: `25_r16.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/izx1kl46vwn4iiqjbcmxyf1csr2hcxcp-x86-25_r16.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/izx1kl46vwn4iiqjbcmxyf1csr2hcxcp-x86-25_r16.zip`
