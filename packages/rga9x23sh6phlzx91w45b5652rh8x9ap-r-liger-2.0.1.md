...
- **Name**: `rPackages.liger`
- **Version**: `2.0.1`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://cran.r-project.org/web/packages/liger/](https://cran.r-project.org/web/packages/liger/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/rga9x23sh6phlzx91w45b5652rh8x9ap-r-liger-2.0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/rga9x23sh6phlzx91w45b5652rh8x9ap-r-liger-2.0.1`
...
- [[wcaamm8hlic7dnag4hih3kwp7yyx1sbm-liger_2.0.1.tar.gz]]
