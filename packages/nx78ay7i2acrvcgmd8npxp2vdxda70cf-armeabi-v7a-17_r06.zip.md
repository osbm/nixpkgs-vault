---
aliases:
  - androidenv.androidPkgs.all.system-images.v17.google_apis.armeabi-v7a
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.system-images.v17.google_apis.armeabi-v7a`
- **Version**: `17_r06.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/nx78ay7i2acrvcgmd8npxp2vdxda70cf-armeabi-v7a-17_r06.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/nx78ay7i2acrvcgmd8npxp2vdxda70cf-armeabi-v7a-17_r06.zip`
