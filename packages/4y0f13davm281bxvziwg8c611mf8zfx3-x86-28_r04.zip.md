---
aliases:
  - androidenv.androidPkgs.all.system-images.v28.default.x86
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.system-images.v28.default.x86`
- **Version**: `28_r04.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/4y0f13davm281bxvziwg8c611mf8zfx3-x86-28_r04.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/4y0f13davm281bxvziwg8c611mf8zfx3-x86-28_r04.zip`
