...
- **Name**: `python312Packages.fire`
- **Version**: `0.7.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Library for automatically generating command line interfaces
- **Homepage**: [https://github.com/google/python-fire](https://github.com/google/python-fire)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/3pc84qcv549ym43c1kvikb3f0cmcr0kw-python3.12-fire-0.7.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/fire/default.nix:46`
- **Outputs**:
  - `dist`:  `/nix/store/3pc84qcv549ym43c1kvikb3f0cmcr0kw-python3.12-fire-0.7.1`
  - `out`:  `/nix/store/3pc84qcv549ym43c1kvikb3f0cmcr0kw-python3.12-fire-0.7.1`
...
- [[yga2834bd8a3dxlgf8fzk8qp43h1qfm1-source]]
