...
- **Name**: `python313Packages.cement`
- **Version**: `3.0.14`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: CLI Application Framework for Python
- **Homepage**: [https://builtoncement.com/](https://builtoncement.com/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/fagai390231gzh2h1zvjaib97kwn9s2v-python3.13-cement-3.0.14.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/cement/default.nix:80`
- **Outputs**:
  - `dist`:  `/nix/store/fagai390231gzh2h1zvjaib97kwn9s2v-python3.13-cement-3.0.14`
  - `out`:  `/nix/store/fagai390231gzh2h1zvjaib97kwn9s2v-python3.13-cement-3.0.14`
...
- [[aixalrlc4rms54v6yc2p95ivlryy63ig-source]]
