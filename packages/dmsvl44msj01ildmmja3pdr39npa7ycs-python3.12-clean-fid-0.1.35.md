...
- **Name**: `python312Packages.clean-fid`
- **Version**: `0.1.35`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: PyTorch - FID calculation with proper image resizing and quantization steps [CVPR 2022]
- **Homepage**: [https://github.com/GaParmar/clean-fid](https://github.com/GaParmar/clean-fid)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/dmsvl44msj01ildmmja3pdr39npa7ycs-python3.12-clean-fid-0.1.35.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/clean-fid/default.nix:44`
- **Outputs**:
  - `dist`:  `/nix/store/dmsvl44msj01ildmmja3pdr39npa7ycs-python3.12-clean-fid-0.1.35`
  - `out`:  `/nix/store/dmsvl44msj01ildmmja3pdr39npa7ycs-python3.12-clean-fid-0.1.35`
...
- [[yrpswvd0pidyl3r4f05q5nsnqmrfr54g-source]]
