---
aliases:
  - home-assistant-component-tests.command_line
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.command_line`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/h25sgd1lky0y3gblkvyrjqb89jdczf58-homeassistant-test-command_line-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/h25sgd1lky0y3gblkvyrjqb89jdczf58-homeassistant-test-command_line-2025.9.4`
