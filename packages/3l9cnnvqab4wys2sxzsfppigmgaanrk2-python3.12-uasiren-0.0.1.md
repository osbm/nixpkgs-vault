...
- **Name**: `python312Packages.uasiren`
- **Version**: `0.0.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/3l9cnnvqab4wys2sxzsfppigmgaanrk2-python3.12-uasiren-0.0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/uasiren/default.nix:49`
- **Outputs**:
  - `dist`:  `/nix/store/3l9cnnvqab4wys2sxzsfppigmgaanrk2-python3.12-uasiren-0.0.1`
  - `out`:  `/nix/store/3l9cnnvqab4wys2sxzsfppigmgaanrk2-python3.12-uasiren-0.0.1`
