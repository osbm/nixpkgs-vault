---
aliases:
  - python312Packages.pytorch-tabnet
tags:
  - license/unknown
...
- **Name**: `python312Packages.pytorch-tabnet`
- **Version**: `4.1.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: PyTorch implementation of TabNet
- **Homepage**: [https://github.com/dreamquark-ai/tabnet](https://github.com/dreamquark-ai/tabnet)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/2w1qgckvwl8ifiknfmp7vk91n9s6zf7f-python3.12-pytorch-tabnet-4.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/pytorch-tabnet/default.nix:54`
- **Outputs**:
  - `dist`:  `/nix/store/2w1qgckvwl8ifiknfmp7vk91n9s6zf7f-python3.12-pytorch-tabnet-4.1.0`
  - `out`:  `/nix/store/2w1qgckvwl8ifiknfmp7vk91n9s6zf7f-python3.12-pytorch-tabnet-4.1.0`

## 🔗 Dependencies

- [[01snwzmzl4pm638jnggnzvcdd5m2yq2l-python3.12-torch-2.8.0]]
- [[5s22xqwqqla9m533xzwi77zx6way0idq-source]]
