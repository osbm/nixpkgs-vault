...
- **Name**: `haskellPackages.goggles`
- **Version**: `0.3.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Extensible interface to Web APIs
- **Homepage**: [https://hackage.haskell.org/package/goggles](https://hackage.haskell.org/package/goggles)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/5ailq53p434wzr3h1d95hrj1d19v644d-goggles-0.3.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:275361`
- **Outputs**:
  - `doc`:  `/nix/store/5ailq53p434wzr3h1d95hrj1d19v644d-goggles-0.3.2`
  - `out`:  `/nix/store/5ailq53p434wzr3h1d95hrj1d19v644d-goggles-0.3.2`
...
- [[p02svarjfann1r2iz3xccfzcvwn0lm45-goggles-0.3.2.tar.gz]]
