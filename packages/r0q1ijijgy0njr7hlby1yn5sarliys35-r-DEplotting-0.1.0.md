...
- **Name**: `rPackages.DEplotting`
- **Version**: `0.1.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/DEplotting/](https://cran.r-project.org/web/packages/DEplotting/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/r0q1ijijgy0njr7hlby1yn5sarliys35-r-DEplotting-0.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/r0q1ijijgy0njr7hlby1yn5sarliys35-r-DEplotting-0.1.0`
...
- [[i6h9p64pql2y0q687m36sfd19dfs63fm-DEplotting_0.1.0.tar.gz]]
