...
- **Name**: `rPackages.socialrisk`
- **Version**: `0.5.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/socialrisk/](https://cran.r-project.org/web/packages/socialrisk/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/hnycznkwdjz9hkfc7803nz9mdgpgy2hi-r-socialrisk-0.5.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/hnycznkwdjz9hkfc7803nz9mdgpgy2hi-r-socialrisk-0.5.1`
...
- [[m79y7rj2l0ar7jsrv9jgiclg0ixis7dq-socialrisk_0.5.1.tar.gz]]
