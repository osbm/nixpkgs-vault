...
- **Derivation Path**: `/nix/store/66bzrdw11pds73ay0r60rq1hlxgrbx4k-zabbix-server-6.0.41.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/monitoring/zabbix/server.nix:121`
- **Outputs**:
  - `out`:  `/nix/store/66bzrdw11pds73ay0r60rq1hlxgrbx4k-zabbix-server-6.0.41`
