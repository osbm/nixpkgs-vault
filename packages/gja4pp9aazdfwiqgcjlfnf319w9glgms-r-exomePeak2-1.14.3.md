...
- **Name**: `rPackages.exomePeak2`
- **Version**: `1.14.3`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://bioconductor.org/packages/3.21/bioc/html/exomePeak2.html](https://bioconductor.org/packages/3.21/bioc/html/exomePeak2.html)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/gja4pp9aazdfwiqgcjlfnf319w9glgms-r-exomePeak2-1.14.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/gja4pp9aazdfwiqgcjlfnf319w9glgms-r-exomePeak2-1.14.3`
...
- [[kkh4khsmb12a8n51lyqkhpzhmhwm4nyx-exomePeak2_1.14.3.tar.gz]]
