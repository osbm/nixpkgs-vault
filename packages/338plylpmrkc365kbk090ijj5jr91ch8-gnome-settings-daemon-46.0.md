...
- **Name**: `gnome-settings-daemon46`
- **Version**: `46.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: GNOME Settings Daemon
- **Homepage**: [https://gitlab.gnome.org/GNOME/gnome-settings-daemon/](https://gitlab.gnome.org/GNOME/gnome-settings-daemon/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/338plylpmrkc365kbk090ijj5jr91ch8-gnome-settings-daemon-46.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/gn/gnome-settings-daemon46/package.nix:113`
- **Outputs**:
  - `out`:  `/nix/store/338plylpmrkc365kbk090ijj5jr91ch8-gnome-settings-daemon-46.0`

## 🔗 Dependencies

- [[04fqy4gqwzd5mgqcw7vxcw5knsln49b3-colord-1.4.6]]
- [[04sxd1ncbv87d14flich8a6g06jbyw6c-docbook-xsl-nons-1.79.2]]
- [[05zhfywv9iw1v0ssg21d7xzq5af65dxh-gnome-session-ctl-47.0.1]]
...
- [[d4z3n07dkkxzh6s5793pjf1qxcilh3j9-gnome-settings-daemon-46.0.tar.xz]]
...
- [[llr4v9y2kyzrcsk4c60ab5vk6rpbi5af-fix-paths.patch]]
...
- `/nix/store/sy14q4855kcwpjgcl8rfc175x6bcdb7n-add-gnome-session-ctl-option.patch`
