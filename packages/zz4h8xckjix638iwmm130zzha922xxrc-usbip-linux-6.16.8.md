---
aliases:
  - linuxKernel.packages.linux_6_16.usbip
tags:
  - license/unknown
  - outputs/out
---
...
- **Name**: `linuxKernel.packages.linux_6_16.usbip`
- **Version**: `6.16.8`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/zz4h8xckjix638iwmm130zzha922xxrc-usbip-linux-6.16.8.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/usbip/default.nix:45`
- **Outputs**:
  - `out`:  `/nix/store/zz4h8xckjix638iwmm130zzha922xxrc-usbip-linux-6.16.8`
