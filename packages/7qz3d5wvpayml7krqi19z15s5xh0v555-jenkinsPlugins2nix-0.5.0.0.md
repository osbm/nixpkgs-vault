...
- **Name**: `haskellPackages.jenkinsPlugins2nix`
- **Version**: `0.5.0.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Generate nix for Jenkins plugins
- **Homepage**: [https://hackage.haskell.org/package/jenkinsPlugins2nix](https://hackage.haskell.org/package/jenkinsPlugins2nix)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/7qz3d5wvpayml7krqi19z15s5xh0v555-jenkinsPlugins2nix-0.5.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:389419`
- **Outputs**:
  - `doc`:  `/nix/store/7qz3d5wvpayml7krqi19z15s5xh0v555-jenkinsPlugins2nix-0.5.0.0`
  - `out`:  `/nix/store/7qz3d5wvpayml7krqi19z15s5xh0v555-jenkinsPlugins2nix-0.5.0.0`
...
- [[d4f9ffydmnflimj1s3gi1b0f18h48sb2-jenkinsPlugins2nix-0.5.0.0.tar.gz]]
