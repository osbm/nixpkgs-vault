---
aliases:
  - androidenv.androidPkgs.all.extras.extras-google-admob_ads_sdk
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.extras.extras-google-admob_ads_sdk`
- **Version**: `6.4.1.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/xgq9a6qw61m6s3zbp000cisap9hay7f2-GoogleAdMobAdsSdkAndroid-6.4.1.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/xgq9a6qw61m6s3zbp000cisap9hay7f2-GoogleAdMobAdsSdkAndroid-6.4.1.zip`
