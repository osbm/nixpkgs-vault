...
- **Name**: `python313Packages.aionotion`
- **Version**: `2025.02.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Python library for Notion Home Monitoring
- **Homepage**: [https://github.com/bachya/aionotion](https://github.com/bachya/aionotion)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/0dqhhphq35shmfzk1bzdp593kyb8268q-python3.13-aionotion-2025.02.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/aionotion/default.nix:73`
- **Outputs**:
  - `dist`:  `/nix/store/0dqhhphq35shmfzk1bzdp593kyb8268q-python3.13-aionotion-2025.02.0`
  - `out`:  `/nix/store/0dqhhphq35shmfzk1bzdp593kyb8268q-python3.13-aionotion-2025.02.0`
...
- [[qmmqc3gp62mjb70bdg3alj0dmla4w9in-source]]
