...
- **Name**: `haskellPackages.yam`
- **Version**: `0.7`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: A wrapper of servant
- **Homepage**: [https://hackage.haskell.org/package/yam](https://hackage.haskell.org/package/yam)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/m1b2flyb69xz55n9j9bwi0dd1ac1vl6p-yam-0.7.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:735039`
- **Outputs**:
  - `doc`:  `/nix/store/m1b2flyb69xz55n9j9bwi0dd1ac1vl6p-yam-0.7`
  - `out`:  `/nix/store/m1b2flyb69xz55n9j9bwi0dd1ac1vl6p-yam-0.7`
...
- [[p3wxfr9aymfvyrmpfv75s32aigzcvhcb-yam-0.7.tar.gz]]
