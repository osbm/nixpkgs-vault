...
- **Name**: `python313Packages.fastapi-sso`
- **Version**: `0.18.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/64wkrw7r120aiz1acrl9pql9giy1bwcl-python3.13-fastapi-sso-0.18.0.drv`
...
- **Outputs**:
  - `dist`:  `/nix/store/64wkrw7r120aiz1acrl9pql9giy1bwcl-python3.13-fastapi-sso-0.18.0`
  - `out`:  `/nix/store/64wkrw7r120aiz1acrl9pql9giy1bwcl-python3.13-fastapi-sso-0.18.0`
