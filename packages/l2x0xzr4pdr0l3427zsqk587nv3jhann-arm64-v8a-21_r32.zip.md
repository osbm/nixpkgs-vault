---
aliases:
  - androidenv.androidPkgs.all.system-images.v21.google_apis.arm64-v8a
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.system-images.v21.google_apis.arm64-v8a`
- **Version**: `21_r32.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/l2x0xzr4pdr0l3427zsqk587nv3jhann-arm64-v8a-21_r32.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/l2x0xzr4pdr0l3427zsqk587nv3jhann-arm64-v8a-21_r32.zip`
