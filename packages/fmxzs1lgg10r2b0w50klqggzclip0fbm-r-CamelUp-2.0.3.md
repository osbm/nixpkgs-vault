...
- **Name**: `rPackages.CamelUp`
- **Version**: `2.0.3`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/CamelUp/](https://cran.r-project.org/web/packages/CamelUp/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/fmxzs1lgg10r2b0w50klqggzclip0fbm-r-CamelUp-2.0.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/fmxzs1lgg10r2b0w50klqggzclip0fbm-r-CamelUp-2.0.3`
...
- [[vhcr42dnyqshd0s0lmxxixxqgfvf3p3a-CamelUp_2.0.3.tar.gz]]
