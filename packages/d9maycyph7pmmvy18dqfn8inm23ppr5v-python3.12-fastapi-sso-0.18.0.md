...
- **Name**: `python312Packages.fastapi-sso`
- **Version**: `0.18.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: FastAPI plugin to enable SSO to most common providers (such as Facebook login, Google login and login via Microsoft Office 365 Account
- **Homepage**: [https://github.com/tomasvotava/fastapi-sso](https://github.com/tomasvotava/fastapi-sso)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/d9maycyph7pmmvy18dqfn8inm23ppr5v-python3.12-fastapi-sso-0.18.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/fastapi-sso/default.nix:55`
- **Outputs**:
  - `dist`:  `/nix/store/d9maycyph7pmmvy18dqfn8inm23ppr5v-python3.12-fastapi-sso-0.18.0`
  - `out`:  `/nix/store/d9maycyph7pmmvy18dqfn8inm23ppr5v-python3.12-fastapi-sso-0.18.0`
...
- [[jvqkz0c1rc3shx00xy07ljh5aax659qc-source]]
