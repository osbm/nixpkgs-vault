---
aliases:
  - androidenv.androidPkgs.all.addons.v9.google_apis
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.addons.v9.google_apis`
- **Version**: `9_r02.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/7mv83vd4a5z5shph6pbcmnma6gd33by6-google_apis-9_r02.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/7mv83vd4a5z5shph6pbcmnma6gd33by6-google_apis-9_r02.zip`
