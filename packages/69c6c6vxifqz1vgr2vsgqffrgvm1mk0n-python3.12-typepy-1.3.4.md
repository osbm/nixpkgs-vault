...
- **Name**: `python312Packages.typepy`
- **Version**: `1.3.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Library for variable type checker/validator/converter at a run time
- **Homepage**: [https://github.com/thombashi/typepy](https://github.com/thombashi/typepy)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/69c6c6vxifqz1vgr2vsgqffrgvm1mk0n-python3.12-typepy-1.3.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/typepy/default.nix:50`
- **Outputs**:
  - `dist`:  `/nix/store/69c6c6vxifqz1vgr2vsgqffrgvm1mk0n-python3.12-typepy-1.3.4`
  - `out`:  `/nix/store/69c6c6vxifqz1vgr2vsgqffrgvm1mk0n-python3.12-typepy-1.3.4`
...
- [[9a7fai51kcidp8a711dhdxvgy7897d3s-source]]
