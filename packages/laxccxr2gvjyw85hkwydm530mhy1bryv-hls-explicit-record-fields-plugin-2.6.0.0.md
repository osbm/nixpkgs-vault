...
- **Name**: `haskellPackages.hls-explicit-record-fields-plugin`
- **Version**: `2.6.0.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Explicit record fields plugin for Haskell Language Server
- **Homepage**: [https://hackage.haskell.org/package/hls-explicit-record-fields-plugin](https://hackage.haskell.org/package/hls-explicit-record-fields-plugin)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/laxccxr2gvjyw85hkwydm530mhy1bryv-hls-explicit-record-fields-plugin-2.6.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:334202`
- **Outputs**:
  - `doc`:  `/nix/store/laxccxr2gvjyw85hkwydm530mhy1bryv-hls-explicit-record-fields-plugin-2.6.0.0`
  - `out`:  `/nix/store/laxccxr2gvjyw85hkwydm530mhy1bryv-hls-explicit-record-fields-plugin-2.6.0.0`
...
- [[mnx62mzbd8cymyzmp713v4aa0704j7a7-hls-explicit-record-fields-plugin-2.6.0.0.tar.gz]]
