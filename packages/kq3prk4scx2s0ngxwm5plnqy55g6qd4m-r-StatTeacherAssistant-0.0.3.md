---
aliases:
  - rPackages.StatTeacherAssistant
tags:
  - license/unknown
  - outputs/out
---
...
- **Name**: `rPackages.StatTeacherAssistant`
- **Version**: `0.0.3`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/StatTeacherAssistant/](https://cran.r-project.org/web/packages/StatTeacherAssistant/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/kq3prk4scx2s0ngxwm5plnqy55g6qd4m-r-StatTeacherAssistant-0.0.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/kq3prk4scx2s0ngxwm5plnqy55g6qd4m-r-StatTeacherAssistant-0.0.3`

## 🔗 Dependencies

- [[02w5d3szjlbnnpjqyd8d1d6395nx5d9q-r-extraDistr-1.10.0]]
- [[1lzjwfylxj6vq92bydddrai7315617sk-StatTeacherAssistant_0.0.3.tar.gz]]
...
- [[k065clqmsqcmz4gw7nqgv7nkhj1p3v6v-r-rmatio-0.19.0]]
