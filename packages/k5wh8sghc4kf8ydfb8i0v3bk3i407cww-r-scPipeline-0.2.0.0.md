...
- **Name**: `rPackages.scPipeline`
- **Version**: `0.2.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/scPipeline/](https://cran.r-project.org/web/packages/scPipeline/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/k5wh8sghc4kf8ydfb8i0v3bk3i407cww-r-scPipeline-0.2.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/k5wh8sghc4kf8ydfb8i0v3bk3i407cww-r-scPipeline-0.2.0.0`

## 🔗 Dependencies

- [[30rzc9606yb3bjgyv1p0zrzwgyxdi2p5-scPipeline_0.2.0.0.tar.gz]]
