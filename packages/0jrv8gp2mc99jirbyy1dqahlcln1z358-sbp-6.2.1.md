...
- **Name**: `haskellPackages.sbp`
- **Version**: `6.2.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: SwiftNav's SBP Library
- **Homepage**: [https://hackage.haskell.org/package/sbp](https://hackage.haskell.org/package/sbp)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/0jrv8gp2mc99jirbyy1dqahlcln1z358-sbp-6.2.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:586326`
- **Outputs**:
  - `doc`:  `/nix/store/0jrv8gp2mc99jirbyy1dqahlcln1z358-sbp-6.2.1`
  - `out`:  `/nix/store/0jrv8gp2mc99jirbyy1dqahlcln1z358-sbp-6.2.1`
...
- [[jvaynyqk7q62gcd0rwjc87hirhphqx45-sbp-6.2.1.tar.gz]]
