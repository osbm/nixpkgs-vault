...
- **Name**: `haskellPackages.space`
- **Version**: `0.1.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Experimental library
- **Homepage**: [https://hackage.haskell.org/package/space](https://hackage.haskell.org/package/space)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/hdcyac6bhz5c6ia2fq84bc4hxqgrki5d-space-0.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:625461`
- **Outputs**:
  - `doc`:  `/nix/store/hdcyac6bhz5c6ia2fq84bc4hxqgrki5d-space-0.1.0`
  - `out`:  `/nix/store/hdcyac6bhz5c6ia2fq84bc4hxqgrki5d-space-0.1.0`
...
- [[h85w4r3y1j0d2yxjsrxm3b49bx6mnnm7-space-0.1.0.tar.gz]]
