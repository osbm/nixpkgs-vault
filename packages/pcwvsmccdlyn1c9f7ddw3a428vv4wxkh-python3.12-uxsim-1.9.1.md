...
- **Name**: `python312Packages.uxsim`
- **Version**: `1.9.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Vehicular traffic flow simulator in road network, written in pure Python
- **Homepage**: [https://github.com/toruseo/UXsim](https://github.com/toruseo/UXsim)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/pcwvsmccdlyn1c9f7ddw3a428vv4wxkh-python3.12-uxsim-1.9.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/uxsim/default.nix:58`
- **Outputs**:
  - `dist`:  `/nix/store/pcwvsmccdlyn1c9f7ddw3a428vv4wxkh-python3.12-uxsim-1.9.1`
  - `out`:  `/nix/store/pcwvsmccdlyn1c9f7ddw3a428vv4wxkh-python3.12-uxsim-1.9.1`
...
- [[xnrrnq37ya58dm1dn01zg3l3clm5qg33-source]]
- [[y4fb116j8zzrqx15ah15xnn64m0zhf2i-python3.12-networkx-3.5]]
- [[z99vzf35iinh3dnh2g994wbcbjrv4siq-ensure-newer-sources-hook]]

## 📁 Input Sources

- `/nix/store/hjh3jnlll82x4cvll1hj7wlsc73j3r5y-add-qt-plugin-path-to-env.patch`
