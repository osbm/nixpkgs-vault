...
man pages for LLDB 20.1.8

## 📋 Package Information

- **Name**: `llvmPackages_20.lldb-manpages`
- **Version**: `20.1.8`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: man pages for LLDB 20.1.8
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/v2krwrrxdhp52kpikm2zj0yim61jww2p-lldb-manpages-20.1.8.drv`
...
- **Outputs**:
  - `out`:  `/nix/store/v2krwrrxdhp52kpikm2zj0yim61jww2p-lldb-manpages-20.1.8`
...
- [[4yqnv95yabrn660kskxzs3zfzwxw3d1k-lldb-src-20.1.8]]
