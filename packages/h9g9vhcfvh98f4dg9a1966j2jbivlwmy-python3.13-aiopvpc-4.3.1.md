...
- **Name**: `python313Packages.aiopvpc`
- **Version**: `4.3.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/h9g9vhcfvh98f4dg9a1966j2jbivlwmy-python3.13-aiopvpc-4.3.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/aiopvpc/default.nix:48`
- **Outputs**:
  - `dist`:  `/nix/store/h9g9vhcfvh98f4dg9a1966j2jbivlwmy-python3.13-aiopvpc-4.3.1`
  - `out`:  `/nix/store/h9g9vhcfvh98f4dg9a1966j2jbivlwmy-python3.13-aiopvpc-4.3.1`
