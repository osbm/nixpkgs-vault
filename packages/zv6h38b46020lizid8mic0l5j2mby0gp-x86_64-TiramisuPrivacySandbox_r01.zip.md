---
aliases:
  - androidenv.androidPkgs.all.system-images.TiramisuPrivacySandbox.google_apis.x86_64
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.system-images.TiramisuPrivacySandbox.google_apis.x86_64`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/zv6h38b46020lizid8mic0l5j2mby0gp-x86_64-TiramisuPrivacySandbox_r01.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/zv6h38b46020lizid8mic0l5j2mby0gp-x86_64-TiramisuPrivacySandbox_r01.zip`
