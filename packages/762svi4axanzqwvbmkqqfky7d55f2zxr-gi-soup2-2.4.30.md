...
Libsoup 2.4.x bindings

## 📋 Package Information

- **Name**: `haskellPackages.gi-soup2`
- **Version**: `2.4.30`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Libsoup 2.4.x bindings
- **Homepage**: [https://hackage.haskell.org/package/gi-soup2](https://hackage.haskell.org/package/gi-soup2)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/762svi4axanzqwvbmkqqfky7d55f2zxr-gi-soup2-2.4.30.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:267090`
- **Outputs**:
  - `doc`:  `/nix/store/762svi4axanzqwvbmkqqfky7d55f2zxr-gi-soup2-2.4.30`
  - `out`:  `/nix/store/762svi4axanzqwvbmkqqfky7d55f2zxr-gi-soup2-2.4.30`
...
- [[xaxdqw0fzk6xjp9sh3lvnafma6ajnkaw-gi-soup2-2.4.30.tar.gz]]
