...
- **Name**: `haskellPackages.mortred`
- **Version**: `0.0.2`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Library for setting up and running scrapers with webdriver
- **Homepage**: [https://hackage.haskell.org/package/mortred](https://hackage.haskell.org/package/mortred)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/xcyhs5gxlw5pldv24svk445kybbckgr5-mortred-0.0.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:460528`
- **Outputs**:
  - `doc`:  `/nix/store/xcyhs5gxlw5pldv24svk445kybbckgr5-mortred-0.0.2`
  - `out`:  `/nix/store/xcyhs5gxlw5pldv24svk445kybbckgr5-mortred-0.0.2`

## 🔗 Dependencies

- [[29w8qiw9z66vkv9brkx1sd40fmh3nsv0-mortred-0.0.2.tar.gz]]
