...
- **Homepage**: [https://github.com/dustinblackman/cargo-run-bin](https://github.com/dustinblackman/cargo-run-bin)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/kz42vcy6mq6pzxwzhkpl7yscq7v2yh6z-cargo-run-bin-1.7.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/ca/cargo-run-bin/package.nix:22`
- **Outputs**:
  - `out`:  `/nix/store/kz42vcy6mq6pzxwzhkpl7yscq7v2yh6z-cargo-run-bin-1.7.4`
...
- [[rcff51z9yis7a406sq089lw08qjixby1-cargo-run-bin-1.7.4-vendor]]
- [[xqxbqs6qgnhvpkcai046s94jfrx8wb62-cargo-check-hook.sh]]
- [[zh7izmnxm4rr4r175afbsynrxjr1p492-cargo-run-bin-1.7.4.tar.gz]]
