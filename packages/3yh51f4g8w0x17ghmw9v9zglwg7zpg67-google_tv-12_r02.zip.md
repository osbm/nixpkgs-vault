---
aliases:
  - androidenv.androidPkgs.all.addons.v12.google_tv_addon
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.addons.v12.google_tv_addon`
- **Version**: `12_r02.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/3yh51f4g8w0x17ghmw9v9zglwg7zpg67-google_tv-12_r02.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/3yh51f4g8w0x17ghmw9v9zglwg7zpg67-google_tv-12_r02.zip`
