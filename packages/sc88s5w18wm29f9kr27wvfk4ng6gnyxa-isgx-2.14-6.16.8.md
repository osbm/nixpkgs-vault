---
aliases:
  - linuxKernel.packages.linux_latest_libre.isgx
tags:
  - broken
  - not-available
  - license/unknown
...
- **Name**: `linuxKernel.packages.linux_latest_libre.isgx`
- **Version**: `2.14-6.16.8`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
...
- **Derivation Path**: `/nix/store/sc88s5w18wm29f9kr27wvfk4ng6gnyxa-isgx-2.14-6.16.8.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/isgx/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/sc88s5w18wm29f9kr27wvfk4ng6gnyxa-isgx-2.14-6.16.8`
