...
- **Name**: `rPackages.rbison`
- **Version**: `1.0.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://cran.r-project.org/web/packages/rbison/](https://cran.r-project.org/web/packages/rbison/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/x8l9g3pd0hbhgz5rrh4cxs2rf2mdzbrz-r-rbison-1.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/x8l9g3pd0hbhgz5rrh4cxs2rf2mdzbrz-r-rbison-1.0.0`

## 🔗 Dependencies

- [[1y3q8qwpfxcawxxdinv8lkmsnbl7vbi3-rbison_1.0.0.tar.gz]]
