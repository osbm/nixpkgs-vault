...
- **Name**: `rPackages.DBERlibR`
- **Version**: `0.1.3`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://cran.r-project.org/web/packages/DBERlibR/](https://cran.r-project.org/web/packages/DBERlibR/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/dns3n0xc5qjhxhf1q618638w9c4hnasc-r-DBERlibR-0.1.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/dns3n0xc5qjhxhf1q618638w9c4hnasc-r-DBERlibR-0.1.3`
...
- [[i6xb46nn43vapipdj5aibj0pvg3h5a5y-DBERlibR_0.1.3.tar.gz]]
