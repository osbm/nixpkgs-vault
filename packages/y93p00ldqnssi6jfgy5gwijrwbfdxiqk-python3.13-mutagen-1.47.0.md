...
- **Name**: `python313Packages.mutagen`
- **Version**: `1.47.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Python module for handling audio metadata
- **Homepage**: [https://mutagen.readthedocs.io](https://mutagen.readthedocs.io)
- **License**: `unknown`
- **Platforms**: `aarch64-linux`, `armv5tel-linux`, `armv6l-linux`, `armv7a-linux`, `armv7l-linux`, `i686-linux`, `loongarch64-linux`, `m68k-linux`, `microblaze-linux`, `microblazeel-linux`, `mips-linux`, `mips64-linux`, `mips64el-linux`, `mipsel-linux`, `powerpc-linux`, `powerpc64-linux`, `powerpc64le-linux`, `riscv32-linux`, `riscv64-linux`, `s390-linux`, `s390x-linux`, `x86_64-linux`, `x86_64-darwin`, `aarch64-darwin`, `i686-cygwin`, `x86_64-cygwin`, `aarch64-windows`, `x86_64-windows`, `i686-windows`, `i686-freebsd`, `x86_64-freebsd`, `aarch64-freebsd`

## 🔧 Build Information

- **Derivation Path**: `/nix/store/y93p00ldqnssi6jfgy5gwijrwbfdxiqk-python3.13-mutagen-1.47.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/mutagen/default.nix:73`
- **Outputs**:
  - `dist`:  `/nix/store/y93p00ldqnssi6jfgy5gwijrwbfdxiqk-python3.13-mutagen-1.47.0`
  - `doc`:  `/nix/store/y93p00ldqnssi6jfgy5gwijrwbfdxiqk-python3.13-mutagen-1.47.0`
  - `out`:  `/nix/store/y93p00ldqnssi6jfgy5gwijrwbfdxiqk-python3.13-mutagen-1.47.0`

## 🔗 Dependencies

- [[06a2j9jv7f40ihnra63q0xx99ry62h35-python-imports-check-hook.sh]]
- [[257k0vnqp1xjgyrpc5as1r0nl7s4yv71-python3-3.13.7]]
- [[3f44dxs0xrwvz276qf57gy1gka0ndh1a-mutagen-1.47.0.tar.gz]]
...
- [[ysg0qv7rbh4jvcj487d3y54i446jb3sx-967212631719de1aeccbd6855c5b6d03f271fdfe.patch]]
