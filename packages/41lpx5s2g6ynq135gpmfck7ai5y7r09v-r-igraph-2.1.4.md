...
- **Name**: `rPackages.igraph`
- **Version**: `2.1.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/igraph/](https://cran.r-project.org/web/packages/igraph/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/41lpx5s2g6ynq135gpmfck7ai5y7r09v-r-igraph-2.1.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/41lpx5s2g6ynq135gpmfck7ai5y7r09v-r-igraph-2.1.4`
...
- [[s5dg938hsa4y24knilmwm9kwc9zs0w6x-igraph_2.1.4.tar.gz]]
