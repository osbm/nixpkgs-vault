...
- **Name**: `haskellPackages.algolia`
- **Version**: `0.1.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: A client implementing the Algolia search API
- **Homepage**: [https://hackage.haskell.org/package/algolia](https://hackage.haskell.org/package/algolia)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/h8zs19qb09ja2pwkcjfwp4miymf04nsq-algolia-0.1.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:58979`
- **Outputs**:
  - `doc`:  `/nix/store/h8zs19qb09ja2pwkcjfwp4miymf04nsq-algolia-0.1.0.0`
  - `out`:  `/nix/store/h8zs19qb09ja2pwkcjfwp4miymf04nsq-algolia-0.1.0.0`
...
- [[8nnia11cy0s1p1hcw89s00wp3iwlz6n5-algolia-0.1.0.0.tar.gz]]
...
- [[vidgj4vrbny27rq1mgpylkgjq5sl6gxx-aeson-iproute-0.3.0]]
