---
aliases:
  - haskellPackages.servant-polysemy
tags:
  - broken
  - not-available
  - license/unknown
...
- **Name**: `haskellPackages.servant-polysemy`
- **Version**: `0.1.4`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Utilities for using servant in a polysemy stack
- **Homepage**: [https://hackage.haskell.org/package/servant-polysemy](https://hackage.haskell.org/package/servant-polysemy)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/wkplr8zc397p36g1ckxy6gmpmzq2w2sv-servant-polysemy-0.1.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:600262`
- **Outputs**:
  - `doc`:  `/nix/store/wkplr8zc397p36g1ckxy6gmpmzq2w2sv-servant-polysemy-0.1.4`
  - `out`:  `/nix/store/wkplr8zc397p36g1ckxy6gmpmzq2w2sv-servant-polysemy-0.1.4`
...
- [[j2gr0h268ipj1lvzm5r01r8fpz20y1ix-servant-polysemy-0.1.4.tar.gz]]
