...
- **Name**: `haskellPackages.atndapi`
- **Version**: `0.1.1.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: An interface of ATND API
- **Homepage**: [https://hackage.haskell.org/package/atndapi](https://hackage.haskell.org/package/atndapi)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/5rw3vv168gwq9zvck9zfaania4zfyb73-atndapi-0.1.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:87051`
- **Outputs**:
  - `doc`:  `/nix/store/5rw3vv168gwq9zvck9zfaania4zfyb73-atndapi-0.1.1.0`
  - `out`:  `/nix/store/5rw3vv168gwq9zvck9zfaania4zfyb73-atndapi-0.1.1.0`
...
- [[klhf0wa4clnkz1kqwpn4045iv2ip6lmj-atndapi-0.1.1.0.tar.gz]]
