...
- **Name**: `python312Packages.itables`
- **Version**: `2.5.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Pandas and Polar DataFrames as interactive DataTables
- **Homepage**: [https://github.com/mwouts/itables](https://github.com/mwouts/itables)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/qn9p49bwmh11pj97wzifs159ny3fpzlv-python3.12-itables-2.5.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/itables/default.nix:73`
- **Outputs**:
  - `dist`:  `/nix/store/qn9p49bwmh11pj97wzifs159ny3fpzlv-python3.12-itables-2.5.2`
  - `out`:  `/nix/store/qn9p49bwmh11pj97wzifs159ny3fpzlv-python3.12-itables-2.5.2`
...
- [[wf5r2vfnaaghfz67kl6anmf0cjj23jm2-itables-2.5.2.tar.gz]]
