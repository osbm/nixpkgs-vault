...
- **Name**: `nodePackages_latest.coc-ltex`
- **Version**: `13.1.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/667vfisrmr8k0d3zr84jy0hxbpz5jqas-coc-ltex-13.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/node-packages/node-packages.nix:48613`
- **Outputs**:
  - `out`:  `/nix/store/667vfisrmr8k0d3zr84jy0hxbpz5jqas-coc-ltex-13.1.0`
