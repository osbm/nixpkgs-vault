...
- **Name**: `nodePackages_latest.localtunnel`
- **Version**: `2.0.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/dl46y7v8gmlm3jlxf9b07crhpib83h7m-localtunnel-2.0.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/node-packages/node-packages.nix:58521`
- **Outputs**:
  - `out`:  `/nix/store/dl46y7v8gmlm3jlxf9b07crhpib83h7m-localtunnel-2.0.2`
