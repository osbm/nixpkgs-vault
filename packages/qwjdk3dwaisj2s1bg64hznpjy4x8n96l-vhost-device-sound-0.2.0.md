...
virtio-sound device using the vhost-user protocol
...
- **Homepage**: [https://github.com/rust-vmm/vhost-device/tree/main/vhost-device-sound](https://github.com/rust-vmm/vhost-device/tree/main/vhost-device-sound)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/qwjdk3dwaisj2s1bg64hznpjy4x8n96l-vhost-device-sound-0.2.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/vh/vhost-device-sound/package.nix:40`
- **Outputs**:
  - `out`:  `/nix/store/qwjdk3dwaisj2s1bg64hznpjy4x8n96l-vhost-device-sound-0.2.0`
...
- [[abf087b2ymhhby27nd1h3bypsya9lni8-source]]
- [[aj35hmramjk714nr632xb68wadb8xlh1-rust-bindgen-hook]]
- [[bjsb6wdjykafnkixq156qdvmxhsm2bai-bash-5.3p3]]
- [[if30dvb18877vhsf1yhq7bzsgw20xlby-alsa-lib-1.2.14]]
- [[lvdvlk7cwad5mna0wfpz8jllb30jdj1n-pkg-config-wrapper-0.29.2]]
- [[n8h8xms8h4zlhcmajkljjas3jbrvpwf1-vhost-device-sound-0.2.0-vendor]]
