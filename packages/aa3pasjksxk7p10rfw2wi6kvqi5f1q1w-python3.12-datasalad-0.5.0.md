...
- **Name**: `python312Packages.datasalad`
- **Version**: `0.5.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Pure-Python library with a collection of utilities for working with Git and git-annex
- **Homepage**: [https://github.com/datalad/datasalad](https://github.com/datalad/datasalad)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/aa3pasjksxk7p10rfw2wi6kvqi5f1q1w-python3.12-datasalad-0.5.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/datasalad/default.nix:42`
- **Outputs**:
  - `dist`:  `/nix/store/aa3pasjksxk7p10rfw2wi6kvqi5f1q1w-python3.12-datasalad-0.5.0`
  - `out`:  `/nix/store/aa3pasjksxk7p10rfw2wi6kvqi5f1q1w-python3.12-datasalad-0.5.0`
...
- [[mc4w58bi7f3rkh5j19dgfyp9g9mdb1nm-source]]
