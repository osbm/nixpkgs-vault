...
Slick ORM cache with automatic granular event-driven invalidation for Django

## 📋 Package Information

- **Name**: `python312Packages.django-cacheops`
- **Version**: `7.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Slick ORM cache with automatic granular event-driven invalidation for Django
- **Homepage**: [https://github.com/Suor/django-cacheops](https://github.com/Suor/django-cacheops)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/j1bzh00dl6a3v22iijlzzjw8zzvjlalj-python3.12-django-cacheops-7.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/django-cacheops/default.nix:63`
- **Outputs**:
  - `dist`:  `/nix/store/j1bzh00dl6a3v22iijlzzjw8zzvjlalj-python3.12-django-cacheops-7.2`
  - `out`:  `/nix/store/j1bzh00dl6a3v22iijlzzjw8zzvjlalj-python3.12-django-cacheops-7.2`

## 🔗 Dependencies

- [[02k28vify8spr80fc4f0skgmqnkxvfv3-python3.12-funcy-2.0]]
- [[46grbcky6ylq2bnj0rl2488jva41bir2-django_cacheops-7.2.tar.gz]]
...
- [[v5zx7410j71zv60zs7nhlid8x2i43689-python3.12-before-after-1.0.1]]
