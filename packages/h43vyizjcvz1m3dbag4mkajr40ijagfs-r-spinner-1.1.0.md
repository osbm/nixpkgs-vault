...
- **Name**: `rPackages.spinner`
- **Version**: `1.1.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/spinner/](https://cran.r-project.org/web/packages/spinner/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/h43vyizjcvz1m3dbag4mkajr40ijagfs-r-spinner-1.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/h43vyizjcvz1m3dbag4mkajr40ijagfs-r-spinner-1.1.0`
...
- [[p75hrb1x8vinxc4gnn7bib9a3sqslgj1-spinner_1.1.0.tar.gz]]
