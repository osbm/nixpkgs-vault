---
aliases:
  - haskellPackages.biscuit-haskell
tags:
  - broken
  - not-available
  - license/unknown
...
- **Name**: `haskellPackages.biscuit-haskell`
- **Version**: `0.4.0.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Library support for the Biscuit security token
- **Homepage**: [https://hackage.haskell.org/package/biscuit-haskell](https://hackage.haskell.org/package/biscuit-haskell)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/bi47h3hg64ah836krwgpmmk6f39nc2h2-biscuit-haskell-0.4.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:106977`
- **Outputs**:
  - `doc`:  `/nix/store/bi47h3hg64ah836krwgpmmk6f39nc2h2-biscuit-haskell-0.4.0.0`
  - `out`:  `/nix/store/bi47h3hg64ah836krwgpmmk6f39nc2h2-biscuit-haskell-0.4.0.0`
...
- [[gk3b8d3lmvyp2f8mxipbirk81djhcg97-biscuit-haskell-0.4.0.0.tar.gz]]
