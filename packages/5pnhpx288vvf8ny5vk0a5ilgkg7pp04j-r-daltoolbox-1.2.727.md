...
- **Name**: `rPackages.daltoolbox`
- **Version**: `1.2.727`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/daltoolbox/](https://cran.r-project.org/web/packages/daltoolbox/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/5pnhpx288vvf8ny5vk0a5ilgkg7pp04j-r-daltoolbox-1.2.727.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/5pnhpx288vvf8ny5vk0a5ilgkg7pp04j-r-daltoolbox-1.2.727`
...
- [[6aphslf7d9f74r4f91gaddf5ynaghryp-daltoolbox_1.2.727.tar.gz]]
