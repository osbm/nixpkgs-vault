...
- **Name**: `rPackages.qtl2ggplot`
- **Version**: `1.2.6`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/qtl2ggplot/](https://cran.r-project.org/web/packages/qtl2ggplot/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/x4kq6pmigxyakcms3agw49851l7npx2v-r-qtl2ggplot-1.2.6.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/x4kq6pmigxyakcms3agw49851l7npx2v-r-qtl2ggplot-1.2.6`
...
- [[n2j5da7rb8z2d638hp3n38abwl3y6fjz-qtl2ggplot_1.2.6.tar.gz]]
