...
- **Name**: `python312Packages.aiosonic`
- **Version**: `0.24.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Very fast Python asyncio http client
- **Homepage**: [https://github.com/sonic182/aiosonic](https://github.com/sonic182/aiosonic)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/if8zdikqwjjbvrna21n6a787ld4zr6vj-python3.12-aiosonic-0.24.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/aiosonic/default.nix:117`
- **Outputs**:
  - `dist`:  `/nix/store/if8zdikqwjjbvrna21n6a787ld4zr6vj-python3.12-aiosonic-0.24.0`
  - `out`:  `/nix/store/if8zdikqwjjbvrna21n6a787ld4zr6vj-python3.12-aiosonic-0.24.0`
...
- [[pnykl1rqwccwqia03mm0nl5mk4i9cadc-python3.12-onecache-0.7.1]]
- [[rfl8ba3f31jddwbaqhgjs84snp985l6x-source]]
