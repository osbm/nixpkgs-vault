...
- **Name**: `rPackages.ggtaxplot`
- **Version**: `0.0.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/ggtaxplot/](https://cran.r-project.org/web/packages/ggtaxplot/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/lkdhpkscgkn72v8gxmxin85fygsq6r1h-r-ggtaxplot-0.0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/lkdhpkscgkn72v8gxmxin85fygsq6r1h-r-ggtaxplot-0.0.1`

## 🔗 Dependencies

- [[00p6f1rjc142wwx01j4na8rszgy9136c-ggtaxplot_0.0.1.tar.gz]]
