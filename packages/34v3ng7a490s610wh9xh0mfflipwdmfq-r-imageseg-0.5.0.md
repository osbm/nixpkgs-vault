...
- **Name**: `rPackages.imageseg`
- **Version**: `0.5.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/imageseg/](https://cran.r-project.org/web/packages/imageseg/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/34v3ng7a490s610wh9xh0mfflipwdmfq-r-imageseg-0.5.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/34v3ng7a490s610wh9xh0mfflipwdmfq-r-imageseg-0.5.0`
...
- [[vjxdm6dqfpfbv357absklfad6shpp9vx-imageseg_0.5.0.tar.gz]]
