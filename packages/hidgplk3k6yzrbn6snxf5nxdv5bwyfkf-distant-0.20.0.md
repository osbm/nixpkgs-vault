...
Library and tooling that supports remote filesystem and process operations
...
- **Homepage**: [https://github.com/chipsenkbeil/distant](https://github.com/chipsenkbeil/distant)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/hidgplk3k6yzrbn6snxf5nxdv5bwyfkf-distant-0.20.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/di/distant/package.nix:77`
- **Outputs**:
  - `out`:  `/nix/store/hidgplk3k6yzrbn6snxf5nxdv5bwyfkf-distant-0.20.0`
...
- [[4jrl0iw10cimy5lb6dk3m289jp7cdkjx-source]]
...
- [[w4vlg7bb9sixw9mjavdgmq3050fc2i3d-distant-0.20.0-vendor]]
