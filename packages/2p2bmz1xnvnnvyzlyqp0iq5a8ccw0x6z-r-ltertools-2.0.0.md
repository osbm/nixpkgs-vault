...
- **Name**: `rPackages.ltertools`
- **Version**: `2.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/ltertools/](https://cran.r-project.org/web/packages/ltertools/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/2p2bmz1xnvnnvyzlyqp0iq5a8ccw0x6z-r-ltertools-2.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/2p2bmz1xnvnnvyzlyqp0iq5a8ccw0x6z-r-ltertools-2.0.0`
...
- [[x9gfj0lc23n5zwmncck5sryw0zggh6fx-ltertools_2.0.0.tar.gz]]
- [[y3v1zfdzxpixpvf06dm4acfsskih87bs-r-supportR-1.5.0]]
