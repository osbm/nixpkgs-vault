...
- **Name**: `python312Packages.manifest-ml`
- **Version**: `0.1.9`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Manifest for Prompting Foundation Models
- **Homepage**: [https://github.com/HazyResearch/manifest](https://github.com/HazyResearch/manifest)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/33h9228ki4qdjyk3xa4a0fhizhiadzhd-python3.12-manifest-ml-0.1.9.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/manifest-ml/default.nix:118`
- **Outputs**:
  - `dist`:  `/nix/store/33h9228ki4qdjyk3xa4a0fhizhiadzhd-python3.12-manifest-ml-0.1.9`
  - `out`:  `/nix/store/33h9228ki4qdjyk3xa4a0fhizhiadzhd-python3.12-manifest-ml-0.1.9`
...
- [[7jsqxmrjz7n146d926mpf2r7y6hmd1k4-source]]
