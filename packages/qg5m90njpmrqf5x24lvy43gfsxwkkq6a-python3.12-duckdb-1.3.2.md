...
- **Derivation Path**: `/nix/store/qg5m90njpmrqf5x24lvy43gfsxwkkq6a-python3.12-duckdb-1.3.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/duckdb/default.nix:101`
- **Outputs**:
  - `dist`:  `/nix/store/qg5m90njpmrqf5x24lvy43gfsxwkkq6a-python3.12-duckdb-1.3.2`
  - `out`:  `/nix/store/qg5m90njpmrqf5x24lvy43gfsxwkkq6a-python3.12-duckdb-1.3.2`
...
- [[mjd08rfm2f8cglihdc1lr5rj3z33w8qa-source]]
...
- [[wfyscxbs8ykiz98bx0h4ya6h9sy3nlca-python3.12-pytest-reraise-2.1.2]]
