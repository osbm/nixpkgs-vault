...
- **Name**: `php81Extensions.posix`
- **Version**: `8.1.33`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: PHP upstream extension: posix
...
- **Derivation Path**: `/nix/store/235jb31rqhi6m8yn2msal1jhpnfyq7n9-php-posix-8.1.33.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/top-level/php-packages.nix:206`
- **Outputs**:
  - `dev`:  `/nix/store/235jb31rqhi6m8yn2msal1jhpnfyq7n9-php-posix-8.1.33`
  - `out`:  `/nix/store/235jb31rqhi6m8yn2msal1jhpnfyq7n9-php-posix-8.1.33`
