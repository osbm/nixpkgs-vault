...
- **Name**: `haskellPackages.simple-amount`
- **Version**: `0.2.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://hackage.haskell.org/package/simple-amount](https://hackage.haskell.org/package/simple-amount)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/hd7hwqc0qspvqw4dx2w6sqpm434gzj3y-simple-amount-0.2.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:610859`
- **Outputs**:
  - `doc`:  `/nix/store/hd7hwqc0qspvqw4dx2w6sqpm434gzj3y-simple-amount-0.2.0`
  - `out`:  `/nix/store/hd7hwqc0qspvqw4dx2w6sqpm434gzj3y-simple-amount-0.2.0`
...
- [[yzmfkp38n5hw0317yxf0y54rn838rvqs-simple-amount-0.2.0.tar.gz]]
