...
- **Name**: `python312Packages.brian2`
- **Version**: `2.9.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Clock-driven simulator for spiking neural networks
- **Homepage**: [https://briansimulator.org/](https://briansimulator.org/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/710xaf9f0hdqjja5di2byn06z5zkwvr1-python3.12-brian2-2.9.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/brian2/default.nix:72`
- **Outputs**:
  - `dist`:  `/nix/store/710xaf9f0hdqjja5di2byn06z5zkwvr1-python3.12-brian2-2.9.0`
  - `out`:  `/nix/store/710xaf9f0hdqjja5di2byn06z5zkwvr1-python3.12-brian2-2.9.0`

## 🔗 Dependencies

- [[1vl6s8xd7kh0n88lvlpfmb2id2zy9j66-brian2-2.9.0.tar.gz]]
...
- `/nix/store/01nrj8cn53nyxj58l0rqs2dglcl0kmrh-0001-remove-invalidxyz.patch`
