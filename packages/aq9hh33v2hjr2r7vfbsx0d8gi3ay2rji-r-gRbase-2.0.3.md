...
- **Name**: `rPackages.gRbase`
- **Version**: `2.0.3`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/gRbase/](https://cran.r-project.org/web/packages/gRbase/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/aq9hh33v2hjr2r7vfbsx0d8gi3ay2rji-r-gRbase-2.0.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/aq9hh33v2hjr2r7vfbsx0d8gi3ay2rji-r-gRbase-2.0.3`
...
- [[w6y05v8r640hnd7f44fd8i1jr1kx1zxd-gRbase_2.0.3.tar.gz]]
