...
- **Name**: `haskellPackages.influxdb`
- **Version**: `1.9.3.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: InfluxDB client library for Haskell
- **Homepage**: [https://hackage.haskell.org/package/influxdb](https://hackage.haskell.org/package/influxdb)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/kighrziam280k7ms3zisnrp047g356k9-influxdb-1.9.3.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:378823`
- **Outputs**:
  - `doc`:  `/nix/store/kighrziam280k7ms3zisnrp047g356k9-influxdb-1.9.3.2`
  - `out`:  `/nix/store/kighrziam280k7ms3zisnrp047g356k9-influxdb-1.9.3.2`
...
- [[i8g5z7s07qf1xn1gkfrg8m8da2n8xbyx-influxdb-1.9.3.2.tar.gz]]
