---
aliases:
  - androidenv.androidPkgs.all.system-images.v34.android-tv.arm64-v8a
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.system-images.v34.android-tv.arm64-v8a`
- **Version**: `34_r03.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/38siic1zdcb12js366b3rf5yhpz5cff9-arm64-v8a-34_r03.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/38siic1zdcb12js366b3rf5yhpz5cff9-arm64-v8a-34_r03.zip`
