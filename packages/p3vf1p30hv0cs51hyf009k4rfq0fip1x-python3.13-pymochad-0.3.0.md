...
- **Name**: `python313Packages.pymochad`
- **Version**: `0.3.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Python library for sending commands to the mochad TCP gateway daemon for the X10 CMA15A controller
- **Homepage**: [https://github.com/mtreinish/pymochad](https://github.com/mtreinish/pymochad)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/p3vf1p30hv0cs51hyf009k4rfq0fip1x-python3.13-pymochad-0.3.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/pymochad/default.nix:49`
- **Outputs**:
  - `dist`:  `/nix/store/p3vf1p30hv0cs51hyf009k4rfq0fip1x-python3.13-pymochad-0.3.0`
  - `out`:  `/nix/store/p3vf1p30hv0cs51hyf009k4rfq0fip1x-python3.13-pymochad-0.3.0`
...
- [[jmicgrnwrzj3bx4a9z59k4h72wama3j0-source]]
