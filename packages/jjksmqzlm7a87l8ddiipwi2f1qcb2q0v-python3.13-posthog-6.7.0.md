...
Module for interacting with PostHog

## 📋 Package Information

- **Name**: `python313Packages.posthog`
- **Version**: `6.7.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Module for interacting with PostHog
- **Homepage**: [https://github.com/PostHog/posthog-python](https://github.com/PostHog/posthog-python)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/jjksmqzlm7a87l8ddiipwi2f1qcb2q0v-python3.13-posthog-6.7.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/posthog/default.nix:74`
- **Outputs**:
  - `dist`:  `/nix/store/jjksmqzlm7a87l8ddiipwi2f1qcb2q0v-python3.13-posthog-6.7.0`
  - `out`:  `/nix/store/jjksmqzlm7a87l8ddiipwi2f1qcb2q0v-python3.13-posthog-6.7.0`
...
- [[vcq0d3vxi6p3d9f9rkw4zmappi7nk69v-source]]
