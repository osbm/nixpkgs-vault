...
- **Name**: `haskellPackages.hledger-iadd`
- **Version**: `1.3.21`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: A terminal UI as drop-in replacement for hledger add
- **Homepage**: [https://hackage.haskell.org/package/hledger-iadd](https://hackage.haskell.org/package/hledger-iadd)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/498ifi4v7dih95vhv1pcg3pkqjvn9abs-hledger-iadd-1.3.21.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:331863`
- **Outputs**:
  - `doc`:  `/nix/store/498ifi4v7dih95vhv1pcg3pkqjvn9abs-hledger-iadd-1.3.21`
  - `out`:  `/nix/store/498ifi4v7dih95vhv1pcg3pkqjvn9abs-hledger-iadd-1.3.21`
...
- [[d9bdxxdnc58hfblf77ay4dk0ipxkhfng-hledger-iadd-1.3.21.tar.gz]]
...
- [[i6w8ygajmz3yawzb750pabxfrfj0w7lj-hledger-iadd-1.3.21-r9.cabal]]
