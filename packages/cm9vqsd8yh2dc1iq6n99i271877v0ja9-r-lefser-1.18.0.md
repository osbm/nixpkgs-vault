...
- **Name**: `rPackages.lefser`
- **Version**: `1.18.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://bioconductor.org/packages/3.21/bioc/html/lefser.html](https://bioconductor.org/packages/3.21/bioc/html/lefser.html)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/cm9vqsd8yh2dc1iq6n99i271877v0ja9-r-lefser-1.18.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/cm9vqsd8yh2dc1iq6n99i271877v0ja9-r-lefser-1.18.0`
...
- [[kdsqcr5hm9rxpw8wrf51zvaix51bavdn-lefser_1.18.0.tar.gz]]
