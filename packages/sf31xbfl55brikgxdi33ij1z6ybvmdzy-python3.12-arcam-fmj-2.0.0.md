...
- **Name**: `python312Packages.arcam-fmj`
- **Version**: `2.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Python library for speaking to Arcam receivers
- **Homepage**: [https://github.com/elupus/arcam_fmj](https://github.com/elupus/arcam_fmj)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/sf31xbfl55brikgxdi33ij1z6ybvmdzy-python3.12-arcam-fmj-2.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/arcam-fmj/default.nix:67`
- **Outputs**:
  - `dist`:  `/nix/store/sf31xbfl55brikgxdi33ij1z6ybvmdzy-python3.12-arcam-fmj-2.0.0`
  - `out`:  `/nix/store/sf31xbfl55brikgxdi33ij1z6ybvmdzy-python3.12-arcam-fmj-2.0.0`
...
- [[mvq24v596rp6vh45wwqn3jxnrclrv7jr-source]]
