---
aliases:
  - home-assistant-component-tests.sql
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.sql`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/lgklg13i18dnx7vyzw6c1v3haqqw78rg-homeassistant-test-sql-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/lgklg13i18dnx7vyzw6c1v3haqqw78rg-homeassistant-test-sql-2025.9.4`
