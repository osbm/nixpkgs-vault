...
- **Name**: `haskellPackages.couch-simple`
- **Version**: `0.0.1.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: A modern, lightweight, complete client for CouchDB
- **Homepage**: [https://hackage.haskell.org/package/couch-simple](https://hackage.haskell.org/package/couch-simple)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/gx1vn2cg2l7lnmy9nx9vc0h999qv3h6j-couch-simple-0.0.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:164427`
- **Outputs**:
  - `doc`:  `/nix/store/gx1vn2cg2l7lnmy9nx9vc0h999qv3h6j-couch-simple-0.0.1.0`
  - `out`:  `/nix/store/gx1vn2cg2l7lnmy9nx9vc0h999qv3h6j-couch-simple-0.0.1.0`
...
- [[83a0vdrwfrzfq6wwx0y6akllw61fzy1x-couch-simple-0.0.1.0.tar.gz]]
