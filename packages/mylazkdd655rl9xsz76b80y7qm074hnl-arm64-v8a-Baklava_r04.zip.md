---
aliases:
  - androidenv.androidPkgs.all.system-images.Baklava.google_apis_playstore.arm64-v8a
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.system-images.Baklava.google_apis_playstore.arm64-v8a`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/mylazkdd655rl9xsz76b80y7qm074hnl-arm64-v8a-Baklava_r04.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/mylazkdd655rl9xsz76b80y7qm074hnl-arm64-v8a-Baklava_r04.zip`
