...
- **Name**: `haskellPackages.cereal-plus`
- **Version**: `0.4.2`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: An extended serialization library on top of "cereal"
- **Homepage**: [https://hackage.haskell.org/package/cereal-plus](https://hackage.haskell.org/package/cereal-plus)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/9d75clpmh76cv70fbsi33p78vd5l952c-cereal-plus-0.4.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:134451`
- **Outputs**:
  - `doc`:  `/nix/store/9d75clpmh76cv70fbsi33p78vd5l952c-cereal-plus-0.4.2`
  - `out`:  `/nix/store/9d75clpmh76cv70fbsi33p78vd5l952c-cereal-plus-0.4.2`

## 🔗 Dependencies

- [[12bb216jjgcxmspcb1sb6cswv59w2076-cereal-plus-0.4.2.tar.gz]]
