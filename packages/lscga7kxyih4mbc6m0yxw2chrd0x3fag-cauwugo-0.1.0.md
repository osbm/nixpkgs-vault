...
Alternative cargo frontend that implements dynamic shell completion for usual cargo commands
...
- **Homepage**: [https://github.com/pacak/bpaf/tree/master/bpaf_cauwugo](https://github.com/pacak/bpaf/tree/master/bpaf_cauwugo)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/lscga7kxyih4mbc6m0yxw2chrd0x3fag-cauwugo-0.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/ca/cauwugo/package.nix:31`
- **Outputs**:
  - `out`:  `/nix/store/lscga7kxyih4mbc6m0yxw2chrd0x3fag-cauwugo-0.1.0`
...
- [[cd92hh3av7vhwzl49qfk60iw3hqcsqlf-cauwugo-0.1.0-vendor]]
- [[d8c2vw6sma3fx67b8mln2zjjbbk52sr4-bpaf_cauwugo-0.1.0.tar.gz]]
