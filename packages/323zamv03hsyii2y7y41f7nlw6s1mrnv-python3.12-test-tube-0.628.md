...
- **Name**: `python312Packages.test-tube`
- **Version**: `0.628`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Framework-agnostic library to track and parallelize hyperparameter search in machine learning experiments
- **Homepage**: [https://github.com/williamFalcon/test-tube](https://github.com/williamFalcon/test-tube)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/323zamv03hsyii2y7y41f7nlw6s1mrnv-python3.12-test-tube-0.628.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/test-tube/default.nix:42`
- **Outputs**:
  - `dist`:  `/nix/store/323zamv03hsyii2y7y41f7nlw6s1mrnv-python3.12-test-tube-0.628`
  - `out`:  `/nix/store/323zamv03hsyii2y7y41f7nlw6s1mrnv-python3.12-test-tube-0.628`
...
- [[pf0k1xamnd6k5q69xgrpq47l1awpa9d2-source]]
