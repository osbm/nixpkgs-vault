...
- **Name**: `haskellPackages.pagerduty`
- **Version**: `0.0.8`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Client library for PagerDuty Integration and REST APIs
- **Homepage**: [https://hackage.haskell.org/package/pagerduty](https://hackage.haskell.org/package/pagerduty)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/xdhl44dqz2slah610yrkbya614b65nyc-pagerduty-0.0.8.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:499239`
- **Outputs**:
  - `doc`:  `/nix/store/xdhl44dqz2slah610yrkbya614b65nyc-pagerduty-0.0.8`
  - `out`:  `/nix/store/xdhl44dqz2slah610yrkbya614b65nyc-pagerduty-0.0.8`
...
- [[cg3jmmlbsispivzcq8q93lrl4s8pqqwd-pagerduty-0.0.8.tar.gz]]
