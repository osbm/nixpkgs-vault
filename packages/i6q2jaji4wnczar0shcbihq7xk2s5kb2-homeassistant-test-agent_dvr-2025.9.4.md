---
aliases:
  - home-assistant-component-tests.agent_dvr
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.agent_dvr`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/i6q2jaji4wnczar0shcbihq7xk2s5kb2-homeassistant-test-agent_dvr-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/i6q2jaji4wnczar0shcbihq7xk2s5kb2-homeassistant-test-agent_dvr-2025.9.4`
...
- [[mfb9yii5j5x6vqqyllyi0cdizcch3jy0-python3.13-agent-py-0.0.24]]
