...
- **Name**: `php81Extensions.simplexml`
- **Version**: `8.1.33`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: PHP upstream extension: simplexml
...
- **Derivation Path**: `/nix/store/hx6jdd9zhpzz52n3ynlid8200z6wxidw-php-simplexml-8.1.33.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/top-level/php-packages.nix:206`
- **Outputs**:
  - `dev`:  `/nix/store/hx6jdd9zhpzz52n3ynlid8200z6wxidw-php-simplexml-8.1.33`
  - `out`:  `/nix/store/hx6jdd9zhpzz52n3ynlid8200z6wxidw-php-simplexml-8.1.33`
