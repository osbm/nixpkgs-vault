...
- **Name**: `rPackages.gitgadget`
- **Version**: `0.8.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/gitgadget/](https://cran.r-project.org/web/packages/gitgadget/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/6n6arlip9z52bf087psp6cpa0arwlib7-r-gitgadget-0.8.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/6n6arlip9z52bf087psp6cpa0arwlib7-r-gitgadget-0.8.2`
...
- [[qjir9cirdzdxwwr6r9f07hsfvm6wsp5w-gitgadget_0.8.2.tar.gz]]
