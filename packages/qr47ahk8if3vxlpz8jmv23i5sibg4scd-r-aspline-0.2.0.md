...
- **Name**: `rPackages.aspline`
- **Version**: `0.2.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/aspline/](https://cran.r-project.org/web/packages/aspline/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/qr47ahk8if3vxlpz8jmv23i5sibg4scd-r-aspline-0.2.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/qr47ahk8if3vxlpz8jmv23i5sibg4scd-r-aspline-0.2.0`
...
- [[rpm0dzi23b5m4f0x5cqwyv1y05myiaar-aspline_0.2.0.tar.gz]]
