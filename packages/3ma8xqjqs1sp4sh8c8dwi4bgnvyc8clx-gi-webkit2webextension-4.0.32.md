...
WebKit2-WebExtension 4.x bindings

## 📋 Package Information

- **Name**: `haskellPackages.gi-webkit2webextension`
- **Version**: `4.0.32`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: WebKit2-WebExtension 4.x bindings
- **Homepage**: [https://hackage.haskell.org/package/gi-webkit2webextension](https://hackage.haskell.org/package/gi-webkit2webextension)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/3ma8xqjqs1sp4sh8c8dwi4bgnvyc8clx-gi-webkit2webextension-4.0.32.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:267435`
- **Outputs**:
  - `doc`:  `/nix/store/3ma8xqjqs1sp4sh8c8dwi4bgnvyc8clx-gi-webkit2webextension-4.0.32`
  - `out`:  `/nix/store/3ma8xqjqs1sp4sh8c8dwi4bgnvyc8clx-gi-webkit2webextension-4.0.32`
...
- [[jxnfdf51dglqhf3mrfqx8r0bv40zdbfg-gi-webkit2webextension-4.0.32.tar.gz]]
