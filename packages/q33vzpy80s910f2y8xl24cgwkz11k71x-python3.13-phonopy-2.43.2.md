...
- **Name**: `python313Packages.phonopy`
- **Version**: `2.43.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Modulefor phonon calculations at harmonic and quasi-harmonic levels
- **Homepage**: [https://phonopy.github.io/phonopy/](https://phonopy.github.io/phonopy/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/q33vzpy80s910f2y8xl24cgwkz11k71x-python3.13-phonopy-2.43.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/phonopy/default.nix:69`
- **Outputs**:
  - `dist`:  `/nix/store/q33vzpy80s910f2y8xl24cgwkz11k71x-python3.13-phonopy-2.43.2`
  - `out`:  `/nix/store/q33vzpy80s910f2y8xl24cgwkz11k71x-python3.13-phonopy-2.43.2`
...
- [[fjwn1gpi9dhdas50klcb0ma0da62d6ca-python3.13-symfc-1.5.4]]
...
- [[x00y8j8ha7vmq0z76xrksz2h4c6wv0hc-source]]
