...
- **Name**: `rPackages.torchvision`
- **Version**: `0.7.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/torchvision/](https://cran.r-project.org/web/packages/torchvision/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/7izxaispg53livzp64nq9x09xf1q5gwk-r-torchvision-0.7.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/7izxaispg53livzp64nq9x09xf1q5gwk-r-torchvision-0.7.0`
...
- [[hzbj6znvpnmfsc3ds20xcjzkpgbdrvyc-torchvision_0.7.0.tar.gz]]
