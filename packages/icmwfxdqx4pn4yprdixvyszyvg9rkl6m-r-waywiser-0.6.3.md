...
- **Name**: `rPackages.waywiser`
- **Version**: `0.6.3`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/waywiser/](https://cran.r-project.org/web/packages/waywiser/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/icmwfxdqx4pn4yprdixvyszyvg9rkl6m-r-waywiser-0.6.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/icmwfxdqx4pn4yprdixvyszyvg9rkl6m-r-waywiser-0.6.3`
...
- [[vszvabm3fnxll6a9j404pksmckkkc2q0-waywiser_0.6.3.tar.gz]]
