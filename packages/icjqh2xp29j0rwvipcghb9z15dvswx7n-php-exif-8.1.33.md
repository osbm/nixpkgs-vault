...
- **Name**: `php81Extensions.exif`
- **Version**: `8.1.33`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: PHP upstream extension: exif
...
- **Derivation Path**: `/nix/store/icjqh2xp29j0rwvipcghb9z15dvswx7n-php-exif-8.1.33.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/top-level/php-packages.nix:206`
- **Outputs**:
  - `dev`:  `/nix/store/icjqh2xp29j0rwvipcghb9z15dvswx7n-php-exif-8.1.33`
  - `out`:  `/nix/store/icjqh2xp29j0rwvipcghb9z15dvswx7n-php-exif-8.1.33`
