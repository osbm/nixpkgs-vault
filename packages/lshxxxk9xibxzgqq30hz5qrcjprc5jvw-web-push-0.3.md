...
- **Name**: `haskellPackages.web-push`
- **Version**: `0.3`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Send messages using Web Push protocol
- **Homepage**: [https://hackage.haskell.org/package/web-push](https://hackage.haskell.org/package/web-push)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/lshxxxk9xibxzgqq30hz5qrcjprc5jvw-web-push-0.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:717764`
- **Outputs**:
  - `doc`:  `/nix/store/lshxxxk9xibxzgqq30hz5qrcjprc5jvw-web-push-0.3`
  - `out`:  `/nix/store/lshxxxk9xibxzgqq30hz5qrcjprc5jvw-web-push-0.3`
...
- [[iqfzzf8102c8vfd6ki72q9bi9h8ymcn0-web-push-0.3.tar.gz]]
