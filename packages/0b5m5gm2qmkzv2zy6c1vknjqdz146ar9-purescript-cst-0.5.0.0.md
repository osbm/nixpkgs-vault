...
- **Name**: `haskellPackages.purescript-cst`
- **Version**: `0.5.0.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: PureScript Programming Language Concrete Syntax Tree
- **Homepage**: [https://hackage.haskell.org/package/purescript-cst](https://hackage.haskell.org/package/purescript-cst)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/0b5m5gm2qmkzv2zy6c1vknjqdz146ar9-purescript-cst-0.5.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:547752`
- **Outputs**:
  - `doc`:  `/nix/store/0b5m5gm2qmkzv2zy6c1vknjqdz146ar9-purescript-cst-0.5.0.0`
  - `out`:  `/nix/store/0b5m5gm2qmkzv2zy6c1vknjqdz146ar9-purescript-cst-0.5.0.0`
...
- [[s25akk60wv9g7sfv7ccvfq5m1r01jwi2-purescript-cst-0.5.0.0.tar.gz]]
