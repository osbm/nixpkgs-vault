...
- **Name**: `python312Packages.type-infer`
- **Version**: `0.0.23`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Automated type inference for Machine Learning pipelines
- **Homepage**: [https://github.com/mindsdb/type_infer](https://github.com/mindsdb/type_infer)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/8m3cx2cprgz95b3hi993n7ymidif20d3-python3.12-type-infer-0.0.23.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/type-infer/default.nix:82`
- **Outputs**:
  - `dist`:  `/nix/store/8m3cx2cprgz95b3hi993n7ymidif20d3-python3.12-type-infer-0.0.23`
  - `out`:  `/nix/store/8m3cx2cprgz95b3hi993n7ymidif20d3-python3.12-type-infer-0.0.23`
...
- [[6x9kgvc3g9iajr1asyp3c8p4rdahy8jc-source]]
...
- [[hv03fn695rpbsp2dlvj172xx75z2gand-python3.12-py3langid-0.3.0]]
...
- [[z662gvixr563myyrjk49bl6nd6hz7qh5-nltk-data-dir]]
