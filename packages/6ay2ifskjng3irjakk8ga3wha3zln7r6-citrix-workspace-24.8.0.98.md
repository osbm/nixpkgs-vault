...
- **Name**: `citrix_workspace_24_08_0`
- **Version**: `24.8.0.98`
- **Available**: ❌ No
- **Broken**: ✅ No
- **Description**: Citrix Workspace
- **Homepage**: [https://www.citrix.com/downloads/workspace-app/legacy-workspace-app-for-linux/workspace-app-for-linux-latest-2408.html](https://www.citrix.com/downloads/workspace-app/legacy-workspace-app-for-linux/workspace-app-for-linux-latest-2408.html)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/6ay2ifskjng3irjakk8ga3wha3zln7r6-citrix-workspace-24.8.0.98.drv`
...
- **Outputs**:
  - `out`:  `/nix/store/6ay2ifskjng3irjakk8ga3wha3zln7r6-citrix-workspace-24.8.0.98`
...
- [[gyqs83sr66kgghckczkpv1qsncxxha09-linuxx64-24.8.0.98.tar.gz]]
