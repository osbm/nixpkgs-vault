...
- **Name**: `rPackages.rattle`
- **Version**: `5.5.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/rattle/](https://cran.r-project.org/web/packages/rattle/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/i7azyklgnsmib0xqd03h09x4shp8mxj0-r-rattle-5.5.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/i7azyklgnsmib0xqd03h09x4shp8mxj0-r-rattle-5.5.1`
...
- [[r4fwk0gyva3nrfgsljgmq4vnsphdbf83-rattle_5.5.1.tar.gz]]
