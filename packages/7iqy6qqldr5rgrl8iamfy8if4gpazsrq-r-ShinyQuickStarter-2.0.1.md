...
- **Name**: `rPackages.ShinyQuickStarter`
- **Version**: `2.0.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/ShinyQuickStarter/](https://cran.r-project.org/web/packages/ShinyQuickStarter/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/7iqy6qqldr5rgrl8iamfy8if4gpazsrq-r-ShinyQuickStarter-2.0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/7iqy6qqldr5rgrl8iamfy8if4gpazsrq-r-ShinyQuickStarter-2.0.1`
...
- [[dd284xmh1xnzdnyi01vgpksxiw45pifa-ShinyQuickStarter_2.0.1.tar.gz]]
