...
- **Name**: `piping-server-rust`
- **Version**: `0.18.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Infinitely transfer between every device over pure HTTP with pipes or browsers
- **Homepage**: [https://github.com/nwtgck/piping-server-rust](https://github.com/nwtgck/piping-server-rust)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/49ila5zv8az7q370mljsf8pazlxwifcl-piping-server-rust-0.18.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/pi/piping-server-rust/package.nix:21`
- **Outputs**:
  - `out`:  `/nix/store/49ila5zv8az7q370mljsf8pazlxwifcl-piping-server-rust-0.18.0`
...
- [[kzn9r9x1048cmv6rmz2qzsy2yn79m42k-piping-server-rust-0.18.0-vendor]]
- [[p76r0cwlf6k97ibprrpfd8xw0r8wc3nx-stdenv-linux]]
- [[qi6337yh29r9ppqm262bf6vz0g13451b-cargo-build-hook.sh]]
- [[xqxbqs6qgnhvpkcai046s94jfrx8wb62-cargo-check-hook.sh]]
- [[zjd7gzw6wyvaar91s4y2xys6gxyvy2xs-source]]
