...
- **Homepage**: [https://github.com/Simple-Robotics/proxsuite](https://github.com/Simple-Robotics/proxsuite)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/n1iwnxr7w1c91rb332n7mimzjwlkdjm5-proxsuite-0.7.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/pr/proxsuite/package.nix:103`
- **Outputs**:
  - `doc`:  `/nix/store/n1iwnxr7w1c91rb332n7mimzjwlkdjm5-proxsuite-0.7.2`
  - `out`:  `/nix/store/n1iwnxr7w1c91rb332n7mimzjwlkdjm5-proxsuite-0.7.2`
...
- [[pkh010rsbhv68sfizkaxfaah2bxawpcs-source]]
