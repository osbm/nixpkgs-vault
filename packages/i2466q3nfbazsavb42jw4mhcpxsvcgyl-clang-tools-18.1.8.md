...
- **Name**: `llvmPackages_18.clang-tools`
- **Version**: `18.1.8`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/i2466q3nfbazsavb42jw4mhcpxsvcgyl-clang-tools-18.1.8.drv`
...
- **Outputs**:
  - `out`:  `/nix/store/i2466q3nfbazsavb42jw4mhcpxsvcgyl-clang-tools-18.1.8`
