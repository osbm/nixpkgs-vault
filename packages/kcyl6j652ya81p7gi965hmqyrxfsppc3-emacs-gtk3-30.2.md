...
- **Homepage**: [https://www.gnu.org/software/emacs/](https://www.gnu.org/software/emacs/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/kcyl6j652ya81p7gi965hmqyrxfsppc3-emacs-gtk3-30.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/applications/editors/emacs/sources.nix:51`
- **Outputs**:
  - `out`:  `/nix/store/kcyl6j652ya81p7gi965hmqyrxfsppc3-emacs-gtk3-30.2`
