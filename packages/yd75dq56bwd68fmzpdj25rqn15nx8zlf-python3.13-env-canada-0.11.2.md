...
- **Name**: `python313Packages.env-canada`
- **Version**: `0.11.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Python library to get Environment Canada weather data
- **Homepage**: [https://github.com/michaeldavie/env_canada](https://github.com/michaeldavie/env_canada)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/yd75dq56bwd68fmzpdj25rqn15nx8zlf-python3.13-env-canada-0.11.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/env-canada/default.nix:76`
- **Outputs**:
  - `dist`:  `/nix/store/yd75dq56bwd68fmzpdj25rqn15nx8zlf-python3.13-env-canada-0.11.2`
  - `out`:  `/nix/store/yd75dq56bwd68fmzpdj25rqn15nx8zlf-python3.13-env-canada-0.11.2`
...
- [[snkhv4ckanj7pbndmdnmi49kz3jlhf79-source]]
