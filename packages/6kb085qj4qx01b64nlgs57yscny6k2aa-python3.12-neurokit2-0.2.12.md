...
- **Name**: `python312Packages.neurokit2`
- **Version**: `0.2.12`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Python Toolbox for Neurophysiological Signal Processing
- **Homepage**: [https://github.com/neuropsychology/NeuroKit](https://github.com/neuropsychology/NeuroKit)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/6kb085qj4qx01b64nlgs57yscny6k2aa-python3.12-neurokit2-0.2.12.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/neurokit2/default.nix:109`
- **Outputs**:
  - `dist`:  `/nix/store/6kb085qj4qx01b64nlgs57yscny6k2aa-python3.12-neurokit2-0.2.12`
  - `out`:  `/nix/store/6kb085qj4qx01b64nlgs57yscny6k2aa-python3.12-neurokit2-0.2.12`
...
- [[fy5savpv5l7zfxicd7s4f6iv1xcx9y78-source]]
