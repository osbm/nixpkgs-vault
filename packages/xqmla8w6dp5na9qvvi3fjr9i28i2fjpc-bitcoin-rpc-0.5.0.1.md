...
Library to communicate with the Satoshi Bitcoin daemon

## 📋 Package Information

- **Name**: `haskellPackages.bitcoin-rpc`
- **Version**: `0.5.0.1`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Library to communicate with the Satoshi Bitcoin daemon
- **Homepage**: [https://hackage.haskell.org/package/bitcoin-rpc](https://hackage.haskell.org/package/bitcoin-rpc)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/xqmla8w6dp5na9qvvi3fjr9i28i2fjpc-bitcoin-rpc-0.5.0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:107951`
- **Outputs**:
  - `doc`:  `/nix/store/xqmla8w6dp5na9qvvi3fjr9i28i2fjpc-bitcoin-rpc-0.5.0.1`
  - `out`:  `/nix/store/xqmla8w6dp5na9qvvi3fjr9i28i2fjpc-bitcoin-rpc-0.5.0.1`
...
- [[8ygyjdsbr7wai2gwvp5lkxaywg2l7992-bitcoin-rpc-0.5.0.1.tar.gz]]
- [[b5kvbgardkngghjlc19a1601k53qqm3f-watchdog-0.3.2]]
