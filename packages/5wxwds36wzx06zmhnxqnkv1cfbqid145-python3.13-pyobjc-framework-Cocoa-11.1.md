---
aliases:
  - python313Packages.pyobjc-framework-Cocoa
tags:
  - not-available
  - license/unknown
  - maintainers/samuela
...
- **Name**: `python313Packages.pyobjc-framework-Cocoa`
- **Version**: `11.1`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/5wxwds36wzx06zmhnxqnkv1cfbqid145-python3.13-pyobjc-framework-Cocoa-11.1.drv`
...
- **Outputs**:
  - `dist`:  `/nix/store/5wxwds36wzx06zmhnxqnkv1cfbqid145-python3.13-pyobjc-framework-Cocoa-11.1`
  - `out`:  `/nix/store/5wxwds36wzx06zmhnxqnkv1cfbqid145-python3.13-pyobjc-framework-Cocoa-11.1`
...
- [[aawhb8bv7a16cn8kx7d39bxhhpmncgns-python3.13-pyobjc-core-11.1]]
