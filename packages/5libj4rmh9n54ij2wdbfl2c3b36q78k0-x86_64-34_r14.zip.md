---
aliases:
  - androidenv.androidPkgs.all.system-images.v34.google_apis_playstore.x86_64
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.system-images.v34.google_apis_playstore.x86_64`
- **Version**: `34_r14.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/5libj4rmh9n54ij2wdbfl2c3b36q78k0-x86_64-34_r14.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/5libj4rmh9n54ij2wdbfl2c3b36q78k0-x86_64-34_r14.zip`
