---
aliases:
  - home-assistant-component-tests.rest
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.rest`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/qzh9y9zl3i8px6syvf24cr4aryja7sz1-homeassistant-test-rest-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/qzh9y9zl3i8px6syvf24cr4aryja7sz1-homeassistant-test-rest-2025.9.4`
