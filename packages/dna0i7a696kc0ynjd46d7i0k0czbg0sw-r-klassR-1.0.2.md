...
- **Name**: `rPackages.klassR`
- **Version**: `1.0.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/klassR/](https://cran.r-project.org/web/packages/klassR/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/dna0i7a696kc0ynjd46d7i0k0czbg0sw-r-klassR-1.0.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/dna0i7a696kc0ynjd46d7i0k0czbg0sw-r-klassR-1.0.2`
...
- [[h9f76170la5p7zwfkqhc799cfq4hy68m-klassR_1.0.2.tar.gz]]
