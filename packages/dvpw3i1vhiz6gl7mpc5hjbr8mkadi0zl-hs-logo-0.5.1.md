...
- **Name**: `haskellPackages.hs-logo`
- **Version**: `0.5.1`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Logo interpreter written in Haskell
- **Homepage**: [https://hackage.haskell.org/package/hs-logo](https://hackage.haskell.org/package/hs-logo)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/dvpw3i1vhiz6gl7mpc5hjbr8mkadi0zl-hs-logo-0.5.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:346557`
- **Outputs**:
  - `data`:  `/nix/store/dvpw3i1vhiz6gl7mpc5hjbr8mkadi0zl-hs-logo-0.5.1`
  - `doc`:  `/nix/store/dvpw3i1vhiz6gl7mpc5hjbr8mkadi0zl-hs-logo-0.5.1`
  - `out`:  `/nix/store/dvpw3i1vhiz6gl7mpc5hjbr8mkadi0zl-hs-logo-0.5.1`
...
- [[yvjvr9lr1ig5wl8vcn7qlf410pbgmm64-hs-logo-0.5.1.tar.gz]]
