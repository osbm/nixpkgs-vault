...
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/isni/](https://cran.r-project.org/web/packages/isni/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/5ic0bdi86n5krycv0n6axicdr76472wx-r-isni-1.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/5ic0bdi86n5krycv0n6axicdr76472wx-r-isni-1.3`
...
- [[d8y4w78l2d3yy2ycsrpsib0n7smql13k-isni_1.3.tar.gz]]
