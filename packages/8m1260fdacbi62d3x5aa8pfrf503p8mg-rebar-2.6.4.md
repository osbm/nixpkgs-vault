...
- **Name**: `beamMinimal26Packages.rebar`
- **Version**: `2.6.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/8m1260fdacbi62d3x5aa8pfrf503p8mg-rebar-2.6.4.drv`
...
- **Outputs**:
  - `out`:  `/nix/store/8m1260fdacbi62d3x5aa8pfrf503p8mg-rebar-2.6.4`
