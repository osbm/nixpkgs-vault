---
aliases:
  - androidenv.androidPkgs.all.system-images.v27.google_apis_playstore.x86
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.system-images.v27.google_apis_playstore.x86`
- **Version**: `27_r03.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/9x7mkmnhmy6nva9wgznpdjs5ww2lh9x5-x86-27_r03.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/9x7mkmnhmy6nva9wgznpdjs5ww2lh9x5-x86-27_r03.zip`
