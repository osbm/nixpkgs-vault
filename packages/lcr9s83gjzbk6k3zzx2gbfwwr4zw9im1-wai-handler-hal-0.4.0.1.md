---
aliases:
  - haskellPackages.wai-handler-hal
tags:
  - license/unknown
  - outputs/doc
  - outputs/out
...
- **Name**: `haskellPackages.wai-handler-hal`
- **Version**: `0.4.0.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Wrap WAI applications to run on AWS Lambda
- **Homepage**: [https://hackage.haskell.org/package/wai-handler-hal](https://hackage.haskell.org/package/wai-handler-hal)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/lcr9s83gjzbk6k3zzx2gbfwwr4zw9im1-wai-handler-hal-0.4.0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:712207`
- **Outputs**:
  - `doc`:  `/nix/store/lcr9s83gjzbk6k3zzx2gbfwwr4zw9im1-wai-handler-hal-0.4.0.1`
  - `out`:  `/nix/store/lcr9s83gjzbk6k3zzx2gbfwwr4zw9im1-wai-handler-hal-0.4.0.1`
...
- [[8xmp3sngd84vk5i7h6889vaznkhky2bg-wai-handler-hal-0.4.0.1.tar.gz]]
- [[9yl3nrhx7f3i38cncjkgjzfv35k1gr26-hal-1.1]]
- [[bjsb6wdjykafnkixq156qdvmxhsm2bai-bash-5.3p3]]
- [[bl28f3glm9d5id38p78w6psq9n0qv7ca-case-insensitive-1.2.1.0]]
- [[cllbxyjrcsjsz2zpz5id109psl8nm1cn-wai-handler-hal-0.4.0.1-r1.cabal]]
