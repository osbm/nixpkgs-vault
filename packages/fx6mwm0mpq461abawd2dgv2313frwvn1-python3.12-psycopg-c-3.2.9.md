...
C optimisation distribution for Psycopg

## 📋 Package Information

- **Name**: `python312Packages.psycopg-c`
- **Version**: `3.2.9`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/fx6mwm0mpq461abawd2dgv2313frwvn1-python3.12-psycopg-c-3.2.9.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/psycopg/default.nix:91`
- **Outputs**:
  - `dist`:  `/nix/store/fx6mwm0mpq461abawd2dgv2313frwvn1-python3.12-psycopg-c-3.2.9`
  - `out`:  `/nix/store/fx6mwm0mpq461abawd2dgv2313frwvn1-python3.12-psycopg-c-3.2.9`
