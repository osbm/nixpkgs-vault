...
- **Name**: `apacheHttpdPackages.mod_spkac`
- **Version**: `0.2.3`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/mqdgdr1gnr10acy16mqnsdh878rj8ajk-mod_spkac-0.2.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/http/apache-modules/mod_spkac/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/mqdgdr1gnr10acy16mqnsdh878rj8ajk-mod_spkac-0.2.3`

## 🔗 Dependencies

- [[3hrsmp7md7zq3xlklkbj1lvqglj0spqs-mod_spkac-0.2.3.tar.gz]]
