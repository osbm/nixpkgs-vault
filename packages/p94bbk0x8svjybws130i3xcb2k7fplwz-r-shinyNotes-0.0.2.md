...
- **Name**: `rPackages.shinyNotes`
- **Version**: `0.0.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/shinyNotes/](https://cran.r-project.org/web/packages/shinyNotes/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/p94bbk0x8svjybws130i3xcb2k7fplwz-r-shinyNotes-0.0.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/p94bbk0x8svjybws130i3xcb2k7fplwz-r-shinyNotes-0.0.2`
...
- [[m8jh7y9bi8kfl33dss3fvg548c7y5fnf-shinyNotes_0.0.2.tar.gz]]
