---
aliases:
  - home-assistant-component-tests.kostal_plenticore
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.kostal_plenticore`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/y3ncma2b9rmald3v994fhjsqbcgii0v4-homeassistant-test-kostal_plenticore-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/y3ncma2b9rmald3v994fhjsqbcgii0v4-homeassistant-test-kostal_plenticore-2025.9.4`
...
- [[k9lymlv6mm8vdn9n74vm2l74s1p86ggm-python3.13-pykoplenti-1.4.0]]
