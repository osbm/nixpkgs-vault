...
- **Name**: `rPackages.corrr`
- **Version**: `0.4.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/corrr/](https://cran.r-project.org/web/packages/corrr/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/43h61id2h8vpw7vgg3mbgl1j43m5n6kn-r-corrr-0.4.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/43h61id2h8vpw7vgg3mbgl1j43m5n6kn-r-corrr-0.4.4`
...
- [[li2bv6xjci2a5im0ladgfydahnm3jdps-corrr_0.4.4.tar.gz]]
