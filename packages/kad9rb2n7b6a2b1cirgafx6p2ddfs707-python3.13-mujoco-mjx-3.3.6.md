...
- **Name**: `python313Packages.mujoco-mjx`
- **Version**: `3.3.6`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/kad9rb2n7b6a2b1cirgafx6p2ddfs707-python3.13-mujoco-mjx-3.3.6.drv`
...
- **Outputs**:
  - `dist`:  `/nix/store/kad9rb2n7b6a2b1cirgafx6p2ddfs707-python3.13-mujoco-mjx-3.3.6`
  - `out`:  `/nix/store/kad9rb2n7b6a2b1cirgafx6p2ddfs707-python3.13-mujoco-mjx-3.3.6`
...
- [[lsxvj3gsac6yxvka56lfy87immx13ca1-python3.13-mujoco-3.3.6]]
