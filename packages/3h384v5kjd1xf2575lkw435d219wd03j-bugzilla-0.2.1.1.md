...
- **Name**: `haskellPackages.bugzilla`
- **Version**: `0.2.1.1`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: A Haskell interface to the Bugzilla native REST API
- **Homepage**: [https://hackage.haskell.org/package/bugzilla](https://hackage.haskell.org/package/bugzilla)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/3h384v5kjd1xf2575lkw435d219wd03j-bugzilla-0.2.1.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:118516`
- **Outputs**:
  - `doc`:  `/nix/store/3h384v5kjd1xf2575lkw435d219wd03j-bugzilla-0.2.1.1`
  - `out`:  `/nix/store/3h384v5kjd1xf2575lkw435d219wd03j-bugzilla-0.2.1.1`
...
- [[xpw0vl270ifqshzxiz6i9dq7gq7qky95-bugzilla-0.2.1.1.tar.gz]]
