...
making data science easy and safe with data frames

## 📋 Package Information

- **Name**: `haskellPackages.analyze`
- **Version**: `0.1.0.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: making data science easy and safe with data frames
- **Homepage**: [https://hackage.haskell.org/package/analyze](https://hackage.haskell.org/package/analyze)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/p638wkj7nlwd0aiq48b4ii3p0lqjrzhb-analyze-0.1.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:75240`
- **Outputs**:
  - `data`:  `/nix/store/p638wkj7nlwd0aiq48b4ii3p0lqjrzhb-analyze-0.1.0.0`
  - `doc`:  `/nix/store/p638wkj7nlwd0aiq48b4ii3p0lqjrzhb-analyze-0.1.0.0`
  - `out`:  `/nix/store/p638wkj7nlwd0aiq48b4ii3p0lqjrzhb-analyze-0.1.0.0`
...
- [[lhh6z9fp9qksansgv0lz3lxh0is3ygjv-analyze-0.1.0.0.tar.gz]]
