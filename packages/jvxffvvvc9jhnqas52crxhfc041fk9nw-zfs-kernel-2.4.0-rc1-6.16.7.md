...
- **Name**: `linuxKernel.packages.linux_zen.zfs_unstable`
...
- **Derivation Path**: `/nix/store/jvxffvvvc9jhnqas52crxhfc041fk9nw-zfs-kernel-2.4.0-rc1-6.16.7.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/zfs/generic.nix:322`
- **Outputs**:
  - `out`:  `/nix/store/jvxffvvvc9jhnqas52crxhfc041fk9nw-zfs-kernel-2.4.0-rc1-6.16.7`
