---
aliases:
  - home-assistant-component-tests.triggercmd
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.triggercmd`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/863ngwziavadbbk4csxwxqwhg1afqdqj-homeassistant-test-triggercmd-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/863ngwziavadbbk4csxwxqwhg1afqdqj-homeassistant-test-triggercmd-2025.9.4`
...
- [[fx8yhwwwxmawybgbq172cg2r6wv90hql-python3.13-triggercmd-0.0.36]]
