...
- **Name**: `linuxKernel.packages.linux_lqx.vmm_clock`
- **Version**: `0.2.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/772scr8qlz7ad6wfcc7s4kj29mx044nq-vmm_clock-0.2.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/vmm_clock/default.nix:38`
- **Outputs**:
  - `out`:  `/nix/store/772scr8qlz7ad6wfcc7s4kj29mx044nq-vmm_clock-0.2.1`
