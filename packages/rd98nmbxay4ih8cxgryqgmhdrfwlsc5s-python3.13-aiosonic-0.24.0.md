...
- **Name**: `python313Packages.aiosonic`
- **Version**: `0.24.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/rd98nmbxay4ih8cxgryqgmhdrfwlsc5s-python3.13-aiosonic-0.24.0.drv`
...
- **Outputs**:
  - `dist`:  `/nix/store/rd98nmbxay4ih8cxgryqgmhdrfwlsc5s-python3.13-aiosonic-0.24.0`
  - `out`:  `/nix/store/rd98nmbxay4ih8cxgryqgmhdrfwlsc5s-python3.13-aiosonic-0.24.0`
...
- [[f4ls3y9vsf8b12y7dmh68mmfwnw3a57s-python3.13-onecache-0.7.1]]
