...
- **Name**: `haskellPackages.Wheb`
- **Version**: `0.3.1.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: The frictionless WAI Framework
- **Homepage**: [https://hackage.haskell.org/package/Wheb](https://hackage.haskell.org/package/Wheb)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/61jf90a6478n2jylcab7pdqnxqa7jsh0-Wheb-0.3.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:46529`
- **Outputs**:
  - `doc`:  `/nix/store/61jf90a6478n2jylcab7pdqnxqa7jsh0-Wheb-0.3.1.0`
  - `out`:  `/nix/store/61jf90a6478n2jylcab7pdqnxqa7jsh0-Wheb-0.3.1.0`
...
- [[gbrkzjc9vjj3nffzf6z9fbz3b4ng88k8-Wheb-0.3.1.0.tar.gz]]
