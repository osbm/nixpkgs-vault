...
- **Name**: `python313Packages.pymoo`
- **Version**: `0.6.1.5`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Multi-objective Optimization in Python
- **Homepage**: [https://pymoo.org/](https://pymoo.org/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/kqx0ail56v453bvv9pjyg9qy1agp6hy1-python3.13-pymoo-0.6.1.5.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/pymoo/default.nix:126`
- **Outputs**:
  - `dist`:  `/nix/store/kqx0ail56v453bvv9pjyg9qy1agp6hy1-python3.13-pymoo-0.6.1.5`
  - `out`:  `/nix/store/kqx0ail56v453bvv9pjyg9qy1agp6hy1-python3.13-pymoo-0.6.1.5`
...
- [[702458a26fahl9vdx4438rn65jhw1pcp-python3.13-cma-4.3.0]]
...
- [[fcl07z7qxnkiz878z9f5xfnpmz0zva84-source]]
- [[fmgak3lvqw3ff8wym1v40kgi0b5i1iza-python-runtime-deps-check-hook.sh]]
- [[g3p39s2vdzz3kypkn4h1aj3zwpkrmwbs-source]]
...
- [[px2dp9dbp4022pzcbqcm8scla7daymbn-unknown]]
