...
- **Name**: `rPackages.lineartestr`
- **Version**: `1.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/lineartestr/](https://cran.r-project.org/web/packages/lineartestr/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/9j608izd6fq1qdvafylykbag13igb2vm-r-lineartestr-1.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/9j608izd6fq1qdvafylykbag13igb2vm-r-lineartestr-1.0.0`
...
- [[mmmy6ksdfp2j4dxjn2n83l3b42alxpj2-lineartestr_1.0.0.tar.gz]]
