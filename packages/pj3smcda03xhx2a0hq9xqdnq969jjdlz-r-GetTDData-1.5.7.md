...
- **Name**: `rPackages.GetTDData`
- **Version**: `1.5.7`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/GetTDData/](https://cran.r-project.org/web/packages/GetTDData/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/pj3smcda03xhx2a0hq9xqdnq969jjdlz-r-GetTDData-1.5.7.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/pj3smcda03xhx2a0hq9xqdnq969jjdlz-r-GetTDData-1.5.7`
...
- [[w08hxv4f30wachzbki4gibj6wnglhdq9-GetTDData_1.5.7.tar.gz]]
