...
- **Name**: `haskellPackages.katip-datadog`
- **Version**: `0.2.0.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Datadog scribe for the Katip logging framework
- **Homepage**: [https://hackage.haskell.org/package/katip-datadog](https://hackage.haskell.org/package/katip-datadog)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/qiapvgqih6fcv7szk8ffrg86qwn5b280-katip-datadog-0.2.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:397369`
- **Outputs**:
  - `doc`:  `/nix/store/qiapvgqih6fcv7szk8ffrg86qwn5b280-katip-datadog-0.2.0.0`
  - `out`:  `/nix/store/qiapvgqih6fcv7szk8ffrg86qwn5b280-katip-datadog-0.2.0.0`

## 🔗 Dependencies

- [[16p59lnqzm13yhhjiwrc17nhz7ns6ily-katip-datadog-0.2.0.0.tar.gz]]
