...
- **Name**: `python313Packages.sqlbag`
- **Version**: `0.1.1617247075`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Handy python code for doing database things
- **Homepage**: [https://github.com/djrobstep/sqlbag](https://github.com/djrobstep/sqlbag)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/lrxsmvmmrc2ivgfz9chpnk7ycj9v6frx-python3.13-sqlbag-0.1.1617247075.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/sqlbag/default.nix:86`
- **Outputs**:
  - `dist`:  `/nix/store/lrxsmvmmrc2ivgfz9chpnk7ycj9v6frx-python3.13-sqlbag-0.1.1617247075`
  - `out`:  `/nix/store/lrxsmvmmrc2ivgfz9chpnk7ycj9v6frx-python3.13-sqlbag-0.1.1617247075`
...
- [[fngpyy2pgaxi07l8sjdljl8lgkh0makp-source]]
