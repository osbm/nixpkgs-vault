---
aliases:
  - haskellPackages.couchdb-conduit
tags:
  - broken
  - not-available
  - license/unknown
...
- **Name**: `haskellPackages.couchdb-conduit`
- **Version**: `0.10.6`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Couch DB client library using http-conduit and aeson
- **Homepage**: [https://hackage.haskell.org/package/couchdb-conduit](https://hackage.haskell.org/package/couchdb-conduit)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/4rq8z86p9khdr3wzkdp2fzyc0vib5lmg-couchdb-conduit-0.10.6.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:164504`
- **Outputs**:
  - `doc`:  `/nix/store/4rq8z86p9khdr3wzkdp2fzyc0vib5lmg-couchdb-conduit-0.10.6`
  - `out`:  `/nix/store/4rq8z86p9khdr3wzkdp2fzyc0vib5lmg-couchdb-conduit-0.10.6`
...
- [[p9sbqblvysf65fhibkw3nr3ixhm9hbgs-couchdb-conduit-0.10.6.tar.gz]]
