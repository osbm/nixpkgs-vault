...
- **Name**: `rPackages.readwritesqlite`
- **Version**: `0.2.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://cran.r-project.org/web/packages/readwritesqlite/](https://cran.r-project.org/web/packages/readwritesqlite/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/3h20b4735m6hdddg67zd300141fnqi9c-r-readwritesqlite-0.2.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/3h20b4735m6hdddg67zd300141fnqi9c-r-readwritesqlite-0.2.0`
...
- [[wjmv18fa2zrb5aysnh6zpbvmprawsjgf-readwritesqlite_0.2.0.tar.gz]]
