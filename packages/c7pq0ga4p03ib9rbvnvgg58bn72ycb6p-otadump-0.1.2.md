...
Command-line tool to extract partitions from Android OTA files
...
- **Homepage**: [https://github.com/crazystylus/otadump](https://github.com/crazystylus/otadump)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/c7pq0ga4p03ib9rbvnvgg58bn72ycb6p-otadump-0.1.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/ot/otadump/package.nix:35`
- **Outputs**:
  - `out`:  `/nix/store/c7pq0ga4p03ib9rbvnvgg58bn72ycb6p-otadump-0.1.2`
...
- [[b0fvldnvq2mlplpbcjrhgdi6m3gi6mqv-otadump-0.1.2-vendor]]
- [[bjsb6wdjykafnkixq156qdvmxhsm2bai-bash-5.3p3]]
- [[hkhcf66kgkvk2y27y305ifxblzcyshin-source]]
...
- `/nix/store/b4bqx8kjry8axqfhw00m6v0fxdrmmaj6-no-static.patch`
