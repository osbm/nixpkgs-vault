...
- **Name**: `pantheon.elementary-calendar`
- **Version**: `8.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Desktop calendar app designed for elementary OS
- **Homepage**: [https://github.com/elementary/calendar](https://github.com/elementary/calendar)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/7zjhqzxvggim53lqlghkm22ax0zpml61-elementary-calendar-8.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/desktops/pantheon/apps/elementary-calendar/default.nix:64`
- **Outputs**:
  - `out`:  `/nix/store/7zjhqzxvggim53lqlghkm22ax0zpml61-elementary-calendar-8.0.0`
...
- [[lndb4y83pr3al989q06q93crxnczn8ix-source]]
