...
- **Name**: `haskellPackages.asana`
- **Version**: `1.0.1.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Asana API Client
- **Homepage**: [https://hackage.haskell.org/package/asana](https://hackage.haskell.org/package/asana)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/392wb7kndpz5g9r2gblg4l0cx9z9vry5-asana-1.0.1.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:84067`
- **Outputs**:
  - `doc`:  `/nix/store/392wb7kndpz5g9r2gblg4l0cx9z9vry5-asana-1.0.1.1`
  - `out`:  `/nix/store/392wb7kndpz5g9r2gblg4l0cx9z9vry5-asana-1.0.1.1`
...
- [[hmlqndcqj8f2zqb2w14dvscpbirj6rww-asana-1.0.1.1.tar.gz]]
