...
Unified approach to explain the output of any machine learning model

## 📋 Package Information

- **Name**: `python312Packages.shap`
- **Version**: `0.48.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Unified approach to explain the output of any machine learning model
- **Homepage**: [https://github.com/slundberg/shap](https://github.com/slundberg/shap)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/wh7i9hir8blv7w13h3i82cpkyhf39bn1-python3.12-shap-0.48.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/shap/default.nix:151`
- **Outputs**:
  - `dist`:  `/nix/store/wh7i9hir8blv7w13h3i82cpkyhf39bn1-python3.12-shap-0.48.0`
  - `out`:  `/nix/store/wh7i9hir8blv7w13h3i82cpkyhf39bn1-python3.12-shap-0.48.0`
...
- [[kk2ijj9nvf741i1b47jbvhd75kxlc4df-source]]
