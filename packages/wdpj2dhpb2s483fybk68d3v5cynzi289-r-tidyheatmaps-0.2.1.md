...
- **Name**: `rPackages.tidyheatmaps`
- **Version**: `0.2.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/tidyheatmaps/](https://cran.r-project.org/web/packages/tidyheatmaps/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/wdpj2dhpb2s483fybk68d3v5cynzi289-r-tidyheatmaps-0.2.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/wdpj2dhpb2s483fybk68d3v5cynzi289-r-tidyheatmaps-0.2.1`
...
- [[iakmssqjzpv173r728mrr8dwmggk9g3i-tidyheatmaps_0.2.1.tar.gz]]
