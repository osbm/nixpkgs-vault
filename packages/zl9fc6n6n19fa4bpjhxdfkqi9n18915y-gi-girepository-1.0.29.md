...
- **Name**: `haskellPackages.gi-girepository`
- **Version**: `1.0.29`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: GIRepository (gobject-introspection) bindings
- **Homepage**: [https://hackage.haskell.org/package/gi-girepository](https://hackage.haskell.org/package/gi-girepository)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/zl9fc6n6n19fa4bpjhxdfkqi9n18915y-gi-girepository-1.0.29.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:264847`
- **Outputs**:
  - `doc`:  `/nix/store/zl9fc6n6n19fa4bpjhxdfkqi9n18915y-gi-girepository-1.0.29`
  - `out`:  `/nix/store/zl9fc6n6n19fa4bpjhxdfkqi9n18915y-gi-girepository-1.0.29`
...
- [[gcpzyjnymc376insjxlacdiaisylnvlv-gi-girepository-1.0.29.tar.gz]]
