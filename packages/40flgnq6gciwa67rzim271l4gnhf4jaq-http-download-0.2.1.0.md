...
- **Name**: `haskellPackages.http-download`
- **Version**: `0.2.1.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Verified downloads with retries
- **Homepage**: [https://hackage.haskell.org/package/http-download](https://hackage.haskell.org/package/http-download)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/40flgnq6gciwa67rzim271l4gnhf4jaq-http-download-0.2.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:361462`
- **Outputs**:
  - `doc`:  `/nix/store/40flgnq6gciwa67rzim271l4gnhf4jaq-http-download-0.2.1.0`
  - `out`:  `/nix/store/40flgnq6gciwa67rzim271l4gnhf4jaq-http-download-0.2.1.0`
...
- [[6vipp4c1sms3wyy3f4zbhi2dn0a2s97n-http-download-0.2.1.0.tar.gz]]
...
- [[ycdjd02cv1rr43bdb080nb59yzlv8n9d-crypton-conduit-0.2.3]]
