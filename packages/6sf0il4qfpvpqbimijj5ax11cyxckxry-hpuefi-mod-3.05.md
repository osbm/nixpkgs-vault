---
aliases:
  - linuxKernel.packages.linux_xanmod.hpuefi-mod
tags:
  - license/unknown
...
- **Name**: `linuxKernel.packages.linux_xanmod.hpuefi-mod`
- **Version**: `3.05`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/6sf0il4qfpvpqbimijj5ax11cyxckxry-hpuefi-mod-3.05.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/hpuefi-mod/default.nix:39`
- **Outputs**:
  - `out`:  `/nix/store/6sf0il4qfpvpqbimijj5ax11cyxckxry-hpuefi-mod-3.05`
