---
aliases:
  - androidenv.androidPkgs.all.system-images.v35x.google_apis.arm64-v8a
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.system-images.v35x.google_apis.arm64-v8a`
...
- **Derivation Path**: `/nix/store/yp9djqmv8npifbdajmyxkvvx0nhgx770-arm64-v8a-35-ext15_r01.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/yp9djqmv8npifbdajmyxkvvx0nhgx770-arm64-v8a-35-ext15_r01.zip`
