...
- **Name**: `haskellPackages.colonnade`
- **Version**: `1.2.0.2`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Generic types and functions for columnar encoding and decoding
- **Homepage**: [https://hackage.haskell.org/package/colonnade](https://hackage.haskell.org/package/colonnade)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/zzyl0asvxijd0y0app2dxyv2x465hajz-colonnade-1.2.0.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:149977`
- **Outputs**:
  - `doc`:  `/nix/store/zzyl0asvxijd0y0app2dxyv2x465hajz-colonnade-1.2.0.2`
  - `out`:  `/nix/store/zzyl0asvxijd0y0app2dxyv2x465hajz-colonnade-1.2.0.2`

## 🔗 Dependencies

- [[0lcfn823gsfdmfrvhmbhq5v0s2vblz8q-colonnade-1.2.0.2.tar.gz]]
...
- [[l1k08xk62b6bmq81d3vlrj1psg57k1mc-colonnade-1.2.0.2-r7.cabal]]
