---
aliases:
  - androidenv.androidPkgs.all.system-images.v36.page_size_16kb.arm64-v8a
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.system-images.v36.page_size_16kb.arm64-v8a`
- **Version**: `36_r06.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/iv79z55vahghcdinflpkk3sz3n2klngm-arm64-v8a-playstore-ps16k-36_r06.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/iv79z55vahghcdinflpkk3sz3n2klngm-arm64-v8a-playstore-ps16k-36_r06.zip`
