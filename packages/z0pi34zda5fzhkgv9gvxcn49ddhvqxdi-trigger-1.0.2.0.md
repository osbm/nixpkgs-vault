...
- **Name**: `haskellPackages.trigger`
- **Version**: `1.0.2.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Trigger is a cross platform file system watcher for super fast build-and-restart workflows
- **Homepage**: [https://hackage.haskell.org/package/trigger](https://hackage.haskell.org/package/trigger)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/z0pi34zda5fzhkgv9gvxcn49ddhvqxdi-trigger-1.0.2.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:685126`
- **Outputs**:
  - `doc`:  `/nix/store/z0pi34zda5fzhkgv9gvxcn49ddhvqxdi-trigger-1.0.2.0`
  - `out`:  `/nix/store/z0pi34zda5fzhkgv9gvxcn49ddhvqxdi-trigger-1.0.2.0`

## 🔗 Dependencies

- [[2p5f4ivzq4f1n670xq7xw6vsm2v0pvig-Glob-0.10.2]]
- [[39i9v4c5vwhz21n660zrq5fdrc62ny7w-trigger-1.0.2.0.tar.gz]]
