---
aliases:
  - home-assistant-component-tests.kodi
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.kodi`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/k4naawsvsz09rm7gbri4fsi7di3a6s0b-homeassistant-test-kodi-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/k4naawsvsz09rm7gbri4fsi7di3a6s0b-homeassistant-test-kodi-2025.9.4`
...
- [[n88r8ilnj9nn0n79xnhz2mbbippai6aa-python3.13-pykodi-0.2.7]]
