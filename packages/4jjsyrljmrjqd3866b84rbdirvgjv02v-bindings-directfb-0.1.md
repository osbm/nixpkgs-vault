...
- **Name**: `haskellPackages.bindings-directfb`
- **Version**: `0.1`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Low level bindings to DirectFB
- **Homepage**: [https://hackage.haskell.org/package/bindings-directfb](https://hackage.haskell.org/package/bindings-directfb)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/4jjsyrljmrjqd3866b84rbdirvgjv02v-bindings-directfb-0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:104829`
- **Outputs**:
  - `doc`:  `/nix/store/4jjsyrljmrjqd3866b84rbdirvgjv02v-bindings-directfb-0.1`
  - `out`:  `/nix/store/4jjsyrljmrjqd3866b84rbdirvgjv02v-bindings-directfb-0.1`
...
- [[978yajyx31fklab5y9w84b54cg0q1sh8-directfb-1.7.7]]
...
- [[pzrkhwzzkc5ascm2llalbphnl2lvmqkv-bindings-directfb-0.1.tar.gz]]
