...
- **Name**: `haskellPackages.hcltest`
- **Version**: `0.3.7`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: A testing library for command line applications
- **Homepage**: [https://hackage.haskell.org/package/hcltest](https://hackage.haskell.org/package/hcltest)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/wb1p24jcc6hiqm2misfarvlrp3wl606w-hcltest-0.3.7.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:315961`
- **Outputs**:
  - `doc`:  `/nix/store/wb1p24jcc6hiqm2misfarvlrp3wl606w-hcltest-0.3.7`
  - `out`:  `/nix/store/wb1p24jcc6hiqm2misfarvlrp3wl606w-hcltest-0.3.7`
...
- [[ikbmndkd0c5aj0jkrk0pcdy5bs45zf89-hcltest-0.3.7.tar.gz]]
