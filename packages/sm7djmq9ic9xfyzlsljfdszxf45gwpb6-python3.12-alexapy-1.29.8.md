...
- **Name**: `python312Packages.alexapy`
- **Version**: `1.29.8`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Python Package for controlling Alexa devices (echo dot, etc) programmatically
- **Homepage**: [https://gitlab.com/keatontaylor/alexapy](https://gitlab.com/keatontaylor/alexapy)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/sm7djmq9ic9xfyzlsljfdszxf45gwpb6-python3.12-alexapy-1.29.8.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/alexapy/default.nix:60`
- **Outputs**:
  - `dist`:  `/nix/store/sm7djmq9ic9xfyzlsljfdszxf45gwpb6-python3.12-alexapy-1.29.8`
  - `out`:  `/nix/store/sm7djmq9ic9xfyzlsljfdszxf45gwpb6-python3.12-alexapy-1.29.8`
...
- [[zc7pyz5a6115z566sqzyzn6dwr7r7jdn-source]]
