---
aliases:
  - haskellPackages.servant-hmac-auth
tags:
  - license/unknown
  - outputs/doc
  - outputs/out
...
- **Name**: `haskellPackages.servant-hmac-auth`
- **Version**: `0.1.8`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Servant authentication with HMAC
- **Homepage**: [https://hackage.haskell.org/package/servant-hmac-auth](https://hackage.haskell.org/package/servant-hmac-auth)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/65ym9ksx8bxzy8kxc5cqwz9gm403xxgs-servant-hmac-auth-0.1.8.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:598805`
- **Outputs**:
  - `doc`:  `/nix/store/65ym9ksx8bxzy8kxc5cqwz9gm403xxgs-servant-hmac-auth-0.1.8`
  - `out`:  `/nix/store/65ym9ksx8bxzy8kxc5cqwz9gm403xxgs-servant-hmac-auth-0.1.8`
...
- [[md39jm8s9iagwzc9gsww5f8p4xmq4f3x-servant-hmac-auth-0.1.8.tar.gz]]
