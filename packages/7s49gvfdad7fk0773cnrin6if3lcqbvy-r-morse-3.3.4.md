...
- **Name**: `rPackages.morse`
- **Version**: `3.3.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/morse/](https://cran.r-project.org/web/packages/morse/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/7s49gvfdad7fk0773cnrin6if3lcqbvy-r-morse-3.3.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/7s49gvfdad7fk0773cnrin6if3lcqbvy-r-morse-3.3.4`

## 🔗 Dependencies

- [[0vpikcy1a4q1rzjbj1hv8mha64rg5hzk-r-reshape2-1.4.4]]
- [[13z1z9n4ag8bmz240kjwd2rkb22ag4cc-morse_3.3.4.tar.gz]]
