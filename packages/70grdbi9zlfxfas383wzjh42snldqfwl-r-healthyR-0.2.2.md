...
- **Name**: `rPackages.healthyR`
- **Version**: `0.2.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/healthyR/](https://cran.r-project.org/web/packages/healthyR/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/70grdbi9zlfxfas383wzjh42snldqfwl-r-healthyR-0.2.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/70grdbi9zlfxfas383wzjh42snldqfwl-r-healthyR-0.2.2`

## 🔗 Dependencies

- [[1n9gvcx8g0knp8mx63sl3h92lg2acf1m-healthyR_0.2.2.tar.gz]]
