---
aliases:
  - haskellPackages.jsons-to-schema
tags:
  - license/unknown
  - outputs/doc
  - outputs/out
...
- **Name**: `haskellPackages.jsons-to-schema`
- **Version**: `0.1.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: JSON to JSON Schema
- **Homepage**: [https://hackage.haskell.org/package/jsons-to-schema](https://hackage.haskell.org/package/jsons-to-schema)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/8vm8ppiishy3a8lr03yjbwnza7gwh2yb-jsons-to-schema-0.1.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:394914`
- **Outputs**:
  - `doc`:  `/nix/store/8vm8ppiishy3a8lr03yjbwnza7gwh2yb-jsons-to-schema-0.1.0.0`
  - `out`:  `/nix/store/8vm8ppiishy3a8lr03yjbwnza7gwh2yb-jsons-to-schema-0.1.0.0`
...
- [[ygcl5kmrxa6r1xdr80m00la3hnzgandl-jsons-to-schema-0.1.0.0.tar.gz]]
