---
aliases:
  - home-assistant-component-tests.uk_transport
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.uk_transport`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/127awlkjlyncjkj8a2pxrnxi2d597cp5-homeassistant-test-uk_transport-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/127awlkjlyncjkj8a2pxrnxi2d597cp5-homeassistant-test-uk_transport-2025.9.4`
