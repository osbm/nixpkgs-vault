---
aliases:
  - home-assistant-component-tests.nordpool
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.nordpool`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/0iy6sds000xqwiaxjqp57ddjic0105sy-homeassistant-test-nordpool-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/0iy6sds000xqwiaxjqp57ddjic0105sy-homeassistant-test-nordpool-2025.9.4`
...
- [[glv32dnpbw9mfmml821935sm0bmsp0p3-python3.13-pynordpool-0.3.0]]
