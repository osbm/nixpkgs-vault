...
- **Name**: `electron_38-bin`
- **Version**: `38.1.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Cross platform desktop application shell
- **Homepage**: [https://github.com/electron/electron](https://github.com/electron/electron)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/9zrwbkj048wblvvp3qnj81387b7acj4y-electron-38.1.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/tools/electron/binary/generic.nix:43`
- **Outputs**:
  - `out`:  `/nix/store/9zrwbkj048wblvvp3qnj81387b7acj4y-electron-38.1.2`
...
- [[fdrhbl993a9f1lgpyznzx8fn4rb6408w-electron-v38.1.2-linux-x64.zip]]
