...
- **Name**: `linuxKernel.packages.linux_lqx.shufflecake`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/29c7yv985f56lcxy8zwyhhi6qim17286-shufflecake.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/shufflecake/default.nix:44`
- **Outputs**:
  - `bin`:  `/nix/store/29c7yv985f56lcxy8zwyhhi6qim17286-shufflecake`
  - `out`:  `/nix/store/29c7yv985f56lcxy8zwyhhi6qim17286-shufflecake`
