...
- **Name**: `haskellPackages.git-vogue`
- **Version**: `0.3.0.2`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: A framework for pre-commit checks
- **Homepage**: [https://hackage.haskell.org/package/git-vogue](https://hackage.haskell.org/package/git-vogue)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/ghfbjhgwnpm05w4pmzj08s0p0ahv8130-git-vogue-0.3.0.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:269559`
- **Outputs**:
  - `data`:  `/nix/store/ghfbjhgwnpm05w4pmzj08s0p0ahv8130-git-vogue-0.3.0.2`
  - `doc`:  `/nix/store/ghfbjhgwnpm05w4pmzj08s0p0ahv8130-git-vogue-0.3.0.2`
  - `out`:  `/nix/store/ghfbjhgwnpm05w4pmzj08s0p0ahv8130-git-vogue-0.3.0.2`

## 🔗 Dependencies

- [[16s38bv5bwp5kkwcq521hjksd5vsdixw-split-0.2.5]]
- [[4lykrm96bxajhbrv42nzm365n9yf9s1y-coreutils-9.7]]
- [[4r693xfdf8q0m0vx0a2jfxsszqaiw7z0-git-vogue-0.3.0.2.tar.gz]]
