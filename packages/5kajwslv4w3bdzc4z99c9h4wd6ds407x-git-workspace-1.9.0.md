...
- **Homepage**: [https://github.com/orf/git-workspace](https://github.com/orf/git-workspace)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/5kajwslv4w3bdzc4z99c9h4wd6ds407x-git-workspace-1.9.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/gi/git-workspace/package.nix:38`
- **Outputs**:
  - `out`:  `/nix/store/5kajwslv4w3bdzc4z99c9h4wd6ds407x-git-workspace-1.9.0`
...
- [[b6r6ix9gqdrcnwss705zk50qxc44ijyb-source]]
- [[bjsb6wdjykafnkixq156qdvmxhsm2bai-bash-5.3p3]]
- [[f8c3zraryrm1cy1lwf2fgbpyfc2h0qlk-git-workspace-1.9.0-vendor]]
