...
- **Name**: `rPackages.autocart`
- **Version**: `1.4.5`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://cran.r-project.org/web/packages/autocart/](https://cran.r-project.org/web/packages/autocart/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/m69wk40bm2bi0gq5193xq95lnhcvz67f-r-autocart-1.4.5.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/m69wk40bm2bi0gq5193xq95lnhcvz67f-r-autocart-1.4.5`
...
- [[z2pby395ngkfcvr9s2v8n11dd06swr0p-autocart_1.4.5.tar.gz]]
