...
- **Name**: `haskellPackages.yackage`
- **Version**: `0.8.1`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Personal Hackage replacement for testing new packages
- **Homepage**: [https://hackage.haskell.org/package/yackage](https://hackage.haskell.org/package/yackage)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/i6cnxz2a0az4v0pnpwbyi2r4pmpkvsj8-yackage-0.8.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:734686`
- **Outputs**:
  - `doc`:  `/nix/store/i6cnxz2a0az4v0pnpwbyi2r4pmpkvsj8-yackage-0.8.1`
  - `out`:  `/nix/store/i6cnxz2a0az4v0pnpwbyi2r4pmpkvsj8-yackage-0.8.1`
...
- [[z83v9wyskm0fz18j7snr7hqzgrqwk787-yackage-0.8.1.tar.gz]]
