...
- **Name**: `rPackages.fishualize`
- **Version**: `0.2.3`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/fishualize/](https://cran.r-project.org/web/packages/fishualize/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/09pr1a3bj8bl2xd91n74lrhvxappycd9-r-fishualize-0.2.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/09pr1a3bj8bl2xd91n74lrhvxappycd9-r-fishualize-0.2.3`
...
- [[8y1rn0a80ry7qkv4m0qadjhpvxddd00q-fishualize_0.2.3.tar.gz]]
