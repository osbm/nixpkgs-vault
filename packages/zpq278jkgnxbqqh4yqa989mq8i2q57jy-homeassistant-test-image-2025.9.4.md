---
aliases:
  - home-assistant-component-tests.image
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.image`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/zpq278jkgnxbqqh4yqa989mq8i2q57jy-homeassistant-test-image-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/zpq278jkgnxbqqh4yqa989mq8i2q57jy-homeassistant-test-image-2025.9.4`
