---
aliases:
  - haskellPackages.katip-elasticsearch
tags:
  - broken
  - not-available
  - license/unknown
...
- **Name**: `haskellPackages.katip-elasticsearch`
- **Version**: `0.7.0.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: ElasticSearch scribe for the Katip logging framework
- **Homepage**: [https://hackage.haskell.org/package/katip-elasticsearch](https://hackage.haskell.org/package/katip-elasticsearch)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/lchamfppvfgkg3m4096pw67f3aaxk4h2-katip-elasticsearch-0.7.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:397502`
- **Outputs**:
  - `doc`:  `/nix/store/lchamfppvfgkg3m4096pw67f3aaxk4h2-katip-elasticsearch-0.7.0.0`
  - `out`:  `/nix/store/lchamfppvfgkg3m4096pw67f3aaxk4h2-katip-elasticsearch-0.7.0.0`
...
- [[jaxvczbqfs2k6wgdgnfk3i9l74br8ilf-katip-elasticsearch-0.7.0.0.tar.gz]]
