...
- **Name**: `rPackages.gmoTree`
- **Version**: `1.4.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/gmoTree/](https://cran.r-project.org/web/packages/gmoTree/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/qk4hkypm0hrl8r9l1z9p90kqrslxxcla-r-gmoTree-1.4.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/qk4hkypm0hrl8r9l1z9p90kqrslxxcla-r-gmoTree-1.4.1`
...
- [[fzwpqmp947amk7ap459rdvxi0r3f346y-gmoTree_1.4.1.tar.gz]]
