...
- **Name**: `rPackages.SDPDmod`
- **Version**: `0.0.6`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/SDPDmod/](https://cran.r-project.org/web/packages/SDPDmod/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/576dk8151hakxf9czq1vycxgf6jgrc75-r-SDPDmod-0.0.6.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/576dk8151hakxf9czq1vycxgf6jgrc75-r-SDPDmod-0.0.6`

## 🔗 Dependencies

- [[30vgylabxas403ilgy88mkjnmdz621ly-SDPDmod_0.0.6.tar.gz]]
