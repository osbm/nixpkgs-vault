...
- **Name**: `python312Packages.opensearch-py`
- **Version**: `3.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Python low-level client for OpenSearch
- **Homepage**: [https://github.com/opensearch-project/opensearch-py](https://github.com/opensearch-project/opensearch-py)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/qch8d06psa6kg3i7rqrcanavilyddhg4-python3.12-opensearch-py-3.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/opensearch-py/default.nix:100`
- **Outputs**:
  - `dist`:  `/nix/store/qch8d06psa6kg3i7rqrcanavilyddhg4-python3.12-opensearch-py-3.0.0`
  - `out`:  `/nix/store/qch8d06psa6kg3i7rqrcanavilyddhg4-python3.12-opensearch-py-3.0.0`

## 🔗 Dependencies

- [[113b6hxwnpbyv852cf0zwd6a6z2w8m68-python3.12-aiohttp-3.12.15]]
- [[24m01i3yp14yr6qrrjfaj4sp8dz05f9g-source]]
...
- `/nix/store/shvflmrsmv4wr0bs1zasnk8iqj349gwy-remove-delete-event-loop-fixture.patch`
