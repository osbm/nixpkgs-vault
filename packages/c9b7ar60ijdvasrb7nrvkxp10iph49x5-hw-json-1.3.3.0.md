...
- **Name**: `haskellPackages.hw-json`
- **Version**: `1.3.3.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Memory efficient JSON parser
- **Homepage**: [https://hackage.haskell.org/package/hw-json](https://hackage.haskell.org/package/hw-json)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/c9b7ar60ijdvasrb7nrvkxp10iph49x5-hw-json-1.3.3.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:366683`
- **Outputs**:
  - `out`:  `/nix/store/c9b7ar60ijdvasrb7nrvkxp10iph49x5-hw-json-1.3.3.0`
...
- [[m5rdp9zp6qbs8lyi0262pwa8xg82nrsj-hw-json-1.3.3.0.tar.gz]]
