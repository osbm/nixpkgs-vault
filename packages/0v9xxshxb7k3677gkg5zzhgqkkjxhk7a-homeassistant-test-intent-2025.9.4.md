---
aliases:
  - home-assistant-component-tests.intent
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.intent`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/0v9xxshxb7k3677gkg5zzhgqkkjxhk7a-homeassistant-test-intent-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/0v9xxshxb7k3677gkg5zzhgqkkjxhk7a-homeassistant-test-intent-2025.9.4`
