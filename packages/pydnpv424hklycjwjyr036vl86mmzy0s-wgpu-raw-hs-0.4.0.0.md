...
- **Name**: `haskellPackages.wgpu-raw-hs`
- **Version**: `0.4.0.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: WGPU Raw
- **Homepage**: [https://hackage.haskell.org/package/wgpu-raw-hs](https://hackage.haskell.org/package/wgpu-raw-hs)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/pydnpv424hklycjwjyr036vl86mmzy0s-wgpu-raw-hs-0.4.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:722098`
- **Outputs**:
  - `doc`:  `/nix/store/pydnpv424hklycjwjyr036vl86mmzy0s-wgpu-raw-hs-0.4.0.0`
  - `out`:  `/nix/store/pydnpv424hklycjwjyr036vl86mmzy0s-wgpu-raw-hs-0.4.0.0`
...
- [[sw9wvxxlrr87v21zfgkqd4xl6r8i9hmh-wgpu-raw-hs-0.4.0.0.tar.gz]]
