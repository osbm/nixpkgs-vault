...
- **Name**: `haskellPackages.apiary`
- **Version**: `2.1.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Simple and type safe web framework that generate web API documentation
- **Homepage**: [https://hackage.haskell.org/package/apiary](https://hackage.haskell.org/package/apiary)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/pvc97xgpjy9psqxgcy6y3y4hgimd99k4-apiary-2.1.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:79063`
- **Outputs**:
  - `doc`:  `/nix/store/pvc97xgpjy9psqxgcy6y3y4hgimd99k4-apiary-2.1.2`
  - `out`:  `/nix/store/pvc97xgpjy9psqxgcy6y3y4hgimd99k4-apiary-2.1.2`
...
- [[ajiffw1m4rx5hq7sbl19sf3rb6zrfgyq-apiary-2.1.2.tar.gz]]
