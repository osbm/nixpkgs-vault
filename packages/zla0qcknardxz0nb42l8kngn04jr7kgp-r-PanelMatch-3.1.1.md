...
- **Name**: `rPackages.PanelMatch`
- **Version**: `3.1.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/PanelMatch/](https://cran.r-project.org/web/packages/PanelMatch/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/zla0qcknardxz0nb42l8kngn04jr7kgp-r-PanelMatch-3.1.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/zla0qcknardxz0nb42l8kngn04jr7kgp-r-PanelMatch-3.1.1`

## 🔗 Dependencies

- [[2mnzw873ryp3i1s1b1qs39hn58zkdws2-PanelMatch_3.1.1.tar.gz]]
