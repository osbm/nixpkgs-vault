---
aliases:
  - haskellPackages.thentos-cookie-session
tags:
  - broken
  - not-available
  - license/unknown
...
- **Name**: `haskellPackages.thentos-cookie-session`
- **Version**: `0.9.1`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: All-in-one session handling for servant-based frontends
- **Homepage**: [https://hackage.haskell.org/package/thentos-cookie-session](https://hackage.haskell.org/package/thentos-cookie-session)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/h626ibakaca7rwrhx50bzs8ph3cxz6my-thentos-cookie-session-0.9.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:671192`
- **Outputs**:
  - `doc`:  `/nix/store/h626ibakaca7rwrhx50bzs8ph3cxz6my-thentos-cookie-session-0.9.1`
  - `out`:  `/nix/store/h626ibakaca7rwrhx50bzs8ph3cxz6my-thentos-cookie-session-0.9.1`
...
- [[mcjr27sf543cngyv4qvf6c79qvmmxy0q-wai-session-0.3.3]]
- [[nfk76zlb29f2v013bbj4iasv3yzv4j6s-thentos-cookie-session-0.9.1.tar.gz]]
...
- [[wvq4swmdgxlvzznh3z5bzyfka78b97b3-sandi-0.5]]
...
---
*Generated on 2025-09-27 12:24:08 UTC*
