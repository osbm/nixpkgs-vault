...
- **Name**: `linuxKernel.packages.linux_5_4.nvidia_x11`
- **Version**: `580.82.09-5.4.299`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/dcsh4s29mylpljj9vmg8h9wfrpviclbr-nvidia-x11-580.82.09-5.4.299.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/nvidia-x11/generic.nix:329`
- **Outputs**:
  - `bin`:  `/nix/store/dcsh4s29mylpljj9vmg8h9wfrpviclbr-nvidia-x11-580.82.09-5.4.299`
  - `firmware`:  `/nix/store/dcsh4s29mylpljj9vmg8h9wfrpviclbr-nvidia-x11-580.82.09-5.4.299`
  - `lib32`:  `/nix/store/dcsh4s29mylpljj9vmg8h9wfrpviclbr-nvidia-x11-580.82.09-5.4.299`
  - `out`:  `/nix/store/dcsh4s29mylpljj9vmg8h9wfrpviclbr-nvidia-x11-580.82.09-5.4.299`
