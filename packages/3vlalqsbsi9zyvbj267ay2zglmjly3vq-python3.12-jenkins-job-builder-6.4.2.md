...
- **Name**: `python312Packages.jenkins-job-builder`
- **Version**: `6.4.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Jenkins Job Builder is a system for configuring Jenkins jobs using simple YAML files stored in Git
- **Homepage**: [https://jenkins-job-builder.readthedocs.io/en/latest/](https://jenkins-job-builder.readthedocs.io/en/latest/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/3vlalqsbsi9zyvbj267ay2zglmjly3vq-python3.12-jenkins-job-builder-6.4.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/jenkins-job-builder/default.nix:54`
- **Outputs**:
  - `dist`:  `/nix/store/3vlalqsbsi9zyvbj267ay2zglmjly3vq-python3.12-jenkins-job-builder-6.4.2`
  - `out`:  `/nix/store/3vlalqsbsi9zyvbj267ay2zglmjly3vq-python3.12-jenkins-job-builder-6.4.2`

## 🔗 Dependencies

- [[4yy5nihibrbba7l9v54wliy6i1j0xjny-python3.12-testtools-2.7.2]]
- [[56xkzqnaq4pmrva96qg4l67ydnmj9dg6-jenkins-job-builder-6.4.2.tar.gz]]
...
- [[k1zcf2jam8b359a450z925ipmyhwlxc4-python3.12-python-jenkins-1.8.3]]
