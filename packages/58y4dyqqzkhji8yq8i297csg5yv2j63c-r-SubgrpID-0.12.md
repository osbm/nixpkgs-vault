...
- **Name**: `rPackages.SubgrpID`
- **Version**: `0.12`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/SubgrpID/](https://cran.r-project.org/web/packages/SubgrpID/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/58y4dyqqzkhji8yq8i297csg5yv2j63c-r-SubgrpID-0.12.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/58y4dyqqzkhji8yq8i297csg5yv2j63c-r-SubgrpID-0.12`

## 🔗 Dependencies

- [[28nya33qf6mx6lr5wc8x1r6a4dmh23cs-SubgrpID_0.12.tar.gz]]
