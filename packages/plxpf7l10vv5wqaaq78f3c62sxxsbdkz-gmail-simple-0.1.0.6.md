...
- **Name**: `haskellPackages.gmail-simple`
- **Version**: `0.1.0.6`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Simple library for Google Mail (GMail)
- **Homepage**: [https://hackage.haskell.org/package/gmail-simple](https://hackage.haskell.org/package/gmail-simple)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/plxpf7l10vv5wqaaq78f3c62sxxsbdkz-gmail-simple-0.1.0.6.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:274352`
- **Outputs**:
  - `doc`:  `/nix/store/plxpf7l10vv5wqaaq78f3c62sxxsbdkz-gmail-simple-0.1.0.6`
  - `out`:  `/nix/store/plxpf7l10vv5wqaaq78f3c62sxxsbdkz-gmail-simple-0.1.0.6`
...
- [[zgql0w1x3yrk94x2m9d4i1vchkz9qkhv-gmail-simple-0.1.0.6.tar.gz]]
