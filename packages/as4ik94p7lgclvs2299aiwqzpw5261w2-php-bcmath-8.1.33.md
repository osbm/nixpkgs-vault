...
- **Name**: `php81Extensions.bcmath`
- **Version**: `8.1.33`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: PHP upstream extension: bcmath
...
- **Derivation Path**: `/nix/store/as4ik94p7lgclvs2299aiwqzpw5261w2-php-bcmath-8.1.33.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/top-level/php-packages.nix:206`
- **Outputs**:
  - `dev`:  `/nix/store/as4ik94p7lgclvs2299aiwqzpw5261w2-php-bcmath-8.1.33`
  - `out`:  `/nix/store/as4ik94p7lgclvs2299aiwqzpw5261w2-php-bcmath-8.1.33`
