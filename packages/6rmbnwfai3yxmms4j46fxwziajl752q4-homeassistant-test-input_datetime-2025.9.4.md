---
aliases:
  - home-assistant-component-tests.input_datetime
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.input_datetime`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/6rmbnwfai3yxmms4j46fxwziajl752q4-homeassistant-test-input_datetime-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/6rmbnwfai3yxmms4j46fxwziajl752q4-homeassistant-test-input_datetime-2025.9.4`
