---
aliases:
  - home-assistant-component-tests.configurator
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.configurator`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/0nisdfd22728l2z9mx4rkhmzv0d3y02f-homeassistant-test-configurator-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/0nisdfd22728l2z9mx4rkhmzv0d3y02f-homeassistant-test-configurator-2025.9.4`
