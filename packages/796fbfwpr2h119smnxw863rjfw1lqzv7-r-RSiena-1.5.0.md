...
- **Name**: `rPackages.RSiena`
- **Version**: `1.5.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/RSiena/](https://cran.r-project.org/web/packages/RSiena/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/796fbfwpr2h119smnxw863rjfw1lqzv7-r-RSiena-1.5.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/796fbfwpr2h119smnxw863rjfw1lqzv7-r-RSiena-1.5.0`

## 🔗 Dependencies

- [[894137gfyaqx4sqnf6v7rq0dhgf458dn-RSiena_1.5.0.tar.gz]]
