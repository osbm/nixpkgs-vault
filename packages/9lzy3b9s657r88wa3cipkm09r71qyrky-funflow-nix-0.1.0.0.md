...
- **Name**: `haskellPackages.funflow-nix`
- **Version**: `0.1.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Utility functions for using funflow with nix
- **Homepage**: [https://hackage.haskell.org/package/funflow-nix](https://hackage.haskell.org/package/funflow-nix)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/9lzy3b9s657r88wa3cipkm09r71qyrky-funflow-nix-0.1.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:248148`
- **Outputs**:
  - `doc`:  `/nix/store/9lzy3b9s657r88wa3cipkm09r71qyrky-funflow-nix-0.1.0.0`
  - `out`:  `/nix/store/9lzy3b9s657r88wa3cipkm09r71qyrky-funflow-nix-0.1.0.0`
...
- [[yqwj7wcmbcnczrl08vhq7jxw3l623hgq-funflow-nix-0.1.0.0.tar.gz]]
