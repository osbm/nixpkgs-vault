---
aliases:
  - home-assistant-component-tests.kitchen_sink
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.kitchen_sink`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/070yns6bypcn9a5xcbhs8ri6m1602gsl-homeassistant-test-kitchen_sink-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/070yns6bypcn9a5xcbhs8ri6m1602gsl-homeassistant-test-kitchen_sink-2025.9.4`
