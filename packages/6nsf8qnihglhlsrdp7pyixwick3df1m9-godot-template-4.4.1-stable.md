---
aliases:
  - godotPackages_4_4.export-template
tags:
  - license/unknown
  - maintainers/shiryel
...
- **Name**: `godotPackages_4_4.export-template`
...
- **Derivation Path**: `/nix/store/6nsf8qnihglhlsrdp7pyixwick3df1m9-godot-template-4.4.1-stable.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/tools/godot/common.nix:564`
- **Outputs**:
  - `debug`:  `/nix/store/6nsf8qnihglhlsrdp7pyixwick3df1m9-godot-template-4.4.1-stable`
  - `out`:  `/nix/store/6nsf8qnihglhlsrdp7pyixwick3df1m9-godot-template-4.4.1-stable`
...
- [[g3kffn4rsncw12vm7yc02dh5c1w1bblq-source]]
