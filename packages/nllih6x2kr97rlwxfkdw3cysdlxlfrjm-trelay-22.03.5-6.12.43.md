---
aliases:
  - linuxKernel.packages.linux_hardened.trelay
tags:
  - license/unknown
...
- **Name**: `linuxKernel.packages.linux_hardened.trelay`
- **Version**: `22.03.5-6.12.43`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/nllih6x2kr97rlwxfkdw3cysdlxlfrjm-trelay-22.03.5-6.12.43.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/trelay/default.nix:41`
- **Outputs**:
  - `out`:  `/nix/store/nllih6x2kr97rlwxfkdw3cysdlxlfrjm-trelay-22.03.5-6.12.43`
