...
- **Name**: `haskellPackages.mtgoxapi`
- **Version**: `0.5.0.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Library to communicate with Mt.Gox
- **Homepage**: [https://hackage.haskell.org/package/mtgoxapi](https://hackage.haskell.org/package/mtgoxapi)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/77261iim48xhbsygrdrhwk3sl0bspknw-mtgoxapi-0.5.0.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:463228`
- **Outputs**:
  - `doc`:  `/nix/store/77261iim48xhbsygrdrhwk3sl0bspknw-mtgoxapi-0.5.0.2`
  - `out`:  `/nix/store/77261iim48xhbsygrdrhwk3sl0bspknw-mtgoxapi-0.5.0.2`
...
- [[ia44ylibpjngyb2zqm98gbj35c9kqsvd-mtgoxapi-0.5.0.2.tar.gz]]
