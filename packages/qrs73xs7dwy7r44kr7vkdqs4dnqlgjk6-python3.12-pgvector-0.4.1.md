...
- **Name**: `python312Packages.pgvector`
- **Version**: `0.4.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Pgvector support for Python
- **Homepage**: [https://github.com/pgvector/pgvector-python](https://github.com/pgvector/pgvector-python)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/qrs73xs7dwy7r44kr7vkdqs4dnqlgjk6-python3.12-pgvector-0.4.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/pgvector/default.nix:81`
- **Outputs**:
  - `dist`:  `/nix/store/qrs73xs7dwy7r44kr7vkdqs4dnqlgjk6-python3.12-pgvector-0.4.1`
  - `out`:  `/nix/store/qrs73xs7dwy7r44kr7vkdqs4dnqlgjk6-python3.12-pgvector-0.4.1`
...
- [[vy79yhpccg6746l818vsmpd2yvnrraww-source]]
