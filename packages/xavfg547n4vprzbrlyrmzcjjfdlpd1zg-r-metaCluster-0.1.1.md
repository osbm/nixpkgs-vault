...
- **Name**: `rPackages.metaCluster`
- **Version**: `0.1.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/metaCluster/](https://cran.r-project.org/web/packages/metaCluster/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/xavfg547n4vprzbrlyrmzcjjfdlpd1zg-r-metaCluster-0.1.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/xavfg547n4vprzbrlyrmzcjjfdlpd1zg-r-metaCluster-0.1.1`
...
- [[w18gpw5qqczmlgpklf4vr090csh9x0z0-metaCluster_0.1.1.tar.gz]]
