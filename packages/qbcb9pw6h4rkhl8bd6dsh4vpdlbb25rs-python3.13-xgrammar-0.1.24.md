...
- **Name**: `python313Packages.xgrammar`
- **Version**: `0.1.24`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/qbcb9pw6h4rkhl8bd6dsh4vpdlbb25rs-python3.13-xgrammar-0.1.24.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/xgrammar/default.nix:98`
- **Outputs**:
  - `dist`:  `/nix/store/qbcb9pw6h4rkhl8bd6dsh4vpdlbb25rs-python3.13-xgrammar-0.1.24`
  - `out`:  `/nix/store/qbcb9pw6h4rkhl8bd6dsh4vpdlbb25rs-python3.13-xgrammar-0.1.24`
...
- [[4czbwalwy1qqwzhfdq2ah8grijpsagr3-source]]
...
- `/nix/store/ahssnqcdmk2lm8hmc50nzsr99gyaww89-0001-fix-find-nanobind-from-python-module.patch`
