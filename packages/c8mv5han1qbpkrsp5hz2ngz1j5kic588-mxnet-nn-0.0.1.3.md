...
- **Name**: `haskellPackages.mxnet-nn`
- **Version**: `0.0.1.3`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Train a neural network with MXNet in Haskell
- **Homepage**: [https://hackage.haskell.org/package/mxnet-nn](https://hackage.haskell.org/package/mxnet-nn)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/c8mv5han1qbpkrsp5hz2ngz1j5kic588-mxnet-nn-0.0.1.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:468106`
- **Outputs**:
  - `doc`:  `/nix/store/c8mv5han1qbpkrsp5hz2ngz1j5kic588-mxnet-nn-0.0.1.3`
  - `out`:  `/nix/store/c8mv5han1qbpkrsp5hz2ngz1j5kic588-mxnet-nn-0.0.1.3`
...
- [[y7krhfsamhxh7bminyxqswwr3p7hqwx5-mxnet-nn-0.0.1.3.tar.gz]]
