---
aliases:
  - androidenv.androidPkgs.all.system-images.VanillaIceCream.google_apis_playstore.x86_64
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.system-images.VanillaIceCream.google_apis_playstore.x86_64`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/gl2nnyv8adk6d0hjda309bmhm60xpqan-x86_64-VanillaIceCream_r05.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/gl2nnyv8adk6d0hjda309bmhm60xpqan-x86_64-VanillaIceCream_r05.zip`
