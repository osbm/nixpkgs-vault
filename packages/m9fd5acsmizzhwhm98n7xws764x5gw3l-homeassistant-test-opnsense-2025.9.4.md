...
- **Name**: `home-assistant-component-tests.opnsense`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/m9fd5acsmizzhwhm98n7xws764x5gw3l-homeassistant-test-opnsense-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/m9fd5acsmizzhwhm98n7xws764x5gw3l-homeassistant-test-opnsense-2025.9.4`

## 🔗 Dependencies

- [[01vjhi3i4gy8bi7a91dik98874s8shbm-python3.13-pyopnsense-0.4.0]]
