---
aliases:
  - haskellPackages.yesod-auth-deskcom
tags:
  - broken
  - not-available
  - license/unknown
...
- **Name**: `haskellPackages.yesod-auth-deskcom`
- **Version**: `1.4.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Desk.com remote authentication support for Yesod apps.
- **Homepage**: [https://hackage.haskell.org/package/yesod-auth-deskcom](https://hackage.haskell.org/package/yesod-auth-deskcom)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/wa0h7707jy5f8xrm1znv72f89zxv9i01-yesod-auth-deskcom-1.4.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:738529`
- **Outputs**:
  - `doc`:  `/nix/store/wa0h7707jy5f8xrm1znv72f89zxv9i01-yesod-auth-deskcom-1.4.0`
  - `out`:  `/nix/store/wa0h7707jy5f8xrm1znv72f89zxv9i01-yesod-auth-deskcom-1.4.0`
...
- [[rqk4jrimybgiap9p61k92qfrgxw15j08-yesod-auth-deskcom-1.4.0.tar.gz]]
