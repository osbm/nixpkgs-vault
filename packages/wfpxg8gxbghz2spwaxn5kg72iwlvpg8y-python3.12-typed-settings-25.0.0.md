...
- **Name**: `python312Packages.typed-settings`
- **Version**: `25.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/wfpxg8gxbghz2spwaxn5kg72iwlvpg8y-python3.12-typed-settings-25.0.0.drv`
...
- **Outputs**:
  - `dist`:  `/nix/store/wfpxg8gxbghz2spwaxn5kg72iwlvpg8y-python3.12-typed-settings-25.0.0`
  - `out`:  `/nix/store/wfpxg8gxbghz2spwaxn5kg72iwlvpg8y-python3.12-typed-settings-25.0.0`
