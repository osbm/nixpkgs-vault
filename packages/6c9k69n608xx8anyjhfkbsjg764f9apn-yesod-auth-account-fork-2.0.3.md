---
aliases:
  - haskellPackages.yesod-auth-account-fork
tags:
  - broken
  - not-available
  - license/unknown
...
- **Name**: `haskellPackages.yesod-auth-account-fork`
- **Version**: `2.0.3`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: An account authentication plugin for Yesod
- **Homepage**: [https://hackage.haskell.org/package/yesod-auth-account-fork](https://hackage.haskell.org/package/yesod-auth-account-fork)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/6c9k69n608xx8anyjhfkbsjg764f9apn-yesod-auth-account-fork-2.0.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:738350`
- **Outputs**:
  - `doc`:  `/nix/store/6c9k69n608xx8anyjhfkbsjg764f9apn-yesod-auth-account-fork-2.0.3`
  - `out`:  `/nix/store/6c9k69n608xx8anyjhfkbsjg764f9apn-yesod-auth-account-fork-2.0.3`
...
- [[mhh18igp3ldyic8zazhpf34nhl5g1fn5-yesod-auth-account-fork-2.0.3.tar.gz]]
