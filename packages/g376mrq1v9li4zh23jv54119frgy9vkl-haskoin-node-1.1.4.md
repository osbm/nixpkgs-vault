...
- **Name**: `haskellPackages.haskoin-node`
- **Version**: `1.1.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: P2P library for Bitcoin and Bitcoin Cash
- **Homepage**: [https://hackage.haskell.org/package/haskoin-node](https://hackage.haskell.org/package/haskoin-node)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/g376mrq1v9li4zh23jv54119frgy9vkl-haskoin-node-1.1.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:308797`
- **Outputs**:
  - `doc`:  `/nix/store/g376mrq1v9li4zh23jv54119frgy9vkl-haskoin-node-1.1.4`
  - `out`:  `/nix/store/g376mrq1v9li4zh23jv54119frgy9vkl-haskoin-node-1.1.4`

## 🔗 Dependencies

- [[0yrz11qijjkr0bd3s76dfbdvgn2inmlg-hspec-discover-2.11.12]]
- [[29ybm58igdzal48m551qwkafmkwglq6g-unliftio-0.2.25.1]]
- [[2l2ywwcz4vq4rzyiq5i0njhxxnmk451x-rocksdb-haskell-jprupp-2.1.7]]
...
- [[7q72s1192wws9in48jnclhcpwsb0vz1l-rocksdb-query-0.4.3]]
- [[8xjhzb7s8921ngclg2r6xdhf35kqs2ad-nqe-0.6.6]]
...
- [[jwc7skxfm4yd3ybavd0pnhskfqpz6z6p-haskoin-node-1.1.4.tar.gz]]
