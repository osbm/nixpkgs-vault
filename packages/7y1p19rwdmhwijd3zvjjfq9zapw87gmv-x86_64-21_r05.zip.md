---
aliases:
  - androidenv.androidPkgs.all.system-images.v21.default.x86_64
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.system-images.v21.default.x86_64`
- **Version**: `21_r05.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/7y1p19rwdmhwijd3zvjjfq9zapw87gmv-x86_64-21_r05.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/7y1p19rwdmhwijd3zvjjfq9zapw87gmv-x86_64-21_r05.zip`
