...
- **Homepage**: [https://github.com/samtay/so](https://github.com/samtay/so)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/gs213xm4z36pjj1qzgi78bdkvm9jgl2h-so-0.4.10.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/so/so/package.nix:53`
- **Outputs**:
  - `out`:  `/nix/store/gs213xm4z36pjj1qzgi78bdkvm9jgl2h-so-0.4.10`

## 🔗 Dependencies

- [[0f5ann1sgwyp31vlfqqsnr95xzv3mzhf-cargo-1.89.0]]
- [[0ha83zamssp8m7q661avaw7imi6giylq-so-0.4.10-vendor]]
...
- [[ivibkxnwybsffq56l2gj7vf56qbw7sdz-so-source-0.4.10]]
