...
- **Name**: `haskellPackages.nri-http`
- **Version**: `0.3.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Make Elm style HTTP requests
- **Homepage**: [https://hackage.haskell.org/package/nri-http](https://hackage.haskell.org/package/nri-http)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/liw3g653rq5kan75jspdjnqq999vj4vv-nri-http-0.3.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:482680`
- **Outputs**:
  - `doc`:  `/nix/store/liw3g653rq5kan75jspdjnqq999vj4vv-nri-http-0.3.0.0`
  - `out`:  `/nix/store/liw3g653rq5kan75jspdjnqq999vj4vv-nri-http-0.3.0.0`
...
- [[ca6019qih62np9dz9m1y447zr9lci8z6-nri-http-0.3.0.0.tar.gz]]
