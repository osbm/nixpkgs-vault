...
- **Name**: `python313Packages.ansible-runner`
- **Version**: `2.4.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/lhfsp0xy1xp6knq1x1zgjnvq90d3wlch-python3.13-ansible-runner-2.4.1.drv`
...
- **Outputs**:
  - `dist`:  `/nix/store/lhfsp0xy1xp6knq1x1zgjnvq90d3wlch-python3.13-ansible-runner-2.4.1`
  - `out`:  `/nix/store/lhfsp0xy1xp6knq1x1zgjnvq90d3wlch-python3.13-ansible-runner-2.4.1`
