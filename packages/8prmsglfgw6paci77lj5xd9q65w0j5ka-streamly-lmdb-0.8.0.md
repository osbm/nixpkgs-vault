...
- **Name**: `haskellPackages.streamly-lmdb`
- **Version**: `0.8.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Stream data to or from LMDB databases using the streamly library
- **Homepage**: [https://hackage.haskell.org/package/streamly-lmdb](https://hackage.haskell.org/package/streamly-lmdb)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/8prmsglfgw6paci77lj5xd9q65w0j5ka-streamly-lmdb-0.8.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:640441`
- **Outputs**:
  - `doc`:  `/nix/store/8prmsglfgw6paci77lj5xd9q65w0j5ka-streamly-lmdb-0.8.0`
  - `out`:  `/nix/store/8prmsglfgw6paci77lj5xd9q65w0j5ka-streamly-lmdb-0.8.0`

## 🔗 Dependencies

- [[00d6js7d91zmrll15kzqpvmchwa5xh1g-lifted-base-0.2.3.12]]
- [[19gis5xkj51lmkisj8grbkfhfj4irmqm-streamly-lmdb-0.8.0.tar.gz]]
