...
- **Name**: `haskellPackages.haskoin`
- **Version**: `0.1.0.2`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Implementation of the Bitcoin protocol
- **Homepage**: [https://hackage.haskell.org/package/haskoin](https://hackage.haskell.org/package/haskoin)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/34fmjw56arfpqy12gir6hnsgg35fj23n-haskoin-0.1.0.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:308382`
- **Outputs**:
  - `doc`:  `/nix/store/34fmjw56arfpqy12gir6hnsgg35fj23n-haskoin-0.1.0.2`
  - `out`:  `/nix/store/34fmjw56arfpqy12gir6hnsgg35fj23n-haskoin-0.1.0.2`
...
- [[b2gggqncjm5wvdhq1c8937l5xvz117zs-json-rpc-1.1.2]]
...
- [[wszr560jbva2ml04r7hsp6xp8142mslb-haskoin-0.1.0.2.tar.gz]]
- [[x6dkylq7yrng6ckyc95zz8a1b1wi4h4h-haskoin-0.1.0.2-r1.cabal]]
