...
- **Name**: `haskellPackages.streamly-zip`
- **Version**: `0.0.1`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Stream data from zip archives using the streamly library
- **Homepage**: [https://hackage.haskell.org/package/streamly-zip](https://hackage.haskell.org/package/streamly-zip)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/14hjb7h9v6gwxzxlpdjvy4qs1gamxz4k-streamly-zip-0.0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:640702`
- **Outputs**:
  - `data`:  `/nix/store/14hjb7h9v6gwxzxlpdjvy4qs1gamxz4k-streamly-zip-0.0.1`
  - `doc`:  `/nix/store/14hjb7h9v6gwxzxlpdjvy4qs1gamxz4k-streamly-zip-0.0.1`
  - `out`:  `/nix/store/14hjb7h9v6gwxzxlpdjvy4qs1gamxz4k-streamly-zip-0.0.1`

## 🔗 Dependencies

- [[0hdyq7d9p9kzljd6k4r7j655399zbfa1-streamly-zip-0.0.1.tar.gz]]
