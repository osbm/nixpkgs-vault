...
- **Name**: `haskellPackages.sparse`
- **Version**: `0.9.2`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: A playground of sparse linear algebra primitives using Morton ordering
- **Homepage**: [https://hackage.haskell.org/package/sparse](https://hackage.haskell.org/package/sparse)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/vabj5pvwaag848073x81gh5m99lcwwka-sparse-0.9.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:626217`
- **Outputs**:
  - `doc`:  `/nix/store/vabj5pvwaag848073x81gh5m99lcwwka-sparse-0.9.2`
  - `out`:  `/nix/store/vabj5pvwaag848073x81gh5m99lcwwka-sparse-0.9.2`
...
- [[fyrsyik79qbqjgz8fwvqzxm3731zz8p2-sparse-0.9.2.tar.gz]]
...
- [[l7dg7rmw8yxx7sq44wag29n044csgvig-hybrid-vectors-0.2.5]]
