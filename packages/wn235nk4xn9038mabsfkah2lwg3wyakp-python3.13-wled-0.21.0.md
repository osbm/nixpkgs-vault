...
- **Name**: `python313Packages.wled`
- **Version**: `0.21.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Asynchronous Python client for WLED
- **Homepage**: [https://github.com/frenck/python-wled](https://github.com/frenck/python-wled)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/wn235nk4xn9038mabsfkah2lwg3wyakp-python3.13-wled-0.21.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/wled/default.nix:73`
- **Outputs**:
  - `dist`:  `/nix/store/wn235nk4xn9038mabsfkah2lwg3wyakp-python3.13-wled-0.21.0`
  - `out`:  `/nix/store/wn235nk4xn9038mabsfkah2lwg3wyakp-python3.13-wled-0.21.0`
...
- [[4j10q5w3zaz39nkha41xms1bh6q6cmf1-source]]
