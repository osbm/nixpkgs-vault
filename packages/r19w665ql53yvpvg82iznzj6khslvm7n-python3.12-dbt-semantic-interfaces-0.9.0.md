---
aliases:
  - python312Packages.dbt-semantic-interfaces
tags:
  - license/unknown
  - maintainers/pbsds
  - outputs/dist
...
- **Name**: `python312Packages.dbt-semantic-interfaces`
- **Version**: `0.9.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Shared interfaces used by dbt-core and MetricFlow projects
- **Homepage**: [https://github.com/dbt-labs/dbt-semantic-interfaces](https://github.com/dbt-labs/dbt-semantic-interfaces)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/r19w665ql53yvpvg82iznzj6khslvm7n-python3.12-dbt-semantic-interfaces-0.9.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/dbt-semantic-interfaces/default.nix:60`
- **Outputs**:
  - `dist`:  `/nix/store/r19w665ql53yvpvg82iznzj6khslvm7n-python3.12-dbt-semantic-interfaces-0.9.0`
  - `out`:  `/nix/store/r19w665ql53yvpvg82iznzj6khslvm7n-python3.12-dbt-semantic-interfaces-0.9.0`
...
- [[bhn58mwx5c45q5h2fk6wiw4fmgpr6lxd-source]]
