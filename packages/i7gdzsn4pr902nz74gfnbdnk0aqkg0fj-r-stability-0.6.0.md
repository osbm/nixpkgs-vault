...
- **Name**: `rPackages.stability`
- **Version**: `0.6.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/stability/](https://cran.r-project.org/web/packages/stability/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/i7gdzsn4pr902nz74gfnbdnk0aqkg0fj-r-stability-0.6.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/i7gdzsn4pr902nz74gfnbdnk0aqkg0fj-r-stability-0.6.0`
...
- [[7rr1zdzhgqa58lvdw0ivkl21q2nvy321-stability_0.6.0.tar.gz]]
