...
- **Name**: `rPackages.gghexsize`
- **Version**: `0.1.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/gghexsize/](https://cran.r-project.org/web/packages/gghexsize/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/ns3rq7crlb61jk1nj9p6s75xk8mrhsi6-r-gghexsize-0.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/ns3rq7crlb61jk1nj9p6s75xk8mrhsi6-r-gghexsize-0.1.0`
...
- [[j2svc2ihqmcgsl4y80679mny8w4sfngr-gghexsize_0.1.0.tar.gz]]
