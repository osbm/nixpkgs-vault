...
- **Name**: `python313Packages.radios`
- **Version**: `0.3.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Asynchronous Python client for the Radio Browser API
- **Homepage**: [https://github.com/frenck/python-radios](https://github.com/frenck/python-radios)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/1375455k9li9cawrgq7falks30p1gs9c-python3.13-radios-0.3.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/radios/default.nix:70`
- **Outputs**:
  - `dist`:  `/nix/store/1375455k9li9cawrgq7falks30p1gs9c-python3.13-radios-0.3.2`
  - `out`:  `/nix/store/1375455k9li9cawrgq7falks30p1gs9c-python3.13-radios-0.3.2`
...
- [[8l4rw3rrmagd49i3gm0k274w8m1g00hy-source]]
