...
- **Name**: `haskellPackages.gothic`
- **Version**: `0.1.8.3`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: A Haskell Vault KVv2 secret engine client
- **Homepage**: [https://hackage.haskell.org/package/gothic](https://hackage.haskell.org/package/gothic)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/l64i2h4px4d97n59jjhc9jsii87zpkl9-gothic-0.1.8.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:279467`
- **Outputs**:
  - `doc`:  `/nix/store/l64i2h4px4d97n59jjhc9jsii87zpkl9-gothic-0.1.8.3`
  - `out`:  `/nix/store/l64i2h4px4d97n59jjhc9jsii87zpkl9-gothic-0.1.8.3`
...
- [[ysbb8w8hbcy3v1gm9hw3vlk7db0cq8gm-gothic-0.1.8.3.tar.gz]]
