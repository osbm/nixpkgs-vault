...
- **Name**: `linuxKernel.packages.linux_5_4.virtualboxGuestAdditions`
- **Version**: `7.2.0-5.4.299`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/s2sg1mnhgyqp6z1lphksjqysqjwl3p2b-VirtualBox-GuestAdditions-7.2.0-5.4.299.drv`
...
- **Outputs**:
  - `out`:  `/nix/store/s2sg1mnhgyqp6z1lphksjqysqjwl3p2b-VirtualBox-GuestAdditions-7.2.0-5.4.299`
...
- [[bn50bijq607b49xqaif7179g7bjydgjq-VirtualBox-GuestAdditions-builder-5.4.299-7.2.0]]
