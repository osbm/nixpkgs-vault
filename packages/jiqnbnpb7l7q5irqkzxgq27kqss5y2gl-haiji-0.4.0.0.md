...
- **Name**: `haskellPackages.haiji`
- **Version**: `0.4.0.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: A typed template engine, subset of jinja2
- **Homepage**: [https://hackage.haskell.org/package/haiji](https://hackage.haskell.org/package/haiji)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/jiqnbnpb7l7q5irqkzxgq27kqss5y2gl-haiji-0.4.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:292306`
- **Outputs**:
  - `doc`:  `/nix/store/jiqnbnpb7l7q5irqkzxgq27kqss5y2gl-haiji-0.4.0.0`
  - `out`:  `/nix/store/jiqnbnpb7l7q5irqkzxgq27kqss5y2gl-haiji-0.4.0.0`
...
- [[af4lv9fisi2vdllqm5xy4a5z90ij0338-haiji-0.4.0.0.tar.gz]]
