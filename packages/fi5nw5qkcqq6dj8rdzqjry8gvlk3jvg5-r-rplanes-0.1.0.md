...
- **Name**: `rPackages.rplanes`
- **Version**: `0.1.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/rplanes/](https://cran.r-project.org/web/packages/rplanes/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/fi5nw5qkcqq6dj8rdzqjry8gvlk3jvg5-r-rplanes-0.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/fi5nw5qkcqq6dj8rdzqjry8gvlk3jvg5-r-rplanes-0.1.0`

## 🔗 Dependencies

- [[35sipq0g1isv0pcs1fw8jb5shsnp69mq-rplanes_0.1.0.tar.gz]]
