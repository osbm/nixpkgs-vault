...
- **Name**: `haskellPackages.script-monad`
- **Version**: `0.0.4`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Stack of error, reader, writer, state, and prompt monad transformers
- **Homepage**: [https://hackage.haskell.org/package/script-monad](https://hackage.haskell.org/package/script-monad)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/40fra55dd3c1j8w0r921pfzih0s1i351-script-monad-0.0.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:590176`
- **Outputs**:
  - `doc`:  `/nix/store/40fra55dd3c1j8w0r921pfzih0s1i351-script-monad-0.0.4`
  - `out`:  `/nix/store/40fra55dd3c1j8w0r921pfzih0s1i351-script-monad-0.0.4`
...
- [[8bbvahr5h6r105jrr3g52kmzpmi2d0q2-script-monad-0.0.4.tar.gz]]
