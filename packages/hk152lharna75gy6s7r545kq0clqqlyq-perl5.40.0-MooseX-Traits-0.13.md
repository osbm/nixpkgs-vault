...
- **Name**: `perl540Packages.MooseXTraits`
- **Version**: `0.13`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Automatically apply roles at object creation time
- **Homepage**: [https://github.com/moose/MooseX-Traits](https://github.com/moose/MooseX-Traits)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/hk152lharna75gy6s7r545kq0clqqlyq-perl5.40.0-MooseX-Traits-0.13.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/top-level/perl-packages.nix:24254`
- **Outputs**:
  - `devdoc`:  `/nix/store/hk152lharna75gy6s7r545kq0clqqlyq-perl5.40.0-MooseX-Traits-0.13`
  - `out`:  `/nix/store/hk152lharna75gy6s7r545kq0clqqlyq-perl5.40.0-MooseX-Traits-0.13`
...
- [[xv946xf0sa1qrf0dpdjs6dfyyjpvh03p-MooseX-Traits-0.13.tar.gz]]
