...
- **Name**: `rPackages.clinUtils`
- **Version**: `0.2.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/clinUtils/](https://cran.r-project.org/web/packages/clinUtils/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/cb2p4j9ix748i2gqxa02d1fbvzhc68hr-r-clinUtils-0.2.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/cb2p4j9ix748i2gqxa02d1fbvzhc68hr-r-clinUtils-0.2.0`
...
- [[rbdg602mmva098aa4i31vkdxnskpd7xg-clinUtils_0.2.0.tar.gz]]
