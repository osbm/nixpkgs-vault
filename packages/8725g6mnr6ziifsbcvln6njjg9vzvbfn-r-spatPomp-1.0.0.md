...
- **Name**: `rPackages.spatPomp`
- **Version**: `1.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/spatPomp/](https://cran.r-project.org/web/packages/spatPomp/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/8725g6mnr6ziifsbcvln6njjg9vzvbfn-r-spatPomp-1.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/8725g6mnr6ziifsbcvln6njjg9vzvbfn-r-spatPomp-1.0.0`

## 🔗 Dependencies

- [[36ynm43a33s9mka7d4qcim9j591vn8kn-r-pomp-6.3]]
...
- [[f8m8wr6w4mspy6jqsbzfdrcb4zcpk358-spatPomp_1.0.0.tar.gz]]
