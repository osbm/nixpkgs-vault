...
- **Name**: `haskellPackages.matrix-client`
- **Version**: `0.1.6.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: A matrix client library
- **Homepage**: [https://hackage.haskell.org/package/matrix-client](https://hackage.haskell.org/package/matrix-client)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/f1hajaczm8xsmifka68lmxq5rmzdzjq0-matrix-client-0.1.6.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:439925`
- **Outputs**:
  - `doc`:  `/nix/store/f1hajaczm8xsmifka68lmxq5rmzdzjq0-matrix-client-0.1.6.1`
  - `out`:  `/nix/store/f1hajaczm8xsmifka68lmxq5rmzdzjq0-matrix-client-0.1.6.1`
...
- [[nhgy0f91mv5xafwsphjd2hnpg31sq4ny-matrix-client-0.1.6.1.tar.gz]]
