...
- **Name**: `rPackages.maxcombo`
- **Version**: `1.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/maxcombo/](https://cran.r-project.org/web/packages/maxcombo/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/7gh52hrp7mjlxwsa6cnyj7k1jabnwsxy-r-maxcombo-1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/7gh52hrp7mjlxwsa6cnyj7k1jabnwsxy-r-maxcombo-1.0`

## 🔗 Dependencies

- [[2gyk7dyjm0d650z8fbxl442wm4jfgzsh-maxcombo_1.0.tar.gz]]
