...
- **Name**: `haskellPackages.doi`
- **Version**: `0.0.2`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Automatic Bibtex and fulltext of scientific articles
- **Homepage**: [https://hackage.haskell.org/package/doi](https://hackage.haskell.org/package/doi)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/pbzhmb59pc9a74h5ixjbyr4ssklsx1i3-doi-0.0.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:201396`
- **Outputs**:
  - `doc`:  `/nix/store/pbzhmb59pc9a74h5ixjbyr4ssklsx1i3-doi-0.0.2`
  - `out`:  `/nix/store/pbzhmb59pc9a74h5ixjbyr4ssklsx1i3-doi-0.0.2`
...
- [[s291klhr2i2daxd70jrb40phjx22jghy-doi-0.0.2.tar.gz]]
