---
aliases:
  - androidenv.androidPkgs.all.system-images.v35x.google_apis_playstore.arm64-v8a
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.system-images.v35x.google_apis_playstore.arm64-v8a`
- **Version**: `35-ext14_r01.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/1v4flwx28svfscg99l0syhqlmnq6l7xb-arm64-v8a-35-ext14_r01.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/1v4flwx28svfscg99l0syhqlmnq6l7xb-arm64-v8a-35-ext14_r01.zip`
