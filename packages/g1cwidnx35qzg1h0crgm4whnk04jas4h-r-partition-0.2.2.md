...
- **Name**: `rPackages.partition`
- **Version**: `0.2.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/partition/](https://cran.r-project.org/web/packages/partition/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/g1cwidnx35qzg1h0crgm4whnk04jas4h-r-partition-0.2.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/g1cwidnx35qzg1h0crgm4whnk04jas4h-r-partition-0.2.2`
...
- [[b56q3b17w2gbgahh017sgci04a2j1p5z-partition_0.2.2.tar.gz]]
