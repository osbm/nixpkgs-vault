...
- **Name**: `python313Packages.httplib2`
- **Version**: `0.22.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/w7r21sc7gdvfib42p0w4rvizxd2a4fqd-python3.13-httplib2-0.22.0.drv`
...
- **Outputs**:
  - `dist`:  `/nix/store/w7r21sc7gdvfib42p0w4rvizxd2a4fqd-python3.13-httplib2-0.22.0`
  - `out`:  `/nix/store/w7r21sc7gdvfib42p0w4rvizxd2a4fqd-python3.13-httplib2-0.22.0`
