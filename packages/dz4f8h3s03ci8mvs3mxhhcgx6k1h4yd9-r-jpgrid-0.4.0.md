...
- **Name**: `rPackages.jpgrid`
- **Version**: `0.4.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/jpgrid/](https://cran.r-project.org/web/packages/jpgrid/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/dz4f8h3s03ci8mvs3mxhhcgx6k1h4yd9-r-jpgrid-0.4.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/dz4f8h3s03ci8mvs3mxhhcgx6k1h4yd9-r-jpgrid-0.4.0`
...
- [[k2gcrk8xwhxsv57fshhbzz84mfnrmp63-jpgrid_0.4.0.tar.gz]]
