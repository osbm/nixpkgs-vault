---
aliases:
  - home-assistant-component-tests.logger
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.logger`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/41fqfbs5f23sjc14qkqcwgj3mig1w3ay-homeassistant-test-logger-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/41fqfbs5f23sjc14qkqcwgj3mig1w3ay-homeassistant-test-logger-2025.9.4`
