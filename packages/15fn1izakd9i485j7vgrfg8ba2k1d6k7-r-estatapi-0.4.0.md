...
- **Name**: `rPackages.estatapi`
- **Version**: `0.4.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/estatapi/](https://cran.r-project.org/web/packages/estatapi/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/15fn1izakd9i485j7vgrfg8ba2k1d6k7-r-estatapi-0.4.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/15fn1izakd9i485j7vgrfg8ba2k1d6k7-r-estatapi-0.4.0`
...
- [[kcras66y4fsq1cm121lmnl5la1b49hvl-estatapi_0.4.0.tar.gz]]
