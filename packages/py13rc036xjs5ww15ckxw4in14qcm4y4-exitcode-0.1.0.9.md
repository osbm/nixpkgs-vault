...
- **Name**: `haskellPackages.exitcode`
- **Version**: `0.1.0.9`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Monad transformer for exit codes
- **Homepage**: [https://hackage.haskell.org/package/exitcode](https://hackage.haskell.org/package/exitcode)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/py13rc036xjs5ww15ckxw4in14qcm4y4-exitcode-0.1.0.9.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:223998`
- **Outputs**:
  - `doc`:  `/nix/store/py13rc036xjs5ww15ckxw4in14qcm4y4-exitcode-0.1.0.9`
  - `out`:  `/nix/store/py13rc036xjs5ww15ckxw4in14qcm4y4-exitcode-0.1.0.9`
...
- [[hdd41afczdqavj7ii55pdpk17ciizvy1-exitcode-0.1.0.9.tar.gz]]
