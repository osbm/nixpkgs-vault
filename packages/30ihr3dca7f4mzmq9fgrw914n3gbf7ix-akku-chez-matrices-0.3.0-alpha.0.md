...
- **Name**: `akkuPackages.chez-matrices`
- **Version**: `0.3.0-alpha.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Implementation of common matrix (tensor) constructions and operatoins.
- **Homepage**: []()
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/30ihr3dca7f4mzmq9fgrw914n3gbf7ix-akku-chez-matrices-0.3.0-alpha.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/tools/package-management/akku/default.nix:39`
- **Outputs**:
  - `out`:  `/nix/store/30ihr3dca7f4mzmq9fgrw914n3gbf7ix-akku-chez-matrices-0.3.0-alpha.0`

## 🔗 Dependencies

- [[2jbjfm0s7c03a7mylffys7n228vs64rz-make-shell-wrapper-hook]]
- [[2y6hgxq39inq23hwbiqpa1mlk5ykkb8n-chez-matrices_0.3.0-alpha.0_repack.tar.xz]]
