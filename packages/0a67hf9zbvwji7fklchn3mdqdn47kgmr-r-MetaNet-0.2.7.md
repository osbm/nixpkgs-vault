...
- **Name**: `rPackages.MetaNet`
- **Version**: `0.2.7`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/MetaNet/](https://cran.r-project.org/web/packages/MetaNet/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/0a67hf9zbvwji7fklchn3mdqdn47kgmr-r-MetaNet-0.2.7.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/0a67hf9zbvwji7fklchn3mdqdn47kgmr-r-MetaNet-0.2.7`
...
- [[ysfsgdp6bfsvcsw922mhr62yb6rz2a70-MetaNet_0.2.7.tar.gz]]
