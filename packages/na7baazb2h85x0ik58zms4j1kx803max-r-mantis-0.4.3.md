...
- **Name**: `rPackages.mantis`
- **Version**: `0.4.3`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/mantis/](https://cran.r-project.org/web/packages/mantis/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/na7baazb2h85x0ik58zms4j1kx803max-r-mantis-0.4.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/na7baazb2h85x0ik58zms4j1kx803max-r-mantis-0.4.3`

## 🔗 Dependencies

- [[1z1nbbqmq2qb5wqqd1jfg9zc1jjd1jiw-r-scales-1.4.0]]
- [[5yah809hhibv0mykclmnk44myp2b4cj2-mantis_0.4.3.tar.gz]]
