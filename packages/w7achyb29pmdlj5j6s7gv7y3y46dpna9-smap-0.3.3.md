...
- **Name**: `haskellPackages.smap`
- **Version**: `0.3.3`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: A command line tool for working with sets and maps
- **Homepage**: [https://hackage.haskell.org/package/smap](https://hackage.haskell.org/package/smap)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/w7achyb29pmdlj5j6s7gv7y3y46dpna9-smap-0.3.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:617749`
- **Outputs**:
  - `doc`:  `/nix/store/w7achyb29pmdlj5j6s7gv7y3y46dpna9-smap-0.3.3`
  - `out`:  `/nix/store/w7achyb29pmdlj5j6s7gv7y3y46dpna9-smap-0.3.3`
...
- [[hpx12bwafx6hwqin8j7hn4hvzsz7438d-smap-0.3.3.tar.gz]]
