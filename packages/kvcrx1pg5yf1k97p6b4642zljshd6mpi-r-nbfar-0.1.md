...
- **Name**: `rPackages.nbfar`
- **Version**: `0.1`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://cran.r-project.org/web/packages/nbfar/](https://cran.r-project.org/web/packages/nbfar/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/kvcrx1pg5yf1k97p6b4642zljshd6mpi-r-nbfar-0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/kvcrx1pg5yf1k97p6b4642zljshd6mpi-r-nbfar-0.1`
...
- [[5hhcxwbfgg5grvbmh6k54ki7jy6ry1w4-nbfar_0.1.tar.gz]]
