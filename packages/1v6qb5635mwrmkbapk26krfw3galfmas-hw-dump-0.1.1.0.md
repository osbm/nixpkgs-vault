...
- **Name**: `haskellPackages.hw-dump`
- **Version**: `0.1.1.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: File Dump
- **Homepage**: [https://hackage.haskell.org/package/hw-dump](https://hackage.haskell.org/package/hw-dump)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/1v6qb5635mwrmkbapk26krfw3galfmas-hw-dump-0.1.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:366132`
- **Outputs**:
  - `doc`:  `/nix/store/1v6qb5635mwrmkbapk26krfw3galfmas-hw-dump-0.1.1.0`
  - `out`:  `/nix/store/1v6qb5635mwrmkbapk26krfw3galfmas-hw-dump-0.1.1.0`
...
- [[mzxbpvbfcl33pq92v7kzidrr8zv09cyx-hw-dump-0.1.1.0.tar.gz]]
- [[p76r0cwlf6k97ibprrpfd8xw0r8wc3nx-stdenv-linux]]
- [[q59yi98n975qnmvvand2zzzfick6y4mx-hw-dump-0.1.1.0-r6.cabal]]
