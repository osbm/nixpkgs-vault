...
- **Name**: `python312Packages.databricks-cli`
- **Version**: `0.18.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Command line interface for Databricks
- **Homepage**: [https://github.com/databricks/databricks-cli](https://github.com/databricks/databricks-cli)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/4bnkfxgrl3ii78vjp7bn0yf8kwvbzyzd-python3.12-databricks-cli-0.18.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/databricks-cli/default.nix:59`
- **Outputs**:
  - `dist`:  `/nix/store/4bnkfxgrl3ii78vjp7bn0yf8kwvbzyzd-python3.12-databricks-cli-0.18.0`
  - `out`:  `/nix/store/4bnkfxgrl3ii78vjp7bn0yf8kwvbzyzd-python3.12-databricks-cli-0.18.0`
...
- [[9wi1nln4dnm5rgsxy87x0cy3p7lc4kgr-source]]
