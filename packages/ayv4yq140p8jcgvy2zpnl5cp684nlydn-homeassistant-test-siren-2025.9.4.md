---
aliases:
  - home-assistant-component-tests.siren
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.siren`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/ayv4yq140p8jcgvy2zpnl5cp684nlydn-homeassistant-test-siren-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/ayv4yq140p8jcgvy2zpnl5cp684nlydn-homeassistant-test-siren-2025.9.4`
