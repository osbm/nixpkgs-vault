...
- **Name**: `home-assistant-component-tests.minecraft_server`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/1b1psvdsigrxkdr74i1x0cd5kkqh4p06-homeassistant-test-minecraft_server-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/1b1psvdsigrxkdr74i1x0cd5kkqh4p06-homeassistant-test-minecraft_server-2025.9.4`
...
- [[nsmwzsmzcrb8l15fa20z9f1vwhdggr00-python3.13-mcstatus-12.0.5]]
