...
- **Name**: `python313Packages.nltk`
- **Version**: `3.9.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Natural Language Processing ToolKit
- **Homepage**: [http://nltk.org/](http://nltk.org/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/3cqljs8src3ih0q4yaw9j59y3gli870f-python3.13-nltk-3.9.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/nltk/default.nix:103`
- **Outputs**:
  - `dist`:  `/nix/store/3cqljs8src3ih0q4yaw9j59y3gli870f-python3.13-nltk-3.9.1`
  - `out`:  `/nix/store/3cqljs8src3ih0q4yaw9j59y3gli870f-python3.13-nltk-3.9.1`
...
- [[2rf762dhy647vjlmrx52pfvw4zgvz9ab-nltk-3.9.1.tar.gz]]
...
- [[mqhi6cnn74czcq4hrphnbwiv39jsh7lh-nltk-data-dir]]
