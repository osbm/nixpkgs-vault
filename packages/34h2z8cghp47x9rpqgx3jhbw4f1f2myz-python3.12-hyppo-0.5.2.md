...
- **Name**: `python312Packages.hyppo`
- **Version**: `0.5.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Python package for multivariate hypothesis testing
- **Homepage**: [https://github.com/neurodata/hyppo](https://github.com/neurodata/hyppo)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/34h2z8cghp47x9rpqgx3jhbw4f1f2myz-python3.12-hyppo-0.5.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/hyppo/default.nix:71`
- **Outputs**:
  - `dist`:  `/nix/store/34h2z8cghp47x9rpqgx3jhbw4f1f2myz-python3.12-hyppo-0.5.2`
  - `out`:  `/nix/store/34h2z8cghp47x9rpqgx3jhbw4f1f2myz-python3.12-hyppo-0.5.2`
...
- [[gq5v80qw2pcfpsxmnalcsh91gp7s1izp-source]]
