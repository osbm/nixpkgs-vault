...
- **Name**: `haskellPackages.gi-adwaita`
- **Version**: `1.0.8`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Adwaita bindings
- **Homepage**: [https://hackage.haskell.org/package/gi-adwaita](https://hackage.haskell.org/package/gi-adwaita)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/hrwi4j2v9y4d6pgf85m1avmh2hwqj530-gi-adwaita-1.0.8.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:263618`
- **Outputs**:
  - `doc`:  `/nix/store/hrwi4j2v9y4d6pgf85m1avmh2hwqj530-gi-adwaita-1.0.8`
  - `out`:  `/nix/store/hrwi4j2v9y4d6pgf85m1avmh2hwqj530-gi-adwaita-1.0.8`
...
- [[6fw616dnl0vwysznvspd9v7vkkfsllh5-gi-adwaita-1.0.8.tar.gz]]
