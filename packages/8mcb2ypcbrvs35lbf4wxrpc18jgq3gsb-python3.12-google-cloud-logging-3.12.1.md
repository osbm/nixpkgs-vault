---
aliases:
  - python312Packages.google-cloud-logging
tags:
  - license/unknown
  - outputs/dist
  - outputs/out
...
- **Name**: `python312Packages.google-cloud-logging`
- **Version**: `3.12.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Stackdriver Logging API client library
- **Homepage**: [https://github.com/googleapis/python-logging](https://github.com/googleapis/python-logging)
- **License**: `unknown`
- **Platforms**: `aarch64-linux`, `armv5tel-linux`, `armv6l-linux`, `armv7a-linux`, `armv7l-linux`, `i686-linux`, `loongarch64-linux`, `m68k-linux`, `microblaze-linux`, `microblazeel-linux`, `mips-linux`, `mips64-linux`, `mips64el-linux`, `mipsel-linux`, `powerpc-linux`, `powerpc64-linux`, `powerpc64le-linux`, `riscv32-linux`, `riscv64-linux`, `s390-linux`, `s390x-linux`, `x86_64-linux`, `x86_64-darwin`, `aarch64-darwin`, `i686-cygwin`, `x86_64-cygwin`, `aarch64-windows`, `x86_64-windows`, `i686-windows`, `i686-freebsd`, `x86_64-freebsd`, `aarch64-freebsd`

## 🔧 Build Information

- **Derivation Path**: `/nix/store/8mcb2ypcbrvs35lbf4wxrpc18jgq3gsb-python3.12-google-cloud-logging-3.12.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/google-cloud-logging/default.nix:89`
- **Outputs**:
  - `dist`:  `/nix/store/8mcb2ypcbrvs35lbf4wxrpc18jgq3gsb-python3.12-google-cloud-logging-3.12.1`
  - `out`:  `/nix/store/8mcb2ypcbrvs35lbf4wxrpc18jgq3gsb-python3.12-google-cloud-logging-3.12.1`
...
- [[3iflh1vdhvv8dgcid767wqjgbibr3idx-python3.12-google-cloud-audit-log-0.3.2]]
...
- [[8vbfzbd700m1sx2lagbd2abkk2hpx54v-google_cloud_logging-3.12.1.tar.gz]]
...
- [[chrj8clzr6b6r1rbbjy97c9kc1gdq3gk-python3.12-google-cloud-appengine-logging-1.6.2]]
