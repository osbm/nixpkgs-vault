---
aliases:
  - linuxKernel.packages.linux_6_16.chipsec
tags:
  - license/unknown
...
- **Name**: `linuxKernel.packages.linux_6_16.chipsec`
- **Version**: `1.10.6`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/51gfrjx5k9619p71mvsjh6p2vcla6b81-chipsec-1.10.6.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/tools/security/chipsec/default.nix:77`
- **Outputs**:
  - `dist`:  `/nix/store/51gfrjx5k9619p71mvsjh6p2vcla6b81-chipsec-1.10.6`
  - `out`:  `/nix/store/51gfrjx5k9619p71mvsjh6p2vcla6b81-chipsec-1.10.6`
