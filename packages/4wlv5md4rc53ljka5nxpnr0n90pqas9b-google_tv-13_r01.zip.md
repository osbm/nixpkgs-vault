---
aliases:
  - androidenv.androidPkgs.all.addons.v13.google_tv_addon
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.addons.v13.google_tv_addon`
- **Version**: `13_r01.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/4wlv5md4rc53ljka5nxpnr0n90pqas9b-google_tv-13_r01.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/4wlv5md4rc53ljka5nxpnr0n90pqas9b-google_tv-13_r01.zip`
