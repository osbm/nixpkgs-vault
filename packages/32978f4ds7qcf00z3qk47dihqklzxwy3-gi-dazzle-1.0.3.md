...
- **Name**: `haskellPackages.gi-dazzle`
- **Version**: `1.0.3`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: libdazzle bindings
- **Homepage**: [https://hackage.haskell.org/package/gi-dazzle](https://hackage.haskell.org/package/gi-dazzle)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/32978f4ds7qcf00z3qk47dihqklzxwy3-gi-dazzle-1.0.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:264062`
- **Outputs**:
  - `doc`:  `/nix/store/32978f4ds7qcf00z3qk47dihqklzxwy3-gi-dazzle-1.0.3`
  - `out`:  `/nix/store/32978f4ds7qcf00z3qk47dihqklzxwy3-gi-dazzle-1.0.3`
...
- [[snydnvsl3aw3apc89y7mvwhprh1wvd96-gi-dazzle-1.0.3.tar.gz]]
