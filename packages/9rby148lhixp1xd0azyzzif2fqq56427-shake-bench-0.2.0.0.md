...
- **Name**: `haskellPackages.shake-bench`
- **Version**: `0.2.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Build rules for historical benchmarking
- **Homepage**: [https://hackage.haskell.org/package/shake-bench](https://hackage.haskell.org/package/shake-bench)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/9rby148lhixp1xd0azyzzif2fqq56427-shake-bench-0.2.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:605972`
- **Outputs**:
  - `doc`:  `/nix/store/9rby148lhixp1xd0azyzzif2fqq56427-shake-bench-0.2.0.0`
  - `out`:  `/nix/store/9rby148lhixp1xd0azyzzif2fqq56427-shake-bench-0.2.0.0`
...
- [[6z1idg2rk1138mrja65qw0cgiz07dc72-shake-bench-0.2.0.0.tar.gz]]
