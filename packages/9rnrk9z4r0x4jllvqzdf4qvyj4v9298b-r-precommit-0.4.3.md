...
- **Name**: `rPackages.precommit`
- **Version**: `0.4.3`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/precommit/](https://cran.r-project.org/web/packages/precommit/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/9rnrk9z4r0x4jllvqzdf4qvyj4v9298b-r-precommit-0.4.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/9rnrk9z4r0x4jllvqzdf4qvyj4v9298b-r-precommit-0.4.3`
...
- [[7wf92v46pirrza2lcgzv9y9sdzp5a6zk-precommit_0.4.3.tar.gz]]
