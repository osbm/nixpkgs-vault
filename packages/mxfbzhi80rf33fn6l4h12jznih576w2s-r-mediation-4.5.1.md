...
- **Name**: `rPackages.mediation`
- **Version**: `4.5.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/mediation/](https://cran.r-project.org/web/packages/mediation/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/mxfbzhi80rf33fn6l4h12jznih576w2s-r-mediation-4.5.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/mxfbzhi80rf33fn6l4h12jznih576w2s-r-mediation-4.5.1`
...
- [[xy6c65060fn5ad51m93x9b9gpc1f1i9i-mediation_4.5.1.tar.gz]]
