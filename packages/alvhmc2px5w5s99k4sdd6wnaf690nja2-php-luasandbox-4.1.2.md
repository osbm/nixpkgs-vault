...
- **Name**: `php81Extensions.luasandbox`
- **Version**: `4.1.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/alvhmc2px5w5s99k4sdd6wnaf690nja2-php-luasandbox-4.1.2.drv`
...
- **Outputs**:
  - `out`:  `/nix/store/alvhmc2px5w5s99k4sdd6wnaf690nja2-php-luasandbox-4.1.2`
