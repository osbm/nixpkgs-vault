---
aliases:
  - home-assistant-component-tests.sensor
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.sensor`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/yf7frmhr9bca9qvpmkqv7zp9qrg4j18h-homeassistant-test-sensor-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/yf7frmhr9bca9qvpmkqv7zp9qrg4j18h-homeassistant-test-sensor-2025.9.4`
