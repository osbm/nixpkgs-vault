...
Close to drop in replacement for cut that can use a regex delimiter instead of a fixed string
...
- **Homepage**: [https://github.com/sstadick/hck](https://github.com/sstadick/hck)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/sykpv7bnq1sp8lfa6xwnni4sm22kpk0b-hck-0.11.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/hc/hck/package.nix:24`
- **Outputs**:
  - `out`:  `/nix/store/sykpv7bnq1sp8lfa6xwnni4sm22kpk0b-hck-0.11.4`
...
- [[k7mxmqlbd848xr5a6r4qv7mvfw4rvk76-source]]
- [[nbi7qpc3j53my9jyylbz3zn6wy0k84wc-hck-0.11.4-vendor]]
