...
- **Name**: `linuxKernel.packages.linux_6_16.cpupower`
- **Version**: `6.16.8`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/47328m3z4wiwr364w02rkvmn4iamy7zy-cpupower-6.16.8.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/cpupower/default.nix:51`
- **Outputs**:
  - `out`:  `/nix/store/47328m3z4wiwr364w02rkvmn4iamy7zy-cpupower-6.16.8`
