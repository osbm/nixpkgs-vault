...
- **Name**: `beam26Packages.elixir_1_16`
- **Version**: `1.16.3`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/90mzfsdixw1489xk4hs4p65f9js01jhi-elixir-1.16.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/interpreters/elixir/1.16.nix:4`
- **Outputs**:
  - `out`:  `/nix/store/90mzfsdixw1489xk4hs4p65f9js01jhi-elixir-1.16.3`
