...
- **Name**: `haskellPackages.Chart-simple`
- **Version**: `1.3.3`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: A wrapper for the chart library to assist with basic plots (Deprecated - use the Easy module instead)
- **Homepage**: [https://hackage.haskell.org/package/Chart-simple](https://hackage.haskell.org/package/Chart-simple)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/ajlkvwa1kg80vlkhwcfmdvqbrilxly8w-Chart-simple-1.3.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:6804`
- **Outputs**:
  - `doc`:  `/nix/store/ajlkvwa1kg80vlkhwcfmdvqbrilxly8w-Chart-simple-1.3.3`
  - `out`:  `/nix/store/ajlkvwa1kg80vlkhwcfmdvqbrilxly8w-Chart-simple-1.3.3`
...
- [[gc9qlvl0i2cvj1yilkqphwdvnamb3v2s-Chart-simple-1.3.3.tar.gz]]
