...
Provides local testing for developers working with Compute@Edge
...
- **Homepage**: [https://github.com/fastly/Viceroy](https://github.com/fastly/Viceroy)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/86wgkrhdkh6hyhhl7202r94a5ygsav5q-viceroy-0.14.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/vi/viceroy/package.nix:25`
- **Outputs**:
  - `out`:  `/nix/store/86wgkrhdkh6hyhhl7202r94a5ygsav5q-viceroy-0.14.3`
...
- [[9smf7xgrjl99h3pczagxb4s1qppkfrka-viceroy-0.14.3-vendor]]
- [[bjsb6wdjykafnkixq156qdvmxhsm2bai-bash-5.3p3]]
- [[mfrjjkmgblqhyfrw8kklashwfbm56ylb-source]]
