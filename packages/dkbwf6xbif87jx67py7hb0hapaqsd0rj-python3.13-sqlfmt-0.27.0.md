...
- **Name**: `python313Packages.sqlfmt`
- **Version**: `0.27.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Sqlfmt formats your dbt SQL files so you don't have to
- **Homepage**: [https://github.com/tconbeer/sqlfmt](https://github.com/tconbeer/sqlfmt)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/dkbwf6xbif87jx67py7hb0hapaqsd0rj-python3.13-sqlfmt-0.27.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/sqlfmt/default.nix:60`
- **Outputs**:
  - `dist`:  `/nix/store/dkbwf6xbif87jx67py7hb0hapaqsd0rj-python3.13-sqlfmt-0.27.0`
  - `out`:  `/nix/store/dkbwf6xbif87jx67py7hb0hapaqsd0rj-python3.13-sqlfmt-0.27.0`
...
- [[dlyd73cwbri94h1m9chaairdvrnayndr-source]]
