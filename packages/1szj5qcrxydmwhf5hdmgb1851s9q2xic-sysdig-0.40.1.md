...
- **Name**: `linuxKernel.packages.linux_latest_libre.sysdig`
- **Version**: `0.40.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/1szj5qcrxydmwhf5hdmgb1851s9q2xic-sysdig-0.40.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/sysdig/default.nix:182`
- **Outputs**:
  - `out`:  `/nix/store/1szj5qcrxydmwhf5hdmgb1851s9q2xic-sysdig-0.40.1`
