...
- **Name**: `python312Packages.pysignalr`
- **Version**: `1.3.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/nszh5nnbcc0wadg42zpjk5zf2f2s2716-python3.12-pysignalr-1.3.0.drv`
...
- **Outputs**:
  - `dist`:  `/nix/store/nszh5nnbcc0wadg42zpjk5zf2f2s2716-python3.12-pysignalr-1.3.0`
  - `out`:  `/nix/store/nszh5nnbcc0wadg42zpjk5zf2f2s2716-python3.12-pysignalr-1.3.0`
