---
aliases:
  - androidenv.androidPkgs.all.packages.build-tools.v35_0_0-rc2
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.packages.build-tools.v35_0_0-rc2`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/v0w53fa57jsaax7ags90f29l0dm2psmw-build-tools_r35-rc2_linux.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/v0w53fa57jsaax7ags90f29l0dm2psmw-build-tools_r35-rc2_linux.zip`
