...
- **Name**: `python313Packages.nextcord`
- **Version**: `3.1.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Python wrapper for the Discord API forked from discord.py
- **Homepage**: [https://github.com/nextcord/nextcord](https://github.com/nextcord/nextcord)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/jd1v7rkvrb3vsmsvsx17sjvi9v5v1wrz-python3.13-nextcord-3.1.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/nextcord/default.nix:78`
- **Outputs**:
  - `dist`:  `/nix/store/jd1v7rkvrb3vsmsvsx17sjvi9v5v1wrz-python3.13-nextcord-3.1.1`
  - `out`:  `/nix/store/jd1v7rkvrb3vsmsvsx17sjvi9v5v1wrz-python3.13-nextcord-3.1.1`
...
- [[qc1va2620jj8jf2df9axj197xf8hcbcq-paths.patch]]
...
- [[x6az0awlgfc214pvcf42jy4585mvrcn8-source]]
