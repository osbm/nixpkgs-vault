...
- **Name**: `rPackages.corrMCT`
- **Version**: `0.2.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/corrMCT/](https://cran.r-project.org/web/packages/corrMCT/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/87fl203c6s8cmjiwa806imqmlvc33i4q-r-corrMCT-0.2.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/87fl203c6s8cmjiwa806imqmlvc33i4q-r-corrMCT-0.2.0`
...
- [[pr18r7dr06nlhciwxy1jl30mqrsmj6yx-corrMCT_0.2.0.tar.gz]]
