...
- **Name**: `haskellPackages.monad-logger`
- **Version**: `0.3.42`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: A class of monads which can log messages
- **Homepage**: [https://hackage.haskell.org/package/monad-logger](https://hackage.haskell.org/package/monad-logger)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/xarn2gqfdxdmh66qq48cnyzi1i80d571-monad-logger-0.3.42.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:454742`
- **Outputs**:
  - `doc`:  `/nix/store/xarn2gqfdxdmh66qq48cnyzi1i80d571-monad-logger-0.3.42`
  - `out`:  `/nix/store/xarn2gqfdxdmh66qq48cnyzi1i80d571-monad-logger-0.3.42`
...
- [[m7as403mj61g2jj31rdpaxsykfzxz76l-monad-logger-0.3.42.tar.gz]]
