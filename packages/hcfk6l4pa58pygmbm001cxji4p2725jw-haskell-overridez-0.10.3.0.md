...
- **Name**: `haskellPackages.haskell-overridez`
- **Version**: `0.10.3.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Manage nix overrides for haskell packages
- **Homepage**: [https://hackage.haskell.org/package/haskell-overridez](https://hackage.haskell.org/package/haskell-overridez)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/hcfk6l4pa58pygmbm001cxji4p2725jw-haskell-overridez-0.10.3.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:304463`
- **Outputs**:
  - `doc`:  `/nix/store/hcfk6l4pa58pygmbm001cxji4p2725jw-haskell-overridez-0.10.3.0`
  - `out`:  `/nix/store/hcfk6l4pa58pygmbm001cxji4p2725jw-haskell-overridez-0.10.3.0`
...
- [[hl1qd23g5aydajr10mcgw3xq5nj45a3r-haskell-overridez-0.10.3.0.tar.gz]]
