...
- **Name**: `haskellPackages.statistics`
- **Version**: `0.16.3.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: A library of statistical types, data, and functions
- **Homepage**: [https://hackage.haskell.org/package/statistics](https://hackage.haskell.org/package/statistics)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/n5ac7h7xdllx269apxayzn9k53hhwd15-statistics-0.16.3.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:635347`
- **Outputs**:
  - `doc`:  `/nix/store/n5ac7h7xdllx269apxayzn9k53hhwd15-statistics-0.16.3.0`
  - `out`:  `/nix/store/n5ac7h7xdllx269apxayzn9k53hhwd15-statistics-0.16.3.0`
...
- [[9hz0hlk09nckygzy1j47czkw4id7j9k4-statistics-0.16.3.0.tar.gz]]
