...
- **Name**: `postgresql14Packages.pg_repack`
- **Version**: `1.5.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Reorganize tables in PostgreSQL databases with minimal locks
- **Homepage**: [https://github.com/reorg/pg_repack](https://github.com/reorg/pg_repack)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/iv269irf947i5dawrnqs22hbcngyq1pf-pg_repack-1.5.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/sql/postgresql/ext/pg_repack.nix:39`
- **Outputs**:
  - `out`:  `/nix/store/iv269irf947i5dawrnqs22hbcngyq1pf-pg_repack-1.5.2`
...
- [[c6z5yr8mw1mr5g3d0j7rvvfacmb63qj8-source]]
