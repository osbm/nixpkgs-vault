...
- **Name**: `rPackages.coalitions`
- **Version**: `0.6.24`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://cran.r-project.org/web/packages/coalitions/](https://cran.r-project.org/web/packages/coalitions/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/q2kzjahdwjgyghqwmfngqjqvjar5icpb-r-coalitions-0.6.24.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/q2kzjahdwjgyghqwmfngqjqvjar5icpb-r-coalitions-0.6.24`
...
- [[k3lxzxbwbfaszg2jdiadavk3y0ni79z3-coalitions_0.6.24.tar.gz]]
