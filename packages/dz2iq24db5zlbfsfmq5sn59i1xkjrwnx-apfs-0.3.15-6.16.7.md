...
- **Name**: `linuxKernel.packages.linux_lqx.apfs`
- **Version**: `0.3.15-6.16.7`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/dz2iq24db5zlbfsfmq5sn59i1xkjrwnx-apfs-0.3.15-6.16.7.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/apfs/default.nix:41`
- **Outputs**:
  - `out`:  `/nix/store/dz2iq24db5zlbfsfmq5sn59i1xkjrwnx-apfs-0.3.15-6.16.7`
