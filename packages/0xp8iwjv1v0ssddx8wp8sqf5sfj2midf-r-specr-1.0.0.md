...
- **Name**: `rPackages.specr`
- **Version**: `1.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/specr/](https://cran.r-project.org/web/packages/specr/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/0xp8iwjv1v0ssddx8wp8sqf5sfj2midf-r-specr-1.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/0xp8iwjv1v0ssddx8wp8sqf5sfj2midf-r-specr-1.0.0`
...
- [[prygar54h8iw3xl1h4k9m2hb4x3s731l-specr_1.0.0.tar.gz]]
