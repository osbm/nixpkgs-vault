...
- **Name**: `haskellPackages.grasp`
- **Version**: `0.1.0.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: GRASP implementation for the AMMM project
- **Homepage**: [https://hackage.haskell.org/package/grasp](https://hackage.haskell.org/package/grasp)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/i8xq30rdg1ihb0qfdgk9j7xw1bwyhl7z-grasp-0.1.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:282900`
- **Outputs**:
  - `doc`:  `/nix/store/i8xq30rdg1ihb0qfdgk9j7xw1bwyhl7z-grasp-0.1.0.0`
  - `out`:  `/nix/store/i8xq30rdg1ihb0qfdgk9j7xw1bwyhl7z-grasp-0.1.0.0`

## 🔗 Dependencies

- [[16s38bv5bwp5kkwcq521hjksd5vsdixw-split-0.2.5]]
- [[1iaw1qwiwcgl183i82i4inwfqxw1hwfz-grasp-0.1.0.0.tar.gz]]
