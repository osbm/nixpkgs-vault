...
- **Name**: `postgresql13Packages.pg_repack`
- **Version**: `1.5.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/5nzb1n2lxnn7x11g2rwxqfnicil90xvk-pg_repack-1.5.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/sql/postgresql/ext/pg_repack.nix:39`
- **Outputs**:
  - `out`:  `/nix/store/5nzb1n2lxnn7x11g2rwxqfnicil90xvk-pg_repack-1.5.2`
