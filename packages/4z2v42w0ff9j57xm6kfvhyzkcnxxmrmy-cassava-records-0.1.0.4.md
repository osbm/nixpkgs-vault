---
aliases:
  - haskellPackages.cassava-records
tags:
  - broken
  - not-available
  - license/unknown
...
- **Name**: `haskellPackages.cassava-records`
- **Version**: `0.1.0.4`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Auto-generation of records data type
- **Homepage**: [https://hackage.haskell.org/package/cassava-records](https://hackage.haskell.org/package/cassava-records)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/4z2v42w0ff9j57xm6kfvhyzkcnxxmrmy-cassava-records-0.1.0.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:132258`
- **Outputs**:
  - `doc`:  `/nix/store/4z2v42w0ff9j57xm6kfvhyzkcnxxmrmy-cassava-records-0.1.0.4`
  - `out`:  `/nix/store/4z2v42w0ff9j57xm6kfvhyzkcnxxmrmy-cassava-records-0.1.0.4`
...
- [[aa4d2ndl79vv374snp2znpkagpymzmmk-cassava-records-0.1.0.4.tar.gz]]
