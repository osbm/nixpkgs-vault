...
- **Name**: `haskellPackages.okapi`
- **Version**: `0.1.0.2`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: A microframework based on monadic parsing
- **Homepage**: [https://hackage.haskell.org/package/okapi](https://hackage.haskell.org/package/okapi)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/rajqc90kvx0dqvj63jrdy4wlchqra1r5-okapi-0.1.0.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:488067`
- **Outputs**:
  - `doc`:  `/nix/store/rajqc90kvx0dqvj63jrdy4wlchqra1r5-okapi-0.1.0.2`
  - `out`:  `/nix/store/rajqc90kvx0dqvj63jrdy4wlchqra1r5-okapi-0.1.0.2`
...
- [[gbkvmbi1kaw83nj1n2ixjfjpc1yzpx7v-okapi-0.1.0.2.tar.gz]]
