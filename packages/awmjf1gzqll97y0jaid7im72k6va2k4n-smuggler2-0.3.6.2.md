...
- **Name**: `haskellPackages.smuggler2`
- **Version**: `0.3.6.2`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: GHC Source Plugin that helps to minimise imports and generate explicit exports
- **Homepage**: [https://hackage.haskell.org/package/smuggler2](https://hackage.haskell.org/package/smuggler2)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/awmjf1gzqll97y0jaid7im72k6va2k4n-smuggler2-0.3.6.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:619263`
- **Outputs**:
  - `doc`:  `/nix/store/awmjf1gzqll97y0jaid7im72k6va2k4n-smuggler2-0.3.6.2`
  - `out`:  `/nix/store/awmjf1gzqll97y0jaid7im72k6va2k4n-smuggler2-0.3.6.2`
...
- [[r3zgymb7wsh4gkiafaacfbw7psd05c8j-smuggler2-0.3.6.2.tar.gz]]
