...
- **Name**: `haskellPackages.bindings-gts`
- **Version**: `0.1.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Low level bindings supporting GTS, the GNU Triangulated Surface Library
- **Homepage**: [https://hackage.haskell.org/package/bindings-gts](https://hackage.haskell.org/package/bindings-gts)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/n69xypbiqp3z2l7f5zxjf7358p56arvi-bindings-gts-0.1.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:105038`
- **Outputs**:
  - `doc`:  `/nix/store/n69xypbiqp3z2l7f5zxjf7358p56arvi-bindings-gts-0.1.1`
  - `out`:  `/nix/store/n69xypbiqp3z2l7f5zxjf7358p56arvi-bindings-gts-0.1.1`
...
- [[8jg9dhrab5q9fhixzw2nbkdbna549vcw-bindings-gts-0.1.1.tar.gz]]
