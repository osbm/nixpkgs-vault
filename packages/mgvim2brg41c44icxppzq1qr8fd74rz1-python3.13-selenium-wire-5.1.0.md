...
- **Name**: `python313Packages.selenium-wire`
- **Version**: `5.1.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Extends Selenium's Python bindings to give you the ability to inspect requests made by the browser
- **Homepage**: [https://github.com/wkeeling/selenium-wire](https://github.com/wkeeling/selenium-wire)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/mgvim2brg41c44icxppzq1qr8fd74rz1-python3.13-selenium-wire-5.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/selenium-wire/default.nix:71`
- **Outputs**:
  - `dist`:  `/nix/store/mgvim2brg41c44icxppzq1qr8fd74rz1-python3.13-selenium-wire-5.1.0`
  - `out`:  `/nix/store/mgvim2brg41c44icxppzq1qr8fd74rz1-python3.13-selenium-wire-5.1.0`
...
- [[fl96g9kwc1wg2a8sylbfn84mh72ljv1n-source]]
