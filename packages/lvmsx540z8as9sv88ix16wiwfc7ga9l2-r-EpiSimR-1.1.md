...
- **Name**: `rPackages.EpiSimR`
- **Version**: `1.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/EpiSimR/](https://cran.r-project.org/web/packages/EpiSimR/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/lvmsx540z8as9sv88ix16wiwfc7ga9l2-r-EpiSimR-1.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/lvmsx540z8as9sv88ix16wiwfc7ga9l2-r-EpiSimR-1.1`

## 🔗 Dependencies

- [[1ilwzfs1cyxqnaq7f4zgl3vr2n0bx7jr-r-shinythemes-1.2.0]]
- [[7p9qj95nrxr1calw15irdg877c4dsc1v-EpiSimR_1.1.tar.gz]]
