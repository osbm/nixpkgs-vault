...
- **Name**: `haskellPackages.adjunctions`
- **Version**: `4.4.3`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Adjunctions and representable functors
- **Homepage**: [https://hackage.haskell.org/package/adjunctions](https://hackage.haskell.org/package/adjunctions)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/74s3xy7kx6ssprfs4zpsn64nijmzrid3-adjunctions-4.4.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:52977`
- **Outputs**:
  - `doc`:  `/nix/store/74s3xy7kx6ssprfs4zpsn64nijmzrid3-adjunctions-4.4.3`
  - `out`:  `/nix/store/74s3xy7kx6ssprfs4zpsn64nijmzrid3-adjunctions-4.4.3`
...
- [[qfiigqlaj2ciqdaprv6dpiqqjik23b0l-adjunctions-4.4.3.tar.gz]]
