...
Full-featured relational database system that lets you run your application logic inside the database
...
- **Homepage**: [https://github.com/clockworklabs/SpacetimeDB](https://github.com/clockworklabs/SpacetimeDB)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/q3x03f4nz2m0ppbplzxrl75xwirnpaps-spacetimedb-1.4.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/sp/spacetimedb/package.nix:53`
- **Outputs**:
  - `out`:  `/nix/store/q3x03f4nz2m0ppbplzxrl75xwirnpaps-spacetimedb-1.4.0`
...
- [[iyagvsnpkyz7y2rx47dg9vmm7avxfzxi-spacetimedb-1.4.0-vendor]]
- [[j5cpr9igriswymy1spmd3pxsji854ihz-source]]
- [[kzbpbfaww8n9jvc27j1gp7hkyd85im49-librusty_v8-137.2.1]]
