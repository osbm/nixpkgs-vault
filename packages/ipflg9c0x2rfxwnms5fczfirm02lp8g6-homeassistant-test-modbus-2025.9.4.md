---
aliases:
  - home-assistant-component-tests.modbus
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.modbus`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/ipflg9c0x2rfxwnms5fczfirm02lp8g6-homeassistant-test-modbus-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/ipflg9c0x2rfxwnms5fczfirm02lp8g6-homeassistant-test-modbus-2025.9.4`
