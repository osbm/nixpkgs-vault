---
aliases:
  - linuxKernel.packages.linux_lqx.corefreq
tags:
  - license/unknown
  - maintainers/mrene
  - outputs/out
...
- **Name**: `linuxKernel.packages.linux_lqx.corefreq`
- **Version**: `2.0.8`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/3f82mkn2dl310vcjqcb7y0alcaahr7ad-corefreq-2.0.8.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/corefreq/default.nix:38`
- **Outputs**:
  - `out`:  `/nix/store/3f82mkn2dl310vcjqcb7y0alcaahr7ad-corefreq-2.0.8`
