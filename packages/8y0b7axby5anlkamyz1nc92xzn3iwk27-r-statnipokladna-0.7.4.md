...
- **Name**: `rPackages.statnipokladna`
- **Version**: `0.7.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/statnipokladna/](https://cran.r-project.org/web/packages/statnipokladna/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/8y0b7axby5anlkamyz1nc92xzn3iwk27-r-statnipokladna-0.7.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/8y0b7axby5anlkamyz1nc92xzn3iwk27-r-statnipokladna-0.7.4`
...
- [[bd07mdp0pwvvymb4pg9injhfbwbml51l-statnipokladna_0.7.4.tar.gz]]
