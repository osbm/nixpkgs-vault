...
- **Name**: `rPackages.usemodels`
- **Version**: `0.2.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/usemodels/](https://cran.r-project.org/web/packages/usemodels/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/ik7gczqbygv78h5qcys7b6nncq2gppd8-r-usemodels-0.2.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/ik7gczqbygv78h5qcys7b6nncq2gppd8-r-usemodels-0.2.0`
...
- [[xkyza12l1z6sj2hvcr6bq2jfpzpfls09-usemodels_0.2.0.tar.gz]]
