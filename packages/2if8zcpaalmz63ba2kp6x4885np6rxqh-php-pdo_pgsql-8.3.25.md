...
- **Name**: `php83Extensions.pdo_pgsql`
- **Version**: `8.3.25`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: PHP upstream extension: pdo_pgsql
...
- **Derivation Path**: `/nix/store/2if8zcpaalmz63ba2kp6x4885np6rxqh-php-pdo_pgsql-8.3.25.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/top-level/php-packages.nix:206`
- **Outputs**:
  - `dev`:  `/nix/store/2if8zcpaalmz63ba2kp6x4885np6rxqh-php-pdo_pgsql-8.3.25`
  - `out`:  `/nix/store/2if8zcpaalmz63ba2kp6x4885np6rxqh-php-pdo_pgsql-8.3.25`
