...
- **Name**: `haskellPackages.jobqueue`
- **Version**: `0.1.6`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: A job queue library
- **Homepage**: [https://hackage.haskell.org/package/jobqueue](https://hackage.haskell.org/package/jobqueue)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/p5g2045s1xjxxckgicmbcqv1wnfd123s-jobqueue-0.1.6.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:390241`
- **Outputs**:
  - `doc`:  `/nix/store/p5g2045s1xjxxckgicmbcqv1wnfd123s-jobqueue-0.1.6`
  - `out`:  `/nix/store/p5g2045s1xjxxckgicmbcqv1wnfd123s-jobqueue-0.1.6`
...
- [[m7jmibdfxafqmqmqna7asnq3n8059h2k-jobqueue-0.1.6.tar.gz]]
