...
- **Name**: `nodePackages_latest.live-server`
- **Version**: `1.2.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/9w5f4lahjqwbp64dx6fankd2s78ygf8m-live-server-1.2.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/node-packages/node-packages.nix:57898`
- **Outputs**:
  - `out`:  `/nix/store/9w5f4lahjqwbp64dx6fankd2s78ygf8m-live-server-1.2.2`
