...
- **Name**: `godotPackages_4_3.export-template`
- **Version**: `4.3-stable`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/123g0wd9xghgnqg9mbmylbj728bq6z1l-godot-template-4.3-stable.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/tools/godot/common.nix:564`
- **Outputs**:
  - `debug`:  `/nix/store/123g0wd9xghgnqg9mbmylbj728bq6z1l-godot-template-4.3-stable`
  - `out`:  `/nix/store/123g0wd9xghgnqg9mbmylbj728bq6z1l-godot-template-4.3-stable`
