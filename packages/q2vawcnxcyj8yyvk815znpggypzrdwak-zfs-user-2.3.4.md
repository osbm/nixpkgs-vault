...
This is the userspace tools package.
...
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: ZFS Filesystem Linux Userspace Tools
...
- **Derivation Path**: `/nix/store/q2vawcnxcyj8yyvk815znpggypzrdwak-zfs-user-2.3.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/zfs/generic.nix:322`
- **Outputs**:
  - `dev`:  `/nix/store/q2vawcnxcyj8yyvk815znpggypzrdwak-zfs-user-2.3.4`
  - `out`:  `/nix/store/q2vawcnxcyj8yyvk815znpggypzrdwak-zfs-user-2.3.4`
...
- [[3c7y05n2m5h9g9ykiv1jgcb5n1xb3cga-source]]
