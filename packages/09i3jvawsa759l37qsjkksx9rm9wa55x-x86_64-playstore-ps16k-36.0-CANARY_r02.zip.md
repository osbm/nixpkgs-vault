---
aliases:
  - androidenv.androidPkgs.all.system-images.CANARY.page_size_16kb.x86_64
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.system-images.CANARY.page_size_16kb.x86_64`
- **Version**: `36.0-CANARY_r02.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/09i3jvawsa759l37qsjkksx9rm9wa55x-x86_64-playstore-ps16k-36.0-CANARY_r02.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/09i3jvawsa759l37qsjkksx9rm9wa55x-x86_64-playstore-ps16k-36.0-CANARY_r02.zip`
