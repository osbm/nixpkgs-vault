...
- **Name**: `rPackages.imageData`
- **Version**: `0.1.64`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/imageData/](https://cran.r-project.org/web/packages/imageData/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/8ic17zs1pcrsiq56azwlryj05z669pxc-r-imageData-0.1.64.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/8ic17zs1pcrsiq56azwlryj05z669pxc-r-imageData-0.1.64`
...
- [[y62l70fbbmkqmmv27cqaj6ncgg10qq9q-imageData_0.1.64.tar.gz]]
