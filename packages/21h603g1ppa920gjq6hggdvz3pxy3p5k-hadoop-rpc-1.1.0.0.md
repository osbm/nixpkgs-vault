...
- **Name**: `haskellPackages.hadoop-rpc`
- **Version**: `1.1.0.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Use the Hadoop RPC interface from Haskell
- **Homepage**: [https://hackage.haskell.org/package/hadoop-rpc](https://hackage.haskell.org/package/hadoop-rpc)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/21h603g1ppa920gjq6hggdvz3pxy3p5k-hadoop-rpc-1.1.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:291900`
- **Outputs**:
  - `doc`:  `/nix/store/21h603g1ppa920gjq6hggdvz3pxy3p5k-hadoop-rpc-1.1.0.0`
  - `out`:  `/nix/store/21h603g1ppa920gjq6hggdvz3pxy3p5k-hadoop-rpc-1.1.0.0`
...
- [[yhlys6fcqq6wsjmzpryizznyf6s43z4z-hadoop-rpc-1.1.0.0.tar.gz]]
