...
- **Name**: `php81Extensions.ctype`
- **Version**: `8.1.33`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: PHP upstream extension: ctype
...
- **Derivation Path**: `/nix/store/i4d0dvcasi3409vi1jvlqhn6b65vdy75-php-ctype-8.1.33.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/top-level/php-packages.nix:206`
- **Outputs**:
  - `dev`:  `/nix/store/i4d0dvcasi3409vi1jvlqhn6b65vdy75-php-ctype-8.1.33`
  - `out`:  `/nix/store/i4d0dvcasi3409vi1jvlqhn6b65vdy75-php-ctype-8.1.33`
