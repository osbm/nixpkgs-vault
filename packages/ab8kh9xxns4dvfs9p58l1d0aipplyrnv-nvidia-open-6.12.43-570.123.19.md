---
aliases:
  - linuxKernel.packages.linux_hardened.nvidia_x11_vulkan_beta_open
tags:
  - license/unknown
  - maintainers/NickCao
  - outputs/out
...
- **Name**: `linuxKernel.packages.linux_hardened.nvidia_x11_vulkan_beta_open`
- **Version**: `6.12.43-570.123.19`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/ab8kh9xxns4dvfs9p58l1d0aipplyrnv-nvidia-open-6.12.43-570.123.19.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/nvidia-x11/open.nix:46`
- **Outputs**:
  - `out`:  `/nix/store/ab8kh9xxns4dvfs9p58l1d0aipplyrnv-nvidia-open-6.12.43-570.123.19`
