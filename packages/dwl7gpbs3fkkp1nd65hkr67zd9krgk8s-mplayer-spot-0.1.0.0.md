...
- **Name**: `haskellPackages.mplayer-spot`
- **Version**: `0.1.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Save your spot when watching movies with @mplayer@
- **Homepage**: [https://hackage.haskell.org/package/mplayer-spot](https://hackage.haskell.org/package/mplayer-spot)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/dwl7gpbs3fkkp1nd65hkr67zd9krgk8s-mplayer-spot-0.1.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:461386`
- **Outputs**:
  - `doc`:  `/nix/store/dwl7gpbs3fkkp1nd65hkr67zd9krgk8s-mplayer-spot-0.1.0.0`
  - `out`:  `/nix/store/dwl7gpbs3fkkp1nd65hkr67zd9krgk8s-mplayer-spot-0.1.0.0`
...
- [[x7nd7p2yw9wyzz654v95rinhc9d8nxdm-mplayer-spot-0.1.0.0.tar.gz]]
