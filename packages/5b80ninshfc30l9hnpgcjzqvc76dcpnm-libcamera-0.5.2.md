...
Open source camera stack and framework for Linux, Android, and ChromeOS
...
- **Homepage**: [https://libcamera.org](https://libcamera.org)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/5b80ninshfc30l9hnpgcjzqvc76dcpnm-libcamera-0.5.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/li/libcamera/package.nix:132`
- **Outputs**:
  - `dev`:  `/nix/store/5b80ninshfc30l9hnpgcjzqvc76dcpnm-libcamera-0.5.2`
  - `out`:  `/nix/store/5b80ninshfc30l9hnpgcjzqvc76dcpnm-libcamera-0.5.2`
...
- [[bs4bzak4svnzij02569cj165i53vk3sd-libcamera]]
...
- `/nix/store/2ryvqnw8g2lcrvij4hqlm1ihflw2x3hd-ipa-priv-key.pem`
