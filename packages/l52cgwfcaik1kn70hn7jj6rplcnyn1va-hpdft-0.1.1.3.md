...
- **Name**: `haskellPackages.hpdft`
- **Version**: `0.1.1.3`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: A tool for looking through PDF file using Haskell
- **Homepage**: [https://hackage.haskell.org/package/hpdft](https://hackage.haskell.org/package/hpdft)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/l52cgwfcaik1kn70hn7jj6rplcnyn1va-hpdft-0.1.1.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:343787`
- **Outputs**:
  - `data`:  `/nix/store/l52cgwfcaik1kn70hn7jj6rplcnyn1va-hpdft-0.1.1.3`
  - `doc`:  `/nix/store/l52cgwfcaik1kn70hn7jj6rplcnyn1va-hpdft-0.1.1.3`
  - `out`:  `/nix/store/l52cgwfcaik1kn70hn7jj6rplcnyn1va-hpdft-0.1.1.3`
...
- [[igcxjclimwkr7phxa215j59103jsx9vm-hpdft-0.1.1.3.tar.gz]]
