...
- **Name**: `haskellPackages.mcp-server`
- **Version**: `0.1.0.14`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Library for building Model Context Protocol (MCP) servers
- **Homepage**: [https://hackage.haskell.org/package/mcp-server](https://hackage.haskell.org/package/mcp-server)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/33f41yhn6bv10jj0vqdgi5bx53hvnjwj-mcp-server-0.1.0.14.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:441470`
- **Outputs**:
  - `doc`:  `/nix/store/33f41yhn6bv10jj0vqdgi5bx53hvnjwj-mcp-server-0.1.0.14`
  - `out`:  `/nix/store/33f41yhn6bv10jj0vqdgi5bx53hvnjwj-mcp-server-0.1.0.14`
...
- [[hdsj5y28pm4xxc001nlnxcdmjch0760a-mcp-server-0.1.0.14.tar.gz]]
