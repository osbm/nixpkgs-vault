...
- **Name**: `rPackages.euroleaguer`
- **Version**: `0.2.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/euroleaguer/](https://cran.r-project.org/web/packages/euroleaguer/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/3h16w69j19lybsdbsmy3kam6y6gyvazb-r-euroleaguer-0.2.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/3h16w69j19lybsdbsmy3kam6y6gyvazb-r-euroleaguer-0.2.0`
...
- [[kg6as0m12p9kbyg74b7cp512h18yh3rm-euroleaguer_0.2.0.tar.gz]]
