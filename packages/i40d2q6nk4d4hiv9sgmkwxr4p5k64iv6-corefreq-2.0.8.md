---
aliases:
  - linuxKernel.packages.linux_zen.corefreq
tags:
  - license/unknown
  - maintainers/mrene
  - outputs/out
...
- **Name**: `linuxKernel.packages.linux_zen.corefreq`
- **Version**: `2.0.8`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/i40d2q6nk4d4hiv9sgmkwxr4p5k64iv6-corefreq-2.0.8.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/corefreq/default.nix:38`
- **Outputs**:
  - `out`:  `/nix/store/i40d2q6nk4d4hiv9sgmkwxr4p5k64iv6-corefreq-2.0.8`
