...
- **Name**: `home-assistant-component-tests.evohome`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/563gy3pd90k30h5qn6sqqyf9f5sd4hki-homeassistant-test-evohome-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/563gy3pd90k30h5qn6sqqyf9f5sd4hki-homeassistant-test-evohome-2025.9.4`
...
- [[bjkklfdx2f99vc7d6x9md83fm62rxlaa-python3.13-evohome-async-1.0.5]]
