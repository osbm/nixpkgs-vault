...
- **Name**: `rPackages.cleaner`
- **Version**: `1.5.5`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/cleaner/](https://cran.r-project.org/web/packages/cleaner/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/as7rx9fl09xk8nh5gpw2pyjg6fxk3vql-r-cleaner-1.5.5.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/as7rx9fl09xk8nh5gpw2pyjg6fxk3vql-r-cleaner-1.5.5`

## 🔗 Dependencies

- [[8zaqw52z32d808wvq94h0vm56ggcpcyl-cleaner_1.5.5.tar.gz]]
