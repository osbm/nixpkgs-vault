---
aliases:
  - androidenv.androidPkgs.all.system-images.v35.page_size_16kb.x86_64
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.system-images.v35.page_size_16kb.x86_64`
- **Version**: `35_r05.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/h1qbxkb14j7495ag8sr5hr5xz2rrhyfz-x86_64-playstore-ps16k-35_r05.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/h1qbxkb14j7495ag8sr5hr5xz2rrhyfz-x86_64-playstore-ps16k-35_r05.zip`
