...
- **Name**: `python313Packages.mozart-api`
- **Version**: `4.1.1.116.6`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: REST API for the Bang & Olufsen Mozart platform
- **Homepage**: [https://github.com/bang-olufsen/mozart-open-api](https://github.com/bang-olufsen/mozart-open-api)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/49fz2qwsrkxlrkhhspcb3b1x5wbabq6c-python3.13-mozart-api-4.1.1.116.6.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/mozart-api/default.nix:53`
- **Outputs**:
  - `dist`:  `/nix/store/49fz2qwsrkxlrkhhspcb3b1x5wbabq6c-python3.13-mozart-api-4.1.1.116.6`
  - `out`:  `/nix/store/49fz2qwsrkxlrkhhspcb3b1x5wbabq6c-python3.13-mozart-api-4.1.1.116.6`
...
- [[6lwa46klk7ly7wxszjfmccy7pg1bw9v5-mozart_api-4.1.1.116.6.tar.gz]]
...
- [[nhl0z78w9dqz9dn4gnprqgf55pjrikhz-python3.13-aioconsole-0.8.1]]
