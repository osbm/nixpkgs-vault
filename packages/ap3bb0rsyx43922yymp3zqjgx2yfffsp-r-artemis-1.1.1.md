...
- **Name**: `rPackages.artemis`
- **Version**: `1.1.1`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://cran.r-project.org/web/packages/artemis/](https://cran.r-project.org/web/packages/artemis/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/ap3bb0rsyx43922yymp3zqjgx2yfffsp-r-artemis-1.1.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/ap3bb0rsyx43922yymp3zqjgx2yfffsp-r-artemis-1.1.1`
...
- [[z2v0ghlq7kz54p99gx52wp9g6jp1v9kw-artemis_1.1.1.tar.gz]]
