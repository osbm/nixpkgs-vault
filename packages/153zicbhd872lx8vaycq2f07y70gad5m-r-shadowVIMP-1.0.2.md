...
- **Name**: `rPackages.shadowVIMP`
- **Version**: `1.0.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/shadowVIMP/](https://cran.r-project.org/web/packages/shadowVIMP/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/153zicbhd872lx8vaycq2f07y70gad5m-r-shadowVIMP-1.0.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/153zicbhd872lx8vaycq2f07y70gad5m-r-shadowVIMP-1.0.2`
...
- [[yagdxyh9s94sa3a1wsp1mvdvnphnlji1-shadowVIMP_1.0.2.tar.gz]]
