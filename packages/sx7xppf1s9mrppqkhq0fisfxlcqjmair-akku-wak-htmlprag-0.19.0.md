...
- **Name**: `akkuPackages.wak-htmlprag`
- **Version**: `0.19.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: pragmatic parsing and emitting of HTML using SXML and SHTML
- **Homepage**: []()
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/sx7xppf1s9mrppqkhq0fisfxlcqjmair-akku-wak-htmlprag-0.19.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/tools/package-management/akku/default.nix:39`
- **Outputs**:
  - `out`:  `/nix/store/sx7xppf1s9mrppqkhq0fisfxlcqjmair-akku-wak-htmlprag-0.19.0`
...
- [[l1b9vr005mbrkix301himx122d5sww4l-akku-wak-testeez-0.2.0]]
- [[nfdk7ijxi682sfc9sff5y7rva027sn07-wak-htmlprag_0.19.0_repack.tar.xz]]
