---
aliases:
  - home-assistant-component-tests.frontend
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.frontend`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/immksmi2s01jznd9adh9nynrzv6gvjjp-homeassistant-test-frontend-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/immksmi2s01jznd9adh9nynrzv6gvjjp-homeassistant-test-frontend-2025.9.4`
