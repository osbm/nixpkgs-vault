---
aliases:
  - home-assistant-component-tests.weather
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.weather`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/vznhld41pr3dk3aqzm0rz5gqqzblfsr9-homeassistant-test-weather-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/vznhld41pr3dk3aqzm0rz5gqqzblfsr9-homeassistant-test-weather-2025.9.4`
