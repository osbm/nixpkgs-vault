...
- **Name**: `python312Packages.python-qt`
- **Version**: `3.6.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/1sqcgi4qnn8dk48gfw3kjzf3asmpsrzs-python-qt-3.6.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/libraries/python-qt/default.nix:60`
- **Outputs**:
  - `out`:  `/nix/store/1sqcgi4qnn8dk48gfw3kjzf3asmpsrzs-python-qt-3.6.1`
