---
aliases:
  - haskellPackages.snaplet-auth-acid
tags:
  - license/unknown
  - outputs/doc
  - outputs/out
...
- **Name**: `haskellPackages.snaplet-auth-acid`
- **Version**: `0.1.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Provides an Acid-State backend for the Auth Snaplet
- **Homepage**: [https://hackage.haskell.org/package/snaplet-auth-acid](https://hackage.haskell.org/package/snaplet-auth-acid)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/0swwwyb2rrc2zd7xwvgivsv0i6ab8n78-snaplet-auth-acid-0.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:620682`
- **Outputs**:
  - `doc`:  `/nix/store/0swwwyb2rrc2zd7xwvgivsv0i6ab8n78-snaplet-auth-acid-0.1.0`
  - `out`:  `/nix/store/0swwwyb2rrc2zd7xwvgivsv0i6ab8n78-snaplet-auth-acid-0.1.0`

## 🔗 Dependencies

- [[17lgi1x4scm6kwyv3ajwifcbcsjc6w93-snap-core-1.0.5.1]]
- [[406abajvpi9x7j81ynyyj6pj03qbkjw7-snaplet-auth-acid-0.1.0.tar.gz]]
