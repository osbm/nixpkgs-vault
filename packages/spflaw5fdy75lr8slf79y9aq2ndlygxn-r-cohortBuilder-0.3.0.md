...
- **Name**: `rPackages.cohortBuilder`
- **Version**: `0.3.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/cohortBuilder/](https://cran.r-project.org/web/packages/cohortBuilder/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/spflaw5fdy75lr8slf79y9aq2ndlygxn-r-cohortBuilder-0.3.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/spflaw5fdy75lr8slf79y9aq2ndlygxn-r-cohortBuilder-0.3.0`
...
- [[9xplw5q6p4ivl5piymfssl6a9sv8h0z1-cohortBuilder_0.3.0.tar.gz]]
