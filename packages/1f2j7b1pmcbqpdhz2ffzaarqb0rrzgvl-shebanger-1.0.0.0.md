...
- **Name**: `haskellPackages.shebanger`
- **Version**: `1.0.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Transform a shell script into a series of scripts with only shebang lines
- **Homepage**: [https://hackage.haskell.org/package/shebanger](https://hackage.haskell.org/package/shebanger)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/1f2j7b1pmcbqpdhz2ffzaarqb0rrzgvl-shebanger-1.0.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:607577`
- **Outputs**:
  - `doc`:  `/nix/store/1f2j7b1pmcbqpdhz2ffzaarqb0rrzgvl-shebanger-1.0.0.0`
  - `out`:  `/nix/store/1f2j7b1pmcbqpdhz2ffzaarqb0rrzgvl-shebanger-1.0.0.0`
...
- [[hm5r13vdyx0y0j8bia5gzpy689209zyb-shebanger-1.0.0.0.tar.gz]]
