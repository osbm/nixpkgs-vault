---
aliases:
  - haskellPackages.snaplet-sqlite-simple
tags:
  - broken
  - not-available
  - license/unknown
...
- **Name**: `haskellPackages.snaplet-sqlite-simple`
- **Version**: `1.0.0.2`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: sqlite-simple snaplet for the Snap Framework
- **Homepage**: [https://hackage.haskell.org/package/snaplet-sqlite-simple](https://hackage.haskell.org/package/snaplet-sqlite-simple)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/8mxqzqkpfziqgzksqkrvqqdmqzziwxqi-snaplet-sqlite-simple-1.0.0.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:622070`
- **Outputs**:
  - `data`:  `/nix/store/8mxqzqkpfziqgzksqkrvqqdmqzziwxqi-snaplet-sqlite-simple-1.0.0.2`
  - `doc`:  `/nix/store/8mxqzqkpfziqgzksqkrvqqdmqzziwxqi-snaplet-sqlite-simple-1.0.0.2`
  - `out`:  `/nix/store/8mxqzqkpfziqgzksqkrvqqdmqzziwxqi-snaplet-sqlite-simple-1.0.0.2`
...
- [[k40c05x9kr7hq2ml7xp60g00gxmvpj0i-direct-sqlite-2.3.29]]
- [[kf160skfwpf98c6iibz31l21j51kidf8-test-framework-0.8.2.2]]
- [[l1ya8rcgk405jscx6136q18v70r0lamx-ghc-9.8.4]]
- [[p76r0cwlf6k97ibprrpfd8xw0r8wc3nx-stdenv-linux]]
- [[xpqbgvchb12jsk6ya8y3i9x50fimn9qp-snaplet-sqlite-simple-1.0.0.2-r1.cabal]]
- [[zzf7qldljxk2hjsqx4qfawsgj5npfr7f-snaplet-sqlite-simple-1.0.0.2.tar.gz]]
