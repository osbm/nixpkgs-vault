...
- **Name**: `haskellPackages.hprox`
- **Version**: `0.6.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: a lightweight HTTP proxy server, and more
- **Homepage**: [https://hackage.haskell.org/package/hprox](https://hackage.haskell.org/package/hprox)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/n4l1jr9vpdkxcpxz9wc59wi2xyspbi6q-hprox-0.6.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:344532`
- **Outputs**:
  - `doc`:  `/nix/store/n4l1jr9vpdkxcpxz9wc59wi2xyspbi6q-hprox-0.6.4`
  - `out`:  `/nix/store/n4l1jr9vpdkxcpxz9wc59wi2xyspbi6q-hprox-0.6.4`
...
- [[sh5ilh2aplj7gblwbs5q1x4xhkfya14i-hprox-0.6.4.tar.gz]]
