...
- **Name**: `rPackages.TarSeqQC`
- **Version**: `1.0.3`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://bioconductor.org/packages/3.21/bioc/html/TarSeqQC.html](https://bioconductor.org/packages/3.21/bioc/html/TarSeqQC.html)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/rmpbsydc0a5ylw419f5fswq8s2g3zl7x-r-TarSeqQC-1.0.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/rmpbsydc0a5ylw419f5fswq8s2g3zl7x-r-TarSeqQC-1.0.3`
...
- [[fdmy1dkxmbdlvr9dyc1lshn9ji8x2b57-TarSeqQC_1.0.3.tar.gz]]
