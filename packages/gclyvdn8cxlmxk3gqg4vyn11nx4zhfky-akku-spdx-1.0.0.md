...
SPDX license expressions and such

## 📋 Package Information

- **Name**: `akkuPackages.spdx`
- **Version**: `1.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: SPDX license expressions and such
- **Homepage**: []()
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/gclyvdn8cxlmxk3gqg4vyn11nx4zhfky-akku-spdx-1.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/tools/package-management/akku/default.nix:39`
- **Outputs**:
  - `out`:  `/nix/store/gclyvdn8cxlmxk3gqg4vyn11nx4zhfky-akku-spdx-1.0.0`
...
- [[vqn5vbqg21c3j6a2a0k340zvjpdiniri-spdx_1.0.0_repack.tar.xz]]
