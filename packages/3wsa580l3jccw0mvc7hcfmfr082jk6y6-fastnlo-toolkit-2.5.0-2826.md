---
aliases:
  - python313Packages.fastnlo-toolkit
tags:
  - license/unknown
  - maintainers/veprbl
  - outputs/out
...
- **Name**: `python313Packages.fastnlo-toolkit`
- **Version**: `2.5.0-2826`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/3wsa580l3jccw0mvc7hcfmfr082jk6y6-fastnlo-toolkit-2.5.0-2826.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/fa/fastnlo-toolkit/package.nix:93`
- **Outputs**:
  - `out`:  `/nix/store/3wsa580l3jccw0mvc7hcfmfr082jk6y6-fastnlo-toolkit-2.5.0-2826`
