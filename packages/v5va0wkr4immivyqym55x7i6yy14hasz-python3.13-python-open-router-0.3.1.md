---
aliases:
  - python313Packages.python-open-router
tags:
  - license/unknown
...
- **Name**: `python313Packages.python-open-router`
- **Version**: `0.3.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/v5va0wkr4immivyqym55x7i6yy14hasz-python3.13-python-open-router-0.3.1.drv`
...
- **Outputs**:
  - `dist`:  `/nix/store/v5va0wkr4immivyqym55x7i6yy14hasz-python3.13-python-open-router-0.3.1`
  - `out`:  `/nix/store/v5va0wkr4immivyqym55x7i6yy14hasz-python3.13-python-open-router-0.3.1`
