...
- **Name**: `rPackages.concordance`
- **Version**: `2.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/concordance/](https://cran.r-project.org/web/packages/concordance/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/m03vqm4jrqii6v8yp13qk0y485m3allr-r-concordance-2.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/m03vqm4jrqii6v8yp13qk0y485m3allr-r-concordance-2.0.0`

## 🔗 Dependencies

- [[0q8w3cv8b5rdaqb0m2dw9h09536i2gn6-concordance_2.0.0.tar.gz]]
