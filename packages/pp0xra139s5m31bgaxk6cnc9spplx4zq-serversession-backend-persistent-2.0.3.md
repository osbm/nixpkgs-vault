---
aliases:
  - haskellPackages.serversession-backend-persistent
tags:
  - broken
  - not-available
  - license/unknown
...
- **Name**: `haskellPackages.serversession-backend-persistent`
- **Version**: `2.0.3`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Storage backend for serversession using persistent and an RDBMS
- **Homepage**: [https://hackage.haskell.org/package/serversession-backend-persistent](https://hackage.haskell.org/package/serversession-backend-persistent)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/pp0xra139s5m31bgaxk6cnc9spplx4zq-serversession-backend-persistent-2.0.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:603753`
- **Outputs**:
  - `doc`:  `/nix/store/pp0xra139s5m31bgaxk6cnc9spplx4zq-serversession-backend-persistent-2.0.3`
  - `out`:  `/nix/store/pp0xra139s5m31bgaxk6cnc9spplx4zq-serversession-backend-persistent-2.0.3`

## 🔗 Dependencies

- [[3jxrk545s79pml3iacvh5vxq4rv4hcy7-serversession-backend-persistent-2.0.3.tar.gz]]
...
- [[hs7rvsbffv85r4w14rwdvhj0f1v08qli-serversession-1.0.3]]
