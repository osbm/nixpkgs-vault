...
- **Name**: `haskellPackages.hstorchat`
- **Version**: `0.1.1.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Distributed instant messaging over Tor
- **Homepage**: [https://hackage.haskell.org/package/hstorchat](https://hackage.haskell.org/package/hstorchat)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/pdvrp9lwwj2j46xsr551shw3nkr6iv59-hstorchat-0.1.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:357907`
- **Outputs**:
  - `data`:  `/nix/store/pdvrp9lwwj2j46xsr551shw3nkr6iv59-hstorchat-0.1.1.0`
  - `doc`:  `/nix/store/pdvrp9lwwj2j46xsr551shw3nkr6iv59-hstorchat-0.1.1.0`
  - `out`:  `/nix/store/pdvrp9lwwj2j46xsr551shw3nkr6iv59-hstorchat-0.1.1.0`

## 🔗 Dependencies

- [[0bajmj25m5f59n1z1z1zbqdidcq323nv-hstorchat-0.1.1.0.tar.gz]]
