...
- **Name**: `haskellPackages.twilio`
- **Version**: `0.3.0.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Twilio REST API library for Haskell
- **Homepage**: [https://hackage.haskell.org/package/twilio](https://hackage.haskell.org/package/twilio)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/aagmh8fv27as2bjgpgrm1hw7yyvd25zd-twilio-0.3.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:688166`
- **Outputs**:
  - `doc`:  `/nix/store/aagmh8fv27as2bjgpgrm1hw7yyvd25zd-twilio-0.3.0.0`
  - `out`:  `/nix/store/aagmh8fv27as2bjgpgrm1hw7yyvd25zd-twilio-0.3.0.0`
...
- [[m75wsxn8vgjd0w8p2459ivbf23lc0mdl-twilio-0.3.0.0.tar.gz]]
