...
- **Name**: `rPackages.DHS_rates`
- **Version**: `0.9.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/DHS.rates/](https://cran.r-project.org/web/packages/DHS.rates/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/05vvwk3pln678z0mh1fwpr7hwx06dq0m-r-DHS.rates-0.9.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/05vvwk3pln678z0mh1fwpr7hwx06dq0m-r-DHS.rates-0.9.2`

## 🔗 Dependencies

- [[4n2bmgg60cyil90jny7gw8ml03sqgm5y-DHS.rates_0.9.2.tar.gz]]
