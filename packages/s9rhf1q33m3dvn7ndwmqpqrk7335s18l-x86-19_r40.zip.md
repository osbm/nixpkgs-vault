---
aliases:
  - androidenv.androidPkgs.all.system-images.v19.google_apis.x86
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.system-images.v19.google_apis.x86`
- **Version**: `19_r40.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/s9rhf1q33m3dvn7ndwmqpqrk7335s18l-x86-19_r40.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/s9rhf1q33m3dvn7ndwmqpqrk7335s18l-x86-19_r40.zip`
