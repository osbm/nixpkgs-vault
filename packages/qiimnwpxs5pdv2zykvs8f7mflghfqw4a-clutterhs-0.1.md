...
- **Name**: `haskellPackages.clutterhs`
- **Version**: `0.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Bindings to the Clutter animation library
- **Homepage**: [https://hackage.haskell.org/package/clutterhs](https://hackage.haskell.org/package/clutterhs)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/qiimnwpxs5pdv2zykvs8f7mflghfqw4a-clutterhs-0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:146250`
- **Outputs**:
  - `doc`:  `/nix/store/qiimnwpxs5pdv2zykvs8f7mflghfqw4a-clutterhs-0.1`
  - `out`:  `/nix/store/qiimnwpxs5pdv2zykvs8f7mflghfqw4a-clutterhs-0.1`
...
- [[my0k1pvz902714famhln9037xfln3aap-clutterhs-0.1.tar.gz]]
