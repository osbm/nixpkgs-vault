...
- **Name**: `python313Packages.langchain-openai`
- **Version**: `0.3.28`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Integration package connecting OpenAI and LangChain
- **Homepage**: [https://github.com/langchain-ai/langchain/tree/master/libs/partners/openai](https://github.com/langchain-ai/langchain/tree/master/libs/partners/openai)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/by0izg3ljihsv0c535nx9w0izcyslpax-python3.13-langchain-openai-0.3.28.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/langchain-openai/default.nix:115`
- **Outputs**:
  - `dist`:  `/nix/store/by0izg3ljihsv0c535nx9w0izcyslpax-python3.13-langchain-openai-0.3.28`
  - `out`:  `/nix/store/by0izg3ljihsv0c535nx9w0izcyslpax-python3.13-langchain-openai-0.3.28`
...
- [[jyssa6x8qqycmmh2xz1nkf1qzz6glpqp-source]]
...
---
*Generated on 2025-09-27 12:46:17 UTC*
