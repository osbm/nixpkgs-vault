...
- **Name**: `rPackages.DIETCOST`
- **Version**: `1.0.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/DIETCOST/](https://cran.r-project.org/web/packages/DIETCOST/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/pkqiy96qmcgwnfw7czcx2pnpiy46zpj3-r-DIETCOST-1.0.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/pkqiy96qmcgwnfw7czcx2pnpiy46zpj3-r-DIETCOST-1.0.0.0`

## 🔗 Dependencies

- [[3f8n9gfa8d7ay5sixww3x88fg6vxvhfg-r-magrittr-2.0.3]]
- [[bjsb6wdjykafnkixq156qdvmxhsm2bai-bash-5.3p3]]
- [[dfw4s3c2hw9nw6piis2w6d30qjhljw8m-DIETCOST_1.0.0.0.tar.gz]]
