...
- **Name**: `haskellPackages.simfin`
- **Version**: `1.0.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: A library to fetch and parse financial data from the SimFin(+) API
- **Homepage**: [https://hackage.haskell.org/package/simfin](https://hackage.haskell.org/package/simfin)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/57cf2k3f8d7p8c6lckn5myxk4fvvid1s-simfin-1.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:610597`
- **Outputs**:
  - `doc`:  `/nix/store/57cf2k3f8d7p8c6lckn5myxk4fvvid1s-simfin-1.0.0`
  - `out`:  `/nix/store/57cf2k3f8d7p8c6lckn5myxk4fvvid1s-simfin-1.0.0`

## 🔗 Dependencies

- [[2pr652igq6awvbbf5rfnb3kbrmg1cryf-http-types-0.12.4]]
- [[336j443c8x9nbg5p92lb5ycv00g4mzhn-multi-containers-0.2]]
...
- [[ikiilixglhvafmljdynxzrrbyd6nzcr6-composition-extra-2.1.0]]
- [[k5pcnc5drxzvy63j38vpm5xw9j0rwrgd-simfin-1.0.0.tar.gz]]
