...
- **Name**: `haskellPackages.changelogged`
- **Version**: `0.2.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Changelog manager for Git projects
- **Homepage**: [https://hackage.haskell.org/package/changelogged](https://hackage.haskell.org/package/changelogged)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/5avb1dima848v4acrv7a0a9v2pl1a9ma-changelogged-0.2.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:135824`
- **Outputs**:
  - `doc`:  `/nix/store/5avb1dima848v4acrv7a0a9v2pl1a9ma-changelogged-0.2.0`
  - `out`:  `/nix/store/5avb1dima848v4acrv7a0a9v2pl1a9ma-changelogged-0.2.0`
...
- [[h2m8bxpqda5mjfan6i1lj2qw7yy3f5b8-changelogged-0.2.0-r1.cabal]]
...
- [[j02lmpp09hhr54jl1b7fnhflisjqliwx-changelogged-0.2.0.tar.gz]]
