...
- **Name**: `rPackages.TreeDist`
- **Version**: `2.9.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/TreeDist/](https://cran.r-project.org/web/packages/TreeDist/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/snz435lmmpqnggrdns0p8bl9v8r2s6ji-r-TreeDist-2.9.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/snz435lmmpqnggrdns0p8bl9v8r2s6ji-r-TreeDist-2.9.2`

## 🔗 Dependencies

- [[386i5algdy8gdxfznfa64p8mh0s651xb-r-Rcpp-1.1.0]]
- [[5c4jbadm510aph4kj3pqjbg2wgli6nnb-TreeDist_2.9.2.tar.gz]]
