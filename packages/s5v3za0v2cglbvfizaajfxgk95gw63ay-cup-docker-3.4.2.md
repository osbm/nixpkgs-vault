...
- **Derivation Path**: `/nix/store/s5v3za0v2cglbvfizaajfxgk95gw63ay-cup-docker-3.4.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/cu/cup-docker/package.nix:87`
- **Outputs**:
  - `out`:  `/nix/store/s5v3za0v2cglbvfizaajfxgk95gw63ay-cup-docker-3.4.2`
