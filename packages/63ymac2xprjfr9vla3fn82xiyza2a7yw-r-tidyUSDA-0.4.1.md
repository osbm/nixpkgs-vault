...
- **Name**: `rPackages.tidyUSDA`
- **Version**: `0.4.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/tidyUSDA/](https://cran.r-project.org/web/packages/tidyUSDA/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/63ymac2xprjfr9vla3fn82xiyza2a7yw-r-tidyUSDA-0.4.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/63ymac2xprjfr9vla3fn82xiyza2a7yw-r-tidyUSDA-0.4.1`
...
- [[is8953hajxqparmmg63pjvb3a5w4ycyf-tidyUSDA_0.4.1.tar.gz]]
