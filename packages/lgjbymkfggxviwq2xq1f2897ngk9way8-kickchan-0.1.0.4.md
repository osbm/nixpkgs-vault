...
- **Name**: `haskellPackages.kickchan`
- **Version**: `0.1.0.4`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Kick Channels: bounded channels with non-blocking writes
- **Homepage**: [https://hackage.haskell.org/package/kickchan](https://hackage.haskell.org/package/kickchan)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/lgjbymkfggxviwq2xq1f2897ngk9way8-kickchan-0.1.0.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:401208`
- **Outputs**:
  - `doc`:  `/nix/store/lgjbymkfggxviwq2xq1f2897ngk9way8-kickchan-0.1.0.4`
  - `out`:  `/nix/store/lgjbymkfggxviwq2xq1f2897ngk9way8-kickchan-0.1.0.4`

## 🔗 Dependencies

- [[0y7fran8yynsyhbwn81z8b2bl71bd9lj-kickchan-0.1.0.4.tar.gz]]
