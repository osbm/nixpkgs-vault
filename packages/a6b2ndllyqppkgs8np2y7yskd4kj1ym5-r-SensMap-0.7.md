...
- **Name**: `rPackages.SensMap`
- **Version**: `0.7`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/SensMap/](https://cran.r-project.org/web/packages/SensMap/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/a6b2ndllyqppkgs8np2y7yskd4kj1ym5-r-SensMap-0.7.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/a6b2ndllyqppkgs8np2y7yskd4kj1ym5-r-SensMap-0.7`
...
- [[s5lf7is4lbbyj0ghsz2838ciiwy9dpa2-SensMap_0.7.tar.gz]]
