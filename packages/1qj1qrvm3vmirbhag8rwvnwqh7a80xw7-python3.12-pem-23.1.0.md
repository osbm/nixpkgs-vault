...
- **Name**: `python312Packages.pem`
- **Version**: `23.1.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Easy PEM file parsing in Python
- **Homepage**: [https://pem.readthedocs.io/](https://pem.readthedocs.io/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/1qj1qrvm3vmirbhag8rwvnwqh7a80xw7-python3.12-pem-23.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/pem/default.nix:50`
- **Outputs**:
  - `dist`:  `/nix/store/1qj1qrvm3vmirbhag8rwvnwqh7a80xw7-python3.12-pem-23.1.0`
  - `out`:  `/nix/store/1qj1qrvm3vmirbhag8rwvnwqh7a80xw7-python3.12-pem-23.1.0`
...
- [[yv1d11ih0cp54aa5gxyq3dianx7d4r4g-source]]
