...
- **Name**: `haskellPackages.gi-gstbase`
- **Version**: `1.0.29`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: GStreamerBase bindings
- **Homepage**: [https://hackage.haskell.org/package/gi-gstbase](https://hackage.haskell.org/package/gi-gstbase)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/6fp7wn9yb01kzcbxlal2hd22bknbs5w8-gi-gstbase-1.0.29.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:265270`
- **Outputs**:
  - `doc`:  `/nix/store/6fp7wn9yb01kzcbxlal2hd22bknbs5w8-gi-gstbase-1.0.29`
  - `out`:  `/nix/store/6fp7wn9yb01kzcbxlal2hd22bknbs5w8-gi-gstbase-1.0.29`
...
- [[b64s4vs0438v6vdcjsjx0iasv5n7fc8m-gi-gstbase-1.0.29.tar.gz]]
