...
- **Name**: `perl540Packages.PlackMiddlewareSession`
- **Version**: `0.33`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/8baq4hh4lp9yg2nr425ljj2dnmicly70-perl5.40.0-Plack-Middleware-Session-0.33.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/top-level/perl-packages.nix:28384`
- **Outputs**:
  - `devdoc`:  `/nix/store/8baq4hh4lp9yg2nr425ljj2dnmicly70-perl5.40.0-Plack-Middleware-Session-0.33`
  - `out`:  `/nix/store/8baq4hh4lp9yg2nr425ljj2dnmicly70-perl5.40.0-Plack-Middleware-Session-0.33`
