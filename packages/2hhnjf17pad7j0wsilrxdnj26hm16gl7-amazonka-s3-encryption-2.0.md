---
aliases:
  - haskellPackages.amazonka-s3-encryption
tags:
  - broken
  - not-available
  - license/unknown
...
- **Name**: `haskellPackages.amazonka-s3-encryption`
- **Version**: `2.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Amazon Simple Storage Service SDK - Client-Side Encryption
- **Homepage**: [https://hackage.haskell.org/package/amazonka-s3-encryption](https://hackage.haskell.org/package/amazonka-s3-encryption)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/2hhnjf17pad7j0wsilrxdnj26hm16gl7-amazonka-s3-encryption-2.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:71933`
- **Outputs**:
  - `doc`:  `/nix/store/2hhnjf17pad7j0wsilrxdnj26hm16gl7-amazonka-s3-encryption-2.0`
  - `out`:  `/nix/store/2hhnjf17pad7j0wsilrxdnj26hm16gl7-amazonka-s3-encryption-2.0`
