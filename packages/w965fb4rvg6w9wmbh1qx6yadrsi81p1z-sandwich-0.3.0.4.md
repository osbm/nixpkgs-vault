...
- **Name**: `haskellPackages.sandwich`
- **Version**: `0.3.0.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Yet another test framework for Haskell
- **Homepage**: [https://hackage.haskell.org/package/sandwich](https://hackage.haskell.org/package/sandwich)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/w965fb4rvg6w9wmbh1qx6yadrsi81p1z-sandwich-0.3.0.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:584784`
- **Outputs**:
  - `doc`:  `/nix/store/w965fb4rvg6w9wmbh1qx6yadrsi81p1z-sandwich-0.3.0.4`
  - `out`:  `/nix/store/w965fb4rvg6w9wmbh1qx6yadrsi81p1z-sandwich-0.3.0.4`

## 🔗 Dependencies

- [[0k5rh32cb0cndb1ajysa19695mldasjb-sandwich-0.3.0.4.tar.gz]]
