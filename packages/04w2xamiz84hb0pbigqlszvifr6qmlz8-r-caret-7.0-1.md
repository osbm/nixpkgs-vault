...
- **Name**: `rPackages.caret`
- **Version**: `7.0-1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/caret/](https://cran.r-project.org/web/packages/caret/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/04w2xamiz84hb0pbigqlszvifr6qmlz8-r-caret-7.0-1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/04w2xamiz84hb0pbigqlszvifr6qmlz8-r-caret-7.0-1`
...
- [[pazbq08glm2zy04d8sd3n7b7xw1i27zm-caret_7.0-1.tar.gz]]
