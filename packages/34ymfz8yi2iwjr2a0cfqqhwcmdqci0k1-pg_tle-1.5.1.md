...
- **Name**: `postgresql18Packages.pg_tle`
- **Version**: `1.5.1`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
...
- **Derivation Path**: `/nix/store/34ymfz8yi2iwjr2a0cfqqhwcmdqci0k1-pg_tle-1.5.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/sql/postgresql/ext/pg_tle.nix:27`
- **Outputs**:
  - `out`:  `/nix/store/34ymfz8yi2iwjr2a0cfqqhwcmdqci0k1-pg_tle-1.5.1`
