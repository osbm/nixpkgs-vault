...
A portable and efficient R[4567]RS implementation of regular expressions, supporting both POSIX syntax with various (irregular) PCRE extensions, as well as SCSH's SRE syntax

## 📋 Package Information

- **Name**: `akkuPackages.chibi-irregex`
- **Version**: `0.9.3`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/rnw1p40dvdj43i7sbfn14xxw4xvq1jl1-akku-chibi-irregex-0.9.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/tools/package-management/akku/default.nix:39`
- **Outputs**:
  - `out`:  `/nix/store/rnw1p40dvdj43i7sbfn14xxw4xvq1jl1-akku-chibi-irregex-0.9.3`
...
- [[kjf87a4fwkg4kifja9igmwiq2xmi3501-chibi-irregex-0.9.3.tgz]]
