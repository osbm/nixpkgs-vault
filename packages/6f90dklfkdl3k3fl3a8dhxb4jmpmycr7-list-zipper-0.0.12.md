...
- **Name**: `haskellPackages.list-zipper`
- **Version**: `0.0.12`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: A list zipper
- **Homepage**: [https://hackage.haskell.org/package/list-zipper](https://hackage.haskell.org/package/list-zipper)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/6f90dklfkdl3k3fl3a8dhxb4jmpmycr7-list-zipper-0.0.12.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:423742`
- **Outputs**:
  - `doc`:  `/nix/store/6f90dklfkdl3k3fl3a8dhxb4jmpmycr7-list-zipper-0.0.12`
  - `out`:  `/nix/store/6f90dklfkdl3k3fl3a8dhxb4jmpmycr7-list-zipper-0.0.12`

## 🔗 Dependencies

- [[29n6idwysci20lbjipn1a5i22x44n2z7-list-zipper-0.0.12.tar.gz]]
