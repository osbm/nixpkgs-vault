...
Simple git wrapper that waits until index.lock file is removed when present before running the command
...
- **Homepage**: [https://github.com/darshanparajuli/git-wait](https://github.com/darshanparajuli/git-wait)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/9m5snclh04ay34yvk83n5v04fcq30150-git-wait-0.4.0-unstable-2024-12-01.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/gi/git-wait/package.nix:44`
- **Outputs**:
  - `out`:  `/nix/store/9m5snclh04ay34yvk83n5v04fcq30150-git-wait-0.4.0-unstable-2024-12-01`
...
- [[j3wsfdfqblajkr08247gqwsgn60nxq1y-git-wait-0.4.0-unstable-2024-12-01-vendor]]
- [[l45n6h2sj3zydandi6hy64b21lkx1iaf-source]]
