...
Library to control Ledger devices

## 📋 Package Information

- **Name**: `python312Packages.ledgerwallet`
- **Version**: `0.5.3`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Library to control Ledger devices
- **Homepage**: [https://github.com/LedgerHQ/ledgerctl](https://github.com/LedgerHQ/ledgerctl)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/0wc46b7yx6qa4lr4xpzmzx4bsswil50i-python3.12-ledgerwallet-0.5.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/ledgerwallet/default.nix:65`
- **Outputs**:
  - `dist`:  `/nix/store/0wc46b7yx6qa4lr4xpzmzx4bsswil50i-python3.12-ledgerwallet-0.5.3`
  - `out`:  `/nix/store/0wc46b7yx6qa4lr4xpzmzx4bsswil50i-python3.12-ledgerwallet-0.5.3`
...
- [[gq371afls8zbq50qpdbb0cjjsq7vin3k-source]]
