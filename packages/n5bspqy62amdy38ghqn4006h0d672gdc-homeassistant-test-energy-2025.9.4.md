---
aliases:
  - home-assistant-component-tests.energy
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.energy`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/n5bspqy62amdy38ghqn4006h0d672gdc-homeassistant-test-energy-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/n5bspqy62amdy38ghqn4006h0d672gdc-homeassistant-test-energy-2025.9.4`
