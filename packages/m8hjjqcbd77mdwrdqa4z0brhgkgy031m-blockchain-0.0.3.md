...
- **Name**: `haskellPackages.blockchain`
- **Version**: `0.0.3`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Generic blockchain implementation
- **Homepage**: [https://hackage.haskell.org/package/blockchain](https://hackage.haskell.org/package/blockchain)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/m8hjjqcbd77mdwrdqa4z0brhgkgy031m-blockchain-0.0.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:110951`
- **Outputs**:
  - `doc`:  `/nix/store/m8hjjqcbd77mdwrdqa4z0brhgkgy031m-blockchain-0.0.3`
  - `out`:  `/nix/store/m8hjjqcbd77mdwrdqa4z0brhgkgy031m-blockchain-0.0.3`

## 🔗 Dependencies

- [[3fl166fdw5bkc5n6jbgb3a091h2y5kmn-blockchain-0.0.3.tar.gz]]
