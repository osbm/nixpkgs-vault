...
- **Name**: `rPackages.mpcmp`
- **Version**: `0.3.6`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://cran.r-project.org/web/packages/mpcmp/](https://cran.r-project.org/web/packages/mpcmp/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/7mvbx4y6i0j2am59wdar9xrwp8k1fzsn-r-mpcmp-0.3.6.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/7mvbx4y6i0j2am59wdar9xrwp8k1fzsn-r-mpcmp-0.3.6`
...
- [[fgh3dg4frk0jxcb34z497b1a49bpb10q-mpcmp_0.3.6.tar.gz]]
