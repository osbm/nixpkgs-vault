...
- **Name**: `python312Packages.vt-py`
- **Version**: `0.21.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Python client library for VirusTotal
- **Homepage**: [https://virustotal.github.io/vt-py/](https://virustotal.github.io/vt-py/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/8iidq9x8sqcl5zy3bc7x6a3m3mdiaqn1-python3.12-vt-py-0.21.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/vt-py/default.nix:53`
- **Outputs**:
  - `dist`:  `/nix/store/8iidq9x8sqcl5zy3bc7x6a3m3mdiaqn1-python3.12-vt-py-0.21.0`
  - `out`:  `/nix/store/8iidq9x8sqcl5zy3bc7x6a3m3mdiaqn1-python3.12-vt-py-0.21.0`
...
- [[r9zcw90rpxinkd23yk9w13w188192x7f-source]]
