...
- **Name**: `rPackages.soc_ca`
- **Version**: `0.8.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://cran.r-project.org/web/packages/soc.ca/](https://cran.r-project.org/web/packages/soc.ca/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/6a541crakl3r937krjzqdbds0a6h31b3-r-soc.ca-0.8.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/6a541crakl3r937krjzqdbds0a6h31b3-r-soc.ca-0.8.0`
...
- [[78xmhg79dny1cxxpd5gd47yl57nvm980-soc.ca_0.8.0.tar.gz]]
