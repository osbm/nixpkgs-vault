...
- **Name**: `python312Packages.dask-ml`
- **Version**: `2025.1.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/87fbd0hg2n36s4hvcrsfl5hwxdjckn1a-python3.12-dask-ml-2025.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/dask-ml/default.nix:97`
- **Outputs**:
  - `dist`:  `/nix/store/87fbd0hg2n36s4hvcrsfl5hwxdjckn1a-python3.12-dask-ml-2025.1.0`
  - `out`:  `/nix/store/87fbd0hg2n36s4hvcrsfl5hwxdjckn1a-python3.12-dask-ml-2025.1.0`
...
- [[dzfik4lcdi15pfikjhl231clwvn32zsh-python3.12-dask-glm-0.3.2]]
