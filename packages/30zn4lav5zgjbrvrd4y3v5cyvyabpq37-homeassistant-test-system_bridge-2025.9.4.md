---
aliases:
  - home-assistant-component-tests.system_bridge
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.system_bridge`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/30zn4lav5zgjbrvrd4y3v5cyvyabpq37-homeassistant-test-system_bridge-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/30zn4lav5zgjbrvrd4y3v5cyvyabpq37-homeassistant-test-system_bridge-2025.9.4`
...
- [[syig2dhzzzan124vaah926s95m69yv3h-python3.13-systembridgeconnector-4.1.11]]
