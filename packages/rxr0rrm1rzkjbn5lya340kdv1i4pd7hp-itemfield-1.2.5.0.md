...
- **Name**: `haskellPackages.itemfield`
- **Version**: `1.2.5.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: A brick Widget for selectable summary of many elements on a terminal
- **Homepage**: [https://hackage.haskell.org/package/itemfield](https://hackage.haskell.org/package/itemfield)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/rxr0rrm1rzkjbn5lya340kdv1i4pd7hp-itemfield-1.2.5.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:386332`
- **Outputs**:
  - `data`:  `/nix/store/rxr0rrm1rzkjbn5lya340kdv1i4pd7hp-itemfield-1.2.5.0`
  - `doc`:  `/nix/store/rxr0rrm1rzkjbn5lya340kdv1i4pd7hp-itemfield-1.2.5.0`
  - `out`:  `/nix/store/rxr0rrm1rzkjbn5lya340kdv1i4pd7hp-itemfield-1.2.5.0`
...
- [[a3mzd9xmwgdhk1ifhy4xlp9r249hs045-itemfield-1.2.5.0.tar.gz]]
