---
aliases:
  - haskellPackages.snaplet-persistent
tags:
  - broken
  - not-available
  - license/unknown
...
- **Name**: `haskellPackages.snaplet-persistent`
- **Version**: `0.7.1`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: persistent snaplet for the Snap Framework
- **Homepage**: [https://hackage.haskell.org/package/snaplet-persistent](https://hackage.haskell.org/package/snaplet-persistent)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/76mjd2nynv4afxfvv9z9s97f5as73jbg-snaplet-persistent-0.7.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:621519`
- **Outputs**:
  - `data`:  `/nix/store/76mjd2nynv4afxfvv9z9s97f5as73jbg-snaplet-persistent-0.7.1`
  - `doc`:  `/nix/store/76mjd2nynv4afxfvv9z9s97f5as73jbg-snaplet-persistent-0.7.1`
  - `out`:  `/nix/store/76mjd2nynv4afxfvv9z9s97f5as73jbg-snaplet-persistent-0.7.1`
...
- [[fsvkpc1flxl144r7v8qvj1hayqzg4yf5-snaplet-persistent-0.7.1.tar.gz]]
