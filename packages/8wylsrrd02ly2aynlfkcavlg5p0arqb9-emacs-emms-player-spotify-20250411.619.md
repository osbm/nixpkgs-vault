---
aliases:
  - emacsPackages.emms-player-spotify
tags:
  - license/unknown
  - outputs/out
---
...
- **Name**: `emacsPackages.emms-player-spotify`
- **Version**: `20250411.619`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://github.com/sarg/emms-spotify](https://github.com/sarg/emms-spotify)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/8wylsrrd02ly2aynlfkcavlg5p0arqb9-emacs-emms-player-spotify-20250411.619.drv`
...
- **Outputs**:
  - `out`:  `/nix/store/8wylsrrd02ly2aynlfkcavlg5p0arqb9-emacs-emms-player-spotify-20250411.619`
...
- [[gi1v89bknisxliyklvsc2hkh7szvbssd-source]]
- [[hi71vi0wzc6facr3xm0jzb80882xvffn-emacs-compat-30.1.0.1]]
- [[jy5ky6kppvrwq4n2d2y8is31xw7fij8x-emms-player-spotify-recipe]]
