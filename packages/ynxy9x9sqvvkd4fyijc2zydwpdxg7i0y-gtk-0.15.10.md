...
- **Name**: `haskellPackages.gtk`
- **Version**: `0.15.10`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Binding to the Gtk+ graphical user interface library
- **Homepage**: [https://hackage.haskell.org/package/gtk](https://hackage.haskell.org/package/gtk)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/ynxy9x9sqvvkd4fyijc2zydwpdxg7i0y-gtk-0.15.10.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:286016`
- **Outputs**:
  - `data`:  `/nix/store/ynxy9x9sqvvkd4fyijc2zydwpdxg7i0y-gtk-0.15.10`
  - `doc`:  `/nix/store/ynxy9x9sqvvkd4fyijc2zydwpdxg7i0y-gtk-0.15.10`
  - `out`:  `/nix/store/ynxy9x9sqvvkd4fyijc2zydwpdxg7i0y-gtk-0.15.10`
...
- [[zpzgzkhwqn1s8ynr2zmz5n367zp5hb69-gtk-0.15.10.tar.gz]]
