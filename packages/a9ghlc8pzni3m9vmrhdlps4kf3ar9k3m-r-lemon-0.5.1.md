...
- **Name**: `rPackages.lemon`
- **Version**: `0.5.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/lemon/](https://cran.r-project.org/web/packages/lemon/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/a9ghlc8pzni3m9vmrhdlps4kf3ar9k3m-r-lemon-0.5.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/a9ghlc8pzni3m9vmrhdlps4kf3ar9k3m-r-lemon-0.5.1`

## 🔗 Dependencies

- [[025a8xdw9gmf691w2njjijzpwa4sbcm9-lemon_0.5.1.tar.gz]]
