...
- **Name**: `python312Packages.wsgidav`
- **Version**: `4.3.3`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Generic and extendable WebDAV server based on WSGI
- **Homepage**: [https://wsgidav.readthedocs.io/](https://wsgidav.readthedocs.io/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/59666s5xny1ahs2byhs8b758kgpyfkqg-python3.12-wsgidav-4.3.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/wsgidav/default.nix:59`
- **Outputs**:
  - `dist`:  `/nix/store/59666s5xny1ahs2byhs8b758kgpyfkqg-python3.12-wsgidav-4.3.3`
  - `out`:  `/nix/store/59666s5xny1ahs2byhs8b758kgpyfkqg-python3.12-wsgidav-4.3.3`
...
- [[f8747n4p5p54i0wcfrn9pvbbmjwdqccq-source]]
