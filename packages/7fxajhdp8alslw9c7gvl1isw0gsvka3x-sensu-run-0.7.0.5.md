...
- **Name**: `haskellPackages.sensu-run`
- **Version**: `0.7.0.5`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: A tool to send command execution results to Sensu
- **Homepage**: [https://hackage.haskell.org/package/sensu-run](https://hackage.haskell.org/package/sensu-run)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/7fxajhdp8alslw9c7gvl1isw0gsvka3x-sensu-run-0.7.0.5.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:594025`
- **Outputs**:
  - `doc`:  `/nix/store/7fxajhdp8alslw9c7gvl1isw0gsvka3x-sensu-run-0.7.0.5`
  - `out`:  `/nix/store/7fxajhdp8alslw9c7gvl1isw0gsvka3x-sensu-run-0.7.0.5`
...
- [[x47aa2qksvwp0260dgxq6qk0gshvz0r1-sensu-run-0.7.0.5.tar.gz]]
