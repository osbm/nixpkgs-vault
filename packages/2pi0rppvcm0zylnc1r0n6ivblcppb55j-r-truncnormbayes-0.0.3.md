...
- **Name**: `rPackages.truncnormbayes`
- **Version**: `0.0.3`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/truncnormbayes/](https://cran.r-project.org/web/packages/truncnormbayes/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/2pi0rppvcm0zylnc1r0n6ivblcppb55j-r-truncnormbayes-0.0.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/2pi0rppvcm0zylnc1r0n6ivblcppb55j-r-truncnormbayes-0.0.3`

## 🔗 Dependencies

- [[1q6x1gnimj2vhgckv7rlwdx97llqpk41-truncnormbayes_0.0.3.tar.gz]]
