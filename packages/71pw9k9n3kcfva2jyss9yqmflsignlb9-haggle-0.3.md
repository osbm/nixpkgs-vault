...
- **Name**: `haskellPackages.haggle`
- **Version**: `0.3`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: A graph library offering mutable, immutable, and inductive graphs
- **Homepage**: [https://hackage.haskell.org/package/haggle](https://hackage.haskell.org/package/haggle)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/71pw9k9n3kcfva2jyss9yqmflsignlb9-haggle-0.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:292187`
- **Outputs**:
  - `doc`:  `/nix/store/71pw9k9n3kcfva2jyss9yqmflsignlb9-haggle-0.3`
  - `out`:  `/nix/store/71pw9k9n3kcfva2jyss9yqmflsignlb9-haggle-0.3`
...
- [[zqmdkxpslhcg9yfyddd4050jc8rz6wbg-haggle-0.3.tar.gz]]
