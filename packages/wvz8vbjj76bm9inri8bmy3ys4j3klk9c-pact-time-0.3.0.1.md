...
- **Name**: `haskellPackages.pact-time`
- **Version**: `0.3.0.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Time Library for Pact
- **Homepage**: [https://hackage.haskell.org/package/pact-time](https://hackage.haskell.org/package/pact-time)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/wvz8vbjj76bm9inri8bmy3ys4j3klk9c-pact-time-0.3.0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:498894`
- **Outputs**:
  - `out`:  `/nix/store/wvz8vbjj76bm9inri8bmy3ys4j3klk9c-pact-time-0.3.0.1`
...
- [[6qnlgpiqjnpjf8x5dpml0lgrydydhhan-pact-time-0.3.0.1.tar.gz]]
