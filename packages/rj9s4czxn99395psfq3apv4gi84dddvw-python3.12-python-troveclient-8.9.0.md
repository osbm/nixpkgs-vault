...
Client library for OpenStack Trove API

## 📋 Package Information

- **Name**: `python312Packages.python-troveclient`
- **Version**: `8.9.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Client library for OpenStack Trove API
- **Homepage**: [https://github.com/openstack/python-troveclient](https://github.com/openstack/python-troveclient)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/rj9s4czxn99395psfq3apv4gi84dddvw-python3.12-python-troveclient-8.9.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/python-troveclient/default.nix:84`
- **Outputs**:
  - `dist`:  `/nix/store/rj9s4czxn99395psfq3apv4gi84dddvw-python3.12-python-troveclient-8.9.0`
  - `out`:  `/nix/store/rj9s4czxn99395psfq3apv4gi84dddvw-python3.12-python-troveclient-8.9.0`
...
- [[8912d1pbrymmckhny15lkxwrs63ybpv1-python3.12-python-swiftclient-4.8.0]]
...
- [[ifqcd7ggadr4b00yy69j8rkbh4aclx8q-python3.12-python-mistralclient-6.0.0]]
- [[j45jmjf6mwz46p7f0f8hjpnzi9pz2pzv-wrap-python-hook]]
- [[kh0627w4wff8syd1iis567224170xw3l-pypa-install-hook]]
- [[kn9lpcgv8x02a8yn62hzygw6lkgk4gqf-source]]
