...
- **Name**: `rPackages.PGRdup`
- **Version**: `0.2.3.9`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/PGRdup/](https://cran.r-project.org/web/packages/PGRdup/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/z2aam0h18csqbhixx4bm5hkaa7aav8sk-r-PGRdup-0.2.3.9.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/z2aam0h18csqbhixx4bm5hkaa7aav8sk-r-PGRdup-0.2.3.9`
...
- [[i1ahmrm83r2gi2ixqxyni9psbnn2riqv-PGRdup_0.2.3.9.tar.gz]]
