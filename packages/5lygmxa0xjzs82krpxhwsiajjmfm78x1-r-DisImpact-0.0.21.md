...
- **Name**: `rPackages.DisImpact`
- **Version**: `0.0.21`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/DisImpact/](https://cran.r-project.org/web/packages/DisImpact/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/5lygmxa0xjzs82krpxhwsiajjmfm78x1-r-DisImpact-0.0.21.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/5lygmxa0xjzs82krpxhwsiajjmfm78x1-r-DisImpact-0.0.21`
...
- [[n91x2aykq75grgljw7vsg9wr7ddq9y9c-DisImpact_0.0.21.tar.gz]]
