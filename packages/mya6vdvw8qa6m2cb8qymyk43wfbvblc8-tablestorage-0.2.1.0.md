...
- **Name**: `haskellPackages.tablestorage`
- **Version**: `0.2.1.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Azure Table Storage REST API Wrapper
- **Homepage**: [https://hackage.haskell.org/package/tablestorage](https://hackage.haskell.org/package/tablestorage)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/mya6vdvw8qa6m2cb8qymyk43wfbvblc8-tablestorage-0.2.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:654295`
- **Outputs**:
  - `data`:  `/nix/store/mya6vdvw8qa6m2cb8qymyk43wfbvblc8-tablestorage-0.2.1.0`
  - `doc`:  `/nix/store/mya6vdvw8qa6m2cb8qymyk43wfbvblc8-tablestorage-0.2.1.0`
  - `out`:  `/nix/store/mya6vdvw8qa6m2cb8qymyk43wfbvblc8-tablestorage-0.2.1.0`
...
- [[l0kx0jqmv16ic8p5pq8bha3sskayd09n-tablestorage-0.2.1.0.tar.gz]]
