---
aliases:
  - androidenv.androidPkgs.all.system-images.v17.default.x86
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.system-images.v17.default.x86`
- **Version**: `17_r07.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/68pf9aknjdm5zkl3pnqbqnjyqgdl243w-x86-17_r07.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/68pf9aknjdm5zkl3pnqbqnjyqgdl243w-x86-17_r07.zip`
