...
- **Name**: `haskellPackages.tailwind`
- **Version**: `0.3.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Tailwind wrapped in Haskell
- **Homepage**: [https://hackage.haskell.org/package/tailwind](https://hackage.haskell.org/package/tailwind)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/3wcjhh32yvsrbrh8ds3x51bah1zdnbvi-tailwind-0.3.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:656232`
- **Outputs**:
  - `doc`:  `/nix/store/3wcjhh32yvsrbrh8ds3x51bah1zdnbvi-tailwind-0.3.0.0`
  - `out`:  `/nix/store/3wcjhh32yvsrbrh8ds3x51bah1zdnbvi-tailwind-0.3.0.0`
...
- [[32y8zspm5bmajibvm826a0ffx06yh4fc-tailwind-0.3.0.0.tar.gz]]
...
- [[fcjfxjrkydwp49clbg3jya9bg2ji1d0b-tailwindcss_3-3.4.17]]
