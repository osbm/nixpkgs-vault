...
- **Name**: `haskellPackages.on-a-horse`
- **Version**: `0.3`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: "Haskell on a Horse" - A combinatorial web framework
- **Homepage**: [https://hackage.haskell.org/package/on-a-horse](https://hackage.haskell.org/package/on-a-horse)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/w9p4krm45chx0dz46gki6524776927jm-on-a-horse-0.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:489144`
- **Outputs**:
  - `doc`:  `/nix/store/w9p4krm45chx0dz46gki6524776927jm-on-a-horse-0.3`
  - `out`:  `/nix/store/w9p4krm45chx0dz46gki6524776927jm-on-a-horse-0.3`
...
- [[j0sbslriqbs2vsirlxhvhaav934g39c1-on-a-horse-0.3.tar.gz]]
