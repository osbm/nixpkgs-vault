---
aliases:
  - androidenv.androidPkgs.all.system-images.v24.default.armeabi-v7a
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.system-images.v24.default.armeabi-v7a`
- **Version**: `24_r07.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/idfiagmb8h9l9pypxg4nmfyd908lkv0x-armeabi-v7a-24_r07.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/idfiagmb8h9l9pypxg4nmfyd908lkv0x-armeabi-v7a-24_r07.zip`
