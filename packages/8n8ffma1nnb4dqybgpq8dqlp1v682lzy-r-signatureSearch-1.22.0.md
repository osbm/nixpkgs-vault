...
- **Name**: `rPackages.signatureSearch`
- **Version**: `1.22.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://bioconductor.org/packages/3.21/bioc/html/signatureSearch.html](https://bioconductor.org/packages/3.21/bioc/html/signatureSearch.html)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/8n8ffma1nnb4dqybgpq8dqlp1v682lzy-r-signatureSearch-1.22.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/8n8ffma1nnb4dqybgpq8dqlp1v682lzy-r-signatureSearch-1.22.0`
...
- [[v5i6ldl5gan9b15vdq191xzgskix02n5-signatureSearch_1.22.0.tar.gz]]
