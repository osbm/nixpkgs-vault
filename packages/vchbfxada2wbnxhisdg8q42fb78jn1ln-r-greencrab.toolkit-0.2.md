...
- **Name**: `rPackages.greencrab_toolkit`
- **Version**: `0.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/greencrab.toolkit/](https://cran.r-project.org/web/packages/greencrab.toolkit/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/vchbfxada2wbnxhisdg8q42fb78jn1ln-r-greencrab.toolkit-0.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/vchbfxada2wbnxhisdg8q42fb78jn1ln-r-greencrab.toolkit-0.2`
...
- [[xrw9afi6sg0crxh295v8c5s9s986kfkd-greencrab.toolkit_0.2.tar.gz]]
