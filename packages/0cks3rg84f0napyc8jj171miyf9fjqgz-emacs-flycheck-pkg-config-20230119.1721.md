...
- **Name**: `emacsPackages.flycheck-pkg-config`
- **Version**: `20230119.1721`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://github.com/Wilfred/flycheck-pkg-config](https://github.com/Wilfred/flycheck-pkg-config)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/0cks3rg84f0napyc8jj171miyf9fjqgz-emacs-flycheck-pkg-config-20230119.1721.drv`
...
- **Outputs**:
  - `out`:  `/nix/store/0cks3rg84f0napyc8jj171miyf9fjqgz-emacs-flycheck-pkg-config-20230119.1721`
...
- [[bp616m3a78cj0wbs5zqp5bcnpyykh53d-source]]
- [[dj4071dniqn7lsyg67yyxx1rjqp3zk6v-emacs-30.2]]
- [[fscz12m3939bskimfinbi6h3ijd3kya9-package-build]]
- [[la1nzcn4asnk1k6i8iqxn0a958zzkgrk-flycheck-pkg-config-recipe]]
