...
- **Name**: `rPackages.MetaVolcanoR`
- **Version**: `1.14.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://bioconductor.org/packages/3.21/bioc/html/MetaVolcanoR.html](https://bioconductor.org/packages/3.21/bioc/html/MetaVolcanoR.html)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/ibi2r0zrgv982b5mpxsayd5n8i57m9lj-r-MetaVolcanoR-1.14.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/ibi2r0zrgv982b5mpxsayd5n8i57m9lj-r-MetaVolcanoR-1.14.0`
...
- [[krh0jlfkpgx1q9hm7icpqinsqc9d1gf4-MetaVolcanoR_1.14.0.tar.gz]]
