...
- **Name**: `perl538Packages.BotTraining`
- **Version**: `0.07`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Plain text training material for bots like Hailo and AI::MegaHAL
- **Homepage**: [https://metacpan.org/release/Bot-Training](https://metacpan.org/release/Bot-Training)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/1wisv40sd4s5dj6yax7idsza0k4xzs70-perl5.38.2-Bot-Training-0.07.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/top-level/perl-packages.nix:2655`
- **Outputs**:
  - `devdoc`:  `/nix/store/1wisv40sd4s5dj6yax7idsza0k4xzs70-perl5.38.2-Bot-Training-0.07`
  - `out`:  `/nix/store/1wisv40sd4s5dj6yax7idsza0k4xzs70-perl5.38.2-Bot-Training-0.07`
...
- [[md6ifkj9w5kygcldv2b7rk5r3j0a6f5z-Bot-Training-0.07.tar.gz]]
