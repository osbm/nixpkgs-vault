...
- **Name**: `rPackages.expose`
- **Version**: `0.0.3`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://cran.r-project.org/web/packages/expose/](https://cran.r-project.org/web/packages/expose/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/4lwf24fpiyd7gc696md2rwfwslsjsrkn-r-expose-0.0.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/4lwf24fpiyd7gc696md2rwfwslsjsrkn-r-expose-0.0.3`
...
- [[9vn55nbs5f88xy25yv4kw04y42mmcj1y-expose_0.0.3.tar.gz]]
