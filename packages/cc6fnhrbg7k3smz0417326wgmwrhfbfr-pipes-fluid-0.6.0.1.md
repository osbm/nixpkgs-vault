...
- **Name**: `haskellPackages.pipes-fluid`
- **Version**: `0.6.0.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Reactively combines Producers so that a value is yielded as soon as possible
- **Homepage**: [https://hackage.haskell.org/package/pipes-fluid](https://hackage.haskell.org/package/pipes-fluid)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/cc6fnhrbg7k3smz0417326wgmwrhfbfr-pipes-fluid-0.6.0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:520502`
- **Outputs**:
  - `doc`:  `/nix/store/cc6fnhrbg7k3smz0417326wgmwrhfbfr-pipes-fluid-0.6.0.1`
  - `out`:  `/nix/store/cc6fnhrbg7k3smz0417326wgmwrhfbfr-pipes-fluid-0.6.0.1`
...
- [[nnskzhggfv5gb60vs0d40ngzj22f1daw-pipes-fluid-0.6.0.1.tar.gz]]
