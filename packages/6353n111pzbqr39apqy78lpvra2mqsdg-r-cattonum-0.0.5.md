...
- **Name**: `rPackages.cattonum`
- **Version**: `0.0.5`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://cran.r-project.org/web/packages/cattonum/](https://cran.r-project.org/web/packages/cattonum/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/6353n111pzbqr39apqy78lpvra2mqsdg-r-cattonum-0.0.5.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/6353n111pzbqr39apqy78lpvra2mqsdg-r-cattonum-0.0.5`

## 🔗 Dependencies

- [[0m6an7sqigyk04yj3cxawvaf4b5v7irj-cattonum_0.0.5.tar.gz]]
