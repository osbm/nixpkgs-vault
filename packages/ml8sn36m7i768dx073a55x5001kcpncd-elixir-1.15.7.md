...
- **Name**: `beam26Packages.elixir_1_15`
- **Version**: `1.15.7`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/ml8sn36m7i768dx073a55x5001kcpncd-elixir-1.15.7.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/interpreters/elixir/1.15.nix:4`
- **Outputs**:
  - `out`:  `/nix/store/ml8sn36m7i768dx073a55x5001kcpncd-elixir-1.15.7`
