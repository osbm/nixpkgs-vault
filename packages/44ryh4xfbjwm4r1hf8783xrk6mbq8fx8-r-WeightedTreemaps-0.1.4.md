...
- **Name**: `rPackages.WeightedTreemaps`
- **Version**: `0.1.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/WeightedTreemaps/](https://cran.r-project.org/web/packages/WeightedTreemaps/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/44ryh4xfbjwm4r1hf8783xrk6mbq8fx8-r-WeightedTreemaps-0.1.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/44ryh4xfbjwm4r1hf8783xrk6mbq8fx8-r-WeightedTreemaps-0.1.4`
...
- [[j25v3qwxl4iydn823bmixmabbd8d403j-WeightedTreemaps_0.1.4.tar.gz]]
