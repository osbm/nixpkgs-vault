...
- **Name**: `python312Packages.papermill`
- **Version**: `2.6.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Parametrize and run Jupyter and interact with notebooks
- **Homepage**: [https://github.com/nteract/papermill](https://github.com/nteract/papermill)
- **License**: `unknown`
- **Platforms**: `aarch64-linux`, `armv5tel-linux`, `armv6l-linux`, `armv7a-linux`, `armv7l-linux`, `i686-linux`, `loongarch64-linux`, `m68k-linux`, `microblaze-linux`, `microblazeel-linux`, `mips-linux`, `mips64-linux`, `mips64el-linux`, `mipsel-linux`, `powerpc-linux`, `powerpc64-linux`, `powerpc64le-linux`, `riscv32-linux`, `riscv64-linux`, `s390-linux`, `s390x-linux`, `x86_64-linux`, `x86_64-darwin`, `aarch64-darwin`, `i686-cygwin`, `x86_64-cygwin`, `aarch64-windows`, `x86_64-windows`, `i686-windows`, `i686-freebsd`, `x86_64-freebsd`, `aarch64-freebsd`

## 🔧 Build Information

- **Derivation Path**: `/nix/store/gb6fg91qdsf2gpgp737imyjv2kfiy40z-python3.12-papermill-2.6.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/papermill/default.nix:121`
- **Outputs**:
  - `dist`:  `/nix/store/gb6fg91qdsf2gpgp737imyjv2kfiy40z-python3.12-papermill-2.6.0`
  - `out`:  `/nix/store/gb6fg91qdsf2gpgp737imyjv2kfiy40z-python3.12-papermill-2.6.0`
...
- [[bab1a430nqd240qgn52jf28fknm27fps-python3.12-ansicolors-1.1.8]]
...
- [[dbq93rhbnsbihyxmp2azvml9w48dq9z2-python3.12-nbclient-0.10.2]]
- [[di2np59yg9yf560yms5ff9188a5gnlbb-python-imports-check-hook.sh]]
- [[dkqa3dj2k1vqrmlyd6hrdf8dww0f5dr9-python-remove-tests-dir-hook]]
- [[dzza407hxx0bk73x0qrk5cpqkn9sskhc-python3.12-azure-datalake-store-1.0.1]]
...
- [[l5rldgidv28799xx98zrxlw12l8ymznp-python3.12-entrypoints-0.4]]
- [[li93qvqlvyv9fkma8wzchdyx1g7c1858-python3.12-tqdm-4.67.1]]
- [[lzvy25g887aypn07ah8igv72z7b9jb88-version-check-hook]]
- [[msf59wnkignf6b60ajfn6a3m2zn8c8r8-source]]
...
- [[y3xvq4iwp2695caklrzr5zw12ynh65hi-python3.12-gcsfs-2025.3.2]]
