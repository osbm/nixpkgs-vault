---
aliases:
  - home-assistant-component-tests.random
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.random`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/sd8yx97if2sf36vacnzhdgvm7nyb8x40-homeassistant-test-random-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/sd8yx97if2sf36vacnzhdgvm7nyb8x40-homeassistant-test-random-2025.9.4`
