...
- **Name**: `linuxKernel.packages.linux_xanmod.nvidia_x11_vulkan_beta_open`
...
- **Derivation Path**: `/nix/store/0vkgbh3b8icsfmq1rij2npw76xl0d9sf-nvidia-open-6.12.48-570.123.19.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/nvidia-x11/open.nix:46`
- **Outputs**:
  - `out`:  `/nix/store/0vkgbh3b8icsfmq1rij2npw76xl0d9sf-nvidia-open-6.12.48-570.123.19`
