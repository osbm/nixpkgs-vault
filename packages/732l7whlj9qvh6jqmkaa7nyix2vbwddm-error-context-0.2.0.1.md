...
- **Name**: `haskellPackages.error-context`
- **Version**: `0.2.0.1`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Provides API for enriching errors with contexts
- **Homepage**: [https://hackage.haskell.org/package/error-context](https://hackage.haskell.org/package/error-context)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/732l7whlj9qvh6jqmkaa7nyix2vbwddm-error-context-0.2.0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:217913`
- **Outputs**:
  - `doc`:  `/nix/store/732l7whlj9qvh6jqmkaa7nyix2vbwddm-error-context-0.2.0.1`
  - `out`:  `/nix/store/732l7whlj9qvh6jqmkaa7nyix2vbwddm-error-context-0.2.0.1`
...
- [[adw79b1a6qsb82zlix69fib8xjyk25as-error-context-0.2.0.1.tar.gz]]
