...
- **Name**: `rPackages.excel2eprime`
- **Version**: `0.4.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/excel2eprime/](https://cran.r-project.org/web/packages/excel2eprime/)
- **License**: `unknown`
