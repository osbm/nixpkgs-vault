---
aliases:
  - factorPackages.factor-minimal-gui
tags:
  - license/unknown
  - maintainers/vrthra
...
- **Name**: `factorPackages.factor-minimal-gui`
- **Version**: `0.100`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/jqkkn4qgwks1v0chwdylid190j904mng-factor-lang-env-0.100.drv`
...
- **Outputs**:
  - `out`:  `/nix/store/jqkkn4qgwks1v0chwdylid190j904mng-factor-lang-env-0.100`
