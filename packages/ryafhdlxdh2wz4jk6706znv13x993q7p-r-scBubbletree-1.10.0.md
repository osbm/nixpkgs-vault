...
- **Name**: `rPackages.scBubbletree`
- **Version**: `1.10.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://bioconductor.org/packages/3.21/bioc/html/scBubbletree.html](https://bioconductor.org/packages/3.21/bioc/html/scBubbletree.html)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/ryafhdlxdh2wz4jk6706znv13x993q7p-r-scBubbletree-1.10.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/ryafhdlxdh2wz4jk6706znv13x993q7p-r-scBubbletree-1.10.0`
...
- [[zxb8l2qi2gn3w2nc75bcda6cip9a6187-scBubbletree_1.10.0.tar.gz]]
