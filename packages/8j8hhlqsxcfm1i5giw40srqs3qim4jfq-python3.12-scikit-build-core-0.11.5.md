...
- **Name**: `python312Packages.scikit-build-core`
- **Version**: `0.11.5`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/8j8hhlqsxcfm1i5giw40srqs3qim4jfq-python3.12-scikit-build-core-0.11.5.drv`
...
- **Outputs**:
  - `dist`:  `/nix/store/8j8hhlqsxcfm1i5giw40srqs3qim4jfq-python3.12-scikit-build-core-0.11.5`
  - `out`:  `/nix/store/8j8hhlqsxcfm1i5giw40srqs3qim4jfq-python3.12-scikit-build-core-0.11.5`
...
- [[51lghm765l215xm1i766cgvx41nwh2l7-python3.12-pytest-subprocess-1.5.3]]
