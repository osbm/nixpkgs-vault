...
- **Name**: `haskellPackages.lmonad-yesod`
- **Version**: `1.0.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: LMonad for Yesod integrates LMonad's IFC with Yesod web applications
- **Homepage**: [https://hackage.haskell.org/package/lmonad-yesod](https://hackage.haskell.org/package/lmonad-yesod)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/rns1w60hfc4ka3d6aa7aybpiwpvch1zq-lmonad-yesod-1.0.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:426035`
- **Outputs**:
  - `doc`:  `/nix/store/rns1w60hfc4ka3d6aa7aybpiwpvch1zq-lmonad-yesod-1.0.0.0`
  - `out`:  `/nix/store/rns1w60hfc4ka3d6aa7aybpiwpvch1zq-lmonad-yesod-1.0.0.0`
...
- [[bxxsq1z4ygyig8zfcmqwzaz3csr90pzf-lmonad-yesod-1.0.0.0.tar.gz]]
...
- [[rjlxd7ypx6ivbhhfyxji4vipl3bqz0kx-lmonad-0.1.0.0]]
