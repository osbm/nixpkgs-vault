...
- **Name**: `haskellPackages.gi-soup3`
- **Version**: `3.0.5`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Libsoup 3.x bindings
- **Homepage**: [https://hackage.haskell.org/package/gi-soup3](https://hackage.haskell.org/package/gi-soup3)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/rykhr39ipklbc4iwlkr6s8n12sp11hr0-gi-soup3-3.0.5.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:267138`
- **Outputs**:
  - `doc`:  `/nix/store/rykhr39ipklbc4iwlkr6s8n12sp11hr0-gi-soup3-3.0.5`
  - `out`:  `/nix/store/rykhr39ipklbc4iwlkr6s8n12sp11hr0-gi-soup3-3.0.5`
...
- [[ziffirhc09v9jyi0i87mjd1b4y250gpg-gi-soup3-3.0.5.tar.gz]]
