...
- **Name**: `haskellPackages.hyperion`
- **Version**: `0.1.0.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Reliable performance measurement with robust data export
- **Homepage**: [https://hackage.haskell.org/package/hyperion](https://hackage.haskell.org/package/hyperion)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/g8yc9fmcswnc3mmzyzqb28gkk9vpg2p8-hyperion-0.1.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:370963`
- **Outputs**:
  - `doc`:  `/nix/store/g8yc9fmcswnc3mmzyzqb28gkk9vpg2p8-hyperion-0.1.0.0`
  - `out`:  `/nix/store/g8yc9fmcswnc3mmzyzqb28gkk9vpg2p8-hyperion-0.1.0.0`

## 🔗 Dependencies

- [[30kfnmndag1knvimsdil145sfbpxg626-hyperion-0.1.0.0.tar.gz]]
