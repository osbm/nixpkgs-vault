...
- **Name**: `rPackages.quincunx`
- **Version**: `0.1.10`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/quincunx/](https://cran.r-project.org/web/packages/quincunx/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/12mwhir5qhfkjrfpglq08kk8lgqadc1b-r-quincunx-0.1.10.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/12mwhir5qhfkjrfpglq08kk8lgqadc1b-r-quincunx-0.1.10`
...
- [[6zw6kk00b9izml88f72kp1r3vvkwnagw-quincunx_0.1.10.tar.gz]]
