...
- **Name**: `python313Packages.cohere`
- **Version**: `5.18.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Simplify interfacing with the Cohere API
- **Homepage**: [https://docs.cohere.com/docs](https://docs.cohere.com/docs)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/2sshkhdap8063kn6gdsd2gww88715xl7-python3.13-cohere-5.18.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/cohere/default.nix:55`
- **Outputs**:
  - `dist`:  `/nix/store/2sshkhdap8063kn6gdsd2gww88715xl7-python3.13-cohere-5.18.0`
  - `out`:  `/nix/store/2sshkhdap8063kn6gdsd2gww88715xl7-python3.13-cohere-5.18.0`
...
- [[zclmp1hp47xklx80c403ab3m4vzwf5jz-source]]
