...
Simple key-value store designed to be used from shell scripts written in Rust
...
- **Homepage**: [https://github.com/DOD-101/config-store](https://github.com/DOD-101/config-store)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/zhwic6jajkaaza19x89bdxai4aqn7ryq-config-store-1.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/co/config-store/package.nix:20`
- **Outputs**:
  - `out`:  `/nix/store/zhwic6jajkaaza19x89bdxai4aqn7ryq-config-store-1.0.0`
...
- [[7fz20pc6bwxdp8hnkh2v5hqbyl2r6a1v-source]]
- [[bjsb6wdjykafnkixq156qdvmxhsm2bai-bash-5.3p3]]
- [[bxaxgjjl650hc896v2drcpwscqga5pin-config-store-1.0.0-vendor]]
