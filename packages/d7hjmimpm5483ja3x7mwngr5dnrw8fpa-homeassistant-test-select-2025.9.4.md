---
aliases:
  - home-assistant-component-tests.select
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.select`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/d7hjmimpm5483ja3x7mwngr5dnrw8fpa-homeassistant-test-select-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/d7hjmimpm5483ja3x7mwngr5dnrw8fpa-homeassistant-test-select-2025.9.4`
