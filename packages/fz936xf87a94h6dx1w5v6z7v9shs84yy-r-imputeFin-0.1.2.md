...
- **Name**: `rPackages.imputeFin`
- **Version**: `0.1.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/imputeFin/](https://cran.r-project.org/web/packages/imputeFin/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/fz936xf87a94h6dx1w5v6z7v9shs84yy-r-imputeFin-0.1.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/fz936xf87a94h6dx1w5v6z7v9shs84yy-r-imputeFin-0.1.2`

## 🔗 Dependencies

- [[3f8n9gfa8d7ay5sixww3x88fg6vxvhfg-r-magrittr-2.0.3]]
- [[ad0hi938ajra7qld1yvs8524q9w7h181-imputeFin_0.1.2.tar.gz]]
