---
aliases:
  - perl540Packages.HTMLMasonPSGIHandler
tags:
  - license/unknown
  - outputs/devdoc
  - outputs/out
...
- **Name**: `perl540Packages.HTMLMasonPSGIHandler`
- **Version**: `0.53`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/0p6wnncmwzxc7nrsmsziwg0lfgv4c91q-perl5.40.0-HTML-Mason-PSGIHandler-0.53.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/top-level/perl-packages.nix:16137`
- **Outputs**:
  - `devdoc`:  `/nix/store/0p6wnncmwzxc7nrsmsziwg0lfgv4c91q-perl5.40.0-HTML-Mason-PSGIHandler-0.53`
  - `out`:  `/nix/store/0p6wnncmwzxc7nrsmsziwg0lfgv4c91q-perl5.40.0-HTML-Mason-PSGIHandler-0.53`
...
- [[k1dzjn5vg7hwrib5qpwyav5rgccv063x-perl5.40.0-HTML-Mason-1.60]]
