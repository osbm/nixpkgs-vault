...
- **Name**: `python313Packages.cvxopt`
- **Version**: `1.3.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Python Software for Convex Optimization
- **Homepage**: [https://cvxopt.org/](https://cvxopt.org/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/pmycnp31sfv3kpin7cyjbiyp74848kb1-python3.13-cvxopt-1.3.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/cvxopt/default.nix:75`
- **Outputs**:
  - `dist`:  `/nix/store/pmycnp31sfv3kpin7cyjbiyp74848kb1-python3.13-cvxopt-1.3.2`
  - `out`:  `/nix/store/pmycnp31sfv3kpin7cyjbiyp74848kb1-python3.13-cvxopt-1.3.2`
...
- [[sqgp72jr9dg7b72v2li69q3aam5kcbd5-cvxopt-1.3.2.tar.gz]]
