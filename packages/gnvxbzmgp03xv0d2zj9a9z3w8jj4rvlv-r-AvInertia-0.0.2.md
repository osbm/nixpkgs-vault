...
- **Name**: `rPackages.AvInertia`
- **Version**: `0.0.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/AvInertia/](https://cran.r-project.org/web/packages/AvInertia/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/gnvxbzmgp03xv0d2zj9a9z3w8jj4rvlv-r-AvInertia-0.0.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/gnvxbzmgp03xv0d2zj9a9z3w8jj4rvlv-r-AvInertia-0.0.2`
...
- [[kp0hrj9irnp6q6765kdg6h515hscb4x7-AvInertia_0.0.2.tar.gz]]
