...
- **Name**: `rPackages.cards`
- **Version**: `0.6.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/cards/](https://cran.r-project.org/web/packages/cards/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/79lszxn8g8aycys264zbld1zxpb72nyq-r-cards-0.6.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/79lszxn8g8aycys264zbld1zxpb72nyq-r-cards-0.6.1`
...
- [[v81q9v712y5yby9ycj3ara0k1xc75q9q-cards_0.6.1.tar.gz]]
