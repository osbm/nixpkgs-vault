...
- **Name**: `haskellPackages.yesod-crud`
- **Version**: `0.1.7`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Generic administrative CRUD operations as a Yesod subsite
- **Homepage**: [https://hackage.haskell.org/package/yesod-crud](https://hackage.haskell.org/package/yesod-crud)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/hfs0zdin0bxd79s896zbq472vs4sqjsc-yesod-crud-0.1.7.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:739875`
- **Outputs**:
  - `doc`:  `/nix/store/hfs0zdin0bxd79s896zbq472vs4sqjsc-yesod-crud-0.1.7`
  - `out`:  `/nix/store/hfs0zdin0bxd79s896zbq472vs4sqjsc-yesod-crud-0.1.7`
...
- [[k1alhr2vf0dcxsbl55p9hia5h00x6am6-yesod-crud-0.1.7.tar.gz]]
