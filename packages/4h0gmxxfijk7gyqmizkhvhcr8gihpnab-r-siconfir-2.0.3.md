...
- **Name**: `rPackages.siconfir`
- **Version**: `2.0.3`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://cran.r-project.org/web/packages/siconfir/](https://cran.r-project.org/web/packages/siconfir/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/4h0gmxxfijk7gyqmizkhvhcr8gihpnab-r-siconfir-2.0.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/4h0gmxxfijk7gyqmizkhvhcr8gihpnab-r-siconfir-2.0.3`
...
- [[fpci18kmp1kn12xywkfn7xgj99j2ycb3-siconfir_2.0.3.tar.gz]]
