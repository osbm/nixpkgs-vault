...
- **Name**: `python312Packages.cryptolyzer`
- **Version**: `1.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Cryptographic protocol analyzer
- **Homepage**: [https://gitlab.com/coroner/cryptolyzer](https://gitlab.com/coroner/cryptolyzer)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/xa68nxfv95wkd6zcd3qgdjppz9798n22-python3.12-cryptolyzer-1.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/cryptolyzer/default.nix:73`
- **Outputs**:
  - `dist`:  `/nix/store/xa68nxfv95wkd6zcd3qgdjppz9798n22-python3.12-cryptolyzer-1.0.0`
  - `out`:  `/nix/store/xa68nxfv95wkd6zcd3qgdjppz9798n22-python3.12-cryptolyzer-1.0.0`

## 🔗 Dependencies

- [[09lljqdh2q34y3ja5w84dvcg2b3vcph6-cryptolyzer-1.0.0.tar.gz]]
- [[3miqva6gn661rma1b4p2qmgh332ly4vw-python3.12-python-dateutil-2.9.0.post0]]
- [[40nzapipfbsasrwvwpm036zvj1basrdp-python3.12-pathlib2-2.3.7.post1]]
...
- [[kcc237y4h5yqn9apx0jjwiajazbd08av-python3.12-cryptoparser-1.0.0]]
...
- `/nix/store/ar7x9g5h447h4wrchd87gd7acm6dvw4f-fix-dirs-exclude.patch`
