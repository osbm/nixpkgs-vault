...
- **Name**: `rPackages.SSOSVM`
- **Version**: `0.2.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/SSOSVM/](https://cran.r-project.org/web/packages/SSOSVM/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/xyvs4pwpyx9jx5647xsh3vs7gh7yaadb-r-SSOSVM-0.2.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/xyvs4pwpyx9jx5647xsh3vs7gh7yaadb-r-SSOSVM-0.2.1`
...
- [[ih8gx8drm6bmp7l9643xcaf1yn3i5jzr-SSOSVM_0.2.1.tar.gz]]
