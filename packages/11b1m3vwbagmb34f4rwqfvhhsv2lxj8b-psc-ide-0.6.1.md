...
- **Name**: `haskellPackages.psc-ide`
- **Version**: `0.6.1`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Language support for the PureScript programming language
- **Homepage**: [https://hackage.haskell.org/package/psc-ide](https://hackage.haskell.org/package/psc-ide)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/11b1m3vwbagmb34f4rwqfvhhsv2lxj8b-psc-ide-0.6.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:545167`
- **Outputs**:
  - `doc`:  `/nix/store/11b1m3vwbagmb34f4rwqfvhhsv2lxj8b-psc-ide-0.6.1`
  - `out`:  `/nix/store/11b1m3vwbagmb34f4rwqfvhhsv2lxj8b-psc-ide-0.6.1`
...
- [[sq6x467n1g17g7ni7g73njf2904g9mx9-psc-ide-0.6.1.tar.gz]]
