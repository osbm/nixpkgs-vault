---
aliases:
  - androidenv.androidPkgs.all.packages.sources.v36
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.packages.sources.v36`
- **Version**: `36_r01.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/3nkvf6ds7a6wdgkmwfwr9f3y1pqgh99n-source-36_r01.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/3nkvf6ds7a6wdgkmwfwr9f3y1pqgh99n-source-36_r01.zip`
