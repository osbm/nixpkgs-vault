---
aliases:
  - linuxKernel.packages.linux_xanmod.hyperv-daemons
tags:
  - license/unknown
...
- **Name**: `linuxKernel.packages.linux_xanmod.hyperv-daemons`
- **Version**: `6.12.48`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/1psmy3krhbjq9pk3zvkbm0a4c4kr897x-hyperv-daemons-6.12.48.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/hyperv-daemons/default.nix:123`
- **Outputs**:
  - `bin`:  `/nix/store/1psmy3krhbjq9pk3zvkbm0a4c4kr897x-hyperv-daemons-6.12.48`
  - `lib`:  `/nix/store/1psmy3krhbjq9pk3zvkbm0a4c4kr897x-hyperv-daemons-6.12.48`
  - `out`:  `/nix/store/1psmy3krhbjq9pk3zvkbm0a4c4kr897x-hyperv-daemons-6.12.48`

## 🔗 Dependencies

- [[0bnrngq5ywwn9r3czl4cb8xrfr8d5bq6-hyperv-daemons-bin-6.12.48]]
