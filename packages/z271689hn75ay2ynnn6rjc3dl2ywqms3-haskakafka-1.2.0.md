...
- **Name**: `haskellPackages.haskakafka`
- **Version**: `1.2.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Kafka bindings for Haskell
- **Homepage**: [https://hackage.haskell.org/package/haskakafka](https://hackage.haskell.org/package/haskakafka)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/z271689hn75ay2ynnn6rjc3dl2ywqms3-haskakafka-1.2.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:300639`
- **Outputs**:
  - `doc`:  `/nix/store/z271689hn75ay2ynnn6rjc3dl2ywqms3-haskakafka-1.2.0`
  - `out`:  `/nix/store/z271689hn75ay2ynnn6rjc3dl2ywqms3-haskakafka-1.2.0`
...
- [[7ymqbnqw2kl9wfdgjhawkrmzpr3zvkd1-haskakafka-1.2.0.tar.gz]]
