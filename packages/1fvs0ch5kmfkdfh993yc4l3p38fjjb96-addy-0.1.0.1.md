...
- **Name**: `haskellPackages.addy`
- **Version**: `0.1.0.1`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: A full-featured library for parsing, validating, and rendering email addresses
- **Homepage**: [https://hackage.haskell.org/package/addy](https://hackage.haskell.org/package/addy)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/1fvs0ch5kmfkdfh993yc4l3p38fjjb96-addy-0.1.0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:52723`
- **Outputs**:
  - `doc`:  `/nix/store/1fvs0ch5kmfkdfh993yc4l3p38fjjb96-addy-0.1.0.1`
  - `out`:  `/nix/store/1fvs0ch5kmfkdfh993yc4l3p38fjjb96-addy-0.1.0.1`
...
- [[65i1vw5191xl7jgdxr1wi9qiiy1n7fh8-addy-0.1.0.1.tar.gz]]
