...
- **Name**: `haskellPackages.graphula-core`
- **Version**: `2.0.0.1`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: A declarative library for describing dependencies between data
- **Homepage**: [https://hackage.haskell.org/package/graphula-core](https://hackage.haskell.org/package/graphula-core)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/kf631ww8x491jjji9jnp2w2261di382w-graphula-core-2.0.0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:282645`
- **Outputs**:
  - `doc`:  `/nix/store/kf631ww8x491jjji9jnp2w2261di382w-graphula-core-2.0.0.1`
  - `out`:  `/nix/store/kf631ww8x491jjji9jnp2w2261di382w-graphula-core-2.0.0.1`
...
- [[bm0cyk6hdh5qnx87h7hckdfpdylswsga-graphula-core-2.0.0.1-r1.cabal]]
...
- [[v4r0d7kd4bj23j6jgyw2957lpwipynfm-graphula-core-2.0.0.1.tar.gz]]
- [[w8ha91k8lxpbjq0vvc84zmib5xz5id3c-resourcet-1.3.0]]
- [[xarn2gqfdxdmh66qq48cnyzi1i80d571-monad-logger-0.3.42]]
- [[z03pa000j945z9v8x5bcaiil7lqwc841-generics-eot-0.4.0.1]]
