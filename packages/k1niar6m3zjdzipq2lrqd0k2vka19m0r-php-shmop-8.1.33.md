...
- **Name**: `php81Extensions.shmop`
- **Version**: `8.1.33`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: PHP upstream extension: shmop
...
- **Derivation Path**: `/nix/store/k1niar6m3zjdzipq2lrqd0k2vka19m0r-php-shmop-8.1.33.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/top-level/php-packages.nix:206`
- **Outputs**:
  - `dev`:  `/nix/store/k1niar6m3zjdzipq2lrqd0k2vka19m0r-php-shmop-8.1.33`
  - `out`:  `/nix/store/k1niar6m3zjdzipq2lrqd0k2vka19m0r-php-shmop-8.1.33`
