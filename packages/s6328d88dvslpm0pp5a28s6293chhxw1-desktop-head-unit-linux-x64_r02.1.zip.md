---
aliases:
  - androidenv.androidPkgs.all.packages.extras.v2_1
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.packages.extras.v2_1`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/s6328d88dvslpm0pp5a28s6293chhxw1-desktop-head-unit-linux-x64_r02.1.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/s6328d88dvslpm0pp5a28s6293chhxw1-desktop-head-unit-linux-x64_r02.1.zip`
