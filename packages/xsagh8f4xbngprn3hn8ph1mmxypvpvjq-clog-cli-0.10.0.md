...
- **Homepage**: [https://github.com/clog-tool/clog-cli](https://github.com/clog-tool/clog-cli)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/xsagh8f4xbngprn3hn8ph1mmxypvpvjq-clog-cli-0.10.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/cl/clog-cli/package.nix:23`
- **Outputs**:
  - `out`:  `/nix/store/xsagh8f4xbngprn3hn8ph1mmxypvpvjq-clog-cli-0.10.0`
...
- [[ghfjrfjy9sgvvmi45rq1zsyq8mqxqhlj-source]]
- [[mfk7f2jkgdav1ssjs4snzpw7a0ng57n3-clog-cli-0.10.0-vendor]]
