...
- **Name**: `haskellPackages.sensei`
- **Version**: `0.9.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Automatically run Hspec tests on file modifications
- **Homepage**: [https://hackage.haskell.org/package/sensei](https://hackage.haskell.org/package/sensei)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/0p7y8dzwzmjq0jfmc2h2yqryjhh4xg3f-sensei-0.9.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:593859`
- **Outputs**:
  - `doc`:  `/nix/store/0p7y8dzwzmjq0jfmc2h2yqryjhh4xg3f-sensei-0.9.0`
  - `out`:  `/nix/store/0p7y8dzwzmjq0jfmc2h2yqryjhh4xg3f-sensei-0.9.0`

## 🔗 Dependencies

- [[095429rpr8zld6cq1m4aaddys91n83v0-sensei-0.9.0.tar.gz]]
