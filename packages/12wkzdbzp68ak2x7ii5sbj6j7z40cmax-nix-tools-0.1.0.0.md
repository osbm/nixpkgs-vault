...
- **Name**: `haskellPackages.nix-tools`
- **Version**: `0.1.0.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: cabal/stack to nix translation tools
- **Homepage**: [https://hackage.haskell.org/package/nix-tools](https://hackage.haskell.org/package/nix-tools)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/12wkzdbzp68ak2x7ii5sbj6j7z40cmax-nix-tools-0.1.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:479384`
- **Outputs**:
  - `doc`:  `/nix/store/12wkzdbzp68ak2x7ii5sbj6j7z40cmax-nix-tools-0.1.0.0`
  - `out`:  `/nix/store/12wkzdbzp68ak2x7ii5sbj6j7z40cmax-nix-tools-0.1.0.0`
...
- [[imf0hxw8m1qbnrjnw5cy1dsc5kisvi1k-nix-tools-0.1.0.0.tar.gz]]
