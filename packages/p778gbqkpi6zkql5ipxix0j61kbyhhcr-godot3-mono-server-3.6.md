...
- **Name**: `godot3-mono-server`
- **Version**: `3.6`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Free and Open Source 2D and 3D game engine (mono server)
...
- **Derivation Path**: `/nix/store/p778gbqkpi6zkql5ipxix0j61kbyhhcr-godot3-mono-server-3.6.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/tools/godot/3/default.nix:178`
- **Outputs**:
  - `out`:  `/nix/store/p778gbqkpi6zkql5ipxix0j61kbyhhcr-godot3-mono-server-3.6`
