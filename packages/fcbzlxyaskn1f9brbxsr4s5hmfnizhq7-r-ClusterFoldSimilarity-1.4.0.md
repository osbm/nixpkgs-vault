---
aliases:
  - rPackages.ClusterFoldSimilarity
tags:
  - license/unknown
  - outputs/out
---
...
- **Name**: `rPackages.ClusterFoldSimilarity`
- **Version**: `1.4.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://bioconductor.org/packages/3.21/bioc/html/ClusterFoldSimilarity.html](https://bioconductor.org/packages/3.21/bioc/html/ClusterFoldSimilarity.html)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/fcbzlxyaskn1f9brbxsr4s5hmfnizhq7-r-ClusterFoldSimilarity-1.4.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/fcbzlxyaskn1f9brbxsr4s5hmfnizhq7-r-ClusterFoldSimilarity-1.4.0`
...
- [[9kmvjfwdxa0s86djz7y9sjhlja8049jq-ClusterFoldSimilarity_1.4.0.tar.gz]]
