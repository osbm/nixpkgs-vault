...
- **Name**: `haskellPackages.aosd`
- **Version**: `0.2.2`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Bindings to libaosd, a library for Cairo-based on-screen displays
- **Homepage**: [https://hackage.haskell.org/package/aosd](https://hackage.haskell.org/package/aosd)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/mrgypfp4l35agjd5zkpmk1sxn3mljyah-aosd-0.2.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:78011`
- **Outputs**:
  - `doc`:  `/nix/store/mrgypfp4l35agjd5zkpmk1sxn3mljyah-aosd-0.2.2`
  - `out`:  `/nix/store/mrgypfp4l35agjd5zkpmk1sxn3mljyah-aosd-0.2.2`
...
- [[sr76pi1h3rk7r8h8fcm4z2rvgmfdq6li-libaosd-0.2.7-9-g177589f]]
...
- [[yrkmbfn05v86zi0a8ldf2diisiajzlnw-aosd-0.2.2.tar.gz]]
