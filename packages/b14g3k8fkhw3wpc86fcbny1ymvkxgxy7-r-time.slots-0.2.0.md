...
- **Name**: `rPackages.time_slots`
- **Version**: `0.2.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://cran.r-project.org/web/packages/time.slots/](https://cran.r-project.org/web/packages/time.slots/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/b14g3k8fkhw3wpc86fcbny1ymvkxgxy7-r-time.slots-0.2.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/b14g3k8fkhw3wpc86fcbny1ymvkxgxy7-r-time.slots-0.2.0`
...
- [[fxd2d2b4k11vsrq8307g0q4y09l854qz-time.slots_0.2.0.tar.gz]]
