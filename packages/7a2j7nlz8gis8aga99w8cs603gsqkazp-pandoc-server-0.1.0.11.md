...
- **Name**: `haskellPackages.pandoc-server`
- **Version**: `0.1.0.11`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Pandoc document conversion as an HTTP servant-server
- **Homepage**: [https://hackage.haskell.org/package/pandoc-server](https://hackage.haskell.org/package/pandoc-server)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/7a2j7nlz8gis8aga99w8cs603gsqkazp-pandoc-server-0.1.0.11.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:501849`
- **Outputs**:
  - `doc`:  `/nix/store/7a2j7nlz8gis8aga99w8cs603gsqkazp-pandoc-server-0.1.0.11`
  - `out`:  `/nix/store/7a2j7nlz8gis8aga99w8cs603gsqkazp-pandoc-server-0.1.0.11`
...
- [[fidm4jgngmhjfyhqk82818gs30fssk9r-pandoc-server-0.1.0.11.tar.gz]]
