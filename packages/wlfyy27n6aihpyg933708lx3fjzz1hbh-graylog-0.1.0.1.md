...
- **Name**: `haskellPackages.graylog`
- **Version**: `0.1.0.1`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Support for graylog output
- **Homepage**: [https://hackage.haskell.org/package/graylog](https://hackage.haskell.org/package/graylog)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/wlfyy27n6aihpyg933708lx3fjzz1hbh-graylog-0.1.0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:283039`
- **Outputs**:
  - `doc`:  `/nix/store/wlfyy27n6aihpyg933708lx3fjzz1hbh-graylog-0.1.0.1`
  - `out`:  `/nix/store/wlfyy27n6aihpyg933708lx3fjzz1hbh-graylog-0.1.0.1`
...
- [[nnj3prmccd14q5zmhd11cyp0fylba9g1-graylog-0.1.0.1.tar.gz]]
