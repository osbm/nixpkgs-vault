...
Gtk front-end to control a Mopidy server
...
- **Homepage**: [https://github.com/orontee/argos](https://github.com/orontee/argos)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/a86qf2c35ray1f2ccw0b5qnsdjwfiam5-mopidy-argos-1.16.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/mo/mopidy-argos/package.nix:54`
- **Outputs**:
  - `out`:  `/nix/store/a86qf2c35ray1f2ccw0b5qnsdjwfiam5-mopidy-argos-1.16.1`
...
- [[yzf9854zmc8p60b2m8y1mx6lp3dhn75y-source]]
