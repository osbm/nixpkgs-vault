...
Web-app pentesting suite written in rust
...
- **Homepage**: [https://github.com/pwnwriter/kanha](https://github.com/pwnwriter/kanha)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/njfqx5nrb8l9bsxn1kdyd51cdxpnwkay-kanha-0.1.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/ka/kanha/package.nix:23`
- **Outputs**:
  - `out`:  `/nix/store/njfqx5nrb8l9bsxn1kdyd51cdxpnwkay-kanha-0.1.2`
...
- [[s5795vf82xdg1b9gazr6gxgbvlcxn2xv-kanha-0.1.2-vendor]]
- [[xqxbqs6qgnhvpkcai046s94jfrx8wb62-cargo-check-hook.sh]]
- [[xrd0l480kngrrws0ayv577xmkd115x2c-kanha-0.1.2.tar.gz]]
