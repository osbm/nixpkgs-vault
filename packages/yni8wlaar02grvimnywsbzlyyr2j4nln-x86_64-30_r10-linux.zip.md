---
aliases:
  - androidenv.androidPkgs.all.system-images.v30.google_apis_playstore.x86_64
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.system-images.v30.google_apis_playstore.x86_64`
...
- **Derivation Path**: `/nix/store/yni8wlaar02grvimnywsbzlyyr2j4nln-x86_64-30_r10-linux.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/yni8wlaar02grvimnywsbzlyyr2j4nln-x86_64-30_r10-linux.zip`
