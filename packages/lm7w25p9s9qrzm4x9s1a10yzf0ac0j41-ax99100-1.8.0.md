---
aliases:
  - linuxKernel.packages.linux_5_10.ax99100
tags:
  - license/unknown
  - outputs/out
---
...
- **Name**: `linuxKernel.packages.linux_5_10.ax99100`
- **Version**: `1.8.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/lm7w25p9s9qrzm4x9s1a10yzf0ac0j41-ax99100-1.8.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/ax99100/default.nix:56`
- **Outputs**:
  - `out`:  `/nix/store/lm7w25p9s9qrzm4x9s1a10yzf0ac0j41-ax99100-1.8.0`
