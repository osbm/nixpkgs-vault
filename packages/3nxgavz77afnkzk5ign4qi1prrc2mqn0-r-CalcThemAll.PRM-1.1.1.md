...
- **Name**: `rPackages.CalcThemAll_PRM`
- **Version**: `1.1.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/CalcThemAll.PRM/](https://cran.r-project.org/web/packages/CalcThemAll.PRM/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/3nxgavz77afnkzk5ign4qi1prrc2mqn0-r-CalcThemAll.PRM-1.1.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/3nxgavz77afnkzk5ign4qi1prrc2mqn0-r-CalcThemAll.PRM-1.1.1`
...
- [[hnbfdyd4hmqs1a9qm6rf6vamd509jpsc-CalcThemAll.PRM_1.1.1.tar.gz]]
