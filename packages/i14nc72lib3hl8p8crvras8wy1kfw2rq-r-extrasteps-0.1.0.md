...
- **Name**: `rPackages.extrasteps`
- **Version**: `0.1.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/extrasteps/](https://cran.r-project.org/web/packages/extrasteps/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/i14nc72lib3hl8p8crvras8wy1kfw2rq-r-extrasteps-0.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/i14nc72lib3hl8p8crvras8wy1kfw2rq-r-extrasteps-0.1.0`

## 🔗 Dependencies

- [[2wdv3fgampa9njlzplgcyr2amybfr0q3-extrasteps_0.1.0.tar.gz]]
