...
- **Name**: `haskellPackages.graphula`
- **Version**: `2.1.2.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: A simple interface for generating persistent data and linking its dependencies
- **Homepage**: [https://hackage.haskell.org/package/graphula](https://hackage.haskell.org/package/graphula)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/3a5v43f7dxmawwp911k7h4f93rscwli9-graphula-2.1.2.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:282575`
- **Outputs**:
  - `doc`:  `/nix/store/3a5v43f7dxmawwp911k7h4f93rscwli9-graphula-2.1.2.0`
  - `out`:  `/nix/store/3a5v43f7dxmawwp911k7h4f93rscwli9-graphula-2.1.2.0`
...
- [[wmkrd8r4gm6w689b52f2py2gdqq3bv17-graphula-2.1.2.0.tar.gz]]
