...
- **Name**: `haskellPackages.servant-server`
- **Version**: `0.20.3.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: A family of combinators for defining webservices APIs and serving them
- **Homepage**: [https://hackage.haskell.org/package/servant-server](https://hackage.haskell.org/package/servant-server)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/dilnizk2i7sxr76b846fan4npfvkgyq5-servant-server-0.20.3.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:601534`
- **Outputs**:
  - `doc`:  `/nix/store/dilnizk2i7sxr76b846fan4npfvkgyq5-servant-server-0.20.3.0`
  - `out`:  `/nix/store/dilnizk2i7sxr76b846fan4npfvkgyq5-servant-server-0.20.3.0`
...
- [[4ynkfzll6d2vfzbp4s0lvpm0vfll8ls8-servant-server-0.20.3.0-r1.cabal]]
...
- [[j07hxd10x7ys0v46gs6mh68gz39bhjal-servant-server-0.20.3.0.tar.gz]]
