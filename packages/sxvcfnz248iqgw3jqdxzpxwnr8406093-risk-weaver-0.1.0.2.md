...
- **Name**: `haskellPackages.risk-weaver`
- **Version**: `0.1.0.2`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: A DSL for Risk-oriented Object Detection Requirements
- **Homepage**: [https://hackage.haskell.org/package/risk-weaver](https://hackage.haskell.org/package/risk-weaver)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/sxvcfnz248iqgw3jqdxzpxwnr8406093-risk-weaver-0.1.0.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:576708`
- **Outputs**:
  - `doc`:  `/nix/store/sxvcfnz248iqgw3jqdxzpxwnr8406093-risk-weaver-0.1.0.2`
  - `out`:  `/nix/store/sxvcfnz248iqgw3jqdxzpxwnr8406093-risk-weaver-0.1.0.2`

## 🔗 Dependencies

- [[2ajvn407r7w37qc7rzklb56ldjip3rfj-parallel-3.2.2.0]]
- [[2s7qjircdrkbwcjxw7q0prdrl5flnrxy-risk-weaver-0.1.0.2.tar.gz]]
