...
- **Name**: `rPackages.bsynth`
- **Version**: `1.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/bsynth/](https://cran.r-project.org/web/packages/bsynth/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/jdng4yr7innpa3kqkl9jwmi107ywj36v-r-bsynth-1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/jdng4yr7innpa3kqkl9jwmi107ywj36v-r-bsynth-1.0`
...
- [[3qfp1k2bmfj2bpkhla3ps3qhcqfk8k66-r-vizdraws-2.0.0]]
...
- [[sl4z4vgg1msaxdpkqmi4bnhi8jwr3lf3-bsynth_1.0.tar.gz]]
