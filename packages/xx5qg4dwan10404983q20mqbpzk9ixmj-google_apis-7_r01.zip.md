---
aliases:
  - androidenv.androidPkgs.all.addons.v7.google_apis
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.addons.v7.google_apis`
- **Version**: `7_r01.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/xx5qg4dwan10404983q20mqbpzk9ixmj-google_apis-7_r01.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/xx5qg4dwan10404983q20mqbpzk9ixmj-google_apis-7_r01.zip`
