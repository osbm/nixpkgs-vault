...
- **Name**: `python312Packages.pytrydan`
- **Version**: `0.8.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Library to interface with V2C EVSE Trydan
- **Homepage**: [https://github.com/dgomes/pytrydan](https://github.com/dgomes/pytrydan)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/hpa3hacjm2aq5nivrvxqz08657l2w4l4-python3.12-pytrydan-0.8.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/pytrydan/default.nix:56`
- **Outputs**:
  - `dist`:  `/nix/store/hpa3hacjm2aq5nivrvxqz08657l2w4l4-python3.12-pytrydan-0.8.1`
  - `out`:  `/nix/store/hpa3hacjm2aq5nivrvxqz08657l2w4l4-python3.12-pytrydan-0.8.1`

## 🔗 Dependencies

- [[0f621nx76kqylk1qrg09kx74l66gq70m-source]]
