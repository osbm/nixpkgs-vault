...
- **Homepage**: [https://github.com/PolyMeilex/Neothesia](https://github.com/PolyMeilex/Neothesia)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/acrvvyjzygkayz292bpkh82qsx0kp7sa-neothesia-0.3.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/ne/neothesia/package.nix:65`
- **Outputs**:
  - `out`:  `/nix/store/acrvvyjzygkayz292bpkh82qsx0kp7sa-neothesia-0.3.1`
...
- [[b00wssfz6l4i9pc7adc728m1pwpnxw4w-neothesia-0.3.1-vendor]]
...
- [[y2rdiz0wrfay2djdg3a7qwq72k9zh7d6-source]]
