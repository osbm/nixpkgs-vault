...
- **Name**: `rPackages.covidregionaldata`
- **Version**: `0.9.3`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://cran.r-project.org/web/packages/covidregionaldata/](https://cran.r-project.org/web/packages/covidregionaldata/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/c6s606pwdwia8n6l1bspacvjf3n75yig-r-covidregionaldata-0.9.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/c6s606pwdwia8n6l1bspacvjf3n75yig-r-covidregionaldata-0.9.3`
...
- [[50r1x8p02qc8w620h6fm3npb2dv73is9-covidregionaldata_0.9.3.tar.gz]]
