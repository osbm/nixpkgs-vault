---
aliases:
  - haskellPackages.oauthenticated
tags:
  - broken
  - not-available
  - license/unknown
...
- **Name**: `haskellPackages.oauthenticated`
- **Version**: `0.3.0.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Simple OAuth for http-client
- **Homepage**: [https://hackage.haskell.org/package/oauthenticated](https://hackage.haskell.org/package/oauthenticated)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/47hzjf8bj44l1d01x55b8x2f0dz65ymq-oauthenticated-0.3.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:485900`
- **Outputs**:
  - `doc`:  `/nix/store/47hzjf8bj44l1d01x55b8x2f0dz65ymq-oauthenticated-0.3.0.0`
  - `out`:  `/nix/store/47hzjf8bj44l1d01x55b8x2f0dz65ymq-oauthenticated-0.3.0.0`
...
- [[da3p8k2wlprs0zvw8ynq9y80iz3v1n07-oauthenticated-0.3.0.0.tar.gz]]
