...
- **Name**: `python313Packages.faraday-plugins`
- **Version**: `1.25.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Security tools report parsers for Faraday
- **Homepage**: [https://github.com/infobyte/faraday_plugins](https://github.com/infobyte/faraday_plugins)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/z1zd6phrfzk5l5byg8hz05yzcgncim7v-python3.13-faraday-plugins-1.25.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/faraday-plugins/default.nix:76`
- **Outputs**:
  - `dist`:  `/nix/store/z1zd6phrfzk5l5byg8hz05yzcgncim7v-python3.13-faraday-plugins-1.25.0`
  - `out`:  `/nix/store/z1zd6phrfzk5l5byg8hz05yzcgncim7v-python3.13-faraday-plugins-1.25.0`
...
- [[zwjlll79f8ly6ikxs2srwjmsj7x8bq7l-source]]
