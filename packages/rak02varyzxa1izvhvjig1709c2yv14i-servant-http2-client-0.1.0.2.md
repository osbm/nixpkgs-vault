---
aliases:
  - haskellPackages.servant-http2-client
tags:
  - broken
  - not-available
  - license/unknown
...
- **Name**: `haskellPackages.servant-http2-client`
- **Version**: `0.1.0.2`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Generate HTTP2 clients from Servant API descriptions
- **Homepage**: [https://hackage.haskell.org/package/servant-http2-client](https://hackage.haskell.org/package/servant-http2-client)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/rak02varyzxa1izvhvjig1709c2yv14i-servant-http2-client-0.1.0.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:599012`
- **Outputs**:
  - `doc`:  `/nix/store/rak02varyzxa1izvhvjig1709c2yv14i-servant-http2-client-0.1.0.2`
  - `out`:  `/nix/store/rak02varyzxa1izvhvjig1709c2yv14i-servant-http2-client-0.1.0.2`
...
- [[rzmvidc2x74kkhi3n8cl68sbjvp6fb8w-servant-http2-client-0.1.0.2.tar.gz]]
