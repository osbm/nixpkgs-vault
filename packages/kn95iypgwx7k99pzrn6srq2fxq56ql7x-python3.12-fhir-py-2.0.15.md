...
- **Name**: `python312Packages.fhir-py`
- **Version**: `2.0.15`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Async/sync API for FHIR resources
- **Homepage**: [https://github.com/beda-software/fhir-py](https://github.com/beda-software/fhir-py)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/kn95iypgwx7k99pzrn6srq2fxq56ql7x-python3.12-fhir-py-2.0.15.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/fhir-py/default.nix:54`
- **Outputs**:
  - `dist`:  `/nix/store/kn95iypgwx7k99pzrn6srq2fxq56ql7x-python3.12-fhir-py-2.0.15`
  - `out`:  `/nix/store/kn95iypgwx7k99pzrn6srq2fxq56ql7x-python3.12-fhir-py-2.0.15`

## 🔗 Dependencies

- [[113b6hxwnpbyv852cf0zwd6a6z2w8m68-python3.12-aiohttp-3.12.15]]
- [[5vsffdi0kgla24ca4l9bv0fxzc7s2qyk-pypa-build-hook.sh]]
- [[7v2mjfr8zkpll99gc2yxk6kily6jdnk5-source]]
