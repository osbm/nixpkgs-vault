...
- **Name**: `postgresql14Packages.pgvector`
- **Version**: `0.8.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/6m8qi77561lg34blh2dpg1cf3ld0xh9y-pgvector-0.8.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/sql/postgresql/ext/pgvector.nix:20`
- **Outputs**:
  - `out`:  `/nix/store/6m8qi77561lg34blh2dpg1cf3ld0xh9y-pgvector-0.8.1`
