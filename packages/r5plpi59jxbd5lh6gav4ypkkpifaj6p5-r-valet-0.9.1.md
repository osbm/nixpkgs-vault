...
- **Name**: `rPackages.valet`
- **Version**: `0.9.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/valet/](https://cran.r-project.org/web/packages/valet/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/r5plpi59jxbd5lh6gav4ypkkpifaj6p5-r-valet-0.9.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/r5plpi59jxbd5lh6gav4ypkkpifaj6p5-r-valet-0.9.1`
...
- [[fqral19yr298kj2ss12114fhppzr8x5x-valet_0.9.1.tar.gz]]
