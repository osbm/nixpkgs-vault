...
- **Name**: `openssh_hpnWithKerberos`
- **Version**: `10.0p2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Implementation of the SSH protocol with high performance networking patches
...
- **Derivation Path**: `/nix/store/yzx95q08c6v8r6jn4rbiial0gl2si1q6-openssh-with-hpn-10.0p2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/tools/networking/openssh/common.nix:250`
- **Outputs**:
  - `out`:  `/nix/store/yzx95q08c6v8r6jn4rbiial0gl2si1q6-openssh-with-hpn-10.0p2`
...
- [[xk9s9in3jc6plmf0fd3xbgswbwgvqfji-ssh-hpn-channels.patch]]
- [[ydfwjv5x07mk79la5pasz9wcln9xpdrz-ssh-hpn-wo-channels.patch]]
