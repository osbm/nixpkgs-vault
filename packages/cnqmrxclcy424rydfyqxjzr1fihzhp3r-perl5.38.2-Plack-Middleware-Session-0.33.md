...
- **Name**: `perl538Packages.PlackMiddlewareSession`
- **Version**: `0.33`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Middleware for session management
- **Homepage**: [https://github.com/plack/Plack-Middleware-Session](https://github.com/plack/Plack-Middleware-Session)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/cnqmrxclcy424rydfyqxjzr1fihzhp3r-perl5.38.2-Plack-Middleware-Session-0.33.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/top-level/perl-packages.nix:28384`
- **Outputs**:
  - `devdoc`:  `/nix/store/cnqmrxclcy424rydfyqxjzr1fihzhp3r-perl5.38.2-Plack-Middleware-Session-0.33`
  - `out`:  `/nix/store/cnqmrxclcy424rydfyqxjzr1fihzhp3r-perl5.38.2-Plack-Middleware-Session-0.33`
...
- [[m1k56iy9r24zc190nbhndcgxyr01w36p-Plack-Middleware-Session-0.33.tar.gz]]
