...
- **Name**: `rPackages.cvdprevent`
- **Version**: `0.2.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/cvdprevent/](https://cran.r-project.org/web/packages/cvdprevent/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/cj312hzqnwyl83gafnjkx5fxkpnn4cr4-r-cvdprevent-0.2.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/cj312hzqnwyl83gafnjkx5fxkpnn4cr4-r-cvdprevent-0.2.2`
...
- [[rbhvgby98n0ngnx8z3108qkaknyjdvgc-cvdprevent_0.2.2.tar.gz]]
