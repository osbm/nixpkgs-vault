...
- **Name**: `rPackages.donutsk`
- **Version**: `0.1.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/donutsk/](https://cran.r-project.org/web/packages/donutsk/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/0xs9v62lbp2b7hqylx9jx52nig6xlbyd-r-donutsk-0.1.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/0xs9v62lbp2b7hqylx9jx52nig6xlbyd-r-donutsk-0.1.1`
...
- [[i5n4y946dm42lk654q9rw1n3j5l4v8zc-donutsk_0.1.1.tar.gz]]
