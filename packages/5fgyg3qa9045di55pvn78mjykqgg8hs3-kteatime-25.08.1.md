...
- **Name**: `kdePackages.kteatime`
- **Version**: `25.08.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Handy timer for steeping tea
- **Homepage**: [https://invent.kde.org/utilities/kteatime](https://invent.kde.org/utilities/kteatime)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/5fgyg3qa9045di55pvn78mjykqgg8hs3-kteatime-25.08.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/kde/gear/kteatime/default.nix:3`
- **Outputs**:
  - `debug`:  `/nix/store/5fgyg3qa9045di55pvn78mjykqgg8hs3-kteatime-25.08.1`
  - `dev`:  `/nix/store/5fgyg3qa9045di55pvn78mjykqgg8hs3-kteatime-25.08.1`
  - `devtools`:  `/nix/store/5fgyg3qa9045di55pvn78mjykqgg8hs3-kteatime-25.08.1`
  - `out`:  `/nix/store/5fgyg3qa9045di55pvn78mjykqgg8hs3-kteatime-25.08.1`
...
- [[bd4n4qxghlksz58wzw4ksyf0pac3yssa-kteatime-25.08.1.tar.xz]]
...
---
*Generated on 2025-09-27 13:18:41 UTC*
