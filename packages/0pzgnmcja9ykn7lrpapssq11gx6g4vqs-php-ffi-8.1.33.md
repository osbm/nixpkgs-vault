...
- **Name**: `php81Extensions.ffi`
- **Version**: `8.1.33`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: PHP upstream extension: ffi
...
- **Derivation Path**: `/nix/store/0pzgnmcja9ykn7lrpapssq11gx6g4vqs-php-ffi-8.1.33.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/top-level/php-packages.nix:206`
- **Outputs**:
  - `dev`:  `/nix/store/0pzgnmcja9ykn7lrpapssq11gx6g4vqs-php-ffi-8.1.33`
  - `out`:  `/nix/store/0pzgnmcja9ykn7lrpapssq11gx6g4vqs-php-ffi-8.1.33`
