---
aliases:
  - androidenv.androidPkgs.all.system-images.v27.google_apis.arm64-v8a
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.system-images.v27.google_apis.arm64-v8a`
- **Version**: `27_r03.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/xv6zcwyv5wixlhjnx84mmddjadyl3zq5-arm64-v8a-27_r03.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/xv6zcwyv5wixlhjnx84mmddjadyl3zq5-arm64-v8a-27_r03.zip`
