...
- **Name**: `haskellPackages.opencv-raw`
- **Version**: `0.1.0.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Raw Haskell bindings to OpenCV >= 2.0
- **Homepage**: [https://hackage.haskell.org/package/opencv-raw](https://hackage.haskell.org/package/opencv-raw)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/kcgx51zhqw7iha8pdndh8ggr8hik33zi-opencv-raw-0.1.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:491436`
- **Outputs**:
  - `doc`:  `/nix/store/kcgx51zhqw7iha8pdndh8ggr8hik33zi-opencv-raw-0.1.0.0`
  - `out`:  `/nix/store/kcgx51zhqw7iha8pdndh8ggr8hik33zi-opencv-raw-0.1.0.0`
...
- [[zzpjscnyyrcjbb6whv6sjqzvqrjj3d8b-opencv-raw-0.1.0.0.tar.gz]]
