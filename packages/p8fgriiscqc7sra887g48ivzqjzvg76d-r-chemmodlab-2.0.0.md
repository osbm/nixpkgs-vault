...
- **Name**: `rPackages.chemmodlab`
- **Version**: `2.0.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://cran.r-project.org/web/packages/chemmodlab/](https://cran.r-project.org/web/packages/chemmodlab/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/p8fgriiscqc7sra887g48ivzqjzvg76d-r-chemmodlab-2.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/p8fgriiscqc7sra887g48ivzqjzvg76d-r-chemmodlab-2.0.0`

## 🔗 Dependencies

- [[022mzqmx6d1fvdqpbn0x9c4lmz19bc9l-r-MSQC-1.1.0]]
...
- [[vxmn1imw3a28y4czwbv8mqqi0ifdcad1-chemmodlab_2.0.0.tar.gz]]
