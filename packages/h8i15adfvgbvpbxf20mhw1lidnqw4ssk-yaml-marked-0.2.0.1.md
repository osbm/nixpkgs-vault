...
- **Name**: `haskellPackages.yaml-marked`
- **Version**: `0.2.0.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Support for parsing and rendering YAML documents with marks
- **Homepage**: [https://hackage.haskell.org/package/yaml-marked](https://hackage.haskell.org/package/yaml-marked)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/h8i15adfvgbvpbxf20mhw1lidnqw4ssk-yaml-marked-0.2.0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:735860`
- **Outputs**:
  - `doc`:  `/nix/store/h8i15adfvgbvpbxf20mhw1lidnqw4ssk-yaml-marked-0.2.0.1`
  - `out`:  `/nix/store/h8i15adfvgbvpbxf20mhw1lidnqw4ssk-yaml-marked-0.2.0.1`
...
- [[71ab9mpwall1z7b5wl7scr2lqf2ashld-yaml-marked-0.2.0.1.tar.gz]]
