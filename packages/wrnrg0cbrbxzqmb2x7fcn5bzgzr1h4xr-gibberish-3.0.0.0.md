...
- **Name**: `haskellPackages.gibberish`
- **Version**: `3.0.0.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Generate easy-to-remember, hard-to-guess passwords
- **Homepage**: [https://hackage.haskell.org/package/gibberish](https://hackage.haskell.org/package/gibberish)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/wrnrg0cbrbxzqmb2x7fcn5bzgzr1h4xr-gibberish-3.0.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:267716`
- **Outputs**:
  - `data`:  `/nix/store/wrnrg0cbrbxzqmb2x7fcn5bzgzr1h4xr-gibberish-3.0.0.0`
  - `out`:  `/nix/store/wrnrg0cbrbxzqmb2x7fcn5bzgzr1h4xr-gibberish-3.0.0.0`
...
- [[h74i5jr58dfx46xm7a3m1rhb3vlshrqf-gibberish-3.0.0.0.tar.gz]]
