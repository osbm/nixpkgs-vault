...
- **Homepage**: [https://git.sr.ht/~shinyzenith/waylevel](https://git.sr.ht/~shinyzenith/waylevel)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/szfrjfwcdw7yj273ilqgmpj61spkwhk2-waylevel-1.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/wa/waylevel/package.nix:25`
- **Outputs**:
  - `out`:  `/nix/store/szfrjfwcdw7yj273ilqgmpj61spkwhk2-waylevel-1.0.0`
...
- [[9hcbqbqs216rhwyba07qj8jfjy6vqalq-source]]
- [[bjsb6wdjykafnkixq156qdvmxhsm2bai-bash-5.3p3]]
- [[ihbh6zi2083s8axljy0namvncv1vb8j5-waylevel-1.0.0-vendor]]
