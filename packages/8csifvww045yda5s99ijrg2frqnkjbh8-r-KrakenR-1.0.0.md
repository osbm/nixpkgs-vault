...
- **Name**: `rPackages.KrakenR`
- **Version**: `1.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/KrakenR/](https://cran.r-project.org/web/packages/KrakenR/)
- **License**: `unknown`
