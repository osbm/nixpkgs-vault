...
- **Name**: `haskellPackages.gtk-traymanager`
- **Version**: `1.0.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: A wrapper around the eggtraymanager library for Linux system trays
- **Homepage**: [https://hackage.haskell.org/package/gtk-traymanager](https://hackage.haskell.org/package/gtk-traymanager)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/qlzlns0gjkp894lcq42x2b2887xkqzff-gtk-traymanager-1.0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:286387`
- **Outputs**:
  - `doc`:  `/nix/store/qlzlns0gjkp894lcq42x2b2887xkqzff-gtk-traymanager-1.0.1`
  - `out`:  `/nix/store/qlzlns0gjkp894lcq42x2b2887xkqzff-gtk-traymanager-1.0.1`
...
- [[a8s7m5nf4dgkfn4jpwfim9n2vwnsc2wn-gtk-traymanager-1.0.1.tar.gz]]
