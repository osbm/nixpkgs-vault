...
- **Name**: `python312Packages.stack-data`
- **Version**: `0.6.3`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Extract data from stack frames and tracebacks
- **Homepage**: [https://github.com/alexmojaki/stack_data/](https://github.com/alexmojaki/stack_data/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/sxgcjng46v1hy0aiia28p9hampcrd645-python3.12-stack-data-0.6.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/stack-data/default.nix:61`
- **Outputs**:
  - `dist`:  `/nix/store/sxgcjng46v1hy0aiia28p9hampcrd645-python3.12-stack-data-0.6.3`
  - `out`:  `/nix/store/sxgcjng46v1hy0aiia28p9hampcrd645-python3.12-stack-data-0.6.3`
...
- [[gppkkz8cr88a3df1rm14l953fxy8qvcg-source]]
