...
- **Name**: `rPackages.rzentra`
- **Version**: `0.1.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/rzentra/](https://cran.r-project.org/web/packages/rzentra/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/zid8akkp7iz1mknryfaynpwk811gdjyl-r-rzentra-0.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/zid8akkp7iz1mknryfaynpwk811gdjyl-r-rzentra-0.1.0`
...
- [[r86pd0jx41kh4yyllg8wvjr0r52y9qqb-rzentra_0.1.0.tar.gz]]
