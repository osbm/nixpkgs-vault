...
- **Name**: `rPackages.isoorbi`
- **Version**: `1.3.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/isoorbi/](https://cran.r-project.org/web/packages/isoorbi/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/3ysar4j47k9knyyqahr9kjp5fffmn8pz-r-isoorbi-1.3.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/3ysar4j47k9knyyqahr9kjp5fffmn8pz-r-isoorbi-1.3.1`
...
- [[df1mdrgfqw5xawgs7qh0zdda13i951s2-isoorbi_1.3.1.tar.gz]]
