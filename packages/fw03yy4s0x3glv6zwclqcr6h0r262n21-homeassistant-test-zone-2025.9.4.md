---
aliases:
  - home-assistant-component-tests.zone
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.zone`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/fw03yy4s0x3glv6zwclqcr6h0r262n21-homeassistant-test-zone-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/fw03yy4s0x3glv6zwclqcr6h0r262n21-homeassistant-test-zone-2025.9.4`
