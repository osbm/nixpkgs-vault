...
- **Name**: `rPackages.landsepi`
- **Version**: `1.5.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/landsepi/](https://cran.r-project.org/web/packages/landsepi/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/0fbm48j50y9kwibr1ah77933z8gf9n22-r-landsepi-1.5.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/0fbm48j50y9kwibr1ah77933z8gf9n22-r-landsepi-1.5.2`
...
- [[3sajz4yqbng8gvp736fci5gxg7nl2xw3-landsepi_1.5.2.tar.gz]]
