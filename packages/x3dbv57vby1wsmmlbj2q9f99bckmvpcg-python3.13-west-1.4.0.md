...
- **Name**: `python313Packages.west`
- **Version**: `1.4.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Zephyr RTOS meta tool
- **Homepage**: [https://github.com/zephyrproject-rtos/west](https://github.com/zephyrproject-rtos/west)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/x3dbv57vby1wsmmlbj2q9f99bckmvpcg-python3.13-west-1.4.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/west/default.nix:41`
- **Outputs**:
  - `dist`:  `/nix/store/x3dbv57vby1wsmmlbj2q9f99bckmvpcg-python3.13-west-1.4.0`
  - `out`:  `/nix/store/x3dbv57vby1wsmmlbj2q9f99bckmvpcg-python3.13-west-1.4.0`
...
- [[x2pk60d09yqjmyklix89nqawmr902p30-west-1.4.0.tar.gz]]
