...
Commit changes in your git repository to a new branch without leaving the current branch
...
- **Homepage**: [https://github.com/siedentop/git-quickfix](https://github.com/siedentop/git-quickfix)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/9pnpv5h97zvq76mc399a8zwid44r8bi2-git-quickfix-0.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/gi/git-quickfix/package.nix:37`
- **Outputs**:
  - `out`:  `/nix/store/9pnpv5h97zvq76mc399a8zwid44r8bi2-git-quickfix-0.1.0`
...
- [[9cwaclqnlqpnlflcyzrr86fq2p9694gj-git-quickfix-0.1.0-vendor]]
- [[bjsb6wdjykafnkixq156qdvmxhsm2bai-bash-5.3p3]]
- [[g5w2a7id6j0jgdl5l6cqikkqap6llqvk-source]]
