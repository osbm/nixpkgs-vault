...
- **Name**: `python312Packages.gto`
- **Version**: `1.8.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Module for Git Tag Operations
- **Homepage**: [https://github.com/iterative/gto](https://github.com/iterative/gto)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/0qsg3fh0srxrk032a9gy4xszd7wbynj3-python3.12-gto-1.8.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/gto/default.nix:91`
- **Outputs**:
  - `dist`:  `/nix/store/0qsg3fh0srxrk032a9gy4xszd7wbynj3-python3.12-gto-1.8.0`
  - `out`:  `/nix/store/0qsg3fh0srxrk032a9gy4xszd7wbynj3-python3.12-gto-1.8.0`
...
- [[a0wqjcgp3vhi2m4b1z0wszqi0rqidkh7-source]]
...
- [[kjdxava1w5yykl0sz7mx1kprj3c2zv89-python3.12-pytest-test-utils-0.1.0]]
