...
- **Name**: `haskellPackages.wxc`
- **Version**: `0.92.3.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: wxHaskell C++ wrapper
- **Homepage**: [https://hackage.haskell.org/package/wxc](https://hackage.haskell.org/package/wxc)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/bkan27z25dd8b5zdjh29i8x8vzp3hl58-wxc-0.92.3.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:728475`
- **Outputs**:
  - `out`:  `/nix/store/bkan27z25dd8b5zdjh29i8x8vzp3hl58-wxc-0.92.3.0`
...
- [[qk8cd8561073ih8p79yvjivjm3mrlah8-wxc-0.92.3.0.tar.gz]]
...
- [[ykzgsmcjpc3p1ad1yck5a8y0lqmib525-wxc-0.92.3.0-r1.cabal]]
