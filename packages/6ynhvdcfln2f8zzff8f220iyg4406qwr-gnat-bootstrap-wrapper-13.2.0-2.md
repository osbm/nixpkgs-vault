...
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: GNAT, the GNU Ada Translator (wrapper script)
- **Homepage**: [https://www.gnu.org/software/gnat](https://www.gnu.org/software/gnat)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/6ynhvdcfln2f8zzff8f220iyg4406qwr-gnat-bootstrap-wrapper-13.2.0-2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/build-support/cc-wrapper/default.nix:989`
- **Outputs**:
  - `out`:  `/nix/store/6ynhvdcfln2f8zzff8f220iyg4406qwr-gnat-bootstrap-wrapper-13.2.0-2`
...
- [[c5p1sfh8pbqpvg49yydyk86k95mzr7xk-gnat-bootstrap-13.2.0-2]]
