...
- **Name**: `rPackages.microdiluteR`
- **Version**: `1.0.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/microdiluteR/](https://cran.r-project.org/web/packages/microdiluteR/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/55gil9ahpx97fhlr1dhq06makp4vhziz-r-microdiluteR-1.0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/55gil9ahpx97fhlr1dhq06makp4vhziz-r-microdiluteR-1.0.1`
...
- [[wvpzygaqja9phgcjsfmgndaagh4s5p3h-microdiluteR_1.0.1.tar.gz]]
