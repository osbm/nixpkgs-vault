...
- **Name**: `python312Packages.chex`
- **Version**: `0.1.91`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Library of utilities for helping to write reliable JAX code
- **Homepage**: [https://github.com/deepmind/chex](https://github.com/deepmind/chex)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/jvr5ls4rviv48ly95aqi7xvacg0nr3ca-python3.12-chex-0.1.91.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/chex/default.nix:60`
- **Outputs**:
  - `dist`:  `/nix/store/jvr5ls4rviv48ly95aqi7xvacg0nr3ca-python3.12-chex-0.1.91`
  - `out`:  `/nix/store/jvr5ls4rviv48ly95aqi7xvacg0nr3ca-python3.12-chex-0.1.91`
...
- [[8mrsnay9ksj87aghgrpidg0263p15s98-source]]
