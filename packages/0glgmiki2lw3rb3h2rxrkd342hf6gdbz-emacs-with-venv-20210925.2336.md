...
- **Name**: `emacsPackages.with-venv`
- **Version**: `20210925.2336`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://github.com/10sr/with-venv-el](https://github.com/10sr/with-venv-el)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/0glgmiki2lw3rb3h2rxrkd342hf6gdbz-emacs-with-venv-20210925.2336.drv`
...
- **Outputs**:
  - `out`:  `/nix/store/0glgmiki2lw3rb3h2rxrkd342hf6gdbz-emacs-with-venv-20210925.2336`
...
- [[qpcza9876wj97skkhkn86mr7w2r0022z-with-venv-recipe]]
- [[xdnj342l63zq86y1hhra67cw4dvxv43z-source]]
