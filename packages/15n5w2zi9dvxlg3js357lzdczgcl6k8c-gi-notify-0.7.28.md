...
- **Name**: `haskellPackages.gi-notify`
- **Version**: `0.7.28`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Libnotify bindings
- **Homepage**: [https://hackage.haskell.org/package/gi-notify](https://hackage.haskell.org/package/gi-notify)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/15n5w2zi9dvxlg3js357lzdczgcl6k8c-gi-notify-0.7.28.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:266646`
- **Outputs**:
  - `doc`:  `/nix/store/15n5w2zi9dvxlg3js357lzdczgcl6k8c-gi-notify-0.7.28`
  - `out`:  `/nix/store/15n5w2zi9dvxlg3js357lzdczgcl6k8c-gi-notify-0.7.28`
...
- [[lr9x62sji7n8iw3829f16mbkxx75myql-gi-notify-0.7.28.tar.gz]]
