---
aliases:
  - androidenv.androidPkgs.all.system-images.v36.google_apis.x86_64
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.system-images.v36.google_apis.x86_64`
- **Version**: `36_r06.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/hjn1q3h9ri4yj7v3znx1qn1fa6xsakic-x86_64-36_r06.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/hjn1q3h9ri4yj7v3znx1qn1fa6xsakic-x86_64-36_r06.zip`
