---
aliases:
  - linuxKernel.packages.linux_hardened.sheep-net
tags:
  - license/unknown
...
- **Name**: `linuxKernel.packages.linux_hardened.sheep-net`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/dajaf3qjk2kvvvwd5qww57z17m07xg1w-sheep_net.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/sheep-net/default.nix:10`
- **Outputs**:
  - `out`:  `/nix/store/dajaf3qjk2kvvvwd5qww57z17m07xg1w-sheep_net`
