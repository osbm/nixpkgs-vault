---
aliases:
  - haskellPackages.pipes-key-value-csv
tags:
  - license/unknown
  - outputs/doc
  - outputs/out
...
- **Name**: `haskellPackages.pipes-key-value-csv`
- **Version**: `0.4.0.3`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Streaming processing of CSV files preceded by key-value pairs
- **Homepage**: [https://hackage.haskell.org/package/pipes-key-value-csv](https://hackage.haskell.org/package/pipes-key-value-csv)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/r0sq2wrb6ccjr4f4xd54ldk5q3nr19ss-pipes-key-value-csv-0.4.0.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:520749`
- **Outputs**:
  - `doc`:  `/nix/store/r0sq2wrb6ccjr4f4xd54ldk5q3nr19ss-pipes-key-value-csv-0.4.0.3`
  - `out`:  `/nix/store/r0sq2wrb6ccjr4f4xd54ldk5q3nr19ss-pipes-key-value-csv-0.4.0.3`
...
- [[93n1fv01ghfqd76979w6zrlzajfpc03n-vinyl-utils-0.3.0.1]]
...
- [[lbc0d6rksdkqp170b9ciyrv454qg34cy-pipes-key-value-csv-0.4.0.3.tar.gz]]
