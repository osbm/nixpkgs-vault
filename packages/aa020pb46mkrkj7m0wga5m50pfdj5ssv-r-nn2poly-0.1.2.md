...
- **Name**: `rPackages.nn2poly`
- **Version**: `0.1.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/nn2poly/](https://cran.r-project.org/web/packages/nn2poly/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/aa020pb46mkrkj7m0wga5m50pfdj5ssv-r-nn2poly-0.1.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/aa020pb46mkrkj7m0wga5m50pfdj5ssv-r-nn2poly-0.1.2`

## 🔗 Dependencies

- [[386i5algdy8gdxfznfa64p8mh0s651xb-r-Rcpp-1.1.0]]
- [[92jpf376bwvklhh4k3nrb8ib2laa1mb8-nn2poly_0.1.2.tar.gz]]
