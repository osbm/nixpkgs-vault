---
aliases:
  - home-assistant-component-tests.anthropic
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.anthropic`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/sf4w8x7xgw5s5jj8fkavbgkisxxv71v4-homeassistant-test-anthropic-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/sf4w8x7xgw5s5jj8fkavbgkisxxv71v4-homeassistant-test-anthropic-2025.9.4`
