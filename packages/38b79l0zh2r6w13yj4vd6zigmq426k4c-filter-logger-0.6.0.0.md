...
- **Name**: `haskellPackages.filter-logger`
- **Version**: `0.6.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Filterable request logging wai middleware. Change how data is logged and when.
- **Homepage**: [https://hackage.haskell.org/package/filter-logger](https://hackage.haskell.org/package/filter-logger)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/38b79l0zh2r6w13yj4vd6zigmq426k4c-filter-logger-0.6.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:233665`
- **Outputs**:
  - `doc`:  `/nix/store/38b79l0zh2r6w13yj4vd6zigmq426k4c-filter-logger-0.6.0.0`
  - `out`:  `/nix/store/38b79l0zh2r6w13yj4vd6zigmq426k4c-filter-logger-0.6.0.0`
...
- [[fiay6shwj9adwi1zmsg2idc2ni87llls-filter-logger-0.6.0.0.tar.gz]]
