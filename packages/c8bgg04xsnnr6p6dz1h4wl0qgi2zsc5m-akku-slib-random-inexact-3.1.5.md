---
aliases:
  - akkuPackages.slib-random-inexact
tags:
  - license/unknown
  - outputs/out
---
...
- **Name**: `akkuPackages.slib-random-inexact`
- **Version**: `3.1.5`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/c8bgg04xsnnr6p6dz1h4wl0qgi2zsc5m-akku-slib-random-inexact-3.1.5.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/tools/package-management/akku/default.nix:39`
- **Outputs**:
  - `out`:  `/nix/store/c8bgg04xsnnr6p6dz1h4wl0qgi2zsc5m-akku-slib-random-inexact-3.1.5`
...
- [[mqs2fmydzay4917ycpsx4mm22iiy8s47-slib-random-inexact-SLIB-3b5-r7rs.tgz]]
