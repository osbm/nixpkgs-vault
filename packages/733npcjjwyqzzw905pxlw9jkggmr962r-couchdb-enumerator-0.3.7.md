---
aliases:
  - haskellPackages.couchdb-enumerator
tags:
  - license/unknown
  - outputs/doc
  - outputs/out
...
- **Name**: `haskellPackages.couchdb-enumerator`
- **Version**: `0.3.7`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Couch DB client library using http-enumerator and aeson
- **Homepage**: [https://hackage.haskell.org/package/couchdb-enumerator](https://hackage.haskell.org/package/couchdb-enumerator)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/733npcjjwyqzzw905pxlw9jkggmr962r-couchdb-enumerator-0.3.7.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:164585`
- **Outputs**:
  - `doc`:  `/nix/store/733npcjjwyqzzw905pxlw9jkggmr962r-couchdb-enumerator-0.3.7`
  - `out`:  `/nix/store/733npcjjwyqzzw905pxlw9jkggmr962r-couchdb-enumerator-0.3.7`
...
- [[iwcxxsyaadx38izi2dk4zax6fl8mimrq-couchdb-enumerator-0.3.7.tar.gz]]
