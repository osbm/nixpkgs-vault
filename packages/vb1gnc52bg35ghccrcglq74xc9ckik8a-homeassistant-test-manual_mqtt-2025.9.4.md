---
aliases:
  - home-assistant-component-tests.manual_mqtt
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.manual_mqtt`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/vb1gnc52bg35ghccrcglq74xc9ckik8a-homeassistant-test-manual_mqtt-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/vb1gnc52bg35ghccrcglq74xc9ckik8a-homeassistant-test-manual_mqtt-2025.9.4`
