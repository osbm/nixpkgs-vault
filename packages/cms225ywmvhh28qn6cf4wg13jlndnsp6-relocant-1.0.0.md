...
- **Name**: `haskellPackages.relocant`
- **Version**: `1.0.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: A PostgreSQL migration CLI tool and library
- **Homepage**: [https://hackage.haskell.org/package/relocant](https://hackage.haskell.org/package/relocant)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/cms225ywmvhh28qn6cf4wg13jlndnsp6-relocant-1.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:568902`
- **Outputs**:
  - `doc`:  `/nix/store/cms225ywmvhh28qn6cf4wg13jlndnsp6-relocant-1.0.0`
  - `out`:  `/nix/store/cms225ywmvhh28qn6cf4wg13jlndnsp6-relocant-1.0.0`
...
- [[zhyvpzb98yf4swscx843a7w7ldx4kcqy-relocant-1.0.0.tar.gz]]
