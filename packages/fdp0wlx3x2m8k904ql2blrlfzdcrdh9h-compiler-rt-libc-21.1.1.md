...
- **Name**: `llvmPackages_21.compiler-rt`
- **Version**: `21.1.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/fdp0wlx3x2m8k904ql2blrlfzdcrdh9h-compiler-rt-libc-21.1.1.drv`
...
- **Outputs**:
  - `dev`:  `/nix/store/fdp0wlx3x2m8k904ql2blrlfzdcrdh9h-compiler-rt-libc-21.1.1`
  - `out`:  `/nix/store/fdp0wlx3x2m8k904ql2blrlfzdcrdh9h-compiler-rt-libc-21.1.1`
