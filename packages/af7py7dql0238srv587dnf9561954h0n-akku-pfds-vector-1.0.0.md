...
Some utility functions for working with vectors

## 📋 Package Information

- **Name**: `akkuPackages.pfds-vector`
- **Version**: `1.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Some utility functions for working with vectors
- **Homepage**: []()
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/af7py7dql0238srv587dnf9561954h0n-akku-pfds-vector-1.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/tools/package-management/akku/default.nix:39`
- **Outputs**:
  - `out`:  `/nix/store/af7py7dql0238srv587dnf9561954h0n-akku-pfds-vector-1.0.0`
...
- [[sv2ri2ljpiwhj72vgli97mxy2gnv2vwp-pfds-vector-1.0.0.tgz]]
