...
- **Name**: `haskellPackages.zip-conduit`
- **Version**: `0.3.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Working with zip archives via conduits
- **Homepage**: [https://hackage.haskell.org/package/zip-conduit](https://hackage.haskell.org/package/zip-conduit)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/w2s1xxjgqqy16p1wbq8q0ngcmj4w3rx1-zip-conduit-0.3.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:747790`
- **Outputs**:
  - `doc`:  `/nix/store/w2s1xxjgqqy16p1wbq8q0ngcmj4w3rx1-zip-conduit-0.3.0`
  - `out`:  `/nix/store/w2s1xxjgqqy16p1wbq8q0ngcmj4w3rx1-zip-conduit-0.3.0`
...
- [[r3z5dvqwxbqipzrvv5ib8dg7ssks49jb-zip-conduit-0.3.0.tar.gz]]
