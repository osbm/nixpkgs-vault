...
- **Name**: `coqPackages.mathcomp-zify`
- **Version**: `1.5.0+2.0+8.16`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Micromega tactics for Mathematical Components
- **Homepage**: [https://github.com/math-comp/mczify](https://github.com/math-comp/mczify)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/l7x8ni6d38hnn07nlcarms7jawkymyps-coq9.0-mathcomp2.4-zify-1.5.0+2.0+8.16.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/coq-modules/mathcomp-zify/default.nix:55`
- **Outputs**:
  - `out`:  `/nix/store/l7x8ni6d38hnn07nlcarms7jawkymyps-coq9.0-mathcomp2.4-zify-1.5.0+2.0+8.16`
...
- [[7j7brlxhy34sh4nanfw612f15vdciivb-source]]
