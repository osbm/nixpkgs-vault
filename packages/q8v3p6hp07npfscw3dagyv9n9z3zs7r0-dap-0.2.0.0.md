...
- **Name**: `haskellPackages.dap`
- **Version**: `0.2.0.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: A debug adaptor protocol library
- **Homepage**: [https://hackage.haskell.org/package/dap](https://hackage.haskell.org/package/dap)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/q8v3p6hp07npfscw3dagyv9n9z3zs7r0-dap-0.2.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:175245`
- **Outputs**:
  - `doc`:  `/nix/store/q8v3p6hp07npfscw3dagyv9n9z3zs7r0-dap-0.2.0.0`
  - `out`:  `/nix/store/q8v3p6hp07npfscw3dagyv9n9z3zs7r0-dap-0.2.0.0`
...
- [[rgi81yj8dkvs514lvhrvc29ifdacbvqh-dap-0.2.0.0.tar.gz]]
