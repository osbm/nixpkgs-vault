---
aliases:
  - haskellPackages.yesod-session-persist
tags:
  - license/unknown
  - outputs/out
---
...
SQL session backend for Yesod

## 📋 Package Information

- **Name**: `haskellPackages.yesod-session-persist`
- **Version**: `0.0.0.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: SQL session backend for Yesod
- **Homepage**: [https://hackage.haskell.org/package/yesod-session-persist](https://hackage.haskell.org/package/yesod-session-persist)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/j503xipspin8sjhxrlhffz2fv77k5h4k-yesod-session-persist-0.0.0.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:742461`
- **Outputs**:
  - `out`:  `/nix/store/j503xipspin8sjhxrlhffz2fv77k5h4k-yesod-session-persist-0.0.0.2`

## 🔗 Dependencies

- [[2pr652igq6awvbbf5rfnb3kbrmg1cryf-http-types-0.12.4]]
- [[44ra45qdvlr31rv7v4268nh9g04zmwqc-yesod-session-persist-0.0.0.2.tar.gz]]
