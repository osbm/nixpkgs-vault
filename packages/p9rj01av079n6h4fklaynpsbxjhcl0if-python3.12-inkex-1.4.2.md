...
- **Name**: `python312Packages.inkex`
- **Version**: `1.4.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Library for manipulating SVG documents which is the basis for Inkscape extensions
- **Homepage**: [https://gitlab.com/inkscape/extensions](https://gitlab.com/inkscape/extensions)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/p9rj01av079n6h4fklaynpsbxjhcl0if-python3.12-inkex-1.4.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/inkex/default.nix:85`
- **Outputs**:
  - `dist`:  `/nix/store/p9rj01av079n6h4fklaynpsbxjhcl0if-python3.12-inkex-1.4.2`
  - `out`:  `/nix/store/p9rj01av079n6h4fklaynpsbxjhcl0if-python3.12-inkex-1.4.2`
...
- [[xszzmihay54w7pffn7632kzyqll1qmi8-python3.12-scour-0.38.2]]
