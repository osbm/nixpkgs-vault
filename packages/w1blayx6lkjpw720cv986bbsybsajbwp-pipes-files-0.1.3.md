...
- **Name**: `haskellPackages.pipes-files`
- **Version**: `0.1.3`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Fast traversal of directory trees using pipes
- **Homepage**: [https://hackage.haskell.org/package/pipes-files](https://hackage.haskell.org/package/pipes-files)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/w1blayx6lkjpw720cv986bbsybsajbwp-pipes-files-0.1.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:520426`
- **Outputs**:
  - `doc`:  `/nix/store/w1blayx6lkjpw720cv986bbsybsajbwp-pipes-files-0.1.3`
  - `out`:  `/nix/store/w1blayx6lkjpw720cv986bbsybsajbwp-pipes-files-0.1.3`
...
- [[z69mc1q7nj862j4sw0hfnmx0md39nsmj-hierarchy-1.0.2]]
- [[zw3ygm0iax4rkyyq0yidqgisa4xs2vp4-pipes-files-0.1.3.tar.gz]]
