---
aliases:
  - androidenv.androidPkgs.all.system-images.v35.default.x86_64
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.system-images.v35.default.x86_64`
- **Version**: `35_r02.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/7j20nrfsza24jgbxblzb3qx9fpihdiji-x86_64-35_r02.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/7j20nrfsza24jgbxblzb3qx9fpihdiji-x86_64-35_r02.zip`
