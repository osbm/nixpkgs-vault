...
- **Name**: `rPackages.RMixtCompIO`
- **Version**: `4.0.11`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/RMixtCompIO/](https://cran.r-project.org/web/packages/RMixtCompIO/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/sj4yhppypchmhc4cj5sff23fmkbh8zzb-r-RMixtCompIO-4.0.11.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/sj4yhppypchmhc4cj5sff23fmkbh8zzb-r-RMixtCompIO-4.0.11`
...
- [[ihppns2zpc5yw60wv9cl2v8y7p2x82kd-RMixtCompIO_4.0.11.tar.gz]]
