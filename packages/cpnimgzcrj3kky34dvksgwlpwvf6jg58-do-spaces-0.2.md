...
- **Name**: `haskellPackages.do-spaces`
- **Version**: `0.2`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: DigitalOcean Spaces API bindings
- **Homepage**: [https://hackage.haskell.org/package/do-spaces](https://hackage.haskell.org/package/do-spaces)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/cpnimgzcrj3kky34dvksgwlpwvf6jg58-do-spaces-0.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:199517`
- **Outputs**:
  - `doc`:  `/nix/store/cpnimgzcrj3kky34dvksgwlpwvf6jg58-do-spaces-0.2`
  - `out`:  `/nix/store/cpnimgzcrj3kky34dvksgwlpwvf6jg58-do-spaces-0.2`
...
- [[558fmlxyalgik1dbn6y1fp9d85ggv5sa-do-spaces-0.2.tar.gz]]
