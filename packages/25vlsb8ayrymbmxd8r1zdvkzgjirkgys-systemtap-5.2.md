---
aliases:
  - linuxKernel.packages.linux_hardened.systemtap
tags:
  - license/unknown
  - outputs/out
---
...
- **Name**: `linuxKernel.packages.linux_hardened.systemtap`
- **Version**: `5.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/25vlsb8ayrymbmxd8r1zdvkzgjirkgys-systemtap-5.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/sy/systemtap-unwrapped/package.nix:37`
- **Outputs**:
  - `out`:  `/nix/store/25vlsb8ayrymbmxd8r1zdvkzgjirkgys-systemtap-5.2`
...
- [[p7xnfknswn445x6v40wqxp4dg8rcc985-systemtap-sysroot-6.12.43]]
