...
A library used for parsing "scribble" format, introduced by Racket and the format used to write this manual

## 📋 Package Information

- **Name**: `akkuPackages.chibi-scribble`
- **Version**: `0.9.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/3nndmcjh2raf96jcczdg6cghjrr994w6-akku-chibi-scribble-0.9.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/tools/package-management/akku/default.nix:39`
- **Outputs**:
  - `out`:  `/nix/store/3nndmcjh2raf96jcczdg6cghjrr994w6-akku-chibi-scribble-0.9.0`
...
- [[sb31r2vl895dkynyv9vcscx4ffysbzlj-chibi-scribble-0.9.0.tgz]]
