---
aliases:
  - haskellPackages.http-conduit-browser
tags:
  - broken
  - not-available
  - license/unknown
...
- **Name**: `haskellPackages.http-conduit-browser`
- **Version**: `2.0.0.1`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Browser interface to the http-conduit package
- **Homepage**: [https://hackage.haskell.org/package/http-conduit-browser](https://hackage.haskell.org/package/http-conduit-browser)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/fng5pg432ydmx8s7acdy24nkiv8f2gk7-http-conduit-browser-2.0.0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:361218`
- **Outputs**:
  - `doc`:  `/nix/store/fng5pg432ydmx8s7acdy24nkiv8f2gk7-http-conduit-browser-2.0.0.1`
  - `out`:  `/nix/store/fng5pg432ydmx8s7acdy24nkiv8f2gk7-http-conduit-browser-2.0.0.1`
...
- [[pm8gkfmn4d3adb5am7k6s8liw1kh4f8p-http-conduit-browser-2.0.0.1.tar.gz]]
