...
- **Name**: `nodePackages.prebuild-install`
- **Version**: `7.1.3`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/dz70f1l954ysllrn492iywfpimg0zx03-prebuild-install-7.1.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/node-packages/node-packages.nix:61451`
- **Outputs**:
  - `out`:  `/nix/store/dz70f1l954ysllrn492iywfpimg0zx03-prebuild-install-7.1.3`
