...
- **Name**: `rPackages.tidyedgar`
- **Version**: `1.0.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/tidyedgar/](https://cran.r-project.org/web/packages/tidyedgar/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/sqiyar8iqakp0mgnxmr989927vjlcldn-r-tidyedgar-1.0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/sqiyar8iqakp0mgnxmr989927vjlcldn-r-tidyedgar-1.0.1`

## 🔗 Dependencies

- [[3086h903fval3kf9rmv3d5y3cfpbqbrz-tidyedgar_1.0.1.tar.gz]]
