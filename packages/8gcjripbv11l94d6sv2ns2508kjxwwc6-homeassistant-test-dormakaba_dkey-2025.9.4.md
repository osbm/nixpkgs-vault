---
aliases:
  - home-assistant-component-tests.dormakaba_dkey
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.dormakaba_dkey`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/8gcjripbv11l94d6sv2ns2508kjxwwc6-homeassistant-test-dormakaba_dkey-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/8gcjripbv11l94d6sv2ns2508kjxwwc6-homeassistant-test-dormakaba_dkey-2025.9.4`
...
- [[8slqmxnmsnl7kcvllyfz6n478kch8548-python3.13-py-dormakaba-dkey-1.0.6]]
