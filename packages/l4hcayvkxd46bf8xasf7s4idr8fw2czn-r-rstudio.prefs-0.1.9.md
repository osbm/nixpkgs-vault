...
- **Name**: `rPackages.rstudio_prefs`
- **Version**: `0.1.9`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/rstudio.prefs/](https://cran.r-project.org/web/packages/rstudio.prefs/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/l4hcayvkxd46bf8xasf7s4idr8fw2czn-r-rstudio.prefs-0.1.9.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/l4hcayvkxd46bf8xasf7s4idr8fw2czn-r-rstudio.prefs-0.1.9`
...
- [[d7smcq819acsxr3vp6kl03kkxqw6lln4-rstudio.prefs_0.1.9.tar.gz]]
