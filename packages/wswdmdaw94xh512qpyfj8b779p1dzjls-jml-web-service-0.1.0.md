---
aliases:
  - haskellPackages.jml-web-service
tags:
  - broken
  - not-available
  - license/unknown
...
- **Name**: `haskellPackages.jml-web-service`
- **Version**: `0.1.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Common utilities for running a web service
- **Homepage**: [https://hackage.haskell.org/package/jml-web-service](https://hackage.haskell.org/package/jml-web-service)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/wswdmdaw94xh512qpyfj8b779p1dzjls-jml-web-service-0.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:390053`
- **Outputs**:
  - `doc`:  `/nix/store/wswdmdaw94xh512qpyfj8b779p1dzjls-jml-web-service-0.1.0`
  - `out`:  `/nix/store/wswdmdaw94xh512qpyfj8b779p1dzjls-jml-web-service-0.1.0`
...
- [[84zff62wkz0lccb0mnsizbkdyyrbdb9w-jml-web-service-0.1.0.tar.gz]]
