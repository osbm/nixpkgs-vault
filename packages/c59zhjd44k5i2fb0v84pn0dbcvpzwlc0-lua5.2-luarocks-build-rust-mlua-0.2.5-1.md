---
aliases:
  - lua52Packages.luarocks-build-rust-mlua
tags:
  - license/unknown
  - maintainers/mrcjkb
  - outputs/out
...
- **Name**: `lua52Packages.luarocks-build-rust-mlua`
- **Version**: `0.2.5-1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/c59zhjd44k5i2fb0v84pn0dbcvpzwlc0-lua5.2-luarocks-build-rust-mlua-0.2.5-1.drv`
...
- **Outputs**:
  - `out`:  `/nix/store/c59zhjd44k5i2fb0v84pn0dbcvpzwlc0-lua5.2-luarocks-build-rust-mlua-0.2.5-1`
...
- [[ig1awl29lrnvqij0p3k4p8chya0j6y02-luarocks-build-rust-mlua-luarocks-config.lua]]
