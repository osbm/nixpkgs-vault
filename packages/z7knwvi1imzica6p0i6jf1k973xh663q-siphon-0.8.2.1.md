...
- **Name**: `haskellPackages.siphon`
- **Version**: `0.8.2.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Encode and decode CSV files
- **Homepage**: [https://hackage.haskell.org/package/siphon](https://hackage.haskell.org/package/siphon)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/z7knwvi1imzica6p0i6jf1k973xh663q-siphon-0.8.2.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:614305`
- **Outputs**:
  - `doc`:  `/nix/store/z7knwvi1imzica6p0i6jf1k973xh663q-siphon-0.8.2.1`
  - `out`:  `/nix/store/z7knwvi1imzica6p0i6jf1k973xh663q-siphon-0.8.2.1`
...
- [[mzqzsp0dcblqgg20jjpsinkamrqnfykg-siphon-0.8.2.1.tar.gz]]
