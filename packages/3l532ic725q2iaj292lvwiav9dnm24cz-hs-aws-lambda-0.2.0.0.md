...
- **Name**: `haskellPackages.hs-aws-lambda`
- **Version**: `0.2.0.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: A modern and easy-to-use wrapper for Docker-based Lambda implementations. Now with API Gateway support!
- **Homepage**: [https://hackage.haskell.org/package/hs-aws-lambda](https://hackage.haskell.org/package/hs-aws-lambda)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/3l532ic725q2iaj292lvwiav9dnm24cz-hs-aws-lambda-0.2.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:345726`
- **Outputs**:
  - `doc`:  `/nix/store/3l532ic725q2iaj292lvwiav9dnm24cz-hs-aws-lambda-0.2.0.0`
  - `out`:  `/nix/store/3l532ic725q2iaj292lvwiav9dnm24cz-hs-aws-lambda-0.2.0.0`
...
- [[rslqzggfix7wdf8ps0pjpjwaiw0nwz2n-hs-aws-lambda-0.2.0.0.tar.gz]]
