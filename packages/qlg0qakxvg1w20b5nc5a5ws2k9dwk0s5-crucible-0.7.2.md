...
- **Name**: `haskellPackages.crucible`
- **Version**: `0.7.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Crucible is a library for language-agnostic symbolic simulation
- **Homepage**: [https://hackage.haskell.org/package/crucible](https://hackage.haskell.org/package/crucible)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/qlg0qakxvg1w20b5nc5a5ws2k9dwk0s5-crucible-0.7.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:168115`
- **Outputs**:
  - `doc`:  `/nix/store/qlg0qakxvg1w20b5nc5a5ws2k9dwk0s5-crucible-0.7.2`
  - `out`:  `/nix/store/qlg0qakxvg1w20b5nc5a5ws2k9dwk0s5-crucible-0.7.2`
...
- [[q7qcyfr8n1pamajqkav52k9iawv1asfc-crucible-0.7.2.tar.gz]]
...
---
*Generated on 2025-09-27 12:40:05 UTC*
