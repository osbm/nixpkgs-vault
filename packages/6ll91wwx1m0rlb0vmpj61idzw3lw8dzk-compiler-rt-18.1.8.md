---
aliases:
  - llvmPackages_18.compiler-rt-no-libc
tags:
  - license/unknown
  - maintainers/dtzWill
  - maintainers/emilazy
...
- **Name**: `llvmPackages_18.compiler-rt-no-libc`
- **Version**: `18.1.8`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/6ll91wwx1m0rlb0vmpj61idzw3lw8dzk-compiler-rt-18.1.8.drv`
...
- **Outputs**:
  - `dev`:  `/nix/store/6ll91wwx1m0rlb0vmpj61idzw3lw8dzk-compiler-rt-18.1.8`
  - `out`:  `/nix/store/6ll91wwx1m0rlb0vmpj61idzw3lw8dzk-compiler-rt-18.1.8`
...
- [[ll3rnfw8rgwmcx21jvb5njdqgwhb95w4-stdenv-linux]]
