...
- **Name**: `linuxKernel.packages.linux_lqx.veikk-linux-driver`
- **Version**: `2.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/bxg4gcjpxzakpvhdsg6sbkbknkiza35d-veikk-linux-driver-2.0.drv`
...
- **Outputs**:
  - `out`:  `/nix/store/bxg4gcjpxzakpvhdsg6sbkbknkiza35d-veikk-linux-driver-2.0`
