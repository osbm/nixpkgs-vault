...
- **Name**: `rPackages.diffudist`
- **Version**: `1.0.1`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://cran.r-project.org/web/packages/diffudist/](https://cran.r-project.org/web/packages/diffudist/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/34wda4m3jgp207wvqn5y7wi5336v8lvc-r-diffudist-1.0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/34wda4m3jgp207wvqn5y7wi5336v8lvc-r-diffudist-1.0.1`
...
- [[yjnyfh0nwl9pcqizc0w97rsh3ia5pi64-diffudist_1.0.1.tar.gz]]
