---
aliases:
  - androidenv.androidPkgs.all.system-images.v19.default.x86
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.system-images.v19.default.x86`
- **Version**: `19_r06.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/yqvn9k9lkj6xlgjybxq4rg0nis3cnhiz-x86-19_r06.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/yqvn9k9lkj6xlgjybxq4rg0nis3cnhiz-x86-19_r06.zip`
