...
- **Name**: `postgresql18Packages.timescaledb`
- **Version**: `2.22.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
...
- **Derivation Path**: `/nix/store/70vm1n8b5hxhwhykdpj97k69yhxdd0bl-timescaledb-2.22.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/sql/postgresql/ext/timescaledb.nix:98`
- **Outputs**:
  - `out`:  `/nix/store/70vm1n8b5hxhwhykdpj97k69yhxdd0bl-timescaledb-2.22.0`
