...
- **Name**: `rPackages.deckgl`
- **Version**: `0.3.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/deckgl/](https://cran.r-project.org/web/packages/deckgl/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/yqic8g3if3gbssga2f5cdpr6l9akii2i-r-deckgl-0.3.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/yqic8g3if3gbssga2f5cdpr6l9akii2i-r-deckgl-0.3.0`
...
- [[vmva7px0zmvsmlg7ksq22psa9yvczy1h-deckgl_0.3.0.tar.gz]]
