...
- **Name**: `python312Packages.pypubsub`
- **Version**: `4.0.3`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/2qg84nq1jir9s6gg2sm7151i26z7zy9h-python3.12-pypubsub-4.0.3.drv`
...
- **Outputs**:
  - `dist`:  `/nix/store/2qg84nq1jir9s6gg2sm7151i26z7zy9h-python3.12-pypubsub-4.0.3`
  - `out`:  `/nix/store/2qg84nq1jir9s6gg2sm7151i26z7zy9h-python3.12-pypubsub-4.0.3`
