...
- **Name**: `haskellPackages.bindings-gobject`
- **Version**: `0.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Low level bindings supporting GObject and derived libraries
- **Homepage**: [https://hackage.haskell.org/package/bindings-gobject](https://hackage.haskell.org/package/bindings-gobject)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/hcm82dz89baga8phrw3lypnrs7h3zsmp-bindings-gobject-0.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:104971`
- **Outputs**:
  - `doc`:  `/nix/store/hcm82dz89baga8phrw3lypnrs7h3zsmp-bindings-gobject-0.4`
  - `out`:  `/nix/store/hcm82dz89baga8phrw3lypnrs7h3zsmp-bindings-gobject-0.4`
...
- [[c11q8yz8xwxvxgbzcwah01pb6daw5mn8-bindings-gobject-0.4.tar.gz]]
