...
- **Name**: `python313Packages.sopel`
- **Version**: `8.0.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Simple and extensible IRC bot
- **Homepage**: [https://sopel.chat](https://sopel.chat)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/rsw0vbz9bskrvz2v0lhzjbvmwydby8xi-python3.13-sopel-8.0.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/sopel/default.nix:82`
- **Outputs**:
  - `dist`:  `/nix/store/rsw0vbz9bskrvz2v0lhzjbvmwydby8xi-python3.13-sopel-8.0.4`
  - `out`:  `/nix/store/rsw0vbz9bskrvz2v0lhzjbvmwydby8xi-python3.13-sopel-8.0.4`
...
- [[i59vf102af5lnb9vl6w8l2v5a5sd758d-python3.13-praw-7.8.1]]
...
- [[pbwpjiy6dn65g91a415ach671i4cw1k7-sopel-8.0.4.tar.gz]]
