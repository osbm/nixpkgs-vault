...
- **Name**: `haskellPackages.tahoe-ssk`
- **Version**: `0.3.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: An implementation of the Tahoe-LAFS SSK cryptographic protocols
- **Homepage**: [https://hackage.haskell.org/package/tahoe-ssk](https://hackage.haskell.org/package/tahoe-ssk)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/7wr2kphq5imch9kg7nv6y7d196i2nzx9-tahoe-ssk-0.3.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:656008`
- **Outputs**:
  - `doc`:  `/nix/store/7wr2kphq5imch9kg7nv6y7d196i2nzx9-tahoe-ssk-0.3.0.0`
  - `out`:  `/nix/store/7wr2kphq5imch9kg7nv6y7d196i2nzx9-tahoe-ssk-0.3.0.0`
...
- [[x8cfr5pz5j3mha4ax1ghqry5ksry0mgq-tahoe-ssk-0.3.0.0.tar.gz]]
