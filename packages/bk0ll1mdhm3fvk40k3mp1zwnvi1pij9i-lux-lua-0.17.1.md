...
Lua API for the Lux package manager

## 📋 Package Information

- **Name**: `luajitPackages.lux-lua`
- **Version**: `0.17.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Lua API for the Lux package manager
- **Homepage**: [https://lux.lumen-labs.org/](https://lux.lumen-labs.org/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/bk0ll1mdhm3fvk40k3mp1zwnvi1pij9i-lux-lua-0.17.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/lua-modules/lux-lua.nix:83`
- **Outputs**:
  - `out`:  `/nix/store/bk0ll1mdhm3fvk40k3mp1zwnvi1pij9i-lux-lua-0.17.1`

## 🔗 Dependencies

- [[07hx2s3mrfcfiyq40qxy2612x1lmvd4x-lux-lua-0.17.1-vendor]]
...
- [[d1ax6k1bhjlp5bz730h66v3f0qlhz2z0-source]]
