---
aliases:
  - home-assistant-component-tests.tailwind
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.tailwind`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/p7wlvjyg6ip4k4x542r1p5jpy37p4lqb-homeassistant-test-tailwind-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/p7wlvjyg6ip4k4x542r1p5jpy37p4lqb-homeassistant-test-tailwind-2025.9.4`
...
- [[rakrzwfmlp71hw3la4p3bl0bba4s41rr-python3.13-gotailwind-0.3.0]]
