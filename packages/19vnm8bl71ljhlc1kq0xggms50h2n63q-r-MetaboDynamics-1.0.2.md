...
- **Name**: `rPackages.MetaboDynamics`
- **Version**: `1.0.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://bioconductor.org/packages/3.21/bioc/html/MetaboDynamics.html](https://bioconductor.org/packages/3.21/bioc/html/MetaboDynamics.html)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/19vnm8bl71ljhlc1kq0xggms50h2n63q-r-MetaboDynamics-1.0.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/19vnm8bl71ljhlc1kq0xggms50h2n63q-r-MetaboDynamics-1.0.2`
...
- [[mygdxml8xvgbjpihy602sl329w45d7z1-MetaboDynamics_1.0.2.tar.gz]]
