...
- **Name**: `python312Packages.filedepot`
- **Version**: `0.11.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Toolkit for storing files and attachments in web applications
- **Homepage**: [https://github.com/amol-/depot](https://github.com/amol-/depot)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/yp6pwhf1s4dyqqy8ps0x3q5999ld960h-python3.12-filedepot-0.11.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/filedepot/default.nix:67`
- **Outputs**:
  - `dist`:  `/nix/store/yp6pwhf1s4dyqqy8ps0x3q5999ld960h-python3.12-filedepot-0.11.0`
  - `out`:  `/nix/store/yp6pwhf1s4dyqqy8ps0x3q5999ld960h-python3.12-filedepot-0.11.0`
...
- [[imi19yl27zxhxsv62jg1s28najz57sp3-source]]
