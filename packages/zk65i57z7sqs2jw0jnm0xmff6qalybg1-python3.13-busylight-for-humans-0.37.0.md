...
- **Name**: `python313Packages.busylight-for-humans`
- **Version**: `0.37.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Control USB connected presence lights from multiple vendors via the command-line or web API
- **Homepage**: [https://github.com/JnyJny/busylight](https://github.com/JnyJny/busylight)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/zk65i57z7sqs2jw0jnm0xmff6qalybg1-python3.13-busylight-for-humans-0.37.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/busylight-for-humans/default.nix:68`
- **Outputs**:
  - `dist`:  `/nix/store/zk65i57z7sqs2jw0jnm0xmff6qalybg1-python3.13-busylight-for-humans-0.37.0`
  - `out`:  `/nix/store/zk65i57z7sqs2jw0jnm0xmff6qalybg1-python3.13-busylight-for-humans-0.37.0`
...
- [[q992b5n2ccgfdyikpk24fn4c8crypib0-source]]
...
- [[yciw829vw3rxfcrv0f8g8l04jl4ycxqg-python3.13-bitvector-for-humans-0.14.1]]
