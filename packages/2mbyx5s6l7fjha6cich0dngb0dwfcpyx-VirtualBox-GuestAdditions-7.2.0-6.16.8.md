---
aliases:
  - linuxKernel.packages.linux_xanmod_stable.virtualboxGuestAdditions
tags:
  - license/unknown
...
- **Name**: `linuxKernel.packages.linux_xanmod_stable.virtualboxGuestAdditions`
...
- **Derivation Path**: `/nix/store/2mbyx5s6l7fjha6cich0dngb0dwfcpyx-VirtualBox-GuestAdditions-7.2.0-6.16.8.drv`
...
- **Outputs**:
  - `out`:  `/nix/store/2mbyx5s6l7fjha6cich0dngb0dwfcpyx-VirtualBox-GuestAdditions-7.2.0-6.16.8`
...
- [[mk3hjx16mghmqhykqyfcmkw88rjim2pj-VirtualBox-GuestAdditions-builder-6.16.8-7.2.0]]
