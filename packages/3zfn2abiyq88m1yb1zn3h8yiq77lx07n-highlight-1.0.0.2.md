...
- **Name**: `haskellPackages.highlight`
- **Version**: `1.0.0.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Command line tool for highlighting parts of files matching a regex
- **Homepage**: [https://hackage.haskell.org/package/highlight](https://hackage.haskell.org/package/highlight)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/3zfn2abiyq88m1yb1zn3h8yiq77lx07n-highlight-1.0.0.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:327843`
- **Outputs**:
  - `doc`:  `/nix/store/3zfn2abiyq88m1yb1zn3h8yiq77lx07n-highlight-1.0.0.2`
  - `out`:  `/nix/store/3zfn2abiyq88m1yb1zn3h8yiq77lx07n-highlight-1.0.0.2`
...
- [[80bh4dmcb6y1l0sf95503799zvajxrp5-highlight-1.0.0.2.tar.gz]]
...
- [[bbyyhji46snjfwhsqasx4kasfmmlb45s-regex-1.1.0.2]]
...
- [[lcbwkp0m8p9fwi3m95fd8mf8qjygq6mh-regex-with-pcre-1.1.0.2]]
