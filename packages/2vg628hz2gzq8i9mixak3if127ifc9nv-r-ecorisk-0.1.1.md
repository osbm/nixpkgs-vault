...
- **Name**: `rPackages.ecorisk`
- **Version**: `0.1.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/ecorisk/](https://cran.r-project.org/web/packages/ecorisk/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/2vg628hz2gzq8i9mixak3if127ifc9nv-r-ecorisk-0.1.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/2vg628hz2gzq8i9mixak3if127ifc9nv-r-ecorisk-0.1.1`
...
- [[hia08fdm22zsc2gslh4k6i77c152fp8w-ecorisk_0.1.1.tar.gz]]
