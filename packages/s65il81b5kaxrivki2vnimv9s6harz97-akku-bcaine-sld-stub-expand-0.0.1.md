...
- **Name**: `akkuPackages.bcaine-sld-stub-expand`
- **Version**: `0.0.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Expands library declarations (`define-unprocessed-library` instead of `define-library`), and generates export statements for all the identifiers in .stub files
- **Homepage**: []()
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/s65il81b5kaxrivki2vnimv9s6harz97-akku-bcaine-sld-stub-expand-0.0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/tools/package-management/akku/default.nix:39`
- **Outputs**:
  - `out`:  `/nix/store/s65il81b5kaxrivki2vnimv9s6harz97-akku-bcaine-sld-stub-expand-0.0.1`
...
- [[qw40x2y3ydnjl2kfwcnncj30m6sq4wii-bcaine-sld-stub-expand-0.0.1.tgz]]
