...
- **Name**: `haskellPackages.persistent`
- **Version**: `2.14.6.3`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Type-safe, multi-backend data serialization
- **Homepage**: [https://hackage.haskell.org/package/persistent](https://hackage.haskell.org/package/persistent)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/7p8yj2yp7fc043bjy441p4aiaznjvgi9-persistent-2.14.6.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:512044`
- **Outputs**:
  - `doc`:  `/nix/store/7p8yj2yp7fc043bjy441p4aiaznjvgi9-persistent-2.14.6.3`
  - `out`:  `/nix/store/7p8yj2yp7fc043bjy441p4aiaznjvgi9-persistent-2.14.6.3`
...
- [[21wd54a53pmlzab0b6kmnb75r6as20zp-persistent-2.14.6.3.tar.gz]]
...
- [[br3ql4wfxmangcnnbcr3j44hf5qv9ky8-persistent-2.14.6.3-r1.cabal]]
