...
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/RSSL/](https://cran.r-project.org/web/packages/RSSL/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/kk9xfiigw7casn2if49mldk1spcsafar-r-RSSL-0.9.7.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/kk9xfiigw7casn2if49mldk1spcsafar-r-RSSL-0.9.7`
...
- [[bxz5p63p715l24r1vyqx0wg42kzl8n48-RSSL_0.9.7.tar.gz]]
