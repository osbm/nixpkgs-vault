...
- **Name**: `haskellPackages.domain-auth`
- **Version**: `0.2.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Domain authentication library
- **Homepage**: [https://hackage.haskell.org/package/domain-auth](https://hackage.haskell.org/package/domain-auth)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/xm76lhg0jjhi3m79x08p4npzsm8fxvw4-domain-auth-0.2.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:201915`
- **Outputs**:
  - `doc`:  `/nix/store/xm76lhg0jjhi3m79x08p4npzsm8fxvw4-domain-auth-0.2.4`
  - `out`:  `/nix/store/xm76lhg0jjhi3m79x08p4npzsm8fxvw4-domain-auth-0.2.4`

## 🔗 Dependencies

- [[1kqyfajc5xnj57d47qqh680pypm8zsic-pretty-simple-4.1.3.0]]
- [[24m66ckzlxr969qhmnafrznc290gzing-domain-auth-0.2.4.tar.gz]]
