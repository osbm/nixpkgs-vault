...
- **Name**: `rPackages.tidyHeatmap`
- **Version**: `1.12.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/tidyHeatmap/](https://cran.r-project.org/web/packages/tidyHeatmap/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/njmww31gs5wiz635c70yiybkkppnsxvq-r-tidyHeatmap-1.12.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/njmww31gs5wiz635c70yiybkkppnsxvq-r-tidyHeatmap-1.12.2`
...
- [[flcwidw930pxqhym173q8za3px0gkvby-tidyHeatmap_1.12.2.tar.gz]]
