...
- **Derivation Path**: `/nix/store/7s0z02ghzdj9s9av0jqkxgx3823vz762-python3.13-deluged-2.2.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/applications/networking/p2p/deluge/default.nix:106`
- **Outputs**:
  - `dist`:  `/nix/store/7s0z02ghzdj9s9av0jqkxgx3823vz762-python3.13-deluged-2.2.0`
  - `out`:  `/nix/store/7s0z02ghzdj9s9av0jqkxgx3823vz762-python3.13-deluged-2.2.0`
...
- [[2bhhvji5znwwxl8wjjq5wr0r9igj131x-libtorrent-rasterbar-2.0.11]]
...
- [[lhmjpsdhpf78dm6lrsswys3y4vbd6api-deluge-2.2.0.tar.xz]]
