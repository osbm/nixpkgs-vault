...
- **Name**: `haskellPackages.gi-ibus`
- **Version**: `1.5.8`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: IBus bindings
- **Homepage**: [https://hackage.haskell.org/package/gi-ibus](https://hackage.haskell.org/package/gi-ibus)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/2i1gi5f4ccibsgd14qjq45b1f0f62g0w-gi-ibus-1.5.8.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:266328`
- **Outputs**:
  - `doc`:  `/nix/store/2i1gi5f4ccibsgd14qjq45b1f0f62g0w-gi-ibus-1.5.8`
  - `out`:  `/nix/store/2i1gi5f4ccibsgd14qjq45b1f0f62g0w-gi-ibus-1.5.8`
...
- [[x2h1xh0rh88j9wlfh4iqvzibl5gxbwx9-gi-ibus-1.5.8.tar.gz]]
