...
- **Name**: `haskellPackages.CurryDB`
- **Version**: `0.1.1.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: CurryDB: In-memory Key/Value Database
- **Homepage**: [https://hackage.haskell.org/package/CurryDB](https://hackage.haskell.org/package/CurryDB)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/bdgrmfdigwvxhhzx01wpcxq4s6a2gzqz-CurryDB-0.1.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:8527`
- **Outputs**:
  - `doc`:  `/nix/store/bdgrmfdigwvxhhzx01wpcxq4s6a2gzqz-CurryDB-0.1.1.0`
  - `out`:  `/nix/store/bdgrmfdigwvxhhzx01wpcxq4s6a2gzqz-CurryDB-0.1.1.0`
...
- [[v6kcahwabx9851zzq9swjg6iwfni79j6-CurryDB-0.1.1.0.tar.gz]]
