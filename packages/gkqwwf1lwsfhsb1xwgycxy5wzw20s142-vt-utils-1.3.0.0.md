...
- **Name**: `haskellPackages.vt-utils`
- **Version**: `1.3.0.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Vector and Text utilities
- **Homepage**: [https://hackage.haskell.org/package/vt-utils](https://hackage.haskell.org/package/vt-utils)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/gkqwwf1lwsfhsb1xwgycxy5wzw20s142-vt-utils-1.3.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:710137`
- **Outputs**:
  - `doc`:  `/nix/store/gkqwwf1lwsfhsb1xwgycxy5wzw20s142-vt-utils-1.3.0.0`
  - `out`:  `/nix/store/gkqwwf1lwsfhsb1xwgycxy5wzw20s142-vt-utils-1.3.0.0`
...
- [[7fy956cdsg3kvxf53fnwixgv6vpdj7ah-vt-utils-1.3.0.0.tar.gz]]
