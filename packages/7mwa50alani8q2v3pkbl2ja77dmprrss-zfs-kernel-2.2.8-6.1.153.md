...
- **Name**: `linuxKernel.packages.linux_6_1.zfs_2_2`
- **Version**: `2.2.8-6.1.153`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/7mwa50alani8q2v3pkbl2ja77dmprrss-zfs-kernel-2.2.8-6.1.153.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/zfs/generic.nix:322`
- **Outputs**:
  - `out`:  `/nix/store/7mwa50alani8q2v3pkbl2ja77dmprrss-zfs-kernel-2.2.8-6.1.153`
