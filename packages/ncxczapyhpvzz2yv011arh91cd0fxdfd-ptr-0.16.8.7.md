...
- **Name**: `haskellPackages.ptr`
- **Version**: `0.16.8.7`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Experimental abstractions for operations on pointers
- **Homepage**: [https://hackage.haskell.org/package/ptr](https://hackage.haskell.org/package/ptr)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/ncxczapyhpvzz2yv011arh91cd0fxdfd-ptr-0.16.8.7.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:545794`
- **Outputs**:
  - `doc`:  `/nix/store/ncxczapyhpvzz2yv011arh91cd0fxdfd-ptr-0.16.8.7`
  - `out`:  `/nix/store/ncxczapyhpvzz2yv011arh91cd0fxdfd-ptr-0.16.8.7`
...
- [[fl56a7rmcpngrlv835wbhli2rg46bib9-ptr-0.16.8.7.tar.gz]]
