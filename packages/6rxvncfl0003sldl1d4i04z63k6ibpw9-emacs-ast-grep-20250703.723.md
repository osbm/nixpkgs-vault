...
- **Name**: `emacsPackages.ast-grep`
- **Version**: `20250703.723`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://github.com/SunskyXH/ast-grep.el](https://github.com/SunskyXH/ast-grep.el)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/6rxvncfl0003sldl1d4i04z63k6ibpw9-emacs-ast-grep-20250703.723.drv`
...
- **Outputs**:
  - `out`:  `/nix/store/6rxvncfl0003sldl1d4i04z63k6ibpw9-emacs-ast-grep-20250703.723`

## 🔗 Dependencies

- [[5sara1isx5k1f1q7y2j58b1ka6jfx53l-ast-grep-recipe]]
- [[a2dbc6jvzf7x52djfhs8nbaawph4kyky-source]]
