...
- **Name**: `rPackages.fractalforest`
- **Version**: `1.0.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/fractalforest/](https://cran.r-project.org/web/packages/fractalforest/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/33qi8zc8f03l294x12a93jivfdf8idy5-r-fractalforest-1.0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/33qi8zc8f03l294x12a93jivfdf8idy5-r-fractalforest-1.0.1`
...
- [[p3f7jljnrhfcy9py0ccm2zbcs8ljbz19-fractalforest_1.0.1.tar.gz]]
