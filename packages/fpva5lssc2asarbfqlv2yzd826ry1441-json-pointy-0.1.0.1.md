...
JSON Pointer (RFC 6901) parsing, access, and modification

## 📋 Package Information

- **Name**: `haskellPackages.json-pointy`
- **Version**: `0.1.0.1`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: JSON Pointer (RFC 6901) parsing, access, and modification
- **Homepage**: [https://hackage.haskell.org/package/json-pointy](https://hackage.haskell.org/package/json-pointy)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/fpva5lssc2asarbfqlv2yzd826ry1441-json-pointy-0.1.0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:392759`
- **Outputs**:
  - `doc`:  `/nix/store/fpva5lssc2asarbfqlv2yzd826ry1441-json-pointy-0.1.0.1`
  - `out`:  `/nix/store/fpva5lssc2asarbfqlv2yzd826ry1441-json-pointy-0.1.0.1`
...
- [[wgm5wlf1hv1p1ap4f2z31c3n4ci78gmg-json-pointy-0.1.0.1.tar.gz]]
