...
- **Derivation Path**: `/nix/store/p50an4yzxiibm6j362aaaskjbmlgrlc0-ocaml5.3.0-dns-client-10.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/ocaml-modules/dns/client.nix:26`
- **Outputs**:
  - `out`:  `/nix/store/p50an4yzxiibm6j362aaaskjbmlgrlc0-ocaml5.3.0-dns-client-10.1.0`
