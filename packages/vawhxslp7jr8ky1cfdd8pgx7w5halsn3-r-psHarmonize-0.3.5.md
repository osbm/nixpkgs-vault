...
- **Name**: `rPackages.psHarmonize`
- **Version**: `0.3.5`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/psHarmonize/](https://cran.r-project.org/web/packages/psHarmonize/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/vawhxslp7jr8ky1cfdd8pgx7w5halsn3-r-psHarmonize-0.3.5.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/vawhxslp7jr8ky1cfdd8pgx7w5halsn3-r-psHarmonize-0.3.5`
...
- [[89wvlkv8416hdhbywsls0yp6f02wqp99-psHarmonize_0.3.5.tar.gz]]
