...
- **Name**: `haskellPackages.DPutils`
- **Version**: `0.1.1.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: utilities for DP
- **Homepage**: [https://hackage.haskell.org/package/DPutils](https://hackage.haskell.org/package/DPutils)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/0ib7yh08xmfh8mhdgx236z9icbd51jza-DPutils-0.1.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:9097`
- **Outputs**:
  - `doc`:  `/nix/store/0ib7yh08xmfh8mhdgx236z9icbd51jza-DPutils-0.1.1.0`
  - `out`:  `/nix/store/0ib7yh08xmfh8mhdgx236z9icbd51jza-DPutils-0.1.1.0`
...
- [[vfwdmvivvs56r470d1zfizw1hcf60i8y-DPutils-0.1.1.0.tar.gz]]
