...
- **Name**: `rPackages.aelab`
- **Version**: `1.0.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/aelab/](https://cran.r-project.org/web/packages/aelab/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/y49zgypmgmcp605l1w5jdv4138in31fj-r-aelab-1.0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/y49zgypmgmcp605l1w5jdv4138in31fj-r-aelab-1.0.1`

## 🔗 Dependencies

- [[2zkb5n2rqd9xgrd79bcz07xc9mqs634r-aelab_1.0.1.tar.gz]]
