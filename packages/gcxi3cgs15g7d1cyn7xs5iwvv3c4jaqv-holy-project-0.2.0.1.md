...
- **Name**: `haskellPackages.holy-project`
- **Version**: `0.2.0.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Start your Haskell project with cabal, git and tests
- **Homepage**: [https://hackage.haskell.org/package/holy-project](https://hackage.haskell.org/package/holy-project)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/gcxi3cgs15g7d1cyn7xs5iwvv3c4jaqv-holy-project-0.2.0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:339244`
- **Outputs**:
  - `data`:  `/nix/store/gcxi3cgs15g7d1cyn7xs5iwvv3c4jaqv-holy-project-0.2.0.1`
  - `doc`:  `/nix/store/gcxi3cgs15g7d1cyn7xs5iwvv3c4jaqv-holy-project-0.2.0.1`
  - `out`:  `/nix/store/gcxi3cgs15g7d1cyn7xs5iwvv3c4jaqv-holy-project-0.2.0.1`
...
- [[ahhfi6cd5qg42p50mb85i4pzjp0czx6l-holy-project-0.2.0.1.tar.gz]]
