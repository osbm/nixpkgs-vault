---
aliases:
  - linuxKernel.packages.linux_xanmod_stable.apfs
tags:
  - license/unknown
  - maintainers/Luflosi
  - outputs/out
...
- **Name**: `linuxKernel.packages.linux_xanmod_stable.apfs`
- **Version**: `0.3.15-6.16.8`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/5ymh8lznykx7w6bz8dc0b6sd8xyaq8h8-apfs-0.3.15-6.16.8.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/apfs/default.nix:41`
- **Outputs**:
  - `out`:  `/nix/store/5ymh8lznykx7w6bz8dc0b6sd8xyaq8h8-apfs-0.3.15-6.16.8`
