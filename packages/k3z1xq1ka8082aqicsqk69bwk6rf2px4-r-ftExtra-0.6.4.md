...
- **Name**: `rPackages.ftExtra`
- **Version**: `0.6.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/ftExtra/](https://cran.r-project.org/web/packages/ftExtra/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/k3z1xq1ka8082aqicsqk69bwk6rf2px4-r-ftExtra-0.6.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/k3z1xq1ka8082aqicsqk69bwk6rf2px4-r-ftExtra-0.6.4`
...
- [[7kp6flfpgvr13p1i5gdwhl2qk3r09cjn-ftExtra_0.6.4.tar.gz]]
