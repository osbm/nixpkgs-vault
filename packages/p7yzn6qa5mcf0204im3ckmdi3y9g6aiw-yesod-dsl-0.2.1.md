...
- **Name**: `haskellPackages.yesod-dsl`
- **Version**: `0.2.1`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: DSL for generating Yesod subsite to manage an RDBMS;
- **Homepage**: [https://hackage.haskell.org/package/yesod-dsl](https://hackage.haskell.org/package/yesod-dsl)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/p7yzn6qa5mcf0204im3ckmdi3y9g6aiw-yesod-dsl-0.2.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:740114`
- **Outputs**:
  - `doc`:  `/nix/store/p7yzn6qa5mcf0204im3ckmdi3y9g6aiw-yesod-dsl-0.2.1`
  - `out`:  `/nix/store/p7yzn6qa5mcf0204im3ckmdi3y9g6aiw-yesod-dsl-0.2.1`
...
- [[6pggvinp5lgh11daian88ggymhc5kl5l-yesod-dsl-0.2.1.tar.gz]]
