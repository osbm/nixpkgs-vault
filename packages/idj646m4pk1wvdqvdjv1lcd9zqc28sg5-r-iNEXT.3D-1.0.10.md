...
- **Name**: `rPackages.iNEXT_3D`
- **Version**: `1.0.10`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/iNEXT.3D/](https://cran.r-project.org/web/packages/iNEXT.3D/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/idj646m4pk1wvdqvdjv1lcd9zqc28sg5-r-iNEXT.3D-1.0.10.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/idj646m4pk1wvdqvdjv1lcd9zqc28sg5-r-iNEXT.3D-1.0.10`
...
- [[bpyqvnqyq7fgawx5y0dccv1lkd5zm9p8-iNEXT.3D_1.0.10.tar.gz]]
