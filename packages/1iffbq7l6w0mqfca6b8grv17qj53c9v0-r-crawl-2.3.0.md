...
- **Name**: `rPackages.crawl`
- **Version**: `2.3.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/crawl/](https://cran.r-project.org/web/packages/crawl/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/1iffbq7l6w0mqfca6b8grv17qj53c9v0-r-crawl-2.3.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/1iffbq7l6w0mqfca6b8grv17qj53c9v0-r-crawl-2.3.0`
...
- [[52hwba2w3dmwcr3ndgd30iz41k2bbkrv-crawl_2.3.0.tar.gz]]
