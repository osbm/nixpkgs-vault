...
- **Name**: `python312Packages.mrsqm`
- **Version**: `4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: MrSQM (Multiple Representations Sequence Miner) is a time series classifier
- **Homepage**: [https://pypi.org/project/mrsqm](https://pypi.org/project/mrsqm)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/9ly7pwx130fcpm1fdmlk57kfxdngslic-python3.12-mrsqm-4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/mrsqm/default.nix:75`
- **Outputs**:
  - `dist`:  `/nix/store/9ly7pwx130fcpm1fdmlk57kfxdngslic-python3.12-mrsqm-4`
  - `out`:  `/nix/store/9ly7pwx130fcpm1fdmlk57kfxdngslic-python3.12-mrsqm-4`

## 🔗 Dependencies

- [[085xlrjn483h686si07j1k4s89hakmgz-fftw-double-3.3.10]]
- [[267wlr0vvn6zssd0qlhmfw377mcrn5q6-source]]
