...
- **Name**: `haskellPackages.spike`
- **Version**: `0.3`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Experimental web browser
- **Homepage**: [https://hackage.haskell.org/package/spike](https://hackage.haskell.org/package/spike)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/kbbyaldqidxn9qhvgh92sd0l0kkxdy32-spike-0.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:627597`
- **Outputs**:
  - `doc`:  `/nix/store/kbbyaldqidxn9qhvgh92sd0l0kkxdy32-spike-0.3`
  - `out`:  `/nix/store/kbbyaldqidxn9qhvgh92sd0l0kkxdy32-spike-0.3`
...
- [[19x97s7bhxr6gnkawfhbkymrxi0z41di-global-variables-1.0.1.1]]
...
- [[l9c0bhn4n7ikzd3has8dr5dz8db43cks-spike-0.3.tar.gz]]
