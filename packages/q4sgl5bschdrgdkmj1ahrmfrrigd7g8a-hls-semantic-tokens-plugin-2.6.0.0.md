...
- **Name**: `haskellPackages.hls-semantic-tokens-plugin`
- **Version**: `2.6.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Call hierarchy plugin for Haskell Language Server
- **Homepage**: [https://hackage.haskell.org/package/hls-semantic-tokens-plugin](https://hackage.haskell.org/package/hls-semantic-tokens-plugin)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/q4sgl5bschdrgdkmj1ahrmfrrigd7g8a-hls-semantic-tokens-plugin-2.6.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:334985`
- **Outputs**:
  - `doc`:  `/nix/store/q4sgl5bschdrgdkmj1ahrmfrrigd7g8a-hls-semantic-tokens-plugin-2.6.0.0`
  - `out`:  `/nix/store/q4sgl5bschdrgdkmj1ahrmfrrigd7g8a-hls-semantic-tokens-plugin-2.6.0.0`
...
- [[4rql2sy60hdxmhr973g51amaapfp2nai-hls-semantic-tokens-plugin-2.6.0.0.tar.gz]]
...
- [[fww8l3vyg2n6zlh6p8bvhf6r4f76plh8-ghcide-test-utils-2.0.0.0]]
