...
- **Name**: `haskellPackages.push-notify-apn`
- **Version**: `0.5.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Send push notifications to mobile iOS devices
- **Homepage**: [https://hackage.haskell.org/package/push-notify-apn](https://hackage.haskell.org/package/push-notify-apn)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/06hnhg01jbf1za3yxyf8n8h3s8wf8f35-push-notify-apn-0.5.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:548186`
- **Outputs**:
  - `doc`:  `/nix/store/06hnhg01jbf1za3yxyf8n8h3s8wf8f35-push-notify-apn-0.5.0.0`
  - `out`:  `/nix/store/06hnhg01jbf1za3yxyf8n8h3s8wf8f35-push-notify-apn-0.5.0.0`
...
- [[qrbww4iz3gpdgqhacw5dy5mwy9vgb4aj-push-notify-apn-0.5.0.0.tar.gz]]
