...
- **Name**: `haskellPackages.git-repair`
- **Version**: `1.20230814`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: repairs a damaged git repository
- **Homepage**: [https://hackage.haskell.org/package/git-repair](https://hackage.haskell.org/package/git-repair)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/zgm03gh90zmmwygy59z5gfw3xiqxlr6j-git-repair-1.20230814.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:269432`
- **Outputs**:
  - `doc`:  `/nix/store/zgm03gh90zmmwygy59z5gfw3xiqxlr6j-git-repair-1.20230814`
  - `out`:  `/nix/store/zgm03gh90zmmwygy59z5gfw3xiqxlr6j-git-repair-1.20230814`
...
- [[awdav4d3wvrh9qpzazq93wwipwilgrz0-git-repair-1.20230814.tar.gz]]
