...
- **Name**: `rPackages.forestat`
- **Version**: `1.1.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/forestat/](https://cran.r-project.org/web/packages/forestat/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/ln04whn1vwyxk4z1jzqsavm64ky01gxp-r-forestat-1.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/ln04whn1vwyxk4z1jzqsavm64ky01gxp-r-forestat-1.1.0`

## 🔗 Dependencies

- [[1sc5yh3fxvclp2sirwybmxwp9gxr9020-forestat_1.1.0.tar.gz]]
