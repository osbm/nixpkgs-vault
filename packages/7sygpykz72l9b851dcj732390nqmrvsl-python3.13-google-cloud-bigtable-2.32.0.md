...
- **Name**: `python313Packages.google-cloud-bigtable`
- **Version**: `2.32.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Google Cloud Bigtable API client library
- **Homepage**: [https://github.com/googleapis/python-bigtable](https://github.com/googleapis/python-bigtable)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/7sygpykz72l9b851dcj732390nqmrvsl-python3.13-google-cloud-bigtable-2.32.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/google-cloud-bigtable/default.nix:75`
- **Outputs**:
  - `dist`:  `/nix/store/7sygpykz72l9b851dcj732390nqmrvsl-python3.13-google-cloud-bigtable-2.32.0`
  - `out`:  `/nix/store/7sygpykz72l9b851dcj732390nqmrvsl-python3.13-google-cloud-bigtable-2.32.0`
...
- [[95r3d0fg19b2xv5cvg7xqsl12kjk8xsp-source]]
