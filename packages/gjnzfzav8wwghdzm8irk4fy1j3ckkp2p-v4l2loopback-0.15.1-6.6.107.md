...
- **Name**: `linuxKernel.packages.linux_6_6.v4l2loopback`
- **Version**: `0.15.1-6.6.107`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/gjnzfzav8wwghdzm8irk4fy1j3ckkp2p-v4l2loopback-0.15.1-6.6.107.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/v4l2loopback/default.nix:58`
- **Outputs**:
  - `bin`:  `/nix/store/gjnzfzav8wwghdzm8irk4fy1j3ckkp2p-v4l2loopback-0.15.1-6.6.107`
  - `out`:  `/nix/store/gjnzfzav8wwghdzm8irk4fy1j3ckkp2p-v4l2loopback-0.15.1-6.6.107`
