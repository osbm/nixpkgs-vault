---
aliases:
  - linuxKernel.packages.linux_6_1.apfs
tags:
  - license/unknown
  - maintainers/Luflosi
  - outputs/out
...
- **Name**: `linuxKernel.packages.linux_6_1.apfs`
- **Version**: `0.3.15-6.1.153`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/jji4r04j8d0gh4ms0iwgw80xl2zdxnh8-apfs-0.3.15-6.1.153.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/apfs/default.nix:41`
- **Outputs**:
  - `out`:  `/nix/store/jji4r04j8d0gh4ms0iwgw80xl2zdxnh8-apfs-0.3.15-6.1.153`
