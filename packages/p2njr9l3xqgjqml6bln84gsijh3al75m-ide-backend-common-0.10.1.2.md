---
aliases:
  - haskellPackages.ide-backend-common
tags:
  - broken
  - not-available
  - license/unknown
...
- **Name**: `haskellPackages.ide-backend-common`
- **Version**: `0.10.1.2`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Shared library used be ide-backend and ide-backend-server
- **Homepage**: [https://hackage.haskell.org/package/ide-backend-common](https://hackage.haskell.org/package/ide-backend-common)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/p2njr9l3xqgjqml6bln84gsijh3al75m-ide-backend-common-0.10.1.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:372628`
- **Outputs**:
  - `doc`:  `/nix/store/p2njr9l3xqgjqml6bln84gsijh3al75m-ide-backend-common-0.10.1.2`
  - `out`:  `/nix/store/p2njr9l3xqgjqml6bln84gsijh3al75m-ide-backend-common-0.10.1.2`
...
- [[mik7n7sm5z7gxccwdvy73k9b3hwnlhnj-ide-backend-common-0.10.1.2-r1.cabal]]
...
- [[rwrll1vfa0ckj7cww2z7g2gvj43y7pha-ide-backend-common-0.10.1.2.tar.gz]]
