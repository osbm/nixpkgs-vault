...
- **Name**: `haskellPackages.gtkimageview`
- **Version**: `0.12.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Binding to the GtkImageView library
- **Homepage**: [https://hackage.haskell.org/package/gtkimageview](https://hackage.haskell.org/package/gtkimageview)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/66f23vipvnnch801z941zpp8pw6miwp6-gtkimageview-0.12.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:286876`
- **Outputs**:
  - `data`:  `/nix/store/66f23vipvnnch801z941zpp8pw6miwp6-gtkimageview-0.12.0`
  - `doc`:  `/nix/store/66f23vipvnnch801z941zpp8pw6miwp6-gtkimageview-0.12.0`
  - `out`:  `/nix/store/66f23vipvnnch801z941zpp8pw6miwp6-gtkimageview-0.12.0`
...
- [[c73j48dxifnd4fl37hcvwpm981b7gvn9-gtkimageview-0.12.0.tar.gz]]
