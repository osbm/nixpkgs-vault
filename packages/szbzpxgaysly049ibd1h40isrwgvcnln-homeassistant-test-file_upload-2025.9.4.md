---
aliases:
  - home-assistant-component-tests.file_upload
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.file_upload`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/szbzpxgaysly049ibd1h40isrwgvcnln-homeassistant-test-file_upload-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/szbzpxgaysly049ibd1h40isrwgvcnln-homeassistant-test-file_upload-2025.9.4`
