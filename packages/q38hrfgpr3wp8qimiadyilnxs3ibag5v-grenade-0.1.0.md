...
- **Name**: `haskellPackages.grenade`
- **Version**: `0.1.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Practical Deep Learning in Haskell
- **Homepage**: [https://hackage.haskell.org/package/grenade](https://hackage.haskell.org/package/grenade)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/q38hrfgpr3wp8qimiadyilnxs3ibag5v-grenade-0.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:283329`
- **Outputs**:
  - `doc`:  `/nix/store/q38hrfgpr3wp8qimiadyilnxs3ibag5v-grenade-0.1.0`
  - `out`:  `/nix/store/q38hrfgpr3wp8qimiadyilnxs3ibag5v-grenade-0.1.0`

## 🔗 Dependencies

- [[485qdczp7d732ili16l2sbmnid8axskf-grenade-0.1.0.tar.gz]]
