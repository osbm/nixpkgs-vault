...
- **Name**: `haskellPackages.postie`
- **Version**: `0.6.0.2`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: SMTP server library to receive emails from within Haskell programs
- **Homepage**: [https://hackage.haskell.org/package/postie](https://hackage.haskell.org/package/postie)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/w5yg1mdw2s2ld0n9xjp19dk6abriayzf-postie-0.6.0.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:533662`
- **Outputs**:
  - `doc`:  `/nix/store/w5yg1mdw2s2ld0n9xjp19dk6abriayzf-postie-0.6.0.2`
  - `out`:  `/nix/store/w5yg1mdw2s2ld0n9xjp19dk6abriayzf-postie-0.6.0.2`
...
- [[mlf75d5zkf3l288153ciw6v6xmbk314q-postie-0.6.0.2.tar.gz]]
