...
- **Name**: `rPackages.PND_heter_cluster`
- **Version**: `0.1.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/PND.heter.cluster/](https://cran.r-project.org/web/packages/PND.heter.cluster/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/ybajxiw53psylfn6hp0n154scckkwyzq-r-PND.heter.cluster-0.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/ybajxiw53psylfn6hp0n154scckkwyzq-r-PND.heter.cluster-0.1.0`
...
- [[qmh33mzxwprw2rsbm3m08ngf3njasiz4-PND.heter.cluster_0.1.0.tar.gz]]
