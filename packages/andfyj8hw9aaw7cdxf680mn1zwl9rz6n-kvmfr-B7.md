---
aliases:
  - linuxKernel.packages.linux_5_4.kvmfr
tags:
  - license/unknown
  - maintainers/j-brn
  - outputs/out
...
- **Name**: `linuxKernel.packages.linux_5_4.kvmfr`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/andfyj8hw9aaw7cdxf680mn1zwl9rz6n-kvmfr-B7.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/kvmfr/default.nix:31`
- **Outputs**:
  - `out`:  `/nix/store/andfyj8hw9aaw7cdxf680mn1zwl9rz6n-kvmfr-B7`
