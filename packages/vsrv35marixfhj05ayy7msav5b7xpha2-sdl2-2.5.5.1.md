...
- **Name**: `haskellPackages.sdl2`
- **Version**: `2.5.5.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Both high- and low-level bindings to the SDL library (version 2.0.6+).
- **Homepage**: [https://hackage.haskell.org/package/sdl2](https://hackage.haskell.org/package/sdl2)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/vsrv35marixfhj05ayy7msav5b7xpha2-sdl2-2.5.5.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:590733`
- **Outputs**:
  - `data`:  `/nix/store/vsrv35marixfhj05ayy7msav5b7xpha2-sdl2-2.5.5.1`
  - `doc`:  `/nix/store/vsrv35marixfhj05ayy7msav5b7xpha2-sdl2-2.5.5.1`
  - `out`:  `/nix/store/vsrv35marixfhj05ayy7msav5b7xpha2-sdl2-2.5.5.1`
...
- [[38jgplr00hc00267bjhfix2m0gb0wnxk-sdl2-2.5.5.1.tar.gz]]
