...
- **Name**: `haskellPackages.aeson-dependent-sum`
- **Version**: `0.1.0.1`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: JSON encoding/decoding for dependent-sum
- **Homepage**: [https://hackage.haskell.org/package/aeson-dependent-sum](https://hackage.haskell.org/package/aeson-dependent-sum)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/5phb3mq0hyp183hrsdygd5ams55c9bfk-aeson-dependent-sum-0.1.0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:54066`
- **Outputs**:
  - `doc`:  `/nix/store/5phb3mq0hyp183hrsdygd5ams55c9bfk-aeson-dependent-sum-0.1.0.1`
  - `out`:  `/nix/store/5phb3mq0hyp183hrsdygd5ams55c9bfk-aeson-dependent-sum-0.1.0.1`
...
- [[yg48pw0pdnjwc2zyg7ar3yv3byb3rs52-aeson-dependent-sum-0.1.0.1.tar.gz]]
