---
aliases:
  - haskellPackages.bindings-libftdi
tags:
  - broken
  - not-available
  - license/unknown
...
- **Name**: `haskellPackages.bindings-libftdi`
- **Version**: `0.1`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Low level bindings to libftdi
- **Homepage**: [https://hackage.haskell.org/package/bindings-libftdi](https://hackage.haskell.org/package/bindings-libftdi)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/hpf5fvscsp489bncxsjx1s2a6fjjaglw-bindings-libftdi-0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:105188`
- **Outputs**:
  - `doc`:  `/nix/store/hpf5fvscsp489bncxsjx1s2a6fjjaglw-bindings-libftdi-0.1`
  - `out`:  `/nix/store/hpf5fvscsp489bncxsjx1s2a6fjjaglw-bindings-libftdi-0.1`
...
- [[3rkibd0a68pkxsxvbd7kma9vd0zk5z1n-bindings-libftdi-0.1.tar.gz]]
