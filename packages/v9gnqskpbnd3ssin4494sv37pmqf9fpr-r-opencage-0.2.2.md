...
- **Name**: `rPackages.opencage`
- **Version**: `0.2.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/opencage/](https://cran.r-project.org/web/packages/opencage/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/v9gnqskpbnd3ssin4494sv37pmqf9fpr-r-opencage-0.2.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/v9gnqskpbnd3ssin4494sv37pmqf9fpr-r-opencage-0.2.2`
...
- [[v7xgdw86ax1n1kknc1lwclkb9s26jick-opencage_0.2.2.tar.gz]]
