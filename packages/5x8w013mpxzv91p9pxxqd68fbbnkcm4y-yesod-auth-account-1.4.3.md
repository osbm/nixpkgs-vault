---
aliases:
  - haskellPackages.yesod-auth-account
tags:
  - broken
  - not-available
  - license/unknown
...
- **Name**: `haskellPackages.yesod-auth-account`
- **Version**: `1.4.3`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: An account authentication plugin for Yesod
- **Homepage**: [https://hackage.haskell.org/package/yesod-auth-account](https://hackage.haskell.org/package/yesod-auth-account)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/5x8w013mpxzv91p9pxxqd68fbbnkcm4y-yesod-auth-account-1.4.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:738283`
- **Outputs**:
  - `doc`:  `/nix/store/5x8w013mpxzv91p9pxxqd68fbbnkcm4y-yesod-auth-account-1.4.3`
  - `out`:  `/nix/store/5x8w013mpxzv91p9pxxqd68fbbnkcm4y-yesod-auth-account-1.4.3`
...
- [[zcpaksn9d53xb0lg2hpnq62y7y4fzvaa-yesod-auth-account-1.4.3.tar.gz]]
