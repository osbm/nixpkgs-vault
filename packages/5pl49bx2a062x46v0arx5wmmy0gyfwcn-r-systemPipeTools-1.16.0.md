...
- **Name**: `rPackages.systemPipeTools`
- **Version**: `1.16.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://bioconductor.org/packages/3.21/bioc/html/systemPipeTools.html](https://bioconductor.org/packages/3.21/bioc/html/systemPipeTools.html)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/5pl49bx2a062x46v0arx5wmmy0gyfwcn-r-systemPipeTools-1.16.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/5pl49bx2a062x46v0arx5wmmy0gyfwcn-r-systemPipeTools-1.16.0`
...
- [[wd6wkwn7wllcwqjrby3m1b8jbp671d92-r-glmpca-0.2.0]]
- [[wfnv723bphqxydaqcrbdv8fy2dp3hpa6-systemPipeTools_1.16.0.tar.gz]]
