...
- **Name**: `rPackages.dataclass`
- **Version**: `1.0.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://cran.r-project.org/web/packages/dataclass/](https://cran.r-project.org/web/packages/dataclass/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/i3hiw6qvc83d4rb891hzq1vv0xjlpa9g-r-dataclass-1.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/i3hiw6qvc83d4rb891hzq1vv0xjlpa9g-r-dataclass-1.0.0`
...
- [[hnw1as639k7sfln6s6v501an9rkdicp0-dataclass_1.0.0.tar.gz]]
