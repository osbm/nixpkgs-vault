---
aliases:
  - home-assistant-component-tests.counter
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.counter`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/6mqv80kpdzd4s1gzgllkzafvwjlzszs2-homeassistant-test-counter-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/6mqv80kpdzd4s1gzgllkzafvwjlzszs2-homeassistant-test-counter-2025.9.4`
