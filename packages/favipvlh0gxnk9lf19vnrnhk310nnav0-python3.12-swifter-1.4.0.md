...
- **Name**: `python312Packages.swifter`
- **Version**: `1.4.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/favipvlh0gxnk9lf19vnrnhk310nnav0-python3.12-swifter-1.4.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/swifter/default.nix:48`
- **Outputs**:
  - `dist`:  `/nix/store/favipvlh0gxnk9lf19vnrnhk310nnav0-python3.12-swifter-1.4.0`
  - `out`:  `/nix/store/favipvlh0gxnk9lf19vnrnhk310nnav0-python3.12-swifter-1.4.0`
