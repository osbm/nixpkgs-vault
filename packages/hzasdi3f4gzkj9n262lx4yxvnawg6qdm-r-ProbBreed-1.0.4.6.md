...
- **Name**: `rPackages.ProbBreed`
- **Version**: `1.0.4.6`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/ProbBreed/](https://cran.r-project.org/web/packages/ProbBreed/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/hzasdi3f4gzkj9n262lx4yxvnawg6qdm-r-ProbBreed-1.0.4.6.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/hzasdi3f4gzkj9n262lx4yxvnawg6qdm-r-ProbBreed-1.0.4.6`
...
- [[shjgc032ik3ph0jwpikb9d9i7xw1drls-ProbBreed_1.0.4.6.tar.gz]]
