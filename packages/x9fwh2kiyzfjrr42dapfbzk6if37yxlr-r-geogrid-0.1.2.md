...
- **Name**: `rPackages.geogrid`
- **Version**: `0.1.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/geogrid/](https://cran.r-project.org/web/packages/geogrid/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/x9fwh2kiyzfjrr42dapfbzk6if37yxlr-r-geogrid-0.1.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/x9fwh2kiyzfjrr42dapfbzk6if37yxlr-r-geogrid-0.1.2`
...
- [[wbbzfc7vw2h8wvv2m9li9wzbwmikzsl0-geogrid_0.1.2.tar.gz]]
