...
- **Name**: `haskellPackages.aip`
- **Version**: `0.1.3`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Aeronautical Information Package (AIP)
- **Homepage**: [https://hackage.haskell.org/package/aip](https://hackage.haskell.org/package/aip)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/6dhhldzmss0yzbrsa0553syj0r2801af-aip-0.1.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:56970`
- **Outputs**:
  - `doc`:  `/nix/store/6dhhldzmss0yzbrsa0553syj0r2801af-aip-0.1.3`
  - `out`:  `/nix/store/6dhhldzmss0yzbrsa0553syj0r2801af-aip-0.1.3`
...
- [[vz8m7s2npk23x5qnl0mny4jnxlgpdalb-aip-0.1.3.tar.gz]]
