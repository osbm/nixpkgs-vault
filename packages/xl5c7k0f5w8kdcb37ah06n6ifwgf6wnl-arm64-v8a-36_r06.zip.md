---
aliases:
  - androidenv.androidPkgs.all.system-images.v36.google_apis.arm64-v8a
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.system-images.v36.google_apis.arm64-v8a`
- **Version**: `36_r06.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/xl5c7k0f5w8kdcb37ah06n6ifwgf6wnl-arm64-v8a-36_r06.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/xl5c7k0f5w8kdcb37ah06n6ifwgf6wnl-arm64-v8a-36_r06.zip`
