...
- **Name**: `rPackages.migrate`
- **Version**: `0.5.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/migrate/](https://cran.r-project.org/web/packages/migrate/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/q0pbril0ar97pzm1ziqfkvmj0hpl9ngc-r-migrate-0.5.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/q0pbril0ar97pzm1ziqfkvmj0hpl9ngc-r-migrate-0.5.0`
...
- [[zs05cnfh6m3682wb70ykgr17hsy22cyd-migrate_0.5.0.tar.gz]]
