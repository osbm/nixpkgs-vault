...
- **Name**: `haskellPackages.libsystemd-journal`
- **Version**: `1.4.6.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Haskell bindings to libsystemd-journal
- **Homepage**: [https://hackage.haskell.org/package/libsystemd-journal](https://hackage.haskell.org/package/libsystemd-journal)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/0zhlylxk9mfklwsz6ddqazvx6wav3skw-libsystemd-journal-1.4.6.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:418254`
- **Outputs**:
  - `doc`:  `/nix/store/0zhlylxk9mfklwsz6ddqazvx6wav3skw-libsystemd-journal-1.4.6.0`
  - `out`:  `/nix/store/0zhlylxk9mfklwsz6ddqazvx6wav3skw-libsystemd-journal-1.4.6.0`
...
- [[pdhyg4whjikjnlcvzis7lx6ww6r3c1dy-libsystemd-journal-1.4.6.0-r2.cabal]]
...
- [[sfwk1pymd6rqk8bkw6n89xq6al6gjimp-libsystemd-journal-1.4.6.0.tar.gz]]
