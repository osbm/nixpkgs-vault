...
- **Name**: `rPackages.rmBayes`
- **Version**: `0.1.16`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/rmBayes/](https://cran.r-project.org/web/packages/rmBayes/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/7dk3hgxvrwnl7ybcpkmn4w4g9xa5v4fp-r-rmBayes-0.1.16.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/7dk3hgxvrwnl7ybcpkmn4w4g9xa5v4fp-r-rmBayes-0.1.16`
...
- [[xragvq9x0pvrb67v0ydp3igbzbwxc7vs-rmBayes_0.1.16.tar.gz]]
