...
- **Name**: `haskellPackages.special-keys`
- **Version**: `0.1.0.3`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Simple data types that help me here and there
- **Homepage**: [https://hackage.haskell.org/package/special-keys](https://hackage.haskell.org/package/special-keys)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/47bkxpb909c4f0jhwg7p10qg31w61wbj-special-keys-0.1.0.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:626887`
- **Outputs**:
  - `doc`:  `/nix/store/47bkxpb909c4f0jhwg7p10qg31w61wbj-special-keys-0.1.0.3`
  - `out`:  `/nix/store/47bkxpb909c4f0jhwg7p10qg31w61wbj-special-keys-0.1.0.3`
...
- [[kc4avv0qqnm02mmxi6yxl8bgki31ljib-special-keys-0.1.0.3.tar.gz]]
