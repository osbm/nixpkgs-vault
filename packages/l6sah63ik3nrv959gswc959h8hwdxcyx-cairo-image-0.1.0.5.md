...
- **Name**: `haskellPackages.cairo-image`
- **Version**: `0.1.0.5`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Image for Cairo
- **Homepage**: [https://hackage.haskell.org/package/cairo-image](https://hackage.haskell.org/package/cairo-image)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/l6sah63ik3nrv959gswc959h8hwdxcyx-cairo-image-0.1.0.5.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:127667`
- **Outputs**:
  - `doc`:  `/nix/store/l6sah63ik3nrv959gswc959h8hwdxcyx-cairo-image-0.1.0.5`
  - `out`:  `/nix/store/l6sah63ik3nrv959gswc959h8hwdxcyx-cairo-image-0.1.0.5`
...
- [[2vhy462nlkhvfm1mpfspzzq60965p3np-cairo-image-0.1.0.5.tar.gz]]
