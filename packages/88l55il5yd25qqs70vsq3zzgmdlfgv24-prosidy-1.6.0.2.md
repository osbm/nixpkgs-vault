...
- **Name**: `haskellPackages.prosidy`
- **Version**: `1.6.0.2`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: A simple language for writing documents
- **Homepage**: [https://hackage.haskell.org/package/prosidy](https://hackage.haskell.org/package/prosidy)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/88l55il5yd25qqs70vsq3zzgmdlfgv24-prosidy-1.6.0.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:543213`
- **Outputs**:
  - `data`:  `/nix/store/88l55il5yd25qqs70vsq3zzgmdlfgv24-prosidy-1.6.0.2`
  - `doc`:  `/nix/store/88l55il5yd25qqs70vsq3zzgmdlfgv24-prosidy-1.6.0.2`
  - `out`:  `/nix/store/88l55il5yd25qqs70vsq3zzgmdlfgv24-prosidy-1.6.0.2`
...
- [[q918i061b4fnl2vfcl472197i7n6gzk8-aeson-diff-1.1.0.13]]
...
- [[xs9g6dv1x1gjizrl4icp7qg27dvc4qqs-prosidy-1.6.0.2.tar.gz]]
