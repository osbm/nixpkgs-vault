...
- **Name**: `haskellPackages.pipes-zlib`
- **Version**: `0.4.4.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Zlib and GZip compression and decompression for Pipes streams
- **Homepage**: [https://hackage.haskell.org/package/pipes-zlib](https://hackage.haskell.org/package/pipes-zlib)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/sqbl31si43wygy6kgjrla8w96rdb4i8l-pipes-zlib-0.4.4.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:521772`
- **Outputs**:
  - `doc`:  `/nix/store/sqbl31si43wygy6kgjrla8w96rdb4i8l-pipes-zlib-0.4.4.2`
  - `out`:  `/nix/store/sqbl31si43wygy6kgjrla8w96rdb4i8l-pipes-zlib-0.4.4.2`

## 🔗 Dependencies

- [[07ryzakvks0bmvx1k1aqpjr5xxw3r5f2-pipes-zlib-0.4.4.2.tar.gz]]
...
- [[fr7237zc77czawlsh5d1nzwcc2y9sn2x-pipes-zlib-0.4.4.2-r1.cabal]]
