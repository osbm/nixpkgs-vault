...
- **Name**: `haskellPackages.mackerel-client`
- **Version**: `0.3.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: An API client library for Mackerel
- **Homepage**: [https://hackage.haskell.org/package/mackerel-client](https://hackage.haskell.org/package/mackerel-client)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/cdxd0dhr5w9dm8brv6s8hflblk3zh05p-mackerel-client-0.3.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:433948`
- **Outputs**:
  - `doc`:  `/nix/store/cdxd0dhr5w9dm8brv6s8hflblk3zh05p-mackerel-client-0.3.0`
  - `out`:  `/nix/store/cdxd0dhr5w9dm8brv6s8hflblk3zh05p-mackerel-client-0.3.0`
...
- [[xraadfrg6j8wkz3mh7mbdxzmapbfms9c-mackerel-client-0.3.0.tar.gz]]
