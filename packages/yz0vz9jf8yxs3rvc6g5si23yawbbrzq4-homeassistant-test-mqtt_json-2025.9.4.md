---
aliases:
  - home-assistant-component-tests.mqtt_json
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.mqtt_json`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/yz0vz9jf8yxs3rvc6g5si23yawbbrzq4-homeassistant-test-mqtt_json-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/yz0vz9jf8yxs3rvc6g5si23yawbbrzq4-homeassistant-test-mqtt_json-2025.9.4`
