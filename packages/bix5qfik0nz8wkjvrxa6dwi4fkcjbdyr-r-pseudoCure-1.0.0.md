...
- **Name**: `rPackages.pseudoCure`
- **Version**: `1.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/pseudoCure/](https://cran.r-project.org/web/packages/pseudoCure/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/bix5qfik0nz8wkjvrxa6dwi4fkcjbdyr-r-pseudoCure-1.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/bix5qfik0nz8wkjvrxa6dwi4fkcjbdyr-r-pseudoCure-1.0.0`
...
- [[fkpmivby8ywpihsfqm0ip8r9jw30c70n-pseudoCure_1.0.0.tar.gz]]
