...
- **Name**: `haskellPackages.hruby`
- **Version**: `0.5.1.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Embed a Ruby intepreter in your Haskell program !
- **Homepage**: [https://hackage.haskell.org/package/hruby](https://hackage.haskell.org/package/hruby)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/j8y4n0hbmxqkf2p8gl448jzi1ndvn1xc-hruby-0.5.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:345537`
- **Outputs**:
  - `doc`:  `/nix/store/j8y4n0hbmxqkf2p8gl448jzi1ndvn1xc-hruby-0.5.1.0`
  - `out`:  `/nix/store/j8y4n0hbmxqkf2p8gl448jzi1ndvn1xc-hruby-0.5.1.0`
...
- [[v7ir3a619q4lw4sgygfgy9qmavrf3wyr-hruby-0.5.1.0.tar.gz]]
