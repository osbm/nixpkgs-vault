...
Multi-threaded raster tile downloader, primarily designed for downloading OSM tiles for usage offline
...
- **Homepage**: [https://gitlab.scd31.com/stephen/tile-downloader](https://gitlab.scd31.com/stephen/tile-downloader)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/1v5idlrrmk1y3vwi3i4sjbmbsfxiv41i-tile-downloader-0.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/ti/tile-downloader/package.nix:40`
- **Outputs**:
  - `out`:  `/nix/store/1v5idlrrmk1y3vwi3i4sjbmbsfxiv41i-tile-downloader-0.1.0`
...
- [[jx1vpmcyksi3bdqa1r00mky1wp1z8n0m-tile-downloader-0.1.0-vendor]]
- [[kddcsnkr5gcpl70zgjqasnc92190kcq1-source]]
