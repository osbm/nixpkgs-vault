...
- **Name**: `haskellPackages.pixiv`
- **Version**: `0.1.1`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Pixiv API binding based on servant-client
- **Homepage**: [https://hackage.haskell.org/package/pixiv](https://hackage.haskell.org/package/pixiv)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/55lmqvk4yazklsqmkf9bgh3cki8hhh1v-pixiv-0.1.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:522152`
- **Outputs**:
  - `doc`:  `/nix/store/55lmqvk4yazklsqmkf9bgh3cki8hhh1v-pixiv-0.1.1`
  - `out`:  `/nix/store/55lmqvk4yazklsqmkf9bgh3cki8hhh1v-pixiv-0.1.1`
...
- [[djyny7q8zzdbyd2nfkvng5ybgxcw2644-pixiv-0.1.1-r2.cabal]]
...
- [[nbps13b87kgpxbzql0sriqsvrig5ix5c-pixiv-0.1.1.tar.gz]]
