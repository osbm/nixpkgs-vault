...
- **Name**: `haskellPackages.kazura-queue`
- **Version**: `0.1.0.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Fast concurrent queues much inspired by unagi-chan
- **Homepage**: [https://hackage.haskell.org/package/kazura-queue](https://hackage.haskell.org/package/kazura-queue)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/10m4fsg3pv2n0ph8syykglgx8dzlr7lg-kazura-queue-0.1.0.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:398299`
- **Outputs**:
  - `doc`:  `/nix/store/10m4fsg3pv2n0ph8syykglgx8dzlr7lg-kazura-queue-0.1.0.4`
  - `out`:  `/nix/store/10m4fsg3pv2n0ph8syykglgx8dzlr7lg-kazura-queue-0.1.0.4`
...
- [[n585sj5f6d3ax9qxzrmj9aiblikysx00-kazura-queue-0.1.0.4.tar.gz]]
