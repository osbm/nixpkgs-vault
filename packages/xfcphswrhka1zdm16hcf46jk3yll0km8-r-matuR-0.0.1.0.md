...
- **Name**: `rPackages.matuR`
- **Version**: `0.0.1.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/matuR/](https://cran.r-project.org/web/packages/matuR/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/xfcphswrhka1zdm16hcf46jk3yll0km8-r-matuR-0.0.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/xfcphswrhka1zdm16hcf46jk3yll0km8-r-matuR-0.0.1.0`

## 🔗 Dependencies

- [[3f8n9gfa8d7ay5sixww3x88fg6vxvhfg-r-magrittr-2.0.3]]
- [[4c84kk1d99xprgbvnw2h906bpq9vhj8j-matuR_0.0.1.0.tar.gz]]
