...
- **Name**: `haskellPackages.json-to-type`
- **Version**: `4.0.1`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Automatic type declaration for JSON input data
- **Homepage**: [https://hackage.haskell.org/package/json-to-type](https://hackage.haskell.org/package/json-to-type)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/1fg8wj8xclzgmk6krj6q4wsx23f91k36-json-to-type-4.0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:393835`
- **Outputs**:
  - `doc`:  `/nix/store/1fg8wj8xclzgmk6krj6q4wsx23f91k36-json-to-type-4.0.1`
  - `out`:  `/nix/store/1fg8wj8xclzgmk6krj6q4wsx23f91k36-json-to-type-4.0.1`
...
- [[r94iizyc1gmi0rka82780zaa8216hr48-json-to-type-4.0.1.tar.gz]]
