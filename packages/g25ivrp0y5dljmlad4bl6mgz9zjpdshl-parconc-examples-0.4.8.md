---
aliases:
  - haskellPackages.parconc-examples
tags:
  - license/unknown
  - outputs/doc
  - outputs/out
...
- **Name**: `haskellPackages.parconc-examples`
- **Version**: `0.4.8`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Examples to accompany the book "Parallel and Concurrent Programming in Haskell"
- **Homepage**: [https://hackage.haskell.org/package/parconc-examples](https://hackage.haskell.org/package/parconc-examples)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/g25ivrp0y5dljmlad4bl6mgz9zjpdshl-parconc-examples-0.4.8.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:504428`
- **Outputs**:
  - `doc`:  `/nix/store/g25ivrp0y5dljmlad4bl6mgz9zjpdshl-parconc-examples-0.4.8`
  - `out`:  `/nix/store/g25ivrp0y5dljmlad4bl6mgz9zjpdshl-parconc-examples-0.4.8`

## 🔗 Dependencies

- [[1vvsl952dhkmndaxlk8s1c4xdwh2wxd5-parconc-examples-0.4.8.tar.gz]]
...
- [[ilm81gq6bh78h8zxyhhkpigkaw91vsvx-distributed-process-simplelocalnet-0.3.3]]
