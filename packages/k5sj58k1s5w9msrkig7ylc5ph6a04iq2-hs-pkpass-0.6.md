...
- **Name**: `haskellPackages.hs-pkpass`
- **Version**: `0.6`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: A library for Passbook pass creation & signing
- **Homepage**: [https://hackage.haskell.org/package/hs-pkpass](https://hackage.haskell.org/package/hs-pkpass)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/k5sj58k1s5w9msrkig7ylc5ph6a04iq2-hs-pkpass-0.6.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:347750`
- **Outputs**:
  - `doc`:  `/nix/store/k5sj58k1s5w9msrkig7ylc5ph6a04iq2-hs-pkpass-0.6`
  - `out`:  `/nix/store/k5sj58k1s5w9msrkig7ylc5ph6a04iq2-hs-pkpass-0.6`

## 🔗 Dependencies

- [[0sla2ha6kb6fwhizkbgwvl83hmxv31i7-shakespeare-2.1.4]]
- [[1aw9s4rgw3rljc6ldrrahlrk0qiqrkjf-hs-pkpass-0.6.tar.gz]]
