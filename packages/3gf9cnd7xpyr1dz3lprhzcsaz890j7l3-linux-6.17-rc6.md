...
- **Name**: `linuxKernel.kernels.linux_testing`
- **Version**: `6.17-rc6`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/3gf9cnd7xpyr1dz3lprhzcsaz890j7l3-linux-6.17-rc6.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/kernel/mainline.nix:34`
- **Outputs**:
  - `dev`:  `/nix/store/3gf9cnd7xpyr1dz3lprhzcsaz890j7l3-linux-6.17-rc6`
  - `modules`:  `/nix/store/3gf9cnd7xpyr1dz3lprhzcsaz890j7l3-linux-6.17-rc6`
  - `out`:  `/nix/store/3gf9cnd7xpyr1dz3lprhzcsaz890j7l3-linux-6.17-rc6`
...
- [[363ibhwprn5gplp7ffk30n209x9c5k3j-linux-config-6.17-rc6]]
...
- [[x2hpmynai1l14ghsc0xbrf7icnq547p6-source]]
