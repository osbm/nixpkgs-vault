...
- **Name**: `rPackages.kmscv`
- **Version**: `0.1.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://cran.r-project.org/web/packages/kmscv/](https://cran.r-project.org/web/packages/kmscv/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/c0rh58n5isw6s1x1prbwcww95hpffx66-r-kmscv-0.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/c0rh58n5isw6s1x1prbwcww95hpffx66-r-kmscv-0.1.0`
...
- [[hhs6yl7qcdz48gd8ilmp6bcbj8h3wsr1-kmscv_0.1.0.tar.gz]]
