...
- **Name**: `rPackages.DEqMS`
- **Version**: `1.26.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://bioconductor.org/packages/3.21/bioc/html/DEqMS.html](https://bioconductor.org/packages/3.21/bioc/html/DEqMS.html)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/swdi160jm5cjwmlvs8ql99xx924xwns4-r-DEqMS-1.26.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/swdi160jm5cjwmlvs8ql99xx924xwns4-r-DEqMS-1.26.0`

## 🔗 Dependencies

- [[37brscj5by3lkcfcr0a28xkw1rchx2vm-DEqMS_1.26.0.tar.gz]]
