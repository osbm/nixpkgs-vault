...
- **Name**: `rPackages.chessR`
- **Version**: `1.5.2`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://cran.r-project.org/web/packages/chessR/](https://cran.r-project.org/web/packages/chessR/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/ky506aq35kf9x03ricr4vyqrifz7h8cp-r-chessR-1.5.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/ky506aq35kf9x03ricr4vyqrifz7h8cp-r-chessR-1.5.2`
...
- [[c0bnami9y5hhs7cs9zlrjncijy2jdmz4-chessR_1.5.2.tar.gz]]
