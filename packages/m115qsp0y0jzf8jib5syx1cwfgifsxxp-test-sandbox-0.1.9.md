...
- **Name**: `haskellPackages.test-sandbox`
- **Version**: `0.1.9`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Sandbox for system tests
- **Homepage**: [https://hackage.haskell.org/package/test-sandbox](https://hackage.haskell.org/package/test-sandbox)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/m115qsp0y0jzf8jib5syx1cwfgifsxxp-test-sandbox-0.1.9.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:665505`
- **Outputs**:
  - `doc`:  `/nix/store/m115qsp0y0jzf8jib5syx1cwfgifsxxp-test-sandbox-0.1.9`
  - `out`:  `/nix/store/m115qsp0y0jzf8jib5syx1cwfgifsxxp-test-sandbox-0.1.9`

## 🔗 Dependencies

- [[00d6js7d91zmrll15kzqpvmchwa5xh1g-lifted-base-0.2.3.12]]
- [[38qvznvki9azhz4jpkaj0xg2wjyrhrif-test-sandbox-0.1.9.tar.gz]]
