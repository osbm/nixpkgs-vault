...
Port of (rnrs files) to R7RS

## 📋 Package Information

- **Name**: `akkuPackages.r6rs-files`
- **Version**: `0.0.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Port of (rnrs files) to R7RS
- **Homepage**: []()
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/aik29329hvpszliykammkb6gnppxkfcn-akku-r6rs-files-0.0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/tools/package-management/akku/default.nix:39`
- **Outputs**:
  - `out`:  `/nix/store/aik29329hvpszliykammkb6gnppxkfcn-akku-r6rs-files-0.0.1`

## 🔗 Dependencies

- [[0fmn6shqrv14ib2dp0v4ibxznixbf4rn-r6rs-files-0.0.1.tgz]]
