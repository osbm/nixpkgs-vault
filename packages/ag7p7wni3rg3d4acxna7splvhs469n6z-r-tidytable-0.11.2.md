...
- **Name**: `rPackages.tidytable`
- **Version**: `0.11.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/tidytable/](https://cran.r-project.org/web/packages/tidytable/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/ag7p7wni3rg3d4acxna7splvhs469n6z-r-tidytable-0.11.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/ag7p7wni3rg3d4acxna7splvhs469n6z-r-tidytable-0.11.2`
...
- [[6i1hsc4fxf7s8w58sphdz5kmfwc6x06d-tidytable_0.11.2.tar.gz]]
