...
- **Name**: `haskellPackages.subhask`
- **Version**: `0.1.1.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Type safe interface for programming in subcategories of Hask
- **Homepage**: [https://hackage.haskell.org/package/subhask](https://hackage.haskell.org/package/subhask)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/byanjnqr9c2jspcyhxrmjm60rl3c0ma3-subhask-0.1.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:644971`
- **Outputs**:
  - `doc`:  `/nix/store/byanjnqr9c2jspcyhxrmjm60rl3c0ma3-subhask-0.1.1.0`
  - `out`:  `/nix/store/byanjnqr9c2jspcyhxrmjm60rl3c0ma3-subhask-0.1.1.0`
...
- [[jalpzbmv9558q6j8lkmgw9plq58dpcis-bloomfilter-2.0.1.2]]
