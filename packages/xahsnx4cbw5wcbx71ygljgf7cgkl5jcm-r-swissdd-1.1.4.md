...
- **Name**: `rPackages.swissdd`
- **Version**: `1.1.4`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://cran.r-project.org/web/packages/swissdd/](https://cran.r-project.org/web/packages/swissdd/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/xahsnx4cbw5wcbx71ygljgf7cgkl5jcm-r-swissdd-1.1.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/xahsnx4cbw5wcbx71ygljgf7cgkl5jcm-r-swissdd-1.1.4`
...
- [[zfysmfpy5249cfaq10rjq8pw0kn1b0pi-swissdd_1.1.4.tar.gz]]
