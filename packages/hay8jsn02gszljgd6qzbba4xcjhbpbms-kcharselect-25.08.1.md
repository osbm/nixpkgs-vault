...
- **Name**: `kdePackages.kcharselect`
- **Version**: `25.08.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Tool to select and copy special characters from all installed fonts
- **Homepage**: [https://invent.kde.org/utilities/kcharselect](https://invent.kde.org/utilities/kcharselect)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/hay8jsn02gszljgd6qzbba4xcjhbpbms-kcharselect-25.08.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/kde/gear/kcharselect/default.nix:3`
- **Outputs**:
  - `debug`:  `/nix/store/hay8jsn02gszljgd6qzbba4xcjhbpbms-kcharselect-25.08.1`
  - `dev`:  `/nix/store/hay8jsn02gszljgd6qzbba4xcjhbpbms-kcharselect-25.08.1`
  - `devtools`:  `/nix/store/hay8jsn02gszljgd6qzbba4xcjhbpbms-kcharselect-25.08.1`
  - `out`:  `/nix/store/hay8jsn02gszljgd6qzbba4xcjhbpbms-kcharselect-25.08.1`
...
- [[90qp37bcvkq0ljlg6ayzwsw4cp0a36n8-kcharselect-25.08.1.tar.xz]]
