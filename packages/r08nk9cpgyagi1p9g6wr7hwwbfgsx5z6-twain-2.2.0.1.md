...
- **Name**: `haskellPackages.twain`
- **Version**: `2.2.0.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Tiny web application framework for WAI
- **Homepage**: [https://hackage.haskell.org/package/twain](https://hackage.haskell.org/package/twain)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/r08nk9cpgyagi1p9g6wr7hwwbfgsx5z6-twain-2.2.0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:687420`
- **Outputs**:
  - `doc`:  `/nix/store/r08nk9cpgyagi1p9g6wr7hwwbfgsx5z6-twain-2.2.0.1`
  - `out`:  `/nix/store/r08nk9cpgyagi1p9g6wr7hwwbfgsx5z6-twain-2.2.0.1`
...
- [[wmizqrhn90cpw1hn3ryq0vi5qh9sdxm6-twain-2.2.0.1.tar.gz]]
