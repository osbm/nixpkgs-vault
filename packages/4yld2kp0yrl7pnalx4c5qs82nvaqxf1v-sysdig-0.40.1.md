---
aliases:
  - linuxKernel.packages.linux_xanmod_stable.sysdig
tags:
  - license/unknown
...
- **Name**: `linuxKernel.packages.linux_xanmod_stable.sysdig`
- **Version**: `0.40.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/4yld2kp0yrl7pnalx4c5qs82nvaqxf1v-sysdig-0.40.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/sysdig/default.nix:182`
- **Outputs**:
  - `out`:  `/nix/store/4yld2kp0yrl7pnalx4c5qs82nvaqxf1v-sysdig-0.40.1`
