...
- **Name**: `python312Packages.boost-histogram`
- **Version**: `1.5.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Python bindings for the C++14 Boost::Histogram library
- **Homepage**: [https://github.com/scikit-hep/boost-histogram](https://github.com/scikit-hep/boost-histogram)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/0vkk4gzb84gfh6yljhr89l90iw0d2dpv-python3.12-boost-histogram-1.5.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/boost-histogram/default.nix:79`
- **Outputs**:
  - `dist`:  `/nix/store/0vkk4gzb84gfh6yljhr89l90iw0d2dpv-python3.12-boost-histogram-1.5.2`
  - `out`:  `/nix/store/0vkk4gzb84gfh6yljhr89l90iw0d2dpv-python3.12-boost-histogram-1.5.2`
...
- [[jp438rihg85nl3v7qbbdk5xxirajkn92-source]]
