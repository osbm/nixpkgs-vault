...
- **Name**: `python313Packages.cli-helpers`
- **Version**: `2.7.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Python helpers for common CLI tasks
- **Homepage**: [https://cli-helpers.readthedocs.io/en/stable/](https://cli-helpers.readthedocs.io/en/stable/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/krwazf95048fhpi9n1wmqjp75210fmag-python3.13-cli-helpers-2.7.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/cli-helpers/default.nix:43`
- **Outputs**:
  - `dist`:  `/nix/store/krwazf95048fhpi9n1wmqjp75210fmag-python3.13-cli-helpers-2.7.0`
  - `out`:  `/nix/store/krwazf95048fhpi9n1wmqjp75210fmag-python3.13-cli-helpers-2.7.0`
...
- [[njrpnvvlk1vr6cpdqqwpc0bi3g4d67ym-cli_helpers-2.7.0.tar.gz]]
