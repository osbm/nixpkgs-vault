---
aliases:
  - linuxKernel.packages.linux_hardened.rr-zen_workaround
tags:
  - license/unknown
  - maintainers/vcunat
  - outputs/out
...
- **Name**: `linuxKernel.packages.linux_hardened.rr-zen_workaround`
- **Version**: `5.9.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/5sxayhqg65cyg847laf1v6n0ncbw5fv6-rr-zen_workaround-5.9.0.drv`
...
- **Outputs**:
  - `out`:  `/nix/store/5sxayhqg65cyg847laf1v6n0ncbw5fv6-rr-zen_workaround-5.9.0`
