...
- **Name**: `emacsPackages.php-mode`
- **Version**: `20250602.1308`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://github.com/emacs-php/php-mode](https://github.com/emacs-php/php-mode)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/chv03qnlphrpd2v1j0r9y5jn2nzp59g9-emacs-php-mode-20250602.1308.drv`
...
- **Outputs**:
  - `out`:  `/nix/store/chv03qnlphrpd2v1j0r9y5jn2nzp59g9-emacs-php-mode-20250602.1308`

## 🔗 Dependencies

- [[84irbgn3jnmpdrixlrvwd25ldsx280dd-php-mode-recipe]]
- [[b4pa5k4if2jl33f1ynicjwz2nihy4z3c-texinfo-7.2]]
- [[bjsb6wdjykafnkixq156qdvmxhsm2bai-bash-5.3p3]]
- [[d1gkgsfk73na6xqx2z59sph5fhapwbgi-source]]
