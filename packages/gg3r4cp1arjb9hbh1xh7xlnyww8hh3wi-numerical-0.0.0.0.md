...
- **Name**: `haskellPackages.numerical`
- **Version**: `0.0.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: core package for Numerical Haskell project
- **Homepage**: [https://hackage.haskell.org/package/numerical](https://hackage.haskell.org/package/numerical)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/gg3r4cp1arjb9hbh1xh7xlnyww8hh3wi-numerical-0.0.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:484302`
- **Outputs**:
  - `doc`:  `/nix/store/gg3r4cp1arjb9hbh1xh7xlnyww8hh3wi-numerical-0.0.0.0`
  - `out`:  `/nix/store/gg3r4cp1arjb9hbh1xh7xlnyww8hh3wi-numerical-0.0.0.0`
...
- [[jrkp44kqwikpkmld1fs87faabjhz734a-numerical-0.0.0.0.tar.gz]]
