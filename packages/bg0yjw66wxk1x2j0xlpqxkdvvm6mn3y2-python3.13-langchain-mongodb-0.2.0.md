...
- **Name**: `python313Packages.langchain-mongodb`
- **Version**: `0.2.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/bg0yjw66wxk1x2j0xlpqxkdvvm6mn3y2-python3.13-langchain-mongodb-0.2.0.drv`
...
- **Outputs**:
  - `dist`:  `/nix/store/bg0yjw66wxk1x2j0xlpqxkdvvm6mn3y2-python3.13-langchain-mongodb-0.2.0`
  - `out`:  `/nix/store/bg0yjw66wxk1x2j0xlpqxkdvvm6mn3y2-python3.13-langchain-mongodb-0.2.0`
