...
- **Name**: `rPackages.myTAI`
- **Version**: `0.9.3`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://cran.r-project.org/web/packages/myTAI/](https://cran.r-project.org/web/packages/myTAI/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/smpnb830p8q70rpxaf6zd0kcaxnwikpn-r-myTAI-0.9.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/smpnb830p8q70rpxaf6zd0kcaxnwikpn-r-myTAI-0.9.3`
...
- [[f0crnwjn4x16k94k0awk0iqbz98vdql9-myTAI_0.9.3.tar.gz]]
