...
- **Name**: `php81Extensions.ldap`
- **Version**: `8.1.33`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: PHP upstream extension: ldap
...
- **Derivation Path**: `/nix/store/5anzmn5nvr6habwwbws5kyykdmm6nykk-php-ldap-8.1.33.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/top-level/php-packages.nix:206`
- **Outputs**:
  - `dev`:  `/nix/store/5anzmn5nvr6habwwbws5kyykdmm6nykk-php-ldap-8.1.33`
  - `out`:  `/nix/store/5anzmn5nvr6habwwbws5kyykdmm6nykk-php-ldap-8.1.33`
