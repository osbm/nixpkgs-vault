...
- **Name**: `haskellPackages.stm-conduit`
- **Version**: `4.0.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Introduces conduits to channels, and promotes using conduits concurrently
- **Homepage**: [https://hackage.haskell.org/package/stm-conduit](https://hackage.haskell.org/package/stm-conduit)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/h4gfkz19hszfy825fifhjsny821wi2bg-stm-conduit-4.0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:636889`
- **Outputs**:
  - `doc`:  `/nix/store/h4gfkz19hszfy825fifhjsny821wi2bg-stm-conduit-4.0.1`
  - `out`:  `/nix/store/h4gfkz19hszfy825fifhjsny821wi2bg-stm-conduit-4.0.1`
...
- [[7crdkkalwcqdhsgc94g5jaxqz7zlr66v-stm-conduit-4.0.1.tar.gz]]
...
- [[jac2z69785q2xfbjbhwj9rgarp3xjk3s-stm-conduit-4.0.1-r1.cabal]]
