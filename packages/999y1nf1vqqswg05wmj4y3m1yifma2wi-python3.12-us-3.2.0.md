...
- **Name**: `python312Packages.us`
- **Version**: `3.2.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Package for easily working with US and state metadata
- **Homepage**: [https://github.com/unitedstates/python-us/](https://github.com/unitedstates/python-us/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/999y1nf1vqqswg05wmj4y3m1yifma2wi-python3.12-us-3.2.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/us/default.nix:38`
- **Outputs**:
  - `dist`:  `/nix/store/999y1nf1vqqswg05wmj4y3m1yifma2wi-python3.12-us-3.2.0`
  - `out`:  `/nix/store/999y1nf1vqqswg05wmj4y3m1yifma2wi-python3.12-us-3.2.0`
...
- [[rx44xsbqn1kb3483pn9jv4nwxwlb0jvv-us-3.2.0.tar.gz]]
