...
- **Name**: `haskellPackages.gi-gdkpixbuf`
- **Version**: `2.0.32`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: GdkPixbuf bindings
- **Homepage**: [https://hackage.haskell.org/package/gi-gdkpixbuf](https://hackage.haskell.org/package/gi-gdkpixbuf)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/w0azi38cj2vywgp9x2yaljfzlfmhd47a-gi-gdkpixbuf-2.0.32.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:264450`
- **Outputs**:
  - `doc`:  `/nix/store/w0azi38cj2vywgp9x2yaljfzlfmhd47a-gi-gdkpixbuf-2.0.32`
  - `out`:  `/nix/store/w0azi38cj2vywgp9x2yaljfzlfmhd47a-gi-gdkpixbuf-2.0.32`
