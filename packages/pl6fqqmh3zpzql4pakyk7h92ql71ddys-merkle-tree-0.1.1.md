...
- **Name**: `haskellPackages.merkle-tree`
- **Version**: `0.1.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: An implementation of a Merkle tree and merkle tree proofs of inclusion
- **Homepage**: [https://hackage.haskell.org/package/merkle-tree](https://hackage.haskell.org/package/merkle-tree)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/pl6fqqmh3zpzql4pakyk7h92ql71ddys-merkle-tree-0.1.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:444932`
- **Outputs**:
  - `doc`:  `/nix/store/pl6fqqmh3zpzql4pakyk7h92ql71ddys-merkle-tree-0.1.1`
  - `out`:  `/nix/store/pl6fqqmh3zpzql4pakyk7h92ql71ddys-merkle-tree-0.1.1`
...
- [[ilpxya26pd41hnsdh72niz2hjjhas4as-merkle-tree-0.1.1.tar.gz]]
