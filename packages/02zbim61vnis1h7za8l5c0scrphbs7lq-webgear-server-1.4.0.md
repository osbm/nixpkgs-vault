---
aliases:
  - haskellPackages.webgear-server_1_4_0
tags:
  - license/unknown
  - outputs/doc
  - outputs/out
...
- **Name**: `haskellPackages.webgear-server_1_4_0`
- **Version**: `1.4.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Composable, type-safe library to build HTTP API servers
- **Homepage**: [https://hackage.haskell.org/package/webgear-server](https://hackage.haskell.org/package/webgear-server)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/02zbim61vnis1h7za8l5c0scrphbs7lq-webgear-server-1.4.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:720287`
- **Outputs**:
  - `doc`:  `/nix/store/02zbim61vnis1h7za8l5c0scrphbs7lq-webgear-server-1.4.0`
  - `out`:  `/nix/store/02zbim61vnis1h7za8l5c0scrphbs7lq-webgear-server-1.4.0`

## 🔗 Dependencies

- [[0jk9igvcynf8dh9n7zrqms788p08jg0b-arrows-0.4.4.2]]
- [[2pr652igq6awvbbf5rfnb3kbrmg1cryf-http-types-0.12.4]]
- [[32v1d6mwn8ddabyvd91jdbb79yi5h5gb-webgear-server-1.4.0.tar.gz]]
...
- [[n8jh7rvq5j71wk910kpgmrjji9w0nspn-webgear-core-1.3.1]]
