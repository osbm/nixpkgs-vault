---
aliases:
  - androidenv.androidPkgs.all.addons.v3.google_apis
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.addons.v3.google_apis`
- **Version**: `3-r03.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/9aw3cy84zch9nyc4i2qdw2b0cji9vlrl-google_apis-3-r03.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/9aw3cy84zch9nyc4i2qdw2b0cji9vlrl-google_apis-3-r03.zip`
