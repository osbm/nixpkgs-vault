...
- **Name**: `rPackages.echarts4r`
- **Version**: `0.4.5`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/echarts4r/](https://cran.r-project.org/web/packages/echarts4r/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/agqqj1171mqfgsbwbv6xhmqrbdk0jcsg-r-echarts4r-0.4.5.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/agqqj1171mqfgsbwbv6xhmqrbdk0jcsg-r-echarts4r-0.4.5`
...
- [[sy2f37wl1d1j13571gqp7l790a3x35f7-echarts4r_0.4.5.tar.gz]]
