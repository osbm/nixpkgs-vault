...
- **Name**: `haskellPackages.cfg`
- **Version**: `0.0.2.2`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Type directed application configuration parsing and accessors
- **Homepage**: [https://hackage.haskell.org/package/cfg](https://hackage.haskell.org/package/cfg)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/ns3fvr9rzka5w7pfdq0igcg0x8g4dwbx-cfg-0.0.2.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:134814`
- **Outputs**:
  - `doc`:  `/nix/store/ns3fvr9rzka5w7pfdq0igcg0x8g4dwbx-cfg-0.0.2.2`
  - `out`:  `/nix/store/ns3fvr9rzka5w7pfdq0igcg0x8g4dwbx-cfg-0.0.2.2`
...
- [[9cpmz2rs852fs1vs7cqzhf1jh0kr4rcg-cfg-0.0.2.2.tar.gz]]
