...
- **Name**: `haskellPackages.arch-web`
- **Version**: `0.3.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Arch Linux official and AUR web interface binding
- **Homepage**: [https://hackage.haskell.org/package/arch-web](https://hackage.haskell.org/package/arch-web)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/139xfxscp6yiyhj4mhiqvfcdhiw3pvgd-arch-web-0.3.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:81878`
- **Outputs**:
  - `doc`:  `/nix/store/139xfxscp6yiyhj4mhiqvfcdhiw3pvgd-arch-web-0.3.1`
  - `out`:  `/nix/store/139xfxscp6yiyhj4mhiqvfcdhiw3pvgd-arch-web-0.3.1`
...
- [[ylr1fb3ibwk4hjb9vy44175ylgmbmri5-arch-web-0.3.1.tar.gz]]
