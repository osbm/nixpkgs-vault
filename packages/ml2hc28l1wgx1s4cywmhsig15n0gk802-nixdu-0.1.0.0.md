...
- **Name**: `haskellPackages.nixdu`
- **Version**: `0.1.0.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Interactively browse a Nix store paths dependencies
- **Homepage**: [https://hackage.haskell.org/package/nixdu](https://hackage.haskell.org/package/nixdu)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/ml2hc28l1wgx1s4cywmhsig15n0gk802-nixdu-0.1.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:479546`
- **Outputs**:
  - `doc`:  `/nix/store/ml2hc28l1wgx1s4cywmhsig15n0gk802-nixdu-0.1.0.0`
  - `out`:  `/nix/store/ml2hc28l1wgx1s4cywmhsig15n0gk802-nixdu-0.1.0.0`

## 🔗 Dependencies

- [[0jzzkf2b8d9l5v7lr4c7nriwjh9iagqj-nixdu-0.1.0.0.tar.gz]]
...
- [[vrglcsbhkfj3dwb9i9hj1v7hdg110wq9-hrfsize-0.0.2]]
