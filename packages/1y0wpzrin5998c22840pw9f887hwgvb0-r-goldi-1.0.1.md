...
- **Name**: `rPackages.goldi`
- **Version**: `1.0.1`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://cran.r-project.org/web/packages/goldi/](https://cran.r-project.org/web/packages/goldi/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/1y0wpzrin5998c22840pw9f887hwgvb0-r-goldi-1.0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/1y0wpzrin5998c22840pw9f887hwgvb0-r-goldi-1.0.1`
...
- [[j5z4cznz1wy7wramqp399m9vj3sx2cbk-goldi_1.0.1.tar.gz]]
