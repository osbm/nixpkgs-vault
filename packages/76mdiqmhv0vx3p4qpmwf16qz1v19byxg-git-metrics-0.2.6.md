...
Git extension to be able to track metrics about your project, within the git repository
...
- **Homepage**: [https://github.com/jdrouet/git-metrics](https://github.com/jdrouet/git-metrics)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/76mdiqmhv0vx3p4qpmwf16qz1v19byxg-git-metrics-0.2.6.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/gi/git-metrics/package.nix:45`
- **Outputs**:
  - `out`:  `/nix/store/76mdiqmhv0vx3p4qpmwf16qz1v19byxg-git-metrics-0.2.6`
...
- [[4cshlyim2af6d1c4gq11aamn809k8pzc-source]]
- [[5x9g9n8gzrdy806j6nzvyia7zv2pyzhg-git-minimal-2.51.0]]
- [[7d5p0ip9nd3aj3r1a2pmhsxxizqqnis8-openssl-3.5.1]]
- [[bjsb6wdjykafnkixq156qdvmxhsm2bai-bash-5.3p3]]
- [[lvdvlk7cwad5mna0wfpz8jllb30jdj1n-pkg-config-wrapper-0.29.2]]
- [[p37nrx0ag2niq1cxgazyjs7r97dpz7mh-git-metrics-0.2.6-vendor]]
