---
aliases:
  - androidenv.androidPkgs.all.system-images.v24.google_apis.x86_64
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.system-images.v24.google_apis.x86_64`
- **Version**: `24_r27.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/v9d39apxz44rr9s08x4jzmdid1kn2dsi-x86_64-24_r27.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/v9d39apxz44rr9s08x4jzmdid1kn2dsi-x86_64-24_r27.zip`
