...
- **Name**: `rPackages.orbital`
- **Version**: `0.3.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/orbital/](https://cran.r-project.org/web/packages/orbital/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/sf9si87hx41vha3l42027abq4qwbwrbq-r-orbital-0.3.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/sf9si87hx41vha3l42027abq4qwbwrbq-r-orbital-0.3.0`

## 🔗 Dependencies

- [[7z4520kqjqs8qf5g05lg8b851rxfl8my-orbital_0.3.0.tar.gz]]
