...
- **Name**: `haskellPackages.stdio`
- **Version**: `0.2.0.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: A simple and high performance IO toolkit for Haskell
- **Homepage**: [https://hackage.haskell.org/package/stdio](https://hackage.haskell.org/package/stdio)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/l5rg1wjw7658dmgvqzwdlvn9sayyyh7v-stdio-0.2.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:636246`
- **Outputs**:
  - `doc`:  `/nix/store/l5rg1wjw7658dmgvqzwdlvn9sayyyh7v-stdio-0.2.0.0`
  - `out`:  `/nix/store/l5rg1wjw7658dmgvqzwdlvn9sayyyh7v-stdio-0.2.0.0`
...
- [[rbcz1bjx7f4zw0w25rbfgcdq5rxnjaxs-stdio-0.2.0.0.tar.gz]]
