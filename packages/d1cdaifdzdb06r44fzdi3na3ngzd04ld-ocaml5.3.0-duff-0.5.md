...
- **Name**: `ocamlPackages.duff`
- **Version**: `0.5`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Pure OCaml implementation of libXdiff (Rabin’s fingerprint)
- **Homepage**: [https://github.com/mirage/duff](https://github.com/mirage/duff)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/d1cdaifdzdb06r44fzdi3na3ngzd04ld-ocaml5.3.0-duff-0.5.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/ocaml-modules/duff/default.nix:35`
- **Outputs**:
  - `out`:  `/nix/store/d1cdaifdzdb06r44fzdi3na3ngzd04ld-ocaml5.3.0-duff-0.5`
...
- [[q12yrd54mk9aggsjwqgf7fpj1prksgm4-duff-0.5.tbz]]
