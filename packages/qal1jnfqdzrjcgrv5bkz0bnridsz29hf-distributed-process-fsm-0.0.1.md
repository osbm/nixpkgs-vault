---
aliases:
  - haskellPackages.distributed-process-fsm
tags:
  - broken
  - not-available
  - license/unknown
...
- **Name**: `haskellPackages.distributed-process-fsm`
- **Version**: `0.0.1`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: The Cloud Haskell implementation of Erlang/OTP gen_statem
- **Homepage**: [https://hackage.haskell.org/package/distributed-process-fsm](https://hackage.haskell.org/package/distributed-process-fsm)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/qal1jnfqdzrjcgrv5bkz0bnridsz29hf-distributed-process-fsm-0.0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:197299`
- **Outputs**:
  - `doc`:  `/nix/store/qal1jnfqdzrjcgrv5bkz0bnridsz29hf-distributed-process-fsm-0.0.1`
  - `out`:  `/nix/store/qal1jnfqdzrjcgrv5bkz0bnridsz29hf-distributed-process-fsm-0.0.1`
...
- [[5d5hpidfc6f50ws9rij8w222b387pz5p-distributed-process-fsm-0.0.1.tar.gz]]
...
---
*Generated on 2025-09-27 12:42:16 UTC*
