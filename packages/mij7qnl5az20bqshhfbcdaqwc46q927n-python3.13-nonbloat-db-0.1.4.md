...
- **Name**: `python313Packages.nonbloat-db`
- **Version**: `0.1.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Simple key-value database for my small projects
- **Homepage**: [https://github.com/PerchunPak/nonbloat-db](https://github.com/PerchunPak/nonbloat-db)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/mij7qnl5az20bqshhfbcdaqwc46q927n-python3.13-nonbloat-db-0.1.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/nonbloat-db/default.nix:65`
- **Outputs**:
  - `dist`:  `/nix/store/mij7qnl5az20bqshhfbcdaqwc46q927n-python3.13-nonbloat-db-0.1.4`
  - `out`:  `/nix/store/mij7qnl5az20bqshhfbcdaqwc46q927n-python3.13-nonbloat-db-0.1.4`
