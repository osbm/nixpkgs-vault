...
- **Name**: `rPackages.ggsem`
- **Version**: `0.2.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/ggsem/](https://cran.r-project.org/web/packages/ggsem/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/y7cms1qjvgck4q6gzjbwv752s11zcj54-r-ggsem-0.2.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/y7cms1qjvgck4q6gzjbwv752s11zcj54-r-ggsem-0.2.4`

## 🔗 Dependencies

- [[41lpx5s2g6ynq135gpmfck7ai5y7r09v-r-igraph-2.1.4]]
- [[5gf1iwrqpx078n0l5x2wb15k9mrzsjza-r-smplot2-0.2.5]]
...
- [[n7hbzv2ylyz5bg6vbs4scf9s2m12d94b-ggsem_0.2.4.tar.gz]]
