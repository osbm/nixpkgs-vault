...
- **Name**: `haskellPackages.wai-lambda`
- **Version**: `0.1.1.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Haskell Webapps on AWS Lambda
- **Homepage**: [https://hackage.haskell.org/package/wai-lambda](https://hackage.haskell.org/package/wai-lambda)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/xlrxl0rwlrvwy2xl6ibifwljg84wwrs1-wai-lambda-0.1.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:712515`
- **Outputs**:
  - `doc`:  `/nix/store/xlrxl0rwlrvwy2xl6ibifwljg84wwrs1-wai-lambda-0.1.1.0`
  - `out`:  `/nix/store/xlrxl0rwlrvwy2xl6ibifwljg84wwrs1-wai-lambda-0.1.1.0`
...
- [[5344s043h1iqr5brdwp20lq9412b99r4-wai-lambda-0.1.1.0.tar.gz]]
