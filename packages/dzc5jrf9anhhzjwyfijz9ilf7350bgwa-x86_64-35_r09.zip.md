...
- **Name**: `androidenv.androidPkgs.all.system-images.v35.google_apis_playstore.x86_64`
- **Version**: `35_r09.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/dzc5jrf9anhhzjwyfijz9ilf7350bgwa-x86_64-35_r09.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/dzc5jrf9anhhzjwyfijz9ilf7350bgwa-x86_64-35_r09.zip`
