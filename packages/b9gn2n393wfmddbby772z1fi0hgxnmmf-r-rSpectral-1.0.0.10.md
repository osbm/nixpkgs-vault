...
- **Name**: `rPackages.rSpectral`
- **Version**: `1.0.0.10`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/rSpectral/](https://cran.r-project.org/web/packages/rSpectral/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/b9gn2n393wfmddbby772z1fi0hgxnmmf-r-rSpectral-1.0.0.10.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/b9gn2n393wfmddbby772z1fi0hgxnmmf-r-rSpectral-1.0.0.10`
...
- [[hsx8sgdp138c4q5zxm1dazikxsv523b1-rSpectral_1.0.0.10.tar.gz]]
