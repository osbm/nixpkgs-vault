---
aliases:
  - haskellPackages.google-server-api
tags:
  - broken
  - not-available
  - license/unknown
...
- **Name**: `haskellPackages.google-server-api`
- **Version**: `0.4.1.1`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Google APIs for server to server applications
- **Homepage**: [https://hackage.haskell.org/package/google-server-api](https://hackage.haskell.org/package/google-server-api)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/dnzb948jidgkmrqpss4imf9nkh8skdws-google-server-api-0.4.1.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:278582`
- **Outputs**:
  - `doc`:  `/nix/store/dnzb948jidgkmrqpss4imf9nkh8skdws-google-server-api-0.4.1.1`
  - `out`:  `/nix/store/dnzb948jidgkmrqpss4imf9nkh8skdws-google-server-api-0.4.1.1`
...
- [[h4r3gib2yqjwfmhgn8ha0q459hgnz0wc-google-server-api-0.4.1.1.tar.gz]]
