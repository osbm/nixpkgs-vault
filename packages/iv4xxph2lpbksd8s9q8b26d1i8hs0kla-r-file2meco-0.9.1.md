...
- **Name**: `rPackages.file2meco`
- **Version**: `0.9.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/file2meco/](https://cran.r-project.org/web/packages/file2meco/)
- **License**: `unknown`
