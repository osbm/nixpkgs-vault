---
aliases:
  - linuxKernel.packages.linux_hardened.nvidia_x11_beta_open
tags:
  - license/unknown
  - maintainers/NickCao
  - outputs/out
...
- **Name**: `linuxKernel.packages.linux_hardened.nvidia_x11_beta_open`
- **Version**: `6.12.43-580.82.09`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/43v66wjgnl2sqg9q7z89cgz4av57gn4j-nvidia-open-6.12.43-580.82.09.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/nvidia-x11/open.nix:46`
- **Outputs**:
  - `out`:  `/nix/store/43v66wjgnl2sqg9q7z89cgz4av57gn4j-nvidia-open-6.12.43-580.82.09`
