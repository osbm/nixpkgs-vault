...
- **Name**: `rPackages.psborrow2`
- **Version**: `0.0.4.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/psborrow2/](https://cran.r-project.org/web/packages/psborrow2/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/b574l8jh6z10nav5s5izcylc0hw4ssy5-r-psborrow2-0.0.4.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/b574l8jh6z10nav5s5izcylc0hw4ssy5-r-psborrow2-0.0.4.0`
...
- [[wh9mwkj8831p9xpd59wzi2ii6w0yr5jj-psborrow2_0.0.4.0.tar.gz]]
