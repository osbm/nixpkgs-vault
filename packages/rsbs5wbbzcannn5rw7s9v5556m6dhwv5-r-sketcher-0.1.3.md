...
- **Name**: `rPackages.sketcher`
- **Version**: `0.1.3`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/sketcher/](https://cran.r-project.org/web/packages/sketcher/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/rsbs5wbbzcannn5rw7s9v5556m6dhwv5-r-sketcher-0.1.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/rsbs5wbbzcannn5rw7s9v5556m6dhwv5-r-sketcher-0.1.3`
...
- [[wiqywq14pp39w3i04zvznx1vaqc891sh-sketcher_0.1.3.tar.gz]]
