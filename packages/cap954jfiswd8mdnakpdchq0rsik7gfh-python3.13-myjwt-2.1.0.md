...
- **Name**: `python313Packages.myjwt`
- **Version**: `2.1.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: CLI tool for testing vulnerabilities of JSON Web Tokens (JWT)
- **Homepage**: [https://github.com/mBouamama/MyJWT](https://github.com/mBouamama/MyJWT)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/cap954jfiswd8mdnakpdchq0rsik7gfh-python3.13-myjwt-2.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/myjwt/default.nix:60`
- **Outputs**:
  - `dist`:  `/nix/store/cap954jfiswd8mdnakpdchq0rsik7gfh-python3.13-myjwt-2.1.0`
  - `out`:  `/nix/store/cap954jfiswd8mdnakpdchq0rsik7gfh-python3.13-myjwt-2.1.0`
...
- [[grn9jhc8ks1dc0h5vqn4k8rilskg9a4d-source]]
- [[hrz1bf341q4n0d2zx8rlyrmsqi0wdalw-python3.13-exrex-0.11.0]]
