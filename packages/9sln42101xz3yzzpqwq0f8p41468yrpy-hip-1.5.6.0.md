...
- **Name**: `haskellPackages.hip`
- **Version**: `1.5.6.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Haskell Image Processing (HIP) Library
- **Homepage**: [https://hackage.haskell.org/package/hip](https://hackage.haskell.org/package/hip)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/9sln42101xz3yzzpqwq0f8p41468yrpy-hip-1.5.6.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:329285`
- **Outputs**:
  - `doc`:  `/nix/store/9sln42101xz3yzzpqwq0f8p41468yrpy-hip-1.5.6.0`
  - `out`:  `/nix/store/9sln42101xz3yzzpqwq0f8p41468yrpy-hip-1.5.6.0`
...
- [[xp7hwjvjz93mj34kjzg29vpgcg7174xv-hip-1.5.6.0.tar.gz]]
