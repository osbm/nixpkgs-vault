...
- **Name**: `postgresql13Packages.timescaledb`
- **Version**: `2.22.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
...
- **Derivation Path**: `/nix/store/2p7vpld2p73rad4632lj8dh3ipnbp9lp-timescaledb-2.22.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/sql/postgresql/ext/timescaledb.nix:98`
- **Outputs**:
  - `out`:  `/nix/store/2p7vpld2p73rad4632lj8dh3ipnbp9lp-timescaledb-2.22.0`
