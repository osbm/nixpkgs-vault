...
- **Name**: `python312Packages.google-generativeai`
- **Version**: `0.8.5`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/bjzxfrvqglsz0gnyy3l7z2f8mwazsc15-python3.12-google-generativeai-0.8.5.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/google-generativeai/default.nix:52`
- **Outputs**:
  - `dist`:  `/nix/store/bjzxfrvqglsz0gnyy3l7z2f8mwazsc15-python3.12-google-generativeai-0.8.5`
  - `out`:  `/nix/store/bjzxfrvqglsz0gnyy3l7z2f8mwazsc15-python3.12-google-generativeai-0.8.5`
...
- [[nflwgsx3fpvvyirgsxsicca8zwvms87x-source]]
