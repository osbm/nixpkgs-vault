...
- **Homepage**: [https://mapproxy.org/](https://mapproxy.org/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/i0qr9js6a1ma19v63mblag2ls2nbp23k-mapproxy-5.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/ma/mapproxy/package.nix:49`
- **Outputs**:
  - `dist`:  `/nix/store/i0qr9js6a1ma19v63mblag2ls2nbp23k-mapproxy-5.0.0`
  - `out`:  `/nix/store/i0qr9js6a1ma19v63mblag2ls2nbp23k-mapproxy-5.0.0`
...
- [[kmj4w74f4fpi0j0hxidzhivlnv6c6nxv-source]]
