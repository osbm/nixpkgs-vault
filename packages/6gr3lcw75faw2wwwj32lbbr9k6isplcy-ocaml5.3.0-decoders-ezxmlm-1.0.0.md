...
Ezxmlm backend for decoders

## 📋 Package Information

- **Name**: `ocamlPackages.decoders-ezxmlm`
- **Version**: `1.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/6gr3lcw75faw2wwwj32lbbr9k6isplcy-ocaml5.3.0-decoders-ezxmlm-1.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/ocaml-modules/decoders-ezxmlm/default.nix:28`
- **Outputs**:
  - `out`:  `/nix/store/6gr3lcw75faw2wwwj32lbbr9k6isplcy-ocaml5.3.0-decoders-ezxmlm-1.0.0`
