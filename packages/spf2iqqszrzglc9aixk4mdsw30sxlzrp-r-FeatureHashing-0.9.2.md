...
- **Name**: `rPackages.FeatureHashing`
- **Version**: `0.9.2`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://cran.r-project.org/web/packages/FeatureHashing/](https://cran.r-project.org/web/packages/FeatureHashing/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/spf2iqqszrzglc9aixk4mdsw30sxlzrp-r-FeatureHashing-0.9.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/spf2iqqszrzglc9aixk4mdsw30sxlzrp-r-FeatureHashing-0.9.2`
...
- [[93zmznsdjabri5kq6dnv4cc9h6gbih4c-FeatureHashing_0.9.2.tar.gz]]
