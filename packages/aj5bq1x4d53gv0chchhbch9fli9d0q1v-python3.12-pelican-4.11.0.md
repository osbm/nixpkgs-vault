...
- **Name**: `python312Packages.pelican`
- **Version**: `4.11.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Static site generator that requires no database or server-side logic
- **Homepage**: [https://getpelican.com/](https://getpelican.com/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/aj5bq1x4d53gv0chchhbch9fli9d0q1v-python3.12-pelican-4.11.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/pelican/default.nix:132`
- **Outputs**:
  - `dist`:  `/nix/store/aj5bq1x4d53gv0chchhbch9fli9d0q1v-python3.12-pelican-4.11.0`
  - `out`:  `/nix/store/aj5bq1x4d53gv0chchhbch9fli9d0q1v-python3.12-pelican-4.11.0`
...
- [[c9hnawp429acgb5l693i767ahpd3dhr9-python3.12-feedgenerator-2.2.1]]
...
- [[q9sgl9qfbr5mvhl820z744lk34qx4545-source]]
...
- [[xz6zdiqnvjzvqz0xahnmp3bh7c5ia691-python3.12-typogrify-2.1.0]]
