...
- **Name**: `python313Packages.torchWithVulkan`
- **Version**: `2.8.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/4bw9za8ifamjisyy21wri5df2liv0dqf-python3.13-torch-2.8.0.drv`
...
- **Outputs**:
  - `cxxdev`:  `/nix/store/4bw9za8ifamjisyy21wri5df2liv0dqf-python3.13-torch-2.8.0`
  - `dev`:  `/nix/store/4bw9za8ifamjisyy21wri5df2liv0dqf-python3.13-torch-2.8.0`
  - `dist`:  `/nix/store/4bw9za8ifamjisyy21wri5df2liv0dqf-python3.13-torch-2.8.0`
  - `lib`:  `/nix/store/4bw9za8ifamjisyy21wri5df2liv0dqf-python3.13-torch-2.8.0`
  - `out`:  `/nix/store/4bw9za8ifamjisyy21wri5df2liv0dqf-python3.13-torch-2.8.0`
