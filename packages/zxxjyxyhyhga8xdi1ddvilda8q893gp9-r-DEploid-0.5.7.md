...
- **Name**: `rPackages.DEploid`
- **Version**: `0.5.7`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/DEploid/](https://cran.r-project.org/web/packages/DEploid/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/zxxjyxyhyhga8xdi1ddvilda8q893gp9-r-DEploid-0.5.7.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/zxxjyxyhyhga8xdi1ddvilda8q893gp9-r-DEploid-0.5.7`

## 🔗 Dependencies

- [[1549hrqf30dcydflwljsw3vg2x740r3c-DEploid_0.5.7.tar.gz]]
...
- [[dqy8l0cp48agracygffbdsi1isajq214-r-DEploid.utils-0.0.1]]
