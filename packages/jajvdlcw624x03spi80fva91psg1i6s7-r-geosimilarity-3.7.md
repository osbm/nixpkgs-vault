...
- **Name**: `rPackages.geosimilarity`
- **Version**: `3.7`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/geosimilarity/](https://cran.r-project.org/web/packages/geosimilarity/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/jajvdlcw624x03spi80fva91psg1i6s7-r-geosimilarity-3.7.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/jajvdlcw624x03spi80fva91psg1i6s7-r-geosimilarity-3.7`

## 🔗 Dependencies

- [[3f8n9gfa8d7ay5sixww3x88fg6vxvhfg-r-magrittr-2.0.3]]
- [[5js0442m923xkvawvnkn6xvjf5rcwjli-geosimilarity_3.7.tar.gz]]
