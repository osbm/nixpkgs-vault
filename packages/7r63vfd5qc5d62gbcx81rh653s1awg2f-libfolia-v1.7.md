...
- **Name**: `languageMachines.libfolia`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: C++ API for FoLiA documents; an XML-based linguistic annotation format
- **Homepage**: [https://proycon.github.io/folia/](https://proycon.github.io/folia/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/7r63vfd5qc5d62gbcx81rh653s1awg2f-libfolia-v1.7.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/libraries/languagemachines/libfolia.nix:48`
- **Outputs**:
  - `out`:  `/nix/store/7r63vfd5qc5d62gbcx81rh653s1awg2f-libfolia-v1.7`

## 🔗 Dependencies

- [[1fzxi5zfzvgbj9j19wl9ihk41nhmjyw3-autoconf-archive-2024.10.16]]
- [[3h2pqwsp2izzlynp9gjar39hm70nnz89-libxml2-2.14.5]]
- [[65ij72yczx41p2hqv1wfidmygg9cgry7-libfolia-v1.7.tar.gz]]
