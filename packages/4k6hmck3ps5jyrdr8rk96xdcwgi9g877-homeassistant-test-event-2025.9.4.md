---
aliases:
  - home-assistant-component-tests.event
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.event`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/4k6hmck3ps5jyrdr8rk96xdcwgi9g877-homeassistant-test-event-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/4k6hmck3ps5jyrdr8rk96xdcwgi9g877-homeassistant-test-event-2025.9.4`
