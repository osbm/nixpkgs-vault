...
- **Name**: `haskellPackages.jsonnet`
- **Version**: `0.4.0.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Jsonnet implementaton in pure Haskell
- **Homepage**: [https://hackage.haskell.org/package/jsonnet](https://hackage.haskell.org/package/jsonnet)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/3zqf6nlxm898madnzpqnf4s63x5w1rc9-jsonnet-0.4.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:394600`
- **Outputs**:
  - `doc`:  `/nix/store/3zqf6nlxm898madnzpqnf4s63x5w1rc9-jsonnet-0.4.0.0`
  - `out`:  `/nix/store/3zqf6nlxm898madnzpqnf4s63x5w1rc9-jsonnet-0.4.0.0`
...
- [[qr2hwxbwmp5jqx7qnw9dl7146r021bcw-jsonnet-0.4.0.0.tar.gz]]
