...
- **Derivation Path**: `/nix/store/54vy8mjqgr8nlni6d7981kyzmk643yh1-zabbix-agent2-7.4.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/monitoring/zabbix/agent2.nix:82`
- **Outputs**:
  - `out`:  `/nix/store/54vy8mjqgr8nlni6d7981kyzmk643yh1-zabbix-agent2-7.4.0`
