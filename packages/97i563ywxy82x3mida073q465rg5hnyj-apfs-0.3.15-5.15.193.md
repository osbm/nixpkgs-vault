---
aliases:
  - linuxKernel.packages.linux_5_15.apfs
tags:
  - license/unknown
  - maintainers/Luflosi
  - outputs/out
...
- **Name**: `linuxKernel.packages.linux_5_15.apfs`
- **Version**: `0.3.15-5.15.193`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/97i563ywxy82x3mida073q465rg5hnyj-apfs-0.3.15-5.15.193.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/apfs/default.nix:41`
- **Outputs**:
  - `out`:  `/nix/store/97i563ywxy82x3mida073q465rg5hnyj-apfs-0.3.15-5.15.193`
