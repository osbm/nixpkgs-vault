...
- **Name**: `rPackages.rstatix`
- **Version**: `0.7.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/rstatix/](https://cran.r-project.org/web/packages/rstatix/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/7i9jhzczxsgkw0r7fvb7cskx9n1nfraw-r-rstatix-0.7.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/7i9jhzczxsgkw0r7fvb7cskx9n1nfraw-r-rstatix-0.7.2`
...
- [[p3ysh1kpbmnm83xmwxxal26s99fgzw98-rstatix_0.7.2.tar.gz]]
