...
- **Name**: `linuxKernel.packages.linux_5_10.veikk-linux-driver`
- **Version**: `2.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/445i1h30x77aasfh3a9y4mr88w7qkdy5-veikk-linux-driver-2.0.drv`
...
- **Outputs**:
  - `out`:  `/nix/store/445i1h30x77aasfh3a9y4mr88w7qkdy5-veikk-linux-driver-2.0`
