...
- **Name**: `rPackages.ENMTools`
- **Version**: `1.1.5`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/ENMTools/](https://cran.r-project.org/web/packages/ENMTools/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/1an4i9ib495i5rbip3s1mjqq047vc57k-r-ENMTools-1.1.5.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/1an4i9ib495i5rbip3s1mjqq047vc57k-r-ENMTools-1.1.5`

## 🔗 Dependencies

- [[15gf94b63xxjdbg4x8kfzahwb8pr8zi4-r-spatstat.geom-3.5-0]]
- [[1k6br6f6prjasx5yda9lp2wvp66w1p2k-ENMTools_1.1.5.tar.gz]]
...
- [[wnpjc9nhfzc6q62wwlqbxxhyvjxdp6nv-r-ENMeval-2.0.5.2]]
