...
- **Name**: `rPackages.textshaping`
- **Version**: `1.0.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/textshaping/](https://cran.r-project.org/web/packages/textshaping/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/36vjfm1gpwkvq4sli62gz2xjsl4f21bz-r-textshaping-1.0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/36vjfm1gpwkvq4sli62gz2xjsl4f21bz-r-textshaping-1.0.1`
...
- [[9k73qq38y43srnwdl8j6qz2b7fqyrbdj-textshaping_1.0.1.tar.gz]]
