...
Little Scheme DSL to build shell command lines

## 📋 Package Information

- **Name**: `akkuPackages.shell-quote`
- **Version**: `0.1.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Little Scheme DSL to build shell command lines
- **Homepage**: []()
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/kqqns90vlbxdixjxhkww3619ww9kxsqf-akku-shell-quote-0.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/tools/package-management/akku/default.nix:39`
- **Outputs**:
  - `out`:  `/nix/store/kqqns90vlbxdixjxhkww3619ww9kxsqf-akku-shell-quote-0.1.0`
...
- [[nl0vmgdbcm5mavra7rmc503hfs49ikrw-shell-quote-0.1.tgz]]
