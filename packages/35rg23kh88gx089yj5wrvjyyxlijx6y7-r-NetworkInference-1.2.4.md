...
- **Name**: `rPackages.NetworkInference`
- **Version**: `1.2.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/NetworkInference/](https://cran.r-project.org/web/packages/NetworkInference/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/35rg23kh88gx089yj5wrvjyyxlijx6y7-r-NetworkInference-1.2.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/35rg23kh88gx089yj5wrvjyyxlijx6y7-r-NetworkInference-1.2.4`
...
- [[p3mvr0jny8r8h0lk02rrlrdcvy77fagm-NetworkInference_1.2.4.tar.gz]]
