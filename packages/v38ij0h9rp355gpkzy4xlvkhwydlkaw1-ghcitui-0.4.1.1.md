...
- **Name**: `haskellPackages.ghcitui`
- **Version**: `0.4.1.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: A Terminal User Interface (TUI) for GHCi
- **Homepage**: [https://hackage.haskell.org/package/ghcitui](https://hackage.haskell.org/package/ghcitui)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/v38ij0h9rp355gpkzy4xlvkhwydlkaw1-ghcitui-0.4.1.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:262658`
- **Outputs**:
  - `out`:  `/nix/store/v38ij0h9rp355gpkzy4xlvkhwydlkaw1-ghcitui-0.4.1.1`
...
- [[m0g24p1l4n52nn39ynbc1ggnrkjxcfx6-ghcitui-0.4.1.1.tar.gz]]
