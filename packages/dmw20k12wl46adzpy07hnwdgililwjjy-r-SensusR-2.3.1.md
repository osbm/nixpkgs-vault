...
- **Name**: `rPackages.SensusR`
- **Version**: `2.3.1`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://cran.r-project.org/web/packages/SensusR/](https://cran.r-project.org/web/packages/SensusR/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/dmw20k12wl46adzpy07hnwdgililwjjy-r-SensusR-2.3.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/dmw20k12wl46adzpy07hnwdgililwjjy-r-SensusR-2.3.1`

## 🔗 Dependencies

- [[894i9a13ff4k189jjsbyrsbb4pbx2fbd-SensusR_2.3.1.tar.gz]]
