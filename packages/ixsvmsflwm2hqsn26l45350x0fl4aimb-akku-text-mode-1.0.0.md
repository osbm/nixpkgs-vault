...
Text-mode console library (like curses)

## 📋 Package Information

- **Name**: `akkuPackages.text-mode`
- **Version**: `1.0.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Text-mode console library (like curses)
- **Homepage**: []()
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/ixsvmsflwm2hqsn26l45350x0fl4aimb-akku-text-mode-1.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/tools/package-management/akku/default.nix:39`
- **Outputs**:
  - `out`:  `/nix/store/ixsvmsflwm2hqsn26l45350x0fl4aimb-akku-text-mode-1.0.0`

## 🔗 Dependencies

- [[2jbjfm0s7c03a7mylffys7n228vs64rz-make-shell-wrapper-hook]]
- [[7834q6b01x3zpv4sx6glbv0f8a67zh5x-text-mode_1.0.0_repack.tar.xz]]
...
- [[jdszxih13h7mpwpdv7x7zilvj8ayv55p-akku-r6rs-pffi-1.6.0]]
