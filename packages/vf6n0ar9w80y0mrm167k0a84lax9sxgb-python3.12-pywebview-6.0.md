...
- **Name**: `python312Packages.pywebview`
- **Version**: `6.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/vf6n0ar9w80y0mrm167k0a84lax9sxgb-python3.12-pywebview-6.0.drv`
...
- **Outputs**:
  - `dist`:  `/nix/store/vf6n0ar9w80y0mrm167k0a84lax9sxgb-python3.12-pywebview-6.0`
  - `out`:  `/nix/store/vf6n0ar9w80y0mrm167k0a84lax9sxgb-python3.12-pywebview-6.0`
...
- [[i0gm8ada80jjrdzgym8wihalp7ak85wn-python3.12-proxy-tools-0.1.0]]
