...
man pages for LLDB 18.1.8

## 📋 Package Information

- **Name**: `llvmPackages_18.lldb-manpages`
- **Version**: `18.1.8`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: man pages for LLDB 18.1.8
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/6pg51zs3grmmnraaliigzkza7wmw5r3l-lldb-manpages-18.1.8.drv`
...
- **Outputs**:
  - `out`:  `/nix/store/6pg51zs3grmmnraaliigzkza7wmw5r3l-lldb-manpages-18.1.8`
