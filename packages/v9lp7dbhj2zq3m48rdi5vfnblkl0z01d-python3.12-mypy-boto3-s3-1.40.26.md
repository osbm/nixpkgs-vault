---
aliases:
  - python312Packages.mypy-boto3-s3
tags:
  - license/unknown
  - maintainers/fabaff
...
- **Name**: `python312Packages.mypy-boto3-s3`
- **Version**: `1.40.26`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/v9lp7dbhj2zq3m48rdi5vfnblkl0z01d-python3.12-mypy-boto3-s3-1.40.26.drv`
...
- **Outputs**:
  - `dist`:  `/nix/store/v9lp7dbhj2zq3m48rdi5vfnblkl0z01d-python3.12-mypy-boto3-s3-1.40.26`
  - `out`:  `/nix/store/v9lp7dbhj2zq3m48rdi5vfnblkl0z01d-python3.12-mypy-boto3-s3-1.40.26`
