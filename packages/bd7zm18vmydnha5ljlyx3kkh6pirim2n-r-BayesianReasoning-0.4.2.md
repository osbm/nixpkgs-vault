...
- **Name**: `rPackages.BayesianReasoning`
- **Version**: `0.4.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/BayesianReasoning/](https://cran.r-project.org/web/packages/BayesianReasoning/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/bd7zm18vmydnha5ljlyx3kkh6pirim2n-r-BayesianReasoning-0.4.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/bd7zm18vmydnha5ljlyx3kkh6pirim2n-r-BayesianReasoning-0.4.2`
...
- [[nn1qghpi5m6im9ifdicja9zmw5k4pg8p-BayesianReasoning_0.4.2.tar.gz]]
