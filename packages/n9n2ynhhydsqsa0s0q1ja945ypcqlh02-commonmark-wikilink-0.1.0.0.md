...
- **Name**: `haskellPackages.commonmark-wikilink`
- **Version**: `0.1.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Obsidian-friendly commonmark wikilink parser
- **Homepage**: [https://hackage.haskell.org/package/commonmark-wikilink](https://hackage.haskell.org/package/commonmark-wikilink)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/n9n2ynhhydsqsa0s0q1ja945ypcqlh02-commonmark-wikilink-0.1.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:151943`
- **Outputs**:
  - `doc`:  `/nix/store/n9n2ynhhydsqsa0s0q1ja945ypcqlh02-commonmark-wikilink-0.1.0.0`
  - `out`:  `/nix/store/n9n2ynhhydsqsa0s0q1ja945ypcqlh02-commonmark-wikilink-0.1.0.0`
...
- [[zsl4798f2v949s8xpmspyvc6vsdj7xh0-commonmark-wikilink-0.1.0.0.tar.gz]]
