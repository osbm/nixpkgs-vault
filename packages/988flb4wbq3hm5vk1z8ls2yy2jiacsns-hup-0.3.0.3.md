...
- **Name**: `haskellPackages.hup`
- **Version**: `0.3.0.3`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Upload packages and/or documentation to a hackage server
- **Homepage**: [https://hackage.haskell.org/package/hup](https://hackage.haskell.org/package/hup)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/988flb4wbq3hm5vk1z8ls2yy2jiacsns-hup-0.3.0.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:364924`
- **Outputs**:
  - `doc`:  `/nix/store/988flb4wbq3hm5vk1z8ls2yy2jiacsns-hup-0.3.0.3`
  - `out`:  `/nix/store/988flb4wbq3hm5vk1z8ls2yy2jiacsns-hup-0.3.0.3`
...
- [[g6vin7jask93a03r26ckvgh4qbwp2wzb-hup-0.3.0.3.tar.gz]]
