...
- **Name**: `haskellPackages.datadog`
- **Version**: `0.3.0.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Datadog client for Haskell. Supports both the HTTP API and StatsD.
- **Homepage**: [https://hackage.haskell.org/package/datadog](https://hackage.haskell.org/package/datadog)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/lls1h2b22slwcacg2y31c5fph051ql5a-datadog-0.3.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:180551`
- **Outputs**:
  - `doc`:  `/nix/store/lls1h2b22slwcacg2y31c5fph051ql5a-datadog-0.3.0.0`
  - `out`:  `/nix/store/lls1h2b22slwcacg2y31c5fph051ql5a-datadog-0.3.0.0`
...
- [[7mqa8wb92pkv5vkbjw892081w6vzr7h0-datadog-0.3.0.0.tar.gz]]
