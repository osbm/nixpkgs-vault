---
aliases:
  - haskellPackages.openid-connect
tags:
  - broken
  - not-available
  - license/unknown
...
- **Name**: `haskellPackages.openid-connect`
- **Version**: `0.2.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: An OpenID Connect library that does all the heavy lifting for you
- **Homepage**: [https://hackage.haskell.org/package/openid-connect](https://hackage.haskell.org/package/openid-connect)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/y1x8i2kxc8fvdkgmj3fjxlyl487pn0vq-openid-connect-0.2.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:491831`
- **Outputs**:
  - `doc`:  `/nix/store/y1x8i2kxc8fvdkgmj3fjxlyl487pn0vq-openid-connect-0.2.0`
  - `out`:  `/nix/store/y1x8i2kxc8fvdkgmj3fjxlyl487pn0vq-openid-connect-0.2.0`
...
- [[gn6vjhsfg2bz2rmd6nac3pjjkhyf1r1v-openid-connect-0.2.0.tar.gz]]
