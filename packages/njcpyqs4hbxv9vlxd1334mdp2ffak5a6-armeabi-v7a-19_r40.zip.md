---
aliases:
  - androidenv.androidPkgs.all.system-images.v19.google_apis.armeabi-v7a
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.system-images.v19.google_apis.armeabi-v7a`
- **Version**: `19_r40.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/njcpyqs4hbxv9vlxd1334mdp2ffak5a6-armeabi-v7a-19_r40.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/njcpyqs4hbxv9vlxd1334mdp2ffak5a6-armeabi-v7a-19_r40.zip`
