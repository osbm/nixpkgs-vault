...
- **Name**: `linuxKernel.packages.linux_5_10.nvidia_x11_vulkan_beta`
- **Version**: `570.123.19-5.10.244`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/aqfinxf9ja41gw83sc5nhwi74inz50y0-nvidia-x11-570.123.19-5.10.244.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/nvidia-x11/generic.nix:329`
- **Outputs**:
  - `bin`:  `/nix/store/aqfinxf9ja41gw83sc5nhwi74inz50y0-nvidia-x11-570.123.19-5.10.244`
  - `firmware`:  `/nix/store/aqfinxf9ja41gw83sc5nhwi74inz50y0-nvidia-x11-570.123.19-5.10.244`
  - `lib32`:  `/nix/store/aqfinxf9ja41gw83sc5nhwi74inz50y0-nvidia-x11-570.123.19-5.10.244`
  - `out`:  `/nix/store/aqfinxf9ja41gw83sc5nhwi74inz50y0-nvidia-x11-570.123.19-5.10.244`
