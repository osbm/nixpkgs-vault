...
- **Derivation Path**: `/nix/store/k6l5wss2iga22yfav0a4vl74xj8bf6a3-openjdk-headless-24.0.2+12.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/compilers/openjdk/generic.nix:606`
- **Outputs**:
  - `debug`:  `/nix/store/k6l5wss2iga22yfav0a4vl74xj8bf6a3-openjdk-headless-24.0.2+12`
  - `out`:  `/nix/store/k6l5wss2iga22yfav0a4vl74xj8bf6a3-openjdk-headless-24.0.2+12`
...
- [[6ph89f15ddmzjy09mzn67sx93s0fjnxf-source]]
- [[7jmgm6iyr51gm2nlyfgv4p20nzq3li0m-temurin-bin-24.0.1]]
...
- `/nix/store/3va4i4spgv3rqlixkrypwr3zvkkbnmsl-fix-java-home-jdk24.patch`
- `/nix/store/5kqw0l5s940vbp7gxz59vk9fad25v3wr-increase-javadoc-heap-jdk13.patch`
- `/nix/store/9fkmqkfvlbqb7z79wmbn5drxhn8rn437-read-truststore-from-env-jdk24.patch`
