---
aliases:
  - python313Packages.mypy-boto3-ebs
tags:
  - license/unknown
  - maintainers/fabaff
...
- **Name**: `python313Packages.mypy-boto3-ebs`
- **Version**: `1.40.15`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/ga5wndmjkggg0hbkmca397spfg9x0ll8-python3.13-mypy-boto3-ebs-1.40.15.drv`
...
- **Outputs**:
  - `dist`:  `/nix/store/ga5wndmjkggg0hbkmca397spfg9x0ll8-python3.13-mypy-boto3-ebs-1.40.15`
  - `out`:  `/nix/store/ga5wndmjkggg0hbkmca397spfg9x0ll8-python3.13-mypy-boto3-ebs-1.40.15`
