---
aliases:
  - androidenv.androidPkgs.all.system-images.v32.android-automotive-playstore.arm64-v8a
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.system-images.v32.android-automotive-playstore.arm64-v8a`
- **Version**: `32_r01.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/8p05i2db8bizqs1pgsi0if7n816phshw-arm64-v8a-32_r01.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/8p05i2db8bizqs1pgsi0if7n816phshw-arm64-v8a-32_r01.zip`
