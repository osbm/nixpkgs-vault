---
aliases:
  - python313Packages.python-barbicanclient
tags:
  - license/unknown
...
Client library for OpenStack Barbican API

## 📋 Package Information

- **Name**: `python313Packages.python-barbicanclient`
- **Version**: `7.2.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Client library for OpenStack Barbican API
- **Homepage**: [https://opendev.org/openstack/python-barbicanclient](https://opendev.org/openstack/python-barbicanclient)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/fhi86fswjvvh1pb8mlyig5994iqnm7xd-python3.13-python-barbicanclient-7.2.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/python-barbicanclient/default.nix:74`
- **Outputs**:
  - `dist`:  `/nix/store/fhi86fswjvvh1pb8mlyig5994iqnm7xd-python3.13-python-barbicanclient-7.2.0`
  - `out`:  `/nix/store/fhi86fswjvvh1pb8mlyig5994iqnm7xd-python3.13-python-barbicanclient-7.2.0`
...
- [[cyv8jxnz49pxk6yz1975x32azg0lm282-source]]
