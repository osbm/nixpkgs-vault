...
- **Homepage**: [https://github.com/sphinx-contrib/sphinx-lint](https://github.com/sphinx-contrib/sphinx-lint)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/di2m0dscblmdl27a8jky314lcyi3bxc9-sphinx-lint-1.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/sp/sphinx-lint/package.nix:35`
- **Outputs**:
  - `dist`:  `/nix/store/di2m0dscblmdl27a8jky314lcyi3bxc9-sphinx-lint-1.0.0`
  - `out`:  `/nix/store/di2m0dscblmdl27a8jky314lcyi3bxc9-sphinx-lint-1.0.0`
...
- [[6ib4zh9irpaq14hwnvfjap0lw2814n2x-source]]
