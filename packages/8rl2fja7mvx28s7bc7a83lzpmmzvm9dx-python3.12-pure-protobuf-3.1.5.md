---
aliases:
  - python312Packages.pure-protobuf
tags:
  - license/unknown
...
- **Name**: `python312Packages.pure-protobuf`
- **Version**: `3.1.5`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Python implementation of Protocol Buffers with dataclass-based schemas
- **Homepage**: [https://github.com/eigenein/protobuf](https://github.com/eigenein/protobuf)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/8rl2fja7mvx28s7bc7a83lzpmmzvm9dx-python3.12-pure-protobuf-3.1.5.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/pure-protobuf/default.nix:50`
- **Outputs**:
  - `dist`:  `/nix/store/8rl2fja7mvx28s7bc7a83lzpmmzvm9dx-python3.12-pure-protobuf-3.1.5`
  - `out`:  `/nix/store/8rl2fja7mvx28s7bc7a83lzpmmzvm9dx-python3.12-pure-protobuf-3.1.5`
...
- [[qj43rgc3b4qpm8j3rl3ag7aqxbyprqmr-source]]
