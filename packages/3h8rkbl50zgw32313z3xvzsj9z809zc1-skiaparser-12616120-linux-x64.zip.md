---
aliases:
  - androidenv.androidPkgs.all.packages.skiaparser.v5
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.packages.skiaparser.v5`
...
- **Derivation Path**: `/nix/store/3h8rkbl50zgw32313z3xvzsj9z809zc1-skiaparser-12616120-linux-x64.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/3h8rkbl50zgw32313z3xvzsj9z809zc1-skiaparser-12616120-linux-x64.zip`
