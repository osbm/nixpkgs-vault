---
aliases:
  - home-assistant-component-tests.integration
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.integration`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/jhw8xn6d7ax65x5yda1s0s4np7ija4lm-homeassistant-test-integration-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/jhw8xn6d7ax65x5yda1s0s4np7ija4lm-homeassistant-test-integration-2025.9.4`
