...
- **Name**: `haskellPackages.bake`
- **Version**: `0.5`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Continuous integration system
- **Homepage**: [https://hackage.haskell.org/package/bake](https://hackage.haskell.org/package/bake)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/8xwz1mm7x0sfjxj1p09ypscsyi0drqir-bake-0.5.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:95650`
- **Outputs**:
  - `data`:  `/nix/store/8xwz1mm7x0sfjxj1p09ypscsyi0drqir-bake-0.5`
  - `doc`:  `/nix/store/8xwz1mm7x0sfjxj1p09ypscsyi0drqir-bake-0.5`
  - `out`:  `/nix/store/8xwz1mm7x0sfjxj1p09ypscsyi0drqir-bake-0.5`

## 🔗 Dependencies

- [[2pr652igq6awvbbf5rfnb3kbrmg1cryf-http-types-0.12.4]]
- [[4alsgcwk3rpr7gf4i9hzjpcskrar547g-bake-0.5.tar.gz]]
