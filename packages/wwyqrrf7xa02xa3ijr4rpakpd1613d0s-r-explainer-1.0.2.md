...
- **Name**: `rPackages.explainer`
- **Version**: `1.0.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/explainer/](https://cran.r-project.org/web/packages/explainer/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/wwyqrrf7xa02xa3ijr4rpakpd1613d0s-r-explainer-1.0.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/wwyqrrf7xa02xa3ijr4rpakpd1613d0s-r-explainer-1.0.2`
...
- [[kfb06fb1mahl9kzn4chf96l7f7jkzxbh-explainer_1.0.2.tar.gz]]
