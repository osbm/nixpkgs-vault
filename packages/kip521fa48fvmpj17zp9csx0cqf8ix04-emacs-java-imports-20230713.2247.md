...
- **Name**: `emacsPackages.java-imports`
- **Version**: `20230713.2247`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://github.com/dakrone/emacs-java-imports](https://github.com/dakrone/emacs-java-imports)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/kip521fa48fvmpj17zp9csx0cqf8ix04-emacs-java-imports-20230713.2247.drv`
...
- **Outputs**:
  - `out`:  `/nix/store/kip521fa48fvmpj17zp9csx0cqf8ix04-emacs-java-imports-20230713.2247`
...
- [[k7wrs8q1fawq26dari6sh8mk7dmil3mv-java-imports-recipe]]
- [[nxjhz82wba4sx6jv97h0mzbmm64wgi8j-source]]
