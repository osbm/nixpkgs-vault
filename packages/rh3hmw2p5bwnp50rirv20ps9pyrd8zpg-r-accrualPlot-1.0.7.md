...
- **Name**: `rPackages.accrualPlot`
- **Version**: `1.0.7`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/accrualPlot/](https://cran.r-project.org/web/packages/accrualPlot/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/rh3hmw2p5bwnp50rirv20ps9pyrd8zpg-r-accrualPlot-1.0.7.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/rh3hmw2p5bwnp50rirv20ps9pyrd8zpg-r-accrualPlot-1.0.7`
...
- [[l6ppyb5ki9kpk09yf6065hv325k1xxh5-accrualPlot_1.0.7.tar.gz]]
