...
- **Name**: `haskellPackages.gli`
- **Version**: `0.0.1.1`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Tiny cli to fetch PR info from gitlab
- **Homepage**: [https://hackage.haskell.org/package/gli](https://hackage.haskell.org/package/gli)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/mxnr12if12xia42rclbwqs5sa0w7carc-gli-0.0.1.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:272615`
- **Outputs**:
  - `doc`:  `/nix/store/mxnr12if12xia42rclbwqs5sa0w7carc-gli-0.0.1.1`
  - `out`:  `/nix/store/mxnr12if12xia42rclbwqs5sa0w7carc-gli-0.0.1.1`

## 🔗 Dependencies

- [[3z8ag97ih8zfyf7252brjx7kb70hyq3n-gli-0.0.1.1.tar.gz]]
- [[4lykrm96bxajhbrv42nzm365n9yf9s1y-coreutils-9.7]]
- [[4qvy2wb7h69rj2ps5jyk5mfbpsqm4h9f-gli-0.0.1.1-r1.cabal]]
