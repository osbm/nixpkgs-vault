...
- **Name**: `python313Packages.bumps`
- **Version**: `1.0.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Data fitting with bayesian uncertainty analysis
- **Homepage**: [https://bumps.readthedocs.io/](https://bumps.readthedocs.io/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/9n7v9fyclyyiv1qiardcx704bjqcyms0-python3.13-bumps-1.0.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/bumps/default.nix:61`
- **Outputs**:
  - `dist`:  `/nix/store/9n7v9fyclyyiv1qiardcx704bjqcyms0-python3.13-bumps-1.0.2`
  - `out`:  `/nix/store/9n7v9fyclyyiv1qiardcx704bjqcyms0-python3.13-bumps-1.0.2`
...
- [[rcpcbg99vc8nbslax8531rcgvvcw9xn4-bumps-1.0.2.tar.gz]]
