...
- **Name**: `python313Packages.docling-jobkit`
- **Version**: `1.5.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Running a distributed job processing documents with Docling
- **Homepage**: [https://github.com/docling-project/docling-jobkit](https://github.com/docling-project/docling-jobkit)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/gki8vsl5m46z3y6b9wx239nkx1k8vsdy-python3.13-docling-jobkit-1.5.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/docling-jobkit/default.nix:102`
- **Outputs**:
  - `dist`:  `/nix/store/gki8vsl5m46z3y6b9wx239nkx1k8vsdy-python3.13-docling-jobkit-1.5.0`
  - `out`:  `/nix/store/gki8vsl5m46z3y6b9wx239nkx1k8vsdy-python3.13-docling-jobkit-1.5.0`
...
- [[70rd81d2b9vjjdsdb4iz3138xhr8xq6i-python3.13-docling-2.47.1]]
...
- [[pd5hw53262avpkawpaf9slymfi9m1dp1-python3.13-rq-2.4.1]]
...
- [[yid2mjcdjsdmrfgvixhih6dyb14wl3pj-source]]
