...
- **Name**: `haskellPackages.hslogstash`
- **Version**: `0.4.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: A library to work with, or as, a logstash server
- **Homepage**: [https://hackage.haskell.org/package/hslogstash](https://hackage.haskell.org/package/hslogstash)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/sbdl1ggq5yqfqbj73fh0sqrr86a4dy6v-hslogstash-0.4.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:352902`
- **Outputs**:
  - `doc`:  `/nix/store/sbdl1ggq5yqfqbj73fh0sqrr86a4dy6v-hslogstash-0.4.2`
  - `out`:  `/nix/store/sbdl1ggq5yqfqbj73fh0sqrr86a4dy6v-hslogstash-0.4.2`
...
- [[78sz8pf9rqcfmd2636m1jp1kgb6prpww-hslogstash-0.4.2.tar.gz]]
...
- [[krh0aqxhhy6ap4blam7drq3yd8zx18d9-stm-firehose-0.3.0.2]]
