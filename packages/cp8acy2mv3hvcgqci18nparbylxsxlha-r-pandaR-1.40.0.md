...
- **Name**: `rPackages.pandaR`
- **Version**: `1.40.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://bioconductor.org/packages/3.21/bioc/html/pandaR.html](https://bioconductor.org/packages/3.21/bioc/html/pandaR.html)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/cp8acy2mv3hvcgqci18nparbylxsxlha-r-pandaR-1.40.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/cp8acy2mv3hvcgqci18nparbylxsxlha-r-pandaR-1.40.0`
...
- [[ak4d3hcw105pid5s07nzxki2a3j6k8i1-pandaR_1.40.0.tar.gz]]
