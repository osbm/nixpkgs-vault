...
- **Name**: `php83Extensions.openssl-legacy`
- **Version**: `8.3.25`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/6bd3cmgs90npk85qh6fvyvkg63w2320r-php-openssl-legacy-8.3.25.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/top-level/php-packages.nix:206`
- **Outputs**:
  - `dev`:  `/nix/store/6bd3cmgs90npk85qh6fvyvkg63w2320r-php-openssl-legacy-8.3.25`
  - `out`:  `/nix/store/6bd3cmgs90npk85qh6fvyvkg63w2320r-php-openssl-legacy-8.3.25`
