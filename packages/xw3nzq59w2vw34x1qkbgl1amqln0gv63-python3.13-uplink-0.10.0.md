...
- **Name**: `python313Packages.uplink`
- **Version**: `0.10.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Declarative HTTP client for Python
- **Homepage**: [https://github.com/prkumar/uplink](https://github.com/prkumar/uplink)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/xw3nzq59w2vw34x1qkbgl1amqln0gv63-python3.13-uplink-0.10.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/uplink/default.nix:58`
- **Outputs**:
  - `dist`:  `/nix/store/xw3nzq59w2vw34x1qkbgl1amqln0gv63-python3.13-uplink-0.10.0`
  - `out`:  `/nix/store/xw3nzq59w2vw34x1qkbgl1amqln0gv63-python3.13-uplink-0.10.0`
...
- [[k71crgqfqckjk3ki7fggll4pg1kkbz1b-source]]
