...
- **Name**: `python312Packages.ansible-runner`
- **Version**: `2.4.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Helps when interfacing with Ansible
- **Homepage**: [https://github.com/ansible/ansible-runner](https://github.com/ansible/ansible-runner)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/ibfkfakdh748jasccmr8ccscz7is36mv-python3.12-ansible-runner-2.4.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/ansible-runner/default.nix:117`
- **Outputs**:
  - `dist`:  `/nix/store/ibfkfakdh748jasccmr8ccscz7is36mv-python3.12-ansible-runner-2.4.1`
  - `out`:  `/nix/store/ibfkfakdh748jasccmr8ccscz7is36mv-python3.12-ansible-runner-2.4.1`
...
- [[njhjr7f18gpc1w3nhg47i03hhbl2n751-source]]
