...
- **Name**: `rPackages.VarBundle`
- **Version**: `0.3.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://cran.r-project.org/web/packages/VarBundle/](https://cran.r-project.org/web/packages/VarBundle/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/sab480d1l3ld2q776713ryaddmj6qha0-r-VarBundle-0.3.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/sab480d1l3ld2q776713ryaddmj6qha0-r-VarBundle-0.3.0`
...
- [[qvsrzaqnq6w7wjhkz8b67isfgr3yb4m6-VarBundle_0.3.0.tar.gz]]
