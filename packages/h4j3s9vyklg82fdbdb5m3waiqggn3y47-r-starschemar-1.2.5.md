...
- **Name**: `rPackages.starschemar`
- **Version**: `1.2.5`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/starschemar/](https://cran.r-project.org/web/packages/starschemar/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/h4j3s9vyklg82fdbdb5m3waiqggn3y47-r-starschemar-1.2.5.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/h4j3s9vyklg82fdbdb5m3waiqggn3y47-r-starschemar-1.2.5`
...
- [[gbf1m1xhdvfh7r9bjcp880mpc95vlpdg-starschemar_1.2.5.tar.gz]]
