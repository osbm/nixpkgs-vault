...
- **Name**: `rPackages.audubon`
- **Version**: `0.5.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/audubon/](https://cran.r-project.org/web/packages/audubon/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/443fazb0iz5axlyji3zxzigpg3idixka-r-audubon-0.5.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/443fazb0iz5axlyji3zxzigpg3idixka-r-audubon-0.5.2`
...
- [[p94m3dyv603rg00pijvjmym6jlp3ymb2-audubon_0.5.2.tar.gz]]
