---
aliases:
  - home-assistant-component-tests.cpuspeed
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.cpuspeed`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/4iycnxlgc2rgvf6q4kdyl8wrxmdxfz7r-homeassistant-test-cpuspeed-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/4iycnxlgc2rgvf6q4kdyl8wrxmdxfz7r-homeassistant-test-cpuspeed-2025.9.4`
