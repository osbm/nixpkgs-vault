...
- **Name**: `akkuPackages.rapid-test`
- **Version**: `0.1.3`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: A Scheme API for test suites compatible to SRFI 64
- **Homepage**: []()
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/xddk3an2x3jh8md47cp6rywaizbiq3fp-akku-rapid-test-0.1.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/tools/package-management/akku/default.nix:39`
- **Outputs**:
  - `out`:  `/nix/store/xddk3an2x3jh8md47cp6rywaizbiq3fp-akku-rapid-test-0.1.3`
...
- [[w4xbw0jn10xjvc11z6sf3h83856lp9xn-rapid-test-0.1.3.tgz]]
