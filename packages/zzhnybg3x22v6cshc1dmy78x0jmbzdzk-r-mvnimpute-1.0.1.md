...
- **Name**: `rPackages.mvnimpute`
- **Version**: `1.0.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/mvnimpute/](https://cran.r-project.org/web/packages/mvnimpute/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/zzhnybg3x22v6cshc1dmy78x0jmbzdzk-r-mvnimpute-1.0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/zzhnybg3x22v6cshc1dmy78x0jmbzdzk-r-mvnimpute-1.0.1`
...
- [[9i4gvcb6ld613sdcmr3j499ynpmdkh2x-mvnimpute_1.0.1.tar.gz]]
