...
- **Name**: `rPackages.dataset`
- **Version**: `0.3.9`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/dataset/](https://cran.r-project.org/web/packages/dataset/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/9652ma74p4jwm2j7r3kw5s4lhzdbv0fd-r-dataset-0.3.9.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/9652ma74p4jwm2j7r3kw5s4lhzdbv0fd-r-dataset-0.3.9`
...
- [[by53chggwhbbp0k67zmlvfslmahba22j-dataset_0.3.9.tar.gz]]
