...
- **Name**: `haskellPackages.caster`
- **Version**: `0.0.3.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Multicast, thread-safe, and fast logger
- **Homepage**: [https://hackage.haskell.org/package/caster](https://hackage.haskell.org/package/caster)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/avgrz04pq8jvf7cyc9ib4s4rll1f6w0y-caster-0.0.3.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:132542`
- **Outputs**:
  - `doc`:  `/nix/store/avgrz04pq8jvf7cyc9ib4s4rll1f6w0y-caster-0.0.3.0`
  - `out`:  `/nix/store/avgrz04pq8jvf7cyc9ib4s4rll1f6w0y-caster-0.0.3.0`
...
- [[xwghcqim7pq5jhzwycndzbzdfl54rbg4-caster-0.0.3.0.tar.gz]]
