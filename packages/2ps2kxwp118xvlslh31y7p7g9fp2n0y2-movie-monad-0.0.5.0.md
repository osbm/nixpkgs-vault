...
- **Name**: `haskellPackages.movie-monad`
- **Version**: `0.0.5.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Plays videos using GStreamer and GTK+
- **Homepage**: [https://hackage.haskell.org/package/movie-monad](https://hackage.haskell.org/package/movie-monad)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/2ps2kxwp118xvlslh31y7p7g9fp2n0y2-movie-monad-0.0.5.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:460969`
- **Outputs**:
  - `data`:  `/nix/store/2ps2kxwp118xvlslh31y7p7g9fp2n0y2-movie-monad-0.0.5.0`
  - `doc`:  `/nix/store/2ps2kxwp118xvlslh31y7p7g9fp2n0y2-movie-monad-0.0.5.0`
  - `out`:  `/nix/store/2ps2kxwp118xvlslh31y7p7g9fp2n0y2-movie-monad-0.0.5.0`
...
- [[74i6ma594nwwa64rs095l08zll5kx096-movie-monad-0.0.5.0.tar.gz]]
