...
Compute cint coefficients

## 📋 Package Information

- **Name**: `akkuPackages.chrisoei-cint`
- **Version**: `0.1.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/7xzdxk1vad2n2yl71cgpday9ygw4kah2-akku-chrisoei-cint-0.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/tools/package-management/akku/default.nix:39`
- **Outputs**:
  - `out`:  `/nix/store/7xzdxk1vad2n2yl71cgpday9ygw4kah2-akku-chrisoei-cint-0.1.0`
...
- [[mkh7g6swpshs9zhvgdqmw5yzsl6m7dnv-chrisoei-cint-0.1.0.tgz]]
