...
- **Name**: `python313Packages.pyiqvia`
- **Version**: `2023.12.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Module for working with IQVIA data
- **Homepage**: [https://github.com/bachya/pyiqvia](https://github.com/bachya/pyiqvia)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/is5daa6gyd2ys9kqwrsddzy66sc49adv-python3.13-pyiqvia-2023.12.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/pyiqvia/default.nix:57`
- **Outputs**:
  - `dist`:  `/nix/store/is5daa6gyd2ys9kqwrsddzy66sc49adv-python3.13-pyiqvia-2023.12.0`
  - `out`:  `/nix/store/is5daa6gyd2ys9kqwrsddzy66sc49adv-python3.13-pyiqvia-2023.12.0`
...
- [[phhxc5p7nvms5aj7l93in8f9zg7w5w8w-source]]
