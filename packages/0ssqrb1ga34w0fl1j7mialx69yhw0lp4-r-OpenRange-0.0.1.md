...
- **Name**: `rPackages.OpenRange`
- **Version**: `0.0.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/OpenRange/](https://cran.r-project.org/web/packages/OpenRange/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/0ssqrb1ga34w0fl1j7mialx69yhw0lp4-r-OpenRange-0.0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/0ssqrb1ga34w0fl1j7mialx69yhw0lp4-r-OpenRange-0.0.1`

## 🔗 Dependencies

- [[023nii3p34db5bbzh8cgljzsw43fncv1-r-RPostgreSQL-0.7-8]]
- [[0fpbalnr8a59g58jznjyqfs10xxdqz9k-OpenRange_0.0.1.tar.gz]]
