...
- **Name**: `python313Packages.smpclient`
- **Version**: `5.1.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Simple Management Protocol (SMP) Client for remotely managing MCU firmware
- **Homepage**: [https://github.com/intercreate/smpclient](https://github.com/intercreate/smpclient)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/g1lgw3518bas98jpixj8gsgkcb22xrwp-python3.13-smpclient-5.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/smpclient/default.nix:56`
- **Outputs**:
  - `dist`:  `/nix/store/g1lgw3518bas98jpixj8gsgkcb22xrwp-python3.13-smpclient-5.1.0`
  - `out`:  `/nix/store/g1lgw3518bas98jpixj8gsgkcb22xrwp-python3.13-smpclient-5.1.0`
...
- [[an0ajxc52wrba9xp3wja2x8qsxzkcip5-source]]
...
- [[in18lafqvzb9w8rw8fhywbrw9xzmpjsz-python3.13-smp-3.3.2]]
...
- `/nix/store/f0lvk6isdbbpcsymnc3k4fc826pmj2qr-bleak-compat.patch`
