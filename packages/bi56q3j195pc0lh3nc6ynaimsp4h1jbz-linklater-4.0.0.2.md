...
- **Name**: `haskellPackages.linklater`
- **Version**: `4.0.0.2`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: A Haskell library for the Slack API
- **Homepage**: [https://hackage.haskell.org/package/linklater](https://hackage.haskell.org/package/linklater)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/bi56q3j195pc0lh3nc6ynaimsp4h1jbz-linklater-4.0.0.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:421507`
- **Outputs**:
  - `doc`:  `/nix/store/bi56q3j195pc0lh3nc6ynaimsp4h1jbz-linklater-4.0.0.2`
  - `out`:  `/nix/store/bi56q3j195pc0lh3nc6ynaimsp4h1jbz-linklater-4.0.0.2`
...
- [[k3ann6j8z8nxlh4d7pj0hnvsj0kb0rwx-linklater-4.0.0.2.tar.gz]]
