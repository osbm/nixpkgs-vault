...
AT Protocol (Bluesky) SDK for Python

## 📋 Package Information

- **Name**: `python312Packages.atproto`
- **Version**: `0.0.62`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: AT Protocol (Bluesky) SDK for Python
- **Homepage**: [https://github.com/MarshalX/atproto](https://github.com/MarshalX/atproto)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/ml8y0ckphmj67xznr2s6rh345w662imb-python3.12-atproto-0.0.62.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/atproto/default.nix:101`
- **Outputs**:
  - `dist`:  `/nix/store/ml8y0ckphmj67xznr2s6rh345w662imb-python3.12-atproto-0.0.62`
  - `out`:  `/nix/store/ml8y0ckphmj67xznr2s6rh345w662imb-python3.12-atproto-0.0.62`
...
- [[c78c4z7cpazh38rkdx0fmjf2gygyys8c-source]]
...
- [[lizf52b9m4693w0kzxrffp18ffg384km-python3.12-libipld-3.1.1]]
