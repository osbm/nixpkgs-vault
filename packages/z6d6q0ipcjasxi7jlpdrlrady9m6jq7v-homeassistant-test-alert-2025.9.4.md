---
aliases:
  - home-assistant-component-tests.alert
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.alert`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/z6d6q0ipcjasxi7jlpdrlrady9m6jq7v-homeassistant-test-alert-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/z6d6q0ipcjasxi7jlpdrlrady9m6jq7v-homeassistant-test-alert-2025.9.4`
