...
- **Name**: `akkuPackages.rapid-assume`
- **Version**: `0.1.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Assumptions compatible with SRFI 145
- **Homepage**: []()
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/rwsqn2np1ncpgzggz02gh9bp8hdhz0f8-akku-rapid-assume-0.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/tools/package-management/akku/default.nix:39`
- **Outputs**:
  - `out`:  `/nix/store/rwsqn2np1ncpgzggz02gh9bp8hdhz0f8-akku-rapid-assume-0.1.0`
...
- [[n5l4n3hijy3s4pq7ba1d01gcy08hy2nv-rapid-assume-0.1.0.tgz]]
