---
aliases:
  - home-assistant-component-tests.sma
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.sma`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/hh0dcnvwxj9m6cpmnnbi6nl1dw5lpb9n-homeassistant-test-sma-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/hh0dcnvwxj9m6cpmnnbi6nl1dw5lpb9n-homeassistant-test-sma-2025.9.4`
...
- [[3b2s292acdskhrshsnrn271a5c0z1kd6-python3.13-pysma-0.7.5]]
