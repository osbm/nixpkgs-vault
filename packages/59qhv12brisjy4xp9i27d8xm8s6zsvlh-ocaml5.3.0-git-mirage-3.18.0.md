...
Package to use ocaml-git with MirageOS backend

## 📋 Package Information

- **Name**: `ocamlPackages.git-mirage`
- **Version**: `3.18.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/59qhv12brisjy4xp9i27d8xm8s6zsvlh-ocaml5.3.0-git-mirage-3.18.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/ocaml-modules/git/mirage.nix:82`
- **Outputs**:
  - `out`:  `/nix/store/59qhv12brisjy4xp9i27d8xm8s6zsvlh-ocaml5.3.0-git-mirage-3.18.0`
...
- [[lh0khb85kcm3kns58hap5jgw5sj2mzfd-ocaml5.3.0-mimic-happy-eyeballs-0.0.9]]
...
- [[rn4a8z3x2vvkfl475hzx790r603w700w-ocaml5.3.0-ca-certs-nss-3.115]]
- [[v7frpbpy8hkmji5gb4ak2mr2g4d3jm1d-dune-3.20.2]]
- [[v99srx44cxacvgf271n8b4fy6i2dph30-ocaml5.3.0-awa-mirage-0.5.2]]
