---
aliases:
  - androidenv.androidPkgs.all.system-images.v29.google_apis_playstore.arm64-v8a
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.system-images.v29.google_apis_playstore.arm64-v8a`
- **Version**: `29_r09.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/2xrkpk5bkp3p03w7zc3jxvxrrrfbjgqk-arm64-v8a-29_r09.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/2xrkpk5bkp3p03w7zc3jxvxrrrfbjgqk-arm64-v8a-29_r09.zip`
