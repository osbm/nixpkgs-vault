...
- **Name**: `rPackages.gestate`
- **Version**: `1.6.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/gestate/](https://cran.r-project.org/web/packages/gestate/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/77w3hjqqb97jyj8ddm5liaan6f8ky653-r-gestate-1.6.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/77w3hjqqb97jyj8ddm5liaan6f8ky653-r-gestate-1.6.0`
...
- [[vp1nspiixr8iy0mb89n97y2nqc2f9gq3-gestate_1.6.0.tar.gz]]
