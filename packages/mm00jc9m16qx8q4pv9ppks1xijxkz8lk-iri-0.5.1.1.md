...
- **Name**: `haskellPackages.iri`
- **Version**: `0.5.1.1`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: RFC-compliant universal resource identifier library (URL, URI, IRI)
- **Homepage**: [https://hackage.haskell.org/package/iri](https://hackage.haskell.org/package/iri)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/mm00jc9m16qx8q4pv9ppks1xijxkz8lk-iri-0.5.1.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:385249`
- **Outputs**:
  - `out`:  `/nix/store/mm00jc9m16qx8q4pv9ppks1xijxkz8lk-iri-0.5.1.1`
...
- [[wsxgxi9icksbql5jxgh5nkgkp8gy456m-iri-0.5.1.1.tar.gz]]
