...
- **Name**: `haskellPackages.wreq`
- **Version**: `0.5.4.3`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: An easy-to-use HTTP client library
- **Homepage**: [https://hackage.haskell.org/package/wreq](https://hackage.haskell.org/package/wreq)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/25km2z3fnnrq3pqqz7qb5xpapsyaxbv5-wreq-0.5.4.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:726929`
- **Outputs**:
  - `doc`:  `/nix/store/25km2z3fnnrq3pqqz7qb5xpapsyaxbv5-wreq-0.5.4.3`
  - `out`:  `/nix/store/25km2z3fnnrq3pqqz7qb5xpapsyaxbv5-wreq-0.5.4.3`
...
- [[ddnv8k3n51sb4glm3w4aylg13x6p1f6l-wreq-0.5.4.3.tar.gz]]
