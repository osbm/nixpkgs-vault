...
- **Name**: `matrix-synapse-plugins.matrix-synapse-s3-storage-provider`
- **Version**: `1.5.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Synapse storage provider to fetch and store media in Amazon S3
- **Homepage**: [https://github.com/matrix-org/synapse-s3-storage-provider](https://github.com/matrix-org/synapse-s3-storage-provider)
- **License**: `unknown`
- **Platforms**: `aarch64-linux`, `armv5tel-linux`, `armv6l-linux`, `armv7a-linux`, `armv7l-linux`, `i686-linux`, `loongarch64-linux`, `m68k-linux`, `microblaze-linux`, `microblazeel-linux`, `mips-linux`, `mips64-linux`, `mips64el-linux`, `mipsel-linux`, `powerpc-linux`, `powerpc64-linux`, `powerpc64le-linux`, `riscv32-linux`, `riscv64-linux`, `s390-linux`, `s390x-linux`, `x86_64-linux`, `x86_64-darwin`, `aarch64-darwin`, `i686-cygwin`, `x86_64-cygwin`, `aarch64-windows`, `x86_64-windows`, `i686-windows`, `i686-freebsd`, `x86_64-freebsd`, `aarch64-freebsd`

## 🔧 Build Information

- **Derivation Path**: `/nix/store/1c1vj05vln0awd0wl3y98f671v3gaj4p-python3.13-matrix-synapse-s3-storage-provider-1.5.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/ma/matrix-synapse-unwrapped/plugins/s3-storage-provider.nix:55`
- **Outputs**:
  - `dist`:  `/nix/store/1c1vj05vln0awd0wl3y98f671v3gaj4p-python3.13-matrix-synapse-s3-storage-provider-1.5.0`
  - `out`:  `/nix/store/1c1vj05vln0awd0wl3y98f671v3gaj4p-python3.13-matrix-synapse-s3-storage-provider-1.5.0`
...
- [[9g26x0dknlp248jx73w4df9qiyp8ny2r-source]]
...
- [[gk5qfn9ainhbsvl9n4riq6lwwib2d0xc-python3.13-canonicaljson-2.0.0]]
...
- [[q2cfnal9nkgr3jdfqh9286jly95r2wgy-python3.13-pymacaroons-0.13.0]]
- [[q31amkdlw945gfmqcci8n00brh5liiz2-pypa-install-hook]]
- [[qzqs20llgr2g4a1laqiz9kxcidvl809g-python3.13-matrix-common-1.3.0]]
...
- [[xrl54i58nxd3inbksm6xf8gysvyp012y-python3.13-treq-25.5.0]]
- [[yca9z34spm1h5ydzq517qmkjix528c3l-python3.13-signedjson-1.1.4]]
