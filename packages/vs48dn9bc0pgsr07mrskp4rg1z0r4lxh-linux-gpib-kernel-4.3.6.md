...
- **Name**: `linuxKernel.packages.linux_6_1.linux-gpib`
- **Version**: `4.3.6`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/vs48dn9bc0pgsr07mrskp4rg1z0r4lxh-linux-gpib-kernel-4.3.6.drv`
...
- **Outputs**:
  - `out`:  `/nix/store/vs48dn9bc0pgsr07mrskp4rg1z0r4lxh-linux-gpib-kernel-4.3.6`
