...
- **Name**: `haskellPackages.ghcide-bench`
- **Version**: `2.8.0.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: An LSP client for running performance experiments on HLS
- **Homepage**: [https://hackage.haskell.org/package/ghcide-bench](https://hackage.haskell.org/package/ghcide-bench)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/f35rrs9zdqcm2hbmfwyf6nfj52mvnzwf-ghcide-bench-2.8.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:262517`
- **Outputs**:
  - `doc`:  `/nix/store/f35rrs9zdqcm2hbmfwyf6nfj52mvnzwf-ghcide-bench-2.8.0.0`
  - `out`:  `/nix/store/f35rrs9zdqcm2hbmfwyf6nfj52mvnzwf-ghcide-bench-2.8.0.0`
...
- [[kdnd26p61slcrw102wvz837mj04z2svh-ghcide-bench-2.8.0.0.tar.gz]]
