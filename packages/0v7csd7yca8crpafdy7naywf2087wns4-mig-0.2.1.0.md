...
- **Name**: `haskellPackages.mig`
- **Version**: `0.2.1.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Build lightweight and composable servers
- **Homepage**: [https://hackage.haskell.org/package/mig](https://hackage.haskell.org/package/mig)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/0v7csd7yca8crpafdy7naywf2087wns4-mig-0.2.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:447451`
- **Outputs**:
  - `doc`:  `/nix/store/0v7csd7yca8crpafdy7naywf2087wns4-mig-0.2.1.0`
  - `out`:  `/nix/store/0v7csd7yca8crpafdy7naywf2087wns4-mig-0.2.1.0`
...
- [[9fjw00lrzan66ns8na3y6rrjici9mnrn-mig-0.2.1.0.tar.gz]]
