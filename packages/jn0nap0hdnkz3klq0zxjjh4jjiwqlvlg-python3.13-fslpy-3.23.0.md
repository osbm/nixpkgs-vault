...
- **Name**: `python313Packages.fslpy`
- **Version**: `3.23.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: FSL Python library
- **Homepage**: [https://git.fmrib.ox.ac.uk/fsl/fslpy](https://git.fmrib.ox.ac.uk/fsl/fslpy)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/jn0nap0hdnkz3klq0zxjjh4jjiwqlvlg-python3.13-fslpy-3.23.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/fslpy/default.nix:93`
- **Outputs**:
  - `dist`:  `/nix/store/jn0nap0hdnkz3klq0zxjjh4jjiwqlvlg-python3.13-fslpy-3.23.0`
  - `out`:  `/nix/store/jn0nap0hdnkz3klq0zxjjh4jjiwqlvlg-python3.13-fslpy-3.23.0`
...
- [[5nrw00k5ag0904gxqmcm6hrpabix115h-python3.13-indexed_gzip-1.9.5]]
...
- [[n97bddz4h9wclm3g3dy0jdqwm3nhzr13-source]]
