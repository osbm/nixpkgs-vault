...
- **Name**: `rPackages.fixtuRes`
- **Version**: `0.1.3`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/fixtuRes/](https://cran.r-project.org/web/packages/fixtuRes/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/zw672mlhlya531c7q25a8203pwrws194-r-fixtuRes-0.1.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/zw672mlhlya531c7q25a8203pwrws194-r-fixtuRes-0.1.3`
...
- [[rbnyr7p4jy00brrf0lh5n6382dd6rkfy-fixtuRes_0.1.3.tar.gz]]
