...
- **Name**: `rPackages.gghilbertstrings`
- **Version**: `0.3.3`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/gghilbertstrings/](https://cran.r-project.org/web/packages/gghilbertstrings/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/vp0k6802kl1dmxfhznddns87dggilr53-r-gghilbertstrings-0.3.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/vp0k6802kl1dmxfhznddns87dggilr53-r-gghilbertstrings-0.3.3`
...
- [[r0f8g7qgsbs49rq73spbaq5c9ls53i2p-gghilbertstrings_0.3.3.tar.gz]]
