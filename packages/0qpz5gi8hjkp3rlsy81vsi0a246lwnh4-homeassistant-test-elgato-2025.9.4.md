---
aliases:
  - home-assistant-component-tests.elgato
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.elgato`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/0qpz5gi8hjkp3rlsy81vsi0a246lwnh4-homeassistant-test-elgato-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/0qpz5gi8hjkp3rlsy81vsi0a246lwnh4-homeassistant-test-elgato-2025.9.4`
...
- [[awbxs5ipc54rw0s6jjh1i3v1px77ljvd-python3.13-elgato-5.1.2]]
