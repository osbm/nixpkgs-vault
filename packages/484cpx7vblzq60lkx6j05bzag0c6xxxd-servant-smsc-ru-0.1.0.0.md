---
aliases:
  - haskellPackages.servant-smsc-ru
tags:
  - broken
  - not-available
  - license/unknown
...
- **Name**: `haskellPackages.servant-smsc-ru`
- **Version**: `0.1.0.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Servant client for smsc.ru service for sending SMS to cell phones
- **Homepage**: [https://hackage.haskell.org/package/servant-smsc-ru](https://hackage.haskell.org/package/servant-smsc-ru)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/484cpx7vblzq60lkx6j05bzag0c6xxxd-servant-smsc-ru-0.1.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:601661`
- **Outputs**:
  - `doc`:  `/nix/store/484cpx7vblzq60lkx6j05bzag0c6xxxd-servant-smsc-ru-0.1.0.0`
  - `out`:  `/nix/store/484cpx7vblzq60lkx6j05bzag0c6xxxd-servant-smsc-ru-0.1.0.0`
...
- [[v7khnll3r0pa6391nsrxd89ximnyz0x1-servant-smsc-ru-0.1.0.0.tar.gz]]
