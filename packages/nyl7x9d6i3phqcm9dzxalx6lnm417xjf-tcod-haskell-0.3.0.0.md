...
- **Name**: `haskellPackages.tcod-haskell`
- **Version**: `0.3.0.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Bindings to libtcod roguelike engine
- **Homepage**: [https://hackage.haskell.org/package/tcod-haskell](https://hackage.haskell.org/package/tcod-haskell)
- **License**: `unknown`
- **Platforms**: `aarch64-linux`, `armv5tel-linux`, `armv6l-linux`, `armv7a-linux`, `armv7l-linux`, `i686-linux`, `loongarch64-linux`, `m68k-linux`, `microblaze-linux`, `microblazeel-linux`, `mips-linux`, `mips64-linux`, `mips64el-linux`, `mipsel-linux`, `powerpc-linux`, `powerpc64-linux`, `powerpc64le-linux`, `riscv32-linux`, `riscv64-linux`, `s390-linux`, `s390x-linux`, `x86_64-linux`

## 🔧 Build Information

- **Derivation Path**: `/nix/store/nyl7x9d6i3phqcm9dzxalx6lnm417xjf-tcod-haskell-0.3.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:660463`
- **Outputs**:
  - `doc`:  `/nix/store/nyl7x9d6i3phqcm9dzxalx6lnm417xjf-tcod-haskell-0.3.0.0`
  - `out`:  `/nix/store/nyl7x9d6i3phqcm9dzxalx6lnm417xjf-tcod-haskell-0.3.0.0`
...
- [[2vjc7ggddhjim4g8s73f05h2hkfdmahl-tcod-haskell-0.3.0.0.tar.gz]]
