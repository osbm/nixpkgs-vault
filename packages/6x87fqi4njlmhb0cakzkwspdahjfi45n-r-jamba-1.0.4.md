...
- **Name**: `rPackages.jamba`
- **Version**: `1.0.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/jamba/](https://cran.r-project.org/web/packages/jamba/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/6x87fqi4njlmhb0cakzkwspdahjfi45n-r-jamba-1.0.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/6x87fqi4njlmhb0cakzkwspdahjfi45n-r-jamba-1.0.4`
...
- [[hvxh27mb8pblccz6rnl499l1n284vpis-jamba_1.0.4.tar.gz]]
