...
- **Name**: `haskellPackages.implicit`
- **Version**: `0.4.1.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: A math-inspired programmatic 2D & 3D CAD system
- **Homepage**: [https://hackage.haskell.org/package/implicit](https://hackage.haskell.org/package/implicit)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/hq3nqisl7h5qw1m9cv6azjgnykqsl7ar-implicit-0.4.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:376102`
- **Outputs**:
  - `doc`:  `/nix/store/hq3nqisl7h5qw1m9cv6azjgnykqsl7ar-implicit-0.4.1.0`
  - `out`:  `/nix/store/hq3nqisl7h5qw1m9cv6azjgnykqsl7ar-implicit-0.4.1.0`
...
- [[xwkp1hk0zbchrpmxllyvpbbyfvr65jx9-implicit-0.4.1.0.tar.gz]]
