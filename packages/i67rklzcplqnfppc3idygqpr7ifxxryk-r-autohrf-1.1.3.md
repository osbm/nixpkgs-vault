...
- **Name**: `rPackages.autohrf`
- **Version**: `1.1.3`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/autohrf/](https://cran.r-project.org/web/packages/autohrf/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/i67rklzcplqnfppc3idygqpr7ifxxryk-r-autohrf-1.1.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/i67rklzcplqnfppc3idygqpr7ifxxryk-r-autohrf-1.1.3`
...
- [[rj75g8zvn0framssggl6vv1qkqssy5m7-autohrf_1.1.3.tar.gz]]
