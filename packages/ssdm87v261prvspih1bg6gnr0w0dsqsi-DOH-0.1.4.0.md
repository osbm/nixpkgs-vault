...
- **Name**: `haskellPackages.DOH`
- **Version**: `0.1.4.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Complete API bindings for DigitalOcean API V2
- **Homepage**: [https://hackage.haskell.org/package/DOH](https://hackage.haskell.org/package/DOH)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/ssdm87v261prvspih1bg6gnr0w0dsqsi-DOH-0.1.4.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:8897`
- **Outputs**:
  - `doc`:  `/nix/store/ssdm87v261prvspih1bg6gnr0w0dsqsi-DOH-0.1.4.0`
  - `out`:  `/nix/store/ssdm87v261prvspih1bg6gnr0w0dsqsi-DOH-0.1.4.0`
...
- [[cbjzpy93xm8hfda011c6lgmiv995mcs6-DOH-0.1.4.0.tar.gz]]
