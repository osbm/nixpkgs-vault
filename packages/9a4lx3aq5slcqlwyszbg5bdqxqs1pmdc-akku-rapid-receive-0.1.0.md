...
Binding to multiple values compatible with SRFI 8

## 📋 Package Information

- **Name**: `akkuPackages.rapid-receive`
- **Version**: `0.1.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Binding to multiple values compatible with SRFI 8
- **Homepage**: []()
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/9a4lx3aq5slcqlwyszbg5bdqxqs1pmdc-akku-rapid-receive-0.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/tools/package-management/akku/default.nix:39`
- **Outputs**:
  - `out`:  `/nix/store/9a4lx3aq5slcqlwyszbg5bdqxqs1pmdc-akku-rapid-receive-0.1.0`

## 🔗 Dependencies

- [[2jbjfm0s7c03a7mylffys7n228vs64rz-make-shell-wrapper-hook]]
- [[6vpj3jzl7m0v5cx2436f37gmhgzz9p8l-rapid-receive-0.1.0.tgz]]
