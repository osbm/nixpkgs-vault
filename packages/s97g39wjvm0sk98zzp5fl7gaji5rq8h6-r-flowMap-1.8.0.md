...
- **Name**: `rPackages.flowMap`
- **Version**: `1.8.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://bioconductor.org/packages/3.21/bioc/html/flowMap.html](https://bioconductor.org/packages/3.21/bioc/html/flowMap.html)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/s97g39wjvm0sk98zzp5fl7gaji5rq8h6-r-flowMap-1.8.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/s97g39wjvm0sk98zzp5fl7gaji5rq8h6-r-flowMap-1.8.0`
...
- [[k4z3bmh4cwf3am6m7pjknjj4n2x48ll7-flowMap_1.8.0.tar.gz]]
