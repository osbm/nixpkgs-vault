...
- **Name**: `python313Packages.timm`
- **Version**: `1.0.20`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: PyTorch image models, scripts, and pretrained weights
- **Homepage**: [https://huggingface.co/docs/timm/index](https://huggingface.co/docs/timm/index)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/nhvzczg9n96vavhbjn3nsymnmjb001vx-python3.13-timm-1.0.20.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/timm/default.nix:71`
- **Outputs**:
  - `dist`:  `/nix/store/nhvzczg9n96vavhbjn3nsymnmjb001vx-python3.13-timm-1.0.20`
  - `out`:  `/nix/store/nhvzczg9n96vavhbjn3nsymnmjb001vx-python3.13-timm-1.0.20`
...
- [[hzgf1w72ly9q25ap3cxai4ahj4gsvd65-source]]
