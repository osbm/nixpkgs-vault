---
aliases:
  - androidenv.androidPkgs.all.system-images.v16.google_apis.armeabi-v7a
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.system-images.v16.google_apis.armeabi-v7a`
- **Version**: `16_r06.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/cgi25nsmyiz4i2902705g1cnax08anbl-armeabi-v7a-16_r06.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/cgi25nsmyiz4i2902705g1cnax08anbl-armeabi-v7a-16_r06.zip`
