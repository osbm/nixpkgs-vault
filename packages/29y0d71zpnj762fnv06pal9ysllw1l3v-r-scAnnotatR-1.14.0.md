...
- **Name**: `rPackages.scAnnotatR`
- **Version**: `1.14.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://bioconductor.org/packages/3.21/bioc/html/scAnnotatR.html](https://bioconductor.org/packages/3.21/bioc/html/scAnnotatR.html)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/29y0d71zpnj762fnv06pal9ysllw1l3v-r-scAnnotatR-1.14.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/29y0d71zpnj762fnv06pal9ysllw1l3v-r-scAnnotatR-1.14.0`
...
- [[m789fa1hdyzgq3nyjn5h53i6qzsghx9z-scAnnotatR_1.14.0.tar.gz]]
