...
- **Name**: `haskellPackages.bindings-portaudio`
- **Version**: `0.3`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Low-level bindings to portaudio library
- **Homepage**: [https://hackage.haskell.org/package/bindings-portaudio](https://hackage.haskell.org/package/bindings-portaudio)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/ysjz606fcjjp58bjhvlikns05sn456cx-bindings-portaudio-0.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:105530`
- **Outputs**:
  - `doc`:  `/nix/store/ysjz606fcjjp58bjhvlikns05sn456cx-bindings-portaudio-0.3`
  - `out`:  `/nix/store/ysjz606fcjjp58bjhvlikns05sn456cx-bindings-portaudio-0.3`
...
- [[b22a2pqf7b5ivd9icwcingabzjxqyn34-bindings-portaudio-0.3.tar.gz]]
