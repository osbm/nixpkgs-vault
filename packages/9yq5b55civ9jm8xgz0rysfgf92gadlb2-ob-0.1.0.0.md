...
Live in-memory sync of Obsidian Markdown notes

## 📋 Package Information

- **Name**: `haskellPackages.ob`
- **Version**: `0.1.0.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Live in-memory sync of Obsidian Markdown notes
- **Homepage**: [https://hackage.haskell.org/package/ob](https://hackage.haskell.org/package/ob)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/9yq5b55civ9jm8xgz0rysfgf92gadlb2-ob-0.1.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:485970`
- **Outputs**:
  - `doc`:  `/nix/store/9yq5b55civ9jm8xgz0rysfgf92gadlb2-ob-0.1.0.0`
  - `out`:  `/nix/store/9yq5b55civ9jm8xgz0rysfgf92gadlb2-ob-0.1.0.0`
...
- [[89nskb09rcg1j5fq1jh41jcrr4pi3d8p-ob-0.1.0.0.tar.gz]]
