...
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/padr/](https://cran.r-project.org/web/packages/padr/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/p42xw8azgpm1mkdg4xlm8i3vj7bzzwvf-r-padr-0.6.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/p42xw8azgpm1mkdg4xlm8i3vj7bzzwvf-r-padr-0.6.3`

## 🔗 Dependencies

- [[386i5algdy8gdxfznfa64p8mh0s651xb-r-Rcpp-1.1.0]]
- [[bjsb6wdjykafnkixq156qdvmxhsm2bai-bash-5.3p3]]
- [[c2y5236bl4c70ghddvygf6zbamxdayww-padr_0.6.3.tar.gz]]
