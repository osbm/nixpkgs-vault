...
- **Name**: `python313Packages.niapy`
- **Version**: `2.5.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Micro framework for building nature-inspired algorithms
- **Homepage**: [https://niapy.org/](https://niapy.org/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/psjxb5z1zb0insa03wkk1hcz9rirsrp3-python3.13-niapy-2.5.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/niapy/default.nix:50`
- **Outputs**:
  - `dist`:  `/nix/store/psjxb5z1zb0insa03wkk1hcz9rirsrp3-python3.13-niapy-2.5.2`
  - `out`:  `/nix/store/psjxb5z1zb0insa03wkk1hcz9rirsrp3-python3.13-niapy-2.5.2`
...
- [[l5q6x6r1gdr957v2s0csp6fw0a7jyr2s-source]]
