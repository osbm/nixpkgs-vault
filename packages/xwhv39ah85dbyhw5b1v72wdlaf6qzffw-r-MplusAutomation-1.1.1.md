...
- **Name**: `rPackages.MplusAutomation`
- **Version**: `1.1.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/MplusAutomation/](https://cran.r-project.org/web/packages/MplusAutomation/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/xwhv39ah85dbyhw5b1v72wdlaf6qzffw-r-MplusAutomation-1.1.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/xwhv39ah85dbyhw5b1v72wdlaf6qzffw-r-MplusAutomation-1.1.1`

## 🔗 Dependencies

- [[2vw9905gsx4cjcmsgdr8a68j48zryv9x-MplusAutomation_1.1.1.tar.gz]]
