---
aliases:
  - androidenv.androidPkgs.all.extras.extras-google-google_play_services_froyo
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.extras.extras-google-google_play_services_froyo`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/rp85kzazr3zzmilgdiily77cqivqlj1m-google_play_services_3265130_r12.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/rp85kzazr3zzmilgdiily77cqivqlj1m-google_play_services_3265130_r12.zip`
