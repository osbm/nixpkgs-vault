---
aliases:
  - androidenv.androidPkgs.all.system-images.v10.default.armeabi-v7a
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.system-images.v10.default.armeabi-v7a`
- **Version**: `10_r05.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/x17wi6192z5pi0ci72xpkhvfajx7klcb-armeabi-v7a-10_r05.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/x17wi6192z5pi0ci72xpkhvfajx7klcb-armeabi-v7a-10_r05.zip`
