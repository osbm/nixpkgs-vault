...
- **Name**: `synergyWithoutGUI`
- **Version**: `1.14.6.19-stable`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Share one mouse and keyboard between multiple computers
- **Homepage**: [https://symless.com/synergy](https://symless.com/synergy)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/2fsc4xdhrrfj6av1ki621s9dda983z6j-synergy-1.14.6.19-stable.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/applications/misc/synergy/default.nix:138`
- **Outputs**:
  - `out`:  `/nix/store/2fsc4xdhrrfj6av1ki621s9dda983z6j-synergy-1.14.6.19-stable`
...
- [[zavrdxnjhc4b9d432vg7wv4yfvpyydmv-source]]

## 📁 Input Sources

- `/nix/store/1j1icc2g0l862hv4h7s1601vn45q473a-darwin-non-static-openssl.patch`
