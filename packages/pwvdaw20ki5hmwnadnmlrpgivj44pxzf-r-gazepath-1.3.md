...
- **Name**: `rPackages.gazepath`
- **Version**: `1.3`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://cran.r-project.org/web/packages/gazepath/](https://cran.r-project.org/web/packages/gazepath/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/pwvdaw20ki5hmwnadnmlrpgivj44pxzf-r-gazepath-1.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/pwvdaw20ki5hmwnadnmlrpgivj44pxzf-r-gazepath-1.3`
...
- [[xgj7w3mmbnql7dps3lgnyjhcc6471v8b-gazepath_1.3.tar.gz]]
