...
- **Name**: `rPackages.mcStats`
- **Version**: `0.1.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/mcStats/](https://cran.r-project.org/web/packages/mcStats/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/s8nwlw5d0dmmbsym90r73g508z4k1kb0-r-mcStats-0.1.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/s8nwlw5d0dmmbsym90r73g508z4k1kb0-r-mcStats-0.1.2`
...
- [[y5a479a6c2va5sw1nacfzzmwvlscnlhz-mcStats_0.1.2.tar.gz]]
