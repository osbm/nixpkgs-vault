---
aliases:
  - haskellPackages.circuit-breaker
tags:
  - license/unknown
  - outputs/doc
  - outputs/out
...
- **Name**: `haskellPackages.circuit-breaker`
- **Version**: `0.1.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: An implementation of the "circuit breaker" pattern to disable repeated calls to a failing system
- **Homepage**: [https://hackage.haskell.org/package/circuit-breaker](https://hackage.haskell.org/package/circuit-breaker)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/dfgf11806q8jlyswkm45c6fvskk6ymq4-circuit-breaker-0.1.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:140160`
- **Outputs**:
  - `doc`:  `/nix/store/dfgf11806q8jlyswkm45c6fvskk6ymq4-circuit-breaker-0.1.0.0`
  - `out`:  `/nix/store/dfgf11806q8jlyswkm45c6fvskk6ymq4-circuit-breaker-0.1.0.0`
...
- [[wq1z3lis9ilpz68vqhczxmlmi20i63mg-circuit-breaker-0.1.0.0.tar.gz]]
