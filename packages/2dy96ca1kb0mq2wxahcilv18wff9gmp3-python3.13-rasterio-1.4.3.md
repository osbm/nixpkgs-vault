...
- **Name**: `python313Packages.rasterio`
- **Version**: `1.4.3`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Python package to read and write geospatial raster data
- **Homepage**: [https://rasterio.readthedocs.io/](https://rasterio.readthedocs.io/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/2dy96ca1kb0mq2wxahcilv18wff9gmp3-python3.13-rasterio-1.4.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/rasterio/default.nix:117`
- **Outputs**:
  - `dist`:  `/nix/store/2dy96ca1kb0mq2wxahcilv18wff9gmp3-python3.13-rasterio-1.4.3`
  - `out`:  `/nix/store/2dy96ca1kb0mq2wxahcilv18wff9gmp3-python3.13-rasterio-1.4.3`
...
- [[l03a1ynbfpb6fkxj3sz7zxdx3ag3imsy-python3.13-cligj-0.7.2]]
