...
Wrapper for the QuickJS Javascript Engine

## 📋 Package Information

- **Name**: `haskellPackages.quickjs-hs`
- **Version**: `0.1.2.4`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Wrapper for the QuickJS Javascript Engine
- **Homepage**: [https://hackage.haskell.org/package/quickjs-hs](https://hackage.haskell.org/package/quickjs-hs)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/zxcipkfmvdqpbj0l24mqns1jck10f7jv-quickjs-hs-0.1.2.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:553081`
- **Outputs**:
  - `doc`:  `/nix/store/zxcipkfmvdqpbj0l24mqns1jck10f7jv-quickjs-hs-0.1.2.4`
  - `out`:  `/nix/store/zxcipkfmvdqpbj0l24mqns1jck10f7jv-quickjs-hs-0.1.2.4`
...
- [[g4g8gxh2lkbqsqw2bim023xf5qp2mpc3-quickjs-hs-0.1.2.4.tar.gz]]
