...
- **Homepage**: [https://git.gnunet.org/libgnunetchat.git](https://git.gnunet.org/libgnunetchat.git)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/prly35nyp7zzrnxa8zwpqzvsvjpd2ikh-libgnunetchat.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/li/libgnunetchat/package.nix:52`
- **Outputs**:
  - `out`:  `/nix/store/prly35nyp7zzrnxa8zwpqzvsvjpd2ikh-libgnunetchat`

## 🔗 Dependencies

- [[1w5nrqs8kc565ap5vyzxdhy51b5sb3m3-libgnunetchat]]
