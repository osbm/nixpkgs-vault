...
- **Name**: `linuxKernel.packages.linux_6_1.v4l2loopback`
- **Version**: `0.15.1-6.1.153`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/izmi4i11v3p23rp42fjf3kia5pg15mg3-v4l2loopback-0.15.1-6.1.153.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/v4l2loopback/default.nix:58`
- **Outputs**:
  - `bin`:  `/nix/store/izmi4i11v3p23rp42fjf3kia5pg15mg3-v4l2loopback-0.15.1-6.1.153`
  - `out`:  `/nix/store/izmi4i11v3p23rp42fjf3kia5pg15mg3-v4l2loopback-0.15.1-6.1.153`
