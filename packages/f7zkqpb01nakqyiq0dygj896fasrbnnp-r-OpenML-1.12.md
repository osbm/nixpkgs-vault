...
- **Name**: `rPackages.OpenML`
- **Version**: `1.12`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/OpenML/](https://cran.r-project.org/web/packages/OpenML/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/f7zkqpb01nakqyiq0dygj896fasrbnnp-r-OpenML-1.12.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/f7zkqpb01nakqyiq0dygj896fasrbnnp-r-OpenML-1.12`

## 🔗 Dependencies

- [[3hxhp1gzfpvzf14bwwdg6hhxlrrgzdyk-r-checkmate-2.3.2]]
- [[51yp0qbf4q9wk4lds724ndg77kxdj82f-OpenML_1.12.tar.gz]]
