---
aliases:
  - python313Packages.microsoft-kiota-http
tags:
  - license/unknown
  - maintainers/fabaff
  - outputs/dist
...
- **Name**: `python313Packages.microsoft-kiota-http`
- **Version**: `1.9.7`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/ysmrqqxk7jgvgi3lnda4yq5qdr8yjy5r-python3.13-microsoft-kiota-http-1.9.7.drv`
...
- **Outputs**:
  - `dist`:  `/nix/store/ysmrqqxk7jgvgi3lnda4yq5qdr8yjy5r-python3.13-microsoft-kiota-http-1.9.7`
  - `out`:  `/nix/store/ysmrqqxk7jgvgi3lnda4yq5qdr8yjy5r-python3.13-microsoft-kiota-http-1.9.7`
