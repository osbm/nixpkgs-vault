...
- **Homepage**: [https://github.com/Virviil/oci2git](https://github.com/Virviil/oci2git)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/0n7gc09zifdl6fyi10n464m3d46jfhaq-oci2git-0.2.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/oc/oci2git/package.nix:38`
- **Outputs**:
  - `out`:  `/nix/store/0n7gc09zifdl6fyi10n464m3d46jfhaq-oci2git-0.2.1`
...
- [[l5lmc9xcszfbblqz390lagssv1dk31rg-oci2git-0.2.1-vendor]]
- [[lvdvlk7cwad5mna0wfpz8jllb30jdj1n-pkg-config-wrapper-0.29.2]]
- [[lvilndvvrn9gld2mjj3d677v8j93x7sa-source]]
