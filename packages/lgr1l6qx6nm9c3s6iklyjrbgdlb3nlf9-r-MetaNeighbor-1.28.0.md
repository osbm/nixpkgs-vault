...
- **Name**: `rPackages.MetaNeighbor`
- **Version**: `1.28.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://bioconductor.org/packages/3.21/bioc/html/MetaNeighbor.html](https://bioconductor.org/packages/3.21/bioc/html/MetaNeighbor.html)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/lgr1l6qx6nm9c3s6iklyjrbgdlb3nlf9-r-MetaNeighbor-1.28.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/lgr1l6qx6nm9c3s6iklyjrbgdlb3nlf9-r-MetaNeighbor-1.28.0`
...
- [[hwzw47sx1m34kl097mnjy0czd77s04qk-MetaNeighbor_1.28.0.tar.gz]]
