...
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/qtl2/](https://cran.r-project.org/web/packages/qtl2/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/w1sclh972zkglqxc1fcmq87rm3hdc1mp-r-qtl2-0.38.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/w1sclh972zkglqxc1fcmq87rm3hdc1mp-r-qtl2-0.38`

## 🔗 Dependencies

- [[188v6cg8gw0n6d7l6ynz4yxilpfn4jy2-qtl2_0.38.tar.gz]]
