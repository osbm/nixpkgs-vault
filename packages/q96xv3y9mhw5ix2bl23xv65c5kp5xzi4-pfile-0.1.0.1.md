...
CLI program for profiles management

## 📋 Package Information

- **Name**: `haskellPackages.pfile`
- **Version**: `0.1.0.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: CLI program for profiles management
- **Homepage**: [https://hackage.haskell.org/package/pfile](https://hackage.haskell.org/package/pfile)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/q96xv3y9mhw5ix2bl23xv65c5kp5xzi4-pfile-0.1.0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:514967`
- **Outputs**:
  - `doc`:  `/nix/store/q96xv3y9mhw5ix2bl23xv65c5kp5xzi4-pfile-0.1.0.1`
  - `out`:  `/nix/store/q96xv3y9mhw5ix2bl23xv65c5kp5xzi4-pfile-0.1.0.1`
...
- [[r7h7w2wwh3qa05fzignbj9nz0kxm0f08-pfile-0.1.0.1.tar.gz]]
