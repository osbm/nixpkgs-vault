---
aliases:
  - linuxKernel.packages.linux_6_1.trelay
tags:
  - license/unknown
...
- **Name**: `linuxKernel.packages.linux_6_1.trelay`
- **Version**: `22.03.5-6.1.153`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/qghfssxcszphpca2sc5a6js5anhqid62-trelay-22.03.5-6.1.153.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/trelay/default.nix:41`
- **Outputs**:
  - `out`:  `/nix/store/qghfssxcszphpca2sc5a6js5anhqid62-trelay-22.03.5-6.1.153`
