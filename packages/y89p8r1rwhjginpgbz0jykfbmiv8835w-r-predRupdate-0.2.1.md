...
- **Name**: `rPackages.predRupdate`
- **Version**: `0.2.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/predRupdate/](https://cran.r-project.org/web/packages/predRupdate/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/y89p8r1rwhjginpgbz0jykfbmiv8835w-r-predRupdate-0.2.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/y89p8r1rwhjginpgbz0jykfbmiv8835w-r-predRupdate-0.2.1`
...
- [[nccxrb78b1xhn759nkar8gf1svbj7psc-predRupdate_0.2.1.tar.gz]]
