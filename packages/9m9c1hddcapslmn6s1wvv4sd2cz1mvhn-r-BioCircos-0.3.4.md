...
- **Name**: `rPackages.BioCircos`
- **Version**: `0.3.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/BioCircos/](https://cran.r-project.org/web/packages/BioCircos/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/9m9c1hddcapslmn6s1wvv4sd2cz1mvhn-r-BioCircos-0.3.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/9m9c1hddcapslmn6s1wvv4sd2cz1mvhn-r-BioCircos-0.3.4`
...
- [[ibkf4x1dhq20mb3p8xwscja9ad1gkwcf-BioCircos_0.3.4.tar.gz]]
