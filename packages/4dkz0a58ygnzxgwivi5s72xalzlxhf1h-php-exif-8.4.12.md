...
- **Derivation Path**: `/nix/store/4dkz0a58ygnzxgwivi5s72xalzlxhf1h-php-exif-8.4.12.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/top-level/php-packages.nix:206`
- **Outputs**:
  - `dev`:  `/nix/store/4dkz0a58ygnzxgwivi5s72xalzlxhf1h-php-exif-8.4.12`
  - `out`:  `/nix/store/4dkz0a58ygnzxgwivi5s72xalzlxhf1h-php-exif-8.4.12`
