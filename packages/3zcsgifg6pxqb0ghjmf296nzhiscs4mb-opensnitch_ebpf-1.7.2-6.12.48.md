---
aliases:
  - linuxKernel.packages.linux_libre.opensnitch-ebpf
tags:
  - license/unknown
  - maintainers/onny
...
- **Name**: `linuxKernel.packages.linux_libre.opensnitch-ebpf`
- **Version**: `1.7.2-6.12.48`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/3zcsgifg6pxqb0ghjmf296nzhiscs4mb-opensnitch_ebpf-1.7.2-6.12.48.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/opensnitch-ebpf/default.nix:67`
- **Outputs**:
  - `out`:  `/nix/store/3zcsgifg6pxqb0ghjmf296nzhiscs4mb-opensnitch_ebpf-1.7.2-6.12.48`
