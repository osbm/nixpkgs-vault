...
- **Name**: `python313Packages.cliff`
- **Version**: `4.10.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Command Line Interface Formulation Framework
- **Homepage**: [https://github.com/openstack/cliff](https://github.com/openstack/cliff)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/ffm01832afdchhdb4mdvjh28xwfn7mg5-python3.13-cliff-4.10.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/cliff/default.nix:58`
- **Outputs**:
  - `dist`:  `/nix/store/ffm01832afdchhdb4mdvjh28xwfn7mg5-python3.13-cliff-4.10.0`
  - `out`:  `/nix/store/ffm01832afdchhdb4mdvjh28xwfn7mg5-python3.13-cliff-4.10.0`
...
- [[yi6if1l0riya34im37jfrgmxrxmajhcs-cliff-4.10.0.tar.gz]]
