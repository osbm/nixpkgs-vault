---
aliases:
  - haskellPackages.distributed-process-task
tags:
  - broken
  - not-available
  - license/unknown
...
- **Name**: `haskellPackages.distributed-process-task`
- **Version**: `0.1.2.2`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Task Framework for The Cloud Haskell Application Platform
- **Homepage**: [https://hackage.haskell.org/package/distributed-process-task](https://hackage.haskell.org/package/distributed-process-task)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/nkiiv78ygfy86lm257npyr54iw37yy6r-distributed-process-task-0.1.2.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:197826`
- **Outputs**:
  - `doc`:  `/nix/store/nkiiv78ygfy86lm257npyr54iw37yy6r-distributed-process-task-0.1.2.2`
  - `out`:  `/nix/store/nkiiv78ygfy86lm257npyr54iw37yy6r-distributed-process-task-0.1.2.2`

## 🔗 Dependencies

- [[1mw3si3szpv443dl60apjri80s8scp8x-distributed-process-client-server-0.2.8.0]]
- [[2v3i7iywprqkq1lac8bnfkv3pcw6x9k2-distributed-process-tests-0.5.2]]
...
- [[bllx1fcnmb86khj68daq9ib6w0dy7lkd-distributed-process-task-0.1.2.2.tar.gz]]
...
- [[k2p8wzywfa4c34s6wrmnnsw9b2imq7yx-rematch-0.2.0.0]]
...
- [[lzxdzmkmgrrjlfizsjj4h1irfqy9adwf-distributed-process-task-0.1.2.2-r1.cabal]]
...
---
*Generated on 2025-09-27 12:42:29 UTC*
