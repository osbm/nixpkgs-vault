...
- **Name**: `kdePackages.picmi`
- **Version**: `25.08.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: A nonogram logic game by KDE
- **Homepage**: [https://invent.kde.org/games/picmi](https://invent.kde.org/games/picmi)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/7h3qnivisnvf8x9s9i4parc0kj4fspyx-picmi-25.08.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/kde/gear/picmi/default.nix:7`
- **Outputs**:
  - `debug`:  `/nix/store/7h3qnivisnvf8x9s9i4parc0kj4fspyx-picmi-25.08.1`
  - `dev`:  `/nix/store/7h3qnivisnvf8x9s9i4parc0kj4fspyx-picmi-25.08.1`
  - `devtools`:  `/nix/store/7h3qnivisnvf8x9s9i4parc0kj4fspyx-picmi-25.08.1`
  - `out`:  `/nix/store/7h3qnivisnvf8x9s9i4parc0kj4fspyx-picmi-25.08.1`
...
- [[rjq7jhfwxhbhfq7zn81lv2i528l6x8hb-picmi-25.08.1.tar.xz]]
