---
aliases:
  - home-assistant-component-tests.volumio
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.volumio`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/437wflb8w4zvlayhb3g1rlvlg9a45dd7-homeassistant-test-volumio-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/437wflb8w4zvlayhb3g1rlvlg9a45dd7-homeassistant-test-volumio-2025.9.4`
...
- [[fijclri57hgdf6fs4v4lg29g7qspgpvq-python3.13-pyvolumio-0.1.5]]
