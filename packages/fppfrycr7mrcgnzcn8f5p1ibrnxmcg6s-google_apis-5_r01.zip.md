---
aliases:
  - androidenv.androidPkgs.all.addons.v5.google_apis
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.addons.v5.google_apis`
- **Version**: `5_r01.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/fppfrycr7mrcgnzcn8f5p1ibrnxmcg6s-google_apis-5_r01.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/fppfrycr7mrcgnzcn8f5p1ibrnxmcg6s-google_apis-5_r01.zip`
