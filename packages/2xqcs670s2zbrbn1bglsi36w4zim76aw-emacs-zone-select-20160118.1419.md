...
- **Name**: `emacsPackages.zone-select`
- **Version**: `20160118.1419`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://github.com/kawabata/zone-select](https://github.com/kawabata/zone-select)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/2xqcs670s2zbrbn1bglsi36w4zim76aw-emacs-zone-select-20160118.1419.drv`
...
- **Outputs**:
  - `out`:  `/nix/store/2xqcs670s2zbrbn1bglsi36w4zim76aw-emacs-zone-select-20160118.1419`
