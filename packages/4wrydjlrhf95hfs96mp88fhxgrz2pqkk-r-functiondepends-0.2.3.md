...
- **Name**: `rPackages.functiondepends`
- **Version**: `0.2.3`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/functiondepends/](https://cran.r-project.org/web/packages/functiondepends/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/4wrydjlrhf95hfs96mp88fhxgrz2pqkk-r-functiondepends-0.2.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/4wrydjlrhf95hfs96mp88fhxgrz2pqkk-r-functiondepends-0.2.3`
...
- [[cyfqxpl2qm1lfixnlv54502scm2w1nj0-functiondepends_0.2.3.tar.gz]]
