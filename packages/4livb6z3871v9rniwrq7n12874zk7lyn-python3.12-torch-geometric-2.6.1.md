...
- **Name**: `python312Packages.torch-geometric`
- **Version**: `2.6.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Graph Neural Network Library for PyTorch
- **Homepage**: [https://github.com/pyg-team/pytorch_geometric](https://github.com/pyg-team/pytorch_geometric)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/4livb6z3871v9rniwrq7n12874zk7lyn-python3.12-torch-geometric-2.6.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/torch-geometric/default.nix:212`
- **Outputs**:
  - `dist`:  `/nix/store/4livb6z3871v9rniwrq7n12874zk7lyn-python3.12-torch-geometric-2.6.1`
  - `out`:  `/nix/store/4livb6z3871v9rniwrq7n12874zk7lyn-python3.12-torch-geometric-2.6.1`
...
- [[kpls2b2q3wgjgk7vi15mz667jp9lv94r-source]]
