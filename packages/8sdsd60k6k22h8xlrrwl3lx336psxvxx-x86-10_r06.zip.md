---
aliases:
  - androidenv.androidPkgs.all.system-images.v10.google_apis.x86
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.system-images.v10.google_apis.x86`
- **Version**: `10_r06.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/8sdsd60k6k22h8xlrrwl3lx336psxvxx-x86-10_r06.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/8sdsd60k6k22h8xlrrwl3lx336psxvxx-x86-10_r06.zip`
