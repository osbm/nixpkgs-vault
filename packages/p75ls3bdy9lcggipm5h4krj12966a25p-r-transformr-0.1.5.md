...
- **Name**: `rPackages.transformr`
- **Version**: `0.1.5`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/transformr/](https://cran.r-project.org/web/packages/transformr/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/p75ls3bdy9lcggipm5h4krj12966a25p-r-transformr-0.1.5.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/p75ls3bdy9lcggipm5h4krj12966a25p-r-transformr-0.1.5`
...
- [[k1x4fi92qmqzlcajxk0v61682q630zpp-transformr_0.1.5.tar.gz]]
