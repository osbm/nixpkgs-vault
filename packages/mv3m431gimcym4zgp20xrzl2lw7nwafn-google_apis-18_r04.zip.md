---
aliases:
  - androidenv.androidPkgs.all.addons.v18.google_apis
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.addons.v18.google_apis`
- **Version**: `18_r04.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/mv3m431gimcym4zgp20xrzl2lw7nwafn-google_apis-18_r04.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/mv3m431gimcym4zgp20xrzl2lw7nwafn-google_apis-18_r04.zip`
