...
- **Name**: `rPackages.tibbletime`
- **Version**: `0.1.9`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/tibbletime/](https://cran.r-project.org/web/packages/tibbletime/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/0vpmpzc7clwx50nfl33x8f18aqfvj1hr-r-tibbletime-0.1.9.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/0vpmpzc7clwx50nfl33x8f18aqfvj1hr-r-tibbletime-0.1.9`
...
- [[qdknvmi5ch6zlriqn1235di1b9p0da6v-tibbletime_0.1.9.tar.gz]]
