...
- **Name**: `rPackages.metabolighteR`
- **Version**: `0.1.3`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://cran.r-project.org/web/packages/metabolighteR/](https://cran.r-project.org/web/packages/metabolighteR/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/q4qksm562r7v8a4rlqqskparw422a5cd-r-metabolighteR-0.1.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/q4qksm562r7v8a4rlqqskparw422a5cd-r-metabolighteR-0.1.3`
...
- [[fj4ibzivwdi1h6ah0b0laiaw5s1rs08c-metabolighteR_0.1.3.tar.gz]]
