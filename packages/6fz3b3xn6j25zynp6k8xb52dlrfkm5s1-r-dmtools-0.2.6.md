...
- **Name**: `rPackages.dmtools`
- **Version**: `0.2.6`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/dmtools/](https://cran.r-project.org/web/packages/dmtools/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/6fz3b3xn6j25zynp6k8xb52dlrfkm5s1-r-dmtools-0.2.6.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/6fz3b3xn6j25zynp6k8xb52dlrfkm5s1-r-dmtools-0.2.6`
...
- [[i1m6ifs18jaksmjj0j3ychchs1s9mvgj-dmtools_0.2.6.tar.gz]]
