...
- **Name**: `rPackages.fgeo_plot`
- **Version**: `1.1.11`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/fgeo.plot/](https://cran.r-project.org/web/packages/fgeo.plot/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/d4z6snh16kd7z7dg0vzvlahj5rwb0h34-r-fgeo.plot-1.1.11.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/d4z6snh16kd7z7dg0vzvlahj5rwb0h34-r-fgeo.plot-1.1.11`
...
- [[y8y1m9cvwwi6md4bpkbjfgscm8zh5a0n-fgeo.plot_1.1.11.tar.gz]]
