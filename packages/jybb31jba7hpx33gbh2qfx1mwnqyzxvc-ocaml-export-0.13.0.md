...
- **Name**: `haskellPackages.ocaml-export`
- **Version**: `0.13.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Convert Haskell types in OCaml types
- **Homepage**: [https://hackage.haskell.org/package/ocaml-export](https://hackage.haskell.org/package/ocaml-export)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/jybb31jba7hpx33gbh2qfx1mwnqyzxvc-ocaml-export-0.13.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:486360`
- **Outputs**:
  - `doc`:  `/nix/store/jybb31jba7hpx33gbh2qfx1mwnqyzxvc-ocaml-export-0.13.0`
  - `out`:  `/nix/store/jybb31jba7hpx33gbh2qfx1mwnqyzxvc-ocaml-export-0.13.0`
...
- [[8kwakjzipcbk1ysvw2bsrg4qac9y04yr-ocaml-export-0.13.0.tar.gz]]
