...
- **Name**: `rPackages.inlamemi`
- **Version**: `1.1.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/inlamemi/](https://cran.r-project.org/web/packages/inlamemi/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/vffzafm73an8vfz9bwzs9mnpw24vgd9n-r-inlamemi-1.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/vffzafm73an8vfz9bwzs9mnpw24vgd9n-r-inlamemi-1.1.0`
...
- [[pda9agqf1r719di52nyrxrdilka4x7zr-inlamemi_1.1.0.tar.gz]]
