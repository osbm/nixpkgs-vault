...
- **Name**: `haskellPackages.monzo`
- **Version**: `0.4.0.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Haskell bindings for the Monzo API
- **Homepage**: [https://hackage.haskell.org/package/monzo](https://hackage.haskell.org/package/monzo)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/9brzkgqzx85qcbx8hv40z0m0ljx6mij9-monzo-0.4.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:458926`
- **Outputs**:
  - `doc`:  `/nix/store/9brzkgqzx85qcbx8hv40z0m0ljx6mij9-monzo-0.4.0.0`
  - `out`:  `/nix/store/9brzkgqzx85qcbx8hv40z0m0ljx6mij9-monzo-0.4.0.0`
...
- [[zygsd19nzn4v85adyxpzzwxfyvi85l6h-monzo-0.4.0.0.tar.gz]]
