...
- **Name**: `python313Packages.aioautomower`
- **Version**: `2.2.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Module to communicate with the Automower Connect API
- **Homepage**: [https://github.com/Thomas55555/aioautomower](https://github.com/Thomas55555/aioautomower)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/vn4sh7rd46c4zmpirbg1aqxg79m8z6vf-python3.13-aioautomower-2.2.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/aioautomower/default.nix:83`
- **Outputs**:
  - `dist`:  `/nix/store/vn4sh7rd46c4zmpirbg1aqxg79m8z6vf-python3.13-aioautomower-2.2.2`
  - `out`:  `/nix/store/vn4sh7rd46c4zmpirbg1aqxg79m8z6vf-python3.13-aioautomower-2.2.2`
...
- [[x3w0bqbp566qgkxgjcrnvpysj3p0g7ap-python3.13-ical-11.0.0]]
- [[xchysxq7zxii82j37ns4vagdy4ig0ixd-source]]
