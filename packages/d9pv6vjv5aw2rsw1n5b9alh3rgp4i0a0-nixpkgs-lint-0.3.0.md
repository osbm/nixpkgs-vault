...
- **Name**: `nixpkgs-lint-community`
- **Version**: `0.3.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Fast semantic linter for Nix using tree-sitter
- **Homepage**: [https://github.com/nix-community/nixpkgs-lint](https://github.com/nix-community/nixpkgs-lint)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/d9pv6vjv5aw2rsw1n5b9alh3rgp4i0a0-nixpkgs-lint-0.3.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/ni/nixpkgs-lint-community/package.nix:21`
- **Outputs**:
  - `out`:  `/nix/store/d9pv6vjv5aw2rsw1n5b9alh3rgp4i0a0-nixpkgs-lint-0.3.0`

## 🔗 Dependencies

- [[090v8ppsbpyfdfvm0yhk6zj4wbd3v147-nixpkgs-lint-0.3.0-vendor]]
...
- [[dn06mxx58b7l18v3i2c0v7kf3spwmxr5-source]]
