...
- **Name**: `rPackages.visOmopResults`
- **Version**: `1.1.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/visOmopResults/](https://cran.r-project.org/web/packages/visOmopResults/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/7cgp3z0lzzc23p6lp801x8ki74an4027-r-visOmopResults-1.1.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/7cgp3z0lzzc23p6lp801x8ki74an4027-r-visOmopResults-1.1.1`
...
- [[x2m11zz8grwd2vvr1j94d2jdnibmhs1f-visOmopResults_1.1.1.tar.gz]]
