...
- **Name**: `python312Packages.jupyter-console`
- **Version**: `6.6.3`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Jupyter terminal console
- **Homepage**: [https://github.com/jupyter/jupyter_console](https://github.com/jupyter/jupyter_console)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/901cp2b7n1l0kcrrfh6b3vb1dllqrmay-python3.12-jupyter-console-6.6.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/jupyter-console/default.nix:82`
- **Outputs**:
  - `dist`:  `/nix/store/901cp2b7n1l0kcrrfh6b3vb1dllqrmay-python3.12-jupyter-console-6.6.3`
  - `out`:  `/nix/store/901cp2b7n1l0kcrrfh6b3vb1dllqrmay-python3.12-jupyter-console-6.6.3`
...
- [[i5nfhkks8zmdvc1p6q1yz8a4abbpza4y-source]]
