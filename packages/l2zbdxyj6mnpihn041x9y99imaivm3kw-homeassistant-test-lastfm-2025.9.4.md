---
aliases:
  - home-assistant-component-tests.lastfm
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.lastfm`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/l2zbdxyj6mnpihn041x9y99imaivm3kw-homeassistant-test-lastfm-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/l2zbdxyj6mnpihn041x9y99imaivm3kw-homeassistant-test-lastfm-2025.9.4`
