...
- **Derivation Path**: `/nix/store/7jm3izkp9y5d9ib6a7wxlyvzylxnidfn-kdoctools-5.116.0.drv`
...
- **Outputs**:
  - `dev`:  `/nix/store/7jm3izkp9y5d9ib6a7wxlyvzylxnidfn-kdoctools-5.116.0`
  - `out`:  `/nix/store/7jm3izkp9y5d9ib6a7wxlyvzylxnidfn-kdoctools-5.116.0`
...
- [[s6h8fwl3kclrj9ml3r23dhrckxxylz8d-kdoctools-5.116.0.tar.xz]]

## 📁 Input Sources

- `/nix/store/9ysinmc65vw0caj9i0aiy5h8kk950lv7-kdoctools-no-find-docbook-xml.patch`
