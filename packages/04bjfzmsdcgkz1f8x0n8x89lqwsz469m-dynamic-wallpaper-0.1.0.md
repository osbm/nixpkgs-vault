...
- **Homepage**: [https://github.com/dusansimic/dynamic-wallpaper](https://github.com/dusansimic/dynamic-wallpaper)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/04bjfzmsdcgkz1f8x0n8x89lqwsz469m-dynamic-wallpaper-0.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/dy/dynamic-wallpaper/package.nix:59`
- **Outputs**:
  - `out`:  `/nix/store/04bjfzmsdcgkz1f8x0n8x89lqwsz469m-dynamic-wallpaper-0.1.0`
...
- [[5bbgj8w5zrdww55zglj23rfv9x5mckk0-source]]
