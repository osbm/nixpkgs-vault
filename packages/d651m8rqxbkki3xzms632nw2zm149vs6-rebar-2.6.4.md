...
- **Name**: `beamMinimal27Packages.rebar`
- **Version**: `2.6.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/d651m8rqxbkki3xzms632nw2zm149vs6-rebar-2.6.4.drv`
...
- **Outputs**:
  - `out`:  `/nix/store/d651m8rqxbkki3xzms632nw2zm149vs6-rebar-2.6.4`
