...
- **Name**: `rPackages.statgenIBD`
- **Version**: `1.0.9`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/statgenIBD/](https://cran.r-project.org/web/packages/statgenIBD/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/vxs1p82l35xcpwdldl2s5jlnd3xwad2p-r-statgenIBD-1.0.9.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/vxs1p82l35xcpwdldl2s5jlnd3xwad2p-r-statgenIBD-1.0.9`
...
- [[gayqs8zrhdn2qn55397civkgip4avc6z-statgenIBD_1.0.9.tar.gz]]
