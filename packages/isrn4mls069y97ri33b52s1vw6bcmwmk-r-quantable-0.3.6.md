...
- **Name**: `rPackages.quantable`
- **Version**: `0.3.6`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://cran.r-project.org/web/packages/quantable/](https://cran.r-project.org/web/packages/quantable/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/isrn4mls069y97ri33b52s1vw6bcmwmk-r-quantable-0.3.6.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/isrn4mls069y97ri33b52s1vw6bcmwmk-r-quantable-0.3.6`
...
- [[xrxljlrcyxrrh7jzp9y7wjmvzchcxbzd-quantable_0.3.6.tar.gz]]
