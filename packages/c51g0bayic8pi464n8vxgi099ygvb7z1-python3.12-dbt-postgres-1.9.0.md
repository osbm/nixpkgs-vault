...
- **Name**: `python312Packages.dbt-postgres`
- **Version**: `1.9.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/c51g0bayic8pi464n8vxgi099ygvb7z1-python3.12-dbt-postgres-1.9.0.drv`
...
- **Outputs**:
  - `dist`:  `/nix/store/c51g0bayic8pi464n8vxgi099ygvb7z1-python3.12-dbt-postgres-1.9.0`
  - `out`:  `/nix/store/c51g0bayic8pi464n8vxgi099ygvb7z1-python3.12-dbt-postgres-1.9.0`
