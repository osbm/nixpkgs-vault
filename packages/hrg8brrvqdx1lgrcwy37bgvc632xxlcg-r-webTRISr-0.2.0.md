...
- **Name**: `rPackages.webTRISr`
- **Version**: `0.2.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://cran.r-project.org/web/packages/webTRISr/](https://cran.r-project.org/web/packages/webTRISr/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/hrg8brrvqdx1lgrcwy37bgvc632xxlcg-r-webTRISr-0.2.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/hrg8brrvqdx1lgrcwy37bgvc632xxlcg-r-webTRISr-0.2.0`
...
- [[gm84x2a1llc27lxq4nzklkxpm3vjhl42-webTRISr_0.2.0.tar.gz]]
