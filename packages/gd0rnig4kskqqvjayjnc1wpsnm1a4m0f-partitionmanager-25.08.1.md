...
- **Name**: `kdePackages.partitionmanager`
- **Version**: `25.08.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Manage the disk devices, partitions and file systems on your computer
- **Homepage**: [https://invent.kde.org/system/partitionmanager](https://invent.kde.org/system/partitionmanager)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/gd0rnig4kskqqvjayjnc1wpsnm1a4m0f-partitionmanager-25.08.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/kde/gear/partitionmanager/default.nix:6`
- **Outputs**:
  - `debug`:  `/nix/store/gd0rnig4kskqqvjayjnc1wpsnm1a4m0f-partitionmanager-25.08.1`
  - `dev`:  `/nix/store/gd0rnig4kskqqvjayjnc1wpsnm1a4m0f-partitionmanager-25.08.1`
  - `devtools`:  `/nix/store/gd0rnig4kskqqvjayjnc1wpsnm1a4m0f-partitionmanager-25.08.1`
  - `out`:  `/nix/store/gd0rnig4kskqqvjayjnc1wpsnm1a4m0f-partitionmanager-25.08.1`
...
- [[gvmlzr37fhwv8k6bhyqv60b2mb79a734-partitionmanager-25.08.1.tar.xz]]
