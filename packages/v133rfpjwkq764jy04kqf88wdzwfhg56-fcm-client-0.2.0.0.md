...
Admin API for Firebase Cloud Messaging

## 📋 Package Information

- **Name**: `haskellPackages.fcm-client`
- **Version**: `0.2.0.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Admin API for Firebase Cloud Messaging
- **Homepage**: [https://hackage.haskell.org/package/fcm-client](https://hackage.haskell.org/package/fcm-client)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/v133rfpjwkq764jy04kqf88wdzwfhg56-fcm-client-0.2.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:229711`
- **Outputs**:
  - `doc`:  `/nix/store/v133rfpjwkq764jy04kqf88wdzwfhg56-fcm-client-0.2.0.0`
  - `out`:  `/nix/store/v133rfpjwkq764jy04kqf88wdzwfhg56-fcm-client-0.2.0.0`
...
- [[vnf02i29ljbjxbds5jd6yxn8h5px8h0d-fcm-client-0.2.0.0.tar.gz]]
