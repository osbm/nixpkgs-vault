...
- **Name**: `postgresql17Packages.pgx_ulid`
- **Version**: `0.2.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/qg3mnpdfv7pzjdfgz5ra7s9hbbm7mzzh-pgx_ulid-0.2.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/sql/postgresql/ext/pgx_ulid.nix:52`
- **Outputs**:
  - `out`:  `/nix/store/qg3mnpdfv7pzjdfgz5ra7s9hbbm7mzzh-pgx_ulid-0.2.0`
