...
- **Name**: `python313Packages.jupyter-console`
- **Version**: `6.6.3`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/2jwpmfy7v7nk69jn2vkj2wybndqclldg-python3.13-jupyter-console-6.6.3.drv`
...
- **Outputs**:
  - `dist`:  `/nix/store/2jwpmfy7v7nk69jn2vkj2wybndqclldg-python3.13-jupyter-console-6.6.3`
  - `out`:  `/nix/store/2jwpmfy7v7nk69jn2vkj2wybndqclldg-python3.13-jupyter-console-6.6.3`
