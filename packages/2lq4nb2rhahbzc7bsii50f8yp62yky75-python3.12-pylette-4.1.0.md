...
Python library for extracting color palettes from images

## 📋 Package Information

- **Name**: `python312Packages.pylette`
- **Version**: `4.1.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Python library for extracting color palettes from images
- **Homepage**: [https://qtiptip.github.io/Pylette/](https://qtiptip.github.io/Pylette/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/2lq4nb2rhahbzc7bsii50f8yp62yky75-python3.12-pylette-4.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/pylette/default.nix:63`
- **Outputs**:
  - `dist`:  `/nix/store/2lq4nb2rhahbzc7bsii50f8yp62yky75-python3.12-pylette-4.1.0`
  - `out`:  `/nix/store/2lq4nb2rhahbzc7bsii50f8yp62yky75-python3.12-pylette-4.1.0`
...
- [[9kx9glf2r4hwgifbha8f2i3xcjpar44z-source]]
