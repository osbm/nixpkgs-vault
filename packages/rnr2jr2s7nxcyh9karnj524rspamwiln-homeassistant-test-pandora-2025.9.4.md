---
aliases:
  - home-assistant-component-tests.pandora
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.pandora`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/rnr2jr2s7nxcyh9karnj524rspamwiln-homeassistant-test-pandora-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/rnr2jr2s7nxcyh9karnj524rspamwiln-homeassistant-test-pandora-2025.9.4`
