...
- **Derivation Path**: `/nix/store/gsmpi56gpc8h7zqizzbfrm6bnqzcd0fm-mariadb-server-11.8.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/sql/mariadb/default.nix:215`
- **Outputs**:
  - `man`:  `/nix/store/gsmpi56gpc8h7zqizzbfrm6bnqzcd0fm-mariadb-server-11.8.3`
  - `out`:  `/nix/store/gsmpi56gpc8h7zqizzbfrm6bnqzcd0fm-mariadb-server-11.8.3`
...
- [[xazfgqnx6vfchq5295vv5gk7pz3z004a-mariadb-11.8.3.tar.gz]]
