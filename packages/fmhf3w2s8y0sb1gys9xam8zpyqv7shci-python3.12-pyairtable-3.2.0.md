...
- **Name**: `python312Packages.pyairtable`
- **Version**: `3.2.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/fmhf3w2s8y0sb1gys9xam8zpyqv7shci-python3.12-pyairtable-3.2.0.drv`
...
- **Outputs**:
  - `dist`:  `/nix/store/fmhf3w2s8y0sb1gys9xam8zpyqv7shci-python3.12-pyairtable-3.2.0`
  - `out`:  `/nix/store/fmhf3w2s8y0sb1gys9xam8zpyqv7shci-python3.12-pyairtable-3.2.0`
