...
- **Name**: `python313Packages.django-health-check`
- **Version**: `3.20.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/v12sl8ibly6i5qfjxb948i0agjpyssnw-python3.13-django-health-check-3.20.0.drv`
...
- **Outputs**:
  - `dist`:  `/nix/store/v12sl8ibly6i5qfjxb948i0agjpyssnw-python3.13-django-health-check-3.20.0`
  - `out`:  `/nix/store/v12sl8ibly6i5qfjxb948i0agjpyssnw-python3.13-django-health-check-3.20.0`
