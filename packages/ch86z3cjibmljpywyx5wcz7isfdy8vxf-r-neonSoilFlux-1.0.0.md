...
- **Name**: `rPackages.neonSoilFlux`
- **Version**: `1.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/neonSoilFlux/](https://cran.r-project.org/web/packages/neonSoilFlux/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/ch86z3cjibmljpywyx5wcz7isfdy8vxf-r-neonSoilFlux-1.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/ch86z3cjibmljpywyx5wcz7isfdy8vxf-r-neonSoilFlux-1.0.0`
...
- [[ylpc0zfscym1nicback56cnxxflkkw13-neonSoilFlux_1.0.0.tar.gz]]
