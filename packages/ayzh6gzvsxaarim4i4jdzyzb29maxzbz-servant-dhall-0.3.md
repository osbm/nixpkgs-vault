...
- **Name**: `haskellPackages.servant-dhall`
- **Version**: `0.3`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Servant Dhall content-type
- **Homepage**: [https://hackage.haskell.org/package/servant-dhall](https://hackage.haskell.org/package/servant-dhall)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/ayzh6gzvsxaarim4i4jdzyzb29maxzbz-servant-dhall-0.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:597820`
- **Outputs**:
  - `doc`:  `/nix/store/ayzh6gzvsxaarim4i4jdzyzb29maxzbz-servant-dhall-0.3`
  - `out`:  `/nix/store/ayzh6gzvsxaarim4i4jdzyzb29maxzbz-servant-dhall-0.3`
...
- [[d1cwdrihbg7gy2ahigx5a68k4zkm7d3s-servant-dhall-0.3.tar.gz]]
