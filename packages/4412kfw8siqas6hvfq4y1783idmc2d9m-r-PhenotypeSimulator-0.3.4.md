...
- **Name**: `rPackages.PhenotypeSimulator`
- **Version**: `0.3.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/PhenotypeSimulator/](https://cran.r-project.org/web/packages/PhenotypeSimulator/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/4412kfw8siqas6hvfq4y1783idmc2d9m-r-PhenotypeSimulator-0.3.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/4412kfw8siqas6hvfq4y1783idmc2d9m-r-PhenotypeSimulator-0.3.4`
...
- [[hcmayf9557fsyj65aans8xrih1cxq6kz-PhenotypeSimulator_0.3.4.tar.gz]]
