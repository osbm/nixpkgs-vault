...
- **Name**: `haskellPackages.chorale`
- **Version**: `0.1.8`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: A module containing basic functions that the prelude does not offer
- **Homepage**: [https://hackage.haskell.org/package/chorale](https://hackage.haskell.org/package/chorale)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/vkv4rzj39rwpbzqhfvfzij02gb2b3gw9-chorale-0.1.8.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:138320`
- **Outputs**:
  - `doc`:  `/nix/store/vkv4rzj39rwpbzqhfvfzij02gb2b3gw9-chorale-0.1.8`
  - `out`:  `/nix/store/vkv4rzj39rwpbzqhfvfzij02gb2b3gw9-chorale-0.1.8`

## 🔗 Dependencies

- [[0qg9f1f86ds4jai44p17ii62vqlaf6w0-chorale-0.1.8.tar.gz]]
