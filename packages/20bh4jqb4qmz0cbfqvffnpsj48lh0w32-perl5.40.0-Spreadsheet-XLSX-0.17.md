---
aliases:
  - perl540Packages.SpreadsheetXLSX
tags:
  - license/unknown
  - outputs/devdoc
  - outputs/out
...
- **Name**: `perl540Packages.SpreadsheetXLSX`
- **Version**: `0.17`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/20bh4jqb4qmz0cbfqvffnpsj48lh0w32-perl5.40.0-Spreadsheet-XLSX-0.17.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/top-level/perl-packages.nix:30934`
- **Outputs**:
  - `devdoc`:  `/nix/store/20bh4jqb4qmz0cbfqvffnpsj48lh0w32-perl5.40.0-Spreadsheet-XLSX-0.17`
  - `out`:  `/nix/store/20bh4jqb4qmz0cbfqvffnpsj48lh0w32-perl5.40.0-Spreadsheet-XLSX-0.17`
