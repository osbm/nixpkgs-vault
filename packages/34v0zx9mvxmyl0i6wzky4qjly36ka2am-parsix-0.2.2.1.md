...
- **Name**: `haskellPackages.parsix`
- **Version**: `0.2.2.1`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Parser combinators with slicing, error recovery, and syntax highlighting
- **Homepage**: [https://hackage.haskell.org/package/parsix](https://hackage.haskell.org/package/parsix)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/34v0zx9mvxmyl0i6wzky4qjly36ka2am-parsix-0.2.2.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:505835`
- **Outputs**:
  - `doc`:  `/nix/store/34v0zx9mvxmyl0i6wzky4qjly36ka2am-parsix-0.2.2.1`
  - `out`:  `/nix/store/34v0zx9mvxmyl0i6wzky4qjly36ka2am-parsix-0.2.2.1`
...
- [[xvzk3xbgbzcplcpdf846j6yx7ar6sg21-parsix-0.2.2.1.tar.gz]]
