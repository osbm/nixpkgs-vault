...
- **Name**: `haskellPackages.opencv`
- **Version**: `0.0.2.1`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Haskell binding to OpenCV-3.x
- **Homepage**: [https://hackage.haskell.org/package/opencv](https://hackage.haskell.org/package/opencv)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/21d9sbksps3jg324k1w3nwlw4kahy8kg-opencv-0.0.2.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:491294`
- **Outputs**:
  - `doc`:  `/nix/store/21d9sbksps3jg324k1w3nwlw4kahy8kg-opencv-0.0.2.1`
  - `out`:  `/nix/store/21d9sbksps3jg324k1w3nwlw4kahy8kg-opencv-0.0.2.1`
...
- [[r5w6k65s5kfdkn2plik6i14yh683pfkk-opencv-0.0.2.1.tar.gz]]
