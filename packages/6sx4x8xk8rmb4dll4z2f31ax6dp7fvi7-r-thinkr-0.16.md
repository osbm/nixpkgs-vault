...
- **Name**: `rPackages.thinkr`
- **Version**: `0.16`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/thinkr/](https://cran.r-project.org/web/packages/thinkr/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/6sx4x8xk8rmb4dll4z2f31ax6dp7fvi7-r-thinkr-0.16.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/6sx4x8xk8rmb4dll4z2f31ax6dp7fvi7-r-thinkr-0.16`
...
- [[sig9z7pzyc2573c3jb2qbkpr4b1ymd52-thinkr_0.16.tar.gz]]
