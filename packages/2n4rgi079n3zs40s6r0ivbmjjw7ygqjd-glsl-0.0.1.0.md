...
- **Name**: `haskellPackages.glsl`
- **Version**: `0.0.1.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Parser and optimizer for a small subset of GLSL
- **Homepage**: [https://hackage.haskell.org/package/glsl](https://hackage.haskell.org/package/glsl)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/2n4rgi079n3zs40s6r0ivbmjjw7ygqjd-glsl-0.0.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:273789`
- **Outputs**:
  - `data`:  `/nix/store/2n4rgi079n3zs40s6r0ivbmjjw7ygqjd-glsl-0.0.1.0`
  - `doc`:  `/nix/store/2n4rgi079n3zs40s6r0ivbmjjw7ygqjd-glsl-0.0.1.0`
  - `out`:  `/nix/store/2n4rgi079n3zs40s6r0ivbmjjw7ygqjd-glsl-0.0.1.0`
...
- [[gpsrgs8k3fb7b34zk1m9wga4isbqdams-glsl-0.0.1.0.tar.gz]]
