...
- **Name**: `haskellPackages.lxd-client`
- **Version**: `0.1.0.6`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: LXD client written in Haskell
- **Homepage**: [https://hackage.haskell.org/package/lxd-client](https://hackage.haskell.org/package/lxd-client)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/h2ksgcqc6xrnc213xdypkwqmj6785iv6-lxd-client-0.1.0.6.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:432581`
- **Outputs**:
  - `doc`:  `/nix/store/h2ksgcqc6xrnc213xdypkwqmj6785iv6-lxd-client-0.1.0.6`
  - `out`:  `/nix/store/h2ksgcqc6xrnc213xdypkwqmj6785iv6-lxd-client-0.1.0.6`

## 🔗 Dependencies

- [[0cpysqbfdz4zmn59jm07rrn9272sapl3-lxd-client-0.1.0.6.tar.gz]]
