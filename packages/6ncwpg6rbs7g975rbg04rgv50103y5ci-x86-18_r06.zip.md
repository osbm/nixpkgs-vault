---
aliases:
  - androidenv.androidPkgs.all.system-images.v18.google_apis.x86
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.system-images.v18.google_apis.x86`
- **Version**: `18_r06.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/6ncwpg6rbs7g975rbg04rgv50103y5ci-x86-18_r06.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/6ncwpg6rbs7g975rbg04rgv50103y5ci-x86-18_r06.zip`
