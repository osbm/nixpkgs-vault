...
- **Name**: `elmPackages.elm-test-rs`
- **Version**: `3.0.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Fast and portable executable to run your Elm tests
- **Homepage**: [https://github.com/mpizenberg/elm-test-rs](https://github.com/mpizenberg/elm-test-rs)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/qgjimak364ifggaai6925jyxdpdyvwdc-elm-test-rs-3.0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/compilers/elm/packages/elm-test-rs/default.nix:28`
- **Outputs**:
  - `out`:  `/nix/store/qgjimak364ifggaai6925jyxdpdyvwdc-elm-test-rs-3.0.1`
...
- [[mq7fyqi0r4npif747m8900cr5hrsclba-elm-test-rs-3.0.1-vendor]]
- [[p76r0cwlf6k97ibprrpfd8xw0r8wc3nx-stdenv-linux]]
- [[qi6337yh29r9ppqm262bf6vz0g13451b-cargo-build-hook.sh]]
- [[xqxbqs6qgnhvpkcai046s94jfrx8wb62-cargo-check-hook.sh]]
- [[xspng6cnn4wbvjfbvphsnkqdbivgrb5d-source]]
