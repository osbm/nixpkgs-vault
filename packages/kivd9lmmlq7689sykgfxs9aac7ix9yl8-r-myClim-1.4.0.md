...
- **Name**: `rPackages.myClim`
- **Version**: `1.4.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/myClim/](https://cran.r-project.org/web/packages/myClim/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/kivd9lmmlq7689sykgfxs9aac7ix9yl8-r-myClim-1.4.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/kivd9lmmlq7689sykgfxs9aac7ix9yl8-r-myClim-1.4.0`
...
- [[s7wv08lgaqm63whp0dyasaff943jlx7z-myClim_1.4.0.tar.gz]]
