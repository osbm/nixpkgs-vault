...
- **Name**: `rPackages.flowTraceR`
- **Version**: `0.1.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/flowTraceR/](https://cran.r-project.org/web/packages/flowTraceR/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/saxzydxar1brjpzily0rwfw5kq3s27ry-r-flowTraceR-0.1.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/saxzydxar1brjpzily0rwfw5kq3s27ry-r-flowTraceR-0.1.1`
...
- [[z45cjzxdjbadji81z0msk36nw850jzwg-flowTraceR_0.1.1.tar.gz]]
