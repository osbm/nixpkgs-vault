...
- **Name**: `haskellPackages.thock`
- **Version**: `0.2.1.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: A modern TUI typing game featuring online racing against friends
- **Homepage**: [https://hackage.haskell.org/package/thock](https://hackage.haskell.org/package/thock)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/0h534w5w5p1p3hhh2mq4xr0fbyxn7rcb-thock-0.2.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:671490`
- **Outputs**:
  - `doc`:  `/nix/store/0h534w5w5p1p3hhh2mq4xr0fbyxn7rcb-thock-0.2.1.0`
  - `out`:  `/nix/store/0h534w5w5p1p3hhh2mq4xr0fbyxn7rcb-thock-0.2.1.0`
...
- [[r5j46vkzlzjznc4lwpih15ym390nx6m9-thock-0.2.1.0.tar.gz]]
