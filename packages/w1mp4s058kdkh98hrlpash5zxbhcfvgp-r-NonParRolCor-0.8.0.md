...
- **Name**: `rPackages.NonParRolCor`
- **Version**: `0.8.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/NonParRolCor/](https://cran.r-project.org/web/packages/NonParRolCor/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/w1mp4s058kdkh98hrlpash5zxbhcfvgp-r-NonParRolCor-0.8.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/w1mp4s058kdkh98hrlpash5zxbhcfvgp-r-NonParRolCor-0.8.0`
...
- [[dxisa1rzcs58dw044rx0yp5raw75wdi6-NonParRolCor_0.8.0.tar.gz]]
