...
- **Name**: `haskellPackages.coformat`
- **Version**: `0.3.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Generate clang-format config based on some existing code base
- **Homepage**: [https://hackage.haskell.org/package/coformat](https://hackage.haskell.org/package/coformat)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/0bq4vg2gm1glmlgs2q4sszg4404a8cyl-coformat-0.3.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:148822`
- **Outputs**:
  - `doc`:  `/nix/store/0bq4vg2gm1glmlgs2q4sszg4404a8cyl-coformat-0.3.0.0`
  - `out`:  `/nix/store/0bq4vg2gm1glmlgs2q4sszg4404a8cyl-coformat-0.3.0.0`
...
- [[sy9s2kpd26yjmv55jbayj7cpmqda215i-dom-selector-0.2.0.1]]
- [[vwxj4ws4cy8i2kck4pclnw40c2h2bsjk-command-qq-0.3.1.0]]
