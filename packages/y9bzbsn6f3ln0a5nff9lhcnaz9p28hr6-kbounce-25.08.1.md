...
- **Name**: `kdePackages.kbounce`
- **Version**: `25.08.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: KBounce is a single player arcade game with the elements of puzzle
- **Homepage**: [https://invent.kde.org/games/kbounce](https://invent.kde.org/games/kbounce)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/y9bzbsn6f3ln0a5nff9lhcnaz9p28hr6-kbounce-25.08.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/kde/gear/kbounce/default.nix:7`
- **Outputs**:
  - `debug`:  `/nix/store/y9bzbsn6f3ln0a5nff9lhcnaz9p28hr6-kbounce-25.08.1`
  - `dev`:  `/nix/store/y9bzbsn6f3ln0a5nff9lhcnaz9p28hr6-kbounce-25.08.1`
  - `devtools`:  `/nix/store/y9bzbsn6f3ln0a5nff9lhcnaz9p28hr6-kbounce-25.08.1`
  - `out`:  `/nix/store/y9bzbsn6f3ln0a5nff9lhcnaz9p28hr6-kbounce-25.08.1`
...
- [[hq0drkb0inla4gkanp5shwvqf7p2av5j-kbounce-25.08.1.tar.xz]]
