...
- **Name**: `rPackages.pksensi`
- **Version**: `1.2.3`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/pksensi/](https://cran.r-project.org/web/packages/pksensi/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/f13bq169vwd7axic9a3j5y64h5d23r4k-r-pksensi-1.2.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/f13bq169vwd7axic9a3j5y64h5d23r4k-r-pksensi-1.2.3`

## 🔗 Dependencies

- [[4aagfd5czsxj89c3559njxg9lk8p4kcf-pksensi_1.2.3.tar.gz]]
