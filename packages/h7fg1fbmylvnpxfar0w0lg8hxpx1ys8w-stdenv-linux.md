...
- **Derivation Path**: `/nix/store/h7fg1fbmylvnpxfar0w0lg8hxpx1ys8w-stdenv-linux.drv`
- **Outputs**:
  - `out`:  `/nix/store/h7fg1fbmylvnpxfar0w0lg8hxpx1ys8w-stdenv-linux`
...
- [[ar7czi7acc51q86w2hmmjnzqg1mgyib3-gcc-wrapper-15.2.0]]
