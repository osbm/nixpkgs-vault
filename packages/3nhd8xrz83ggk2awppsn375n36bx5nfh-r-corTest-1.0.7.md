...
- **Name**: `rPackages.corTest`
- **Version**: `1.0.7`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/corTest/](https://cran.r-project.org/web/packages/corTest/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/3nhd8xrz83ggk2awppsn375n36bx5nfh-r-corTest-1.0.7.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/3nhd8xrz83ggk2awppsn375n36bx5nfh-r-corTest-1.0.7`
...
- [[j0bm3zd74y2rqc6wbgs6lpd9a9wi9s2z-corTest_1.0.7.tar.gz]]
