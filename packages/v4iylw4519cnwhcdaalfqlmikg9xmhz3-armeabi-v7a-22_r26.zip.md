---
aliases:
  - androidenv.androidPkgs.all.system-images.v22.google_apis.armeabi-v7a
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.system-images.v22.google_apis.armeabi-v7a`
- **Version**: `22_r26.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/v4iylw4519cnwhcdaalfqlmikg9xmhz3-armeabi-v7a-22_r26.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/v4iylw4519cnwhcdaalfqlmikg9xmhz3-armeabi-v7a-22_r26.zip`
