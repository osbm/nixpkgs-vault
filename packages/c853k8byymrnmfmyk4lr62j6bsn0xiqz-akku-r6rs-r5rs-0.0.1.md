...
Port of (rnrs r5rs) to R7RS

## 📋 Package Information

- **Name**: `akkuPackages.r6rs-r5rs`
- **Version**: `0.0.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/c853k8byymrnmfmyk4lr62j6bsn0xiqz-akku-r6rs-r5rs-0.0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/tools/package-management/akku/default.nix:39`
- **Outputs**:
  - `out`:  `/nix/store/c853k8byymrnmfmyk4lr62j6bsn0xiqz-akku-r6rs-r5rs-0.0.1`
...
- [[hhdj6i6vfjqfszdsz2c7q4lrwb4jlykr-r6rs-r5rs-0.0.1.tgz]]
