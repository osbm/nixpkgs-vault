...
- **Name**: `rPackages.wrappedtools`
- **Version**: `0.9.8`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/wrappedtools/](https://cran.r-project.org/web/packages/wrappedtools/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/zygbr4lbm852k4diw8wssfs01dpnxpfr-r-wrappedtools-0.9.8.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/zygbr4lbm852k4diw8wssfs01dpnxpfr-r-wrappedtools-0.9.8`
...
- [[dksq3nlz9h54l33nxdkdk4dipdrgshzf-wrappedtools_0.9.8.tar.gz]]
