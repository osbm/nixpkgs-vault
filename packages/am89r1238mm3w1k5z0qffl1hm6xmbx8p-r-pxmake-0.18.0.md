...
- **Name**: `rPackages.pxmake`
- **Version**: `0.18.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/pxmake/](https://cran.r-project.org/web/packages/pxmake/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/am89r1238mm3w1k5z0qffl1hm6xmbx8p-r-pxmake-0.18.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/am89r1238mm3w1k5z0qffl1hm6xmbx8p-r-pxmake-0.18.0`

## 🔗 Dependencies

- [[023yv8qcmkl9nzjfdp359a6y01mv7vgz-pxmake_0.18.0.tar.gz]]
