...
- **Name**: `python313Packages.gdown`
- **Version**: `5.2.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: CLI tool for downloading large files from Google Drive
- **Homepage**: [https://github.com/wkentaro/gdown](https://github.com/wkentaro/gdown)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/d7vgj2904s8c8flmk26s16594rsh38sb-python3.13-gdown-5.2.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/gdown/default.nix:52`
- **Outputs**:
  - `dist`:  `/nix/store/d7vgj2904s8c8flmk26s16594rsh38sb-python3.13-gdown-5.2.0`
  - `out`:  `/nix/store/d7vgj2904s8c8flmk26s16594rsh38sb-python3.13-gdown-5.2.0`
...
- [[8y2swllx50fk3734cby9djjz81yxac6z-gdown-5.2.0.tar.gz]]
