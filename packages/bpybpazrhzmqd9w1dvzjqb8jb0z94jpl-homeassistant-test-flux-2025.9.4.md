---
aliases:
  - home-assistant-component-tests.flux
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.flux`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/bpybpazrhzmqd9w1dvzjqb8jb0z94jpl-homeassistant-test-flux-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/bpybpazrhzmqd9w1dvzjqb8jb0z94jpl-homeassistant-test-flux-2025.9.4`
