...
- **Name**: `rPackages.WinRatio`
- **Version**: `1.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/WinRatio/](https://cran.r-project.org/web/packages/WinRatio/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/hlynb9kj21l4hf9pbg5nbjjiq2y7kjn6-r-WinRatio-1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/hlynb9kj21l4hf9pbg5nbjjiq2y7kjn6-r-WinRatio-1.0`
...
- [[z46mphisg0ws59hpf4p72hq5b0sk9qf2-WinRatio_1.0.tar.gz]]
