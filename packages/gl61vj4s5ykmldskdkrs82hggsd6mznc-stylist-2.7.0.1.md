...
- **Name**: `haskellPackages.stylist`
- **Version**: `2.7.0.1`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Apply CSS styles to a document tree
- **Homepage**: [https://hackage.haskell.org/package/stylist](https://hackage.haskell.org/package/stylist)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/gl61vj4s5ykmldskdkrs82hggsd6mznc-stylist-2.7.0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:644600`
- **Outputs**:
  - `doc`:  `/nix/store/gl61vj4s5ykmldskdkrs82hggsd6mznc-stylist-2.7.0.1`
  - `out`:  `/nix/store/gl61vj4s5ykmldskdkrs82hggsd6mznc-stylist-2.7.0.1`
...
- [[lm93v7dslf9m0iwqrp594cmbh5gdqjpm-stylist-2.7.0.1-r1.cabal]]
- [[p76r0cwlf6k97ibprrpfd8xw0r8wc3nx-stdenv-linux]]
- [[pqyf6khzwr12gs28w3m8hs3xc0pssz0x-async-2.2.5]]
- [[q3s60sfs4dkd4xg1pfmghmm0sn2azsqr-stylist-2.7.0.1.tar.gz]]
