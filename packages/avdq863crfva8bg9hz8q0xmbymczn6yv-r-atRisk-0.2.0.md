...
- **Name**: `rPackages.atRisk`
- **Version**: `0.2.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/atRisk/](https://cran.r-project.org/web/packages/atRisk/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/avdq863crfva8bg9hz8q0xmbymczn6yv-r-atRisk-0.2.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/avdq863crfva8bg9hz8q0xmbymczn6yv-r-atRisk-0.2.0`

## 🔗 Dependencies

- [[0ws8y5dl5zj9qffs1kcv76900cvckm45-atRisk_0.2.0.tar.gz]]
