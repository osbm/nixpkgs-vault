...
- **Name**: `kdePackages.kpat`
- **Version**: `25.08.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: KPatience offers a selection of solitaire card games
- **Homepage**: [https://invent.kde.org/games/kpat](https://invent.kde.org/games/kpat)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/z1c3s1babq35sbbwd3cdhzqqp351jav4-kpat-25.08.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/kde/gear/kpat/default.nix:11`
- **Outputs**:
  - `debug`:  `/nix/store/z1c3s1babq35sbbwd3cdhzqqp351jav4-kpat-25.08.1`
  - `dev`:  `/nix/store/z1c3s1babq35sbbwd3cdhzqqp351jav4-kpat-25.08.1`
  - `devtools`:  `/nix/store/z1c3s1babq35sbbwd3cdhzqqp351jav4-kpat-25.08.1`
  - `out`:  `/nix/store/z1c3s1babq35sbbwd3cdhzqqp351jav4-kpat-25.08.1`
...
- [[vxc0az2j3klizanpzfxr5pzis034y74j-kpat-25.08.1.tar.xz]]
