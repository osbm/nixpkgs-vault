...
- **Name**: `python313Packages.seatconnect`
- **Version**: `1.1.9`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/irq8a94mdaysb0mn00w5jbi9dshzbbk6-python3.13-seatconnect-1.1.9.drv`
...
- **Outputs**:
  - `dist`:  `/nix/store/irq8a94mdaysb0mn00w5jbi9dshzbbk6-python3.13-seatconnect-1.1.9`
  - `out`:  `/nix/store/irq8a94mdaysb0mn00w5jbi9dshzbbk6-python3.13-seatconnect-1.1.9`
