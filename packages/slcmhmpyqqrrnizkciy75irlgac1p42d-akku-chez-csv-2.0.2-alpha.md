...
- **Name**: `akkuPackages.chez-csv`
- **Version**: `2.0.2-alpha`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Chez Scheme CSV library.
- **Homepage**: []()
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/slcmhmpyqqrrnizkciy75irlgac1p42d-akku-chez-csv-2.0.2-alpha.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/tools/package-management/akku/default.nix:39`
- **Outputs**:
  - `out`:  `/nix/store/slcmhmpyqqrrnizkciy75irlgac1p42d-akku-chez-csv-2.0.2-alpha`
...
- [[r2d798xc2ffhaqbllxdwv64vskq4bn7l-chez-csv_2.0.2-alpha_repack.tar.xz]]
