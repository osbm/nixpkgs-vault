...
- **Name**: `haskellPackages.watchit`
- **Version**: `0.1.0.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: File change watching utility
- **Homepage**: [https://hackage.haskell.org/package/watchit](https://hackage.haskell.org/package/watchit)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/17zap192776bbm4650y59il939nn2f27-watchit-0.1.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:716795`
- **Outputs**:
  - `doc`:  `/nix/store/17zap192776bbm4650y59il939nn2f27-watchit-0.1.0.0`
  - `out`:  `/nix/store/17zap192776bbm4650y59il939nn2f27-watchit-0.1.0.0`

## 🔗 Dependencies

- [[034063f708fnsx4n2vn8pnvnnv7crij5-watchit-0.1.0.0.tar.gz]]
