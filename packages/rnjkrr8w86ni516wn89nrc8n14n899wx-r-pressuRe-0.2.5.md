...
- **Name**: `rPackages.pressuRe`
- **Version**: `0.2.5`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/pressuRe/](https://cran.r-project.org/web/packages/pressuRe/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/rnjkrr8w86ni516wn89nrc8n14n899wx-r-pressuRe-0.2.5.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/rnjkrr8w86ni516wn89nrc8n14n899wx-r-pressuRe-0.2.5`

## 🔗 Dependencies

- [[0qd67ii9y66r6bj7jj9x3mpqdnhkkk6p-pressuRe_0.2.5.tar.gz]]
