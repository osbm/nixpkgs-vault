...
- **Name**: `rPackages.rfacebookstat`
- **Version**: `2.12.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/rfacebookstat/](https://cran.r-project.org/web/packages/rfacebookstat/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/wlds4maf1fk4z09zza5ipvl598rmnka5-r-rfacebookstat-2.12.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/wlds4maf1fk4z09zza5ipvl598rmnka5-r-rfacebookstat-2.12.0`

## 🔗 Dependencies

- [[01zs9sg6p3k1fmp2ip2lx4k3c6cr0pmy-rfacebookstat_2.12.0.tar.gz]]
