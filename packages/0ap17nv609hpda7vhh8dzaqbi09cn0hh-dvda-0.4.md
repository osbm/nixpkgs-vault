...
- **Name**: `haskellPackages.dvda`
- **Version**: `0.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Efficient automatic differentiation and code generation
- **Homepage**: [https://hackage.haskell.org/package/dvda](https://hackage.haskell.org/package/dvda)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/0ap17nv609hpda7vhh8dzaqbi09cn0hh-dvda-0.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:205957`
- **Outputs**:
  - `doc`:  `/nix/store/0ap17nv609hpda7vhh8dzaqbi09cn0hh-dvda-0.4`
  - `out`:  `/nix/store/0ap17nv609hpda7vhh8dzaqbi09cn0hh-dvda-0.4`

## 🔗 Dependencies

- [[3494nqykqad0l5wr2484004wy0jkzl66-dvda-0.4.tar.gz]]
