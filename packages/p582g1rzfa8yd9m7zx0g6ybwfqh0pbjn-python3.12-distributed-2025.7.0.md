...
- **Name**: `python312Packages.distributed`
- **Version**: `2025.7.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Distributed computation in Python
- **Homepage**: [https://distributed.readthedocs.io/](https://distributed.readthedocs.io/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/p582g1rzfa8yd9m7zx0g6ybwfqh0pbjn-python3.12-distributed-2025.7.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/distributed/default.nix:80`
- **Outputs**:
  - `dist`:  `/nix/store/p582g1rzfa8yd9m7zx0g6ybwfqh0pbjn-python3.12-distributed-2025.7.0`
  - `out`:  `/nix/store/p582g1rzfa8yd9m7zx0g6ybwfqh0pbjn-python3.12-distributed-2025.7.0`

## 🔗 Dependencies

- [[2711784wyj9nad6jh8l004i8zni05h0a-source]]
...
- [[k7cwz2n9rw4i2m4ihsiagxw4bccw6wq3-python3.12-zict-3.0.0]]
...
- [[msmflh5r0kh52am77zi2b5vrnriwa0q2-python3.12-locket-1.0.0]]
