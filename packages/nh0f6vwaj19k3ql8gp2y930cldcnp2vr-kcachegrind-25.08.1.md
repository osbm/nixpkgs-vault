...
- **Name**: `kdePackages.kcachegrind`
- **Version**: `25.08.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: GUI to profilers such as Valgrind
- **Homepage**: [https://invent.kde.org/sdk/kcachegrind](https://invent.kde.org/sdk/kcachegrind)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/nh0f6vwaj19k3ql8gp2y930cldcnp2vr-kcachegrind-25.08.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/kde/gear/kcachegrind/default.nix:8`
- **Outputs**:
  - `debug`:  `/nix/store/nh0f6vwaj19k3ql8gp2y930cldcnp2vr-kcachegrind-25.08.1`
  - `dev`:  `/nix/store/nh0f6vwaj19k3ql8gp2y930cldcnp2vr-kcachegrind-25.08.1`
  - `devtools`:  `/nix/store/nh0f6vwaj19k3ql8gp2y930cldcnp2vr-kcachegrind-25.08.1`
  - `out`:  `/nix/store/nh0f6vwaj19k3ql8gp2y930cldcnp2vr-kcachegrind-25.08.1`

## 🔗 Dependencies

- [[3w1a0i4za57yp1hnnd7ym3wjhffpryrm-kxmlgui-6.18.0]]
- [[5vsd7c42y7hvrwh89i5gxv2qicnjrwmz-kcachegrind-25.08.1.tar.xz]]
