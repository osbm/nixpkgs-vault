...
- **Name**: `rPackages.crsra`
- **Version**: `0.2.3`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://cran.r-project.org/web/packages/crsra/](https://cran.r-project.org/web/packages/crsra/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/gwmdvi7chm1m16v05x47kvb8diqjscak-r-crsra-0.2.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/gwmdvi7chm1m16v05x47kvb8diqjscak-r-crsra-0.2.3`

## 🔗 Dependencies

- [[2hcfnhajihg6nlkxlaw1qhwmqd0n6z6s-crsra_0.2.3.tar.gz]]
