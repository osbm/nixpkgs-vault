...
- **Name**: `akkuPackages.slib-filename`
- **Version**: `3.1.5`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/32a35hwa1pbakc2q71swmfhhdw9xajzy-akku-slib-filename-3.1.5.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/tools/package-management/akku/default.nix:39`
- **Outputs**:
  - `out`:  `/nix/store/32a35hwa1pbakc2q71swmfhhdw9xajzy-akku-slib-filename-3.1.5`

## 🔗 Dependencies

- [[209glybmg8j4vk87hgs3nlx1sprc5m5h-slib-filename-SLIB-3b5-r7rs.tgz]]
