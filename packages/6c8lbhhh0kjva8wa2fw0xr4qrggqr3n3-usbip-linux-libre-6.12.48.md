---
aliases:
  - linuxKernel.packages.linux_libre.usbip
tags:
  - license/unknown
  - outputs/out
---
...
- **Name**: `linuxKernel.packages.linux_libre.usbip`
- **Version**: `6.12.48`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/6c8lbhhh0kjva8wa2fw0xr4qrggqr3n3-usbip-linux-libre-6.12.48.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/usbip/default.nix:45`
- **Outputs**:
  - `out`:  `/nix/store/6c8lbhhh0kjva8wa2fw0xr4qrggqr3n3-usbip-linux-libre-6.12.48`
