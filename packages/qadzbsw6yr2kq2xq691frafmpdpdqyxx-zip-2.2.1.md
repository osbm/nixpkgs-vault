...
- **Name**: `haskellPackages.zip_2_2_1`
- **Version**: `2.2.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/qadzbsw6yr2kq2xq691frafmpdpdqyxx-zip-2.2.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:747612`
- **Outputs**:
  - `doc`:  `/nix/store/qadzbsw6yr2kq2xq691frafmpdpdqyxx-zip-2.2.1`
  - `out`:  `/nix/store/qadzbsw6yr2kq2xq691frafmpdpdqyxx-zip-2.2.1`
...
- [[6zbyqb5lfl9wlfnfzqrgk9qa98r25h9n-zip-2.2.1.tar.gz]]
