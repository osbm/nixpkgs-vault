...
- **Name**: `python312Packages.pymochad`
- **Version**: `0.3.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/girv8l15b57jambqhm70myfsgsy7a34v-python3.12-pymochad-0.3.0.drv`
...
- **Outputs**:
  - `dist`:  `/nix/store/girv8l15b57jambqhm70myfsgsy7a34v-python3.12-pymochad-0.3.0`
  - `out`:  `/nix/store/girv8l15b57jambqhm70myfsgsy7a34v-python3.12-pymochad-0.3.0`
