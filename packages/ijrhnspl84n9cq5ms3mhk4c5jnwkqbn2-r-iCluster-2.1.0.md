...
- **Name**: `rPackages.iCluster`
- **Version**: `2.1.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://cran.r-project.org/web/packages/iCluster/](https://cran.r-project.org/web/packages/iCluster/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/ijrhnspl84n9cq5ms3mhk4c5jnwkqbn2-r-iCluster-2.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/ijrhnspl84n9cq5ms3mhk4c5jnwkqbn2-r-iCluster-2.1.0`

## 🔗 Dependencies

- [[2zw2sc9q4glaqavwvycnrhpi3bw1fwvv-iCluster_2.1.0.tar.gz]]
