---
aliases:
  - androidenv.androidPkgs.all.system-images.v17.default.mips
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.system-images.v17.default.mips`
- **Version**: `17_r01.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/si2ga8rvwgyfwgyasc1kr39j2g721vnz-sysimg_mips-17_r01.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/si2ga8rvwgyfwgyasc1kr39j2g721vnz-sysimg_mips-17_r01.zip`
