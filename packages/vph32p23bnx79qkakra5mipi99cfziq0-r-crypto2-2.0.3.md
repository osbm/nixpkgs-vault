...
- **Name**: `rPackages.crypto2`
- **Version**: `2.0.3`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/crypto2/](https://cran.r-project.org/web/packages/crypto2/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/vph32p23bnx79qkakra5mipi99cfziq0-r-crypto2-2.0.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/vph32p23bnx79qkakra5mipi99cfziq0-r-crypto2-2.0.3`
...
- [[kfdxzlvc6q25d1pjn8r475d4w6wllwjh-crypto2_2.0.3.tar.gz]]
