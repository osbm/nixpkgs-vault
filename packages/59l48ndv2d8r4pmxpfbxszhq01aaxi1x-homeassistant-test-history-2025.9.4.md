---
aliases:
  - home-assistant-component-tests.history
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.history`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/59l48ndv2d8r4pmxpfbxszhq01aaxi1x-homeassistant-test-history-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/59l48ndv2d8r4pmxpfbxszhq01aaxi1x-homeassistant-test-history-2025.9.4`
