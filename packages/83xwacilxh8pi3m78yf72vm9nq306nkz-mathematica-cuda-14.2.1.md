...
- **Name**: `mathematica-webdoc-cuda`
- **Version**: `14.2.1`
- **Available**: ❌ No
- **Broken**: ✅ No
- **Description**: Wolfram Mathematica computational software system
- **Homepage**: [https://www.wolfram.com/mathematica/](https://www.wolfram.com/mathematica/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/83xwacilxh8pi3m78yf72vm9nq306nkz-mathematica-cuda-14.2.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/ma/mathematica/package.nix:74`
- **Outputs**:
  - `out`:  `/nix/store/83xwacilxh8pi3m78yf72vm9nq306nkz-mathematica-cuda-14.2.1`
...
- [[bbzzkp18vjs9a93xs2wkpkxpd3q00gkp-Wolfram_14.2.1_LIN.sh]]
...
- [[zhac0fxzp5xzk2ssdd9y1gqng2iqk0yk-mathematica-cuda-env]]
