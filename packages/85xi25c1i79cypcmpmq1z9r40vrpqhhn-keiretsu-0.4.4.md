...
- **Name**: `haskellPackages.keiretsu`
- **Version**: `0.4.4`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Multi-process orchestration for development and integration testing
- **Homepage**: [https://hackage.haskell.org/package/keiretsu](https://hackage.haskell.org/package/keiretsu)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/85xi25c1i79cypcmpmq1z9r40vrpqhhn-keiretsu-0.4.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:399752`
- **Outputs**:
  - `doc`:  `/nix/store/85xi25c1i79cypcmpmq1z9r40vrpqhhn-keiretsu-0.4.4`
  - `out`:  `/nix/store/85xi25c1i79cypcmpmq1z9r40vrpqhhn-keiretsu-0.4.4`

## 🔗 Dependencies

- [[4lykrm96bxajhbrv42nzm365n9yf9s1y-coreutils-9.7]]
- [[4nkk3hwl9lwhk8r5l9s44cr5fm7qbp76-keiretsu-0.4.4.tar.gz]]
