...
- **Name**: `python312Packages.ormar`
- **Version**: `0.20.2`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Async ORM with fastapi in mind and pydantic validation
- **Homepage**: [https://github.com/collerek/ormar](https://github.com/collerek/ormar)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/qlfkyqmjr7wmcq0san6jnryr5gfr4vka-python3.12-ormar-0.20.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/ormar/default.nix:143`
- **Outputs**:
  - `dist`:  `/nix/store/qlfkyqmjr7wmcq0san6jnryr5gfr4vka-python3.12-ormar-0.20.2`
  - `out`:  `/nix/store/qlfkyqmjr7wmcq0san6jnryr5gfr4vka-python3.12-ormar-0.20.2`

## 🔗 Dependencies

- [[0x2m8jwc3mnz3vjy2ax6x6n04vdhrm2y-python3.12-httpx-0.28.1]]
- [[5vsffdi0kgla24ca4l9bv0fxzc7s2qyk-pypa-build-hook.sh]]
- [[7nlmkf5q46sqzizzih0mfaj77wv9b6mi-python3.12-aiopg-1.4.0]]
...
- [[b72l9f7kh1yiq7cgcih6dbyrkscrmp4h-source]]
- [[bhc4qvdi1fqbpsnqqgbl422ydlbnbqis-python3.12-databases-0.9.0]]
...
- [[qrdmw1z0qcspq0rfx1dd9gnrdpznc70n-python3.12-aiomysql-0.2.0]]
