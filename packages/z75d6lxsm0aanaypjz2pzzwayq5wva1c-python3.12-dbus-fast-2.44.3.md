...
- **Name**: `python312Packages.dbus-fast`
- **Version**: `2.44.3`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/z75d6lxsm0aanaypjz2pzzwayq5wva1c-python3.12-dbus-fast-2.44.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/dbus-fast/default.nix:76`
- **Outputs**:
  - `dist`:  `/nix/store/z75d6lxsm0aanaypjz2pzzwayq5wva1c-python3.12-dbus-fast-2.44.3`
  - `out`:  `/nix/store/z75d6lxsm0aanaypjz2pzzwayq5wva1c-python3.12-dbus-fast-2.44.3`

## 🔗 Dependencies

- [[0v2zbx5gky15vwbzncrwdbmiq8aic9rw-source]]
