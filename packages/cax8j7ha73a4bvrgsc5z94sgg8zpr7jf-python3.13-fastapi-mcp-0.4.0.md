...
- **Name**: `python313Packages.fastapi-mcp`
- **Version**: `0.4.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/cax8j7ha73a4bvrgsc5z94sgg8zpr7jf-python3.13-fastapi-mcp-0.4.0.drv`
...
- **Outputs**:
  - `dist`:  `/nix/store/cax8j7ha73a4bvrgsc5z94sgg8zpr7jf-python3.13-fastapi-mcp-0.4.0`
  - `out`:  `/nix/store/cax8j7ha73a4bvrgsc5z94sgg8zpr7jf-python3.13-fastapi-mcp-0.4.0`
