---
aliases:
  - androidenv.androidPkgs.all.system-images.v10.default.x86
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.system-images.v10.default.x86`
- **Version**: `10_r05.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/whq1clpsy8ngsshxc9k2pbl1i5h25knn-x86-10_r05.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/whq1clpsy8ngsshxc9k2pbl1i5h25knn-x86-10_r05.zip`
