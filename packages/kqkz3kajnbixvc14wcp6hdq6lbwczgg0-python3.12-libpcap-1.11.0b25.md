...
- **Name**: `python312Packages.libpcap`
- **Version**: `1.11.0b25`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Python binding for the libpcap C library
- **Homepage**: [https://github.com/karpierz/libpcap/](https://github.com/karpierz/libpcap/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/kqkz3kajnbixvc14wcp6hdq6lbwczgg0-python3.12-libpcap-1.11.0b25.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/libpcap/default.nix:55`
- **Outputs**:
  - `dist`:  `/nix/store/kqkz3kajnbixvc14wcp6hdq6lbwczgg0-python3.12-libpcap-1.11.0b25`
  - `out`:  `/nix/store/kqkz3kajnbixvc14wcp6hdq6lbwczgg0-python3.12-libpcap-1.11.0b25`
...
- [[876nvqlmvg13gq07mnpndcjfa7g3argn-libpcap-1.11.0b25.tar.gz]]
...
- [[y3884nksk02z2zi4pxm4g7m5y515bg6d-python3.12-pkg-about-2.0.1]]
