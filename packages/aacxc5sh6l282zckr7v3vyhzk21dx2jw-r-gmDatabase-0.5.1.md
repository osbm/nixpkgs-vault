...
- **Name**: `rPackages.gmDatabase`
- **Version**: `0.5.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/gmDatabase/](https://cran.r-project.org/web/packages/gmDatabase/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/aacxc5sh6l282zckr7v3vyhzk21dx2jw-r-gmDatabase-0.5.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/aacxc5sh6l282zckr7v3vyhzk21dx2jw-r-gmDatabase-0.5.1`

## 🔗 Dependencies

- [[8ydj9p6qp2zmasgn1kvyyx5ss6gh4hq5-r-digest-0.6.37]]
- [[bjsb6wdjykafnkixq156qdvmxhsm2bai-bash-5.3p3]]
- [[cz60ynzfkckc9y7qn9hdvc9dpvm002sl-gmDatabase_0.5.1.tar.gz]]
