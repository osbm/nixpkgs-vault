...
- **Name**: `python312Packages.pytest-mypy-plugins`
- **Version**: `3.2.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/bw51dwgsxpciiwja3gkqc3smlbyan8h0-python3.12-pytest-mypy-plugins-3.2.0.drv`
...
- **Outputs**:
  - `dist`:  `/nix/store/bw51dwgsxpciiwja3gkqc3smlbyan8h0-python3.12-pytest-mypy-plugins-3.2.0`
  - `out`:  `/nix/store/bw51dwgsxpciiwja3gkqc3smlbyan8h0-python3.12-pytest-mypy-plugins-3.2.0`
