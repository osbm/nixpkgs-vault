...
- **Name**: `haskellPackages.cairo`
- **Version**: `0.13.12.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Binding to the Cairo library
- **Homepage**: [https://hackage.haskell.org/package/cairo](https://hackage.haskell.org/package/cairo)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/7y7x1dz4g9w2wklyfidi2lq12zaiqmj6-cairo-0.13.12.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:127528`
- **Outputs**:
  - `data`:  `/nix/store/7y7x1dz4g9w2wklyfidi2lq12zaiqmj6-cairo-0.13.12.0`
  - `doc`:  `/nix/store/7y7x1dz4g9w2wklyfidi2lq12zaiqmj6-cairo-0.13.12.0`
  - `out`:  `/nix/store/7y7x1dz4g9w2wklyfidi2lq12zaiqmj6-cairo-0.13.12.0`
...
- [[zpdaqpxiv5lq71lq5kgb87mkq8lpwxqy-cairo-0.13.12.0.tar.gz]]
