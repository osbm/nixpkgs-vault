...
- **Name**: `python312Packages.renault-api`
- **Version**: `0.4.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Python library to interact with the Renault API
- **Homepage**: [https://github.com/hacf-fr/renault-api](https://github.com/hacf-fr/renault-api)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/i82lx0gazslqk3866d1wkq7xdimf5qv2-python3.12-renault-api-0.4.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/renault-api/default.nix:64`
- **Outputs**:
  - `dist`:  `/nix/store/i82lx0gazslqk3866d1wkq7xdimf5qv2-python3.12-renault-api-0.4.0`
  - `out`:  `/nix/store/i82lx0gazslqk3866d1wkq7xdimf5qv2-python3.12-renault-api-0.4.0`
...
- [[d6iaxkc8xmsk3b200q42baarggg6nc7f-source]]
...
- [[ksaw849m2mcxmfmc8a0ay3lvfynra6l2-python3.12-marshmallow-dataclass-8.7.1]]
