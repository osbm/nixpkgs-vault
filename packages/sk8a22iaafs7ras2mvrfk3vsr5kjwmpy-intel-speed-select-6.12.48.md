---
aliases:
  - linuxKernel.packages.linux_xanmod.intel-speed-select
tags:
  - broken
  - not-available
  - license/unknown
...
- **Name**: `linuxKernel.packages.linux_xanmod.intel-speed-select`
- **Version**: `6.12.48`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
...
- **Derivation Path**: `/nix/store/sk8a22iaafs7ras2mvrfk3vsr5kjwmpy-intel-speed-select-6.12.48.drv`
...
- **Outputs**:
  - `out`:  `/nix/store/sk8a22iaafs7ras2mvrfk3vsr5kjwmpy-intel-speed-select-6.12.48`
