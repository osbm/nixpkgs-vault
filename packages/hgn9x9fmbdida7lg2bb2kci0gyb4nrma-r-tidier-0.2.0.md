...
- **Name**: `rPackages.tidier`
- **Version**: `0.2.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/tidier/](https://cran.r-project.org/web/packages/tidier/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/hgn9x9fmbdida7lg2bb2kci0gyb4nrma-r-tidier-0.2.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/hgn9x9fmbdida7lg2bb2kci0gyb4nrma-r-tidier-0.2.0`

## 🔗 Dependencies

- [[3cw906d1s2azhax42sq23kvybixkwkai-tidier_0.2.0.tar.gz]]
