...
- **Name**: `rPackages.sdtm_oak`
- **Version**: `0.2.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/sdtm.oak/](https://cran.r-project.org/web/packages/sdtm.oak/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/gnfzbvbwq9bpyjkyfi0jszzfclnifpxr-r-sdtm.oak-0.2.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/gnfzbvbwq9bpyjkyfi0jszzfclnifpxr-r-sdtm.oak-0.2.0`
...
- [[zz1k57md0dxhm8iqv4i8h20hlnvxcpnm-sdtm.oak_0.2.0.tar.gz]]
