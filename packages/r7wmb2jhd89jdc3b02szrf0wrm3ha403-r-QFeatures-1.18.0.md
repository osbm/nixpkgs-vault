...
- **Name**: `rPackages.QFeatures`
- **Version**: `1.18.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://bioconductor.org/packages/3.21/bioc/html/QFeatures.html](https://bioconductor.org/packages/3.21/bioc/html/QFeatures.html)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/r7wmb2jhd89jdc3b02szrf0wrm3ha403-r-QFeatures-1.18.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/r7wmb2jhd89jdc3b02szrf0wrm3ha403-r-QFeatures-1.18.0`
...
- [[i9zaqzv3mx9s2nz45375nvfgif50j0yq-QFeatures_1.18.0.tar.gz]]
