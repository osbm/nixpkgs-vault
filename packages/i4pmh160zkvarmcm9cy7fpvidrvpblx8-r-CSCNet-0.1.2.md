...
- **Name**: `rPackages.CSCNet`
- **Version**: `0.1.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/CSCNet/](https://cran.r-project.org/web/packages/CSCNet/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/i4pmh160zkvarmcm9cy7fpvidrvpblx8-r-CSCNet-0.1.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/i4pmh160zkvarmcm9cy7fpvidrvpblx8-r-CSCNet-0.1.2`
...
- [[rnk4kkx87rwy5gmf4hcykplfic4kkg94-CSCNet_0.1.2.tar.gz]]
