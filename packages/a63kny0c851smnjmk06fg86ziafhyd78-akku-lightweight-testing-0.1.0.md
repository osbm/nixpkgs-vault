---
aliases:
  - akkuPackages.lightweight-testing
tags:
  - license/unknown
  - outputs/out
---
...
SRFI-78 implemented as a wrapper around (chibi test)

## 📋 Package Information

- **Name**: `akkuPackages.lightweight-testing`
- **Version**: `0.1.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/a63kny0c851smnjmk06fg86ziafhyd78-akku-lightweight-testing-0.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/tools/package-management/akku/default.nix:39`
- **Outputs**:
  - `out`:  `/nix/store/a63kny0c851smnjmk06fg86ziafhyd78-akku-lightweight-testing-0.1.0`

## 🔗 Dependencies

- [[12ikp89fb2wyf7fk7p0xwj9blzidw4j4-lightweight-testing-0.1.tgz]]
