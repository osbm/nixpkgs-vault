...
- **Name**: `haskellPackages.antiope-sns`
- **Version**: `7.5.3`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Please see the README on Github at <https://github.com/arbor/antiope#readme>
- **Homepage**: [https://hackage.haskell.org/package/antiope-sns](https://hackage.haskell.org/package/antiope-sns)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/ilvwm4s497b61pw3h11p1pvbdgprdr37-antiope-sns-7.5.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:77495`
- **Outputs**:
  - `doc`:  `/nix/store/ilvwm4s497b61pw3h11p1pvbdgprdr37-antiope-sns-7.5.3`
  - `out`:  `/nix/store/ilvwm4s497b61pw3h11p1pvbdgprdr37-antiope-sns-7.5.3`
...
- [[zf3kbzqp3rkaq9zghmhyjy3mv4b4j62a-antiope-sns-7.5.3.tar.gz]]
