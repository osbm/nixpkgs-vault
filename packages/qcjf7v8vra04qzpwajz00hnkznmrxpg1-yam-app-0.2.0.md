...
- **Name**: `haskellPackages.yam-app`
- **Version**: `0.2.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Yam App
- **Homepage**: [https://hackage.haskell.org/package/yam-app](https://hackage.haskell.org/package/yam-app)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/qcjf7v8vra04qzpwajz00hnkznmrxpg1-yam-app-0.2.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:735146`
- **Outputs**:
  - `doc`:  `/nix/store/qcjf7v8vra04qzpwajz00hnkznmrxpg1-yam-app-0.2.0`
  - `out`:  `/nix/store/qcjf7v8vra04qzpwajz00hnkznmrxpg1-yam-app-0.2.0`
...
- [[wscpwi2rhp89rwqzmdngmqn6s3kzddw2-yam-app-0.2.0.tar.gz]]
