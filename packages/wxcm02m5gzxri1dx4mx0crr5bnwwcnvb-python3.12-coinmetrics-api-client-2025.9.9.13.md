---
aliases:
  - python312Packages.coinmetrics-api-client
tags:
  - license/unknown
...
- **Name**: `python312Packages.coinmetrics-api-client`
- **Version**: `2025.9.9.13`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Coin Metrics API v4 client library
- **Homepage**: [https://coinmetrics.github.io/api-client-python/site/index.html](https://coinmetrics.github.io/api-client-python/site/index.html)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/wxcm02m5gzxri1dx4mx0crr5bnwwcnvb-python3.12-coinmetrics-api-client-2025.9.9.13.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/coinmetrics-api-client/default.nix:63`
- **Outputs**:
  - `dist`:  `/nix/store/wxcm02m5gzxri1dx4mx0crr5bnwwcnvb-python3.12-coinmetrics-api-client-2025.9.9.13`
  - `out`:  `/nix/store/wxcm02m5gzxri1dx4mx0crr5bnwwcnvb-python3.12-coinmetrics-api-client-2025.9.9.13`
...
- [[qxnqs7s2866j8vyq5c91gf2fiqs8lgj7-coinmetrics_api_client-2025.9.9.13.tar.gz]]
...
---
*Generated on 2025-09-27 12:07:54 UTC*
