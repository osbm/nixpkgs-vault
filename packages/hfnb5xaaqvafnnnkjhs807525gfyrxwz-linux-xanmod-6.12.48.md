...
- **Name**: `linuxKernel.kernels.linux_xanmod`
- **Version**: `6.12.48`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/hfnb5xaaqvafnnnkjhs807525gfyrxwz-linux-xanmod-6.12.48.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/kernel/xanmod-kernels.nix:39`
- **Outputs**:
  - `dev`:  `/nix/store/hfnb5xaaqvafnnnkjhs807525gfyrxwz-linux-xanmod-6.12.48`
  - `modules`:  `/nix/store/hfnb5xaaqvafnnnkjhs807525gfyrxwz-linux-xanmod-6.12.48`
  - `out`:  `/nix/store/hfnb5xaaqvafnnnkjhs807525gfyrxwz-linux-xanmod-6.12.48`
...
- [[93289lrr9wl4qn111h2w9fw62cz02ydn-linux-config-6.12.48]]
