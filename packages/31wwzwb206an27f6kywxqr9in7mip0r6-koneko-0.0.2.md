...
- **Name**: `haskellPackages.koneko`
- **Version**: `0.0.2`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: a concatenative not-quite-lisp for kittens
- **Homepage**: [https://hackage.haskell.org/package/koneko](https://hackage.haskell.org/package/koneko)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/31wwzwb206an27f6kywxqr9in7mip0r6-koneko-0.0.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:402380`
- **Outputs**:
  - `data`:  `/nix/store/31wwzwb206an27f6kywxqr9in7mip0r6-koneko-0.0.2`
  - `doc`:  `/nix/store/31wwzwb206an27f6kywxqr9in7mip0r6-koneko-0.0.2`
  - `out`:  `/nix/store/31wwzwb206an27f6kywxqr9in7mip0r6-koneko-0.0.2`
...
- [[r492an5j0vz8ff380jnrd1s7j18h9zn7-koneko-0.0.2.tar.gz]]
