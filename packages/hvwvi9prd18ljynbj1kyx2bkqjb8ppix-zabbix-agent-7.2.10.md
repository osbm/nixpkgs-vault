...
- **Derivation Path**: `/nix/store/hvwvi9prd18ljynbj1kyx2bkqjb8ppix-zabbix-agent-7.2.10.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/monitoring/zabbix/agent.nix:49`
- **Outputs**:
  - `out`:  `/nix/store/hvwvi9prd18ljynbj1kyx2bkqjb8ppix-zabbix-agent-7.2.10`
