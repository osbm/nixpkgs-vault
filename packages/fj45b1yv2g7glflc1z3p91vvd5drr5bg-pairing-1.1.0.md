...
- **Name**: `haskellPackages.pairing`
- **Version**: `1.1.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Bilinear pairings
- **Homepage**: [https://hackage.haskell.org/package/pairing](https://hackage.haskell.org/package/pairing)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/fj45b1yv2g7glflc1z3p91vvd5drr5bg-pairing-1.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:499481`
- **Outputs**:
  - `doc`:  `/nix/store/fj45b1yv2g7glflc1z3p91vvd5drr5bg-pairing-1.1.0`
  - `out`:  `/nix/store/fj45b1yv2g7glflc1z3p91vvd5drr5bg-pairing-1.1.0`
...
- [[7hf5gqr4m75vvxixhi74v0ng6mcc2n6w-pairing-1.1.0.tar.gz]]
