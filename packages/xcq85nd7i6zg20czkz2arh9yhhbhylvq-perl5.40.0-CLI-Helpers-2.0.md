...
- **Name**: `perl540Packages.CLIHelpers`
- **Version**: `2.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/xcq85nd7i6zg20czkz2arh9yhhbhylvq-perl5.40.0-CLI-Helpers-2.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/top-level/perl-packages.nix:5506`
- **Outputs**:
  - `devdoc`:  `/nix/store/xcq85nd7i6zg20czkz2arh9yhhbhylvq-perl5.40.0-CLI-Helpers-2.0`
  - `out`:  `/nix/store/xcq85nd7i6zg20czkz2arh9yhhbhylvq-perl5.40.0-CLI-Helpers-2.0`
