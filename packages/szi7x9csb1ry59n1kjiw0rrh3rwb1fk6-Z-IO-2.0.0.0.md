...
- **Name**: `haskellPackages.Z-IO`
- **Version**: `2.0.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Simple and high performance IO toolkit for Haskell
- **Homepage**: [https://hackage.haskell.org/package/Z-IO](https://hackage.haskell.org/package/Z-IO)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/szi7x9csb1ry59n1kjiw0rrh3rwb1fk6-Z-IO-2.0.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:48490`
- **Outputs**:
  - `doc`:  `/nix/store/szi7x9csb1ry59n1kjiw0rrh3rwb1fk6-Z-IO-2.0.0.0`
  - `out`:  `/nix/store/szi7x9csb1ry59n1kjiw0rrh3rwb1fk6-Z-IO-2.0.0.0`
...
- [[va7fh1gvgghadw6mh20dsa22jhwqrhxr-Z-IO-2.0.0.0.tar.gz]]
