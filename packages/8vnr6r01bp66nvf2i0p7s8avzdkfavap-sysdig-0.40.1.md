...
- **Name**: `linuxKernel.packages.linux_5_10.sysdig`
- **Version**: `0.40.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/8vnr6r01bp66nvf2i0p7s8avzdkfavap-sysdig-0.40.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/sysdig/default.nix:182`
- **Outputs**:
  - `out`:  `/nix/store/8vnr6r01bp66nvf2i0p7s8avzdkfavap-sysdig-0.40.1`
