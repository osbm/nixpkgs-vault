---
aliases:
  - androidenv.androidPkgs.all.packages.cmdline-tools.v11_0
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.packages.cmdline-tools.v11_0`
- **Version**: `10406996_latest.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/fklz0x7h5vp3n2dxsyhlqmi7w5dapcn9-commandlinetools-linux-10406996_latest.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/fklz0x7h5vp3n2dxsyhlqmi7w5dapcn9-commandlinetools-linux-10406996_latest.zip`
