...
- **Name**: `haskellPackages.Deadpan-DDP`
- **Version**: `0.9.6.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Write clients for Meteor's DDP Protocol
- **Homepage**: [https://hackage.haskell.org/package/Deadpan-DDP](https://hackage.haskell.org/package/Deadpan-DDP)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/vrpk3ss0n8krs06crwsdxlda6flbgcjd-Deadpan-DDP-0.9.6.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:9772`
- **Outputs**:
  - `doc`:  `/nix/store/vrpk3ss0n8krs06crwsdxlda6flbgcjd-Deadpan-DDP-0.9.6.0`
  - `out`:  `/nix/store/vrpk3ss0n8krs06crwsdxlda6flbgcjd-Deadpan-DDP-0.9.6.0`
...
- [[7i4dbjkm6zs9vbgy84815h82wx70v4nb-Deadpan-DDP-0.9.6.0.tar.gz]]
