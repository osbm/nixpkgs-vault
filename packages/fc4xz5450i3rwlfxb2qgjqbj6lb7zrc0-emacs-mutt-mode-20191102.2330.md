...
- **Name**: `emacsPackages.mutt-mode`
- **Version**: `20191102.2330`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://gitlab.com/flexw/mutt-mode/](https://gitlab.com/flexw/mutt-mode/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/fc4xz5450i3rwlfxb2qgjqbj6lb7zrc0-emacs-mutt-mode-20191102.2330.drv`
...
- **Outputs**:
  - `out`:  `/nix/store/fc4xz5450i3rwlfxb2qgjqbj6lb7zrc0-emacs-mutt-mode-20191102.2330`

## 🔗 Dependencies

- [[1x36lgymb004fl3l0y9rpdv445ydlm6c-mutt-mode-recipe]]
- [[3n4wbiwgywi0zbzl8cfcfn64xxwn9ww6-source]]
