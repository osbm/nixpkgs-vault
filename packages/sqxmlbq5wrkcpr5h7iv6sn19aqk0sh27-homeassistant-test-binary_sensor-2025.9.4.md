---
aliases:
  - home-assistant-component-tests.binary_sensor
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.binary_sensor`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/sqxmlbq5wrkcpr5h7iv6sn19aqk0sh27-homeassistant-test-binary_sensor-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/sqxmlbq5wrkcpr5h7iv6sn19aqk0sh27-homeassistant-test-binary_sensor-2025.9.4`
