...
- **Homepage**: [https://github.com/jtroo/kanata](https://github.com/jtroo/kanata)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/xp0nsmrmdlb45kdjmk10741cp5lb64y8-kanata-1.9.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/ka/kanata/package.nix:53`
- **Outputs**:
  - `out`:  `/nix/store/xp0nsmrmdlb45kdjmk10741cp5lb64y8-kanata-1.9.0`
...
- [[rvyj7qgr8sj3nq2ibvwr1rv2n9plj4v7-source]]
- [[s7n5vhi0jiijq6c2d9sh30mxqhl999nb-kanata-1.9.0-vendor]]
