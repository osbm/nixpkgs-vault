...
- **Name**: `haskellPackages.myxine-client`
- **Version**: `0.0.1.2`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: A Haskell client for the Myxine GUI server
- **Homepage**: [https://hackage.haskell.org/package/myxine-client](https://hackage.haskell.org/package/myxine-client)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/hnprrpcz45fi0ni7f3cgcgmrnjczhf0m-myxine-client-0.0.1.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:469335`
- **Outputs**:
  - `doc`:  `/nix/store/hnprrpcz45fi0ni7f3cgcgmrnjczhf0m-myxine-client-0.0.1.2`
  - `out`:  `/nix/store/hnprrpcz45fi0ni7f3cgcgmrnjczhf0m-myxine-client-0.0.1.2`

## 🔗 Dependencies

- [[0nmal0bd7l16qimn9d0rkbs8d0dqm27s-some-1.0.6]]
- [[2pr652igq6awvbbf5rfnb3kbrmg1cryf-http-types-0.12.4]]
- [[351p210f57zr4wi79bl385xhgj5lmn7z-myxine-client-0.0.1.2.tar.gz]]
...
- [[y0v3fzsaaacgrlj33dg2c4zpq7wqvp6k-salve-2.0.0.8]]
