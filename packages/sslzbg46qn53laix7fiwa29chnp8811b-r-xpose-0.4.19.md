...
- **Name**: `rPackages.xpose`
- **Version**: `0.4.19`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/xpose/](https://cran.r-project.org/web/packages/xpose/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/sslzbg46qn53laix7fiwa29chnp8811b-r-xpose-0.4.19.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/sslzbg46qn53laix7fiwa29chnp8811b-r-xpose-0.4.19`

## 🔗 Dependencies

- [[0s88wyn9by42lvph7am0mhlrxcml835w-xpose_0.4.19.tar.gz]]
