---
aliases:
  - linuxKernel.packages.linux_5_4.cpupower
tags:
  - license/unknown
  - outputs/out
---
...
- **Name**: `linuxKernel.packages.linux_5_4.cpupower`
- **Version**: `5.4.299`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/qrhrmly3i5879a33zmygz2k1riyz4lsj-cpupower-5.4.299.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/cpupower/default.nix:51`
- **Outputs**:
  - `out`:  `/nix/store/qrhrmly3i5879a33zmygz2k1riyz4lsj-cpupower-5.4.299`
...
- `/nix/store/2lr5rrl7ipi8yf0vw8bacqxv1xaw7gph-rtl8761b-support.patch`
