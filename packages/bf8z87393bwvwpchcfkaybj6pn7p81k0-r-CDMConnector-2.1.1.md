...
- **Name**: `rPackages.CDMConnector`
- **Version**: `2.1.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/CDMConnector/](https://cran.r-project.org/web/packages/CDMConnector/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/bf8z87393bwvwpchcfkaybj6pn7p81k0-r-CDMConnector-2.1.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/bf8z87393bwvwpchcfkaybj6pn7p81k0-r-CDMConnector-2.1.1`
...
- [[rw25wcdysbccd97015jf3lhg486wgpd8-CDMConnector_2.1.1.tar.gz]]
