...
- **Name**: `haskellPackages.zbar`
- **Version**: `0.2.0.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: zbar bindings in Haskell
- **Homepage**: [https://hackage.haskell.org/package/zbar](https://hackage.haskell.org/package/zbar)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/nbnsffddl9wylrkyq6029b4dn4nykx7k-zbar-0.2.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:745994`
- **Outputs**:
  - `doc`:  `/nix/store/nbnsffddl9wylrkyq6029b4dn4nykx7k-zbar-0.2.0.0`
  - `out`:  `/nix/store/nbnsffddl9wylrkyq6029b4dn4nykx7k-zbar-0.2.0.0`
...
- [[yxk4nw0plm7lk9cnls4sa40b6npy5y8l-zbar-0.2.0.0.tar.gz]]
