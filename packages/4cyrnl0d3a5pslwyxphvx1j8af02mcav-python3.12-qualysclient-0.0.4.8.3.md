---
aliases:
  - python312Packages.qualysclient
tags:
  - license/unknown
  - maintainers/fabaff
  - outputs/dist
...
- **Name**: `python312Packages.qualysclient`
- **Version**: `0.0.4.8.3`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/4cyrnl0d3a5pslwyxphvx1j8af02mcav-python3.12-qualysclient-0.0.4.8.3.drv`
...
- **Outputs**:
  - `dist`:  `/nix/store/4cyrnl0d3a5pslwyxphvx1j8af02mcav-python3.12-qualysclient-0.0.4.8.3`
  - `out`:  `/nix/store/4cyrnl0d3a5pslwyxphvx1j8af02mcav-python3.12-qualysclient-0.0.4.8.3`
