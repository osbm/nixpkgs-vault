---
aliases:
  - haskellPackages.consul-haskell
tags:
  - broken
  - not-available
  - license/unknown
...
- **Name**: `haskellPackages.consul-haskell`
- **Version**: `0.5.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: A consul client for Haskell
- **Homepage**: [https://hackage.haskell.org/package/consul-haskell](https://hackage.haskell.org/package/consul-haskell)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/w8nw2a37sg263xz6wdjcci1bid1vikpd-consul-haskell-0.5.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:160113`
- **Outputs**:
  - `doc`:  `/nix/store/w8nw2a37sg263xz6wdjcci1bid1vikpd-consul-haskell-0.5.0`
  - `out`:  `/nix/store/w8nw2a37sg263xz6wdjcci1bid1vikpd-consul-haskell-0.5.0`
...
- [[gikgnss109l3qqd0yipbsnxm7x9hxkh6-consul-haskell-0.5.0.tar.gz]]
