...
- **Name**: `haskellPackages.sdl2-image`
- **Version**: `2.1.0.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Haskell bindings to SDL2_image
- **Homepage**: [https://hackage.haskell.org/package/sdl2-image](https://hackage.haskell.org/package/sdl2-image)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/sg7y3wavpdv0nvl984xzq23f77wfk3ps-sdl2-image-2.1.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:590962`
- **Outputs**:
  - `doc`:  `/nix/store/sg7y3wavpdv0nvl984xzq23f77wfk3ps-sdl2-image-2.1.0.0`
  - `out`:  `/nix/store/sg7y3wavpdv0nvl984xzq23f77wfk3ps-sdl2-image-2.1.0.0`
...
- [[yq9civmlccswcvp7vv3jpg9q31l9bjn0-sdl2-image-2.1.0.0.tar.gz]]
