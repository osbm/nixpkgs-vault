...
- **Name**: `python313Packages.phik`
- **Version**: `0.12.5`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Phi_K correlation analyzer library
- **Homepage**: [https://phik.readthedocs.io/](https://phik.readthedocs.io/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/7ji2ffbg94hhvyysyd0mhar8a34ng83y-python3.13-phik-0.12.5.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/phik/default.nix:64`
- **Outputs**:
  - `dist`:  `/nix/store/7ji2ffbg94hhvyysyd0mhar8a34ng83y-python3.13-phik-0.12.5`
  - `out`:  `/nix/store/7ji2ffbg94hhvyysyd0mhar8a34ng83y-python3.13-phik-0.12.5`
...
- [[740pknwhmsr8w5p2bv3nlkrgm0iv8q3l-source]]
