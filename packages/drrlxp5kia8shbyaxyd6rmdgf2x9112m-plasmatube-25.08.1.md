...
- **Name**: `kdePackages.plasmatube`
- **Version**: `25.08.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Kirigami YouTube video player based on QtMultimedia and youtube-dl
- **Homepage**: [https://invent.kde.org/multimedia/plasmatube](https://invent.kde.org/multimedia/plasmatube)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/drrlxp5kia8shbyaxyd6rmdgf2x9112m-plasmatube-25.08.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/kde/gear/plasmatube/default.nix:11`
- **Outputs**:
  - `debug`:  `/nix/store/drrlxp5kia8shbyaxyd6rmdgf2x9112m-plasmatube-25.08.1`
  - `dev`:  `/nix/store/drrlxp5kia8shbyaxyd6rmdgf2x9112m-plasmatube-25.08.1`
  - `devtools`:  `/nix/store/drrlxp5kia8shbyaxyd6rmdgf2x9112m-plasmatube-25.08.1`
  - `out`:  `/nix/store/drrlxp5kia8shbyaxyd6rmdgf2x9112m-plasmatube-25.08.1`
...
- [[w07f42pckswbbcdw1bmpsaqma18g24g4-plasmatube-25.08.1.tar.xz]]
