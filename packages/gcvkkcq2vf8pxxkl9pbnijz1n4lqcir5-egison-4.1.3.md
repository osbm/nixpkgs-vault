...
- **Name**: `haskellPackages.egison`
- **Version**: `4.1.3`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Programming language with non-linear pattern-matching against non-free data
- **Homepage**: [https://hackage.haskell.org/package/egison](https://hackage.haskell.org/package/egison)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/gcvkkcq2vf8pxxkl9pbnijz1n4lqcir5-egison-4.1.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:210373`
- **Outputs**:
  - `data`:  `/nix/store/gcvkkcq2vf8pxxkl9pbnijz1n4lqcir5-egison-4.1.3`
  - `doc`:  `/nix/store/gcvkkcq2vf8pxxkl9pbnijz1n4lqcir5-egison-4.1.3`
  - `out`:  `/nix/store/gcvkkcq2vf8pxxkl9pbnijz1n4lqcir5-egison-4.1.3`
...
- [[iygksdzqs4d75p0j1ja3psxaqydkzy5d-sweet-egison-0.1.1.3]]
...
- [[pncx0wyivmhf48xqdwx4rlvrclcd0r49-egison-4.1.3.tar.gz]]
