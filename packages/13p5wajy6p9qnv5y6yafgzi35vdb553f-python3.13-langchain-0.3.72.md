...
- **Name**: `python313Packages.langchain`
- **Version**: `0.3.72`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/13p5wajy6p9qnv5y6yafgzi35vdb553f-python3.13-langchain-0.3.72.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/langchain/default.nix:160`
- **Outputs**:
  - `dist`:  `/nix/store/13p5wajy6p9qnv5y6yafgzi35vdb553f-python3.13-langchain-0.3.72`
  - `out`:  `/nix/store/13p5wajy6p9qnv5y6yafgzi35vdb553f-python3.13-langchain-0.3.72`
...
- [[6g4smvxfynyx1f19h67v6d8vksqwa77g-source]]
...
- [[k6d07v1r5kc0jz23wxpplgm6p89h881z-python3.13-langchain-text-splitters-0.3.11]]
