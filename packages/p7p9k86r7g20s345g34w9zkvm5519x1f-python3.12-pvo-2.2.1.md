...
- **Name**: `python312Packages.pvo`
- **Version**: `2.2.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Python module to interact with the PVOutput API
- **Homepage**: [https://github.com/frenck/python-pvoutput](https://github.com/frenck/python-pvoutput)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/p7p9k86r7g20s345g34w9zkvm5519x1f-python3.12-pvo-2.2.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/pvo/default.nix:56`
- **Outputs**:
  - `dist`:  `/nix/store/p7p9k86r7g20s345g34w9zkvm5519x1f-python3.12-pvo-2.2.1`
  - `out`:  `/nix/store/p7p9k86r7g20s345g34w9zkvm5519x1f-python3.12-pvo-2.2.1`
...
- [[vr2wyxjj5nx3z6kpcwv179zhd1wns1x8-source]]
