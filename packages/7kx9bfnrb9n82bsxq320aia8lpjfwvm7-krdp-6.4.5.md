...
- **Name**: `kdePackages.krdp`
- **Version**: `6.4.5`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Library and examples for creating an RDP server.
- **Homepage**: [https://invent.kde.org/plasma/krdp](https://invent.kde.org/plasma/krdp)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/7kx9bfnrb9n82bsxq320aia8lpjfwvm7-krdp-6.4.5.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/kde/plasma/krdp/default.nix:11`
- **Outputs**:
  - `debug`:  `/nix/store/7kx9bfnrb9n82bsxq320aia8lpjfwvm7-krdp-6.4.5`
  - `dev`:  `/nix/store/7kx9bfnrb9n82bsxq320aia8lpjfwvm7-krdp-6.4.5`
  - `devtools`:  `/nix/store/7kx9bfnrb9n82bsxq320aia8lpjfwvm7-krdp-6.4.5`
  - `out`:  `/nix/store/7kx9bfnrb9n82bsxq320aia8lpjfwvm7-krdp-6.4.5`
...
- [[fcrg8ip33l96mpc9w5zi7l0r8s697nqi-hardcode-openssl-path.patch]]
- [[i64fh03ivds4cnp6sfbpx8532sazidha-ninja-1.13.1]]
- [[ibjx4fb6iqplf03nis4gnwq3yji7h5j7-wrap-qt6-apps-hook]]
- [[lvdvlk7cwad5mna0wfpz8jllb30jdj1n-pkg-config-wrapper-0.29.2]]
- [[mjjln2kwvy9qvmsv1j6d7n24bkjph03r-krdp-6.4.5.tar.xz]]
