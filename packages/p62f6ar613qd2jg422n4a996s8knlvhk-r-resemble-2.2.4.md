...
- **Name**: `rPackages.resemble`
- **Version**: `2.2.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/resemble/](https://cran.r-project.org/web/packages/resemble/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/p62f6ar613qd2jg422n4a996s8knlvhk-r-resemble-2.2.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/p62f6ar613qd2jg422n4a996s8knlvhk-r-resemble-2.2.4`
...
- [[h5kadkjwwz5x8a7m9mwpgbzdvcnlil2v-resemble_2.2.4.tar.gz]]
