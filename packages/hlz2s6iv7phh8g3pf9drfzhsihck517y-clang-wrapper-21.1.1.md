---
aliases:
  - llvmPackages_21.clangNoCompilerRt
tags:
  - license/unknown
  - maintainers/dtzWill
  - maintainers/emilazy
...
- **Name**: `llvmPackages_21.clangNoCompilerRt`
- **Version**: `21.1.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/hlz2s6iv7phh8g3pf9drfzhsihck517y-clang-wrapper-21.1.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/build-support/cc-wrapper/default.nix:989`
- **Outputs**:
  - `out`:  `/nix/store/hlz2s6iv7phh8g3pf9drfzhsihck517y-clang-wrapper-21.1.1`
