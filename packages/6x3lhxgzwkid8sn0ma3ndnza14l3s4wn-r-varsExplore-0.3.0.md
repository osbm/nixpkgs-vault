...
- **Name**: `rPackages.varsExplore`
- **Version**: `0.3.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://cran.r-project.org/web/packages/varsExplore/](https://cran.r-project.org/web/packages/varsExplore/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/6x3lhxgzwkid8sn0ma3ndnza14l3s4wn-r-varsExplore-0.3.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/6x3lhxgzwkid8sn0ma3ndnza14l3s4wn-r-varsExplore-0.3.0`
...
- [[l4c2a4h7g80hac4ar01rjiyi0xnlba3c-varsExplore_0.3.0.tar.gz]]
