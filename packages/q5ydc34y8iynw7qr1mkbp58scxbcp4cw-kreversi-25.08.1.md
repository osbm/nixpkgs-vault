...
- **Name**: `kdePackages.kreversi`
- **Version**: `25.08.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: KReversi is is a simple one player strategy game played against the computer
- **Homepage**: [https://invent.kde.org/games/kreversi](https://invent.kde.org/games/kreversi)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/q5ydc34y8iynw7qr1mkbp58scxbcp4cw-kreversi-25.08.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/kde/gear/kreversi/default.nix:7`
- **Outputs**:
  - `debug`:  `/nix/store/q5ydc34y8iynw7qr1mkbp58scxbcp4cw-kreversi-25.08.1`
  - `dev`:  `/nix/store/q5ydc34y8iynw7qr1mkbp58scxbcp4cw-kreversi-25.08.1`
  - `devtools`:  `/nix/store/q5ydc34y8iynw7qr1mkbp58scxbcp4cw-kreversi-25.08.1`
  - `out`:  `/nix/store/q5ydc34y8iynw7qr1mkbp58scxbcp4cw-kreversi-25.08.1`

## 🔗 Dependencies

- [[14mzxvhz59akw7mihyx1y3x7aiilnh0z-kreversi-25.08.1.tar.xz]]
