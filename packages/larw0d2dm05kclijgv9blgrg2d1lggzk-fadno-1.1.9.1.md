...
- **Name**: `haskellPackages.fadno`
- **Version**: `1.1.9.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Minimal library for music generation and notation
- **Homepage**: [https://hackage.haskell.org/package/fadno](https://hackage.haskell.org/package/fadno)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/larw0d2dm05kclijgv9blgrg2d1lggzk-fadno-1.1.9.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:226594`
- **Outputs**:
  - `doc`:  `/nix/store/larw0d2dm05kclijgv9blgrg2d1lggzk-fadno-1.1.9.1`
  - `out`:  `/nix/store/larw0d2dm05kclijgv9blgrg2d1lggzk-fadno-1.1.9.1`
...
- [[nj4dfnaad6w3yyy5kyc8x7lfvsy10v95-fadno-1.1.9.1.tar.gz]]
...
- [[svdhphmwc38kyrar9dv9vghqq1s5qb3z-fadno-xml-1.2.1]]
