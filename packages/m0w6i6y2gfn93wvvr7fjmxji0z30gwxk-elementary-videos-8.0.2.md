...
- **Name**: `pantheon.elementary-videos`
- **Version**: `8.0.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Video player and library app designed for elementary OS
- **Homepage**: [https://github.com/elementary/videos](https://github.com/elementary/videos)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/m0w6i6y2gfn93wvvr7fjmxji0z30gwxk-elementary-videos-8.0.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/desktops/pantheon/apps/elementary-videos/default.nix:59`
- **Outputs**:
  - `out`:  `/nix/store/m0w6i6y2gfn93wvvr7fjmxji0z30gwxk-elementary-videos-8.0.2`

## 🔗 Dependencies

- [[3is70z08f23q0nlhxw36kbfvz4jh88cr-source]]
