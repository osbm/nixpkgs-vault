...
- **Name**: `haskellPackages.glib`
- **Version**: `0.13.12.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Binding to the GLIB library for Gtk2Hs
- **Homepage**: [https://hackage.haskell.org/package/glib](https://hackage.haskell.org/package/glib)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/m1vz2wi7sdj2x0bzkfb7rmdx8zwlxrks-glib-0.13.12.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:272662`
- **Outputs**:
  - `doc`:  `/nix/store/m1vz2wi7sdj2x0bzkfb7rmdx8zwlxrks-glib-0.13.12.0`
  - `out`:  `/nix/store/m1vz2wi7sdj2x0bzkfb7rmdx8zwlxrks-glib-0.13.12.0`
...
- [[lj3ckq7a8vyap3isa0mginvr9a15lnvr-glib-0.13.12.0.tar.gz]]
