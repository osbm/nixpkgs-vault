...
- **Name**: `haskellPackages.ConClusion`
- **Version**: `0.2.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Cluster algorithms, PCA, and chemical conformere analysis
- **Homepage**: [https://hackage.haskell.org/package/ConClusion](https://hackage.haskell.org/package/ConClusion)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/5z4l8x7hiplgl3b0hchfc88cpzd3m46r-ConClusion-0.2.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:7760`
- **Outputs**:
  - `doc`:  `/nix/store/5z4l8x7hiplgl3b0hchfc88cpzd3m46r-ConClusion-0.2.2`
  - `out`:  `/nix/store/5z4l8x7hiplgl3b0hchfc88cpzd3m46r-ConClusion-0.2.2`
...
- [[9kf8jjbm4c6k2qhjli97fipq45pw0jw4-ConClusion-0.2.2.tar.gz]]
