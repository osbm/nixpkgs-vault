...
- **Name**: `python313Packages.pulumi-command`
- **Version**: `0.9.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/192fg353dp0649dv2vk6kxmilk10g6yi-python3.13-pulumi-command-0.9.0.drv`
...
- **Outputs**:
  - `dist`:  `/nix/store/192fg353dp0649dv2vk6kxmilk10g6yi-python3.13-pulumi-command-0.9.0`
  - `out`:  `/nix/store/192fg353dp0649dv2vk6kxmilk10g6yi-python3.13-pulumi-command-0.9.0`
