...
- **Name**: `mysql-shell-innovation`
- **Version**: `9.4.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: New command line scriptable shell for MySQL
- **Homepage**: [https://dev.mysql.com/doc/mysql-shell/9.4/en/](https://dev.mysql.com/doc/mysql-shell/9.4/en/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/j577rfabl5lg64iv1api4xqygimr4yqw-mysql-shell-innovation-9.4.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/tools/mysql-shell/innovation.nix:147`
- **Outputs**:
  - `out`:  `/nix/store/j577rfabl5lg64iv1api4xqygimr4yqw-mysql-shell-innovation-9.4.0`
...
- [[7wjji18752y0a48kn05djqlnny70chx9-protobuf-25.8]]
- [[84j2hb7bla3l8a2y4m0p75qi83zj8rzw-python3.13-paramiko-4.0.0]]
- [[8rgz3781yw1gmfkj3lg2z5pn1y5k855h-lz4-1.10.0]]
- [[9j8w4bcicjkza42lizkrrx7sb6jw2qik-cmake-3.31.7]]
- [[ap65r3906858k58jisl8qphg092ywhkp-zstd-1.5.7]]
- [[bjsb6wdjykafnkixq156qdvmxhsm2bai-bash-5.3p3]]
- [[dk4nswf4g8nwmzgkfik8ybmdp22iqal2-antlr-runtime-cpp-4.10.1]]
...
- [[n0iqpwgw5ii76lam6s13idr4i4dnqnxv-mysql-shell-9.4.0-src.tar.gz]]
- [[nh9x7rf79s9w0aj3n6v2ffhk6hldmhql-mysql-9.4.0.tar.gz]]
...
- `/nix/store/nim4f63xspxc0c36ljy6qyzkwfn4w4ap-no-openssl-bundling.patch`
