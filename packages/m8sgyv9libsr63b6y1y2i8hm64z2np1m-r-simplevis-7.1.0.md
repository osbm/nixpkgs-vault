...
- **Name**: `rPackages.simplevis`
- **Version**: `7.1.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://cran.r-project.org/web/packages/simplevis/](https://cran.r-project.org/web/packages/simplevis/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/m8sgyv9libsr63b6y1y2i8hm64z2np1m-r-simplevis-7.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/m8sgyv9libsr63b6y1y2i8hm64z2np1m-r-simplevis-7.1.0`
...
- [[fgw2zd2rjhlc05l8qhc0n719qablair4-simplevis_7.1.0.tar.gz]]
