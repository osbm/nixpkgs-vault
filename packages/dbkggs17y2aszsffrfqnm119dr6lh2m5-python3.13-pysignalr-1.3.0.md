...
- **Name**: `python313Packages.pysignalr`
- **Version**: `1.3.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Modern, reliable and async-ready client for SignalR protocol
- **Homepage**: [https://github.com/baking-bad/pysignalr](https://github.com/baking-bad/pysignalr)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/dbkggs17y2aszsffrfqnm119dr6lh2m5-python3.13-pysignalr-1.3.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/pysignalr/default.nix:48`
- **Outputs**:
  - `dist`:  `/nix/store/dbkggs17y2aszsffrfqnm119dr6lh2m5-python3.13-pysignalr-1.3.0`
  - `out`:  `/nix/store/dbkggs17y2aszsffrfqnm119dr6lh2m5-python3.13-pysignalr-1.3.0`
...
- [[h03lbz1my0k4658iys2vwc9qwd3xjb10-source]]
