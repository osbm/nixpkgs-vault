...
- **Name**: `haskellPackages.hledger-stockquotes`
- **Version**: `0.1.3.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Generate HLedger Price Directives From Daily Stock Quotes
- **Homepage**: [https://hackage.haskell.org/package/hledger-stockquotes](https://hackage.haskell.org/package/hledger-stockquotes)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/6ysila44bwkhwd5f918wrzjx2hdq7j44-hledger-stockquotes-0.1.3.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:332402`
- **Outputs**:
  - `doc`:  `/nix/store/6ysila44bwkhwd5f918wrzjx2hdq7j44-hledger-stockquotes-0.1.3.2`
  - `out`:  `/nix/store/6ysila44bwkhwd5f918wrzjx2hdq7j44-hledger-stockquotes-0.1.3.2`
...
- [[bv8sc6a551a4l2q24gx01prp32zs9m0r-hledger-stockquotes-0.1.3.2.tar.gz]]
