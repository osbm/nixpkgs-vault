---
aliases:
  - linuxKernel.packages.linux_xanmod.chipsec
tags:
  - license/unknown
...
- **Name**: `linuxKernel.packages.linux_xanmod.chipsec`
- **Version**: `1.10.6`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/gzxld7mlb72lzjvhj1rrsrd3m90yppc2-chipsec-1.10.6.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/tools/security/chipsec/default.nix:77`
- **Outputs**:
  - `dist`:  `/nix/store/gzxld7mlb72lzjvhj1rrsrd3m90yppc2-chipsec-1.10.6`
  - `out`:  `/nix/store/gzxld7mlb72lzjvhj1rrsrd3m90yppc2-chipsec-1.10.6`
