---
aliases:
  - home-assistant-component-tests.p1_monitor
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.p1_monitor`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/94qmb3fnmwli2m4qcxvx0r2x02kawskq-homeassistant-test-p1_monitor-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/94qmb3fnmwli2m4qcxvx0r2x02kawskq-homeassistant-test-p1_monitor-2025.9.4`
...
- [[v5965bgsq3h6w23kha2q9znys5sykqxc-python3.13-p1monitor-3.2.0]]
