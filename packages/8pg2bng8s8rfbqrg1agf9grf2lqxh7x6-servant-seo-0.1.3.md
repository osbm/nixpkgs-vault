...
- **Name**: `haskellPackages.servant-seo`
- **Version**: `0.1.3`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Generate Robots.txt and Sitemap.xml specification for your servant API.
- **Homepage**: [https://hackage.haskell.org/package/servant-seo](https://hackage.haskell.org/package/servant-seo)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/8pg2bng8s8rfbqrg1agf9grf2lqxh7x6-servant-seo-0.1.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:601351`
- **Outputs**:
  - `doc`:  `/nix/store/8pg2bng8s8rfbqrg1agf9grf2lqxh7x6-servant-seo-0.1.3`
  - `out`:  `/nix/store/8pg2bng8s8rfbqrg1agf9grf2lqxh7x6-servant-seo-0.1.3`
...
- [[d4x19aw5vw71i6bmggpaxdbgzzfmb32d-servant-seo-0.1.3.tar.gz]]
