...
A simple logging library for outputting messages while a program is running

## 📋 Package Information

- **Name**: `akkuPackages.robin-logger`
- **Version**: `1.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: A simple logging library for outputting messages while a program is running
- **Homepage**: []()
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/97c7lnwzara8w38619lwwsl6vl3hzbvc-akku-robin-logger-1.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/tools/package-management/akku/default.nix:39`
- **Outputs**:
  - `out`:  `/nix/store/97c7lnwzara8w38619lwwsl6vl3hzbvc-akku-robin-logger-1.0.0`
...
- [[lcrhjl0j1kfx6ldzhhb8g992m42054ib-robin-logger-1.0.0.tgz]]
