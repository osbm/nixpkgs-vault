---
aliases:
  - haskellPackages.moffy-samples-gtk3-run
tags:
  - broken
  - not-available
  - license/unknown
...
- **Name**: `haskellPackages.moffy-samples-gtk3-run`
- **Version**: `0.1.0.7`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Package to run moffy samples - GTK3 version
- **Homepage**: [https://hackage.haskell.org/package/moffy-samples-gtk3-run](https://hackage.haskell.org/package/moffy-samples-gtk3-run)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/ry6zy4ww2687s3phij673i7bz3zjyk5q-moffy-samples-gtk3-run-0.1.0.7.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:453217`
- **Outputs**:
  - `doc`:  `/nix/store/ry6zy4ww2687s3phij673i7bz3zjyk5q-moffy-samples-gtk3-run-0.1.0.7`
  - `out`:  `/nix/store/ry6zy4ww2687s3phij673i7bz3zjyk5q-moffy-samples-gtk3-run-0.1.0.7`
...
- [[hahgbzzmqh97grbmnqmsszapqafbxza9-moffy-samples-gtk3-run-0.1.0.7.tar.gz]]
