---
aliases:
  - haskellPackages.hls-stan-plugin
tags:
  - broken
  - not-available
  - license/unknown
...
- **Name**: `haskellPackages.hls-stan-plugin`
- **Version**: `2.6.0.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Stan integration plugin with Haskell Language Server
- **Homepage**: [https://hackage.haskell.org/package/hls-stan-plugin](https://hackage.haskell.org/package/hls-stan-plugin)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/7q34r1w2pwzd7j5zxmr3fanliaqnqakz-hls-stan-plugin-2.6.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:335075`
- **Outputs**:
  - `doc`:  `/nix/store/7q34r1w2pwzd7j5zxmr3fanliaqnqakz-hls-stan-plugin-2.6.0.0`
  - `out`:  `/nix/store/7q34r1w2pwzd7j5zxmr3fanliaqnqakz-hls-stan-plugin-2.6.0.0`
...
- [[lisdy219ppl0f0c6q5835g0p8kn89mqf-hls-stan-plugin-2.6.0.0.tar.gz]]
