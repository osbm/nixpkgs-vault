...
- **Name**: `haskellPackages.testbench`
- **Version**: `0.2.1.3`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Create tests and benchmarks together
- **Homepage**: [https://hackage.haskell.org/package/testbench](https://hackage.haskell.org/package/testbench)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/kdv6a079l6k2rz7m9inljbx26yff0gqw-testbench-0.2.1.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:665844`
- **Outputs**:
  - `doc`:  `/nix/store/kdv6a079l6k2rz7m9inljbx26yff0gqw-testbench-0.2.1.3`
  - `out`:  `/nix/store/kdv6a079l6k2rz7m9inljbx26yff0gqw-testbench-0.2.1.3`
...
- [[9451hbd7sr4rn2pjvnfsqlxrmddl250y-testbench-0.2.1.3.tar.gz]]
