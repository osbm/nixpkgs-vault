...
- **Name**: `python312Packages.simple-parsing`
- **Version**: `0.1.7`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Simple, Elegant, Typed Argument Parsing with argparse
- **Homepage**: [https://github.com/lebrice/SimpleParsing](https://github.com/lebrice/SimpleParsing)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/sk5zrb2v9rfwg0df18r2cm1cn2w0dils-python3.12-simple-parsing-0.1.7.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/simple-parsing/default.nix:87`
- **Outputs**:
  - `dist`:  `/nix/store/sk5zrb2v9rfwg0df18r2cm1cn2w0dils-python3.12-simple-parsing-0.1.7`
  - `out`:  `/nix/store/sk5zrb2v9rfwg0df18r2cm1cn2w0dils-python3.12-simple-parsing-0.1.7`
...
- [[c7zjbkzhshx1isjracd5hxk7fvpcqvqg-orion-1.5]]
...
- [[xnbhlvrmah0857c8v5iz84hjbc9fg1cr-source]]
