---
aliases:
  - linuxKernel.packages.linux_6_16.shufflecake
tags:
  - license/unknown
  - maintainers/oluceps
  - outputs/bin
...
- **Name**: `linuxKernel.packages.linux_6_16.shufflecake`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/mjcdz5m6jigdgb9bv0vvppvgnxwgnaa8-shufflecake.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/shufflecake/default.nix:44`
- **Outputs**:
  - `bin`:  `/nix/store/mjcdz5m6jigdgb9bv0vvppvgnxwgnaa8-shufflecake`
  - `out`:  `/nix/store/mjcdz5m6jigdgb9bv0vvppvgnxwgnaa8-shufflecake`
