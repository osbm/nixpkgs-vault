---
aliases:
  - home-assistant-component-tests.date
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.date`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/daxy8r08ki6h32vfwzcqz1s5wdvnnyq3-homeassistant-test-date-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/daxy8r08ki6h32vfwzcqz1s5wdvnnyq3-homeassistant-test-date-2025.9.4`
