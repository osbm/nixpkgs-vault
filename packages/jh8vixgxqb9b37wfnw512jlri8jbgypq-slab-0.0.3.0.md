...
- **Name**: `haskellPackages.slab`
- **Version**: `0.0.3.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: A programmable markup language to generate HTML
- **Homepage**: [https://hackage.haskell.org/package/slab](https://hackage.haskell.org/package/slab)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/jh8vixgxqb9b37wfnw512jlri8jbgypq-slab-0.0.3.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:616243`
- **Outputs**:
  - `doc`:  `/nix/store/jh8vixgxqb9b37wfnw512jlri8jbgypq-slab-0.0.3.0`
  - `out`:  `/nix/store/jh8vixgxqb9b37wfnw512jlri8jbgypq-slab-0.0.3.0`
...
- [[gb95w7n28maym4nw27pnqfq1ccikcgz6-servant-websockets-2.0.0]]
...
- [[zs0y5rvvmvkl30k2qsxvg7c8188rw7qi-slab-0.0.3.0.tar.gz]]
