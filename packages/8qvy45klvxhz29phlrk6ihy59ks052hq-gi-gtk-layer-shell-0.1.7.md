...
- **Name**: `haskellPackages.gi-gtk-layer-shell`
- **Version**: `0.1.7`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: gtk-layer-shell bindings
- **Homepage**: [https://hackage.haskell.org/package/gi-gtk-layer-shell](https://hackage.haskell.org/package/gi-gtk-layer-shell)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/8qvy45klvxhz29phlrk6ihy59ks052hq-gi-gtk-layer-shell-0.1.7.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:265690`
- **Outputs**:
  - `doc`:  `/nix/store/8qvy45klvxhz29phlrk6ihy59ks052hq-gi-gtk-layer-shell-0.1.7`
  - `out`:  `/nix/store/8qvy45klvxhz29phlrk6ihy59ks052hq-gi-gtk-layer-shell-0.1.7`
...
- [[1pf6bigm37yrq2s9mffnj3n782163xj5-gi-gtk-layer-shell-0.1.7.tar.gz]]
