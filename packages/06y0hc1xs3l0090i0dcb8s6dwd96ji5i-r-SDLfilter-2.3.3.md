...
- **Name**: `rPackages.SDLfilter`
- **Version**: `2.3.3`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/SDLfilter/](https://cran.r-project.org/web/packages/SDLfilter/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/06y0hc1xs3l0090i0dcb8s6dwd96ji5i-r-SDLfilter-2.3.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/06y0hc1xs3l0090i0dcb8s6dwd96ji5i-r-SDLfilter-2.3.3`
...
- [[h4yar6m3g84gwakx29n03dpyhfan69m5-SDLfilter_2.3.3.tar.gz]]
