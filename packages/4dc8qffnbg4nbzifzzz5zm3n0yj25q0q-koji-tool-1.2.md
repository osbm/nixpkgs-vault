...
- **Name**: `haskellPackages.koji-tool`
- **Version**: `1.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Koji CLI tool for querying tasks and installing builds
- **Homepage**: [https://hackage.haskell.org/package/koji-tool](https://hackage.haskell.org/package/koji-tool)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/4dc8qffnbg4nbzifzzz5zm3n0yj25q0q-koji-tool-1.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:402258`
- **Outputs**:
  - `doc`:  `/nix/store/4dc8qffnbg4nbzifzzz5zm3n0yj25q0q-koji-tool-1.2`
  - `out`:  `/nix/store/4dc8qffnbg4nbzifzzz5zm3n0yj25q0q-koji-tool-1.2`
...
- [[ry5jcpdc2nf6qhprdxsp97d8gvv2zlnx-koji-tool-1.2.tar.gz]]
