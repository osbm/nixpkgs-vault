...
- **Name**: `rPackages.edbuildr`
- **Version**: `0.3.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://cran.r-project.org/web/packages/edbuildr/](https://cran.r-project.org/web/packages/edbuildr/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/5r8s2k69dj2d872inf4grkq96f20yjhi-r-edbuildr-0.3.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/5r8s2k69dj2d872inf4grkq96f20yjhi-r-edbuildr-0.3.0`
...
- [[9d2prhr9s9qi66598ipnsfwrcwc9mc6f-edbuildr_0.3.0.tar.gz]]
