...
- **Name**: `python313Packages.sse-starlette`
- **Version**: `3.0.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Server Sent Events for Starlette and FastAPI
- **Homepage**: [https://github.com/sysid/sse-starlette](https://github.com/sysid/sse-starlette)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/f1ak3dyi5d4ww1gpl778qy7dcak0ck72-python3.13-sse-starlette-3.0.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/sse-starlette/default.nix:77`
- **Outputs**:
  - `dist`:  `/nix/store/f1ak3dyi5d4ww1gpl778qy7dcak0ck72-python3.13-sse-starlette-3.0.2`
  - `out`:  `/nix/store/f1ak3dyi5d4ww1gpl778qy7dcak0ck72-python3.13-sse-starlette-3.0.2`

## 🔗 Dependencies

- [[06a2j9jv7f40ihnra63q0xx99ry62h35-python-imports-check-hook.sh]]
- [[257k0vnqp1xjgyrpc5as1r0nl7s4yv71-python3-3.13.7]]
- [[406ps38j6d6m1gxaxrr3shyv1y15ah9m-python3.13-testcontainers-4.13.0]]
- [[51f20779249vfcf6x4axjz1psmywh9p6-source]]
...
- [[jx8f04ia95spij5nfgpbrdd829acgs4l-python3.13-portend-3.2.1]]
