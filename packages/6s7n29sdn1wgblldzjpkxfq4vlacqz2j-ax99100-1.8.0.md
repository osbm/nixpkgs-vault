...
- **Name**: `linuxKernel.packages.linux_lqx.ax99100`
- **Version**: `1.8.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/6s7n29sdn1wgblldzjpkxfq4vlacqz2j-ax99100-1.8.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/ax99100/default.nix:56`
- **Outputs**:
  - `out`:  `/nix/store/6s7n29sdn1wgblldzjpkxfq4vlacqz2j-ax99100-1.8.0`
