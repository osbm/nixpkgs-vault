...
- **Homepage**: [https://github.com/gitext-rs/git-dive](https://github.com/gitext-rs/git-dive)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/7x0zjg7djlvhj6irj25a54q7qcx4ddq5-git-dive-0.1.6.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/gi/git-dive/package.nix:59`
- **Outputs**:
  - `out`:  `/nix/store/7x0zjg7djlvhj6irj25a54q7qcx4ddq5-git-dive-0.1.6`
...
- [[8jfycwx7x3hd2mzn72w6prqd9fvp8sfn-git-dive-0.1.6-vendor]]
- [[bjsb6wdjykafnkixq156qdvmxhsm2bai-bash-5.3p3]]
- [[lvdvlk7cwad5mna0wfpz8jllb30jdj1n-pkg-config-wrapper-0.29.2]]
- [[m7xggs937rxl3930k6v3r9kq7g649v7f-source]]
