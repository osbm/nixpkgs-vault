...
- **Name**: `haskellPackages.jsop`
- **Version**: `0.2.0.1`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Cherry picking in JSON objects
- **Homepage**: [https://hackage.haskell.org/package/jsop](https://hackage.haskell.org/package/jsop)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/dn83f2fm1nxzx5x5zfcdcpwwl2i58m5h-jsop-0.2.0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:395176`
- **Outputs**:
  - `doc`:  `/nix/store/dn83f2fm1nxzx5x5zfcdcpwwl2i58m5h-jsop-0.2.0.1`
  - `out`:  `/nix/store/dn83f2fm1nxzx5x5zfcdcpwwl2i58m5h-jsop-0.2.0.1`
...
- [[7sz3vnl93d0blg0qcg5y5szxg4hp7fcp-jsop-0.2.0.1.tar.gz]]
