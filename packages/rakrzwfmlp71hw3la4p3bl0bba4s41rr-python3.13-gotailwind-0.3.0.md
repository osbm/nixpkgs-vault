...
- **Name**: `python313Packages.gotailwind`
- **Version**: `0.3.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/rakrzwfmlp71hw3la4p3bl0bba4s41rr-python3.13-gotailwind-0.3.0.drv`
...
- **Outputs**:
  - `dist`:  `/nix/store/rakrzwfmlp71hw3la4p3bl0bba4s41rr-python3.13-gotailwind-0.3.0`
  - `out`:  `/nix/store/rakrzwfmlp71hw3la4p3bl0bba4s41rr-python3.13-gotailwind-0.3.0`
