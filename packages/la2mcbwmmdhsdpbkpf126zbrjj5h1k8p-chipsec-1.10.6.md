---
aliases:
  - linuxKernel.packages.linux_libre.chipsec
tags:
  - license/unknown
...
- **Name**: `linuxKernel.packages.linux_libre.chipsec`
- **Version**: `1.10.6`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/la2mcbwmmdhsdpbkpf126zbrjj5h1k8p-chipsec-1.10.6.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/tools/security/chipsec/default.nix:77`
- **Outputs**:
  - `dist`:  `/nix/store/la2mcbwmmdhsdpbkpf126zbrjj5h1k8p-chipsec-1.10.6`
  - `out`:  `/nix/store/la2mcbwmmdhsdpbkpf126zbrjj5h1k8p-chipsec-1.10.6`
