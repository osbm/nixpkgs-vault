...
- **Name**: `haskellPackages.ory-hydra-client`
- **Version**: `2.1.2.1`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Auto-generated ory-hydra API Client
- **Homepage**: [https://hackage.haskell.org/package/ory-hydra-client](https://hackage.haskell.org/package/ory-hydra-client)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/llhwvlapwka1qyaxvvlsqgpzrf2124yg-ory-hydra-client-2.1.2.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:496760`
- **Outputs**:
  - `doc`:  `/nix/store/llhwvlapwka1qyaxvvlsqgpzrf2124yg-ory-hydra-client-2.1.2.1`
  - `out`:  `/nix/store/llhwvlapwka1qyaxvvlsqgpzrf2124yg-ory-hydra-client-2.1.2.1`
...
- [[skw6j5pn91qvbz5273jy60l7ijmdjib5-ory-hydra-client-2.1.2.1.tar.gz]]
