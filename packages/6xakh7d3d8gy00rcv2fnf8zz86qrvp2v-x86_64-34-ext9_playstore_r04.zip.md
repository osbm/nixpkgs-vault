---
aliases:
  - androidenv.androidPkgs.all.system-images.v34x.android-automotive.x86_64
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.system-images.v34x.android-automotive.x86_64`
...
- **Derivation Path**: `/nix/store/6xakh7d3d8gy00rcv2fnf8zz86qrvp2v-x86_64-34-ext9_playstore_r04.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/6xakh7d3d8gy00rcv2fnf8zz86qrvp2v-x86_64-34-ext9_playstore_r04.zip`
