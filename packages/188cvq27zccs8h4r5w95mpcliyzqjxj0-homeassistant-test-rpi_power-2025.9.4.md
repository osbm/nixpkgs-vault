---
aliases:
  - home-assistant-component-tests.rpi_power
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.rpi_power`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/188cvq27zccs8h4r5w95mpcliyzqjxj0-homeassistant-test-rpi_power-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/188cvq27zccs8h4r5w95mpcliyzqjxj0-homeassistant-test-rpi_power-2025.9.4`
