...
- **Name**: `python312Packages.django-health-check`
- **Version**: `3.20.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Pluggable app that runs a full check on the deployment
- **Homepage**: [https://github.com/KristianOellegaard/django-health-check](https://github.com/KristianOellegaard/django-health-check)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/mpsyqddby43x9zl02y760pqcj2cn0a8g-python3.12-django-health-check-3.20.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/django-health-check/default.nix:63`
- **Outputs**:
  - `dist`:  `/nix/store/mpsyqddby43x9zl02y760pqcj2cn0a8g-python3.12-django-health-check-3.20.0`
  - `out`:  `/nix/store/mpsyqddby43x9zl02y760pqcj2cn0a8g-python3.12-django-health-check-3.20.0`

## 🔗 Dependencies

- [[52aw60xrbyl1lmndmq2ayc8cmjxzjs7a-source]]
...
- [[kk21ygpf57knv9darcvwdzbjbv78072n-python3.12-django-storages-1.14.5]]
...
- [[zlac0c68fcc68zfcqwkmkpl8jm3as11y-python3.12-flit-scm-1.7.0]]
