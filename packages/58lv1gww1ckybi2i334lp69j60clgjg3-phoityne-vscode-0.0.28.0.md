...
- **Name**: `haskellPackages.phoityne-vscode`
- **Version**: `0.0.28.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Haskell Debug Adapter for Visual Studio Code
- **Homepage**: [https://hackage.haskell.org/package/phoityne-vscode](https://hackage.haskell.org/package/phoityne-vscode)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/58lv1gww1ckybi2i334lp69j60clgjg3-phoityne-vscode-0.0.28.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:516440`
- **Outputs**:
  - `doc`:  `/nix/store/58lv1gww1ckybi2i334lp69j60clgjg3-phoityne-vscode-0.0.28.0`
  - `out`:  `/nix/store/58lv1gww1ckybi2i334lp69j60clgjg3-phoityne-vscode-0.0.28.0`
...
- [[kzpypbxhsgnfmndf88i9k6l46kxdl1kr-phoityne-vscode-0.0.28.0.tar.gz]]
