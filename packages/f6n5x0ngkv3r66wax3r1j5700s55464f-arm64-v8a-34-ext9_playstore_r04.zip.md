---
aliases:
  - androidenv.androidPkgs.all.system-images.v34x.android-automotive.arm64-v8a
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.system-images.v34x.android-automotive.arm64-v8a`
- **Version**: `34-ext9_playstore_r04.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/f6n5x0ngkv3r66wax3r1j5700s55464f-arm64-v8a-34-ext9_playstore_r04.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/f6n5x0ngkv3r66wax3r1j5700s55464f-arm64-v8a-34-ext9_playstore_r04.zip`
