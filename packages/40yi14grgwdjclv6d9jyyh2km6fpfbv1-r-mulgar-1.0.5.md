...
- **Name**: `rPackages.mulgar`
- **Version**: `1.0.5`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/mulgar/](https://cran.r-project.org/web/packages/mulgar/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/40yi14grgwdjclv6d9jyyh2km6fpfbv1-r-mulgar-1.0.5.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/40yi14grgwdjclv6d9jyyh2km6fpfbv1-r-mulgar-1.0.5`

## 🔗 Dependencies

- [[3915xdbzl9n1hdgpyqsz1n6scq4ljb5z-mulgar_1.0.5.tar.gz]]
