---
aliases:
  - postgresql16Packages.pg_repack
tags:
  - license/unknown
  - maintainers/danbst
  - outputs/out
...
- **Name**: `postgresql16Packages.pg_repack`
- **Version**: `1.5.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/s5hnzgcya9bcr34xjb3c7vxh5dn5ilc9-pg_repack-1.5.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/sql/postgresql/ext/pg_repack.nix:39`
- **Outputs**:
  - `out`:  `/nix/store/s5hnzgcya9bcr34xjb3c7vxh5dn5ilc9-pg_repack-1.5.2`
