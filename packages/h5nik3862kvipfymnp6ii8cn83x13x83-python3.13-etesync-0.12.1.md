...
Python API to interact with an EteSync server

## 📋 Package Information

- **Name**: `python313Packages.etesync`
- **Version**: `0.12.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Python API to interact with an EteSync server
- **Homepage**: [https://www.etesync.com/](https://www.etesync.com/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/h5nik3862kvipfymnp6ii8cn83x13x83-python3.13-etesync-0.12.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/etesync/default.nix:70`
- **Outputs**:
  - `dist`:  `/nix/store/h5nik3862kvipfymnp6ii8cn83x13x83-python3.13-etesync-0.12.1`
  - `out`:  `/nix/store/h5nik3862kvipfymnp6ii8cn83x13x83-python3.13-etesync-0.12.1`
...
- [[bxwbjvy1inp747bqkl9rmcl6k22llyad-python3.13-orderedmultidict-1.0.1]]
- [[c0z1y0jmf74nabznf8sdyqm41g0l0sr4-python3.13-appdirs-1.4.4]]
- [[cv9zjk6dmhybvxdx0k17z0gk7fc6q03b-python3.13-pycparser-2.22]]
- [[d8fwmk8c49x5q25cly8ib80v8zg4ykxs-python3.13-pyscrypt-1.6.2]]
...
- [[pa4cs9jn909fc9rm3vqfcrz3b355ddl1-python3.13-furl-2.1.4]]
...
- [[yvmqwll286n2vh0l464x9idyi3hqmw1r-etesync-0.12.1.tar.gz]]
