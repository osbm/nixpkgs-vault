...
Typechecker for automated deduction languages

## 📋 Package Information

- **Name**: `ocamlPackages.dolmen_type`
- **Version**: `0.10`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/4ajjnh8c5nl1y2dcjzcbfnd6hjglm58x-ocaml5.3.0-dolmen_type-0.10.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/ocaml-modules/dolmen/type.nix:19`
- **Outputs**:
  - `out`:  `/nix/store/4ajjnh8c5nl1y2dcjzcbfnd6hjglm58x-ocaml5.3.0-dolmen_type-0.10`
