...
- **Name**: `rPackages.tidyrstats`
- **Version**: `0.1.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/tidyrstats/](https://cran.r-project.org/web/packages/tidyrstats/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/b47sxanrln38m8c22vh2vadb20wg8iaf-r-tidyrstats-0.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/b47sxanrln38m8c22vh2vadb20wg8iaf-r-tidyrstats-0.1.0`
...
- [[i7hdsh9jd6if1ps5hql3lcbibg6qdl7g-tidyrstats_0.1.0.tar.gz]]
