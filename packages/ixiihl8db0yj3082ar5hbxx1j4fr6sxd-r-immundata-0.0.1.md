...
- **Name**: `rPackages.immundata`
- **Version**: `0.0.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/immundata/](https://cran.r-project.org/web/packages/immundata/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/ixiihl8db0yj3082ar5hbxx1j4fr6sxd-r-immundata-0.0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/ixiihl8db0yj3082ar5hbxx1j4fr6sxd-r-immundata-0.0.1`
...
- [[cp67aan4z4a7a5m6dr1khi7mwc32j1dd-immundata_0.0.1.tar.gz]]
...
- [[pd5vpxl04fzk41ilhar54kghh058mkja-r-duckplyr-1.1.1]]
