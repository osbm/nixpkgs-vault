...
- **Name**: `rPackages.PopComm`
- **Version**: `0.1.0.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/PopComm/](https://cran.r-project.org/web/packages/PopComm/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/az916afbccvi1l7jar5f8df9hjfwysbs-r-PopComm-0.1.0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/az916afbccvi1l7jar5f8df9hjfwysbs-r-PopComm-0.1.0.1`

## 🔗 Dependencies

- [[0vpikcy1a4q1rzjbj1hv8mha64rg5hzk-r-reshape2-1.4.4]]
- [[158lp94nd95svzydymb07qkd75g34lvn-PopComm_0.1.0.1.tar.gz]]
