---
aliases:
  - haskellPackages.dynamodb-simple
tags:
  - broken
  - not-available
  - license/unknown
...
- **Name**: `haskellPackages.dynamodb-simple`
- **Version**: `0.6.0.2`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Typesafe library for working with DynamoDB database
- **Homepage**: [https://hackage.haskell.org/package/dynamodb-simple](https://hackage.haskell.org/package/dynamodb-simple)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/g8vkdk7287pzibglqfnw3kzf3fwk7b3n-dynamodb-simple-0.6.0.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:207070`
- **Outputs**:
  - `doc`:  `/nix/store/g8vkdk7287pzibglqfnw3kzf3fwk7b3n-dynamodb-simple-0.6.0.2`
  - `out`:  `/nix/store/g8vkdk7287pzibglqfnw3kzf3fwk7b3n-dynamodb-simple-0.6.0.2`
...
- [[j0b79fdvf3q38icknhizg8x7lqckqbkc-dynamodb-simple-0.6.0.2.tar.gz]]
