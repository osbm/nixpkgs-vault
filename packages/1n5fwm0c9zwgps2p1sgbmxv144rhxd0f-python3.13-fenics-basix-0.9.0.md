---
aliases:
  - python313Packages.fenics-basix
tags:
  - license/unknown
  - maintainers/qbisi
  - outputs/dist
...
Finite element definition and tabulation runtime library

## 📋 Package Information

- **Name**: `python313Packages.fenics-basix`
- **Version**: `0.9.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/1n5fwm0c9zwgps2p1sgbmxv144rhxd0f-python3.13-fenics-basix-0.9.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/fenics-basix/default.nix:78`
- **Outputs**:
  - `dist`:  `/nix/store/1n5fwm0c9zwgps2p1sgbmxv144rhxd0f-python3.13-fenics-basix-0.9.0`
  - `out`:  `/nix/store/1n5fwm0c9zwgps2p1sgbmxv144rhxd0f-python3.13-fenics-basix-0.9.0`
...
- [[pwvx2pv8rxmzi731mlcq3cd3hgl2qj6s-source]]
