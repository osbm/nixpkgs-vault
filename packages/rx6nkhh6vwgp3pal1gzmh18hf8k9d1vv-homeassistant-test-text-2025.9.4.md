---
aliases:
  - home-assistant-component-tests.text
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.text`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/rx6nkhh6vwgp3pal1gzmh18hf8k9d1vv-homeassistant-test-text-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/rx6nkhh6vwgp3pal1gzmh18hf8k9d1vv-homeassistant-test-text-2025.9.4`
