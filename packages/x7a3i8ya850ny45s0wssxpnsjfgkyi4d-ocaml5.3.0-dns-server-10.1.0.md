...
- **Derivation Path**: `/nix/store/x7a3i8ya850ny45s0wssxpnsjfgkyi4d-ocaml5.3.0-dns-server-10.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/ocaml-modules/dns/server.nix:44`
- **Outputs**:
  - `out`:  `/nix/store/x7a3i8ya850ny45s0wssxpnsjfgkyi4d-ocaml5.3.0-dns-server-10.1.0`
