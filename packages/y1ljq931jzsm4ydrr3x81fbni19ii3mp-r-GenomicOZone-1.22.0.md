...
- **Name**: `rPackages.GenomicOZone`
- **Version**: `1.22.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://bioconductor.org/packages/3.21/bioc/html/GenomicOZone.html](https://bioconductor.org/packages/3.21/bioc/html/GenomicOZone.html)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/y1ljq931jzsm4ydrr3x81fbni19ii3mp-r-GenomicOZone-1.22.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/y1ljq931jzsm4ydrr3x81fbni19ii3mp-r-GenomicOZone-1.22.0`
...
- [[dwx6gsn3bn0s2d8jgivxm5f6iyr3wxva-GenomicOZone_1.22.0.tar.gz]]
