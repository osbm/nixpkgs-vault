---
aliases:
  - linuxKernel.packages.linux_6_6.tbs
tags:
  - license/unknown
  - maintainers/ck3d
  - outputs/out
...
- **Name**: `linuxKernel.packages.linux_6_6.tbs`
- **Version**: `20250510-6.6.107`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/3649v8h9pr4zjrnrxsp4pv9m3mx4cif0-tbs-20250510-6.6.107.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/tbs/default.nix:80`
- **Outputs**:
  - `out`:  `/nix/store/3649v8h9pr4zjrnrxsp4pv9m3mx4cif0-tbs-20250510-6.6.107`
