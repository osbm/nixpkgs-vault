...
- **Name**: `haskellPackages.helix`
- **Version**: `0.9.5`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Web development micro framework for haskell with typesafe URLs
- **Homepage**: [https://hackage.haskell.org/package/helix](https://hackage.haskell.org/package/helix)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/f69297syiqs5a79myjfz8h34pi0blr65-helix-0.9.5.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:320802`
- **Outputs**:
  - `doc`:  `/nix/store/f69297syiqs5a79myjfz8h34pi0blr65-helix-0.9.5`
  - `out`:  `/nix/store/f69297syiqs5a79myjfz8h34pi0blr65-helix-0.9.5`
...
- [[6gqqhz9580wg2graxbmvjrl5833d4sg0-helix-0.9.5.tar.gz]]
