...
- **Name**: `haskellPackages.logstash`
- **Version**: `0.1.0.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Logstash client library for Haskell
- **Homepage**: [https://hackage.haskell.org/package/logstash](https://hackage.haskell.org/package/logstash)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/9n5x3g6hwjavmc4bfbaqv6xi73xyfbh8-logstash-0.1.0.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:428392`
- **Outputs**:
  - `doc`:  `/nix/store/9n5x3g6hwjavmc4bfbaqv6xi73xyfbh8-logstash-0.1.0.4`
  - `out`:  `/nix/store/9n5x3g6hwjavmc4bfbaqv6xi73xyfbh8-logstash-0.1.0.4`

## 🔗 Dependencies

- [[29ybm58igdzal48m551qwkafmkwglq6g-unliftio-0.2.25.1]]
- [[36j4rqrfm8gy847m0v1mrckxv9x22j1q-logstash-0.1.0.4.tar.gz]]
