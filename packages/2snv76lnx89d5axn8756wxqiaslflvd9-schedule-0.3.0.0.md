...
- **Name**: `haskellPackages.schedule`
- **Version**: `0.3.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Pure deterministic scheduled computations
- **Homepage**: [https://hackage.haskell.org/package/schedule](https://hackage.haskell.org/package/schedule)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/2snv76lnx89d5axn8756wxqiaslflvd9-schedule-0.3.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:587683`
- **Outputs**:
  - `doc`:  `/nix/store/2snv76lnx89d5axn8756wxqiaslflvd9-schedule-0.3.0.0`
  - `out`:  `/nix/store/2snv76lnx89d5axn8756wxqiaslflvd9-schedule-0.3.0.0`

## 🔗 Dependencies

- [[2wjc615ddpx8y6wlrdrpzcr7v9r0fxcy-schedule-0.3.0.0.tar.gz]]
...
- [[pgg12mfvymrpd1q0wkdwbnrg74bj568l-system-time-monotonic-0.2]]
