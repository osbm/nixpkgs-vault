...
- **Derivation Path**: `/nix/store/45lwwxh7m7x46bajdwrlja35ig7ysc1m-python3.13-prisma-0.15.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/prisma/default.nix:52`
- **Outputs**:
  - `dist`:  `/nix/store/45lwwxh7m7x46bajdwrlja35ig7ysc1m-python3.13-prisma-0.15.0`
  - `out`:  `/nix/store/45lwwxh7m7x46bajdwrlja35ig7ysc1m-python3.13-prisma-0.15.0`
