...
- **Name**: `home-assistant-component-tests.unifi`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/v19lbzxalgnzra4gawndinw099zwxgza-homeassistant-test-unifi-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/v19lbzxalgnzra4gawndinw099zwxgza-homeassistant-test-unifi-2025.9.4`
...
- [[jzzrdm1fpcj29zwvhfcq0arw0gim854d-python3.13-aiounifi-86]]
