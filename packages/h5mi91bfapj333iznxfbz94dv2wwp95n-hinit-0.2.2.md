...
- **Homepage**: [https://hackage.haskell.org/package/hinit](https://hackage.haskell.org/package/hinit)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/h5mi91bfapj333iznxfbz94dv2wwp95n-hinit-0.2.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:328738`
- **Outputs**:
  - `data`:  `/nix/store/h5mi91bfapj333iznxfbz94dv2wwp95n-hinit-0.2.2`
  - `out`:  `/nix/store/h5mi91bfapj333iznxfbz94dv2wwp95n-hinit-0.2.2`
...
- [[b77f7qyjrvabcvjfn7305h2r2bb7xjip-hinit-0.2.2.tar.gz]]
