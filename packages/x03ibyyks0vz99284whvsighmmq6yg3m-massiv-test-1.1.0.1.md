...
- **Name**: `haskellPackages.massiv-test`
- **Version**: `1.1.0.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Library that contains generators, properties and tests for Massiv Array Library
- **Homepage**: [https://hackage.haskell.org/package/massiv-test](https://hackage.haskell.org/package/massiv-test)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/x03ibyyks0vz99284whvsighmmq6yg3m-massiv-test-1.1.0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:438816`
- **Outputs**:
  - `doc`:  `/nix/store/x03ibyyks0vz99284whvsighmmq6yg3m-massiv-test-1.1.0.1`
  - `out`:  `/nix/store/x03ibyyks0vz99284whvsighmmq6yg3m-massiv-test-1.1.0.1`
...
- [[zl1lijhgkr4q8bl27m2hqfn8ni90l49w-massiv-test-1.1.0.1.tar.gz]]
