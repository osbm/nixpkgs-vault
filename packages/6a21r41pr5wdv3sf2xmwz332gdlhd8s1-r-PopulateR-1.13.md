...
- **Name**: `rPackages.PopulateR`
- **Version**: `1.13`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/PopulateR/](https://cran.r-project.org/web/packages/PopulateR/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/6a21r41pr5wdv3sf2xmwz332gdlhd8s1-r-PopulateR-1.13.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/6a21r41pr5wdv3sf2xmwz332gdlhd8s1-r-PopulateR-1.13`
...
- [[ympp878dxl62a4965ssi61r8vwhr10nj-PopulateR_1.13.tar.gz]]
