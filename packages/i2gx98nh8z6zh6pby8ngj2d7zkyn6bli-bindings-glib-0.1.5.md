...
- **Name**: `haskellPackages.bindings-glib`
- **Version**: `0.1.5`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Low level bindings to GLib
- **Homepage**: [https://hackage.haskell.org/package/bindings-glib](https://hackage.haskell.org/package/bindings-glib)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/i2gx98nh8z6zh6pby8ngj2d7zkyn6bli-bindings-glib-0.1.5.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:104949`
- **Outputs**:
  - `doc`:  `/nix/store/i2gx98nh8z6zh6pby8ngj2d7zkyn6bli-bindings-glib-0.1.5`
  - `out`:  `/nix/store/i2gx98nh8z6zh6pby8ngj2d7zkyn6bli-bindings-glib-0.1.5`
...
- [[pndxmy0mfglxgl6j610adf2lpns75k1y-bindings-glib-0.1.5.tar.gz]]
