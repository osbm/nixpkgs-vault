...
- **Name**: `languageMachines.timbl`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: TiMBL implements several memory-based learning algorithms
- **Homepage**: [https://github.com/LanguageMachines/timbl/](https://github.com/LanguageMachines/timbl/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/m5dlncs5ihibw75iy9lfp9wlzrf11lxn-timbl-v6.4.9.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/libraries/languagemachines/timbl.nix:43`
- **Outputs**:
  - `out`:  `/nix/store/m5dlncs5ihibw75iy9lfp9wlzrf11lxn-timbl-v6.4.9`
...
- [[xc9hvnzimszkl6bsf6klcyniirxha6vk-timbl-v6.4.9.tar.gz]]
