---
aliases:
  - home-assistant-component-tests.openalpr_cloud
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.openalpr_cloud`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/6aszm5nnkdrz4l9kyadpxkknbx6nzj89-homeassistant-test-openalpr_cloud-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/6aszm5nnkdrz4l9kyadpxkknbx6nzj89-homeassistant-test-openalpr_cloud-2025.9.4`
