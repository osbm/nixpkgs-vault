...
- **Name**: `haskellPackages.lambdatwit`
- **Version**: `0.1.0.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Lambdabot running as a twitter bot. Similar to the @fsibot f# bot.
- **Homepage**: [https://hackage.haskell.org/package/lambdatwit](https://hackage.haskell.org/package/lambdatwit)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/zxpaakqk2w12qim52ybcn9cai4a65bzq-lambdatwit-0.1.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:406146`
- **Outputs**:
  - `doc`:  `/nix/store/zxpaakqk2w12qim52ybcn9cai4a65bzq-lambdatwit-0.1.0.0`
  - `out`:  `/nix/store/zxpaakqk2w12qim52ybcn9cai4a65bzq-lambdatwit-0.1.0.0`

## 🔗 Dependencies

- [[0692bcgawl3xkgl2l33yfpgc8x9az0n3-lambdatwit-0.1.0.0.tar.gz]]
