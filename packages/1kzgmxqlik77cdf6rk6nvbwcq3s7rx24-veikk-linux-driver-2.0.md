...
- **Name**: `linuxKernel.packages.linux_latest_libre.veikk-linux-driver`
- **Version**: `2.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/1kzgmxqlik77cdf6rk6nvbwcq3s7rx24-veikk-linux-driver-2.0.drv`
...
- **Outputs**:
  - `out`:  `/nix/store/1kzgmxqlik77cdf6rk6nvbwcq3s7rx24-veikk-linux-driver-2.0`
