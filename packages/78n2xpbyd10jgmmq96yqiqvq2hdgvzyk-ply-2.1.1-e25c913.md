...
- **Name**: `linuxKernel.packages.linux_5_10.ply`
...
- **Derivation Path**: `/nix/store/78n2xpbyd10jgmmq96yqiqvq2hdgvzyk-ply-2.1.1-e25c913.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/ply/default.nix:50`
- **Outputs**:
  - `out`:  `/nix/store/78n2xpbyd10jgmmq96yqiqvq2hdgvzyk-ply-2.1.1-e25c913`
