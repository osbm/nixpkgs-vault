...
- **Name**: `haskellPackages.qhs`
- **Version**: `0.4.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Command line tool qhs, SQL queries on CSV and TSV files
- **Homepage**: [https://hackage.haskell.org/package/qhs](https://hackage.haskell.org/package/qhs)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/q1340k4sby9l6kwsyadxzarwqyg1wq62-qhs-0.4.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:549526`
- **Outputs**:
  - `out`:  `/nix/store/q1340k4sby9l6kwsyadxzarwqyg1wq62-qhs-0.4.0`
...
- [[hr0gpzivqcs28cawsc0lpav6fs68czzg-qhs-0.4.0.tar.gz]]
