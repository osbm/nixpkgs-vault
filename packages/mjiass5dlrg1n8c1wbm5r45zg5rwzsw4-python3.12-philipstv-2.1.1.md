...
- **Name**: `python312Packages.philipstv`
- **Version**: `2.1.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: CLI and library to control Philips Android-powered TVs
- **Homepage**: [https://github.com/bcyran/philipstv](https://github.com/bcyran/philipstv)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/mjiass5dlrg1n8c1wbm5r45zg5rwzsw4-python3.12-philipstv-2.1.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/philipstv/default.nix:66`
- **Outputs**:
  - `dist`:  `/nix/store/mjiass5dlrg1n8c1wbm5r45zg5rwzsw4-python3.12-philipstv-2.1.1`
  - `out`:  `/nix/store/mjiass5dlrg1n8c1wbm5r45zg5rwzsw4-python3.12-philipstv-2.1.1`
...
- [[k2w4ayrz668x10i6324dq1y9j6gndcyg-source]]
