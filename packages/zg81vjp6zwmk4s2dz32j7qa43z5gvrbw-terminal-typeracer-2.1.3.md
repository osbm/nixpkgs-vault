...
Open source terminal based version of Typeracer written in rust
...
- **Homepage**: [https://gitlab.com/ttyperacer/terminal-typeracer](https://gitlab.com/ttyperacer/terminal-typeracer)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/zg81vjp6zwmk4s2dz32j7qa43z5gvrbw-terminal-typeracer-2.1.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/te/terminal-typeracer/package.nix:41`
- **Outputs**:
  - `out`:  `/nix/store/zg81vjp6zwmk4s2dz32j7qa43z5gvrbw-terminal-typeracer-2.1.3`
...
- [[8z1lqmx627h52wqjciys56msrjbvvjcv-terminal-typeracer-2.1.3-vendor]]
- [[bjsb6wdjykafnkixq156qdvmxhsm2bai-bash-5.3p3]]
- [[dgwg9k0afbfvi6ln0dwc4y6ay1hww4k7-source]]
