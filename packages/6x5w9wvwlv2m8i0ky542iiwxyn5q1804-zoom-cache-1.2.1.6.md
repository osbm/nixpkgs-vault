...
- **Name**: `haskellPackages.zoom-cache`
- **Version**: `1.2.1.6`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: A streamable, seekable, zoomable cache file format
- **Homepage**: [https://hackage.haskell.org/package/zoom-cache](https://hackage.haskell.org/package/zoom-cache)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/6x5w9wvwlv2m8i0ky542iiwxyn5q1804-zoom-cache-1.2.1.6.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:748617`
- **Outputs**:
  - `doc`:  `/nix/store/6x5w9wvwlv2m8i0ky542iiwxyn5q1804-zoom-cache-1.2.1.6`
  - `out`:  `/nix/store/6x5w9wvwlv2m8i0ky542iiwxyn5q1804-zoom-cache-1.2.1.6`

## 🔗 Dependencies

- [[0nz8wdrndf4i752zh7haj6427q5afcvn-ListLike-4.7.8.3]]
- [[3zvqymxrdksaym0gvyzsmx0l231h3xbw-zoom-cache-1.2.1.6.tar.gz]]
