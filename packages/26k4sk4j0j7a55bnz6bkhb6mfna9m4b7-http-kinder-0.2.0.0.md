...
- **Name**: `haskellPackages.http-kinder`
- **Version**: `0.2.0.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Generic kinds and types for working with HTTP
- **Homepage**: [https://hackage.haskell.org/package/http-kinder](https://hackage.haskell.org/package/http-kinder)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/26k4sk4j0j7a55bnz6bkhb6mfna9m4b7-http-kinder-0.2.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:361883`
- **Outputs**:
  - `doc`:  `/nix/store/26k4sk4j0j7a55bnz6bkhb6mfna9m4b7-http-kinder-0.2.0.0`
  - `out`:  `/nix/store/26k4sk4j0j7a55bnz6bkhb6mfna9m4b7-http-kinder-0.2.0.0`
...
- [[yaypzg31l11yfczy6758fkbhnmd0q6zv-http-kinder-0.2.0.0.tar.gz]]
