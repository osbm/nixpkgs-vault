---
aliases:
  - linuxKernel.kernels.linux_5_10
tags:
  - license/unknown
...
- **Name**: `linuxKernel.kernels.linux_5_10`
- **Version**: `5.10.244`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/nqmkpnqndz61y4yr6yxbm1byyi854vwj-linux-5.10.244.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/kernel/mainline.nix:34`
- **Outputs**:
  - `dev`:  `/nix/store/nqmkpnqndz61y4yr6yxbm1byyi854vwj-linux-5.10.244`
  - `modules`:  `/nix/store/nqmkpnqndz61y4yr6yxbm1byyi854vwj-linux-5.10.244`
  - `out`:  `/nix/store/nqmkpnqndz61y4yr6yxbm1byyi854vwj-linux-5.10.244`
...
- [[mq66bz3dd3yqgps7yk7j8bnkl2x9yaa7-linux-config-5.10.244]]
