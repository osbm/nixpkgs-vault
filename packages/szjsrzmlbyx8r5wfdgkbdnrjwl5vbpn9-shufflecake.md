...
- **Name**: `linuxKernel.packages.linux_xanmod.shufflecake`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/szjsrzmlbyx8r5wfdgkbdnrjwl5vbpn9-shufflecake.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/shufflecake/default.nix:44`
- **Outputs**:
  - `bin`:  `/nix/store/szjsrzmlbyx8r5wfdgkbdnrjwl5vbpn9-shufflecake`
  - `out`:  `/nix/store/szjsrzmlbyx8r5wfdgkbdnrjwl5vbpn9-shufflecake`
