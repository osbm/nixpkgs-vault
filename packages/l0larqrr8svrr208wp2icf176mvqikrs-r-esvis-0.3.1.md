...
- **Name**: `rPackages.esvis`
- **Version**: `0.3.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/esvis/](https://cran.r-project.org/web/packages/esvis/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/l0larqrr8svrr208wp2icf176mvqikrs-r-esvis-0.3.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/l0larqrr8svrr208wp2icf176mvqikrs-r-esvis-0.3.1`
...
- [[q6pkxhc3d5fzm4cc75c25nj1w2842q6a-esvis_0.3.1.tar.gz]]
