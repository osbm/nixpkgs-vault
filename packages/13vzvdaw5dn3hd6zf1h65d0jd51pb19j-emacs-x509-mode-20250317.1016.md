...
- **Name**: `emacsPackages.x509-mode`
- **Version**: `20250317.1016`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://github.com/jobbflykt/x509-mode](https://github.com/jobbflykt/x509-mode)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/13vzvdaw5dn3hd6zf1h65d0jd51pb19j-emacs-x509-mode-20250317.1016.drv`
...
- **Outputs**:
  - `out`:  `/nix/store/13vzvdaw5dn3hd6zf1h65d0jd51pb19j-emacs-x509-mode-20250317.1016`

## 🔗 Dependencies

- [[07wc7smzkq4kgdss6j5gk5lhgp9qy6nd-source]]
...
- [[hjcdpz0amvy8ys9yrqpnw781dxv5jy8l-x509-mode-recipe]]
