...
- **Name**: `python312Packages.yapf`
- **Version**: `0.43.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Yet Another Python Formatter
- **Homepage**: [https://github.com/google/yapf](https://github.com/google/yapf)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/c096cifwc8kb8c3psak9rlq3rp7ihsf3-python3.12-yapf-0.43.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/yapf/default.nix:38`
- **Outputs**:
  - `dist`:  `/nix/store/c096cifwc8kb8c3psak9rlq3rp7ihsf3-python3.12-yapf-0.43.0`
  - `out`:  `/nix/store/c096cifwc8kb8c3psak9rlq3rp7ihsf3-python3.12-yapf-0.43.0`

## 🔗 Dependencies

- [[4sk6ib1f2kibjcab0fvm7zsw99zfxnnn-yapf-0.43.0.tar.gz]]
