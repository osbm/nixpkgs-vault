---
aliases:
  - androidenv.androidPkgs.all.addons.v21.google_apis
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.addons.v21.google_apis`
- **Version**: `21_r01.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/y0jlvkkqjfncyv6yyf1l9d2hm28171la-google_apis-21_r01.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/y0jlvkkqjfncyv6yyf1l9d2hm28171la-google_apis-21_r01.zip`
