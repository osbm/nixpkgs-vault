...
- **Name**: `haskellPackages.hls-ormolu-plugin`
- **Version**: `2.6.0.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Integration with the Ormolu code formatter
- **Homepage**: [https://hackage.haskell.org/package/hls-ormolu-plugin](https://hackage.haskell.org/package/hls-ormolu-plugin)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/s1b5vgci4ydzbrranb5sfynan1b7zlxr-hls-ormolu-plugin-2.6.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:334490`
- **Outputs**:
  - `doc`:  `/nix/store/s1b5vgci4ydzbrranb5sfynan1b7zlxr-hls-ormolu-plugin-2.6.0.0`
  - `out`:  `/nix/store/s1b5vgci4ydzbrranb5sfynan1b7zlxr-hls-ormolu-plugin-2.6.0.0`
...
- [[ydzkancbmd3gh8bcj6qxn52vjz89hj75-hls-ormolu-plugin-2.6.0.0.tar.gz]]
