---
aliases:
  - androidenv.androidPkgs.all.system-images.v34.android-tv.x86
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.system-images.v34.android-tv.x86`
- **Version**: `34_r03.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/ici8p2mkksi5a18gbwbhsz30scg9ifjj-x86-34_r03.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/ici8p2mkksi5a18gbwbhsz30scg9ifjj-x86-34_r03.zip`
