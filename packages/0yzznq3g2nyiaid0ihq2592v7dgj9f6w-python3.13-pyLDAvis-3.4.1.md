...
- **Name**: `python313Packages.pyldavis`
- **Version**: `3.4.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Python library for interactive topic model visualization
- **Homepage**: [https://github.com/bmabey/pyLDAvis](https://github.com/bmabey/pyLDAvis)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/0yzznq3g2nyiaid0ihq2592v7dgj9f6w-python3.13-pyLDAvis-3.4.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/pyldavis/default.nix:45`
- **Outputs**:
  - `dist`:  `/nix/store/0yzznq3g2nyiaid0ihq2592v7dgj9f6w-python3.13-pyLDAvis-3.4.1`
  - `out`:  `/nix/store/0yzznq3g2nyiaid0ihq2592v7dgj9f6w-python3.13-pyLDAvis-3.4.1`
...
- [[gyxfj9c5xn2aqilsn8wwifk7qaiycszz-source]]
