...
- **Name**: `haskellPackages.grakn`
- **Version**: `0.3.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: A Haskell client for Grakn
- **Homepage**: [https://hackage.haskell.org/package/grakn](https://hackage.haskell.org/package/grakn)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/z47nma4rwavqa9dl75dlnihfygwabag4-grakn-0.3.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:280681`
- **Outputs**:
  - `doc`:  `/nix/store/z47nma4rwavqa9dl75dlnihfygwabag4-grakn-0.3.0`
  - `out`:  `/nix/store/z47nma4rwavqa9dl75dlnihfygwabag4-grakn-0.3.0`
...
- [[p2c2j7jwqnk6ahj9yzygdiqx839f40m9-grakn-0.3.0.tar.gz]]
