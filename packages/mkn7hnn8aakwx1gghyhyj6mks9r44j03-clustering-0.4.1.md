...
- **Name**: `haskellPackages.clustering`
- **Version**: `0.4.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: High performance clustering algorithms
- **Homepage**: [https://hackage.haskell.org/package/clustering](https://hackage.haskell.org/package/clustering)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/mkn7hnn8aakwx1gghyhyj6mks9r44j03-clustering-0.4.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:146158`
- **Outputs**:
  - `doc`:  `/nix/store/mkn7hnn8aakwx1gghyhyj6mks9r44j03-clustering-0.4.1`
  - `out`:  `/nix/store/mkn7hnn8aakwx1gghyhyj6mks9r44j03-clustering-0.4.1`
...
- [[m2mvjzddak5vpaq4n1hkrymcnzjz09mx-clustering-0.4.1.tar.gz]]
