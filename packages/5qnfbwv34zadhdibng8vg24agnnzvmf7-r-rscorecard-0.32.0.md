...
- **Name**: `rPackages.rscorecard`
- **Version**: `0.32.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/rscorecard/](https://cran.r-project.org/web/packages/rscorecard/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/5qnfbwv34zadhdibng8vg24agnnzvmf7-r-rscorecard-0.32.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/5qnfbwv34zadhdibng8vg24agnnzvmf7-r-rscorecard-0.32.0`

## 🔗 Dependencies

- [[6mvy7jqnrh3la9hbkpng9c2iz9rv7x6h-r-purrr-1.1.0]]
- [[98x4ynkzabx1yylxzf57j94s8hr5z2l1-rscorecard_0.32.0.tar.gz]]
