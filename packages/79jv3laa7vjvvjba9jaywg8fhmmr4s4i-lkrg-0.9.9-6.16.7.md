...
- **Name**: `linuxKernel.packages.linux_zen.lkrg`
...
- **Derivation Path**: `/nix/store/79jv3laa7vjvvjba9jaywg8fhmmr4s4i-lkrg-0.9.9-6.16.7.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/lkrg/default.nix:47`
- **Outputs**:
  - `out`:  `/nix/store/79jv3laa7vjvvjba9jaywg8fhmmr4s4i-lkrg-0.9.9-6.16.7`
