...
- **Name**: `rPackages.idmodelr`
- **Version**: `0.4.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://cran.r-project.org/web/packages/idmodelr/](https://cran.r-project.org/web/packages/idmodelr/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/7r318igax4f0aixzcdyxyzpdrdmbqk64-r-idmodelr-0.4.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/7r318igax4f0aixzcdyxyzpdrdmbqk64-r-idmodelr-0.4.0`
...
- [[7v3kjrnb3cxkh3q26dxsnb2kwdvj30r9-idmodelr_0.4.0.tar.gz]]
