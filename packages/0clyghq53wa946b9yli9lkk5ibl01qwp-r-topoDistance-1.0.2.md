...
- **Name**: `rPackages.topoDistance`
- **Version**: `1.0.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/topoDistance/](https://cran.r-project.org/web/packages/topoDistance/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/0clyghq53wa946b9yli9lkk5ibl01qwp-r-topoDistance-1.0.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/0clyghq53wa946b9yli9lkk5ibl01qwp-r-topoDistance-1.0.2`
...
- [[k6m7b31749klp8gdf14kny2ljy1vmkqp-topoDistance_1.0.2.tar.gz]]
