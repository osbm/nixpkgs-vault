...
- **Name**: `rPackages.staccuracy`
- **Version**: `0.2.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/staccuracy/](https://cran.r-project.org/web/packages/staccuracy/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/47m6d8rm9vr65ppfbqayfm0wmha5kfsi-r-staccuracy-0.2.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/47m6d8rm9vr65ppfbqayfm0wmha5kfsi-r-staccuracy-0.2.2`

## 🔗 Dependencies

- [[1iim5fgm923i4vnvm5p06w73rscx3pmv-staccuracy_0.2.2.tar.gz]]
