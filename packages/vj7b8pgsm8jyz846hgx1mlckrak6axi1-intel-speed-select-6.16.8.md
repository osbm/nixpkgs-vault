---
aliases:
  - linuxKernel.packages.linux_xanmod_stable.intel-speed-select
tags:
  - broken
  - not-available
  - license/unknown
...
- **Name**: `linuxKernel.packages.linux_xanmod_stable.intel-speed-select`
- **Version**: `6.16.8`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
...
- **Derivation Path**: `/nix/store/vj7b8pgsm8jyz846hgx1mlckrak6axi1-intel-speed-select-6.16.8.drv`
...
- **Outputs**:
  - `out`:  `/nix/store/vj7b8pgsm8jyz846hgx1mlckrak6axi1-intel-speed-select-6.16.8`
