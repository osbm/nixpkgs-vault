...
- **Name**: `haskellPackages.hls-pragmas-plugin`
- **Version**: `2.6.0.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Pragmas plugin for Haskell Language Server
- **Homepage**: [https://hackage.haskell.org/package/hls-pragmas-plugin](https://hackage.haskell.org/package/hls-pragmas-plugin)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/brvb7wmbvdh78qq05wzgkiz4nby3i6rv-hls-pragmas-plugin-2.6.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:334722`
- **Outputs**:
  - `doc`:  `/nix/store/brvb7wmbvdh78qq05wzgkiz4nby3i6rv-hls-pragmas-plugin-2.6.0.0`
  - `out`:  `/nix/store/brvb7wmbvdh78qq05wzgkiz4nby3i6rv-hls-pragmas-plugin-2.6.0.0`

## 🔗 Dependencies

- [[0awk5ahv6yjs6lgj6j5arkf5g27wk3aq-lsp-types-2.3.0.1]]
- [[1j23d35vbmvwpllxirw70nlpfv61jri0-hls-pragmas-plugin-2.6.0.0.tar.gz]]
