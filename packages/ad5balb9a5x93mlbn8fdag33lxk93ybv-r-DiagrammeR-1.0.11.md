...
- **Name**: `rPackages.DiagrammeR`
- **Version**: `1.0.11`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/DiagrammeR/](https://cran.r-project.org/web/packages/DiagrammeR/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/ad5balb9a5x93mlbn8fdag33lxk93ybv-r-DiagrammeR-1.0.11.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/ad5balb9a5x93mlbn8fdag33lxk93ybv-r-DiagrammeR-1.0.11`
...
- [[gm4dy0mvpjb2js6i0rlla7xr3fcqmdz8-DiagrammeR_1.0.11.tar.gz]]
