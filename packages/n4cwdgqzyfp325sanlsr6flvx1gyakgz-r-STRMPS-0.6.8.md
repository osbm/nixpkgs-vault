...
- **Name**: `rPackages.STRMPS`
- **Version**: `0.6.8`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://cran.r-project.org/web/packages/STRMPS/](https://cran.r-project.org/web/packages/STRMPS/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/n4cwdgqzyfp325sanlsr6flvx1gyakgz-r-STRMPS-0.6.8.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/n4cwdgqzyfp325sanlsr6flvx1gyakgz-r-STRMPS-0.6.8`
...
- [[zwci6yd4rr1njz4zh43ywc8kalw7bcxv-STRMPS_0.6.8.tar.gz]]
