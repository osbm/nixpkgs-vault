...
- **Name**: `haskellPackages.k8s-wrapper`
- **Version**: `0.1.0.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Application wrapper for the k8s environment
- **Homepage**: [https://hackage.haskell.org/package/k8s-wrapper](https://hackage.haskell.org/package/k8s-wrapper)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/xi9gaq56mbxnbk4yvkm18cwhlp6l5fws-k8s-wrapper-0.1.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:396151`
- **Outputs**:
  - `doc`:  `/nix/store/xi9gaq56mbxnbk4yvkm18cwhlp6l5fws-k8s-wrapper-0.1.0.0`
  - `out`:  `/nix/store/xi9gaq56mbxnbk4yvkm18cwhlp6l5fws-k8s-wrapper-0.1.0.0`
...
- [[savfnjvxzi8xsq51rckx2r77svjw7vyf-k8s-wrapper-0.1.0.0.tar.gz]]
