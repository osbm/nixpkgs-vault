...
Execute shell commands to server(s) via ssh protocol
...
- **Homepage**: [https://github.com/pwnwriter/x4](https://github.com/pwnwriter/x4)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/fs050vdw51w7s83rz9a8013cbm2wkq90-x4-0.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/x4/x4/package.nix:37`
- **Outputs**:
  - `out`:  `/nix/store/fs050vdw51w7s83rz9a8013cbm2wkq90-x4-0.1.0`
...
- [[6ljdk9cqfpyn14pcc8bjn0cy600ly8kw-source]]
- [[7d5p0ip9nd3aj3r1a2pmhsxxizqqnis8-openssl-3.5.1]]
- [[bjsb6wdjykafnkixq156qdvmxhsm2bai-bash-5.3p3]]
- [[k1iig59spjdn7dafyns9xl4jw312ax1m-x4-0.1.0-vendor]]
