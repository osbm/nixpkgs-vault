...
- **Name**: `haskellPackages.csv-conduit`
- **Version**: `1.0.1.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: A flexible, fast, conduit-based CSV parser library for Haskell
- **Homepage**: [https://hackage.haskell.org/package/csv-conduit](https://hackage.haskell.org/package/csv-conduit)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/801r96s4fhm7hp5jsjhcscpm64vc5gr2-csv-conduit-1.0.1.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:171735`
- **Outputs**:
  - `doc`:  `/nix/store/801r96s4fhm7hp5jsjhcscpm64vc5gr2-csv-conduit-1.0.1.1`
  - `out`:  `/nix/store/801r96s4fhm7hp5jsjhcscpm64vc5gr2-csv-conduit-1.0.1.1`
...
- [[hxrdlh771ib0hn54d2nim0ja2f4dchld-csv-conduit-1.0.1.1.tar.gz]]
