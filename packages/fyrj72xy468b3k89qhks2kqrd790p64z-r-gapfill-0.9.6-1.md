...
- **Name**: `rPackages.gapfill`
- **Version**: `0.9.6-1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/gapfill/](https://cran.r-project.org/web/packages/gapfill/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/fyrj72xy468b3k89qhks2kqrd790p64z-r-gapfill-0.9.6-1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/fyrj72xy468b3k89qhks2kqrd790p64z-r-gapfill-0.9.6-1`
...
- [[jdnsq60jfkx8lqf16hhzkf6ha7yr9bzj-gapfill_0.9.6-1.tar.gz]]
