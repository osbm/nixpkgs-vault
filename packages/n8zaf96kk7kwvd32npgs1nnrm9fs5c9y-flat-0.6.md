...
- **Name**: `haskellPackages.flat`
- **Version**: `0.6`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Principled and efficient bit-oriented binary serialization
- **Homepage**: [https://hackage.haskell.org/package/flat](https://hackage.haskell.org/package/flat)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/n8zaf96kk7kwvd32npgs1nnrm9fs5c9y-flat-0.6.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:236575`
- **Outputs**:
  - `doc`:  `/nix/store/n8zaf96kk7kwvd32npgs1nnrm9fs5c9y-flat-0.6`
  - `out`:  `/nix/store/n8zaf96kk7kwvd32npgs1nnrm9fs5c9y-flat-0.6`
...
- [[ki5iyd36jp3222781n0j5jsfhn11hnib-flat-0.6.tar.gz]]
