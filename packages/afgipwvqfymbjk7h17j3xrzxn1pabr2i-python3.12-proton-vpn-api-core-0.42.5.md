...
Acts as a facade to the other Proton VPN components, exposing a uniform API to the available Proton VPN services

## 📋 Package Information

- **Name**: `python312Packages.proton-vpn-api-core`
- **Version**: `0.42.5`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Homepage**: [https://github.com/ProtonVPN/python-proton-vpn-api-core](https://github.com/ProtonVPN/python-proton-vpn-api-core)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/afgipwvqfymbjk7h17j3xrzxn1pabr2i-python3.12-proton-vpn-api-core-0.42.5.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/proton-vpn-api-core/default.nix:84`
- **Outputs**:
  - `dist`:  `/nix/store/afgipwvqfymbjk7h17j3xrzxn1pabr2i-python3.12-proton-vpn-api-core-0.42.5`
  - `out`:  `/nix/store/afgipwvqfymbjk7h17j3xrzxn1pabr2i-python3.12-proton-vpn-api-core-0.42.5`
...
- [[axmq719nkn92fjyy7x0ha4ivswymbk8l-python3.12-proton-core-0.4.0]]
...
- [[flsyhls3d24i3xvxwvsc8anawh9i4x1s-source]]
