...
New XNAT client (distinct from pyxnat) that exposes XNAT objects/functions as Python objects/functions

## 📋 Package Information

- **Name**: `python313Packages.xnatpy`
- **Version**: `0.7.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: New XNAT client (distinct from pyxnat) that exposes XNAT objects/functions as Python objects/functions
- **Homepage**: [https://xnat.readthedocs.io](https://xnat.readthedocs.io)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/i99xdy2xd3pdpcmmwbvhdszxj84cdkn4-python3.13-xnatpy-0.7.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/xnatpy/default.nix:60`
- **Outputs**:
  - `dist`:  `/nix/store/i99xdy2xd3pdpcmmwbvhdszxj84cdkn4-python3.13-xnatpy-0.7.2`
  - `out`:  `/nix/store/i99xdy2xd3pdpcmmwbvhdszxj84cdkn4-python3.13-xnatpy-0.7.2`
...
- [[dikbw54r9c6varx3rrhycg2sn2qw1prn-xnat-0.7.2.tar.gz]]
