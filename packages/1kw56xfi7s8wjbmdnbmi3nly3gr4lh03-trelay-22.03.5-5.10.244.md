---
aliases:
  - linuxKernel.packages.linux_5_10.trelay
tags:
  - license/unknown
...
- **Name**: `linuxKernel.packages.linux_5_10.trelay`
- **Version**: `22.03.5-5.10.244`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/1kw56xfi7s8wjbmdnbmi3nly3gr4lh03-trelay-22.03.5-5.10.244.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/trelay/default.nix:41`
- **Outputs**:
  - `out`:  `/nix/store/1kw56xfi7s8wjbmdnbmi3nly3gr4lh03-trelay-22.03.5-5.10.244`
