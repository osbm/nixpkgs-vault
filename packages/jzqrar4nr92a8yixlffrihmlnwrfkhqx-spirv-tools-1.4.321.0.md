...
SPIR-V Tools project provides an API and commands for processing SPIR-V modules
...
- **Derivation Path**: `/nix/store/jzqrar4nr92a8yixlffrihmlnwrfkhqx-spirv-tools-1.4.321.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/sp/spirv-tools/package.nix:54`
- **Outputs**:
  - `out`:  `/nix/store/jzqrar4nr92a8yixlffrihmlnwrfkhqx-spirv-tools-1.4.321.0`
