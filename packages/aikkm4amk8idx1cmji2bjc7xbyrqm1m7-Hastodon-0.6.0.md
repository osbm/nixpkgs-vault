...
- **Name**: `haskellPackages.Hastodon`
- **Version**: `0.6.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: mastodon client module for Haskell
- **Homepage**: [https://hackage.haskell.org/package/Hastodon](https://hackage.haskell.org/package/Hastodon)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/aikkm4amk8idx1cmji2bjc7xbyrqm1m7-Hastodon-0.6.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:22471`
- **Outputs**:
  - `doc`:  `/nix/store/aikkm4amk8idx1cmji2bjc7xbyrqm1m7-Hastodon-0.6.0`
  - `out`:  `/nix/store/aikkm4amk8idx1cmji2bjc7xbyrqm1m7-Hastodon-0.6.0`
...
- [[fb9lm7ifh34vrq926r0rv2ys0xchnkvn-Hastodon-0.6.0.tar.gz]]
