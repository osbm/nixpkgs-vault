...
- **Name**: `haskellPackages.jl`
- **Version**: `0.1.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Functional sed for JSON
- **Homepage**: [https://hackage.haskell.org/package/jl](https://hackage.haskell.org/package/jl)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/xcmwab64p61677p1w205pzwwb3l5cnqi-jl-0.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:389812`
- **Outputs**:
  - `doc`:  `/nix/store/xcmwab64p61677p1w205pzwwb3l5cnqi-jl-0.1.0`
  - `out`:  `/nix/store/xcmwab64p61677p1w205pzwwb3l5cnqi-jl-0.1.0`
...
- [[ymv8d7ig75w8a0614yffv1nr29wky8py-jl-0.1.0.tar.gz]]
