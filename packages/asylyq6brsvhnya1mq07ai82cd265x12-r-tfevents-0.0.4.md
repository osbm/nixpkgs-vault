...
- **Name**: `rPackages.tfevents`
- **Version**: `0.0.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/tfevents/](https://cran.r-project.org/web/packages/tfevents/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/asylyq6brsvhnya1mq07ai82cd265x12-r-tfevents-0.0.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/asylyq6brsvhnya1mq07ai82cd265x12-r-tfevents-0.0.4`
...
- [[imwnvnjpa4sz7gkdrmm6xqf19ksr3af7-tfevents_0.0.4.tar.gz]]
