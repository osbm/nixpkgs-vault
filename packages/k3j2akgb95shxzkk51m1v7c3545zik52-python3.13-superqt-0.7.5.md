...
- **Name**: `python313Packages.superqt`
- **Version**: `0.7.5`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/k3j2akgb95shxzkk51m1v7c3545zik52-python3.13-superqt-0.7.5.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/superqt/default.nix:61`
- **Outputs**:
  - `dist`:  `/nix/store/k3j2akgb95shxzkk51m1v7c3545zik52-python3.13-superqt-0.7.5`
  - `out`:  `/nix/store/k3j2akgb95shxzkk51m1v7c3545zik52-python3.13-superqt-0.7.5`
