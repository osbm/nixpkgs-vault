...
- **Name**: `linuxKernel.packages.linux_5_10.cpupower`
- **Version**: `5.10.244`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/gmv4n9mh8im4b4nbb4s1lm1dacbfli2h-cpupower-5.10.244.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/cpupower/default.nix:51`
- **Outputs**:
  - `out`:  `/nix/store/gmv4n9mh8im4b4nbb4s1lm1dacbfli2h-cpupower-5.10.244`
