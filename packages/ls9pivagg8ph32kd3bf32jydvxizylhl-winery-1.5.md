...
- **Name**: `haskellPackages.winery`
- **Version**: `1.5`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: A compact, well-typed seralisation format for Haskell values
- **Homepage**: [https://hackage.haskell.org/package/winery](https://hackage.haskell.org/package/winery)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/ls9pivagg8ph32kd3bf32jydvxizylhl-winery-1.5.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:723798`
- **Outputs**:
  - `doc`:  `/nix/store/ls9pivagg8ph32kd3bf32jydvxizylhl-winery-1.5`
  - `out`:  `/nix/store/ls9pivagg8ph32kd3bf32jydvxizylhl-winery-1.5`
...
- [[m4yr44fllffxc6w6la58rqbk2shrlasq-winery-1.5.tar.gz]]
