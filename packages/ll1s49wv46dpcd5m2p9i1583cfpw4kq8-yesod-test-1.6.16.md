...
- **Name**: `haskellPackages.yesod-test`
- **Version**: `1.6.16`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/ll1s49wv46dpcd5m2p9i1583cfpw4kq8-yesod-test-1.6.16.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:742956`
- **Outputs**:
  - `doc`:  `/nix/store/ll1s49wv46dpcd5m2p9i1583cfpw4kq8-yesod-test-1.6.16`
  - `out`:  `/nix/store/ll1s49wv46dpcd5m2p9i1583cfpw4kq8-yesod-test-1.6.16`
...
- [[id4wryf3ivrkahfqiqkya3kgzly9bcjb-yesod-test-1.6.16.tar.gz]]
