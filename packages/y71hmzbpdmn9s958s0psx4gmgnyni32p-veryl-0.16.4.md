...
- **Homepage**: [https://veryl-lang.org/](https://veryl-lang.org/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/y71hmzbpdmn9s958s0psx4gmgnyni32p-veryl-0.16.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/ve/veryl/package.nix:73`
- **Outputs**:
  - `out`:  `/nix/store/y71hmzbpdmn9s958s0psx4gmgnyni32p-veryl-0.16.4`
...
- [[slsjwlrgvwvy98x22nvrsflgd9rd70dz-source]]
- [[xqxbqs6qgnhvpkcai046s94jfrx8wb62-cargo-check-hook.sh]]
- [[z695ql5xcnip86m164248xr6vkgf9vga-install-shell-files]]
- [[zchkksww26f4gvkg37qc0ilq6d7n64lc-veryl-0.16.4-vendor]]
