...
Command line tool to view objects (JSON/YAML/TOML/XML) in TUI tree widget
...
- **Homepage**: [https://github.com/fioncat/otree](https://github.com/fioncat/otree)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/7slrx6p1xrdjc393dw5w8m34avfimj3i-otree-0.6.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/ot/otree/package.nix:21`
- **Outputs**:
  - `out`:  `/nix/store/7slrx6p1xrdjc393dw5w8m34avfimj3i-otree-0.6.1`
...
- [[6hry2s3a00mhcm806p7861px5s74a6yk-otree-0.6.1-vendor]]
- [[bjsb6wdjykafnkixq156qdvmxhsm2bai-bash-5.3p3]]
- [[mg4vqa9n4wbipmimyk3cvdffczl6gysl-source]]
