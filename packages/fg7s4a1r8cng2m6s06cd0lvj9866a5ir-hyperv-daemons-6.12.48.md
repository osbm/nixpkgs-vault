---
aliases:
  - linuxKernel.packages.linux_libre.hyperv-daemons
tags:
  - license/unknown
...
- **Name**: `linuxKernel.packages.linux_libre.hyperv-daemons`
- **Version**: `6.12.48`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/fg7s4a1r8cng2m6s06cd0lvj9866a5ir-hyperv-daemons-6.12.48.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/hyperv-daemons/default.nix:123`
- **Outputs**:
  - `bin`:  `/nix/store/fg7s4a1r8cng2m6s06cd0lvj9866a5ir-hyperv-daemons-6.12.48`
  - `lib`:  `/nix/store/fg7s4a1r8cng2m6s06cd0lvj9866a5ir-hyperv-daemons-6.12.48`
  - `out`:  `/nix/store/fg7s4a1r8cng2m6s06cd0lvj9866a5ir-hyperv-daemons-6.12.48`

## 🔗 Dependencies

- [[68zm1w0dlhn72xnd0783f40670nlg1mp-hyperv-daemons-bin-6.12.48]]
