...
- **Name**: `rPackages.methrix`
- **Version**: `1.22.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://bioconductor.org/packages/3.21/bioc/html/methrix.html](https://bioconductor.org/packages/3.21/bioc/html/methrix.html)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/qi0b6ibyhzxah1csmi38vm7yzwpz0xsl-r-methrix-1.22.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/qi0b6ibyhzxah1csmi38vm7yzwpz0xsl-r-methrix-1.22.1`

## 🔗 Dependencies

- [[1cq96kfqws9dn29rg178mrzmg7248k4d-r-IRanges-2.42.0]]
- [[1dajh6avhqxdqzp87195jswli59k5w5f-methrix_1.22.1.tar.gz]]
