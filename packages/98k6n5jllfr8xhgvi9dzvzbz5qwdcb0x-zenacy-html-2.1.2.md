...
- **Name**: `haskellPackages.zenacy-html`
- **Version**: `2.1.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: A standard compliant HTML parsing library
- **Homepage**: [https://hackage.haskell.org/package/zenacy-html](https://hackage.haskell.org/package/zenacy-html)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/98k6n5jllfr8xhgvi9dzvzbz5qwdcb0x-zenacy-html-2.1.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:746054`
- **Outputs**:
  - `doc`:  `/nix/store/98k6n5jllfr8xhgvi9dzvzbz5qwdcb0x-zenacy-html-2.1.2`
  - `out`:  `/nix/store/98k6n5jllfr8xhgvi9dzvzbz5qwdcb0x-zenacy-html-2.1.2`
...
- [[8szsaqns0m8zswp14ci2lhf0vinxha66-zenacy-html-2.1.2.tar.gz]]
