---
aliases:
  - linuxKernel.packages.linux_xanmod_stable.sheep-net
tags:
  - license/unknown
...
- **Name**: `linuxKernel.packages.linux_xanmod_stable.sheep-net`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/fcpyzxr6pn4rxpq3gjxbazmwpwwzakhv-sheep_net.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/sheep-net/default.nix:10`
- **Outputs**:
  - `out`:  `/nix/store/fcpyzxr6pn4rxpq3gjxbazmwpwwzakhv-sheep_net`
