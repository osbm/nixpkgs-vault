...
Checksum plugin for Reposilite.

## 📋 Package Information

- **Name**: `reposilitePlugins.checksum`
- **Version**: `3.5.25-all.jar`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Checksum plugin for Reposilite.
...
- **Derivation Path**: `/nix/store/fcpxv1p0kdiwzpi5pfpc6iw1lfb58j0l-checksum-plugin-3.5.25-all.jar.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/re/reposilite/plugins.nix:35`
- **Outputs**:
  - `out`:  `/nix/store/fcpxv1p0kdiwzpi5pfpc6iw1lfb58j0l-checksum-plugin-3.5.25-all.jar`
