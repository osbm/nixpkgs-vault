...
- **Name**: `rPackages.rmcfs`
- **Version**: `1.3.6`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/rmcfs/](https://cran.r-project.org/web/packages/rmcfs/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/59y6h7h6hck4jgd4w2na6qzml34m5mvk-r-rmcfs-1.3.6.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/59y6h7h6hck4jgd4w2na6qzml34m5mvk-r-rmcfs-1.3.6`
...
- [[pkamlafh2y9rknglbz73yp1r74azgnxz-rmcfs_1.3.6.tar.gz]]
