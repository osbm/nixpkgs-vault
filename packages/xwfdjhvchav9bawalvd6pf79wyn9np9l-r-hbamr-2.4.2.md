...
- **Name**: `rPackages.hbamr`
- **Version**: `2.4.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/hbamr/](https://cran.r-project.org/web/packages/hbamr/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/xwfdjhvchav9bawalvd6pf79wyn9np9l-r-hbamr-2.4.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/xwfdjhvchav9bawalvd6pf79wyn9np9l-r-hbamr-2.4.2`
...
- [[skk5ij0szs6z4vp5gl0prldj5bgx6wsn-hbamr_2.4.2.tar.gz]]
