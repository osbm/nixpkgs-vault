...
Markdown viewer TUI for the terminal, with big text and image rendering
...
- **Homepage**: [https://github.com/benjajaja/mdfried](https://github.com/benjajaja/mdfried)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/r5w0r4ciqxka2qra5wyhjwb2xxn4m7kh-mdfried-0.12.6.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/md/mdfried/package.nix:23`
- **Outputs**:
  - `out`:  `/nix/store/r5w0r4ciqxka2qra5wyhjwb2xxn4m7kh-mdfried-0.12.6`
...
- [[7c4dd5w7j589hvq313f3bhs2aqqhp679-source]]
- [[bjsb6wdjykafnkixq156qdvmxhsm2bai-bash-5.3p3]]
- [[krnlr16misb58ri1k4m3cz89jg53fhz3-mdfried-0.12.6-vendor]]
