...
- **Name**: `haskellPackages.horizontal-rule`
- **Version**: `0.7.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: horizontal rule for the terminal
- **Homepage**: [https://hackage.haskell.org/package/horizontal-rule](https://hackage.haskell.org/package/horizontal-rule)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/iglbp3rzbib33y34b9ipawhvaqf2pwhm-horizontal-rule-0.7.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:341553`
- **Outputs**:
  - `doc`:  `/nix/store/iglbp3rzbib33y34b9ipawhvaqf2pwhm-horizontal-rule-0.7.0.0`
  - `out`:  `/nix/store/iglbp3rzbib33y34b9ipawhvaqf2pwhm-horizontal-rule-0.7.0.0`
...
- [[63vzpfhyk85z6b05hxcgq0wpvv1z6vf5-horizontal-rule-0.7.0.0-r2.cabal]]
...
- [[sbl3mbd9lic3zsczms5slxaq79x3zpfm-horizontal-rule-0.7.0.0.tar.gz]]
