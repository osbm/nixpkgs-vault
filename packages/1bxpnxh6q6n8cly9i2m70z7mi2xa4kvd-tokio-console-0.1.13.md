...
Debugger for asynchronous Rust code
...
- **Homepage**: [https://github.com/tokio-rs/console](https://github.com/tokio-rs/console)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/1bxpnxh6q6n8cly9i2m70z7mi2xa4kvd-tokio-console-0.1.13.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/to/tokio-console/package.nix:48`
- **Outputs**:
  - `out`:  `/nix/store/1bxpnxh6q6n8cly9i2m70z7mi2xa4kvd-tokio-console-0.1.13`
...
- [[4vysjfs4p5iir1xnmwsalj1wg48l205s-tokio-console-0.1.13-vendor]]
- [[bjsb6wdjykafnkixq156qdvmxhsm2bai-bash-5.3p3]]
- [[jb6qgh73k1qc3js559njzkar321kqq5v-source]]
