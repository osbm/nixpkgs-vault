...
- **Name**: `python313Packages.pyrealsense2WithCuda`
- **Version**: `2.56.3`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/g6rd3s0va4vm1gfyyycqcfjq3ldfb1wb-librealsense-2.56.3.drv`
...
- **Outputs**:
  - `dev`:  `/nix/store/g6rd3s0va4vm1gfyyycqcfjq3ldfb1wb-librealsense-2.56.3`
  - `out`:  `/nix/store/g6rd3s0va4vm1gfyyycqcfjq3ldfb1wb-librealsense-2.56.3`
