...
Jsonaf backend for decoders

## 📋 Package Information

- **Name**: `ocamlPackages.decoders-jsonaf`
- **Version**: `1.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/wr09f37vla5c4wj8b6wfs8zkw8s8kwhb-ocaml5.3.0-decoders-jsonaf-1.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/ocaml-modules/decoders-jsonaf/default.nix:30`
- **Outputs**:
  - `out`:  `/nix/store/wr09f37vla5c4wj8b6wfs8zkw8s8kwhb-ocaml5.3.0-decoders-jsonaf-1.0.0`
