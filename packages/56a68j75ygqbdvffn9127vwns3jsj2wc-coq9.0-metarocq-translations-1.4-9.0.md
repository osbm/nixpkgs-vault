---
aliases:
  - coqPackages.metarocq-translations
tags:
  - license/unknown
...
- **Name**: `coqPackages.metarocq-translations`
- **Version**: `1.4-9.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/56a68j75ygqbdvffn9127vwns3jsj2wc-coq9.0-metarocq-translations-1.4-9.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/build-support/coq/default.nix:188`
- **Outputs**:
  - `out`:  `/nix/store/56a68j75ygqbdvffn9127vwns3jsj2wc-coq9.0-metarocq-translations-1.4-9.0`
