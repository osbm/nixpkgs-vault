...
- **Name**: `akkuPackages.bcaine-defstruct`
- **Version**: `0.0.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: A more convenient version of `define-record-type`, inspired by Chicken's `defstruct`, including SRFI-17 setters
- **Homepage**: []()
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/n8ihx3bgbchnz22xd7rm2rkxkv7nbdrq-akku-bcaine-defstruct-0.0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/tools/package-management/akku/default.nix:39`
- **Outputs**:
  - `out`:  `/nix/store/n8ihx3bgbchnz22xd7rm2rkxkv7nbdrq-akku-bcaine-defstruct-0.0.1`
...
- [[x02bj7c0pm7msik7fw84fabycfl298qc-bcaine-defstruct-0.0.1.tgz]]
