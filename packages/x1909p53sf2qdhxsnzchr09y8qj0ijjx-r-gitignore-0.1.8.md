...
- **Name**: `rPackages.gitignore`
- **Version**: `0.1.8`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/gitignore/](https://cran.r-project.org/web/packages/gitignore/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/x1909p53sf2qdhxsnzchr09y8qj0ijjx-r-gitignore-0.1.8.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/x1909p53sf2qdhxsnzchr09y8qj0ijjx-r-gitignore-0.1.8`
...
- [[lj98n7hh98i2vqc7aarsmsfrg2fmkw8m-gitignore_0.1.8.tar.gz]]
