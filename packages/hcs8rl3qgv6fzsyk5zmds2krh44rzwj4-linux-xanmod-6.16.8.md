...
- **Name**: `linuxKernel.kernels.linux_xanmod_stable`
- **Version**: `6.16.8`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/hcs8rl3qgv6fzsyk5zmds2krh44rzwj4-linux-xanmod-6.16.8.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/kernel/xanmod-kernels.nix:39`
- **Outputs**:
  - `dev`:  `/nix/store/hcs8rl3qgv6fzsyk5zmds2krh44rzwj4-linux-xanmod-6.16.8`
  - `modules`:  `/nix/store/hcs8rl3qgv6fzsyk5zmds2krh44rzwj4-linux-xanmod-6.16.8`
  - `out`:  `/nix/store/hcs8rl3qgv6fzsyk5zmds2krh44rzwj4-linux-xanmod-6.16.8`
...
- [[p639rjc4r995v3b451r20nkfdahgmds1-linux-config-6.16.8]]
