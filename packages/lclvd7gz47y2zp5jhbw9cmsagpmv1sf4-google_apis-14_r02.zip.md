---
aliases:
  - androidenv.androidPkgs.all.addons.v14.google_apis
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.addons.v14.google_apis`
- **Version**: `14_r02.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/lclvd7gz47y2zp5jhbw9cmsagpmv1sf4-google_apis-14_r02.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/lclvd7gz47y2zp5jhbw9cmsagpmv1sf4-google_apis-14_r02.zip`
