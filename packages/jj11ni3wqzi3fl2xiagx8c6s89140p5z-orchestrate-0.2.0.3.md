...
- **Name**: `haskellPackages.orchestrate`
- **Version**: `0.2.0.3`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: An API client for http://orchestrate.io/.
- **Homepage**: [https://hackage.haskell.org/package/orchestrate](https://hackage.haskell.org/package/orchestrate)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/jj11ni3wqzi3fl2xiagx8c6s89140p5z-orchestrate-0.2.0.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:495094`
- **Outputs**:
  - `doc`:  `/nix/store/jj11ni3wqzi3fl2xiagx8c6s89140p5z-orchestrate-0.2.0.3`
  - `out`:  `/nix/store/jj11ni3wqzi3fl2xiagx8c6s89140p5z-orchestrate-0.2.0.3`
...
- [[sr4ysynzvh00226af2g99s7v60gp6z4j-orchestrate-0.2.0.3.tar.gz]]
