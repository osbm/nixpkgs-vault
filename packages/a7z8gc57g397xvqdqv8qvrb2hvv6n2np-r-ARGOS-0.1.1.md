...
- **Name**: `rPackages.ARGOS`
- **Version**: `0.1.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/ARGOS/](https://cran.r-project.org/web/packages/ARGOS/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/a7z8gc57g397xvqdqv8qvrb2hvv6n2np-r-ARGOS-0.1.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/a7z8gc57g397xvqdqv8qvrb2hvv6n2np-r-ARGOS-0.1.1`
...
- [[lrgs9y7srvydmqff7jpbyb01wi664ksf-ARGOS_0.1.1.tar.gz]]
