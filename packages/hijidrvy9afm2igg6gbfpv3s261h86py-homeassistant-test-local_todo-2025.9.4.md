---
aliases:
  - home-assistant-component-tests.local_todo
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.local_todo`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/hijidrvy9afm2igg6gbfpv3s261h86py-homeassistant-test-local_todo-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/hijidrvy9afm2igg6gbfpv3s261h86py-homeassistant-test-local_todo-2025.9.4`
