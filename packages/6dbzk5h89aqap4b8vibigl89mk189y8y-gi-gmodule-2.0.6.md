...
- **Name**: `haskellPackages.gi-gmodule`
- **Version**: `2.0.6`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: GModule bindings
- **Homepage**: [https://hackage.haskell.org/package/gi-gmodule](https://hackage.haskell.org/package/gi-gmodule)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/6dbzk5h89aqap4b8vibigl89mk189y8y-gi-gmodule-2.0.6.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:264930`
- **Outputs**:
  - `doc`:  `/nix/store/6dbzk5h89aqap4b8vibigl89mk189y8y-gi-gmodule-2.0.6`
  - `out`:  `/nix/store/6dbzk5h89aqap4b8vibigl89mk189y8y-gi-gmodule-2.0.6`
...
- [[c8g7jmgl44yqqp6zim78ni21ss28pdka-gi-gmodule-2.0.6.tar.gz]]
