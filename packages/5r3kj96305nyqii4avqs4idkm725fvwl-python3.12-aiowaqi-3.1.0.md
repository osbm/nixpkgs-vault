...
- **Name**: `python312Packages.aiowaqi`
- **Version**: `3.1.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/5r3kj96305nyqii4avqs4idkm725fvwl-python3.12-aiowaqi-3.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/aiowaqi/default.nix:57`
- **Outputs**:
  - `dist`:  `/nix/store/5r3kj96305nyqii4avqs4idkm725fvwl-python3.12-aiowaqi-3.1.0`
  - `out`:  `/nix/store/5r3kj96305nyqii4avqs4idkm725fvwl-python3.12-aiowaqi-3.1.0`
