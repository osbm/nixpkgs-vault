...
- **Name**: `python313Packages.trectools`
- **Version**: `0.0.50`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Library for assisting Information Retrieval (IR) practitioners with TREC-like campaigns
- **Homepage**: [https://github.com/joaopalotti/trectools](https://github.com/joaopalotti/trectools)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/2xrxcsi19xr3n22iwvwjyi15l7ykcd3b-python3.13-trectools-0.0.50.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/trectools/default.nix:64`
- **Outputs**:
  - `dist`:  `/nix/store/2xrxcsi19xr3n22iwvwjyi15l7ykcd3b-python3.13-trectools-0.0.50`
  - `out`:  `/nix/store/2xrxcsi19xr3n22iwvwjyi15l7ykcd3b-python3.13-trectools-0.0.50`
...
- [[bjicc4gcrgs1wrb2xpb1jhqiz6b7cfhf-source]]
