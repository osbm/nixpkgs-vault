...
- **Name**: `haskellPackages.webgear-server`
- **Version**: `1.3.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/smz361q9nkf19sf0jsvlnngwr98f5v9n-webgear-server-1.3.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:720215`
- **Outputs**:
  - `doc`:  `/nix/store/smz361q9nkf19sf0jsvlnngwr98f5v9n-webgear-server-1.3.1`
  - `out`:  `/nix/store/smz361q9nkf19sf0jsvlnngwr98f5v9n-webgear-server-1.3.1`

## 🔗 Dependencies

- [[0jk9igvcynf8dh9n7zrqms788p08jg0b-arrows-0.4.4.2]]
- [[2pr652igq6awvbbf5rfnb3kbrmg1cryf-http-types-0.12.4]]
- [[2zmdwnsjgz0zqmsh8nmrhrzr2wzp6k6m-webgear-server-1.3.1.tar.gz]]
