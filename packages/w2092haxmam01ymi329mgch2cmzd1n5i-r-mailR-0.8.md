...
- **Name**: `rPackages.mailR`
- **Version**: `0.8`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/mailR/](https://cran.r-project.org/web/packages/mailR/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/w2092haxmam01ymi329mgch2cmzd1n5i-r-mailR-0.8.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/w2092haxmam01ymi329mgch2cmzd1n5i-r-mailR-0.8`

## 🔗 Dependencies

- [[1029a104w2h4nb366m8kcs4pbhbdq49h-mailR_0.8.tar.gz]]
