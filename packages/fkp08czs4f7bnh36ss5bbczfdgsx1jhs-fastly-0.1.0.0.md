...
- **Name**: `haskellPackages.fastly`
- **Version**: `0.1.0.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: A highly experimental Fastly API client
- **Homepage**: [https://hackage.haskell.org/package/fastly](https://hackage.haskell.org/package/fastly)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/fkp08czs4f7bnh36ss5bbczfdgsx1jhs-fastly-0.1.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:228264`
- **Outputs**:
  - `doc`:  `/nix/store/fkp08czs4f7bnh36ss5bbczfdgsx1jhs-fastly-0.1.0.0`
  - `out`:  `/nix/store/fkp08czs4f7bnh36ss5bbczfdgsx1jhs-fastly-0.1.0.0`
...
- [[7ymg9kfhxrkhgcihnk100w6h5x1g8qlb-fastly-0.1.0.0.tar.gz]]
