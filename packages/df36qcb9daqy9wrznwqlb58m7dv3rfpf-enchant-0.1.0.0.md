...
- **Name**: `haskellPackages.enchant`
- **Version**: `0.1.0.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Binding to the Enchant library
- **Homepage**: [https://hackage.haskell.org/package/enchant](https://hackage.haskell.org/package/enchant)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/df36qcb9daqy9wrznwqlb58m7dv3rfpf-enchant-0.1.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:214880`
- **Outputs**:
  - `doc`:  `/nix/store/df36qcb9daqy9wrznwqlb58m7dv3rfpf-enchant-0.1.0.0`
  - `out`:  `/nix/store/df36qcb9daqy9wrznwqlb58m7dv3rfpf-enchant-0.1.0.0`
...
- [[zm2sily67b2jmz6m1p18pkp8c0ywhgg2-enchant-0.1.0.0.tar.gz]]
