---
aliases:
  - androidenv.androidPkgs.all.system-images.v31.default.arm64-v8a
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.system-images.v31.default.arm64-v8a`
- **Version**: `31_r03.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/vsnmdds0g6pm0382xjd5w4m6h3j64bm1-arm64-v8a-31_r03.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/vsnmdds0g6pm0382xjd5w4m6h3j64bm1-arm64-v8a-31_r03.zip`
