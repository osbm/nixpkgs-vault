...
- **Name**: `python313Packages.django-auditlog`
- **Version**: `3.2.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/89zwki44ysvx28hwiql89ldd2vpvc58c-python3.13-django-auditlog-3.2.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/django-auditlog/default.nix:68`
- **Outputs**:
  - `dist`:  `/nix/store/89zwki44ysvx28hwiql89ldd2vpvc58c-python3.13-django-auditlog-3.2.1`
  - `out`:  `/nix/store/89zwki44ysvx28hwiql89ldd2vpvc58c-python3.13-django-auditlog-3.2.1`
...
- [[hjyd4hs21m5n2y0pclvk099b1g31bz7q-source]]
