...
- **Name**: `haskellPackages.dormouse-uri`
- **Version**: `0.3.0.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Library for type-safe representations of Uri/Urls
- **Homepage**: [https://hackage.haskell.org/package/dormouse-uri](https://hackage.haskell.org/package/dormouse-uri)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/8lczijzkk4jpyi9901aa4gzcq5zica8v-dormouse-uri-0.3.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:202390`
- **Outputs**:
  - `doc`:  `/nix/store/8lczijzkk4jpyi9901aa4gzcq5zica8v-dormouse-uri-0.3.0.0`
  - `out`:  `/nix/store/8lczijzkk4jpyi9901aa4gzcq5zica8v-dormouse-uri-0.3.0.0`
...
- [[pggzw9ry1s996g6nng0psrkralrfjc4q-dormouse-uri-0.3.0.0.tar.gz]]
