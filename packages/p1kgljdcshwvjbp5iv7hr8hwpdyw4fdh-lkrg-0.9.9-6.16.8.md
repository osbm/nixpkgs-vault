---
aliases:
  - linuxKernel.packages.linux_xanmod_stable.lkrg
tags:
  - license/unknown
  - maintainers/chivay
  - outputs/out
...
- **Name**: `linuxKernel.packages.linux_xanmod_stable.lkrg`
- **Version**: `0.9.9-6.16.8`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/p1kgljdcshwvjbp5iv7hr8hwpdyw4fdh-lkrg-0.9.9-6.16.8.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/lkrg/default.nix:47`
- **Outputs**:
  - `out`:  `/nix/store/p1kgljdcshwvjbp5iv7hr8hwpdyw4fdh-lkrg-0.9.9-6.16.8`
