...
- **Name**: `linuxKernel.kernels.linux_5_15`
- **Version**: `5.15.193`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/1arldm9b7al3nimanggan91gsjxql1yb-linux-5.15.193.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/kernel/mainline.nix:34`
- **Outputs**:
  - `dev`:  `/nix/store/1arldm9b7al3nimanggan91gsjxql1yb-linux-5.15.193`
  - `modules`:  `/nix/store/1arldm9b7al3nimanggan91gsjxql1yb-linux-5.15.193`
  - `out`:  `/nix/store/1arldm9b7al3nimanggan91gsjxql1yb-linux-5.15.193`
...
- [[y5c84bz0rmvw3s2phbbhb813s28ml1ss-linux-config-5.15.193]]
