---
aliases:
  - haskellPackages.streaming-process
tags:
  - license/unknown
  - outputs/doc
  - outputs/out
...
- **Name**: `haskellPackages.streaming-process`
- **Version**: `0.1.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Streaming support for running system process
- **Homepage**: [https://hackage.haskell.org/package/streaming-process](https://hackage.haskell.org/package/streaming-process)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/sx7z0d4147s6mj4gy5xh7rbsqmgvd1f6-streaming-process-0.1.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:639822`
- **Outputs**:
  - `doc`:  `/nix/store/sx7z0d4147s6mj4gy5xh7rbsqmgvd1f6-streaming-process-0.1.0.0`
  - `out`:  `/nix/store/sx7z0d4147s6mj4gy5xh7rbsqmgvd1f6-streaming-process-0.1.0.0`
...
- [[cq5cywj2l68ky3ss2brik8yi6rmq8jlj-streaming-concurrency-0.3.1.3]]
...
- [[x0znydfl899x24s4lvi4m8nswh40s6by-streaming-process-0.1.0.0.tar.gz]]
