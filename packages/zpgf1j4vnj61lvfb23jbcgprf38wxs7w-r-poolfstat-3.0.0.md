...
- **Name**: `rPackages.poolfstat`
- **Version**: `3.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/poolfstat/](https://cran.r-project.org/web/packages/poolfstat/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/zpgf1j4vnj61lvfb23jbcgprf38wxs7w-r-poolfstat-3.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/zpgf1j4vnj61lvfb23jbcgprf38wxs7w-r-poolfstat-3.0.0`

## 🔗 Dependencies

- [[386i5algdy8gdxfznfa64p8mh0s651xb-r-Rcpp-1.1.0]]
- [[9nvzldflxzi9rsz4z8yk79dgvq1bizmb-poolfstat_3.0.0.tar.gz]]
