...
- **Name**: `rPackages.ISLET`
- **Version**: `1.10.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://bioconductor.org/packages/3.21/bioc/html/ISLET.html](https://bioconductor.org/packages/3.21/bioc/html/ISLET.html)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/f23sdvqkwwxd2ip5xl30p8pddby6a6gd-r-ISLET-1.10.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/f23sdvqkwwxd2ip5xl30p8pddby6a6gd-r-ISLET-1.10.0`
...
- [[mnprm8536rbakf0yah01qb27ii7n33cg-ISLET_1.10.0.tar.gz]]
