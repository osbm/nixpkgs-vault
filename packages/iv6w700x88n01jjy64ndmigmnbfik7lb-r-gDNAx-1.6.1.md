...
- **Name**: `rPackages.gDNAx`
- **Version**: `1.6.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://bioconductor.org/packages/3.21/bioc/html/gDNAx.html](https://bioconductor.org/packages/3.21/bioc/html/gDNAx.html)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/iv6w700x88n01jjy64ndmigmnbfik7lb-r-gDNAx-1.6.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/iv6w700x88n01jjy64ndmigmnbfik7lb-r-gDNAx-1.6.1`
...
- [[lw6j541p7w2qqpdyxib1s8kczxvjwv39-gDNAx_1.6.1.tar.gz]]
