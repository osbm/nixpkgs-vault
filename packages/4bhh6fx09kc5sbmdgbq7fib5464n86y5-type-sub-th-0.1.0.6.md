...
- **Name**: `haskellPackages.type-sub-th`
- **Version**: `0.1.0.6`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Substitute types for other types with Template Haskell
- **Homepage**: [https://hackage.haskell.org/package/type-sub-th](https://hackage.haskell.org/package/type-sub-th)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/4bhh6fx09kc5sbmdgbq7fib5464n86y5-type-sub-th-0.1.0.6.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:690460`
- **Outputs**:
  - `doc`:  `/nix/store/4bhh6fx09kc5sbmdgbq7fib5464n86y5-type-sub-th-0.1.0.6`
  - `out`:  `/nix/store/4bhh6fx09kc5sbmdgbq7fib5464n86y5-type-sub-th-0.1.0.6`
...
- [[dcjm2jcq0mqq5c76a16qhdl9902ayfj5-type-sub-th-0.1.0.6.tar.gz]]
