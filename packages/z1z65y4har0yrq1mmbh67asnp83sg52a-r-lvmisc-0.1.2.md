...
- **Name**: `rPackages.lvmisc`
- **Version**: `0.1.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/lvmisc/](https://cran.r-project.org/web/packages/lvmisc/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/z1z65y4har0yrq1mmbh67asnp83sg52a-r-lvmisc-0.1.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/z1z65y4har0yrq1mmbh67asnp83sg52a-r-lvmisc-0.1.2`

## 🔗 Dependencies

- [[0knjcgrs9ana2vxhkn5ag7xvxmp542hm-r-glue-1.8.0]]
- [[3hp8s0ax41wx1ipvniygaxpj5j7lr0x4-lvmisc_0.1.2.tar.gz]]
