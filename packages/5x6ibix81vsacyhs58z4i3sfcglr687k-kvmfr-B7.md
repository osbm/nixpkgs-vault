---
aliases:
  - linuxKernel.packages.linux_latest_libre.kvmfr
tags:
  - license/unknown
  - maintainers/j-brn
  - outputs/out
...
- **Name**: `linuxKernel.packages.linux_latest_libre.kvmfr`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/5x6ibix81vsacyhs58z4i3sfcglr687k-kvmfr-B7.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/kvmfr/default.nix:31`
- **Outputs**:
  - `out`:  `/nix/store/5x6ibix81vsacyhs58z4i3sfcglr687k-kvmfr-B7`
