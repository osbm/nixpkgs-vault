---
aliases:
  - home-assistant-component-tests.locative
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.locative`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/3s3lybl9nibb4lq5ma2rddvxx3aqjlq5-homeassistant-test-locative-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/3s3lybl9nibb4lq5ma2rddvxx3aqjlq5-homeassistant-test-locative-2025.9.4`
