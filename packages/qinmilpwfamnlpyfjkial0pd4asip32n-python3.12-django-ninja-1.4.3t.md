...
- **Name**: `python312Packages.django-ninja`
- **Version**: `1.4.3t`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/qinmilpwfamnlpyfjkial0pd4asip32n-python3.12-django-ninja-1.4.3t.drv`
...
- **Outputs**:
  - `dist`:  `/nix/store/qinmilpwfamnlpyfjkial0pd4asip32n-python3.12-django-ninja-1.4.3t`
  - `out`:  `/nix/store/qinmilpwfamnlpyfjkial0pd4asip32n-python3.12-django-ninja-1.4.3t`
