...
- **Name**: `hyprlandPlugins.hyprsplit`
- **Version**: `0.50.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Hyprland plugin for awesome / dwm like workspaces
- **Homepage**: [https://github.com/shezdy/hyprsplit](https://github.com/shezdy/hyprsplit)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/17sh2wxv9lng8ki9li78w70xaqjmp8bw-hyprsplit-0.50.1.drv`
...
- **Outputs**:
  - `out`:  `/nix/store/17sh2wxv9lng8ki9li78w70xaqjmp8bw-hyprsplit-0.50.1`
...
- [[lf5kyrrcwhgli9xajr9100g31wzqhwd6-source]]
