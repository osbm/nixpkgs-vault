...
- **Name**: `haskellPackages.neko-obfs`
- **Version**: `0.1.0.4`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: a TCP tunnel with packet length obfuscation
- **Homepage**: [https://hackage.haskell.org/package/neko-obfs](https://hackage.haskell.org/package/neko-obfs)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/ki1p71zyzfswn8zs7prg4a0dal8i43v3-neko-obfs-0.1.0.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:471959`
- **Outputs**:
  - `doc`:  `/nix/store/ki1p71zyzfswn8zs7prg4a0dal8i43v3-neko-obfs-0.1.0.4`
  - `out`:  `/nix/store/ki1p71zyzfswn8zs7prg4a0dal8i43v3-neko-obfs-0.1.0.4`
...
- [[pq2iy753cj9dyyglp6nh6cg0frpigpdj-neko-obfs-0.1.0.4.tar.gz]]
