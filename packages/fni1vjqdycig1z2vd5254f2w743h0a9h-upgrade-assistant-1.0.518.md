...
Tool to assist developers in upgrading .NET Framework applications to .NET 6 and beyond
...
- **Homepage**: [https://github.com/dotnet/upgrade-assistant](https://github.com/dotnet/upgrade-assistant)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/fni1vjqdycig1z2vd5254f2w743h0a9h-upgrade-assistant-1.0.518.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/up/upgrade-assistant/package.nix:10`
- **Outputs**:
  - `out`:  `/nix/store/fni1vjqdycig1z2vd5254f2w743h0a9h-upgrade-assistant-1.0.518`
...
- [[44p4bsgaqc1wky4qmqk0520afniqcxmy-upgrade-assistant-1.0.518]]
