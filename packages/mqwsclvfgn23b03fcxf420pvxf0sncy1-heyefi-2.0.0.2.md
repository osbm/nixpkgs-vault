...
A server for Eye-Fi SD cards

## 📋 Package Information

- **Name**: `haskellPackages.heyefi`
- **Version**: `2.0.0.2`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: A server for Eye-Fi SD cards
- **Homepage**: [https://hackage.haskell.org/package/heyefi](https://hackage.haskell.org/package/heyefi)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/mqwsclvfgn23b03fcxf420pvxf0sncy1-heyefi-2.0.0.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:324488`
- **Outputs**:
  - `doc`:  `/nix/store/mqwsclvfgn23b03fcxf420pvxf0sncy1-heyefi-2.0.0.2`
  - `out`:  `/nix/store/mqwsclvfgn23b03fcxf420pvxf0sncy1-heyefi-2.0.0.2`
...
- [[djvl8mb53acnf46xzymihzbgb7iiv1y3-multipart-0.2.1]]
- [[ffc07fhxir5pg1120b73qrsli2haqqca-heyefi-2.0.0.2.tar.gz]]
