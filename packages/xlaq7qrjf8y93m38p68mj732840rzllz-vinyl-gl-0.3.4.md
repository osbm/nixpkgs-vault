...
- **Name**: `haskellPackages.vinyl-gl`
- **Version**: `0.3.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Utilities for working with OpenGL's GLSL shading language and vinyl records
- **Homepage**: [https://hackage.haskell.org/package/vinyl-gl](https://hackage.haskell.org/package/vinyl-gl)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/xlaq7qrjf8y93m38p68mj732840rzllz-vinyl-gl-0.3.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:708918`
- **Outputs**:
  - `doc`:  `/nix/store/xlaq7qrjf8y93m38p68mj732840rzllz-vinyl-gl-0.3.4`
  - `out`:  `/nix/store/xlaq7qrjf8y93m38p68mj732840rzllz-vinyl-gl-0.3.4`
...
- [[qyyccpvvk8ig6mvy79f9mmk1ahc7jwzz-vinyl-gl-0.3.4.tar.gz]]
