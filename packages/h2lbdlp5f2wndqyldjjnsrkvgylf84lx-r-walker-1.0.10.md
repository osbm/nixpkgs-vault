...
- **Name**: `rPackages.walker`
- **Version**: `1.0.10`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/walker/](https://cran.r-project.org/web/packages/walker/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/h2lbdlp5f2wndqyldjjnsrkvgylf84lx-r-walker-1.0.10.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/h2lbdlp5f2wndqyldjjnsrkvgylf84lx-r-walker-1.0.10`
...
- [[dba9n9ajq7l7fhk2vljyxkxm2zhri82q-walker_1.0.10.tar.gz]]
