...
- **Name**: `haskellPackages.kawaii`
- **Version**: `0.0.1.1`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Utilities for serving static sites and blogs with Wai/Warp
- **Homepage**: [https://hackage.haskell.org/package/kawaii](https://hackage.haskell.org/package/kawaii)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/gcf71fsh37d6dmkmffn8vjawjrhjfnhs-kawaii-0.0.1.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:398163`
- **Outputs**:
  - `doc`:  `/nix/store/gcf71fsh37d6dmkmffn8vjawjrhjfnhs-kawaii-0.0.1.1`
  - `out`:  `/nix/store/gcf71fsh37d6dmkmffn8vjawjrhjfnhs-kawaii-0.0.1.1`
...
- [[n5s1m3yi0d56kn9lq19l63zxf0qvvjby-kawaii-0.0.1.1.tar.gz]]
