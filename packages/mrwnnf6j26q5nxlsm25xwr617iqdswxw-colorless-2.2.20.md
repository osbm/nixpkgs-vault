...
- **Name**: `haskellPackages.colorless`
- **Version**: `2.2.20`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Colorless | The Programmatic IDL
- **Homepage**: [https://hackage.haskell.org/package/colorless](https://hackage.haskell.org/package/colorless)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/mrwnnf6j26q5nxlsm25xwr617iqdswxw-colorless-2.2.20.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:150156`
- **Outputs**:
  - `doc`:  `/nix/store/mrwnnf6j26q5nxlsm25xwr617iqdswxw-colorless-2.2.20`
  - `out`:  `/nix/store/mrwnnf6j26q5nxlsm25xwr617iqdswxw-colorless-2.2.20`
...
- [[g8nx3w1lsgl5k4w1s7h9c80pj87k9mjz-colorless-2.2.20.tar.gz]]
