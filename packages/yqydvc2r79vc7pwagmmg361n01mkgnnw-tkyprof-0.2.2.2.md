...
- **Name**: `haskellPackages.tkyprof`
- **Version**: `0.2.2.2`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: A web-based visualizer for GHC Profiling Reports
- **Homepage**: [https://hackage.haskell.org/package/tkyprof](https://hackage.haskell.org/package/tkyprof)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/yqydvc2r79vc7pwagmmg361n01mkgnnw-tkyprof-0.2.2.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:676971`
- **Outputs**:
  - `data`:  `/nix/store/yqydvc2r79vc7pwagmmg361n01mkgnnw-tkyprof-0.2.2.2`
  - `doc`:  `/nix/store/yqydvc2r79vc7pwagmmg361n01mkgnnw-tkyprof-0.2.2.2`
  - `out`:  `/nix/store/yqydvc2r79vc7pwagmmg361n01mkgnnw-tkyprof-0.2.2.2`

## 🔗 Dependencies

- [[0sla2ha6kb6fwhizkbgwvl83hmxv31i7-shakespeare-2.1.4]]
- [[2pr652igq6awvbbf5rfnb3kbrmg1cryf-http-types-0.12.4]]
- [[3j4ar63vw3p851l3i26cg6349w7m55g4-tkyprof-0.2.2.2.tar.gz]]
