---
aliases:
  - androidenv.androidPkgs.all.system-images.v27.default.x86_64
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.system-images.v27.default.x86_64`
- **Version**: `27_r01.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/9hqjsrkg7ak0f22kxlabvli1jr9sw1kk-x86_64-27_r01.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/9hqjsrkg7ak0f22kxlabvli1jr9sw1kk-x86_64-27_r01.zip`
