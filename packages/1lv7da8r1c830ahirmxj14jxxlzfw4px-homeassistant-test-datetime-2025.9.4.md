---
aliases:
  - home-assistant-component-tests.datetime
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.datetime`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/1lv7da8r1c830ahirmxj14jxxlzfw4px-homeassistant-test-datetime-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/1lv7da8r1c830ahirmxj14jxxlzfw4px-homeassistant-test-datetime-2025.9.4`
