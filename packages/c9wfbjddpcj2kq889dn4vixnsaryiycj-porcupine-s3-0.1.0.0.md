...
- **Name**: `haskellPackages.porcupine-s3`
- **Version**: `0.1.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: A location accessor for porcupine to connect to AWS S3 sources/sinks
- **Homepage**: [https://hackage.haskell.org/package/porcupine-s3](https://hackage.haskell.org/package/porcupine-s3)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/c9wfbjddpcj2kq889dn4vixnsaryiycj-porcupine-s3-0.1.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:529849`
- **Outputs**:
  - `doc`:  `/nix/store/c9wfbjddpcj2kq889dn4vixnsaryiycj-porcupine-s3-0.1.0.0`
  - `out`:  `/nix/store/c9wfbjddpcj2kq889dn4vixnsaryiycj-porcupine-s3-0.1.0.0`
...
- [[v9kn7fq00wn3ypk5axvpf5rb3rznbdr4-porcupine-s3-0.1.0.0.tar.gz]]
