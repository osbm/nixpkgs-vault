...
- **Name**: `haskellPackages.tpb`
- **Version**: `0.4.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Applications for interacting with the Pushbullet API
- **Homepage**: [https://hackage.haskell.org/package/tpb](https://hackage.haskell.org/package/tpb)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/6v4rvdmhbmmjk4lbmcw5i36r0lgfap83-tpb-0.4.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:681210`
- **Outputs**:
  - `doc`:  `/nix/store/6v4rvdmhbmmjk4lbmcw5i36r0lgfap83-tpb-0.4.0.0`
  - `out`:  `/nix/store/6v4rvdmhbmmjk4lbmcw5i36r0lgfap83-tpb-0.4.0.0`
...
- [[dfb6j79k4y3irfriykymm5zlphdjnnac-tpb-0.4.0.0.tar.gz]]
...
- [[ryxzvn7x4xaa1pl889qlzhyxq4ih4yd4-servant-pushbullet-client-0.5.0.0]]
