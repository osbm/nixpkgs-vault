...
- **Name**: `haskellPackages.libremidi`
- **Version**: `0.4.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: libremidi bindings for haskell
- **Homepage**: [https://hackage.haskell.org/package/libremidi](https://hackage.haskell.org/package/libremidi)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/8ddzgp9qcyxxynflpvflkhmypfbrvlj2-libremidi-0.4.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:417761`
- **Outputs**:
  - `doc`:  `/nix/store/8ddzgp9qcyxxynflpvflkhmypfbrvlj2-libremidi-0.4.2`
  - `out`:  `/nix/store/8ddzgp9qcyxxynflpvflkhmypfbrvlj2-libremidi-0.4.2`
...
- [[2f5v3c3ldis3fikhsd9cazgi279dqnbz-libremidi-0.4.2.tar.gz]]
