...
- **Name**: `haskellPackages.language-rust`
- **Version**: `0.2.0.27`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Parsing and pretty printing of Rust code
- **Homepage**: [https://hackage.haskell.org/package/language-rust](https://hackage.haskell.org/package/language-rust)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/8x1ns6433zd3plx6j1ksnfq3fbwplmbp-language-rust-0.2.0.27.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:409272`
- **Outputs**:
  - `doc`:  `/nix/store/8x1ns6433zd3plx6j1ksnfq3fbwplmbp-language-rust-0.2.0.27`
  - `out`:  `/nix/store/8x1ns6433zd3plx6j1ksnfq3fbwplmbp-language-rust-0.2.0.27`
...
- [[x52wbbvnbf6dfis5q85dby1kzl40w0v5-language-rust-0.2.0.27.tar.gz]]
