...
- **Name**: `rPackages.lpjmlkit`
- **Version**: `1.0.11`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://cran.r-project.org/web/packages/lpjmlkit/](https://cran.r-project.org/web/packages/lpjmlkit/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/vxd5mffq0p98lsgynpj89fdgrv3j79h6-r-lpjmlkit-1.0.11.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/vxd5mffq0p98lsgynpj89fdgrv3j79h6-r-lpjmlkit-1.0.11`

## 🔗 Dependencies

- [[22vaikkn22frx6qi6i4zg4fv0604r39i-lpjmlkit_1.0.11.tar.gz]]
