...
- **Name**: `haskellPackages.gi-handy`
- **Version**: `1.0.6`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: libhandy bindings
- **Homepage**: [https://hackage.haskell.org/package/gi-handy](https://hackage.haskell.org/package/gi-handy)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/hfafm7dylzhgi1ll0hi1ibczddsvn8y9-gi-handy-1.0.6.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:266222`
- **Outputs**:
  - `doc`:  `/nix/store/hfafm7dylzhgi1ll0hi1ibczddsvn8y9-gi-handy-1.0.6`
  - `out`:  `/nix/store/hfafm7dylzhgi1ll0hi1ibczddsvn8y9-gi-handy-1.0.6`
...
- [[fmp60082ilalrqd4sr2vchrx6rp1icpd-gi-handy-1.0.6.tar.gz]]
