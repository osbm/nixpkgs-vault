...
- **Name**: `php81Extensions.gettext`
- **Version**: `8.1.33`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: PHP upstream extension: gettext
...
- **Derivation Path**: `/nix/store/a84fkjzvjk81cg1svcm1c7znixg3cnzl-php-gettext-8.1.33.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/top-level/php-packages.nix:206`
- **Outputs**:
  - `dev`:  `/nix/store/a84fkjzvjk81cg1svcm1c7znixg3cnzl-php-gettext-8.1.33`
  - `out`:  `/nix/store/a84fkjzvjk81cg1svcm1c7znixg3cnzl-php-gettext-8.1.33`
