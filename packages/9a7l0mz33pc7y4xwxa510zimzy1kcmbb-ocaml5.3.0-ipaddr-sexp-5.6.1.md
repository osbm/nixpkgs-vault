...
Library for manipulation of IP address representations usnig sexp

## 📋 Package Information

- **Name**: `ocamlPackages.ipaddr-sexp`
- **Version**: `5.6.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/9a7l0mz33pc7y4xwxa510zimzy1kcmbb-ocaml5.3.0-ipaddr-sexp-5.6.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/ocaml-modules/ipaddr/sexp.nix:26`
- **Outputs**:
  - `out`:  `/nix/store/9a7l0mz33pc7y4xwxa510zimzy1kcmbb-ocaml5.3.0-ipaddr-sexp-5.6.1`
...
- [[wyvdjdbilnm5v31y52l9nwb72j0g5c4p-ocaml5.3.0-ipaddr-cstruct-5.6.1]]
