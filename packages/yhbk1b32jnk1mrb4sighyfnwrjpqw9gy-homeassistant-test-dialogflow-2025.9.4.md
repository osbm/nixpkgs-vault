---
aliases:
  - home-assistant-component-tests.dialogflow
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.dialogflow`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/yhbk1b32jnk1mrb4sighyfnwrjpqw9gy-homeassistant-test-dialogflow-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/yhbk1b32jnk1mrb4sighyfnwrjpqw9gy-homeassistant-test-dialogflow-2025.9.4`
