...
- **Name**: `haskellPackages.stack-network`
- **Version**: `0.1.0.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: A program for extending Stack to add distributed capabilities
- **Homepage**: [https://hackage.haskell.org/package/stack-network](https://hackage.haskell.org/package/stack-network)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/ci0aidaxc5dl39i9vs4sckvnwp1ccmc9-stack-network-0.1.0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:632332`
- **Outputs**:
  - `doc`:  `/nix/store/ci0aidaxc5dl39i9vs4sckvnwp1ccmc9-stack-network-0.1.0.1`
  - `out`:  `/nix/store/ci0aidaxc5dl39i9vs4sckvnwp1ccmc9-stack-network-0.1.0.1`
...
- [[bm986nzkgn6q9krp5141wrqxb54cy4iv-stack-network-0.1.0.1.tar.gz]]
- [[cn9jpi213c8ijwkg2h933mv71xagk2xf-system-filepath-0.4.14.1]]
- [[d1994ii5dn1vvkj32c4mg2f7wgfv94qx-distributed-process-lifted-0.3.0.1]]
...
- [[nynzyavlr8hjnk7d74mkqn1bqqzbfyyy-dirstream-1.1.0]]
