---
aliases:
  - linuxKernel.packages.linux_hardened.shufflecake
tags:
  - license/unknown
  - maintainers/oluceps
  - outputs/bin
...
- **Name**: `linuxKernel.packages.linux_hardened.shufflecake`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/khg5dqdy6x92v5ydkvjyj7h6zcg408mk-shufflecake.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/shufflecake/default.nix:44`
- **Outputs**:
  - `bin`:  `/nix/store/khg5dqdy6x92v5ydkvjyj7h6zcg408mk-shufflecake`
  - `out`:  `/nix/store/khg5dqdy6x92v5ydkvjyj7h6zcg408mk-shufflecake`
