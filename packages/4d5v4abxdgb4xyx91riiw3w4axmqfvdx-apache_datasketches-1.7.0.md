...
- **Name**: `postgresql16Packages.apache_datasketches`
- **Version**: `1.7.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/4d5v4abxdgb4xyx91riiw3w4axmqfvdx-apache_datasketches-1.7.0.drv`
...
- **Outputs**:
  - `out`:  `/nix/store/4d5v4abxdgb4xyx91riiw3w4axmqfvdx-apache_datasketches-1.7.0`
