...
- **Name**: `beamMinimal28Packages.elixir`
- **Version**: `1.18.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/30jikflbhv61yvj6yy1zcj4gncyshvqn-elixir-1.18.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/interpreters/elixir/1.18.nix:4`
- **Outputs**:
  - `out`:  `/nix/store/30jikflbhv61yvj6yy1zcj4gncyshvqn-elixir-1.18.4`
