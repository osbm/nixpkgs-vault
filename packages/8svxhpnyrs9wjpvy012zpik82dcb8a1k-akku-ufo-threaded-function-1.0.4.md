---
aliases:
  - akkuPackages.ufo-threaded-function
tags:
  - license/unknown
  - outputs/out
---
...
- **Name**: `akkuPackages.ufo-threaded-function`
- **Version**: `1.0.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: This package contains threaded-map, threaded-vector-map and such threaded functions for chez scheme.
- **Homepage**: []()
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/8svxhpnyrs9wjpvy012zpik82dcb8a1k-akku-ufo-threaded-function-1.0.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/tools/package-management/akku/default.nix:39`
- **Outputs**:
  - `out`:  `/nix/store/8svxhpnyrs9wjpvy012zpik82dcb8a1k-akku-ufo-threaded-function-1.0.4`
...
- [[gl5z871s7ld66x78bq5c774b2dvkay7p-ufo-threaded-function_1.0.4_repack.tar.xz]]
