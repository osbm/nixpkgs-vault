---
aliases:
  - python313Packages.python-zaqarclient
tags:
  - license/unknown
...
Client library for OpenStack Zaqar API

## 📋 Package Information

- **Name**: `python313Packages.python-zaqarclient`
- **Version**: `4.1.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Client library for OpenStack Zaqar API
- **Homepage**: [https://github.com/openstack/python-zaqarclient](https://github.com/openstack/python-zaqarclient)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/d4qhjx410dfgl61g7wr2g4c82i2wipbz-python3.13-python-zaqarclient-4.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/python-zaqarclient/default.nix:78`
- **Outputs**:
  - `dist`:  `/nix/store/d4qhjx410dfgl61g7wr2g4c82i2wipbz-python3.13-python-zaqarclient-4.1.0`
  - `out`:  `/nix/store/d4qhjx410dfgl61g7wr2g4c82i2wipbz-python3.13-python-zaqarclient-4.1.0`
...
- [[2gpw930fxhj62953qgk4i7jxm2ig7gz1-source]]
...
---
*Generated on 2025-09-27 12:26:28 UTC*
