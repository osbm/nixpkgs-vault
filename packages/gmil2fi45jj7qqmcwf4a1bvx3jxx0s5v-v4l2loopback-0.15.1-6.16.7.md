...
- **Name**: `linuxKernel.packages.linux_lqx.v4l2loopback`
- **Version**: `0.15.1-6.16.7`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/gmil2fi45jj7qqmcwf4a1bvx3jxx0s5v-v4l2loopback-0.15.1-6.16.7.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/v4l2loopback/default.nix:58`
- **Outputs**:
  - `bin`:  `/nix/store/gmil2fi45jj7qqmcwf4a1bvx3jxx0s5v-v4l2loopback-0.15.1-6.16.7`
  - `out`:  `/nix/store/gmil2fi45jj7qqmcwf4a1bvx3jxx0s5v-v4l2loopback-0.15.1-6.16.7`
