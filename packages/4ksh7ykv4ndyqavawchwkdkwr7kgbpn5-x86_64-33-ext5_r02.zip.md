---
aliases:
  - androidenv.androidPkgs.all.system-images.v33x.google_apis_playstore.x86_64
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.system-images.v33x.google_apis_playstore.x86_64`
...
- **Derivation Path**: `/nix/store/4ksh7ykv4ndyqavawchwkdkwr7kgbpn5-x86_64-33-ext5_r02.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/4ksh7ykv4ndyqavawchwkdkwr7kgbpn5-x86_64-33-ext5_r02.zip`
