...
- **Name**: `haskellPackages.servant-pipes`
- **Version**: `0.16.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Servant Stream support for pipes
- **Homepage**: [https://hackage.haskell.org/package/servant-pipes](https://hackage.haskell.org/package/servant-pipes)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/77jppk048km4b7hxspwdk57yjcyblykb-servant-pipes-0.16.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:600207`
- **Outputs**:
  - `doc`:  `/nix/store/77jppk048km4b7hxspwdk57yjcyblykb-servant-pipes-0.16.1`
  - `out`:  `/nix/store/77jppk048km4b7hxspwdk57yjcyblykb-servant-pipes-0.16.1`

## 🔗 Dependencies

- [[3x0fq132pc9ldn348n9yqi8iv116sm34-servant-pipes-0.16.1.tar.gz]]
