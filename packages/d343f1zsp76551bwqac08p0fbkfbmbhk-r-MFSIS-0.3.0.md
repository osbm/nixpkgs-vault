...
- **Name**: `rPackages.MFSIS`
- **Version**: `0.3.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/MFSIS/](https://cran.r-project.org/web/packages/MFSIS/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/d343f1zsp76551bwqac08p0fbkfbmbhk-r-MFSIS-0.3.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/d343f1zsp76551bwqac08p0fbkfbmbhk-r-MFSIS-0.3.0`

## 🔗 Dependencies

- [[0gacrygyysxaxs1zfsb5hmjcr33hmsch-MFSIS_0.3.0.tar.gz]]
