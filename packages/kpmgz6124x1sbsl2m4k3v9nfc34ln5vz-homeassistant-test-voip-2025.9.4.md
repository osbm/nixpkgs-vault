---
aliases:
  - home-assistant-component-tests.voip
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.voip`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/kpmgz6124x1sbsl2m4k3v9nfc34ln5vz-homeassistant-test-voip-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/kpmgz6124x1sbsl2m4k3v9nfc34ln5vz-homeassistant-test-voip-2025.9.4`
...
- [[780dff76asl2znmnxrn5p91j5iax0a1i-python3.13-voip-utils-0.3.4]]
