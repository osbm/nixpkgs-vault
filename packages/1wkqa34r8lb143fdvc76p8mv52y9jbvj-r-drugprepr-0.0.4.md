...
- **Name**: `rPackages.drugprepr`
- **Version**: `0.0.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/drugprepr/](https://cran.r-project.org/web/packages/drugprepr/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/1wkqa34r8lb143fdvc76p8mv52y9jbvj-r-drugprepr-0.0.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/1wkqa34r8lb143fdvc76p8mv52y9jbvj-r-drugprepr-0.0.4`

## 🔗 Dependencies

- [[3sisfv8m6ziv41s3h6jnwq12ppp62xd4-r-stringr-1.5.1]]
- [[47psw1by2vhc6wxscixzkrqsig1yrgv7-r-doseminer-0.1.2]]
...
- [[x4cys0izsgypxd9xaf3lp3h1czlwrzz6-drugprepr_0.0.4.tar.gz]]
