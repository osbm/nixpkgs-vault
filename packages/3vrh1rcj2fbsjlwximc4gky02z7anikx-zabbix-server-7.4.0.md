...
- **Derivation Path**: `/nix/store/3vrh1rcj2fbsjlwximc4gky02z7anikx-zabbix-server-7.4.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/monitoring/zabbix/server.nix:121`
- **Outputs**:
  - `out`:  `/nix/store/3vrh1rcj2fbsjlwximc4gky02z7anikx-zabbix-server-7.4.0`
