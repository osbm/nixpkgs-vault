...
PHP upstream extension: zip

## 📋 Package Information

- **Name**: `php81Extensions.zip`
- **Version**: `8.1.33`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: PHP upstream extension: zip
...
- **Derivation Path**: `/nix/store/w9yz92rw6sgl3a26h4f4i5sjr6kkc0z5-php-zip-8.1.33.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/top-level/php-packages.nix:206`
- **Outputs**:
  - `dev`:  `/nix/store/w9yz92rw6sgl3a26h4f4i5sjr6kkc0z5-php-zip-8.1.33`
  - `out`:  `/nix/store/w9yz92rw6sgl3a26h4f4i5sjr6kkc0z5-php-zip-8.1.33`
