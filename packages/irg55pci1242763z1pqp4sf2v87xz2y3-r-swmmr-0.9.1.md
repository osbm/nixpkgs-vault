...
- **Name**: `rPackages.swmmr`
- **Version**: `0.9.1`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://cran.r-project.org/web/packages/swmmr/](https://cran.r-project.org/web/packages/swmmr/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/irg55pci1242763z1pqp4sf2v87xz2y3-r-swmmr-0.9.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/irg55pci1242763z1pqp4sf2v87xz2y3-r-swmmr-0.9.1`
...
- [[wvmbnrwrlhc7xihvgq0ri5i0ac5i7h5d-swmmr_0.9.1.tar.gz]]
