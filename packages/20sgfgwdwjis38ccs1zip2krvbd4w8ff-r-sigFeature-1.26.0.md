...
- **Name**: `rPackages.sigFeature`
- **Version**: `1.26.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://bioconductor.org/packages/3.21/bioc/html/sigFeature.html](https://bioconductor.org/packages/3.21/bioc/html/sigFeature.html)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/20sgfgwdwjis38ccs1zip2krvbd4w8ff-r-sigFeature-1.26.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/20sgfgwdwjis38ccs1zip2krvbd4w8ff-r-sigFeature-1.26.0`
...
- [[vxacbpd3gzli2wjagvbpac1rv20ngzjp-sigFeature_1.26.0.tar.gz]]
