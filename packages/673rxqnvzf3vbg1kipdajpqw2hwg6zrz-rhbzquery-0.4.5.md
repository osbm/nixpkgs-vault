...
- **Name**: `haskellPackages.rhbzquery`
- **Version**: `0.4.5`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Bugzilla query tool
- **Homepage**: [https://hackage.haskell.org/package/rhbzquery](https://hackage.haskell.org/package/rhbzquery)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/673rxqnvzf3vbg1kipdajpqw2hwg6zrz-rhbzquery-0.4.5.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:574609`
- **Outputs**:
  - `doc`:  `/nix/store/673rxqnvzf3vbg1kipdajpqw2hwg6zrz-rhbzquery-0.4.5`
  - `out`:  `/nix/store/673rxqnvzf3vbg1kipdajpqw2hwg6zrz-rhbzquery-0.4.5`

## 🔗 Dependencies

- [[2pr652igq6awvbbf5rfnb3kbrmg1cryf-http-types-0.12.4]]
- [[2yblq43j5mqi22i3bxsak6464zmavlw7-rhbzquery-0.4.5.tar.gz]]
