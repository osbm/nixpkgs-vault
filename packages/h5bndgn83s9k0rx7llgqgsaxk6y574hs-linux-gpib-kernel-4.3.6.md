...
- **Name**: `linuxKernel.packages.linux_latest_libre.linux-gpib`
- **Version**: `4.3.6`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/h5bndgn83s9k0rx7llgqgsaxk6y574hs-linux-gpib-kernel-4.3.6.drv`
...
- **Outputs**:
  - `out`:  `/nix/store/h5bndgn83s9k0rx7llgqgsaxk6y574hs-linux-gpib-kernel-4.3.6`
