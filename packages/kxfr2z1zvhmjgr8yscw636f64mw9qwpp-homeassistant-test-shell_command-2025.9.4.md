---
aliases:
  - home-assistant-component-tests.shell_command
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.shell_command`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/kxfr2z1zvhmjgr8yscw636f64mw9qwpp-homeassistant-test-shell_command-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/kxfr2z1zvhmjgr8yscw636f64mw9qwpp-homeassistant-test-shell_command-2025.9.4`
