...
- **Name**: `rPackages.chessboard`
- **Version**: `0.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/chessboard/](https://cran.r-project.org/web/packages/chessboard/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/b4cyicwxclp83dyn41ccl0mhmma3wvrz-r-chessboard-0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/b4cyicwxclp83dyn41ccl0mhmma3wvrz-r-chessboard-0.1`
...
- [[q9yyxrsrz60ax2ijc9c2i3q74p8v2ig6-chessboard_0.1.tar.gz]]
