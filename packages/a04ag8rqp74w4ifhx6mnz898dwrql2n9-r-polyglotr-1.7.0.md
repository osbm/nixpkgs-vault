...
- **Name**: `rPackages.polyglotr`
- **Version**: `1.7.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/polyglotr/](https://cran.r-project.org/web/packages/polyglotr/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/a04ag8rqp74w4ifhx6mnz898dwrql2n9-r-polyglotr-1.7.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/a04ag8rqp74w4ifhx6mnz898dwrql2n9-r-polyglotr-1.7.0`

## 🔗 Dependencies

- [[2b397p6dx5gpjwcksbgkj6z40il9ff2z-polyglotr_1.7.0.tar.gz]]
