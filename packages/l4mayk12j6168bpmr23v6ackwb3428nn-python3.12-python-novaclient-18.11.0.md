...
- **Name**: `python312Packages.python-novaclient`
- **Version**: `18.11.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Client library for OpenStack Compute API
- **Homepage**: [https://github.com/openstack/python-novaclient](https://github.com/openstack/python-novaclient)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/l4mayk12j6168bpmr23v6ackwb3428nn-python3.12-python-novaclient-18.11.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/python-novaclient/default.nix:77`
- **Outputs**:
  - `dist`:  `/nix/store/l4mayk12j6168bpmr23v6ackwb3428nn-python3.12-python-novaclient-18.11.0`
  - `out`:  `/nix/store/l4mayk12j6168bpmr23v6ackwb3428nn-python3.12-python-novaclient-18.11.0`
...
- [[s0c7s6aldjd2qnraai4bp2kppp5vvb5s-python_novaclient-18.11.0.tar.gz]]
