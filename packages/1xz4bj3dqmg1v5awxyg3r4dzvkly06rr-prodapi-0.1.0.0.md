...
Some curated and opinionated packages for building Haskell services

## 📋 Package Information

- **Name**: `haskellPackages.prodapi`
- **Version**: `0.1.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Some curated and opinionated packages for building Haskell services
- **Homepage**: [https://hackage.haskell.org/package/prodapi](https://hackage.haskell.org/package/prodapi)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/1xz4bj3dqmg1v5awxyg3r4dzvkly06rr-prodapi-0.1.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:540705`
- **Outputs**:
  - `doc`:  `/nix/store/1xz4bj3dqmg1v5awxyg3r4dzvkly06rr-prodapi-0.1.0.0`
  - `out`:  `/nix/store/1xz4bj3dqmg1v5awxyg3r4dzvkly06rr-prodapi-0.1.0.0`
...
- [[3hf776nddx12rsyqh2w7ssh88zcw7kgh-prodapi-0.1.0.0.tar.gz]]
