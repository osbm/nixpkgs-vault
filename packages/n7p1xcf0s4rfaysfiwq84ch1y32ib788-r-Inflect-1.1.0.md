...
- **Name**: `rPackages.Inflect`
- **Version**: `1.1.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://cran.r-project.org/web/packages/Inflect/](https://cran.r-project.org/web/packages/Inflect/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/n7p1xcf0s4rfaysfiwq84ch1y32ib788-r-Inflect-1.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/n7p1xcf0s4rfaysfiwq84ch1y32ib788-r-Inflect-1.1.0`
...
- [[p2wc1hs1rq81i04m8m04hlbavgfdk9qk-Inflect_1.1.0.tar.gz]]
