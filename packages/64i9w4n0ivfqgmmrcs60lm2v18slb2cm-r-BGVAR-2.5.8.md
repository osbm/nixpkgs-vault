...
- **Name**: `rPackages.BGVAR`
- **Version**: `2.5.8`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/BGVAR/](https://cran.r-project.org/web/packages/BGVAR/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/64i9w4n0ivfqgmmrcs60lm2v18slb2cm-r-BGVAR-2.5.8.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/64i9w4n0ivfqgmmrcs60lm2v18slb2cm-r-BGVAR-2.5.8`
...
- [[y6rq7gbqchq1c41pyqpz22fjb4hbpksy-BGVAR_2.5.8.tar.gz]]
