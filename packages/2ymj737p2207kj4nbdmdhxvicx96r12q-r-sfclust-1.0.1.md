...
- **Name**: `rPackages.sfclust`
- **Version**: `1.0.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/sfclust/](https://cran.r-project.org/web/packages/sfclust/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/2ymj737p2207kj4nbdmdhxvicx96r12q-r-sfclust-1.0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/2ymj737p2207kj4nbdmdhxvicx96r12q-r-sfclust-1.0.1`
...
- [[w003y7rxfvi33n163xkkwdlm6hrq79rx-sfclust_1.0.1.tar.gz]]
