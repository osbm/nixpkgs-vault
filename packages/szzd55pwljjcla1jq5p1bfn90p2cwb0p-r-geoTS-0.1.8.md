...
- **Name**: `rPackages.geoTS`
- **Version**: `0.1.8`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/geoTS/](https://cran.r-project.org/web/packages/geoTS/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/szzd55pwljjcla1jq5p1bfn90p2cwb0p-r-geoTS-0.1.8.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/szzd55pwljjcla1jq5p1bfn90p2cwb0p-r-geoTS-0.1.8`
...
- [[bbskh4g3p8rzhgga2rbmacmvndyck3c0-geoTS_0.1.8.tar.gz]]
