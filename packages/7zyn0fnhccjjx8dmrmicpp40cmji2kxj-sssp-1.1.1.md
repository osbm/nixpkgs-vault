...
- **Name**: `haskellPackages.sssp`
- **Version**: `1.1.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: HTTP proxy for S3
- **Homepage**: [https://hackage.haskell.org/package/sssp](https://hackage.haskell.org/package/sssp)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/7zyn0fnhccjjx8dmrmicpp40cmji2kxj-sssp-1.1.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:631264`
- **Outputs**:
  - `doc`:  `/nix/store/7zyn0fnhccjjx8dmrmicpp40cmji2kxj-sssp-1.1.1`
  - `out`:  `/nix/store/7zyn0fnhccjjx8dmrmicpp40cmji2kxj-sssp-1.1.1`
...
- [[cjqi9ggg35sjbdq45akzqix4phpxa796-sssp-1.1.1.tar.gz]]
