---
aliases:
  - rPackages.PlasmaMutationDetector
tags:
  - license/unknown
  - outputs/out
---
...
- **Name**: `rPackages.PlasmaMutationDetector`
- **Version**: `1.7.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/PlasmaMutationDetector/](https://cran.r-project.org/web/packages/PlasmaMutationDetector/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/nldd19lvz7i17zp2icm51dvcdkhsl8yq-r-PlasmaMutationDetector-1.7.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/nldd19lvz7i17zp2icm51dvcdkhsl8yq-r-PlasmaMutationDetector-1.7.2`
...
- [[r37cvw97sb1bkdnvwvnj96zhlingxcvm-PlasmaMutationDetector_1.7.2.tar.gz]]
