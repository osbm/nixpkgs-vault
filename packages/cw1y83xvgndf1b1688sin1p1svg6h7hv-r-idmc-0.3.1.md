...
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/idmc/](https://cran.r-project.org/web/packages/idmc/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/cw1y83xvgndf1b1688sin1p1svg6h7hv-r-idmc-0.3.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/cw1y83xvgndf1b1688sin1p1svg6h7hv-r-idmc-0.3.1`
...
- [[wh3lcpfsx78r8y828lw6ndp705gkf73h-idmc_0.3.1.tar.gz]]
