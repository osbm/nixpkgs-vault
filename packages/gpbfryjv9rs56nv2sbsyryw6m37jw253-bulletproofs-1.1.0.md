...
- **Name**: `haskellPackages.bulletproofs`
- **Version**: `1.1.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Bulletproofs are short zero-knowledge proofs without a trusted setup
- **Homepage**: [https://hackage.haskell.org/package/bulletproofs](https://hackage.haskell.org/package/bulletproofs)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/gpbfryjv9rs56nv2sbsyryw6m37jw253-bulletproofs-1.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:118990`
- **Outputs**:
  - `doc`:  `/nix/store/gpbfryjv9rs56nv2sbsyryw6m37jw253-bulletproofs-1.1.0`
  - `out`:  `/nix/store/gpbfryjv9rs56nv2sbsyryw6m37jw253-bulletproofs-1.1.0`

## 🔗 Dependencies

- [[1rdhxwy0767ishknnsl2qd4fz97di33p-bulletproofs-1.1.0.tar.gz]]
...
- [[qnpbais6dv3smvddfhhs1fl4n5zw0mzz-bulletproofs-1.1.0-r1.cabal]]
