...
- **Name**: `python312Packages.pyunbound`
- **Version**: `1.23.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/bq2krm08564316cbyb1a80dfbfh3vzf9-python3.12-pyunbound-1.23.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/pyunbound/default.nix:85`
- **Outputs**:
  - `out`:  `/nix/store/bq2krm08564316cbyb1a80dfbfh3vzf9-python3.12-pyunbound-1.23.1`
