...
- **Name**: `haskellPackages.HasChor`
- **Version**: `0.1.0.1`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Functional choreographic programming in Haskell
- **Homepage**: [https://hackage.haskell.org/package/HasChor](https://hackage.haskell.org/package/HasChor)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/x2n8ss3dqnzysbva8az6ix8wkqjwfmc2-HasChor-0.1.0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:21949`
- **Outputs**:
  - `doc`:  `/nix/store/x2n8ss3dqnzysbva8az6ix8wkqjwfmc2-HasChor-0.1.0.1`
  - `out`:  `/nix/store/x2n8ss3dqnzysbva8az6ix8wkqjwfmc2-HasChor-0.1.0.1`

## 🔗 Dependencies

- [[16s38bv5bwp5kkwcq521hjksd5vsdixw-split-0.2.5]]
- [[1hm8fhzvdca0f4z895x508d42sspc73d-HasChor-0.1.0.1.tar.gz]]
