---
aliases:
  - linuxKernel.packages.linux_hardened.tbs
tags:
  - license/unknown
  - maintainers/ck3d
  - outputs/out
...
- **Name**: `linuxKernel.packages.linux_hardened.tbs`
- **Version**: `20250510-6.12.43`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/bnwcjsnjqz11a27vkv7bdasbbmbmxx4p-tbs-20250510-6.12.43.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/tbs/default.nix:80`
- **Outputs**:
  - `out`:  `/nix/store/bnwcjsnjqz11a27vkv7bdasbbmbmxx4p-tbs-20250510-6.12.43`
