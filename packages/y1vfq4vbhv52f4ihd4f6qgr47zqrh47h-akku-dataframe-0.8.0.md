...
- **Name**: `akkuPackages.dataframe`
- **Version**: `0.8.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: A dataframe record type for Scheme (R6RS) with procedures to select, drop, and rename columns, and filter, sort, split, bind, append, join, reshape, and aggregate dataframes.
- **Homepage**: []()
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/y1vfq4vbhv52f4ihd4f6qgr47zqrh47h-akku-dataframe-0.8.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/tools/package-management/akku/default.nix:39`
- **Outputs**:
  - `out`:  `/nix/store/y1vfq4vbhv52f4ihd4f6qgr47zqrh47h-akku-dataframe-0.8.0`
...
- [[fbgicc9ymal8nyqaj598pv4pbp8rl596-dataframe_0.8.0_repack.tar.xz]]
