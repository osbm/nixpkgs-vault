---
aliases:
  - androidenv.androidPkgs.all.system-images.v24.google_apis.x86
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.system-images.v24.google_apis.x86`
- **Version**: `24_r27.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/c2cr2k3ilcsfzyi1l926j44mha0982p6-x86-24_r27.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/c2cr2k3ilcsfzyi1l926j44mha0982p6-x86-24_r27.zip`
