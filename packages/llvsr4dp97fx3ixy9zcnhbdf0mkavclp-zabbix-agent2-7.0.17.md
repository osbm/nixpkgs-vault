...
- **Derivation Path**: `/nix/store/llvsr4dp97fx3ixy9zcnhbdf0mkavclp-zabbix-agent2-7.0.17.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/monitoring/zabbix/agent2.nix:82`
- **Outputs**:
  - `out`:  `/nix/store/llvsr4dp97fx3ixy9zcnhbdf0mkavclp-zabbix-agent2-7.0.17`
