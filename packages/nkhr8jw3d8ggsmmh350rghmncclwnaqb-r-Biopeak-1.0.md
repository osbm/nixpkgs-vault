...
- **Name**: `rPackages.Biopeak`
- **Version**: `1.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://cran.r-project.org/web/packages/Biopeak/](https://cran.r-project.org/web/packages/Biopeak/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/nkhr8jw3d8ggsmmh350rghmncclwnaqb-r-Biopeak-1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/nkhr8jw3d8ggsmmh350rghmncclwnaqb-r-Biopeak-1.0`

## 🔗 Dependencies

- [[98xxm4xfnkldwljawx6dx57y18z9rc0d-r-dbscan-1.2.2]]
- [[bjsb6wdjykafnkixq156qdvmxhsm2bai-bash-5.3p3]]
- [[dnm5x2y4yvpbayspsprpk022zx7f29lh-Biopeak_1.0.tar.gz]]
