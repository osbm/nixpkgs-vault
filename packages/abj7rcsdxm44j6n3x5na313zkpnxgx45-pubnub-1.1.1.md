...
- **Name**: `haskellPackages.pubnub`
- **Version**: `1.1.1`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: PubNub Haskell SDK
- **Homepage**: [https://hackage.haskell.org/package/pubnub](https://hackage.haskell.org/package/pubnub)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/abj7rcsdxm44j6n3x5na313zkpnxgx45-pubnub-1.1.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:546191`
- **Outputs**:
  - `doc`:  `/nix/store/abj7rcsdxm44j6n3x5na313zkpnxgx45-pubnub-1.1.1`
  - `out`:  `/nix/store/abj7rcsdxm44j6n3x5na313zkpnxgx45-pubnub-1.1.1`
...
- [[7milg58xmrwhsf2hqs6angfnnbmkw5d4-pubnub-1.1.1.tar.gz]]
