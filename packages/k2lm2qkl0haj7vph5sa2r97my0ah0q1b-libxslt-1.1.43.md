...
- **Name**: `python313Packages.libxslt`
- **Version**: `1.1.43`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/k2lm2qkl0haj7vph5sa2r97my0ah0q1b-libxslt-1.1.43.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/libraries/libxslt/default.nix:109`
- **Outputs**:
  - `bin`:  `/nix/store/k2lm2qkl0haj7vph5sa2r97my0ah0q1b-libxslt-1.1.43`
  - `dev`:  `/nix/store/k2lm2qkl0haj7vph5sa2r97my0ah0q1b-libxslt-1.1.43`
  - `devdoc`:  `/nix/store/k2lm2qkl0haj7vph5sa2r97my0ah0q1b-libxslt-1.1.43`
  - `doc`:  `/nix/store/k2lm2qkl0haj7vph5sa2r97my0ah0q1b-libxslt-1.1.43`
  - `out`:  `/nix/store/k2lm2qkl0haj7vph5sa2r97my0ah0q1b-libxslt-1.1.43`
  - `py`:  `/nix/store/k2lm2qkl0haj7vph5sa2r97my0ah0q1b-libxslt-1.1.43`
