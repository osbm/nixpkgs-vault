---
aliases:
  - haskellPackages.hnix-store-nar
tags:
  - license/unknown
  - outputs/doc
  - outputs/out
...
- **Name**: `haskellPackages.hnix-store-nar`
- **Version**: `0.1.1.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: NAR file format
- **Homepage**: [https://hackage.haskell.org/package/hnix-store-nar](https://hackage.haskell.org/package/hnix-store-nar)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/ch0z1pa0cc7i3pch91i7r4kclmir07ra-hnix-store-nar-0.1.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:337280`
- **Outputs**:
  - `doc`:  `/nix/store/ch0z1pa0cc7i3pch91i7r4kclmir07ra-hnix-store-nar-0.1.1.0`
  - `out`:  `/nix/store/ch0z1pa0cc7i3pch91i7r4kclmir07ra-hnix-store-nar-0.1.1.0`
...
- [[p5qvpayx37hrl8y6b0hc2mgcwmas57l1-hnix-store-nar-0.1.1.0.tar.gz]]
