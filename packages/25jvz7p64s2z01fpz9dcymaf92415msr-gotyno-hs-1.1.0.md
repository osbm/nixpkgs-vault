...
- **Name**: `haskellPackages.gotyno-hs`
- **Version**: `1.1.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: A type definition compiler supporting multiple output languages
- **Homepage**: [https://hackage.haskell.org/package/gotyno-hs](https://hackage.haskell.org/package/gotyno-hs)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/25jvz7p64s2z01fpz9dcymaf92415msr-gotyno-hs-1.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:279553`
- **Outputs**:
  - `doc`:  `/nix/store/25jvz7p64s2z01fpz9dcymaf92415msr-gotyno-hs-1.1.0`
  - `out`:  `/nix/store/25jvz7p64s2z01fpz9dcymaf92415msr-gotyno-hs-1.1.0`
...
- [[abkqj4vz3s0hn8yzwxcw3xy33jyz0rc1-gotyno-hs-1.1.0.tar.gz]]
