---
aliases:
  - home-assistant-component-tests.input_boolean
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.input_boolean`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/pyh85cy12hvqsbsh5gz411w3f6zyg0p9-homeassistant-test-input_boolean-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/pyh85cy12hvqsbsh5gz411w3f6zyg0p9-homeassistant-test-input_boolean-2025.9.4`
