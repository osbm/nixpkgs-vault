...
- **Name**: `rPackages.zoltr`
- **Version**: `1.0.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/zoltr/](https://cran.r-project.org/web/packages/zoltr/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/73hyknbpr9dns1mmdlpl79zvd6mdb5bf-r-zoltr-1.0.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/73hyknbpr9dns1mmdlpl79zvd6mdb5bf-r-zoltr-1.0.2`
...
- [[rs4l0rc85n6bwwqn8j39w0pjg75qdmcz-zoltr_1.0.2.tar.gz]]
