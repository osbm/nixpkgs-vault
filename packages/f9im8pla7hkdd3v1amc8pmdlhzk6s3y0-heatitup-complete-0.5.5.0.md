...
- **Name**: `haskellPackages.heatitup-complete`
- **Version**: `0.5.5.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Find and annotate ITDs with assembly or read pair joining
- **Homepage**: [https://hackage.haskell.org/package/heatitup-complete](https://hackage.haskell.org/package/heatitup-complete)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/f9im8pla7hkdd3v1amc8pmdlhzk6s3y0-heatitup-complete-0.5.5.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:318038`
- **Outputs**:
  - `doc`:  `/nix/store/f9im8pla7hkdd3v1amc8pmdlhzk6s3y0-heatitup-complete-0.5.5.0`
  - `out`:  `/nix/store/f9im8pla7hkdd3v1amc8pmdlhzk6s3y0-heatitup-complete-0.5.5.0`
...
- [[g94305k6kfrp5rlrd4f0178179k7lazl-heatitup-complete-0.5.5.0.tar.gz]]
