---
aliases:
  - home-assistant-component-tests.auth
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.auth`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/ww927ssx6g0ifmx3mq1x3q58j06kya8w-homeassistant-test-auth-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/ww927ssx6g0ifmx3mq1x3q58j06kya8w-homeassistant-test-auth-2025.9.4`
