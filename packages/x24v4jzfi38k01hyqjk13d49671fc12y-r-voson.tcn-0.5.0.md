...
- **Name**: `rPackages.voson_tcn`
- **Version**: `0.5.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/voson.tcn/](https://cran.r-project.org/web/packages/voson.tcn/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/x24v4jzfi38k01hyqjk13d49671fc12y-r-voson.tcn-0.5.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/x24v4jzfi38k01hyqjk13d49671fc12y-r-voson.tcn-0.5.0`
...
- [[qri8qd9ggq6lqm66bdldf0hiqazyxjsg-voson.tcn_0.5.0.tar.gz]]
