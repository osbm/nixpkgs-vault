...
- **Name**: `python312Packages.fiblary3-fork`
- **Version**: `0.1.12`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Fibaro Home Center API Python Library
- **Homepage**: [https://github.com/graham33/fiblary](https://github.com/graham33/fiblary)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/c28aq1mr6lhsbfvl0skj1hlgifjwbif6-python3.12-fiblary3-fork-0.1.12.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/fiblary3-fork/default.nix:47`
- **Outputs**:
  - `dist`:  `/nix/store/c28aq1mr6lhsbfvl0skj1hlgifjwbif6-python3.12-fiblary3-fork-0.1.12`
  - `out`:  `/nix/store/c28aq1mr6lhsbfvl0skj1hlgifjwbif6-python3.12-fiblary3-fork-0.1.12`

## 🔗 Dependencies

- [[1zxm4758ii6dmkfzwlxrncwc4m54fgkp-fiblary3-fork-0.1.12.tar.gz]]
