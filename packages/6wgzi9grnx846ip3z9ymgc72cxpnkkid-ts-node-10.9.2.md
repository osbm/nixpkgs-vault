...
- **Derivation Path**: `/nix/store/6wgzi9grnx846ip3z9ymgc72cxpnkkid-ts-node-10.9.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/node-packages/node-packages.nix:62691`
- **Outputs**:
  - `out`:  `/nix/store/6wgzi9grnx846ip3z9ymgc72cxpnkkid-ts-node-10.9.2`
