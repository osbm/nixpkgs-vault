...
- **Name**: `haskellPackages.teleshell`
- **Version**: `0.1.0.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Telnet client and other things
- **Homepage**: [https://hackage.haskell.org/package/teleshell](https://hackage.haskell.org/package/teleshell)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/3h8ahqqi651c68svh2kmmnlbhc2476q1-teleshell-0.1.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:662035`
- **Outputs**:
  - `doc`:  `/nix/store/3h8ahqqi651c68svh2kmmnlbhc2476q1-teleshell-0.1.0.0`
  - `out`:  `/nix/store/3h8ahqqi651c68svh2kmmnlbhc2476q1-teleshell-0.1.0.0`
...
- [[y3kp16h5d01ivzxhhdpnnnnvpq3f3f7f-teleshell-0.1.0.0.tar.gz]]
