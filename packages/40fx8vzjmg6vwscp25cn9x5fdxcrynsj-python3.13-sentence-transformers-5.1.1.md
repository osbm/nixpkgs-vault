...
- **Name**: `python313Packages.sentence-transformers`
- **Version**: `5.1.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Multilingual Sentence & Image Embeddings with BERT
- **Homepage**: [https://github.com/UKPLab/sentence-transformers](https://github.com/UKPLab/sentence-transformers)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/40fx8vzjmg6vwscp25cn9x5fdxcrynsj-python3.13-sentence-transformers-5.1.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/sentence-transformers/default.nix:143`
- **Outputs**:
  - `dist`:  `/nix/store/40fx8vzjmg6vwscp25cn9x5fdxcrynsj-python3.13-sentence-transformers-5.1.1`
  - `out`:  `/nix/store/40fx8vzjmg6vwscp25cn9x5fdxcrynsj-python3.13-sentence-transformers-5.1.1`
...
- [[lf4rfwbkdi1b0cjmk9y40scwjglvh5h8-source]]
- [[lf5s9p815wma4sx39xi6gmykskgq9myk-python3.13-optimum-1.27.0]]
