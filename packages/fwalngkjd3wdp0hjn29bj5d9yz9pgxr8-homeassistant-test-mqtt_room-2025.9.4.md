---
aliases:
  - home-assistant-component-tests.mqtt_room
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.mqtt_room`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/fwalngkjd3wdp0hjn29bj5d9yz9pgxr8-homeassistant-test-mqtt_room-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/fwalngkjd3wdp0hjn29bj5d9yz9pgxr8-homeassistant-test-mqtt_room-2025.9.4`
