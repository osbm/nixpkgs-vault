---
aliases:
  - haskellPackages.conduit-vfs-zip
tags:
  - license/unknown
  - outputs/doc
  - outputs/out
...
- **Name**: `haskellPackages.conduit-vfs-zip`
- **Version**: `0.1.0.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Zip archive interface for the Conduit Virtual File System
- **Homepage**: [https://hackage.haskell.org/package/conduit-vfs-zip](https://hackage.haskell.org/package/conduit-vfs-zip)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/sa7ar8r4xpjz2s4acv3kzxyjsqf178hr-conduit-vfs-zip-0.1.0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:157238`
- **Outputs**:
  - `doc`:  `/nix/store/sa7ar8r4xpjz2s4acv3kzxyjsqf178hr-conduit-vfs-zip-0.1.0.1`
  - `out`:  `/nix/store/sa7ar8r4xpjz2s4acv3kzxyjsqf178hr-conduit-vfs-zip-0.1.0.1`
...
- [[azvn8s6sflx37lv2pj5zbh9jmr2xrbr1-conduit-vfs-zip-0.1.0.1.tar.gz]]
...
- [[hrfiyjcgjz62g5k6x0ns5ca02b8npzwy-conduit-vfs-0.1.0.3]]
