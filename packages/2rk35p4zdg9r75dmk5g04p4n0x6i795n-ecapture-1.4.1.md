---
aliases:
  - linuxKernel.packages.linux_latest_libre.ecapture
tags:
  - license/unknown
...
- **Name**: `linuxKernel.packages.linux_latest_libre.ecapture`
- **Version**: `1.4.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/2rk35p4zdg9r75dmk5g04p4n0x6i795n-ecapture-1.4.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/ec/ecapture/package.nix:130`
- **Outputs**:
  - `out`:  `/nix/store/2rk35p4zdg9r75dmk5g04p4n0x6i795n-ecapture-1.4.1`
