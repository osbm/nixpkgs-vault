...
Open source implementation of CLIP

## 📋 Package Information

- **Name**: `python313Packages.open-clip-torch`
- **Version**: `3.2.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Open source implementation of CLIP
- **Homepage**: [https://github.com/mlfoundations/open_clip](https://github.com/mlfoundations/open_clip)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/723plkpxvx7v4fsqlfajhlqi9i52pg91-python3.13-open-clip-torch-3.2.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/open-clip-torch/default.nix:87`
- **Outputs**:
  - `dist`:  `/nix/store/723plkpxvx7v4fsqlfajhlqi9i52pg91-python3.13-open-clip-torch-3.2.0`
  - `out`:  `/nix/store/723plkpxvx7v4fsqlfajhlqi9i52pg91-python3.13-open-clip-torch-3.2.0`
...
- [[57nw3qdf9zb4ab6c2rrvw8s7i3c7h4ai-source]]
...
- [[a9r02saypvif5110fjxp16p5z1hziwl8-python3.13-webdataset-1.0.2]]
...
- [[nhvzczg9n96vavhbjn3nsymnmjb001vx-python3.13-timm-1.0.20]]
