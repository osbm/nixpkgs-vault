...
- **Name**: `rPackages.OpenStats`
- **Version**: `1.20.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://bioconductor.org/packages/3.21/bioc/html/OpenStats.html](https://bioconductor.org/packages/3.21/bioc/html/OpenStats.html)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/mabpaib456b9sscf8flc8n3shmnp9jpv-r-OpenStats-1.20.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/mabpaib456b9sscf8flc8n3shmnp9jpv-r-OpenStats-1.20.0`
...
- [[zp5al06b74247r2hk7lraw6i7s3igq4j-OpenStats_1.20.0.tar.gz]]
