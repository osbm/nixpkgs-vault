...
- **Derivation Path**: `/nix/store/5chrqaaqwv25q7sblgnlq2pya18xdd18-percona-server-8.4.6-6.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/sql/percona-server/8_4.nix:216`
- **Outputs**:
  - `out`:  `/nix/store/5chrqaaqwv25q7sblgnlq2pya18xdd18-percona-server-8.4.6-6`
  - `static`:  `/nix/store/5chrqaaqwv25q7sblgnlq2pya18xdd18-percona-server-8.4.6-6`
...
- [[m791nrkwrcfd97r3bg4qmw9jk5gijd4k-percona-server-8.4.6-6.tar.gz]]
