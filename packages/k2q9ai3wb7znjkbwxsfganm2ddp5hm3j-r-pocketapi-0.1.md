...
- **Name**: `rPackages.pocketapi`
- **Version**: `0.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/pocketapi/](https://cran.r-project.org/web/packages/pocketapi/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/k2q9ai3wb7znjkbwxsfganm2ddp5hm3j-r-pocketapi-0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/k2q9ai3wb7znjkbwxsfganm2ddp5hm3j-r-pocketapi-0.1`
...
- [[yib6dplswb5f3wyarp73pbq7ih5pqlbj-pocketapi_0.1.tar.gz]]
