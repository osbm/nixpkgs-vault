...
- **Name**: `python312Packages.aws-adfs`
- **Version**: `2.12.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Command line tool to ease AWS CLI authentication against ADFS
- **Homepage**: [https://github.com/venth/aws-adfs](https://github.com/venth/aws-adfs)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/k3mbv3ahiqmjav0z9rfglxhk3xykxsvm-python3.12-aws-adfs-2.12.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/aws-adfs/default.nix:69`
- **Outputs**:
  - `dist`:  `/nix/store/k3mbv3ahiqmjav0z9rfglxhk3xykxsvm-python3.12-aws-adfs-2.12.1`
  - `out`:  `/nix/store/k3mbv3ahiqmjav0z9rfglxhk3xykxsvm-python3.12-aws-adfs-2.12.1`
...
- [[vf1zi62257h8qqz12v5ivsw5nc1lp08v-source]]
