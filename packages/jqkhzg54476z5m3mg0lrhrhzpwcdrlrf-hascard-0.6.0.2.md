...
- **Name**: `haskellPackages.hascard`
- **Version**: `0.6.0.2`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: A TUI for reviewing notes using 'flashcards' written with markdown-like syntax
- **Homepage**: [https://hackage.haskell.org/package/hascard](https://hackage.haskell.org/package/hascard)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/jqkhzg54476z5m3mg0lrhrhzpwcdrlrf-hascard-0.6.0.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:299035`
- **Outputs**:
  - `doc`:  `/nix/store/jqkhzg54476z5m3mg0lrhrhzpwcdrlrf-hascard-0.6.0.2`
  - `out`:  `/nix/store/jqkhzg54476z5m3mg0lrhrhzpwcdrlrf-hascard-0.6.0.2`
...
- [[ppgzvrmwz3nlvqxrj63dxdc1mnihlini-hascard-0.6.0.2.tar.gz]]
