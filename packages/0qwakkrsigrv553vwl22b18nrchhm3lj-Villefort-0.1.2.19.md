...
- **Name**: `haskellPackages.Villefort`
- **Version**: `0.1.2.19`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Villefort is a task manager and time tracker
- **Homepage**: [https://hackage.haskell.org/package/Villefort](https://hackage.haskell.org/package/Villefort)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/0qwakkrsigrv553vwl22b18nrchhm3lj-Villefort-0.1.2.19.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:45731`
- **Outputs**:
  - `data`:  `/nix/store/0qwakkrsigrv553vwl22b18nrchhm3lj-Villefort-0.1.2.19`
  - `doc`:  `/nix/store/0qwakkrsigrv553vwl22b18nrchhm3lj-Villefort-0.1.2.19`
  - `out`:  `/nix/store/0qwakkrsigrv553vwl22b18nrchhm3lj-Villefort-0.1.2.19`
...
- [[6fwabqbmnyp3gd8vv520zl8j0pfr7a0h-Villefort-0.1.2.19.tar.gz]]
