---
aliases:
  - haskellPackages.haskell-kubernetes
tags:
  - broken
  - not-available
  - license/unknown
...
- **Name**: `haskellPackages.haskell-kubernetes`
- **Version**: `0.5.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Haskell bindings to the Kubernetes API (via swagger-codegen)
- **Homepage**: [https://hackage.haskell.org/package/haskell-kubernetes](https://hackage.haskell.org/package/haskell-kubernetes)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/fm6c3clj8mh59xfpc04rky6d34aa5lzk-haskell-kubernetes-0.5.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:303566`
- **Outputs**:
  - `doc`:  `/nix/store/fm6c3clj8mh59xfpc04rky6d34aa5lzk-haskell-kubernetes-0.5.0`
  - `out`:  `/nix/store/fm6c3clj8mh59xfpc04rky6d34aa5lzk-haskell-kubernetes-0.5.0`

## 🔗 Dependencies

- [[16s38bv5bwp5kkwcq521hjksd5vsdixw-split-0.2.5]]
- [[2pr652igq6awvbbf5rfnb3kbrmg1cryf-http-types-0.12.4]]
- [[3y2nz6byqiz4ry7pyw8drbphhvivx9j9-haskell-kubernetes-0.5.0.tar.gz]]
