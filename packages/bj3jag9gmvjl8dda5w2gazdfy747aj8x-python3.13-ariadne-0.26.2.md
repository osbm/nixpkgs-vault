...
- **Name**: `python313Packages.ariadne`
- **Version**: `0.26.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/bj3jag9gmvjl8dda5w2gazdfy747aj8x-python3.13-ariadne-0.26.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/ariadne/default.nix:79`
- **Outputs**:
  - `dist`:  `/nix/store/bj3jag9gmvjl8dda5w2gazdfy747aj8x-python3.13-ariadne-0.26.2`
  - `out`:  `/nix/store/bj3jag9gmvjl8dda5w2gazdfy747aj8x-python3.13-ariadne-0.26.2`
