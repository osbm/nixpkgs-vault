...
- **Name**: `rPackages.metaBMA`
- **Version**: `0.6.9`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/metaBMA/](https://cran.r-project.org/web/packages/metaBMA/)
- **License**: `unknown`
