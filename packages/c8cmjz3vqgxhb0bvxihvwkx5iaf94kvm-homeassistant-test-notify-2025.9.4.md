---
aliases:
  - home-assistant-component-tests.notify
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.notify`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/c8cmjz3vqgxhb0bvxihvwkx5iaf94kvm-homeassistant-test-notify-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/c8cmjz3vqgxhb0bvxihvwkx5iaf94kvm-homeassistant-test-notify-2025.9.4`
