...
- **Name**: `godot3-debug-server`
- **Version**: `3.6`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Free and Open Source 2D and 3D game engine (debug server)
...
- **Derivation Path**: `/nix/store/1qzk2gvkmg14h69gpibkkswq3rm82565-godot3-debug-server-3.6.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/tools/godot/3/default.nix:178`
- **Outputs**:
  - `out`:  `/nix/store/1qzk2gvkmg14h69gpibkkswq3rm82565-godot3-debug-server-3.6`
