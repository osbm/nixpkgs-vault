...
- **Name**: `haskellPackages.cabal-src`
- **Version**: `0.3.0.2`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Alternative install procedure to avoid the diamond dependency issue
- **Homepage**: [https://hackage.haskell.org/package/cabal-src](https://hackage.haskell.org/package/cabal-src)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/zbxbw1dwsq89ssclagbp2xfr4191i2zg-cabal-src-0.3.0.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:125796`
- **Outputs**:
  - `doc`:  `/nix/store/zbxbw1dwsq89ssclagbp2xfr4191i2zg-cabal-src-0.3.0.2`
  - `out`:  `/nix/store/zbxbw1dwsq89ssclagbp2xfr4191i2zg-cabal-src-0.3.0.2`
...
- [[gnff9sigzqiav4irrnglfvmbd64ng8wz-cabal-src-0.3.0.2.tar.gz]]
