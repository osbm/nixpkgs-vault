---
aliases:
  - haskellPackages.antiope-messages
tags:
  - broken
  - not-available
  - license/unknown
...
- **Name**: `haskellPackages.antiope-messages`
- **Version**: `7.5.3`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Please see the README on Github at <https://github.com/arbor/antiope#readme>
- **Homepage**: [https://hackage.haskell.org/package/antiope-messages](https://hackage.haskell.org/package/antiope-messages)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/275j6sg4d59hs1vrr7pl4shr6vnxpizs-antiope-messages-7.5.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:77205`
- **Outputs**:
  - `doc`:  `/nix/store/275j6sg4d59hs1vrr7pl4shr6vnxpizs-antiope-messages-7.5.3`
  - `out`:  `/nix/store/275j6sg4d59hs1vrr7pl4shr6vnxpizs-antiope-messages-7.5.3`
...
- [[mp7i7byg70h4z8zxab6dgm4ga9rm979s-antiope-messages-7.5.3.tar.gz]]
