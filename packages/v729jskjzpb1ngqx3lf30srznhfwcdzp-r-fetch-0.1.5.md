...
- **Name**: `rPackages.fetch`
- **Version**: `0.1.5`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/fetch/](https://cran.r-project.org/web/packages/fetch/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/v729jskjzpb1ngqx3lf30srznhfwcdzp-r-fetch-0.1.5.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/v729jskjzpb1ngqx3lf30srznhfwcdzp-r-fetch-0.1.5`
...
- [[zqsbjrsvmixpk1sn3kp2wdc58vwifgza-fetch_0.1.5.tar.gz]]
