...
- **Name**: `haskellPackages.plaid`
- **Version**: `0.1.0.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Plaid.com api integration library
- **Homepage**: [https://hackage.haskell.org/package/plaid](https://hackage.haskell.org/package/plaid)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/6czp9gnj3yqf5n3mp1v9x8jm6mg53srj-plaid-0.1.0.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:522594`
- **Outputs**:
  - `doc`:  `/nix/store/6czp9gnj3yqf5n3mp1v9x8jm6mg53srj-plaid-0.1.0.4`
  - `out`:  `/nix/store/6czp9gnj3yqf5n3mp1v9x8jm6mg53srj-plaid-0.1.0.4`

## 🔗 Dependencies

- [[163zc3ibbnvdr4nbz8k7clqdvp3rr28h-plaid-0.1.0.4.tar.gz]]
