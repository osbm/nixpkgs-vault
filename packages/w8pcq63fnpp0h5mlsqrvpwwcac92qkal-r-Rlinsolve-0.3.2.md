...
- **Name**: `rPackages.Rlinsolve`
- **Version**: `0.3.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/Rlinsolve/](https://cran.r-project.org/web/packages/Rlinsolve/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/w8pcq63fnpp0h5mlsqrvpwwcac92qkal-r-Rlinsolve-0.3.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/w8pcq63fnpp0h5mlsqrvpwwcac92qkal-r-Rlinsolve-0.3.2`
...
- [[wfsrmp185ms75zyabclc589kfw5560d7-Rlinsolve_0.3.2.tar.gz]]
