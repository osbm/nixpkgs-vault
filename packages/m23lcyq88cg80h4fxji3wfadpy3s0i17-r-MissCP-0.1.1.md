...
- **Name**: `rPackages.MissCP`
- **Version**: `0.1.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/MissCP/](https://cran.r-project.org/web/packages/MissCP/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/m23lcyq88cg80h4fxji3wfadpy3s0i17-r-MissCP-0.1.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/m23lcyq88cg80h4fxji3wfadpy3s0i17-r-MissCP-0.1.1`
...
- [[y6rvbmmi6rld0k0qc0plyvv5zdc511jz-MissCP_0.1.1.tar.gz]]
