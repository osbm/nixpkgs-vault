...
- **Name**: `haskellPackages.compactable`
- **Version**: `0.2.0.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: A typeclass for structures which can be catMaybed, filtered, and partitioned
- **Homepage**: [https://hackage.haskell.org/package/compactable](https://hackage.haskell.org/package/compactable)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/hwdby217vx6803n3ilhyrkni21b96rdz-compactable-0.2.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:152661`
- **Outputs**:
  - `doc`:  `/nix/store/hwdby217vx6803n3ilhyrkni21b96rdz-compactable-0.2.0.0`
  - `out`:  `/nix/store/hwdby217vx6803n3ilhyrkni21b96rdz-compactable-0.2.0.0`
...
- [[gbg8kkclggnhff58vipm7nyjmbbwmn23-compactable-0.2.0.0.tar.gz]]
