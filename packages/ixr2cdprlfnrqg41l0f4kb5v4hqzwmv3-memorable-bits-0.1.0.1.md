---
aliases:
  - haskellPackages.memorable-bits
tags:
  - broken
  - not-available
  - license/unknown
...
Generate human memorable strings from binary data

## 📋 Package Information

- **Name**: `haskellPackages.memorable-bits`
- **Version**: `0.1.0.1`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Generate human memorable strings from binary data
- **Homepage**: [https://hackage.haskell.org/package/memorable-bits](https://hackage.haskell.org/package/memorable-bits)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/ixr2cdprlfnrqg41l0f4kb5v4hqzwmv3-memorable-bits-0.1.0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:444044`
- **Outputs**:
  - `doc`:  `/nix/store/ixr2cdprlfnrqg41l0f4kb5v4hqzwmv3-memorable-bits-0.1.0.1`
  - `out`:  `/nix/store/ixr2cdprlfnrqg41l0f4kb5v4hqzwmv3-memorable-bits-0.1.0.1`
...
- [[z38a1kpxqif0ma4v9l5vpsp91x9vinmx-memorable-bits-0.1.0.1.tar.gz]]
