---
aliases:
  - rPackages.TreeSummarizedExperiment
tags:
  - license/unknown
  - outputs/out
---
...
- **Name**: `rPackages.TreeSummarizedExperiment`
- **Version**: `2.16.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://bioconductor.org/packages/3.21/bioc/html/TreeSummarizedExperiment.html](https://bioconductor.org/packages/3.21/bioc/html/TreeSummarizedExperiment.html)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/lyqwvdrcqhlq321cqfh50lck8gqsyz18-r-TreeSummarizedExperiment-2.16.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/lyqwvdrcqhlq321cqfh50lck8gqsyz18-r-TreeSummarizedExperiment-2.16.1`
...
- [[jvi3j3p688dn7wv8d0i80f715y36grl6-TreeSummarizedExperiment_2.16.1.tar.gz]]
