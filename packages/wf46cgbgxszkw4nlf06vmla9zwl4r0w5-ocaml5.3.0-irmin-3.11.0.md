...
Distributed database built on the same principles as Git

## 📋 Package Information

- **Name**: `ocamlPackages.irmin`
- **Version**: `3.11.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/wf46cgbgxszkw4nlf06vmla9zwl4r0w5-ocaml5.3.0-irmin-3.11.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/ocaml-modules/irmin/default.nix:57`
- **Outputs**:
  - `out`:  `/nix/store/wf46cgbgxszkw4nlf06vmla9zwl4r0w5-ocaml5.3.0-irmin-3.11.0`
...
- [[z7psmjrw3zanyqwxs8ahnbifg88g0j8n-ocaml5.3.0-repr-0.7.0]]
