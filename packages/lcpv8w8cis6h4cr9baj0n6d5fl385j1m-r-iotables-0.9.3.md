...
- **Name**: `rPackages.iotables`
- **Version**: `0.9.3`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/iotables/](https://cran.r-project.org/web/packages/iotables/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/lcpv8w8cis6h4cr9baj0n6d5fl385j1m-r-iotables-0.9.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/lcpv8w8cis6h4cr9baj0n6d5fl385j1m-r-iotables-0.9.3`
...
- [[lawq9mvghp7nvj0xbyrz9lipf7ixbagh-iotables_0.9.3.tar.gz]]
