...
- **Derivation Path**: `/nix/store/k2rx6jdc7pjkzq5yklpccyijpbfxs2vq-semeru-jre-bin-17.0.9.drv`
...
- **Outputs**:
  - `out`:  `/nix/store/k2rx6jdc7pjkzq5yklpccyijpbfxs2vq-semeru-jre-bin-17.0.9`
...
- [[1zv0j85h0j7wa5jfp60vh6dipakm9l1s-ibm-semeru-open-jre_x64_linux_17.0.9_9_openj9-0.41.0.tar.gz]]
