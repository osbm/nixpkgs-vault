...
- **Name**: `haskellPackages.cabal-bounds`
- **Version**: `2.6.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: A command line program for managing the dependency versions in a cabal file
- **Homepage**: [https://hackage.haskell.org/package/cabal-bounds](https://hackage.haskell.org/package/cabal-bounds)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/xa1lv3hswnhlhkcf2jw900kp0bx86y7i-cabal-bounds-2.6.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:123062`
- **Outputs**:
  - `doc`:  `/nix/store/xa1lv3hswnhlhkcf2jw900kp0bx86y7i-cabal-bounds-2.6.0`
  - `out`:  `/nix/store/xa1lv3hswnhlhkcf2jw900kp0bx86y7i-cabal-bounds-2.6.0`
...
- [[c0qmsh5w79mh1amb7w3ixsh3gjrawi6p-cabal-lenses-0.15.0]]
...
- [[xl2hhva6n7jzjrbrldibr609y3md1mdm-cabal-bounds-2.6.0.tar.gz]]
