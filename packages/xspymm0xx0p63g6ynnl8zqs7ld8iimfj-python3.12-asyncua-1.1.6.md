...
- **Name**: `python312Packages.asyncua`
- **Version**: `1.1.6`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: OPC UA / IEC 62541 Client and Server for Python
- **Homepage**: [https://github.com/FreeOpcUa/opcua-asyncio](https://github.com/FreeOpcUa/opcua-asyncio)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/xspymm0xx0p63g6ynnl8zqs7ld8iimfj-python3.12-asyncua-1.1.6.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/asyncua/default.nix:84`
- **Outputs**:
  - `dist`:  `/nix/store/xspymm0xx0p63g6ynnl8zqs7ld8iimfj-python3.12-asyncua-1.1.6`
  - `out`:  `/nix/store/xspymm0xx0p63g6ynnl8zqs7ld8iimfj-python3.12-asyncua-1.1.6`

## 🔗 Dependencies

- [[0vmzyqjjicshfngh7pivk6b7z2q3hvk5-source]]
...
- [[w3yshfyx4i4q08qrm07cv1qzjqs0ba36-python3.12-pytest-asyncio-0.21.2]]
