...
- **Name**: `kdePackages.kspaceduel`
- **Version**: `25.08.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: KSpaceDuel: each of two possible players controls a satellite spaceship orbiting the sun
- **Homepage**: [https://invent.kde.org/games/kspaceduel](https://invent.kde.org/games/kspaceduel)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/r8d3yg6p96bk90k6swycqw2w2cmv2kwf-kspaceduel-25.08.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/kde/gear/kspaceduel/default.nix:6`
- **Outputs**:
  - `debug`:  `/nix/store/r8d3yg6p96bk90k6swycqw2w2cmv2kwf-kspaceduel-25.08.1`
  - `dev`:  `/nix/store/r8d3yg6p96bk90k6swycqw2w2cmv2kwf-kspaceduel-25.08.1`
  - `devtools`:  `/nix/store/r8d3yg6p96bk90k6swycqw2w2cmv2kwf-kspaceduel-25.08.1`
  - `out`:  `/nix/store/r8d3yg6p96bk90k6swycqw2w2cmv2kwf-kspaceduel-25.08.1`
...
- [[ncr28hsd1bs6fd7npm1jdaq0zyhji170-kspaceduel-25.08.1.tar.xz]]
