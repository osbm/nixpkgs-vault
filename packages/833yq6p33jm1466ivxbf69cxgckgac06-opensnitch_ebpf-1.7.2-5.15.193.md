...
- **Name**: `linuxKernel.packages.linux_5_15.opensnitch-ebpf`
- **Version**: `1.7.2-5.15.193`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/833yq6p33jm1466ivxbf69cxgckgac06-opensnitch_ebpf-1.7.2-5.15.193.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/opensnitch-ebpf/default.nix:67`
- **Outputs**:
  - `out`:  `/nix/store/833yq6p33jm1466ivxbf69cxgckgac06-opensnitch_ebpf-1.7.2-5.15.193`
