...
- **Name**: `rPackages.nasadata`
- **Version**: `0.9.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/nasadata/](https://cran.r-project.org/web/packages/nasadata/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/fa2y3vpd9g687y8f5pnp4zg938pcz3q8-r-nasadata-0.9.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/fa2y3vpd9g687y8f5pnp4zg938pcz3q8-r-nasadata-0.9.0`
...
- [[z148391plv0f7jz9imgs9xhx05p8cm0w-nasadata_0.9.0.tar.gz]]
