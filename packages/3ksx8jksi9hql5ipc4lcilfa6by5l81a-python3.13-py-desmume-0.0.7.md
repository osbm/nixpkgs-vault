...
- **Name**: `python313Packages.py-desmume`
- **Version**: `0.0.7`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Python library to interface with DeSmuME, the Nintendo DS emulator
- **Homepage**: [https://github.com/SkyTemple/py-desmume](https://github.com/SkyTemple/py-desmume)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/3ksx8jksi9hql5ipc4lcilfa6by5l81a-python3.13-py-desmume-0.0.7.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/py-desmume/default.nix:61`
- **Outputs**:
  - `dist`:  `/nix/store/3ksx8jksi9hql5ipc4lcilfa6by5l81a-python3.13-py-desmume-0.0.7`
  - `out`:  `/nix/store/3ksx8jksi9hql5ipc4lcilfa6by5l81a-python3.13-py-desmume-0.0.7`
...
- [[hrgl6hy9vig3s49npj31czf9xjsnn7mg-source]]
