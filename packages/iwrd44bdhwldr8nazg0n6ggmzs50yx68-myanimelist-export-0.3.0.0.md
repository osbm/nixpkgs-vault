...
- **Name**: `haskellPackages.myanimelist-export`
- **Version**: `0.3.0.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Export from MyAnimeList
- **Homepage**: [https://hackage.haskell.org/package/myanimelist-export](https://hackage.haskell.org/package/myanimelist-export)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/iwrd44bdhwldr8nazg0n6ggmzs50yx68-myanimelist-export-0.3.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:468375`
- **Outputs**:
  - `doc`:  `/nix/store/iwrd44bdhwldr8nazg0n6ggmzs50yx68-myanimelist-export-0.3.0.0`
  - `out`:  `/nix/store/iwrd44bdhwldr8nazg0n6ggmzs50yx68-myanimelist-export-0.3.0.0`
...
- [[a962fwkbr86mlbpfiy0bagjbn1vn82y8-myanimelist-export-0.3.0.0.tar.gz]]
