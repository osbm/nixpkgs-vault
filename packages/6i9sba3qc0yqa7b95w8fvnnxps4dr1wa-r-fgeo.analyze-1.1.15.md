...
- **Name**: `rPackages.fgeo_analyze`
- **Version**: `1.1.15`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/fgeo.analyze/](https://cran.r-project.org/web/packages/fgeo.analyze/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/6i9sba3qc0yqa7b95w8fvnnxps4dr1wa-r-fgeo.analyze-1.1.15.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/6i9sba3qc0yqa7b95w8fvnnxps4dr1wa-r-fgeo.analyze-1.1.15`
...
- [[x3lvnn7qdsn5izq10kl7k90p42zam8yl-fgeo.analyze_1.1.15.tar.gz]]
