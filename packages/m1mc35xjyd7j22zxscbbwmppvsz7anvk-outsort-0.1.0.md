...
- **Name**: `haskellPackages.outsort`
- **Version**: `0.1.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: External sorting package based on Conduit
- **Homepage**: [https://hackage.haskell.org/package/outsort](https://hackage.haskell.org/package/outsort)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/m1mc35xjyd7j22zxscbbwmppvsz7anvk-outsort-0.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:497552`
- **Outputs**:
  - `doc`:  `/nix/store/m1mc35xjyd7j22zxscbbwmppvsz7anvk-outsort-0.1.0`
  - `out`:  `/nix/store/m1mc35xjyd7j22zxscbbwmppvsz7anvk-outsort-0.1.0`

## 🔗 Dependencies

- [[2hjvvhn7638j65cfqdbjx8pb2kb08lq8-conduit-algorithms-0.0.14.0]]
...
- [[gim9lkc4cnkl5dw99yfwvm7dn9zk1a03-safeio-0.0.6.0]]
...
- [[rigld4gx3lm0k5j3kfrh1182ral0wl6b-outsort-0.1.0.tar.gz]]
