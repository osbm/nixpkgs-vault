---
aliases:
  - haskellPackages.configuration-tools
tags:
  - license/unknown
  - outputs/doc
  - outputs/out
...
- **Name**: `haskellPackages.configuration-tools`
- **Version**: `0.7.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Tools for specifying and parsing configurations
- **Homepage**: [https://hackage.haskell.org/package/configuration-tools](https://hackage.haskell.org/package/configuration-tools)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/b8jl7n3f63lp5dc6ryczyhacivhlsbsw-configuration-tools-0.7.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:158548`
- **Outputs**:
  - `doc`:  `/nix/store/b8jl7n3f63lp5dc6ryczyhacivhlsbsw-configuration-tools-0.7.1`
  - `out`:  `/nix/store/b8jl7n3f63lp5dc6ryczyhacivhlsbsw-configuration-tools-0.7.1`

## 🔗 Dependencies

- [[28l9xwf5lxjcf5p67axf3azxx0wprmr1-configuration-tools-0.7.1.tar.gz]]
