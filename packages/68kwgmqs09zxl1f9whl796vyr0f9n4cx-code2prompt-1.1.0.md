...
CLI tool that converts your codebase into a single LLM prompt with a source tree, prompt templating, and token counting
...
- **Homepage**: [https://github.com/mufeedvh/code2prompt](https://github.com/mufeedvh/code2prompt)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/68kwgmqs09zxl1f9whl796vyr0f9n4cx-code2prompt-1.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/co/code2prompt/package.nix:34`
- **Outputs**:
  - `out`:  `/nix/store/68kwgmqs09zxl1f9whl796vyr0f9n4cx-code2prompt-1.1.0`
...
- [[wr967khr9flpp10ixxlmr17qws65q729-source]]
- [[xqxbqs6qgnhvpkcai046s94jfrx8wb62-cargo-check-hook.sh]]
- [[yhix4f8y8l0z6v555mqfyaak5bb64yjh-cargo-vendor-dir]]

## 📁 Input Sources

- `/nix/store/8hv5w4g35gzabimlmjnf60dszn15f0ym-Cargo.lock`
