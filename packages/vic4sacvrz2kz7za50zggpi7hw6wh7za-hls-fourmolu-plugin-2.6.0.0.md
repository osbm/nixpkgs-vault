...
- **Name**: `haskellPackages.hls-fourmolu-plugin`
- **Version**: `2.6.0.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Integration with the Fourmolu code formatter
- **Homepage**: [https://hackage.haskell.org/package/hls-fourmolu-plugin](https://hackage.haskell.org/package/hls-fourmolu-plugin)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/vic4sacvrz2kz7za50zggpi7hw6wh7za-hls-fourmolu-plugin-2.6.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:334270`
- **Outputs**:
  - `doc`:  `/nix/store/vic4sacvrz2kz7za50zggpi7hw6wh7za-hls-fourmolu-plugin-2.6.0.0`
  - `out`:  `/nix/store/vic4sacvrz2kz7za50zggpi7hw6wh7za-hls-fourmolu-plugin-2.6.0.0`
...
- [[5ysl3anj2h579vjhr8qkj9bkrwfh7slf-hls-fourmolu-plugin-2.6.0.0.tar.gz]]
