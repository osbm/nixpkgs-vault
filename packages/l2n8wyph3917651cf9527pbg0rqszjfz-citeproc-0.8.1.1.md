...
- **Name**: `haskellPackages.citeproc`
- **Version**: `0.8.1.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Generates citations and bibliography from CSL styles
- **Homepage**: [https://hackage.haskell.org/package/citeproc](https://hackage.haskell.org/package/citeproc)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/l2n8wyph3917651cf9527pbg0rqszjfz-citeproc-0.8.1.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:140533`
- **Outputs**:
  - `bin`:  `/nix/store/l2n8wyph3917651cf9527pbg0rqszjfz-citeproc-0.8.1.1`
  - `doc`:  `/nix/store/l2n8wyph3917651cf9527pbg0rqszjfz-citeproc-0.8.1.1`
  - `out`:  `/nix/store/l2n8wyph3917651cf9527pbg0rqszjfz-citeproc-0.8.1.1`
...
- [[i4hmfkkxlyyfxgm7r85bml1rkgg8blfy-citeproc-0.8.1.1.tar.gz]]
...
- [[vf64nbdfsklfnk4bkl4vpwijf4s8k2yd-citeproc-0.8.1.1-r1.cabal]]
