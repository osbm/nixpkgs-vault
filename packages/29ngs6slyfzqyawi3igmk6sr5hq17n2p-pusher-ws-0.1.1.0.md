...
- **Name**: `haskellPackages.pusher-ws`
- **Version**: `0.1.1.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Implementation of the Pusher WebSocket protocol
- **Homepage**: [https://hackage.haskell.org/package/pusher-ws](https://hackage.haskell.org/package/pusher-ws)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/29ngs6slyfzqyawi3igmk6sr5hq17n2p-pusher-ws-0.1.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:548519`
- **Outputs**:
  - `doc`:  `/nix/store/29ngs6slyfzqyawi3igmk6sr5hq17n2p-pusher-ws-0.1.1.0`
  - `out`:  `/nix/store/29ngs6slyfzqyawi3igmk6sr5hq17n2p-pusher-ws-0.1.1.0`
...
- [[za7mc902q1qa93is6cr8frj3ladqfnmm-pusher-ws-0.1.1.0.tar.gz]]
