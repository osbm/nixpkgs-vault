---
aliases:
  - haskellPackages.hnix-store-tests
tags:
  - license/unknown
  - outputs/doc
  - outputs/out
...
Test utilities and instances

## 📋 Package Information

- **Name**: `haskellPackages.hnix-store-tests`
- **Version**: `0.1.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Test utilities and instances
- **Homepage**: [https://hackage.haskell.org/package/hnix-store-tests](https://hackage.haskell.org/package/hnix-store-tests)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/xmnz8wwrkkzqs1idp4ff7pjcqgl7sh8x-hnix-store-tests-0.1.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:337529`
- **Outputs**:
  - `doc`:  `/nix/store/xmnz8wwrkkzqs1idp4ff7pjcqgl7sh8x-hnix-store-tests-0.1.0.0`
  - `out`:  `/nix/store/xmnz8wwrkkzqs1idp4ff7pjcqgl7sh8x-hnix-store-tests-0.1.0.0`
...
- [[blv0p0jzk9yr3abin2cz34ckkc246ibi-hnix-store-tests-0.1.0.0.tar.gz]]
