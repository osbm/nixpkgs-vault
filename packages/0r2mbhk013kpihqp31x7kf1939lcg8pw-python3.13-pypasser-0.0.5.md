...
- **Name**: `python313Packages.pypasser`
- **Version**: `0.0.5`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/0r2mbhk013kpihqp31x7kf1939lcg8pw-python3.13-pypasser-0.0.5.drv`
...
- **Outputs**:
  - `dist`:  `/nix/store/0r2mbhk013kpihqp31x7kf1939lcg8pw-python3.13-pypasser-0.0.5`
  - `out`:  `/nix/store/0r2mbhk013kpihqp31x7kf1939lcg8pw-python3.13-pypasser-0.0.5`
