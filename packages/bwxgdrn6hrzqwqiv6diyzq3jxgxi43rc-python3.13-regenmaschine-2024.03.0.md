---
aliases:
  - python313Packages.regenmaschine
tags:
  - license/unknown
  - maintainers/fabaff
  - outputs/dist
...
- **Name**: `python313Packages.regenmaschine`
- **Version**: `2024.03.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Python library for interacting with RainMachine smart sprinkler controllers
- **Homepage**: [https://github.com/bachya/regenmaschine](https://github.com/bachya/regenmaschine)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/bwxgdrn6hrzqwqiv6diyzq3jxgxi43rc-python3.13-regenmaschine-2024.03.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/regenmaschine/default.nix:57`
- **Outputs**:
  - `dist`:  `/nix/store/bwxgdrn6hrzqwqiv6diyzq3jxgxi43rc-python3.13-regenmaschine-2024.03.0`
  - `out`:  `/nix/store/bwxgdrn6hrzqwqiv6diyzq3jxgxi43rc-python3.13-regenmaschine-2024.03.0`

## 🔗 Dependencies

- [[06a2j9jv7f40ihnra63q0xx99ry62h35-python-imports-check-hook.sh]]
- [[257k0vnqp1xjgyrpc5as1r0nl7s4yv71-python3-3.13.7]]
- [[2ym8hf95m77pwkjrmn453xjhbg45dhlk-source]]
