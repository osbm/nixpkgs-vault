...
- **Name**: `rPackages.autoTS`
- **Version**: `0.9.11`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/autoTS/](https://cran.r-project.org/web/packages/autoTS/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/y0if0ijqpx1ilr2pyfckdlh1k2f6iyrg-r-autoTS-0.9.11.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/y0if0ijqpx1ilr2pyfckdlh1k2f6iyrg-r-autoTS-0.9.11`
...
- [[8g1hf4r9al8w4p46zx7zmc4psgqj9qky-autoTS_0.9.11.tar.gz]]
