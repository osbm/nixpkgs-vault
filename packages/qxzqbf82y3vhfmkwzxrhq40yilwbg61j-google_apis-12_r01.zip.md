---
aliases:
  - androidenv.androidPkgs.all.addons.v12.google_apis
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.addons.v12.google_apis`
- **Version**: `12_r01.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/qxzqbf82y3vhfmkwzxrhq40yilwbg61j-google_apis-12_r01.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/qxzqbf82y3vhfmkwzxrhq40yilwbg61j-google_apis-12_r01.zip`
