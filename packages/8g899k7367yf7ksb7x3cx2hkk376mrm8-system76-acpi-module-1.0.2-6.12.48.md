---
aliases:
  - linuxKernel.packages.linux_6_12.system76-acpi
tags:
  - license/unknown
...
- **Name**: `linuxKernel.packages.linux_6_12.system76-acpi`
- **Version**: `1.0.2-6.12.48`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/8g899k7367yf7ksb7x3cx2hkk376mrm8-system76-acpi-module-1.0.2-6.12.48.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/system76-acpi/default.nix:49`
- **Outputs**:
  - `out`:  `/nix/store/8g899k7367yf7ksb7x3cx2hkk376mrm8-system76-acpi-module-1.0.2-6.12.48`
