...
- **Name**: `haskellPackages.erd`
- **Version**: `0.2.1.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: An entity-relationship diagram generator from a plain text description
- **Homepage**: [https://hackage.haskell.org/package/erd](https://hackage.haskell.org/package/erd)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/f8lkc6la7mq4fnf0d2nhmpgmqf014hci-erd-0.2.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:217300`
- **Outputs**:
  - `doc`:  `/nix/store/f8lkc6la7mq4fnf0d2nhmpgmqf014hci-erd-0.2.1.0`
  - `out`:  `/nix/store/f8lkc6la7mq4fnf0d2nhmpgmqf014hci-erd-0.2.1.0`
...
- [[6dkgki99x3wyzznwvwhh7xvsykjazfjp-erd-0.2.1.0.tar.gz]]
