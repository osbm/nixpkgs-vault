...
- **Name**: `php81Extensions.zlib`
- **Version**: `8.1.33`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: PHP upstream extension: zlib
...
- **Derivation Path**: `/nix/store/bc35wc8qs4a9higbaq6p7kj5d3fk9csq-php-zlib-8.1.33.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/top-level/php-packages.nix:206`
- **Outputs**:
  - `dev`:  `/nix/store/bc35wc8qs4a9higbaq6p7kj5d3fk9csq-php-zlib-8.1.33`
  - `out`:  `/nix/store/bc35wc8qs4a9higbaq6p7kj5d3fk9csq-php-zlib-8.1.33`
