---
aliases:
  - home-assistant-component-tests.hardware
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.hardware`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/7x5s7npgqdy1md134kjf504cpa9crcjg-homeassistant-test-hardware-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/7x5s7npgqdy1md134kjf504cpa9crcjg-homeassistant-test-hardware-2025.9.4`
