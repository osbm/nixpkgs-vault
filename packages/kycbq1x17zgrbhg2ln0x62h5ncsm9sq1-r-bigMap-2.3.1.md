...
- **Name**: `rPackages.bigMap`
- **Version**: `2.3.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/bigMap/](https://cran.r-project.org/web/packages/bigMap/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/kycbq1x17zgrbhg2ln0x62h5ncsm9sq1-r-bigMap-2.3.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/kycbq1x17zgrbhg2ln0x62h5ncsm9sq1-r-bigMap-2.3.1`

## 🔗 Dependencies

- [[3332qhwzbhh875dslm6vvwv141j1j1zj-bigMap_2.3.1.tar.gz]]
