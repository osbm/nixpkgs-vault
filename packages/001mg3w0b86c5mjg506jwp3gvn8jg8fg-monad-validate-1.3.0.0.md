---
aliases:
  - haskellPackages.monad-validate
tags:
  - license/unknown
  - outputs/doc
  - outputs/out
...
- **Name**: `haskellPackages.monad-validate`
- **Version**: `1.3.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: A monad transformer for data validation
- **Homepage**: [https://hackage.haskell.org/package/monad-validate](https://hackage.haskell.org/package/monad-validate)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/001mg3w0b86c5mjg506jwp3gvn8jg8fg-monad-validate-1.3.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:456280`
- **Outputs**:
  - `doc`:  `/nix/store/001mg3w0b86c5mjg506jwp3gvn8jg8fg-monad-validate-1.3.0.0`
  - `out`:  `/nix/store/001mg3w0b86c5mjg506jwp3gvn8jg8fg-monad-validate-1.3.0.0`
...
- [[fnx2ms24vqwimm8x89fgh6wviambs4m9-monad-validate-1.3.0.0.tar.gz]]
