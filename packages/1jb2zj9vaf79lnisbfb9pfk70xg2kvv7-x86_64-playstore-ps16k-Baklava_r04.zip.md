---
aliases:
  - androidenv.androidPkgs.all.system-images.Baklava.page_size_16kb.x86_64
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.system-images.Baklava.page_size_16kb.x86_64`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/1jb2zj9vaf79lnisbfb9pfk70xg2kvv7-x86_64-playstore-ps16k-Baklava_r04.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/1jb2zj9vaf79lnisbfb9pfk70xg2kvv7-x86_64-playstore-ps16k-Baklava_r04.zip`
