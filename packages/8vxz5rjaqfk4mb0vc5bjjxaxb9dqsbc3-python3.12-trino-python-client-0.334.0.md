...
- **Name**: `python312Packages.trino-python-client`
- **Version**: `0.334.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Client for the Trino distributed SQL Engine
- **Homepage**: [https://github.com/trinodb/trino-python-client](https://github.com/trinodb/trino-python-client)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/8vxz5rjaqfk4mb0vc5bjjxaxb9dqsbc3-python3.12-trino-python-client-0.334.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/trino-python-client/default.nix:81`
- **Outputs**:
  - `dist`:  `/nix/store/8vxz5rjaqfk4mb0vc5bjjxaxb9dqsbc3-python3.12-trino-python-client-0.334.0`
  - `out`:  `/nix/store/8vxz5rjaqfk4mb0vc5bjjxaxb9dqsbc3-python3.12-trino-python-client-0.334.0`
...
- [[n2x7662bsb1nnnp8ibk0fzilzy3nd4bw-source]]
...
- [[rfvlfp1xa2c83mb4yafi4nwp8h3mdmw7-python3.12-requests-gssapi-1.3.0]]
