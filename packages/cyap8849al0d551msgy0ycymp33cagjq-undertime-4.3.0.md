...
- **Homepage**: [https://gitlab.com/anarcat/undertime](https://gitlab.com/anarcat/undertime)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/cyap8849al0d551msgy0ycymp33cagjq-undertime-4.3.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/un/undertime/package.nix:36`
- **Outputs**:
  - `dist`:  `/nix/store/cyap8849al0d551msgy0ycymp33cagjq-undertime-4.3.0`
  - `out`:  `/nix/store/cyap8849al0d551msgy0ycymp33cagjq-undertime-4.3.0`
...
- [[hx9zxvsi8wdq22qnkkii58ng56z8w850-source]]
