---
aliases:
  - linuxKernel.packages.linux_6_12.openafs
tags:
  - license/unknown
  - maintainers/andersk
  - maintainers/maggesi
...
- **Name**: `linuxKernel.packages.linux_6_12.openafs`
- **Version**: `1.8.13.2-6.12.48`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/xsywhz7n1j0xwa3hh7rk4hl78hm4knxz-openafs-1.8.13.2-6.12.48.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/openafs/1.8/module.nix:158`
- **Outputs**:
  - `out`:  `/nix/store/xsywhz7n1j0xwa3hh7rk4hl78hm4knxz-openafs-1.8.13.2-6.12.48`
