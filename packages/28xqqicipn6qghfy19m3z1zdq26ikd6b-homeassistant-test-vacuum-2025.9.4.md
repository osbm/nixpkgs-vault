---
aliases:
  - home-assistant-component-tests.vacuum
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.vacuum`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/28xqqicipn6qghfy19m3z1zdq26ikd6b-homeassistant-test-vacuum-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/28xqqicipn6qghfy19m3z1zdq26ikd6b-homeassistant-test-vacuum-2025.9.4`
