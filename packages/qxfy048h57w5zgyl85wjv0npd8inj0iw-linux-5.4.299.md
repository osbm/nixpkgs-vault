...
The Linux kernel (with patches: bridge-stp-helper, request-key-helper, rtl8761b-support)

## 📋 Package Information

- **Name**: `linuxKernel.kernels.linux_5_4`
- **Version**: `5.4.299`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: The Linux kernel (with patches: bridge-stp-helper, request-key-helper, rtl8761b-support)
...
- **Derivation Path**: `/nix/store/qxfy048h57w5zgyl85wjv0npd8inj0iw-linux-5.4.299.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/kernel/mainline.nix:34`
- **Outputs**:
  - `dev`:  `/nix/store/qxfy048h57w5zgyl85wjv0npd8inj0iw-linux-5.4.299`
  - `modules`:  `/nix/store/qxfy048h57w5zgyl85wjv0npd8inj0iw-linux-5.4.299`
  - `out`:  `/nix/store/qxfy048h57w5zgyl85wjv0npd8inj0iw-linux-5.4.299`
...
- [[jcdbkpjr9z266jki7hfbmhn9xz400ljv-linux-config-5.4.299]]
