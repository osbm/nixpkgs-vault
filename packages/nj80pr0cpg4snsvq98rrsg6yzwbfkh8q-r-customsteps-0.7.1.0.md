...
- **Name**: `rPackages.customsteps`
- **Version**: `0.7.1.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://cran.r-project.org/web/packages/customsteps/](https://cran.r-project.org/web/packages/customsteps/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/nj80pr0cpg4snsvq98rrsg6yzwbfkh8q-r-customsteps-0.7.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/nj80pr0cpg4snsvq98rrsg6yzwbfkh8q-r-customsteps-0.7.1.0`
...
- [[qiz650fmvzmgxmssbjrzml1s4ryx1iy3-customsteps_0.7.1.0.tar.gz]]
