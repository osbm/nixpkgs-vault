...
- **Name**: `haskellPackages.clit`
- **Version**: `0.4.0.6`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Post tweets from stdin
- **Homepage**: [https://hackage.haskell.org/package/clit](https://hackage.haskell.org/package/clit)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/gyn2k4nkikhp751yaqqpvbljbbfayz82-clit-0.4.0.6.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:144903`
- **Outputs**:
  - `doc`:  `/nix/store/gyn2k4nkikhp751yaqqpvbljbbfayz82-clit-0.4.0.6`
  - `out`:  `/nix/store/gyn2k4nkikhp751yaqqpvbljbbfayz82-clit-0.4.0.6`
...
- [[p16jypls42m98safvq19195wnl89jmzi-clit-0.4.0.6.tar.gz]]
