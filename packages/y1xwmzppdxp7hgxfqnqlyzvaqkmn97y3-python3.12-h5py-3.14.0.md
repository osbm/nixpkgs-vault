...
- **Name**: `python312Packages.h5py-mpi`
- **Version**: `3.14.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Pythonic interface to the HDF5 binary data format
- **Homepage**: [http://www.h5py.org/](http://www.h5py.org/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/y1xwmzppdxp7hgxfqnqlyzvaqkmn97y3-python3.12-h5py-3.14.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/h5py/default.nix:97`
- **Outputs**:
  - `dist`:  `/nix/store/y1xwmzppdxp7hgxfqnqlyzvaqkmn97y3-python3.12-h5py-3.14.0`
  - `out`:  `/nix/store/y1xwmzppdxp7hgxfqnqlyzvaqkmn97y3-python3.12-h5py-3.14.0`

## 🔗 Dependencies

- [[285jpsfl65fbd3w5qz2za3gijhjbb7ay-openssh-10.0p2]]
- [[38w260qjda6jdvgvqgbzjfrpkivs4m3w-python3.12-pkgconfig-1.5.5]]
- [[4kjc0izzdglx00pk1z2kwfrd48kf0isk-h5py-3.14.0.tar.gz]]
