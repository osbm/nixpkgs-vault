...
- **Name**: `php81Extensions.session`
- **Version**: `8.1.33`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: PHP upstream extension: session
...
- **Derivation Path**: `/nix/store/92pkci3ryspyd4lcm4scpp5qmjhahwj5-php-session-8.1.33.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/top-level/php-packages.nix:206`
- **Outputs**:
  - `dev`:  `/nix/store/92pkci3ryspyd4lcm4scpp5qmjhahwj5-php-session-8.1.33`
  - `out`:  `/nix/store/92pkci3ryspyd4lcm4scpp5qmjhahwj5-php-session-8.1.33`
