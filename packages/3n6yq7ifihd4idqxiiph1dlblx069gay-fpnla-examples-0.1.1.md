---
aliases:
  - haskellPackages.fpnla-examples
tags:
  - license/unknown
  - outputs/doc
  - outputs/out
...
- **Name**: `haskellPackages.fpnla-examples`
- **Version**: `0.1.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Example implementations for FPNLA library
- **Homepage**: [https://hackage.haskell.org/package/fpnla-examples](https://hackage.haskell.org/package/fpnla-examples)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/3n6yq7ifihd4idqxiiph1dlblx069gay-fpnla-examples-0.1.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:242503`
- **Outputs**:
  - `doc`:  `/nix/store/3n6yq7ifihd4idqxiiph1dlblx069gay-fpnla-examples-0.1.1`
  - `out`:  `/nix/store/3n6yq7ifihd4idqxiiph1dlblx069gay-fpnla-examples-0.1.1`
...
- [[ilfp9gpb606s89k2hpcfsnx4ck8rjq0w-fpnla-0.1.1]]
...
- [[nmbv6zdaa0dr1w1n9f67lg062dyq3lx3-linear-algebra-cblas-0.1]]
- [[p76r0cwlf6k97ibprrpfd8xw0r8wc3nx-stdenv-linux]]
- [[qnw8j5j3p1nr132ckzaz00p0c8zbgnmm-data-default-0.7.1.3]]
- [[v9a84jfph4k9x7yhhf2zmygw5k3q0732-vector-0.13.2.0]]
- [[xa70ll0dz4wjzpnw2n9wk8f8py1fpjyy-fpnla-examples-0.1.1.tar.gz]]
