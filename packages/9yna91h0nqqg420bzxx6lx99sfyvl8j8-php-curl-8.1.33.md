...
- **Name**: `php81Extensions.curl`
- **Version**: `8.1.33`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: PHP upstream extension: curl
...
- **Derivation Path**: `/nix/store/9yna91h0nqqg420bzxx6lx99sfyvl8j8-php-curl-8.1.33.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/top-level/php-packages.nix:206`
- **Outputs**:
  - `dev`:  `/nix/store/9yna91h0nqqg420bzxx6lx99sfyvl8j8-php-curl-8.1.33`
  - `out`:  `/nix/store/9yna91h0nqqg420bzxx6lx99sfyvl8j8-php-curl-8.1.33`
