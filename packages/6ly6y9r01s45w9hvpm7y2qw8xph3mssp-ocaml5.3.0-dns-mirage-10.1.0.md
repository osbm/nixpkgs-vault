...
Opinionated Domain Name System (DNS) library

## 📋 Package Information

- **Name**: `ocamlPackages.dns-mirage`
- **Version**: `10.1.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/6ly6y9r01s45w9hvpm7y2qw8xph3mssp-ocaml5.3.0-dns-mirage-10.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/ocaml-modules/dns/mirage.nix:24`
- **Outputs**:
  - `out`:  `/nix/store/6ly6y9r01s45w9hvpm7y2qw8xph3mssp-ocaml5.3.0-dns-mirage-10.1.0`
