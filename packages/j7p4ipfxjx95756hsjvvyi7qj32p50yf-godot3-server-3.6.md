...
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Free and Open Source 2D and 3D game engine (server)
...
- **Derivation Path**: `/nix/store/j7p4ipfxjx95756hsjvvyi7qj32p50yf-godot3-server-3.6.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/tools/godot/3/default.nix:178`
- **Outputs**:
  - `out`:  `/nix/store/j7p4ipfxjx95756hsjvvyi7qj32p50yf-godot3-server-3.6`
