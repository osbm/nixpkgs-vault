...
- **Name**: `rPackages.tidyhydat`
- **Version**: `0.7.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/tidyhydat/](https://cran.r-project.org/web/packages/tidyhydat/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/7a021malncxph6ynzh5gws73f4idw3fj-r-tidyhydat-0.7.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/7a021malncxph6ynzh5gws73f4idw3fj-r-tidyhydat-0.7.1`

## 🔗 Dependencies

- [[15vvlhpjglzzx7v605kh5nmlbbhbfjrd-tidyhydat_0.7.1.tar.gz]]
