...
- **Name**: `perl540Packages.InlineJava`
- **Version**: `0.67`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Write Perl classes in Java
- **Homepage**: [https://metacpan.org/dist/Inline-Java](https://metacpan.org/dist/Inline-Java)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/xb9hqbvy1a3f7hrc55fryfm140ypplgl-perl5.40.0-Inline-Java-0.67.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/top-level/perl-packages.nix:18049`
- **Outputs**:
  - `devdoc`:  `/nix/store/xb9hqbvy1a3f7hrc55fryfm140ypplgl-perl5.40.0-Inline-Java-0.67`
  - `out`:  `/nix/store/xb9hqbvy1a3f7hrc55fryfm140ypplgl-perl5.40.0-Inline-Java-0.67`

## 🔗 Dependencies

- [[1w2gbqjc50nm9ah5zvxnykd1pfkzrknl-Inline-Java-0.67.tar.gz]]
