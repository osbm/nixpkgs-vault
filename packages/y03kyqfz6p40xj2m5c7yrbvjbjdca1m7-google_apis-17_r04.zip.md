---
aliases:
  - androidenv.androidPkgs.all.addons.v17.google_apis
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.addons.v17.google_apis`
- **Version**: `17_r04.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/y03kyqfz6p40xj2m5c7yrbvjbjdca1m7-google_apis-17_r04.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/y03kyqfz6p40xj2m5c7yrbvjbjdca1m7-google_apis-17_r04.zip`
