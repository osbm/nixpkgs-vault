---
aliases:
  - linuxKernel.packages.linux_xanmod.usbip
tags:
  - license/unknown
  - outputs/out
---
...
- **Name**: `linuxKernel.packages.linux_xanmod.usbip`
- **Version**: `6.12.48`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/34lnyxc3jg6hdqvc6r5k8vcxq8ajrgp3-usbip-linux-xanmod-6.12.48.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/usbip/default.nix:45`
- **Outputs**:
  - `out`:  `/nix/store/34lnyxc3jg6hdqvc6r5k8vcxq8ajrgp3-usbip-linux-xanmod-6.12.48`
