...
- **Name**: `python313Packages.python-kasa`
- **Version**: `0.10.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Python API for TP-Link Kasa Smarthome products
- **Homepage**: [https://python-kasa.readthedocs.io/](https://python-kasa.readthedocs.io/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/cx33wq620ww2ng88w0c8bjjw217xv3sm-python3.13-python-kasa-0.10.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/python-kasa/default.nix:78`
- **Outputs**:
  - `dist`:  `/nix/store/cx33wq620ww2ng88w0c8bjjw217xv3sm-python3.13-python-kasa-0.10.2`
  - `out`:  `/nix/store/cx33wq620ww2ng88w0c8bjjw217xv3sm-python3.13-python-kasa-0.10.2`
...
- [[7xg2kxbbnczszmpk49gvfpdm511agr3p-source]]
