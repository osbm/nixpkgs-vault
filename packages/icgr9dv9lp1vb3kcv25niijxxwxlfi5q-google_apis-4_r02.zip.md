---
aliases:
  - androidenv.androidPkgs.all.addons.v4.google_apis
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.addons.v4.google_apis`
- **Version**: `4_r02.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/icgr9dv9lp1vb3kcv25niijxxwxlfi5q-google_apis-4_r02.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/icgr9dv9lp1vb3kcv25niijxxwxlfi5q-google_apis-4_r02.zip`
