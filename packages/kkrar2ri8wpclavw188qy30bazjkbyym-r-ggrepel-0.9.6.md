...
- **Name**: `rPackages.ggrepel`
- **Version**: `0.9.6`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/ggrepel/](https://cran.r-project.org/web/packages/ggrepel/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/kkrar2ri8wpclavw188qy30bazjkbyym-r-ggrepel-0.9.6.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/kkrar2ri8wpclavw188qy30bazjkbyym-r-ggrepel-0.9.6`
...
- [[z9pwwz03hc1d5s8l8w4j4fy9x21nkynb-ggrepel_0.9.6.tar.gz]]
