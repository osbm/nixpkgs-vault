---
aliases:
  - haskellPackages.network-bitcoin
tags:
  - broken
  - not-available
  - license/unknown
...
- **Name**: `haskellPackages.network-bitcoin`
- **Version**: `1.9.1`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: An interface to bitcoind
- **Homepage**: [https://hackage.haskell.org/package/network-bitcoin](https://hackage.haskell.org/package/network-bitcoin)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/bd5y3a7nanyzxhxfz08mpr6alh7q73fy-network-bitcoin-1.9.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:474579`
- **Outputs**:
  - `doc`:  `/nix/store/bd5y3a7nanyzxhxfz08mpr6alh7q73fy-network-bitcoin-1.9.1`
  - `out`:  `/nix/store/bd5y3a7nanyzxhxfz08mpr6alh7q73fy-network-bitcoin-1.9.1`
...
- [[9kjglmrgzcda4j7fvp95xx63hip67qwr-network-bitcoin-1.9.1.tar.gz]]
