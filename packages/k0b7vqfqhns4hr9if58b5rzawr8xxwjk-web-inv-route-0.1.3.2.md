...
- **Name**: `haskellPackages.web-inv-route`
- **Version**: `0.1.3.2`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Composable, reversible, efficient web routing using invertible invariants and bijections
- **Homepage**: [https://hackage.haskell.org/package/web-inv-route](https://hackage.haskell.org/package/web-inv-route)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/k0b7vqfqhns4hr9if58b5rzawr8xxwjk-web-inv-route-0.1.3.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:717551`
- **Outputs**:
  - `doc`:  `/nix/store/k0b7vqfqhns4hr9if58b5rzawr8xxwjk-web-inv-route-0.1.3.2`
  - `out`:  `/nix/store/k0b7vqfqhns4hr9if58b5rzawr8xxwjk-web-inv-route-0.1.3.2`
...
- [[m7jj4bsw08x8rigf4jkwx2y7fvnpsq09-web-inv-route-0.1.3.2.tar.gz]]
