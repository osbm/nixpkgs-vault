...
- **Homepage**: [https://sourceforge.net/p/csv2odf/wiki/Main_Page/](https://sourceforge.net/p/csv2odf/wiki/Main_Page/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/xpjir1nvk1s286f44bg4psv5lbqn8a1q-csv2odf-2.09.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/cs/csv2odf/package.nix:23`
- **Outputs**:
  - `dist`:  `/nix/store/xpjir1nvk1s286f44bg4psv5lbqn8a1q-csv2odf-2.09`
  - `out`:  `/nix/store/xpjir1nvk1s286f44bg4psv5lbqn8a1q-csv2odf-2.09`
...
- [[pygwznqr463wqqaz5zzi9224ys9d2nbl-csv2odf-2.09.tar.gz]]
