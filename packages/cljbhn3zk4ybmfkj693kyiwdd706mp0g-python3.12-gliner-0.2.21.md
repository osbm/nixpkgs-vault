...
- **Name**: `python312Packages.gliner`
- **Version**: `0.2.21`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Generalist and Lightweight Model for Named Entity Recognition
- **Homepage**: [https://github.com/urchade/GLiNER](https://github.com/urchade/GLiNER)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/cljbhn3zk4ybmfkj693kyiwdd706mp0g-python3.12-gliner-0.2.21.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/gliner/default.nix:49`
- **Outputs**:
  - `dist`:  `/nix/store/cljbhn3zk4ybmfkj693kyiwdd706mp0g-python3.12-gliner-0.2.21`
  - `out`:  `/nix/store/cljbhn3zk4ybmfkj693kyiwdd706mp0g-python3.12-gliner-0.2.21`

## 🔗 Dependencies

- [[01snwzmzl4pm638jnggnzvcdd5m2yq2l-python3.12-torch-2.8.0]]
- [[32prg1r9prkvslffmhc3d9v78lcpdr3n-source]]
