...
- **Derivation Path**: `/nix/store/xnpaprij0bvqzbvjaxycxa6ps67fhr1a-stdenv-linux.drv`
- **Outputs**:
  - `out`:  `/nix/store/xnpaprij0bvqzbvjaxycxa6ps67fhr1a-stdenv-linux`
...
- [[5md246y5glcg0mfkpwndswdjqm3lgciz-gcc-wrapper-14.3.0]]
