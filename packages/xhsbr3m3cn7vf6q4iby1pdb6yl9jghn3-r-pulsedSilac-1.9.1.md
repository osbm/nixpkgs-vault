...
- **Name**: `rPackages.pulsedSilac`
- **Version**: `1.9.1`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://bioconductor.org/packages/3.21/bioc/html/pulsedSilac.html](https://bioconductor.org/packages/3.21/bioc/html/pulsedSilac.html)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/xhsbr3m3cn7vf6q4iby1pdb6yl9jghn3-r-pulsedSilac-1.9.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/xhsbr3m3cn7vf6q4iby1pdb6yl9jghn3-r-pulsedSilac-1.9.1`
...
- [[xlp7i11qb8w9gfczrlz9z5yw1q0vd8m8-pulsedSilac_1.9.1.tar.gz]]
