...
- **Name**: `haskellPackages.hledger-flow`
- **Version**: `0.14.4`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: An hledger workflow focusing on automated statement import and classification
- **Homepage**: [https://hackage.haskell.org/package/hledger-flow](https://hackage.haskell.org/package/hledger-flow)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/g46d68gxgdbq46q5mnlg5lmh8jnivvmk-hledger-flow-0.14.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:331790`
- **Outputs**:
  - `doc`:  `/nix/store/g46d68gxgdbq46q5mnlg5lmh8jnivvmk-hledger-flow-0.14.4`
  - `out`:  `/nix/store/g46d68gxgdbq46q5mnlg5lmh8jnivvmk-hledger-flow-0.14.4`
...
- [[9510cmjhlysvfgy8c6dd13h2xcqalznk-hledger-flow-0.14.4.tar.gz]]
