...
- **Name**: `haskellPackages.ffmpeg-light`
- **Version**: `0.14.1`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Minimal bindings to the FFmpeg library
- **Homepage**: [https://hackage.haskell.org/package/ffmpeg-light](https://hackage.haskell.org/package/ffmpeg-light)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/fl0gh2gfai2rl9ncd80lccymphabgv2q-ffmpeg-light-0.14.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:231970`
- **Outputs**:
  - `doc`:  `/nix/store/fl0gh2gfai2rl9ncd80lccymphabgv2q-ffmpeg-light-0.14.1`
  - `out`:  `/nix/store/fl0gh2gfai2rl9ncd80lccymphabgv2q-ffmpeg-light-0.14.1`
...
- [[3jam6m4kfiwjawyc3974s9n4pcw1yjgd-ffmpeg-light-0.14.1.tar.gz]]
