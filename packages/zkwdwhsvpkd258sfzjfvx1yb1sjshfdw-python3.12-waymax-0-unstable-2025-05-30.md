...
JAX-based simulator for autonomous driving research

## 📋 Package Information

- **Name**: `python312Packages.waymax`
- **Version**: `0-unstable-2025-05-30`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: JAX-based simulator for autonomous driving research
- **Homepage**: [https://github.com/waymo-research/waymax](https://github.com/waymo-research/waymax)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/zkwdwhsvpkd258sfzjfvx1yb1sjshfdw-python3.12-waymax-0-unstable-2025-05-30.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/waymax/default.nix:71`
- **Outputs**:
  - `dist`:  `/nix/store/zkwdwhsvpkd258sfzjfvx1yb1sjshfdw-python3.12-waymax-0-unstable-2025-05-30`
  - `out`:  `/nix/store/zkwdwhsvpkd258sfzjfvx1yb1sjshfdw-python3.12-waymax-0-unstable-2025-05-30`

## 🔗 Dependencies

- [[1c9lb3501z93y6j0zqv22nsshgy6l3r1-source]]
...
- [[jvr5ls4rviv48ly95aqi7xvacg0nr3ca-python3.12-chex-0.1.91]]
...
- [[ywjfdwhy2v1ssdsvpyxginihj3n95bs2-python3.12-mediapy-1.2.4]]
