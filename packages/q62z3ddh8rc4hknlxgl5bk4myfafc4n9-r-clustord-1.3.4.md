...
- **Name**: `rPackages.clustord`
- **Version**: `1.3.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/clustord/](https://cran.r-project.org/web/packages/clustord/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/q62z3ddh8rc4hknlxgl5bk4myfafc4n9-r-clustord-1.3.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/q62z3ddh8rc4hknlxgl5bk4myfafc4n9-r-clustord-1.3.4`

## 🔗 Dependencies

- [[0i5268hcbx68hxhpr504gbrvvh3gg4kv-clustord_1.3.4.tar.gz]]
