...
- **Name**: `rPackages.tidytree`
- **Version**: `0.4.6`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/tidytree/](https://cran.r-project.org/web/packages/tidytree/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/l0la71fq1c9wyr2sp8nm13v9lh9m45np-r-tidytree-0.4.6.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/l0la71fq1c9wyr2sp8nm13v9lh9m45np-r-tidytree-0.4.6`
...
- [[gq2nh620mc3v8mjn7z92n0gr25gxrdnh-tidytree_0.4.6.tar.gz]]
