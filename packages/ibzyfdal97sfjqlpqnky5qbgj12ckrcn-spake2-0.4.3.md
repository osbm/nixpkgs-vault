...
- **Name**: `haskellPackages.spake2`
- **Version**: `0.4.3`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Implementation of the SPAKE2 Password-Authenticated Key Exchange algorithm
- **Homepage**: [https://hackage.haskell.org/package/spake2](https://hackage.haskell.org/package/spake2)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/ibzyfdal97sfjqlpqnky5qbgj12ckrcn-spake2-0.4.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:625891`
- **Outputs**:
  - `data`:  `/nix/store/ibzyfdal97sfjqlpqnky5qbgj12ckrcn-spake2-0.4.3`
  - `doc`:  `/nix/store/ibzyfdal97sfjqlpqnky5qbgj12ckrcn-spake2-0.4.3`
  - `out`:  `/nix/store/ibzyfdal97sfjqlpqnky5qbgj12ckrcn-spake2-0.4.3`
...
- [[8a4i8dpqpgrfqc5alfsyqmjpfi1jspi6-spake2-0.4.3.tar.gz]]
