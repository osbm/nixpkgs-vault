---
aliases:
  - linuxKernel.packages.linux_5_10.hid-t150
tags:
  - license/unknown
  - maintainers/dbalan
  - outputs/out
...
- **Name**: `linuxKernel.packages.linux_5_10.hid-t150`
- **Version**: `0.8a`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/8f6mh3mqysx9gjc9vbkzrzda5v4i8518-hid-t150-0.8a.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/hid-t150/default.nix:35`
- **Outputs**:
  - `out`:  `/nix/store/8f6mh3mqysx9gjc9vbkzrzda5v4i8518-hid-t150-0.8a`
