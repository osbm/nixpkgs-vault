...
- **Homepage**: [http://comicneue.com/](http://comicneue.com/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/75l5r1ka7c9jamgkqwakrqjlrv64j6wk-comic-neue-2.51.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/co/comic-neue/package.nix:30`
- **Outputs**:
  - `out`:  `/nix/store/75l5r1ka7c9jamgkqwakrqjlrv64j6wk-comic-neue-2.51`

## 🔗 Dependencies

- [[a9yz7gxmris2jrmn4srx1klsl8xch99x-source]]
