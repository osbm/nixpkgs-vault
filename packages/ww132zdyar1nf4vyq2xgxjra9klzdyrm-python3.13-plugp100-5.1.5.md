...
Python library to control Tapo Plug P100 devices

## 📋 Package Information

- **Name**: `python313Packages.plugp100`
- **Version**: `5.1.5`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Python library to control Tapo Plug P100 devices
- **Homepage**: [https://github.com/petretiandrea/plugp100](https://github.com/petretiandrea/plugp100)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/ww132zdyar1nf4vyq2xgxjra9klzdyrm-python3.13-plugp100-5.1.5.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/plugp100/default.nix:57`
- **Outputs**:
  - `dist`:  `/nix/store/ww132zdyar1nf4vyq2xgxjra9klzdyrm-python3.13-plugp100-5.1.5`
  - `out`:  `/nix/store/ww132zdyar1nf4vyq2xgxjra9klzdyrm-python3.13-plugp100-5.1.5`
...
- [[mmgb2apmjyvbkva1v50dvh1hb9lay76c-source]]
