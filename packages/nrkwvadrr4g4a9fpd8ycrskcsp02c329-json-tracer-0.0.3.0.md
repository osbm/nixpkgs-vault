...
- **Name**: `haskellPackages.json-tracer`
- **Version**: `0.0.3.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: A polymorphic, type-safe, json-structured tracing library
- **Homepage**: [https://hackage.haskell.org/package/json-tracer](https://hackage.haskell.org/package/json-tracer)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/nrkwvadrr4g4a9fpd8ycrskcsp02c329-json-tracer-0.0.3.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:394086`
- **Outputs**:
  - `doc`:  `/nix/store/nrkwvadrr4g4a9fpd8ycrskcsp02c329-json-tracer-0.0.3.0`
  - `out`:  `/nix/store/nrkwvadrr4g4a9fpd8ycrskcsp02c329-json-tracer-0.0.3.0`
...
- [[jpsm2mjhck25kk60g050ifwgi41mdra0-json-tracer-0.0.3.0.tar.gz]]
