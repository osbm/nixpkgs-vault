---
aliases:
  - androidenv.androidPkgs.all.system-images.v18.default.x86
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.system-images.v18.default.x86`
- **Version**: `18_r04.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/xhf7lvzpmj4jnrhrnc801p1sgjz02n16-x86-18_r04.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/xhf7lvzpmj4jnrhrnc801p1sgjz02n16-x86-18_r04.zip`
