...
- **Name**: `haskellPackages.puzzle-draw`
- **Version**: `0.3.0.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Creating graphics for pencil puzzles
- **Homepage**: [https://hackage.haskell.org/package/puzzle-draw](https://hackage.haskell.org/package/puzzle-draw)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/y4gpfpl6sikh58hgs8d2rxn4vqb72npp-puzzle-draw-0.3.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:548744`
- **Outputs**:
  - `data`:  `/nix/store/y4gpfpl6sikh58hgs8d2rxn4vqb72npp-puzzle-draw-0.3.0.0`
  - `doc`:  `/nix/store/y4gpfpl6sikh58hgs8d2rxn4vqb72npp-puzzle-draw-0.3.0.0`
  - `out`:  `/nix/store/y4gpfpl6sikh58hgs8d2rxn4vqb72npp-puzzle-draw-0.3.0.0`
...
- [[7b1zv5f9szws9d0iif51jdqz5dk0javs-puzzle-draw-0.3.0.0.tar.gz]]
