...
- **Name**: `python313Packages.aiomealie`
- **Version**: `0.10.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/bzhjavgsqdly98s9rx5vjbifgbghsx7q-python3.13-aiomealie-0.10.2.drv`
...
- **Outputs**:
  - `dist`:  `/nix/store/bzhjavgsqdly98s9rx5vjbifgbghsx7q-python3.13-aiomealie-0.10.2`
  - `out`:  `/nix/store/bzhjavgsqdly98s9rx5vjbifgbghsx7q-python3.13-aiomealie-0.10.2`
