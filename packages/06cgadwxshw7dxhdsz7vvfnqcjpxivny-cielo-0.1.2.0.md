...
- **Name**: `haskellPackages.cielo`
- **Version**: `0.1.2.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Cielo API v3 Bindings for Haskell
- **Homepage**: [https://hackage.haskell.org/package/cielo](https://hackage.haskell.org/package/cielo)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/06cgadwxshw7dxhdsz7vvfnqcjpxivny-cielo-0.1.2.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:139452`
- **Outputs**:
  - `doc`:  `/nix/store/06cgadwxshw7dxhdsz7vvfnqcjpxivny-cielo-0.1.2.0`
  - `out`:  `/nix/store/06cgadwxshw7dxhdsz7vvfnqcjpxivny-cielo-0.1.2.0`
...
- [[9gghsfhb6bkd4fj984xf1annzpsphk4r-cielo-0.1.2.0.tar.gz]]
