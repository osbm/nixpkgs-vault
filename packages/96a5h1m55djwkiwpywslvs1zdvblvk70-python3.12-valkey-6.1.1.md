...
- **Name**: `python312Packages.valkey`
- **Version**: `6.1.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Python client for Redis key-value store
- **Homepage**: [https://github.com/valkey-io/valkey-py](https://github.com/valkey-io/valkey-py)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/96a5h1m55djwkiwpywslvs1zdvblvk70-python3.12-valkey-6.1.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/valkey/default.nix:105`
- **Outputs**:
  - `dist`:  `/nix/store/96a5h1m55djwkiwpywslvs1zdvblvk70-python3.12-valkey-6.1.1`
  - `out`:  `/nix/store/96a5h1m55djwkiwpywslvs1zdvblvk70-python3.12-valkey-6.1.1`
...
- [[vw6gfnmqbbyjqlh092iy4a0wppvghmnp-source]]
