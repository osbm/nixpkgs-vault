...
Better rust version of pokeget
...
- **Homepage**: [https://github.com/talwat/pokeget-rs](https://github.com/talwat/pokeget-rs)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/6jzxcbw35i3qsv42ivm7d9xx50jcqbk5-pokeget-rs-1.6.5.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/po/pokeget-rs/package.nix:22`
- **Outputs**:
  - `out`:  `/nix/store/6jzxcbw35i3qsv42ivm7d9xx50jcqbk5-pokeget-rs-1.6.5`
...
- [[4ksamcmi0ny393756wy52pdp06p415ya-pokeget-rs-1.6.5-vendor]]
- [[65a63cr8cg6wxrqbqqv2n5jn6ia3l285-source]]
