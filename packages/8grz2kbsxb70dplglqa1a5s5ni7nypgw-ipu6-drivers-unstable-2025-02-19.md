---
aliases:
  - linuxKernel.packages.linux_xanmod_stable.ipu6-drivers
tags:
  - license/unknown
  - outputs/out
---
...
- **Name**: `linuxKernel.packages.linux_xanmod_stable.ipu6-drivers`
- **Version**: `2025-02-19`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/8grz2kbsxb70dplglqa1a5s5ni7nypgw-ipu6-drivers-unstable-2025-02-19.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/ipu6-drivers/default.nix:52`
- **Outputs**:
  - `out`:  `/nix/store/8grz2kbsxb70dplglqa1a5s5ni7nypgw-ipu6-drivers-unstable-2025-02-19`
