...
- **Name**: `rPackages.inspectdf`
- **Version**: `0.0.12.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/inspectdf/](https://cran.r-project.org/web/packages/inspectdf/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/9p836ypdxbg6nhq81zrdy8qv3059j68x-r-inspectdf-0.0.12.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/9p836ypdxbg6nhq81zrdy8qv3059j68x-r-inspectdf-0.0.12.1`

## 🔗 Dependencies

- [[07av1fzzpkv5mcw7carzw88294n46rkm-inspectdf_0.0.12.1.tar.gz]]
