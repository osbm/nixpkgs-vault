...
- **Homepage**: [https://github.com/almandin/krbjack](https://github.com/almandin/krbjack)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/0w0cwqkin22y698mmx3mv7cd11c930b9-krbjack-1.2.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/kr/krbjack/package.nix:42`
- **Outputs**:
  - `dist`:  `/nix/store/0w0cwqkin22y698mmx3mv7cd11c930b9-krbjack-1.2.0`
  - `out`:  `/nix/store/0w0cwqkin22y698mmx3mv7cd11c930b9-krbjack-1.2.0`
...
- [[psa6c0cdza8d5x598szdcjhpi03wm6xk-source]]
