---
aliases:
  - home-assistant-component-tests.schedule
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.schedule`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/wgp2k3bifia2bqy172h3pczb24ni4n9v-homeassistant-test-schedule-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/wgp2k3bifia2bqy172h3pczb24ni4n9v-homeassistant-test-schedule-2025.9.4`
