...
- **Name**: `python312Packages.python-mistralclient`
- **Version**: `6.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: OpenStack Mistral Command-line Client
- **Homepage**: [https://opendev.org/openstack/python-mistralclient/](https://opendev.org/openstack/python-mistralclient/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/ifqcd7ggadr4b00yy69j8rkbh4aclx8q-python3.12-python-mistralclient-6.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/python-mistralclient/default.nix:85`
- **Outputs**:
  - `dist`:  `/nix/store/ifqcd7ggadr4b00yy69j8rkbh4aclx8q-python3.12-python-mistralclient-6.0.0`
  - `out`:  `/nix/store/ifqcd7ggadr4b00yy69j8rkbh4aclx8q-python3.12-python-mistralclient-6.0.0`
...
- [[r5hdjj97jrb7d18h9maqbx2y43y4j90r-source]]
