...
Bindings for TVM machine learning framework

## 📋 Package Information

- **Name**: `haskellPackages.htvm`
- **Version**: `0.1.2`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Bindings for TVM machine learning framework
- **Homepage**: [https://hackage.haskell.org/package/htvm](https://hackage.haskell.org/package/htvm)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/4qwz8kdmynigj4j1j5baxw9vv60b2fbx-htvm-0.1.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:363733`
- **Outputs**:
  - `doc`:  `/nix/store/4qwz8kdmynigj4j1j5baxw9vv60b2fbx-htvm-0.1.2`
  - `out`:  `/nix/store/4qwz8kdmynigj4j1j5baxw9vv60b2fbx-htvm-0.1.2`
...
- [[lsr0jxv61b1dkd3yzr75irr2gxpm7zwf-htvm-0.1.2.tar.gz]]
