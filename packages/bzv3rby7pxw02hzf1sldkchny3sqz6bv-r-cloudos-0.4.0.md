...
- **Name**: `rPackages.cloudos`
- **Version**: `0.4.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/cloudos/](https://cran.r-project.org/web/packages/cloudos/)
- **License**: `unknown`
