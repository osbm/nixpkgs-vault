...
- **Name**: `python313Packages.pysnow`
- **Version**: `0.7.16`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: ServiceNow HTTP client library written in Python
- **Homepage**: [https://github.com/rbw/pysnow](https://github.com/rbw/pysnow)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/vijz5binscr8i4fya2948c0bagzw5vq8-python3.13-pysnow-0.7.16.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/pysnow/default.nix:70`
- **Outputs**:
  - `dist`:  `/nix/store/vijz5binscr8i4fya2948c0bagzw5vq8-python3.13-pysnow-0.7.16`
  - `out`:  `/nix/store/vijz5binscr8i4fya2948c0bagzw5vq8-python3.13-pysnow-0.7.16`
...
- [[5x78iw0wzjqp5jwav4dy7jdxh8dr9d82-switch-to-poetry-core.patch]]
...
- [[r0v29cqb7rv330xdsh5zgj3q8yh143cf-source]]
