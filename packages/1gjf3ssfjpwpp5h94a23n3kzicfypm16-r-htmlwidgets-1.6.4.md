...
- **Name**: `rPackages.htmlwidgets`
- **Version**: `1.6.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/htmlwidgets/](https://cran.r-project.org/web/packages/htmlwidgets/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/1gjf3ssfjpwpp5h94a23n3kzicfypm16-r-htmlwidgets-1.6.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/1gjf3ssfjpwpp5h94a23n3kzicfypm16-r-htmlwidgets-1.6.4`
...
- [[d51acmrgzqzmk2839n6c8n70lf6fnzp2-htmlwidgets_1.6.4.tar.gz]]
