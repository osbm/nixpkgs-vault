---
aliases:
  - haskellPackages.cabal-install-parsers_0_6_3
tags:
  - license/unknown
  - outputs/doc
  - outputs/out
...
- **Name**: `haskellPackages.cabal-install-parsers_0_6_3`
- **Version**: `0.6.3`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Utilities to work with cabal-install files
- **Homepage**: [https://hackage.haskell.org/package/cabal-install-parsers](https://hackage.haskell.org/package/cabal-install-parsers)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/as3rwq4flf122xs8nzzay98rl78aljc5-cabal-install-parsers-0.6.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:124884`
- **Outputs**:
  - `doc`:  `/nix/store/as3rwq4flf122xs8nzzay98rl78aljc5-cabal-install-parsers-0.6.3`
  - `out`:  `/nix/store/as3rwq4flf122xs8nzzay98rl78aljc5-cabal-install-parsers-0.6.3`
...
- [[vvh2n46qssa0fpjcyfxl3410a801xfmr-cabal-install-parsers-0.6.3.tar.gz]]
