...
- **Name**: `python312Packages.softlayer`
- **Version**: `6.2.7`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Python libraries that assist in calling the SoftLayer API
- **Homepage**: [https://github.com/softlayer/softlayer-python](https://github.com/softlayer/softlayer-python)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/j6wd2xczrq8qqh9wkxkadxp764b1i0xs-python3.12-softlayer-6.2.7.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/softlayer/default.nix:78`
- **Outputs**:
  - `dist`:  `/nix/store/j6wd2xczrq8qqh9wkxkadxp764b1i0xs-python3.12-softlayer-6.2.7`
  - `out`:  `/nix/store/j6wd2xczrq8qqh9wkxkadxp764b1i0xs-python3.12-softlayer-6.2.7`
...
- [[l15i8z3dnq068qfn1isrkgggi04abi9v-source]]
