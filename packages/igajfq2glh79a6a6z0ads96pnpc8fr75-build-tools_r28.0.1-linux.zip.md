---
aliases:
  - androidenv.androidPkgs.all.packages.build-tools.v28_0_1
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.packages.build-tools.v28_0_1`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/igajfq2glh79a6a6z0ads96pnpc8fr75-build-tools_r28.0.1-linux.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/igajfq2glh79a6a6z0ads96pnpc8fr75-build-tools_r28.0.1-linux.zip`
