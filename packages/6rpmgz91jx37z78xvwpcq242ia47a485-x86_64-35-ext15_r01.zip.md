---
aliases:
  - androidenv.androidPkgs.all.system-images.v35x.android-wear.x86_64
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.system-images.v35x.android-wear.x86_64`
...
- **Derivation Path**: `/nix/store/6rpmgz91jx37z78xvwpcq242ia47a485-x86_64-35-ext15_r01.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/6rpmgz91jx37z78xvwpcq242ia47a485-x86_64-35-ext15_r01.zip`
