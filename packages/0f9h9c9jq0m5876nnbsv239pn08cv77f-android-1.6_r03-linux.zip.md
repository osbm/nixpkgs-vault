---
aliases:
  - androidenv.androidPkgs.all.packages.platforms.v4
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.packages.platforms.v4`
- **Version**: `1.6_r03-linux.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/0f9h9c9jq0m5876nnbsv239pn08cv77f-android-1.6_r03-linux.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/0f9h9c9jq0m5876nnbsv239pn08cv77f-android-1.6_r03-linux.zip`
