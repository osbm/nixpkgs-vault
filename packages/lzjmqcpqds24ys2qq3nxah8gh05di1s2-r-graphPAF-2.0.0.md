...
- **Name**: `rPackages.graphPAF`
- **Version**: `2.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/graphPAF/](https://cran.r-project.org/web/packages/graphPAF/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/lzjmqcpqds24ys2qq3nxah8gh05di1s2-r-graphPAF-2.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/lzjmqcpqds24ys2qq3nxah8gh05di1s2-r-graphPAF-2.0.0`
...
- [[j79izkz0za4gcilwxi9a0i40nxwwy4yk-graphPAF_2.0.0.tar.gz]]
