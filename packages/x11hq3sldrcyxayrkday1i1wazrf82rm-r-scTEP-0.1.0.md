...
- **Name**: `rPackages.scTEP`
- **Version**: `0.1.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://cran.r-project.org/web/packages/scTEP/](https://cran.r-project.org/web/packages/scTEP/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/x11hq3sldrcyxayrkday1i1wazrf82rm-r-scTEP-0.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/x11hq3sldrcyxayrkday1i1wazrf82rm-r-scTEP-0.1.0`

## 🔗 Dependencies

- [[2yzf0s6jp5hlymb8731hfm5pnlllrbgk-scTEP_0.1.0.tar.gz]]
...
- [[9rkiygs5cjq74qp13559ybar9qcsbr2i-r-scDHA-1.2.2]]
