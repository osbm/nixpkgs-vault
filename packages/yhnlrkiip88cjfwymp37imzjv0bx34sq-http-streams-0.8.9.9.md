...
- **Name**: `haskellPackages.http-streams`
- **Version**: `0.8.9.9`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: An HTTP client using io-streams
- **Homepage**: [https://hackage.haskell.org/package/http-streams](https://hackage.haskell.org/package/http-streams)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/yhnlrkiip88cjfwymp37imzjv0bx34sq-http-streams-0.8.9.9.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:362805`
- **Outputs**:
  - `doc`:  `/nix/store/yhnlrkiip88cjfwymp37imzjv0bx34sq-http-streams-0.8.9.9`
  - `out`:  `/nix/store/yhnlrkiip88cjfwymp37imzjv0bx34sq-http-streams-0.8.9.9`
...
- [[aldzzj0jk6jjsvdraz34qmhy7jg7jznx-http-streams-0.8.9.9.tar.gz]]
- [[bjsb6wdjykafnkixq156qdvmxhsm2bai-bash-5.3p3]]
- [[bl28f3glm9d5id38p78w6psq9n0qv7ca-case-insensitive-1.2.1.0]]
- [[c4w97zjyqms8gb1zcc2k1x49vh3z2znb-http-common-0.8.3.4]]
