...
- **Name**: `openraPackages_2019.mods.gen`
- **Version**: `1157.git.4f5e11d`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Re-imagination of the original Command & Conquer: Generals game
- **Homepage**: [https://github.com/MustaphaTR/Generals-Alpha](https://github.com/MustaphaTR/Generals-Alpha)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/07kv464bfg6awi83645yssaxvs8m6873-openra_2019-gen-1157.git.4f5e11d.drv`
- **Outputs**:
  - `out`:  `/nix/store/07kv464bfg6awi83645yssaxvs8m6873-openra_2019-gen-1157.git.4f5e11d`
...
- [[3a6mbgilyxgx740ihr6znlgylyfjskc0-source]]
...
- [[n6zcv8rk6fww9icnnhkg8x2ykshkbmkx-generals-alpha-engine]]
