---
aliases:
  - haskellPackages.yesod-recaptcha
tags:
  - broken
  - not-available
  - license/unknown
...
- **Name**: `haskellPackages.yesod-recaptcha`
- **Version**: `1.4`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Dead simple support for reCAPTCHA on Yesod applications
- **Homepage**: [https://hackage.haskell.org/package/yesod-recaptcha](https://hackage.haskell.org/package/yesod-recaptcha)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/wfwgqfyvnbnhdba48nmm426j2vgm4v3s-yesod-recaptcha-1.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:742145`
- **Outputs**:
  - `doc`:  `/nix/store/wfwgqfyvnbnhdba48nmm426j2vgm4v3s-yesod-recaptcha-1.4`
  - `out`:  `/nix/store/wfwgqfyvnbnhdba48nmm426j2vgm4v3s-yesod-recaptcha-1.4`
...
- [[y12215djqmnpga3p92s502y5vjvgjw3z-yesod-recaptcha-1.4.tar.gz]]
