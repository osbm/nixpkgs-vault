...
- **Name**: `rPackages.bayeslist`
- **Version**: `0.0.1.5`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/bayeslist/](https://cran.r-project.org/web/packages/bayeslist/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/gj4fgxd27zx9x77vi7pd0lschck2yv10-r-bayeslist-0.0.1.5.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/gj4fgxd27zx9x77vi7pd0lschck2yv10-r-bayeslist-0.0.1.5`

## 🔗 Dependencies

- [[1m9h65ni1j33rgjcqp8qz57sacr1msk3-bayeslist_0.0.1.5.tar.gz]]
