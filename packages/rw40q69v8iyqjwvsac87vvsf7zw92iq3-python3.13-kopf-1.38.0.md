...
Python framework to write Kubernetes operators

## 📋 Package Information

- **Name**: `python313Packages.kopf`
- **Version**: `1.38.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Python framework to write Kubernetes operators
- **Homepage**: [https://kopf.readthedocs.io/](https://kopf.readthedocs.io/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/rw40q69v8iyqjwvsac87vvsf7zw92iq3-python3.13-kopf-1.38.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/kopf/default.nix:80`
- **Outputs**:
  - `dist`:  `/nix/store/rw40q69v8iyqjwvsac87vvsf7zw92iq3-python3.13-kopf-1.38.0`
  - `out`:  `/nix/store/rw40q69v8iyqjwvsac87vvsf7zw92iq3-python3.13-kopf-1.38.0`
...
- [[hlkp3939vbrka8l3sf4qzpxks39kc0k3-source]]
...
- [[xx4hmzlj37xydiwrrz48g34qazrnvnnn-python3.13-pyngrok-7.3.0]]
