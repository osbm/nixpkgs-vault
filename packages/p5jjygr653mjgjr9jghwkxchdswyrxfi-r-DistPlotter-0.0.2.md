...
- **Name**: `rPackages.DistPlotter`
- **Version**: `0.0.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/DistPlotter/](https://cran.r-project.org/web/packages/DistPlotter/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/p5jjygr653mjgjr9jghwkxchdswyrxfi-r-DistPlotter-0.0.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/p5jjygr653mjgjr9jghwkxchdswyrxfi-r-DistPlotter-0.0.2`
...
- [[y4c6wyywy3cj1afc7bn8qmkmdnk1gmiq-DistPlotter_0.0.2.tar.gz]]
