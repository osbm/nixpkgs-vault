...
- **Derivation Path**: `/nix/store/gjqn33ls87a6wxnqpmaahzk0xjjq547c-openssh-with-hpn-10.0p2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/tools/networking/openssh/common.nix:250`
- **Outputs**:
  - `out`:  `/nix/store/gjqn33ls87a6wxnqpmaahzk0xjjq547c-openssh-with-hpn-10.0p2`
