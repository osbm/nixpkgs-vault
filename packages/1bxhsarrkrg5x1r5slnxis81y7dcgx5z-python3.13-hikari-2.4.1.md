...
Discord API wrapper for Python written with asyncio

## 📋 Package Information

- **Name**: `python313Packages.hikari`
- **Version**: `2.4.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Discord API wrapper for Python written with asyncio
- **Homepage**: [https://www.hikari-py.dev/](https://www.hikari-py.dev/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/1bxhsarrkrg5x1r5slnxis81y7dcgx5z-python3.13-hikari-2.4.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/hikari/default.nix:76`
- **Outputs**:
  - `dist`:  `/nix/store/1bxhsarrkrg5x1r5slnxis81y7dcgx5z-python3.13-hikari-2.4.1`
  - `out`:  `/nix/store/1bxhsarrkrg5x1r5slnxis81y7dcgx5z-python3.13-hikari-2.4.1`
...
- [[sdbrwbw53wid9si0byqlvf3ivzvlhf7f-source]]
