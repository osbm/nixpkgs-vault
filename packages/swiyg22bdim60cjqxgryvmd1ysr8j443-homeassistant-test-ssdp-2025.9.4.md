---
aliases:
  - home-assistant-component-tests.ssdp
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.ssdp`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/swiyg22bdim60cjqxgryvmd1ysr8j443-homeassistant-test-ssdp-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/swiyg22bdim60cjqxgryvmd1ysr8j443-homeassistant-test-ssdp-2025.9.4`
