---
aliases:
  - home-assistant-component-tests.button
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.button`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/vymp5rabi3a89hmp79yjlw4n9s3mipqa-homeassistant-test-button-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/vymp5rabi3a89hmp79yjlw4n9s3mipqa-homeassistant-test-button-2025.9.4`
