---
aliases:
  - emacsPackages.pip-requirements
tags:
  - license/unknown
  - outputs/out
---
...
- **Name**: `emacsPackages.pip-requirements`
- **Version**: `20240621.2151`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://github.com/Wilfred/pip-requirements.el](https://github.com/Wilfred/pip-requirements.el)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/x834gcycqax1kdmf8zgjnqvrx0yjh33w-emacs-pip-requirements-20240621.2151.drv`
...
- **Outputs**:
  - `out`:  `/nix/store/x834gcycqax1kdmf8zgjnqvrx0yjh33w-emacs-pip-requirements-20240621.2151`
...
- [[hispfa3diifpd3z534adb33l1qw210rj-pip-requirements-recipe]]
- [[ma2yzrxwzkm04zcz4zkdqvk2f0hbb84l-source]]
