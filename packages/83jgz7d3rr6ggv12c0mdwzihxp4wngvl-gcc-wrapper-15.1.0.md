...
- **Name**: `gccNGPackages_15.gccWithLibc`
- **Version**: `15.1.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/83jgz7d3rr6ggv12c0mdwzihxp4wngvl-gcc-wrapper-15.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/build-support/cc-wrapper/default.nix:989`
- **Outputs**:
  - `info`:  `/nix/store/83jgz7d3rr6ggv12c0mdwzihxp4wngvl-gcc-wrapper-15.1.0`
  - `man`:  `/nix/store/83jgz7d3rr6ggv12c0mdwzihxp4wngvl-gcc-wrapper-15.1.0`
  - `out`:  `/nix/store/83jgz7d3rr6ggv12c0mdwzihxp4wngvl-gcc-wrapper-15.1.0`
