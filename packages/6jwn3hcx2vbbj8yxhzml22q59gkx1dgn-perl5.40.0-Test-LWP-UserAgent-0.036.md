---
aliases:
  - perl540Packages.TestLWPUserAgent
tags:
  - license/unknown
  - outputs/devdoc
  - outputs/out
...
- **Name**: `perl540Packages.TestLWPUserAgent`
- **Version**: `0.036`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: LWP::UserAgent suitable for simulating and testing network calls
- **Homepage**: [https://github.com/karenetheridge/Test-LWP-UserAgent](https://github.com/karenetheridge/Test-LWP-UserAgent)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/6jwn3hcx2vbbj8yxhzml22q59gkx1dgn-perl5.40.0-Test-LWP-UserAgent-0.036.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/top-level/perl-packages.nix:34218`
- **Outputs**:
  - `devdoc`:  `/nix/store/6jwn3hcx2vbbj8yxhzml22q59gkx1dgn-perl5.40.0-Test-LWP-UserAgent-0.036`
  - `out`:  `/nix/store/6jwn3hcx2vbbj8yxhzml22q59gkx1dgn-perl5.40.0-Test-LWP-UserAgent-0.036`

## 🔗 Dependencies

- [[0mncbbjyrh91sz24xfgkjgmxfcg5xcdl-perl5.40.0-Plack-1.0050]]
- [[19h9aidban2f7d930fsf9jiwiwf90s0s-perl5.40.0-libwww-perl-6.72]]
- [[25agd3jav8525s8lm8qafc6wasyhwzmy-Test-LWP-UserAgent-0.036.tar.gz]]
