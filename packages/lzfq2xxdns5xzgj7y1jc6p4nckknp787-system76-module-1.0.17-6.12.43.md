...
- **Name**: `linuxKernel.packages.linux_hardened.system76`
- **Version**: `1.0.17-6.12.43`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/lzfq2xxdns5xzgj7y1jc6p4nckknp787-system76-module-1.0.17-6.12.43.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/os-specific/linux/system76/default.nix:47`
- **Outputs**:
  - `out`:  `/nix/store/lzfq2xxdns5xzgj7y1jc6p4nckknp787-system76-module-1.0.17-6.12.43`
