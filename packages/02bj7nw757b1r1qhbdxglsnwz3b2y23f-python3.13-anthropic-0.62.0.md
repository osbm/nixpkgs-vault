...
- **Name**: `python313Packages.anthropic`
- **Version**: `0.62.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Anthropic's safety-first language model APIs
- **Homepage**: [https://github.com/anthropics/anthropic-sdk-python](https://github.com/anthropics/anthropic-sdk-python)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/02bj7nw757b1r1qhbdxglsnwz3b2y23f-python3.13-anthropic-0.62.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/anthropic/default.nix:102`
- **Outputs**:
  - `dist`:  `/nix/store/02bj7nw757b1r1qhbdxglsnwz3b2y23f-python3.13-anthropic-0.62.0`
  - `out`:  `/nix/store/02bj7nw757b1r1qhbdxglsnwz3b2y23f-python3.13-anthropic-0.62.0`
...
- [[k31y4nsdk5rl9xzvw4xnr4ksli77c39s-source]]
