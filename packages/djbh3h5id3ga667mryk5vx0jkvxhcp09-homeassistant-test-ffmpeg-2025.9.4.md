---
aliases:
  - home-assistant-component-tests.ffmpeg
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.ffmpeg`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/djbh3h5id3ga667mryk5vx0jkvxhcp09-homeassistant-test-ffmpeg-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/djbh3h5id3ga667mryk5vx0jkvxhcp09-homeassistant-test-ffmpeg-2025.9.4`
