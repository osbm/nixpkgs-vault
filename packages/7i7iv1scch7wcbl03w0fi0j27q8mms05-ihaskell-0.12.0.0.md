---
aliases:
  - haskellPackages.ihaskell_0_12_0_0
tags:
  - license/unknown
  - outputs/data
  - outputs/doc
...
- **Name**: `haskellPackages.ihaskell_0_12_0_0`
- **Version**: `0.12.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: A Haskell backend kernel for the Jupyter project
- **Homepage**: [https://hackage.haskell.org/package/ihaskell](https://hackage.haskell.org/package/ihaskell)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/7i7iv1scch7wcbl03w0fi0j27q8mms05-ihaskell-0.12.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:374023`
- **Outputs**:
  - `data`:  `/nix/store/7i7iv1scch7wcbl03w0fi0j27q8mms05-ihaskell-0.12.0.0`
  - `doc`:  `/nix/store/7i7iv1scch7wcbl03w0fi0j27q8mms05-ihaskell-0.12.0.0`
  - `out`:  `/nix/store/7i7iv1scch7wcbl03w0fi0j27q8mms05-ihaskell-0.12.0.0`
...
- [[8v02ra29l7wq6rm5asqm9qd1dfjgmdrk-ihaskell-0.12.0.0.tar.gz]]
...
- [[ki45lrhbwsgxp7xg375hdrvri47lac39-ipython-kernel-0.11.0.0]]
...
- [[x82h1vjfl8pqgl3pv8bdvf2kkyd1nhdp-ghc-parser-0.2.7.0]]
- [[y0qj3r7q83fp8dw3gn27m2by8pg8zw6i-base64-bytestring-1.2.1.0]]
- [[z565zgagc09pd7lnwd8ayxdqs9xh9sr2-ghc-syntax-highlighter-0.0.11.0]]
