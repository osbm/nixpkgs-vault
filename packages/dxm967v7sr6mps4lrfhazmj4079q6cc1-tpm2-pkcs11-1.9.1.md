...
PKCS#11 interface for TPM2 hardware Enables fapi by default, as if TPM2_PKCS11_BACKEND defaulted to 'fapi'.

## 📋 Package Information

- **Name**: `tpm2-pkcs11-fapi`
- **Version**: `1.9.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: PKCS#11 interface for TPM2 hardware Enables fapi by default, as if TPM2_PKCS11_BACKEND defaulted to 'fapi'.
...
- **Derivation Path**: `/nix/store/dxm967v7sr6mps4lrfhazmj4079q6cc1-tpm2-pkcs11-1.9.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/tp/tpm2-pkcs11/package.nix:248`
- **Outputs**:
  - `bin`:  `/nix/store/dxm967v7sr6mps4lrfhazmj4079q6cc1-tpm2-pkcs11-1.9.1`
  - `dev`:  `/nix/store/dxm967v7sr6mps4lrfhazmj4079q6cc1-tpm2-pkcs11-1.9.1`
  - `out`:  `/nix/store/dxm967v7sr6mps4lrfhazmj4079q6cc1-tpm2-pkcs11-1.9.1`
...
- `/nix/store/lssgsqqdh5gr5b20dbkdjipbpnvxfa6q-default-to-fapi.patch`
