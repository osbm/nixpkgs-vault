---
aliases:
  - haskellPackages.servant-aeson-specs
tags:
  - broken
  - not-available
  - license/unknown
...
- **Name**: `haskellPackages.servant-aeson-specs`
- **Version**: `0.6.2.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: generic tests for aeson serialization in servant
- **Homepage**: [https://hackage.haskell.org/package/servant-aeson-specs](https://hackage.haskell.org/package/servant-aeson-specs)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/nmwgsivsz7nqm95bhs1d7p44inncw8li-servant-aeson-specs-0.6.2.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:596037`
- **Outputs**:
  - `doc`:  `/nix/store/nmwgsivsz7nqm95bhs1d7p44inncw8li-servant-aeson-specs-0.6.2.0`
  - `out`:  `/nix/store/nmwgsivsz7nqm95bhs1d7p44inncw8li-servant-aeson-specs-0.6.2.0`
...
- [[91r11hry1wx8mqgpg2kzaqnyv2ccn97f-servant-aeson-specs-0.6.2.0.tar.gz]]
