...
- **Name**: `rPackages.gdalcubes`
- **Version**: `0.7.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/gdalcubes/](https://cran.r-project.org/web/packages/gdalcubes/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/w2xl2i48mncj2rmrhi7ik91lnclxv8q9-r-gdalcubes-0.7.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/w2xl2i48mncj2rmrhi7ik91lnclxv8q9-r-gdalcubes-0.7.1`

## 🔗 Dependencies

- [[1fnz36aqjsig20bs8fc0qwa01ayrzx9w-r-ncdf4-1.24]]
- [[201maaarndz6m6vsgyr4vxvpc220c5ni-gdalcubes_0.7.1.tar.gz]]
