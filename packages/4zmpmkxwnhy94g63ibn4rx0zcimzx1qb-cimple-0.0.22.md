...
- **Name**: `haskellPackages.cimple`
- **Version**: `0.0.22`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Simple C-like programming language
- **Homepage**: [https://hackage.haskell.org/package/cimple](https://hackage.haskell.org/package/cimple)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/4zmpmkxwnhy94g63ibn4rx0zcimzx1qb-cimple-0.0.22.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:139545`
- **Outputs**:
  - `doc`:  `/nix/store/4zmpmkxwnhy94g63ibn4rx0zcimzx1qb-cimple-0.0.22`
  - `out`:  `/nix/store/4zmpmkxwnhy94g63ibn4rx0zcimzx1qb-cimple-0.0.22`
...
- [[hsr82x17qvjw01hqg3ybgb2d2gckyvam-cimple-0.0.22.tar.gz]]
