...
Domain Name Service library, with high-level utilities for address, mx and text record lookups

## 📋 Package Information

- **Name**: `akkuPackages.chibi-net-dns`
- **Version**: `0.2.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/wvcpbz8aiw5h0q75zxgc3ddfh6wwi31k-akku-chibi-net-dns-0.2.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/tools/package-management/akku/default.nix:39`
- **Outputs**:
  - `out`:  `/nix/store/wvcpbz8aiw5h0q75zxgc3ddfh6wwi31k-akku-chibi-net-dns-0.2.0`
...
- [[lawaa7jrf0bsmqvjmn8f28dk0psy2s7m-chibi-net-dns-0.2.tgz]]
