...
- **Name**: `kdePackages.kshisen`
- **Version**: `25.08.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Shisen-Sho is a solitaire-like game played using the standard set of Mahjong tiles
- **Homepage**: [https://invent.kde.org/games/kshisen](https://invent.kde.org/games/kshisen)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/2bsgfhqlbrr8pmcaylswxpcmamr59clm-kshisen-25.08.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/kde/gear/kshisen/default.nix:3`
- **Outputs**:
  - `debug`:  `/nix/store/2bsgfhqlbrr8pmcaylswxpcmamr59clm-kshisen-25.08.1`
  - `dev`:  `/nix/store/2bsgfhqlbrr8pmcaylswxpcmamr59clm-kshisen-25.08.1`
  - `devtools`:  `/nix/store/2bsgfhqlbrr8pmcaylswxpcmamr59clm-kshisen-25.08.1`
  - `out`:  `/nix/store/2bsgfhqlbrr8pmcaylswxpcmamr59clm-kshisen-25.08.1`
...
- [[q4raq7hyynw36735aw160j64dq5w2r2m-kshisen-25.08.1.tar.xz]]
