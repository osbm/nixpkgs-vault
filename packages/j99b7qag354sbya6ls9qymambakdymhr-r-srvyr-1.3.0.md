...
- **Name**: `rPackages.srvyr`
- **Version**: `1.3.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/srvyr/](https://cran.r-project.org/web/packages/srvyr/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/j99b7qag354sbya6ls9qymambakdymhr-r-srvyr-1.3.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/j99b7qag354sbya6ls9qymambakdymhr-r-srvyr-1.3.0`
...
- [[hijwg3d9f4q1krpdhyhrmp65didpk4gc-srvyr_1.3.0.tar.gz]]
