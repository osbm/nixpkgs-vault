---
aliases:
  - androidenv.androidPkgs.all.system-images.CANARY.google_apis_playstore.x86_64
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.system-images.CANARY.google_apis_playstore.x86_64`
...
- **Derivation Path**: `/nix/store/qyas3x01lpydpiagdjqffqglq9k82jy5-x86_64-36.0-CANARY_r02.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/qyas3x01lpydpiagdjqffqglq9k82jy5-x86_64-36.0-CANARY_r02.zip`
