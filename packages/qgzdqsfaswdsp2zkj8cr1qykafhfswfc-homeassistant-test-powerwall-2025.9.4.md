---
aliases:
  - home-assistant-component-tests.powerwall
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.powerwall`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/qgzdqsfaswdsp2zkj8cr1qykafhfswfc-homeassistant-test-powerwall-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/qgzdqsfaswdsp2zkj8cr1qykafhfswfc-homeassistant-test-powerwall-2025.9.4`
...
- [[pgxwclw6w29i3nldvwadr5sy50vqdbcb-python3.13-tesla-powerwall-0.5.2]]
