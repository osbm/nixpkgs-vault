...
- **Name**: `rPackages.mpathsenser`
- **Version**: `1.2.3`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/mpathsenser/](https://cran.r-project.org/web/packages/mpathsenser/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/6viad7z81kmdhq2pvmxmy82llb3kyw79-r-mpathsenser-1.2.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/6viad7z81kmdhq2pvmxmy82llb3kyw79-r-mpathsenser-1.2.3`
...
- [[sf6v0px3rbxvidxc6dprbk6fgmbczmn3-mpathsenser_1.2.3.tar.gz]]
