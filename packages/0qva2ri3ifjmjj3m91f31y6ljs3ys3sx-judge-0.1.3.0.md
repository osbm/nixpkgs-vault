...
- **Name**: `haskellPackages.judge`
- **Version**: `0.1.3.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Tableau-based theorem prover for justification logic
- **Homepage**: [https://hackage.haskell.org/package/judge](https://hackage.haskell.org/package/judge)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/0qva2ri3ifjmjj3m91f31y6ljs3ys3sx-judge-0.1.3.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:395328`
- **Outputs**:
  - `data`:  `/nix/store/0qva2ri3ifjmjj3m91f31y6ljs3ys3sx-judge-0.1.3.0`
  - `doc`:  `/nix/store/0qva2ri3ifjmjj3m91f31y6ljs3ys3sx-judge-0.1.3.0`
  - `out`:  `/nix/store/0qva2ri3ifjmjj3m91f31y6ljs3ys3sx-judge-0.1.3.0`
...
- [[pa8m8h4k8c6400l0fn23m1rph1pp0cza-judge-0.1.3.0.tar.gz]]
