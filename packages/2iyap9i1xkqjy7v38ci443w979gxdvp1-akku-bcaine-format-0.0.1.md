...
- **Name**: `akkuPackages.bcaine-format`
- **Version**: `0.0.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: A `format`, `printf` and `sprintf` somewhat in the style of Chicken Scheme
- **Homepage**: []()
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/2iyap9i1xkqjy7v38ci443w979gxdvp1-akku-bcaine-format-0.0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/tools/package-management/akku/default.nix:39`
- **Outputs**:
  - `out`:  `/nix/store/2iyap9i1xkqjy7v38ci443w979gxdvp1-akku-bcaine-format-0.0.1`
...
- [[vm2ajdpvk08wfxw2q0v7q4ls89ipfv1n-bcaine-format-0.0.1.tgz]]
