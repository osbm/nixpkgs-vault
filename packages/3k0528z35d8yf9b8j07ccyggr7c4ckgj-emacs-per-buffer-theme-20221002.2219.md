...
- **Name**: `emacsPackages.per-buffer-theme`
- **Version**: `20221002.2219`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://melpa.org/#/per-buffer-theme](https://melpa.org/#/per-buffer-theme)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/3k0528z35d8yf9b8j07ccyggr7c4ckgj-emacs-per-buffer-theme-20221002.2219.drv`
...
- **Outputs**:
  - `out`:  `/nix/store/3k0528z35d8yf9b8j07ccyggr7c4ckgj-emacs-per-buffer-theme-20221002.2219`
...
- [[fc8zy8msshz38w3vz54g4dc38nbgf48x-per-buffer-theme-recipe]]
- [[fscz12m3939bskimfinbi6h3ijd3kya9-package-build]]
- [[p76r0cwlf6k97ibprrpfd8xw0r8wc3nx-stdenv-linux]]
- [[srli81yzhan7160c3m1fvsvj7prv0g3i-hg-archive]]
