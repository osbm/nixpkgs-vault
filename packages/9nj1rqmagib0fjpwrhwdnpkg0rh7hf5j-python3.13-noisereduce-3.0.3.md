...
- **Name**: `python313Packages.noisereduce`
- **Version**: `3.0.3`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Noise reduction using spectral gating (speech, bioacoustics, audio, time-domain signals
- **Homepage**: [https://github.com/timsainb/noisereduce](https://github.com/timsainb/noisereduce)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/9nj1rqmagib0fjpwrhwdnpkg0rh7hf5j-python3.13-noisereduce-3.0.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/noisereduce/default.nix:46`
- **Outputs**:
  - `dist`:  `/nix/store/9nj1rqmagib0fjpwrhwdnpkg0rh7hf5j-python3.13-noisereduce-3.0.3`
  - `out`:  `/nix/store/9nj1rqmagib0fjpwrhwdnpkg0rh7hf5j-python3.13-noisereduce-3.0.3`
...
- [[mljbn2icw4ah6pwld3s0csrc6dh6yanx-source]]
