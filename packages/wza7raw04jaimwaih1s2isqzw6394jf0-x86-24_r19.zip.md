---
aliases:
  - androidenv.androidPkgs.all.system-images.v24.google_apis_playstore.x86
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.system-images.v24.google_apis_playstore.x86`
- **Version**: `24_r19.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/wza7raw04jaimwaih1s2isqzw6394jf0-x86-24_r19.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/wza7raw04jaimwaih1s2isqzw6394jf0-x86-24_r19.zip`
