...
- **Name**: `godot3-mono-headless`
- **Version**: `3.6`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Free and Open Source 2D and 3D game engine (mono headless)
...
- **Derivation Path**: `/nix/store/wxvz8x0b2b8xnfkzmfw39iyidsgysm72-godot3-mono-headless-3.6.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/tools/godot/3/default.nix:178`
- **Outputs**:
  - `dev`:  `/nix/store/wxvz8x0b2b8xnfkzmfw39iyidsgysm72-godot3-mono-headless-3.6`
  - `man`:  `/nix/store/wxvz8x0b2b8xnfkzmfw39iyidsgysm72-godot3-mono-headless-3.6`
  - `out`:  `/nix/store/wxvz8x0b2b8xnfkzmfw39iyidsgysm72-godot3-mono-headless-3.6`
