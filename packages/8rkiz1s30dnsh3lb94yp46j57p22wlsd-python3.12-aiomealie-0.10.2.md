...
- **Name**: `python312Packages.aiomealie`
- **Version**: `0.10.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Module to interact with Mealie
- **Homepage**: [https://github.com/joostlek/python-mealie](https://github.com/joostlek/python-mealie)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/8rkiz1s30dnsh3lb94yp46j57p22wlsd-python3.12-aiomealie-0.10.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/aiomealie/default.nix:54`
- **Outputs**:
  - `dist`:  `/nix/store/8rkiz1s30dnsh3lb94yp46j57p22wlsd-python3.12-aiomealie-0.10.2`
  - `out`:  `/nix/store/8rkiz1s30dnsh3lb94yp46j57p22wlsd-python3.12-aiomealie-0.10.2`

## 🔗 Dependencies

- [[113b6hxwnpbyv852cf0zwd6a6z2w8m68-python3.12-aiohttp-3.12.15]]
- [[5vsffdi0kgla24ca4l9bv0fxzc7s2qyk-pypa-build-hook.sh]]
- [[6xjhxpk71c0cvj8vj85p6pjgdhjc8wg8-source]]
