...
- **Name**: `rPackages.miscset`
- **Version**: `1.1.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://cran.r-project.org/web/packages/miscset/](https://cran.r-project.org/web/packages/miscset/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/s2z1dny2i8207z1m2pfm2n6sk0s3sx2y-r-miscset-1.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/s2z1dny2i8207z1m2pfm2n6sk0s3sx2y-r-miscset-1.1.0`
...
- [[ch5x2z3mwdlcqf40wrrl3kfrfi0hgyjs-miscset_1.1.0.tar.gz]]
