...
- **Name**: `haskellPackages.glade`
- **Version**: `0.13.1`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Binding to the glade library
- **Homepage**: [https://hackage.haskell.org/package/glade](https://hackage.haskell.org/package/glade)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/68zgjm8ri5fnq6m41hffd3vjk301s43h-glade-0.13.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:272137`
- **Outputs**:
  - `data`:  `/nix/store/68zgjm8ri5fnq6m41hffd3vjk301s43h-glade-0.13.1`
  - `doc`:  `/nix/store/68zgjm8ri5fnq6m41hffd3vjk301s43h-glade-0.13.1`
  - `out`:  `/nix/store/68zgjm8ri5fnq6m41hffd3vjk301s43h-glade-0.13.1`
...
- [[5yjrpaf3w2qknz7zicas7ci5gqb75yw3-glade-0.13.1.tar.gz]]
