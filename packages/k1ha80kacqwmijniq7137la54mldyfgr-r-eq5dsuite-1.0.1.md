...
- **Name**: `rPackages.eq5dsuite`
- **Version**: `1.0.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/eq5dsuite/](https://cran.r-project.org/web/packages/eq5dsuite/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/k1ha80kacqwmijniq7137la54mldyfgr-r-eq5dsuite-1.0.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/k1ha80kacqwmijniq7137la54mldyfgr-r-eq5dsuite-1.0.1`

## 🔗 Dependencies

- [[1w7jmrmhvrb6k1r7l39fn2qcw6j9gxlp-eq5dsuite_1.0.1.tar.gz]]
