...
- **Name**: `rPackages.rater`
- **Version**: `1.3.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/rater/](https://cran.r-project.org/web/packages/rater/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/zpbbm84ycly9m7qjsr0lxaybyz6zvry2-r-rater-1.3.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/zpbbm84ycly9m7qjsr0lxaybyz6zvry2-r-rater-1.3.2`
...
- [[wlxv0fsh44rldzwbvdmpa32s32vkqcmm-rater_1.3.2.tar.gz]]
