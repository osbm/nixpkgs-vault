---
aliases:
  - androidenv.androidPkgs.all.system-images.v15.default.x86
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.system-images.v15.default.x86`
- **Version**: `15_r07.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/irb0gnbjw01lr9z8a8g3aqlbag0x6vs8-x86-15_r07.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/irb0gnbjw01lr9z8a8g3aqlbag0x6vs8-x86-15_r07.zip`
