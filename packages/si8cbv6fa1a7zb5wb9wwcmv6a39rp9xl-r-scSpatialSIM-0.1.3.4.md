...
- **Name**: `rPackages.scSpatialSIM`
- **Version**: `0.1.3.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/scSpatialSIM/](https://cran.r-project.org/web/packages/scSpatialSIM/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/si8cbv6fa1a7zb5wb9wwcmv6a39rp9xl-r-scSpatialSIM-0.1.3.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/si8cbv6fa1a7zb5wb9wwcmv6a39rp9xl-r-scSpatialSIM-0.1.3.4`
...
- [[f8h0z5hb74h69cdsdqrn9i3d9069aa81-scSpatialSIM_0.1.3.4.tar.gz]]
