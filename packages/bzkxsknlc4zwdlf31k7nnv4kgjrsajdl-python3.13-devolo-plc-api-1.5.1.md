---
aliases:
  - python313Packages.devolo-plc-api
tags:
  - license/unknown
  - maintainers/fabaff
  - outputs/dist
...
- **Name**: `python313Packages.devolo-plc-api`
- **Version**: `1.5.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Module to interact with Devolo PLC devices
- **Homepage**: [https://github.com/2Fake/devolo_plc_api](https://github.com/2Fake/devolo_plc_api)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/bzkxsknlc4zwdlf31k7nnv4kgjrsajdl-python3.13-devolo-plc-api-1.5.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/devolo-plc-api/default.nix:66`
- **Outputs**:
  - `dist`:  `/nix/store/bzkxsknlc4zwdlf31k7nnv4kgjrsajdl-python3.13-devolo-plc-api-1.5.1`
  - `out`:  `/nix/store/bzkxsknlc4zwdlf31k7nnv4kgjrsajdl-python3.13-devolo-plc-api-1.5.1`
...
- [[malzhv67lrvn1xcrfwia045bqkra0d25-source]]
