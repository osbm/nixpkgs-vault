...
- **Name**: `haskellPackages.simple-pango`
- **Version**: `0.1.0.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Binding to Pango library
- **Homepage**: [https://hackage.haskell.org/package/simple-pango](https://hackage.haskell.org/package/simple-pango)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/w5ydyc2sfwf4bjb7lgnr7vysjbmk1kwx-simple-pango-0.1.0.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:612077`
- **Outputs**:
  - `doc`:  `/nix/store/w5ydyc2sfwf4bjb7lgnr7vysjbmk1kwx-simple-pango-0.1.0.2`
  - `out`:  `/nix/store/w5ydyc2sfwf4bjb7lgnr7vysjbmk1kwx-simple-pango-0.1.0.2`
...
- [[bgngx8ybsaiw30ykajq49i9vxxn0c0va-simple-pango-0.1.0.2.tar.gz]]
...
- [[mxivv7v2h88ysj59rn17yfbir6dhb8xx-glib-stopgap-0.1.0.1]]
