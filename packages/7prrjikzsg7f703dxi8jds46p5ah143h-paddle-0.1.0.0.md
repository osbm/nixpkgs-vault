...
- **Name**: `haskellPackages.paddle`
- **Version**: `0.1.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: API to the Paddle payment processor
- **Homepage**: [https://hackage.haskell.org/package/paddle](https://hackage.haskell.org/package/paddle)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/7prrjikzsg7f703dxi8jds46p5ah143h-paddle-0.1.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:498968`
- **Outputs**:
  - `doc`:  `/nix/store/7prrjikzsg7f703dxi8jds46p5ah143h-paddle-0.1.0.0`
  - `out`:  `/nix/store/7prrjikzsg7f703dxi8jds46p5ah143h-paddle-0.1.0.0`
...
- [[jzwjz77aykn1agajcfh2ak29a0h4mf2z-paddle-0.1.0.0.tar.gz]]
