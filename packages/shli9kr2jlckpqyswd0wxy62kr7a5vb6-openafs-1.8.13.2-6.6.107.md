---
aliases:
  - linuxKernel.packages.linux_6_6.openafs
tags:
  - license/unknown
  - maintainers/andersk
  - maintainers/maggesi
...
- **Name**: `linuxKernel.packages.linux_6_6.openafs`
- **Version**: `1.8.13.2-6.6.107`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/shli9kr2jlckpqyswd0wxy62kr7a5vb6-openafs-1.8.13.2-6.6.107.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/openafs/1.8/module.nix:158`
- **Outputs**:
  - `out`:  `/nix/store/shli9kr2jlckpqyswd0wxy62kr7a5vb6-openafs-1.8.13.2-6.6.107`
