...
- **Derivation Path**: `/nix/store/pfjyciiaqv9vvkpacj3mwpyzzhpapd8j-zabbix-proxy-7.4.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/monitoring/zabbix/proxy.nix:120`
- **Outputs**:
  - `out`:  `/nix/store/pfjyciiaqv9vvkpacj3mwpyzzhpapd8j-zabbix-proxy-7.4.0`
