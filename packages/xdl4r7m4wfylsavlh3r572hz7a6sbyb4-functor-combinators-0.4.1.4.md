---
aliases:
  - haskellPackages.functor-combinators
tags:
  - license/unknown
  - outputs/doc
  - outputs/out
...
- **Name**: `haskellPackages.functor-combinators`
- **Version**: `0.4.1.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Tools for functor combinator-based program design
- **Homepage**: [https://hackage.haskell.org/package/functor-combinators](https://hackage.haskell.org/package/functor-combinators)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/xdl4r7m4wfylsavlh3r572hz7a6sbyb4-functor-combinators-0.4.1.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:247682`
- **Outputs**:
  - `doc`:  `/nix/store/xdl4r7m4wfylsavlh3r572hz7a6sbyb4-functor-combinators-0.4.1.4`
  - `out`:  `/nix/store/xdl4r7m4wfylsavlh3r572hz7a6sbyb4-functor-combinators-0.4.1.4`
...
---
*Generated on 2025-09-27 12:53:21 UTC*
