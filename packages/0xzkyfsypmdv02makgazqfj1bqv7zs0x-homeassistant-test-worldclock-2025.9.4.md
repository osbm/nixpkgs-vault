---
aliases:
  - home-assistant-component-tests.worldclock
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.worldclock`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/0xzkyfsypmdv02makgazqfj1bqv7zs0x-homeassistant-test-worldclock-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/0xzkyfsypmdv02makgazqfj1bqv7zs0x-homeassistant-test-worldclock-2025.9.4`
