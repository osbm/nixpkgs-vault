...
- **Name**: `rPackages.metacart`
- **Version**: `3.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/metacart/](https://cran.r-project.org/web/packages/metacart/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/4902gbld875azia0sflixgxq5jsik0n3-r-metacart-3.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/4902gbld875azia0sflixgxq5jsik0n3-r-metacart-3.0.0`
...
- [[fi8pp83bg1ylfh6sdfj5vizfchgpgg9p-metacart_3.0.0.tar.gz]]
