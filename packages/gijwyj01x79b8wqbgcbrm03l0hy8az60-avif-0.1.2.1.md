...
- **Name**: `haskellPackages.avif`
- **Version**: `0.1.2.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: High-level bindings to libavif
- **Homepage**: [https://hackage.haskell.org/package/avif](https://hackage.haskell.org/package/avif)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/gijwyj01x79b8wqbgcbrm03l0hy8az60-avif-0.1.2.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:91279`
- **Outputs**:
  - `data`:  `/nix/store/gijwyj01x79b8wqbgcbrm03l0hy8az60-avif-0.1.2.1`
  - `doc`:  `/nix/store/gijwyj01x79b8wqbgcbrm03l0hy8az60-avif-0.1.2.1`
  - `out`:  `/nix/store/gijwyj01x79b8wqbgcbrm03l0hy8az60-avif-0.1.2.1`
...
- [[805x7kx66fzgb72k9sd3lyfh88msxf27-avif-0.1.2.1.tar.gz]]
