...
- **Name**: `python312Packages.edward`
- **Version**: `1.3.5`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Probabilistic programming language using Tensorflow
- **Homepage**: [https://github.com/blei-lab/edward](https://github.com/blei-lab/edward)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/w9301496xbqvcmk0iws9gkxnzvplgsv7-python3.12-edward-1.3.5.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/edward/default.nix:38`
- **Outputs**:
  - `dist`:  `/nix/store/w9301496xbqvcmk0iws9gkxnzvplgsv7-python3.12-edward-1.3.5`
  - `out`:  `/nix/store/w9301496xbqvcmk0iws9gkxnzvplgsv7-python3.12-edward-1.3.5`

## 🔗 Dependencies

- [[4xz1gif80y8nv80fh9wg2an5dxixzwmb-edward-1.3.5.tar.gz]]
