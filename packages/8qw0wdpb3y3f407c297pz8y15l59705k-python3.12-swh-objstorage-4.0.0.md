---
aliases:
  - python312Packages.swh-objstorage
tags:
  - license/unknown
  - outputs/dist
  - outputs/out
...
- **Name**: `python312Packages.swh-objstorage`
- **Version**: `4.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/8qw0wdpb3y3f407c297pz8y15l59705k-python3.12-swh-objstorage-4.0.0.drv`
...
- **Outputs**:
  - `dist`:  `/nix/store/8qw0wdpb3y3f407c297pz8y15l59705k-python3.12-swh-objstorage-4.0.0`
  - `out`:  `/nix/store/8qw0wdpb3y3f407c297pz8y15l59705k-python3.12-swh-objstorage-4.0.0`
...
- [[966vbpjps87pwq2px3vkqcb3q1kbzpn8-python3.12-swh-perfecthash-1.3.2]]
