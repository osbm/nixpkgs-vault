...
- **Name**: `rPackages.wildviz`
- **Version**: `0.1.2`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://cran.r-project.org/web/packages/wildviz/](https://cran.r-project.org/web/packages/wildviz/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/4pjnybp61sgbvflbp63lszc714qk5p4h-r-wildviz-0.1.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/4pjnybp61sgbvflbp63lszc714qk5p4h-r-wildviz-0.1.2`

## 🔗 Dependencies

- [[1hlx13n3hi4vddwg6idpf6gi03zl16k0-r-rnoaa-1.4.0]]
...
- [[c3czjcl0z62s1vyy9jxbi0mvnh4jz8im-wildviz_0.1.2.tar.gz]]
