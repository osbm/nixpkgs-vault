...
- **Name**: `python312Packages.python-magnumclient`
- **Version**: `4.9.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/dpjsdhjrsh6x0945lir71sqpgpph5gjy-python3.12-python-magnumclient-4.9.0.drv`
...
- **Outputs**:
  - `dist`:  `/nix/store/dpjsdhjrsh6x0945lir71sqpgpph5gjy-python3.12-python-magnumclient-4.9.0`
  - `out`:  `/nix/store/dpjsdhjrsh6x0945lir71sqpgpph5gjy-python3.12-python-magnumclient-4.9.0`
