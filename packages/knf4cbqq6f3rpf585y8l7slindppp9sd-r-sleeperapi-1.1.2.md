...
- **Name**: `rPackages.sleeperapi`
- **Version**: `1.1.2`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://cran.r-project.org/web/packages/sleeperapi/](https://cran.r-project.org/web/packages/sleeperapi/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/knf4cbqq6f3rpf585y8l7slindppp9sd-r-sleeperapi-1.1.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/knf4cbqq6f3rpf585y8l7slindppp9sd-r-sleeperapi-1.1.2`
...
- [[czcvya52rxyrn8b22l94pkrir81bwhh3-sleeperapi_1.1.2.tar.gz]]
