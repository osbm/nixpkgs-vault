...
- **Name**: `rPackages.workflowsets`
- **Version**: `1.1.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/workflowsets/](https://cran.r-project.org/web/packages/workflowsets/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/4a04lf3zdhdp7f891rcnj183ip3ipibz-r-workflowsets-1.1.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/4a04lf3zdhdp7f891rcnj183ip3ipibz-r-workflowsets-1.1.1`

## 🔗 Dependencies

- [[1s1mx8hiqhw8laq9v61jm006nl7mfzv3-r-lifecycle-1.0.4]]
- [[2s1i119zw0wlbjml161rnx5y3fkwmapw-workflowsets_1.1.1.tar.gz]]
