...
- **Name**: `postgresql14Packages.timescaledb`
- **Version**: `2.22.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
...
- **Derivation Path**: `/nix/store/xvj3hbvxj5m9yagjlwbdidrcymsn2cps-timescaledb-2.22.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/sql/postgresql/ext/timescaledb.nix:98`
- **Outputs**:
  - `out`:  `/nix/store/xvj3hbvxj5m9yagjlwbdidrcymsn2cps-timescaledb-2.22.0`
