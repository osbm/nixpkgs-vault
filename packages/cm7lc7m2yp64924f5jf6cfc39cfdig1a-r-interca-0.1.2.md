...
- **Name**: `rPackages.interca`
- **Version**: `0.1.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/interca/](https://cran.r-project.org/web/packages/interca/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/cm7lc7m2yp64924f5jf6cfc39cfdig1a-r-interca-0.1.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/cm7lc7m2yp64924f5jf6cfc39cfdig1a-r-interca-0.1.2`
...
- [[h0rmbdxmgp5rj8azaf7zjhm1m358vplh-interca_0.1.2.tar.gz]]
