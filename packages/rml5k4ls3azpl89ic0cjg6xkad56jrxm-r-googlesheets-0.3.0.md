...
- **Name**: `rPackages.googlesheets`
- **Version**: `0.3.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://cran.r-project.org/web/packages/googlesheets/](https://cran.r-project.org/web/packages/googlesheets/)
- **License**: `unknown`
