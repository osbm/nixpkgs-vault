...
- **Name**: `rPackages.POWSC`
- **Version**: `1.16.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://bioconductor.org/packages/3.21/bioc/html/POWSC.html](https://bioconductor.org/packages/3.21/bioc/html/POWSC.html)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/n07cw30zj63zphg2p4c7b6whlpsm8hvi-r-POWSC-1.16.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/n07cw30zj63zphg2p4c7b6whlpsm8hvi-r-POWSC-1.16.0`

## 🔗 Dependencies

- [[1dqy3b09pyighwbsqik6id27vxgisjy7-POWSC_1.16.0.tar.gz]]
