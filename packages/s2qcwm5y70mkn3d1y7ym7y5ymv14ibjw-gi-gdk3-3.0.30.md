...
- **Name**: `haskellPackages.gi-gdk3`
- **Version**: `3.0.30`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Gdk 3.x bindings
- **Homepage**: [https://hackage.haskell.org/package/gi-gdk3](https://hackage.haskell.org/package/gi-gdk3)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/s2qcwm5y70mkn3d1y7ym7y5ymv14ibjw-gi-gdk3-3.0.30.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:264338`
- **Outputs**:
  - `doc`:  `/nix/store/s2qcwm5y70mkn3d1y7ym7y5ymv14ibjw-gi-gdk3-3.0.30`
  - `out`:  `/nix/store/s2qcwm5y70mkn3d1y7ym7y5ymv14ibjw-gi-gdk3-3.0.30`
...
- [[371q2nafqhllahlrvwnvp2aqvb46gvyr-gi-gdk3-3.0.30.tar.gz]]
