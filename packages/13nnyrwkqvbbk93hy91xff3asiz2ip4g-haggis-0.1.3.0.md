...
- **Name**: `haskellPackages.haggis`
- **Version**: `0.1.3.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: A static site generator with blogging/comments support
- **Homepage**: [https://hackage.haskell.org/package/haggis](https://hackage.haskell.org/package/haggis)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/13nnyrwkqvbbk93hy91xff3asiz2ip4g-haggis-0.1.3.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:292123`
- **Outputs**:
  - `doc`:  `/nix/store/13nnyrwkqvbbk93hy91xff3asiz2ip4g-haggis-0.1.3.0`
  - `out`:  `/nix/store/13nnyrwkqvbbk93hy91xff3asiz2ip4g-haggis-0.1.3.0`

## 🔗 Dependencies

- [[16s38bv5bwp5kkwcq521hjksd5vsdixw-split-0.2.5]]
- [[1avp0nnxymaxmvdpk2791h5v2s5slfhp-hquery-0.1.1.0]]
...
- [[kss4wpmd72m1qq731zhdzf0m49jrmd71-haggis-0.1.3.0.tar.gz]]
