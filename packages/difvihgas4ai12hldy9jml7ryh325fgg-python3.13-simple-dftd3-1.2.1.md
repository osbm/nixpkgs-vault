...
- **Name**: `python313Packages.simple-dftd3`
- **Version**: `1.2.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/difvihgas4ai12hldy9jml7ryh325fgg-python3.13-simple-dftd3-1.2.1.drv`
...
- **Outputs**:
  - `dist`:  `/nix/store/difvihgas4ai12hldy9jml7ryh325fgg-python3.13-simple-dftd3-1.2.1`
  - `out`:  `/nix/store/difvihgas4ai12hldy9jml7ryh325fgg-python3.13-simple-dftd3-1.2.1`
...
- [[8ch60idn27r42k1dypgkcr6xc42hf6z7-python3.13-qcengine-0.33.0]]
...
- [[y1rfqrma9qv98wabk8rsx7g233gm94vb-python3.13-pyscf-2.10.0]]
