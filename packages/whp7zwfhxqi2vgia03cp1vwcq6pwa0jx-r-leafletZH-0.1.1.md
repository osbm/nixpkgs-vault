...
- **Name**: `rPackages.leafletZH`
- **Version**: `0.1.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/leafletZH/](https://cran.r-project.org/web/packages/leafletZH/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/whp7zwfhxqi2vgia03cp1vwcq6pwa0jx-r-leafletZH-0.1.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/whp7zwfhxqi2vgia03cp1vwcq6pwa0jx-r-leafletZH-0.1.1`
...
- [[dybnzvkhxp20fvpx3n604sclq3iifw7a-leafletZH_0.1.1.tar.gz]]
