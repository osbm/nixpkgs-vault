...
Tool for generating realistic data using a declarative data model
...
- **Homepage**: [https://github.com/getsynth/synth](https://github.com/getsynth/synth)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/yqap79vq4fz9vj89saf3fgxn2pdb2gm4-synth-0.6.9.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/sy/synth/package.nix:29`
- **Outputs**:
  - `out`:  `/nix/store/yqap79vq4fz9vj89saf3fgxn2pdb2gm4-synth-0.6.9`
...
- [[8vq72kg86spihq9m06wgy99g37nr30xp-source]]
- [[bjsb6wdjykafnkixq156qdvmxhsm2bai-bash-5.3p3]]
- [[gvw7yfsnnn44bh8kv3rsihzk641fz175-synth-0.6.9-vendor]]
