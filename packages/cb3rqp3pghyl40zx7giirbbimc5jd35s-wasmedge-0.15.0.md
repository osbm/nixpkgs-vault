...
- **Homepage**: [https://wasmedge.org/](https://wasmedge.org/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/cb3rqp3pghyl40zx7giirbbimc5jd35s-wasmedge-0.15.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/tools/wasmedge/default.nix:69`
- **Outputs**:
  - `out`:  `/nix/store/cb3rqp3pghyl40zx7giirbbimc5jd35s-wasmedge-0.15.0`

## 🔗 Dependencies

- [[3h2pqwsp2izzlynp9gjar39hm70nnz89-libxml2-2.14.5]]
- [[6asyzqvzfzkv8kld678azxxppq3kgybp-source]]
