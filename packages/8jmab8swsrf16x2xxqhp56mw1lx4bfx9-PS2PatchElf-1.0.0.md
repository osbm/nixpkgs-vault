...
Very basic tool for converting PCSX2 .pnach cheats to game executable patches
...
- **Homepage**: [https://github.com/CaptainSwag101/PS2PatchElf/](https://github.com/CaptainSwag101/PS2PatchElf/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/8jmab8swsrf16x2xxqhp56mw1lx4bfx9-PS2PatchElf-1.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/ps/ps2patchelf/package.nix:35`
- **Outputs**:
  - `out`:  `/nix/store/8jmab8swsrf16x2xxqhp56mw1lx4bfx9-PS2PatchElf-1.0.0`
...
- [[pymi10xjl3qiyijp2zir4hq7n97c9ldi-source]]
...
- `/nix/store/251dknzqc9wz29a39ibwg6cb9as3m5k6-fix_arg_check.patch`
- `/nix/store/l622p70vy8k5sh7y5wizi5f2mic6ynpg-source-stdenv.sh`
- `/nix/store/sg0rdgzvk9y9md2i21bjrrn39xyzv0x0-target_net8.0.patch`
