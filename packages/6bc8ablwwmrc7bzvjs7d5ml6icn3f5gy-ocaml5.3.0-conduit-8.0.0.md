...
Network connection establishment library

## 📋 Package Information

- **Name**: `ocamlPackages.conduit`
- **Version**: `8.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/6bc8ablwwmrc7bzvjs7d5ml6icn3f5gy-ocaml5.3.0-conduit-8.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/ocaml-modules/conduit/default.nix:34`
- **Outputs**:
  - `out`:  `/nix/store/6bc8ablwwmrc7bzvjs7d5ml6icn3f5gy-ocaml5.3.0-conduit-8.0.0`
