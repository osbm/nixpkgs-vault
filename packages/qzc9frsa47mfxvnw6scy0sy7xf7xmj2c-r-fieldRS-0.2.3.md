...
- **Name**: `rPackages.fieldRS`
- **Version**: `0.2.3`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://cran.r-project.org/web/packages/fieldRS/](https://cran.r-project.org/web/packages/fieldRS/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/qzc9frsa47mfxvnw6scy0sy7xf7xmj2c-r-fieldRS-0.2.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/qzc9frsa47mfxvnw6scy0sy7xf7xmj2c-r-fieldRS-0.2.3`
...
- [[5v6swmw7h10gwh299i49hkc5354lvxfk-fieldRS_0.2.3.tar.gz]]
