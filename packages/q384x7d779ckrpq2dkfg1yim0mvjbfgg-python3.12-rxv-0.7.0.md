...
- **Name**: `python312Packages.rxv`
- **Version**: `0.7.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Python library for communicate with Yamaha RX-Vxxx receivers
- **Homepage**: [https://github.com/wuub/rxv](https://github.com/wuub/rxv)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/q384x7d779ckrpq2dkfg1yim0mvjbfgg-python3.12-rxv-0.7.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/rxv/default.nix:50`
- **Outputs**:
  - `dist`:  `/nix/store/q384x7d779ckrpq2dkfg1yim0mvjbfgg-python3.12-rxv-0.7.0`
  - `out`:  `/nix/store/q384x7d779ckrpq2dkfg1yim0mvjbfgg-python3.12-rxv-0.7.0`
...
- [[kvhxkvfi1nnyz09m1s95igkv49faxrx5-source]]
