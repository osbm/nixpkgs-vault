---
aliases:
  - haskellPackages.hw-json-simple-cursor
tags:
  - license/unknown
  - outputs/doc
  - outputs/out
...
- **Name**: `haskellPackages.hw-json-simple-cursor`
- **Version**: `0.1.1.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Memory efficient JSON parser
- **Homepage**: [https://hackage.haskell.org/package/hw-json-simple-cursor](https://hackage.haskell.org/package/hw-json-simple-cursor)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/53rvwjsc5az2a9wck5l5priliyxyqlb7-hw-json-simple-cursor-0.1.1.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:366986`
- **Outputs**:
  - `doc`:  `/nix/store/53rvwjsc5az2a9wck5l5priliyxyqlb7-hw-json-simple-cursor-0.1.1.1`
  - `out`:  `/nix/store/53rvwjsc5az2a9wck5l5priliyxyqlb7-hw-json-simple-cursor-0.1.1.1`
...
- [[gwan82amk5c01kjfdq1zsmh2q1cpydd0-hw-json-simple-cursor-0.1.1.1-r3.cabal]]
...
- [[zvjxvl15f6gf9zq1kzhinvfcphkwba7f-hw-json-simple-cursor-0.1.1.1.tar.gz]]
