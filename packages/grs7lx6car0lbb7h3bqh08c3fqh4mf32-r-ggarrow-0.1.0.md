...
- **Name**: `rPackages.ggarrow`
- **Version**: `0.1.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/ggarrow/](https://cran.r-project.org/web/packages/ggarrow/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/grs7lx6car0lbb7h3bqh08c3fqh4mf32-r-ggarrow-0.1.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/grs7lx6car0lbb7h3bqh08c3fqh4mf32-r-ggarrow-0.1.0`

## 🔗 Dependencies

- [[1hjk0zvb05snzfpzg6c7a8flsp522wh6-ggarrow_0.1.0.tar.gz]]
