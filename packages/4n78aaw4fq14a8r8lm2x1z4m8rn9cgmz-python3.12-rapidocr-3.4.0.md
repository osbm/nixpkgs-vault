...
- **Name**: `python312Packages.rapidocr`
- **Version**: `3.4.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/4n78aaw4fq14a8r8lm2x1z4m8rn9cgmz-python3.12-rapidocr-3.4.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/rapidocr/default.nix:117`
- **Outputs**:
  - `dist`:  `/nix/store/4n78aaw4fq14a8r8lm2x1z4m8rn9cgmz-python3.12-rapidocr-3.4.0`
  - `out`:  `/nix/store/4n78aaw4fq14a8r8lm2x1z4m8rn9cgmz-python3.12-rapidocr-3.4.0`
...
- [[naqw9l1awcz289xv5ndxvwj1f0kwbz1p-source]]
...
- [[y3ck17gvszsfnqcjywfkgzs92bx1zmpz-setup-py-override-version-checking.patch]]
