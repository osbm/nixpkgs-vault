...
- **Name**: `haskellPackages.pier-core`
- **Version**: `0.3.0.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: A library for writing forwards-declared build systems in haskell
- **Homepage**: [https://hackage.haskell.org/package/pier-core](https://hackage.haskell.org/package/pier-core)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/0dzhaaqv8qziiw3b9mdvl8vqm6vcka1y-pier-core-0.3.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:518490`
- **Outputs**:
  - `doc`:  `/nix/store/0dzhaaqv8qziiw3b9mdvl8vqm6vcka1y-pier-core-0.3.0.0`
  - `out`:  `/nix/store/0dzhaaqv8qziiw3b9mdvl8vqm6vcka1y-pier-core-0.3.0.0`
...
- [[gpdpnqjafqa4slx9cqznjmb11l2mzk11-pier-core-0.3.0.0.tar.gz]]
