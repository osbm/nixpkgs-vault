...
- **Name**: `kdePackages.kfourinline`
- **Version**: `25.08.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: KFourInLine is a four-in-a-row game
- **Homepage**: [https://invent.kde.org/games/kfourinline](https://invent.kde.org/games/kfourinline)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/7vwhwf7aggbpqqdr2n4bhfknbpbwjh56-kfourinline-25.08.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/kde/gear/kfourinline/default.nix:7`
- **Outputs**:
  - `debug`:  `/nix/store/7vwhwf7aggbpqqdr2n4bhfknbpbwjh56-kfourinline-25.08.1`
  - `dev`:  `/nix/store/7vwhwf7aggbpqqdr2n4bhfknbpbwjh56-kfourinline-25.08.1`
  - `devtools`:  `/nix/store/7vwhwf7aggbpqqdr2n4bhfknbpbwjh56-kfourinline-25.08.1`
  - `out`:  `/nix/store/7vwhwf7aggbpqqdr2n4bhfknbpbwjh56-kfourinline-25.08.1`

## 🔗 Dependencies

- [[31ijrpyw7isdvyf8f96n7p65fsckiz1m-qtsvg-6.9.2]]
- [[3dq6jy51dkbidpbf9jipqmhq88yhkxb7-kfourinline-25.08.1.tar.xz]]
