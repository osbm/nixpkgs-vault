...
- **Name**: `python312Packages.databricks-sql-connector`
- **Version**: `4.0.5`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Databricks SQL Connector for Python
- **Homepage**: [https://docs.databricks.com/dev-tools/python-sql-connector.html](https://docs.databricks.com/dev-tools/python-sql-connector.html)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/231jv99wri340n1wwsx9vaa3dm3kp8fm-python3.12-databricks-sql-connector-4.0.5.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/databricks-sql-connector/default.nix:66`
- **Outputs**:
  - `dist`:  `/nix/store/231jv99wri340n1wwsx9vaa3dm3kp8fm-python3.12-databricks-sql-connector-4.0.5`
  - `out`:  `/nix/store/231jv99wri340n1wwsx9vaa3dm3kp8fm-python3.12-databricks-sql-connector-4.0.5`
...
- [[qmvb0wbrcdq77jdmlrvp0j3hzm9k25l2-source]]
