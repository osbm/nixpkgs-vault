...
- **Name**: `rPackages.combcoint`
- **Version**: `0.2.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/combcoint/](https://cran.r-project.org/web/packages/combcoint/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/2b127g217q2588xf3kqnqv845k58mkyv-r-combcoint-0.2.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/2b127g217q2588xf3kqnqv845k58mkyv-r-combcoint-0.2.0`
...
- [[wvny8qhv8yvw974cn6q1c32ncprmlm6s-combcoint_0.2.0.tar.gz]]
