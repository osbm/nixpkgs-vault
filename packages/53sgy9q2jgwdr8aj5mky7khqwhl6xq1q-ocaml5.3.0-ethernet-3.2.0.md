...
- **Name**: `ocamlPackages.ethernet`
- **Version**: `3.2.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: OCaml Ethernet (IEEE 802.3) layer, used in MirageOS
- **Homepage**: [https://github.com/mirage/ethernet](https://github.com/mirage/ethernet)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/53sgy9q2jgwdr8aj5mky7khqwhl6xq1q-ocaml5.3.0-ethernet-3.2.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/ocaml-modules/ethernet/default.nix:32`
- **Outputs**:
  - `out`:  `/nix/store/53sgy9q2jgwdr8aj5mky7khqwhl6xq1q-ocaml5.3.0-ethernet-3.2.0`
...
- [[p7qdqj0712yahl12h299bdjimbcpwchk-ethernet-3.2.0.tbz]]
