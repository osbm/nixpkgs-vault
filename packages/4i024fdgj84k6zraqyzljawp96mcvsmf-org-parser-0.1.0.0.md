...
- **Name**: `haskellPackages.org-parser`
- **Version**: `0.1.0.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Parser for Org Mode documents
- **Homepage**: [https://hackage.haskell.org/package/org-parser](https://hackage.haskell.org/package/org-parser)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/4i024fdgj84k6zraqyzljawp96mcvsmf-org-parser-0.1.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:495672`
- **Outputs**:
  - `doc`:  `/nix/store/4i024fdgj84k6zraqyzljawp96mcvsmf-org-parser-0.1.0.0`
  - `out`:  `/nix/store/4i024fdgj84k6zraqyzljawp96mcvsmf-org-parser-0.1.0.0`
...
- [[dfrdv7nk0pkb81nr7rkfpxmscs5lh4yy-org-parser-0.1.0.0.tar.gz]]
...
- [[w3rvgvilsnh7w7yz4y6xv8wx92gl1mk8-multiwalk-0.3.0.1]]
