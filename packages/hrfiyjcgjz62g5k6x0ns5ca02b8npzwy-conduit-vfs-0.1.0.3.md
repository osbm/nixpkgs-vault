...
- **Name**: `haskellPackages.conduit-vfs`
- **Version**: `0.1.0.3`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Virtual file system for Conduit; disk, pure, and in-memory impls
- **Homepage**: [https://hackage.haskell.org/package/conduit-vfs](https://hackage.haskell.org/package/conduit-vfs)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/hrfiyjcgjz62g5k6x0ns5ca02b8npzwy-conduit-vfs-0.1.0.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:157163`
- **Outputs**:
  - `doc`:  `/nix/store/hrfiyjcgjz62g5k6x0ns5ca02b8npzwy-conduit-vfs-0.1.0.3`
  - `out`:  `/nix/store/hrfiyjcgjz62g5k6x0ns5ca02b8npzwy-conduit-vfs-0.1.0.3`
...
- [[70nb5rf93nmldr0id23ijlp83n86qr5d-conduit-vfs-0.1.0.3.tar.gz]]
