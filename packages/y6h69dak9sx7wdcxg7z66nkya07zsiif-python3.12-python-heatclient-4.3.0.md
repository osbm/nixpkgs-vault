...
- **Name**: `python312Packages.python-heatclient`
- **Version**: `4.3.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Library for Heat built on the Heat orchestration API
- **Homepage**: [https://github.com/openstack/python-heatclient](https://github.com/openstack/python-heatclient)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/y6h69dak9sx7wdcxg7z66nkya07zsiif-python3.12-python-heatclient-4.3.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/python-heatclient/default.nix:84`
- **Outputs**:
  - `dist`:  `/nix/store/y6h69dak9sx7wdcxg7z66nkya07zsiif-python3.12-python-heatclient-4.3.0`
  - `out`:  `/nix/store/y6h69dak9sx7wdcxg7z66nkya07zsiif-python3.12-python-heatclient-4.3.0`

## 🔗 Dependencies

- [[0hn23bvkh97iv6bnz7j1g1z4d14658pa-python_heatclient-4.3.0.tar.gz]]
