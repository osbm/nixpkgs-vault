...
- **Name**: `kdePackages.baloo`
- **Version**: `6.18.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Baloo is a framework for searching and managing metadata.
- **Homepage**: [https://invent.kde.org/frameworks/baloo](https://invent.kde.org/frameworks/baloo)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/la8jfrbjq55x7d9aapw08xwnqaxmydl5-baloo-6.18.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/kde/frameworks/baloo/default.nix:7`
- **Outputs**:
  - `debug`:  `/nix/store/la8jfrbjq55x7d9aapw08xwnqaxmydl5-baloo-6.18.0`
  - `dev`:  `/nix/store/la8jfrbjq55x7d9aapw08xwnqaxmydl5-baloo-6.18.0`
  - `devtools`:  `/nix/store/la8jfrbjq55x7d9aapw08xwnqaxmydl5-baloo-6.18.0`
  - `out`:  `/nix/store/la8jfrbjq55x7d9aapw08xwnqaxmydl5-baloo-6.18.0`

## 🔗 Dependencies

- [[1zc50fsllggdg2pm81dkpi7pgd2h2i51-baloo-6.18.0.tar.xz]]
