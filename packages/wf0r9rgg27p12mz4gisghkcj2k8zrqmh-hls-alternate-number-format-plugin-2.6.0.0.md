...
- **Name**: `haskellPackages.hls-alternate-number-format-plugin`
- **Version**: `2.6.0.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Provide Alternate Number Formats plugin for Haskell Language Server
- **Homepage**: [https://hackage.haskell.org/package/hls-alternate-number-format-plugin](https://hackage.haskell.org/package/hls-alternate-number-format-plugin)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/wf0r9rgg27p12mz4gisghkcj2k8zrqmh-hls-alternate-number-format-plugin-2.6.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:333574`
- **Outputs**:
  - `doc`:  `/nix/store/wf0r9rgg27p12mz4gisghkcj2k8zrqmh-hls-alternate-number-format-plugin-2.6.0.0`
  - `out`:  `/nix/store/wf0r9rgg27p12mz4gisghkcj2k8zrqmh-hls-alternate-number-format-plugin-2.6.0.0`

## 🔗 Dependencies

- [[0xmdq73d03bmkjlcpqwcpfv7kj259jsx-hls-alternate-number-format-plugin-2.6.0.0.tar.gz]]
