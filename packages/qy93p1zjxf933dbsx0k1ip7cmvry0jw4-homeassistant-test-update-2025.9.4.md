---
aliases:
  - home-assistant-component-tests.update
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.update`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/qy93p1zjxf933dbsx0k1ip7cmvry0jw4-homeassistant-test-update-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/qy93p1zjxf933dbsx0k1ip7cmvry0jw4-homeassistant-test-update-2025.9.4`
