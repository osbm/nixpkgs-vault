...
- **Name**: `haskellPackages.http-client`
- **Version**: `0.7.19`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: An HTTP client engine
- **Homepage**: [https://hackage.haskell.org/package/http-client](https://hackage.haskell.org/package/http-client)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/wpldi3zm3580s1jsmmwf7cxx8cr5qspc-http-client-0.7.19.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:360452`
- **Outputs**:
  - `doc`:  `/nix/store/wpldi3zm3580s1jsmmwf7cxx8cr5qspc-http-client-0.7.19`
  - `out`:  `/nix/store/wpldi3zm3580s1jsmmwf7cxx8cr5qspc-http-client-0.7.19`

## 🔗 Dependencies

- [[2pr652igq6awvbbf5rfnb3kbrmg1cryf-http-types-0.12.4]]
- [[351zy5v306bqpk1qxvcksa6z7r16xh49-http-client-0.7.19.tar.gz]]
