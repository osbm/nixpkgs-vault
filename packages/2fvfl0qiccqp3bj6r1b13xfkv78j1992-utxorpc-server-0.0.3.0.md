---
aliases:
  - haskellPackages.utxorpc-server
tags:
  - license/unknown
  - outputs/doc
  - outputs/out
...
An SDK for UTxO RPC services

## 📋 Package Information

- **Name**: `haskellPackages.utxorpc-server`
- **Version**: `0.0.3.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: An SDK for UTxO RPC services
- **Homepage**: [https://hackage.haskell.org/package/utxorpc-server](https://hackage.haskell.org/package/utxorpc-server)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/2fvfl0qiccqp3bj6r1b13xfkv78j1992-utxorpc-server-0.0.3.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:702246`
- **Outputs**:
  - `doc`:  `/nix/store/2fvfl0qiccqp3bj6r1b13xfkv78j1992-utxorpc-server-0.0.3.0`
  - `out`:  `/nix/store/2fvfl0qiccqp3bj6r1b13xfkv78j1992-utxorpc-server-0.0.3.0`

## 🔗 Dependencies

- [[29ybm58igdzal48m551qwkafmkwglq6g-unliftio-0.2.25.1]]
- [[43asrj899j7s02nyb3d2r9ykp67d8215-utxorpc-0.0.17.0]]
- [[449wda71k0nirafdm12z6vm6k0zh742l-utxorpc-server-0.0.3.0.tar.gz]]
