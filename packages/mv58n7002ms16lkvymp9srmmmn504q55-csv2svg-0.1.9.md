...
- **Homepage**: [https://github.com/Canop/csv2svg](https://github.com/Canop/csv2svg)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/mv58n7002ms16lkvymp9srmmmn504q55-csv2svg-0.1.9.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/by-name/cs/csv2svg/package.nix:19`
- **Outputs**:
  - `out`:  `/nix/store/mv58n7002ms16lkvymp9srmmmn504q55-csv2svg-0.1.9`
...
- [[y4mrjyh91v0rviqk6avzzzrnb7h27rmy-csv2svg-0.1.9-vendor]]
- [[zy244g7a5pd7ywckmbnwabrqya6iinlz-csv2svg-0.1.9.tar.gz]]
