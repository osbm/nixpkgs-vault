...
- **Name**: `python312Packages.jenkinsapi`
- **Version**: `0.3.15`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Python API for accessing resources on a Jenkins continuous-integration server
- **Homepage**: [https://github.com/salimfadhley/jenkinsapi](https://github.com/salimfadhley/jenkinsapi)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/ifgxppr4wj11cn8vrywpw2bfvibx3qz4-python3.12-jenkinsapi-0.3.15.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/jenkinsapi/default.nix:56`
- **Outputs**:
  - `dist`:  `/nix/store/ifgxppr4wj11cn8vrywpw2bfvibx3qz4-python3.12-jenkinsapi-0.3.15`
  - `out`:  `/nix/store/ifgxppr4wj11cn8vrywpw2bfvibx3qz4-python3.12-jenkinsapi-0.3.15`

## 🔗 Dependencies

- [[5vsffdi0kgla24ca4l9bv0fxzc7s2qyk-pypa-build-hook.sh]]
- [[6b9jrmyq84xb4gz9m024z4wja8rhspqx-source]]
