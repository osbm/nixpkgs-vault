...
- **Name**: `haskellPackages.keter`
- **Version**: `2.1.9`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Web application deployment manager, focusing on Haskell web frameworks. It mitigates downtime.
- **Homepage**: [https://hackage.haskell.org/package/keter](https://hackage.haskell.org/package/keter)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/pa13d1naqllaf18sw205j9qx714bdxa8-keter-2.1.9.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:400044`
- **Outputs**:
  - `doc`:  `/nix/store/pa13d1naqllaf18sw205j9qx714bdxa8-keter-2.1.9`
  - `out`:  `/nix/store/pa13d1naqllaf18sw205j9qx714bdxa8-keter-2.1.9`
...
- [[4nyw05g82h3x4nf4dhmaxn4hpph0dqfa-keter-2.1.9.tar.gz]]
