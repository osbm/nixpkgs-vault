...
- **Name**: `rPackages.SomaDataIO`
- **Version**: `6.3.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/SomaDataIO/](https://cran.r-project.org/web/packages/SomaDataIO/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/zppa1yrcpiyxmvyxsw97zapqjm50a0pm-r-SomaDataIO-6.3.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/zppa1yrcpiyxmvyxsw97zapqjm50a0pm-r-SomaDataIO-6.3.0`
...
- [[xw6nrg5jbxl3vmp3igy4pdkzyinhkax2-SomaDataIO_6.3.0.tar.gz]]
