...
- **Name**: `lua53Packages.luadbi-mysql`
- **Version**: `0.7.4-1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/iwvmhsrsqlzc534xg376m7pfm9xm08bv-lua5.3-luadbi-mysql-0.7.4-1.drv`
...
- **Outputs**:
  - `out`:  `/nix/store/iwvmhsrsqlzc534xg376m7pfm9xm08bv-lua5.3-luadbi-mysql-0.7.4-1`
...
- [[z581vdqzlhgpdbh7zmzg2v5bddq9nrx3-luadbi-mysql-luarocks-config.lua]]
