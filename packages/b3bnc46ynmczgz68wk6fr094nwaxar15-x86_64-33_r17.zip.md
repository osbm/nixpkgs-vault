---
aliases:
  - androidenv.androidPkgs.all.system-images.v33.google_apis.x86_64
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.system-images.v33.google_apis.x86_64`
- **Version**: `33_r17.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/b3bnc46ynmczgz68wk6fr094nwaxar15-x86_64-33_r17.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/b3bnc46ynmczgz68wk6fr094nwaxar15-x86_64-33_r17.zip`
