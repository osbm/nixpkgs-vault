...
- **Name**: `haskellPackages.presto-hdbc`
- **Version**: `0.1.0.3`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: An HDBC connector for Presto
- **Homepage**: [https://hackage.haskell.org/package/presto-hdbc](https://hackage.haskell.org/package/presto-hdbc)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/l8cn2k7qr971x0cmjipklcdihj497zaa-presto-hdbc-0.1.0.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:536858`
- **Outputs**:
  - `doc`:  `/nix/store/l8cn2k7qr971x0cmjipklcdihj497zaa-presto-hdbc-0.1.0.3`
  - `out`:  `/nix/store/l8cn2k7qr971x0cmjipklcdihj497zaa-presto-hdbc-0.1.0.3`
...
- [[a03mdgbn6r8zhsg319rbrsxc4676vy44-presto-hdbc-0.1.0.3.tar.gz]]
