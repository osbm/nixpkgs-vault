...
- **Name**: `python312Packages.llama-index-llms-ollama`
- **Version**: `0.7.3`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/qc0njxar2w3w1y8whhs00yfpcwrnm3cy-python3.12-llama-index-llms-ollama-0.7.3.drv`
...
- **Outputs**:
  - `dist`:  `/nix/store/qc0njxar2w3w1y8whhs00yfpcwrnm3cy-python3.12-llama-index-llms-ollama-0.7.3`
  - `out`:  `/nix/store/qc0njxar2w3w1y8whhs00yfpcwrnm3cy-python3.12-llama-index-llms-ollama-0.7.3`
