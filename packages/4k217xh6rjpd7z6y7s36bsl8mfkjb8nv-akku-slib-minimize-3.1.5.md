...
Finds minimum value of a function

## 📋 Package Information

- **Name**: `akkuPackages.slib-minimize`
- **Version**: `3.1.5`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/4k217xh6rjpd7z6y7s36bsl8mfkjb8nv-akku-slib-minimize-3.1.5.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/tools/package-management/akku/default.nix:39`
- **Outputs**:
  - `out`:  `/nix/store/4k217xh6rjpd7z6y7s36bsl8mfkjb8nv-akku-slib-minimize-3.1.5`
...
- [[xjyddp0hiwf5njlsl8hxzskwib543lrm-slib-minimize-SLIB-3b5-r7rs.tgz]]
