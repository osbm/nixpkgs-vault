...
- **Name**: `rPackages.datadigest`
- **Version**: `1.0.2`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://cran.r-project.org/web/packages/datadigest/](https://cran.r-project.org/web/packages/datadigest/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/diifwsfb663xy8873wf9cfs2i57xkh1m-r-datadigest-1.0.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/diifwsfb663xy8873wf9cfs2i57xkh1m-r-datadigest-1.0.2`

## 🔗 Dependencies

- [[1gjf3ssfjpwpp5h94a23n3kzicfypm16-r-htmlwidgets-1.6.4]]
- [[2b31b15jsdgmzmls9lv3ldjmgr3r3d3v-datadigest_1.0.2.tar.gz]]
