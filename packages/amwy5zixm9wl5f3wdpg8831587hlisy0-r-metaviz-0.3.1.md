...
- **Name**: `rPackages.metaviz`
- **Version**: `0.3.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/metaviz/](https://cran.r-project.org/web/packages/metaviz/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/amwy5zixm9wl5f3wdpg8831587hlisy0-r-metaviz-0.3.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/amwy5zixm9wl5f3wdpg8831587hlisy0-r-metaviz-0.3.1`
...
- [[ygfah9bkbbn6iggdjadhb6ghh8wkz08b-metaviz_0.3.1.tar.gz]]
