...
- **Derivation Path**: `/nix/store/9pn0p6sh0cl62zwd0yfnlzdhw87h0dlx-zabbix-agent2-7.2.10.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/monitoring/zabbix/agent2.nix:82`
- **Outputs**:
  - `out`:  `/nix/store/9pn0p6sh0cl62zwd0yfnlzdhw87h0dlx-zabbix-agent2-7.2.10`
