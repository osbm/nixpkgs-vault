...
- **Name**: `haskellPackages.javelin`
- **Version**: `0.1.4.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Labeled one-dimensional arrays
- **Homepage**: [https://hackage.haskell.org/package/javelin](https://hackage.haskell.org/package/javelin)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/6lnbxyhkppa54ncmddw9k09hgwdxnkc6-javelin-0.1.4.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:389102`
- **Outputs**:
  - `doc`:  `/nix/store/6lnbxyhkppa54ncmddw9k09hgwdxnkc6-javelin-0.1.4.2`
  - `out`:  `/nix/store/6lnbxyhkppa54ncmddw9k09hgwdxnkc6-javelin-0.1.4.2`
...
- [[k7iz9wz7mwhw3xmhddih71m16plxnl1d-javelin-0.1.4.2.tar.gz]]
