...
- **Name**: `haskellPackages.azurify`
- **Version**: `0.4.0.5`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: A simple library for accessing Azure blob storage
- **Homepage**: [https://hackage.haskell.org/package/azurify](https://hackage.haskell.org/package/azurify)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/pvc5m815ri8gvb9dy27lrxismm9ck2i4-azurify-0.4.0.5.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:94893`
- **Outputs**:
  - `doc`:  `/nix/store/pvc5m815ri8gvb9dy27lrxismm9ck2i4-azurify-0.4.0.5`
  - `out`:  `/nix/store/pvc5m815ri8gvb9dy27lrxismm9ck2i4-azurify-0.4.0.5`
...
- [[h8xfzrnfd26zaxzr9pljs2g6zbdm0yww-azurify-0.4.0.5.tar.gz]]
