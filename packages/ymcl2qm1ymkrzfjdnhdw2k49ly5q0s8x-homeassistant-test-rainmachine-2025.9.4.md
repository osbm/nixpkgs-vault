...
- **Name**: `home-assistant-component-tests.rainmachine`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/ymcl2qm1ymkrzfjdnhdw2k49ly5q0s8x-homeassistant-test-rainmachine-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/ymcl2qm1ymkrzfjdnhdw2k49ly5q0s8x-homeassistant-test-rainmachine-2025.9.4`
...
- [[bwxgdrn6hrzqwqiv6diyzq3jxgxi43rc-python3.13-regenmaschine-2024.03.0]]
