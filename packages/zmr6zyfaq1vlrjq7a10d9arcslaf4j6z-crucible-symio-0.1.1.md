---
aliases:
  - haskellPackages.crucible-symio
tags:
  - license/unknown
  - outputs/doc
  - outputs/out
...
- **Name**: `haskellPackages.crucible-symio`
- **Version**: `0.1.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: An implementation of symbolic I/O primitives for Crucible
- **Homepage**: [https://hackage.haskell.org/package/crucible-symio](https://hackage.haskell.org/package/crucible-symio)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/zmr6zyfaq1vlrjq7a10d9arcslaf4j6z-crucible-symio-0.1.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:168336`
- **Outputs**:
  - `doc`:  `/nix/store/zmr6zyfaq1vlrjq7a10d9arcslaf4j6z-crucible-symio-0.1.1`
  - `out`:  `/nix/store/zmr6zyfaq1vlrjq7a10d9arcslaf4j6z-crucible-symio-0.1.1`
...
- [[fjfsdysmw6xnk4l3x4y3a8syxyaznf2z-crucible-symio-0.1.1.tar.gz]]
