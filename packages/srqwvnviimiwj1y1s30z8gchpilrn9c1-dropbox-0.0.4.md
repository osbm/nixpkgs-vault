...
- **Name**: `haskellPackages.dropbox`
- **Version**: `0.0.4`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Dropbox API client
- **Homepage**: [https://hackage.haskell.org/package/dropbox](https://hackage.haskell.org/package/dropbox)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/srqwvnviimiwj1y1s30z8gchpilrn9c1-dropbox-0.0.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:204297`
- **Outputs**:
  - `doc`:  `/nix/store/srqwvnviimiwj1y1s30z8gchpilrn9c1-dropbox-0.0.4`
  - `out`:  `/nix/store/srqwvnviimiwj1y1s30z8gchpilrn9c1-dropbox-0.0.4`
...
- [[slj8w1xj08lqdfahi2c2jfdl8y8l07q5-dropbox-0.0.4.tar.gz]]
