...
- **Name**: `rPackages.rearrr`
- **Version**: `0.3.5`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/rearrr/](https://cran.r-project.org/web/packages/rearrr/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/6b7vbj2a1izgvrf05z3mnfpayp1jqwah-r-rearrr-0.3.5.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/6b7vbj2a1izgvrf05z3mnfpayp1jqwah-r-rearrr-0.3.5`
...
- [[nr3629w354zz20qx7xsmawd7gg2drjkf-rearrr_0.3.5.tar.gz]]
