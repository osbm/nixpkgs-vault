...
- **Name**: `haskellPackages.CV`
- **Version**: `0.3.7`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: OpenCV based machine vision library
- **Homepage**: [https://hackage.haskell.org/package/CV](https://hackage.haskell.org/package/CV)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/rv5ag329asygmcmydl9rjvcwrfbf6n8f-CV-0.3.7.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:5719`
- **Outputs**:
  - `doc`:  `/nix/store/rv5ag329asygmcmydl9rjvcwrfbf6n8f-CV-0.3.7`
  - `out`:  `/nix/store/rv5ag329asygmcmydl9rjvcwrfbf6n8f-CV-0.3.7`
...
- [[mspjhl7igayccqrhnhnpnbf0ly5pi691-CV-0.3.7.tar.gz]]
