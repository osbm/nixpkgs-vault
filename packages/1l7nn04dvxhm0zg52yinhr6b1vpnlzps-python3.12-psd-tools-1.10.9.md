...
- **Name**: `python312Packages.psd-tools`
- **Version**: `1.10.9`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Python package for reading Adobe Photoshop PSD files
- **Homepage**: [https://github.com/kmike/psd-tools](https://github.com/kmike/psd-tools)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/1l7nn04dvxhm0zg52yinhr6b1vpnlzps-python3.12-psd-tools-1.10.9.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/psd-tools/default.nix:58`
- **Outputs**:
  - `dist`:  `/nix/store/1l7nn04dvxhm0zg52yinhr6b1vpnlzps-python3.12-psd-tools-1.10.9`
  - `out`:  `/nix/store/1l7nn04dvxhm0zg52yinhr6b1vpnlzps-python3.12-psd-tools-1.10.9`

## 🔗 Dependencies

- [[07lcjzinvgna9bzjmbdq67rcr13a2iad-python3.12-ipython-9.4.0]]
- [[0yhx7lrs562idxc6ab1s649cnyyk9xdi-source]]
...
- [[k861zv5cx88r9l3hixmdpf5xgnci808q-python3.12-aggdraw-1.3.19]]
