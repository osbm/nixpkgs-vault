...
- **Name**: `rPackages.openmeteo`
- **Version**: `0.2.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/openmeteo/](https://cran.r-project.org/web/packages/openmeteo/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/3ik37zsi5sas963b42cpdwhsynrhs7r0-r-openmeteo-0.2.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/3ik37zsi5sas963b42cpdwhsynrhs7r0-r-openmeteo-0.2.4`
...
- [[fxqgf0my2hvljpnzpw10lzlkkgvlga5m-openmeteo_0.2.4.tar.gz]]
