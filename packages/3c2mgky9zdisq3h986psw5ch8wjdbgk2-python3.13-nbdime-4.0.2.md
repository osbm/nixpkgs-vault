...
- **Name**: `python313Packages.nbdime`
- **Version**: `4.0.2`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Tools for diffing and merging of Jupyter notebooks
- **Homepage**: [https://github.com/jupyter/nbdime](https://github.com/jupyter/nbdime)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/3c2mgky9zdisq3h986psw5ch8wjdbgk2-python3.13-nbdime-4.0.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/nbdime/default.nix:95`
- **Outputs**:
  - `dist`:  `/nix/store/3c2mgky9zdisq3h986psw5ch8wjdbgk2-python3.13-nbdime-4.0.2`
  - `out`:  `/nix/store/3c2mgky9zdisq3h986psw5ch8wjdbgk2-python3.13-nbdime-4.0.2`
...
- [[4axnybkjj2mcm90i5fpzzyqj3p4s30pd-python3.13-jupyter-server-mathjax-0.2.6]]
...
- [[m9mbiglh89m4ncqxbzfwvgydw5by0mb3-nbdime-4.0.2.tar.gz]]
