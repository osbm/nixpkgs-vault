...
- **Name**: `haskellPackages.cassy`
- **Version**: `0.7.1`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: A high level driver for the Cassandra datastore
- **Homepage**: [https://hackage.haskell.org/package/cassy](https://hackage.haskell.org/package/cassy)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/s2djw6jgkripnk3530id853mql6x81m7-cassy-0.7.1.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:132431`
- **Outputs**:
  - `doc`:  `/nix/store/s2djw6jgkripnk3530id853mql6x81m7-cassy-0.7.1`
  - `out`:  `/nix/store/s2djw6jgkripnk3530id853mql6x81m7-cassy-0.7.1`
...
- [[ac1aim01k1ixrxcm9gbsy3215pxli8dh-cassandra-thrift-0.8.5.1]]
...
- [[k8pl7855avzhr1m9zkqa2lwf8ckplzad-cassy-0.7.1.tar.gz]]
- [[kf160skfwpf98c6iibz31l21j51kidf8-test-framework-0.8.2.2]]
- [[khf7pv8az92s1kqxbvyb82x5mbg0mw8m-Thrift-0.6.0.1]]
