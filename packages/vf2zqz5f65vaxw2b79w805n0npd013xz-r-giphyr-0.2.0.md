...
- **Name**: `rPackages.giphyr`
- **Version**: `0.2.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://cran.r-project.org/web/packages/giphyr/](https://cran.r-project.org/web/packages/giphyr/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/vf2zqz5f65vaxw2b79w805n0npd013xz-r-giphyr-0.2.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/vf2zqz5f65vaxw2b79w805n0npd013xz-r-giphyr-0.2.0`
...
- [[wrxm8mv14kaddy2sjqaklrva80pwkh5n-giphyr_0.2.0.tar.gz]]
