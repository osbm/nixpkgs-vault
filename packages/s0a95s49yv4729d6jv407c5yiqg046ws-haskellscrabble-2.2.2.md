---
aliases:
  - haskellPackages.haskellscrabble
tags:
  - broken
  - not-available
  - license/unknown
...
- **Name**: `haskellPackages.haskellscrabble`
- **Version**: `2.2.2`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: A scrabble library capturing the core game logic of scrabble
- **Homepage**: [https://hackage.haskell.org/package/haskellscrabble](https://hackage.haskell.org/package/haskellscrabble)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/s0a95s49yv4729d6jv407c5yiqg046ws-haskellscrabble-2.2.2.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:307646`
- **Outputs**:
  - `doc`:  `/nix/store/s0a95s49yv4729d6jv407c5yiqg046ws-haskellscrabble-2.2.2`
  - `out`:  `/nix/store/s0a95s49yv4729d6jv407c5yiqg046ws-haskellscrabble-2.2.2`
...
- [[pzr7mi4xghlqjmmfhlg0qkdygna3l7s5-haskellscrabble-2.2.2.tar.gz]]
