...
- **Name**: `haskellPackages.krapsh`
- **Version**: `0.1.9.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Haskell bindings for Spark Dataframes and Datasets
- **Homepage**: [https://hackage.haskell.org/package/krapsh](https://hackage.haskell.org/package/krapsh)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/78x6vvaq2zaxh0cgd5ffvka017dzn3zv-krapsh-0.1.9.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:402877`
- **Outputs**:
  - `doc`:  `/nix/store/78x6vvaq2zaxh0cgd5ffvka017dzn3zv-krapsh-0.1.9.0`
  - `out`:  `/nix/store/78x6vvaq2zaxh0cgd5ffvka017dzn3zv-krapsh-0.1.9.0`
...
- [[xaim5m0f9ici207c364vhzqv92dc481b-krapsh-0.1.9.0.tar.gz]]
