---
aliases:
  - home-assistant-component-tests.group
tags:
  - license/unknown
...
- **Name**: `home-assistant-component-tests.group`
- **Version**: `2025.9.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/x4w683s8ps9yqhkkyixdzrdihpcfskpm-homeassistant-test-group-2025.9.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/servers/home-assistant/default.nix:600`
- **Outputs**:
  - `out`:  `/nix/store/x4w683s8ps9yqhkkyixdzrdihpcfskpm-homeassistant-test-group-2025.9.4`
