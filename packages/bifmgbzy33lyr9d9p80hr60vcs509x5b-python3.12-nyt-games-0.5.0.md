...
- **Name**: `python312Packages.nyt-games`
- **Version**: `0.5.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/bifmgbzy33lyr9d9p80hr60vcs509x5b-python3.12-nyt-games-0.5.0.drv`
...
- **Outputs**:
  - `dist`:  `/nix/store/bifmgbzy33lyr9d9p80hr60vcs509x5b-python3.12-nyt-games-0.5.0`
  - `out`:  `/nix/store/bifmgbzy33lyr9d9p80hr60vcs509x5b-python3.12-nyt-games-0.5.0`
