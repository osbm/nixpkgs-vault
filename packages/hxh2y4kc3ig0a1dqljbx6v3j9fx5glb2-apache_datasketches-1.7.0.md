...
- **Name**: `postgresql14Packages.apache_datasketches`
- **Version**: `1.7.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/hxh2y4kc3ig0a1dqljbx6v3j9fx5glb2-apache_datasketches-1.7.0.drv`
...
- **Outputs**:
  - `out`:  `/nix/store/hxh2y4kc3ig0a1dqljbx6v3j9fx5glb2-apache_datasketches-1.7.0`
