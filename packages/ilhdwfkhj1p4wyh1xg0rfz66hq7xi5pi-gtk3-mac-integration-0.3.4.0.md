---
aliases:
  - haskellPackages.gtk3-mac-integration
tags:
  - not-available
  - license/unknown
  - outputs/data
...
- **Name**: `haskellPackages.gtk3-mac-integration`
- **Version**: `0.3.4.0`
- **Available**: ❌ No
- **Broken**: ✅ No
- **Description**: Bindings for the Gtk/OS X integration library
- **Homepage**: [https://hackage.haskell.org/package/gtk3-mac-integration](https://hackage.haskell.org/package/gtk3-mac-integration)
- **License**: `unknown`
- **Platforms**: `x86_64-darwin`, `aarch64-darwin`

## 🔧 Build Information

- **Derivation Path**: `/nix/store/ilhdwfkhj1p4wyh1xg0rfz66hq7xi5pi-gtk3-mac-integration-0.3.4.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:286777`
- **Outputs**:
  - `data`:  `/nix/store/ilhdwfkhj1p4wyh1xg0rfz66hq7xi5pi-gtk3-mac-integration-0.3.4.0`
  - `doc`:  `/nix/store/ilhdwfkhj1p4wyh1xg0rfz66hq7xi5pi-gtk3-mac-integration-0.3.4.0`
  - `out`:  `/nix/store/ilhdwfkhj1p4wyh1xg0rfz66hq7xi5pi-gtk3-mac-integration-0.3.4.0`
...
- [[ggwz6sq5yg0ca2lv7rjbpxf93dsns40f-gtk-mac-integration-3.0.1]]
...
- [[ya7k9kpzxa945s00nil1brrdcgrmj8r3-gtk3-mac-integration-0.3.4.0.tar.gz]]
