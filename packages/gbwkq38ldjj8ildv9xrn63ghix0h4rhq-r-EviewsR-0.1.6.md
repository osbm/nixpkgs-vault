...
- **Name**: `rPackages.EviewsR`
- **Version**: `0.1.6`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/EviewsR/](https://cran.r-project.org/web/packages/EviewsR/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/gbwkq38ldjj8ildv9xrn63ghix0h4rhq-r-EviewsR-0.1.6.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/gbwkq38ldjj8ildv9xrn63ghix0h4rhq-r-EviewsR-0.1.6`

## 🔗 Dependencies

- [[280z6ahdgwz3p54cr1am5fcl37f2ypfg-EviewsR_0.1.6.tar.gz]]
