---
aliases:
  - python312Packages.python-bsblan
tags:
  - license/unknown
  - maintainers/fabaff
  - outputs/dist
...
- **Name**: `python312Packages.python-bsblan`
- **Version**: `2.2.5`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Module to control and monitor an BSBLan device programmatically
- **Homepage**: [https://github.com/liudger/python-bsblan](https://github.com/liudger/python-bsblan)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/qp2cskjkbrqqc9sphay2h9vdfmv055gg-python3.12-python-bsblan-2.2.5.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/python-bsblan/default.nix:66`
- **Outputs**:
  - `dist`:  `/nix/store/qp2cskjkbrqqc9sphay2h9vdfmv055gg-python3.12-python-bsblan-2.2.5`
  - `out`:  `/nix/store/qp2cskjkbrqqc9sphay2h9vdfmv055gg-python3.12-python-bsblan-2.2.5`
...
- [[d9wbb4imsxvxdp6zb3bmk76wbj6w0pkf-source]]
