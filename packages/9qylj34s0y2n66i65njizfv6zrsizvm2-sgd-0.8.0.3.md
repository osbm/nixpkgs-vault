...
- **Name**: `haskellPackages.sgd`
- **Version**: `0.8.0.3`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Description**: Stochastic gradient descent library
- **Homepage**: [https://hackage.haskell.org/package/sgd](https://hackage.haskell.org/package/sgd)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/9qylj34s0y2n66i65njizfv6zrsizvm2-sgd-0.8.0.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:605217`
- **Outputs**:
  - `doc`:  `/nix/store/9qylj34s0y2n66i65njizfv6zrsizvm2-sgd-0.8.0.3`
  - `out`:  `/nix/store/9qylj34s0y2n66i65njizfv6zrsizvm2-sgd-0.8.0.3`
...
- [[hs1pg94h9r1rs2d6dqr3v6w7d3s87wjs-sgd-0.8.0.3.tar.gz]]
