...
- **Name**: `python312Packages.tyro`
- **Version**: `0.9.28`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: CLI interfaces & config objects, from types
- **Homepage**: [https://github.com/brentyi/tyro](https://github.com/brentyi/tyro)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/b1l81a8j627jsfrs1llf5brh46z6s5gd-python3.12-tyro-0.9.28.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/tyro/default.nix:65`
- **Outputs**:
  - `dist`:  `/nix/store/b1l81a8j627jsfrs1llf5brh46z6s5gd-python3.12-tyro-0.9.28`
  - `out`:  `/nix/store/b1l81a8j627jsfrs1llf5brh46z6s5gd-python3.12-tyro-0.9.28`

## 🔗 Dependencies

- [[01snwzmzl4pm638jnggnzvcdd5m2yq2l-python3.12-torch-2.8.0]]
- [[2wl38zgyfliclj4gx98gdha5z6srhlli-python3.12-shtab-1.7.2]]
- [[2xqdjfnk2fsfr4inlzrhbyd0qq3lz18s-python3.12-ml-collections-1.1.0]]
...
- [[mqirjbdqwvkn4cnqw0k4h7pccxdwasf6-source]]
