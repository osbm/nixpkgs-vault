...
- **Name**: `rPackages.banditsCI`
- **Version**: `1.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Homepage**: [https://cran.r-project.org/web/packages/banditsCI/](https://cran.r-project.org/web/packages/banditsCI/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/b2qcgggyjmyxlknxfaaxbapmw74iin3k-r-banditsCI-1.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/b2qcgggyjmyxlknxfaaxbapmw74iin3k-r-banditsCI-1.0.0`

## 🔗 Dependencies

- [[2xb8842sk4s8zzcdpxyf8367njanli98-banditsCI_1.0.0.tar.gz]]
