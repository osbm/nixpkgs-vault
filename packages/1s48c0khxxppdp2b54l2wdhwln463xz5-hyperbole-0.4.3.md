...
- **Name**: `haskellPackages.hyperbole`
- **Version**: `0.4.3`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Interactive HTML apps using type-safe serverside Haskell
- **Homepage**: [https://hackage.haskell.org/package/hyperbole](https://hackage.haskell.org/package/hyperbole)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/1s48c0khxxppdp2b54l2wdhwln463xz5-hyperbole-0.4.3.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:370774`
- **Outputs**:
  - `doc`:  `/nix/store/1s48c0khxxppdp2b54l2wdhwln463xz5-hyperbole-0.4.3`
  - `out`:  `/nix/store/1s48c0khxxppdp2b54l2wdhwln463xz5-hyperbole-0.4.3`
...
- [[acvfjjkn658cnf20gr77jkn5s2ynyjhi-web-view-0.7.1]]
...
- [[wyawqcnnd3mq89j9q0p9a5qz835jx4f8-hyperbole-0.4.3.tar.gz]]
