---
aliases:
  - haskellPackages.porcupine-http
tags:
  - license/unknown
  - outputs/doc
  - outputs/out
...
- **Name**: `haskellPackages.porcupine-http`
- **Version**: `0.1.0.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: A location accessor for porcupine to connect to HTTP sources/sinks
- **Homepage**: [https://hackage.haskell.org/package/porcupine-http](https://hackage.haskell.org/package/porcupine-http)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/hw12mcha8jw9ljjps6gazpp568jzdwb9-porcupine-http-0.1.0.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/haskell-modules/hackage-packages.nix:529768`
- **Outputs**:
  - `doc`:  `/nix/store/hw12mcha8jw9ljjps6gazpp568jzdwb9-porcupine-http-0.1.0.0`
  - `out`:  `/nix/store/hw12mcha8jw9ljjps6gazpp568jzdwb9-porcupine-http-0.1.0.0`
...
- [[6vb1sbgb5ykwx4d64hwpg5z9k0rzk0wh-porcupine-core-0.1.0.1]]
...
- [[f4vvg2wjvkp8a19x5ql9p6xl65gg7ag7-porcupine-http-0.1.0.0.tar.gz]]
