---
aliases:
  - python312Packages.scalar-fastapi
tags:
  - license/unknown
...
- **Name**: `python312Packages.scalar-fastapi`
- **Version**: `1.4.0`
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Plugin for FastAPI to render a reference for your OpenAPI document
- **Homepage**: [https://github.com/scalar/scalar/](https://github.com/scalar/scalar/)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/wzfsnka1gg97v4n7g17dnyah7ckqjdyz-python3.12-scalar-fastapi-1.4.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/python-modules/scalar-fastapi/default.nix:60`
- **Outputs**:
  - `dist`:  `/nix/store/wzfsnka1gg97v4n7g17dnyah7ckqjdyz-python3.12-scalar-fastapi-1.4.0`
  - `out`:  `/nix/store/wzfsnka1gg97v4n7g17dnyah7ckqjdyz-python3.12-scalar-fastapi-1.4.0`

## 🔗 Dependencies

- [[0x2m8jwc3mnz3vjy2ax6x6n04vdhrm2y-python3.12-httpx-0.28.1]]
- [[41p8n265c3f3gaf6jsxfxprq5x3904jr-scalar_fastapi-1.4.0.tar.gz]]
