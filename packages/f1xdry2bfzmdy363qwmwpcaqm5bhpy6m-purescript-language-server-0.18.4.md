...
- **Name**: `nodePackages.purescript-language-server`
- **Version**: `0.18.4`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/f1xdry2bfzmdy363qwmwpcaqm5bhpy6m-purescript-language-server-0.18.4.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/node-packages/node-packages.nix:61933`
- **Outputs**:
  - `out`:  `/nix/store/f1xdry2bfzmdy363qwmwpcaqm5bhpy6m-purescript-language-server-0.18.4`
