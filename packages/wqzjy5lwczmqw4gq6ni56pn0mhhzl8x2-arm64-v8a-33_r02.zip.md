---
aliases:
  - androidenv.androidPkgs.all.system-images.v33.default.arm64-v8a
tags:
  - not-available
  - license/unknown
...
- **Name**: `androidenv.androidPkgs.all.system-images.v33.default.arm64-v8a`
- **Version**: `33_r02.zip`
- **Available**: ❌ No
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/wqzjy5lwczmqw4gq6ni56pn0mhhzl8x2-arm64-v8a-33_r02.zip.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/mobile/androidenv/default.nix:36`
- **Outputs**:
  - `out`:  `/nix/store/wqzjy5lwczmqw4gq6ni56pn0mhhzl8x2-arm64-v8a-33_r02.zip`
