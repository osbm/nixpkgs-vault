...
- **Available**: ✅ Yes
- **Broken**: ✅ No
- **Description**: Free and Open Source 2D and 3D game engine (nix export templates)
- **Homepage**: [https://docs.godotengine.org/en/stable/development/compiling/compiling_for_x11.html#building-export-templates](https://docs.godotengine.org/en/stable/development/compiling/compiling_for_x11.html#building-export-templates)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/z42a0fdv8272s3mrf0pdpsbid9n5xnvb-godot3-export-templates-3.6.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/tools/godot/3/default.nix:178`
- **Outputs**:
  - `out`:  `/nix/store/z42a0fdv8272s3mrf0pdpsbid9n5xnvb-godot3-export-templates-3.6`
