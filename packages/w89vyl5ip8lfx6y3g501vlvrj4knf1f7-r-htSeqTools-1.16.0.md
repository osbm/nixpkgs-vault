...
- **Name**: `rPackages.htSeqTools`
- **Version**: `1.16.0`
- **Available**: ❌ No
- **Broken**: ⚠️ Yes
- **Homepage**: [https://bioconductor.org/packages/3.21/bioc/html/htSeqTools.html](https://bioconductor.org/packages/3.21/bioc/html/htSeqTools.html)
- **License**: `unknown`
...
- **Derivation Path**: `/nix/store/w89vyl5ip8lfx6y3g501vlvrj4knf1f7-r-htSeqTools-1.16.0.drv`
- **Source Position**: `/nix/store/ns30sqxb36k8jrds8z18rv96bpnwc60d-source/pkgs/development/r-modules/generic-builder.nix:81`
- **Outputs**:
  - `out`:  `/nix/store/w89vyl5ip8lfx6y3g501vlvrj4knf1f7-r-htSeqTools-1.16.0`
...
- [[ss9a7pvmhh9qpy55jnbc9pbd66srw0lg-htSeqTools_1.16.0.tar.gz]]
