...
- **Name**: `python312Packages.clickgen`
- **Version**: `2.2.5`
- **Available**: ✅ Yes
- **Broken**: ✅ No
...
- **Derivation Path**: `/nix/store/d4i0mf03zd6bng7h5zsgxnv0v2r3nbnq-python3.12-clickgen-2.2.5.drv`
...
- **Outputs**:
  - `dist`:  `/nix/store/d4i0mf03zd6bng7h5zsgxnv0v2r3nbnq-python3.12-clickgen-2.2.5`
  - `out`:  `/nix/store/d4i0mf03zd6bng7h5zsgxnv0v2r3nbnq-python3.12-clickgen-2.2.5`
